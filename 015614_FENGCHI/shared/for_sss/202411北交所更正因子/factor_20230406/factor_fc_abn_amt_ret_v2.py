...
def factor_fc_abn_amt_ret_v2(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='fc_abn_amt_ret_v2'

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['MD']}

    start_date_ = int(s.tradingday(str(start_date), -121)[0])
    ...
    md_data.loc[md_data['stock_code'].str.endswith('BJ'), 'pct_chg'] = md_data.loc[md_data['stock_code'].str.endswith('BJ'), 'pct_chg'] / 3
