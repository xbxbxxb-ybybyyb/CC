...
def factor_fc_dis_pct_ma10(start_date, end_date, IO, return_fillna_dic=False):
    ...
    md_data.loc[md_data['stock_code'].str.endswith('BJ'), 'dis_pct_ma10'] = md_data.loc[md_data['stock_code'].str.endswith('BJ'), 'dis_pct_ma10'] / 3
