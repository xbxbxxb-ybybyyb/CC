...
def factor_fc_stk_hs300_sp_240(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='fc_stk_hs300_sp_240'

    if return_fillna_dic:
        return {factor_name: 0.3915, 'data': ['MD', 'AIndexEODPrices']}
    ...
    index_data = index_data.query(f'Ticker == "000300.SH"')
