...
class modeltrack_Tool:
    ...
    def select_profit(self):
        if self.strategy == 'jupiter':
            self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit_fix/LabelProfit_zt_twap_0.10_800_190_SH300_SZ30.h5'
            self.cost_pct = 0.002
            self.attend_min = 10
            self.attend_max = 51
            self.group_ratio = 0.2
        elif self.strategy == 'Europa':
            self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit_fix/001/LabelProfit_zt_twap_0.10_800_190_SH300_SZ30.h5'
            self.cost_pct = 0.002
            self.attend_min = 10
            self.attend_max = 51
            self.group_ratio = 0.2
            ...
            self.profit_path = '/data/group/800463/project/projectS_prod/LabelProfit_fix/Sell_pct_0.10_800_190_SH300_SZ30.pkl'
            self.cost_pct = 0
            self.attend_min = 10
            ...
            self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit_fixvol_beforeZ/JupiterZ_Label_0.10_800_190_SH300_SZ30.pkl'
            self.cost_pct = 0
        ...
        if 'label_pct' in profit_data.columns:
            ...
            profit_data['label_zuhe'] = profit_data.apply(lambda x: 1 if x['label_pct_cost'] >= self.cost_pct else 0, axis=1)
        else:
    ...
    def select_label(self):
        if self.strategy == 'jupiter':
            ...
            self.label_path = '/data/group/800463/project/projectS_prod/LabelProfit_fix/Sell_pct_0.10_800_190_SH300_SZ30.pkl'
            ...
            self.label_path = '/data/group/800463/project/project1_prod/LabelProfit_fixvol_beforeZ/JupiterZ_Label_0.10_800_190_SH300_SZ30.pkl'
            self.label_rev = 'label_label_diff_pct'
            self.label_o2o10 = 'label_pattern'
    ...
    def cal_stats_sheet(self, model_name):
        ...
        # out_dict['%s中位数' % str_model_pct] = np.median(data[data[model_name] == 1][self.label_rev])
        # out_dict['扣费收益率胜率'] = raw_stats['预测正确正收益样本数量'].sum() / raw_stats['预测正样本数量'].sum()
    ...
    def cal_sharp(self, day_data, pct_col='label_profit_cost', stepdate=3):
        ...
        tot_dt = self.tot_dt # [int(x) for x in hfactor.tradingday(int(day_data['datelist'].min()), int(day_data['datelist'].max()))]
