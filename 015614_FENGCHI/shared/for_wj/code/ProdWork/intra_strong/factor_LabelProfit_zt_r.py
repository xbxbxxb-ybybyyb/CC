...
def factor_LabelProfit_zt(param,basic_file, result_path='/data/group/800463/project/project1_prod/LabelProfit_zt/'):
    ...
    # basic_df = self_IO.read_data([start_date, end_date], alt=basic_path)
    basic_df = basic_file
    ...
    mdp = MarketData()
    sell_type = 'pct'
    import ProdWork.intra_strong.func_LabelProfit_zt_sell as func
...
if __name__ == '__main__':
    ...
    if sell_type == 'twap':
        import func_LabelProfit_zt_twap as func
    elif sell_type == 'pct':
        import func_LabelProfit_zt_sell as func
    elif sell_type == 'twap2':
        import func_LabelProfit_zt_twap2 as func
    ...
    factor_df = factor_LabelProfit_zt(param, result_path)
