...
if __name__ == '__main__':
    ...
    for environment in env_list:
        ...
        inf_df = pd.read_excel( '/data/group/800463/日内强势股/cpp_log_parse/因子耗时/因子耗时_%s_%s.xlsx'%(tradeDate, environment),sheetname = '项目二930样本')
        ...
        excel_saver(excel_save_dict,'/data/group/800463/日内强势股/cpp_log_parse/模型差异/%s/模型差异_%s_%s_pj2_930.xlsx'%(tradeDatestr,tradeDatestr,environment))
