...
if __name__ == '__main__':
    print('==========jupz_prod_model_comparision===========')
    if len(sys.argv) > 1:
        nowdate = sys.argv[1]
    else:
    ...
    for nowdate in datelist:
        ...
        for environment in env_list:
            ...
            inf_df = pd.read_excel( '/data/group/800463/日内强势股/cpp_log_parse/因子耗时/因子耗时_%s_%s.xlsx' % (tradeDate, environment), sheet_name='因子耗时')
            ...
            excel_saver(excel_save_dict, '/data/group/800463/日内强势股/cpp_log_parse/模型差异/%s/JupiterZ模型差异_%s_%s.xlsx' % (tradeDatestr, tradeDatestr, environment))