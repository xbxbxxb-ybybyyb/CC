...
import numpy as np
import pandas as pd
from StrongStockModel.model.Modelmpl.DTCFactorSelection.ConvReg import ConvReg,param_cnn
...
def main(i):
    ...
    factor_num = 100
    indicator = 'union'
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/NewBaseModel/Conv_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
    ...
    if os.path.exists(base_dir + '%d.pkl' % para[1]):
        ...
        # return
    model = ConvReg(para[0], para[-1], None, feature_address=all_mkt_preprocessed_ts_norm_by_date_path, factor_eval_indicator=indicator)
    ...
    label = model.rolling_train_and_predict(params=param_cnn, period=train_period, predict_period=test_period,
