...
def main(i):
    ...
    factor_num = 100
    indicator = 'union'
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/NewBaseModel/LSTMCorrStdPara25SortList_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
...
for idx in list(range(73))[::-1]: #int(AIMR.getParam())
    main(idx)
