...
import numpy as np
import pandas as pd
from StrongStockModel.model.Modelmpl.NN_redefined_5min import NN_redefine,best_param_clf_nn
...
def main(i):
    ...
    test_period = 10
    factor_num = 300
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/NN_param_optimization/NN5min_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
    ...
    if os.path.exists(base_dir+'%d.pkl'%para[1]):
        ...
        return
    model = NN_redefine(para[0], para[-1], None)
...
# import os
# import pandas as pd
# file_list = os.listdir('/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_norm_window_compare/XGB5minNewLoading180_v2_train200_test10_factor_num400_norm_window_40_val_pred/')
# corr_series = pd.Series()
# for each in file_list:
#     corr_series[each[:-4]] = pd.read_pickle('/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_norm_window_compare/XGB5minNewLoading180_v2_train200_test10_factor_num400_norm_window_40_val_pred/'+
#                                             each).corr().values[0,1]
#
# corr_series.mean()