...
import numpy as np
import pandas as pd
from StrongStockModel.model.Modelmpl.Linear5min import LinearReg5min
import time
...
def main(i):
    ...
    N = 40
    indicator = 'ic_all_t'
    all_mkt_preprocessed_ts_norm_by_date_path = '/data/group/800319/ModelSmallFactor/'  # '/data/group/800319/junkData/StrongStock/processed_factor_all_pool_by_date/ts_norm_%d_and_binary/' % N
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/5min/FactorEval/Linear5minFactorEval_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
    ...
    if os.path.exists(base_dir + '_%d.pkl' % train_end):
        print(base_dir + '_%d.pkl' % train_end, 'exist')
        return
    best_param = {'n_jobs': -1}
    ...
    model = LinearReg5min(train_start, test_end, None, feature_address='/data/group/800319/ModelSmallFactor/', indicator=indicator)
