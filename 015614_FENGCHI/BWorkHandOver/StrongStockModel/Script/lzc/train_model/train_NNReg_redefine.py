...
import numpy as np
import pandas as pd
from StrongStockModel.model.Modelmpl.NN_redefined import NN_redefine,best_param_clf_nn
...
def main(i):
    ...
    test_period = 10
    factor_num = 400
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/NN_param_optimization/NNCorrStdAllPeriod_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
    ...
    if os.path.exists(out_file.replace('.pkl','_%d.pkl'%para[1])):
        ...
        return
    model = NN_redefine(para[0], para[-1], None, feature_address=all_mkt_preprocessed_ts_norm_by_date_path)
