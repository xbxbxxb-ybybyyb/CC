...
def main(i):
    ...
    best_param_clf_nn['model_conf_path'] =  '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/out_of_sample/NN/NNOutSample_train199_test1_factor_num400_norm_window_40_model_conf/'
    ...
    model = NN_redefine(train_end, test_end, None, feature_address=all_mkt_preprocessed_ts_norm_by_date_path)
