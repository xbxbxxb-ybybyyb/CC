...
if __name__ == "__main__":
    ...
    cost = 0.001
    N = 40
    signal_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_norm_window_compare//NN_redefineHyper04_out_sample_train%d_test%d_factor_num%d_norm_window_%d.pkl' % \
                  (train_period, test_period, factor_num, N)
    val_path = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_norm_window_compare/NN_redefine_hyper04_train%d_test%d_factor_num%d_norm_window_%d_val_pred/' % (
        200, 10, factor_num, N)
#    signal_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_ic_factor_selection/lr_train%d_test%d_factor_num%d.pkl' % (train_period, test_period, factor_num)
    ...
    signal = get_signal_by_val_pct_threshold(pct_threshold, val_path, signal_file)
