# @Time : 2020/11/29 20:07
# @Author : Zhichen Lu
# @File : LimitPortfolio_rev_240.py
...
import os
import numpy as np
from StrongStockModel.model.ModelResultLoadingTool import get_rolling_threshold_with_no_val_set,get_rolling_threshold_with_no_val_set_daily
...
#    for signal_file in ['/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOutSample/XGBFactorEval_ic_all_c_train200_test10_factor_num400_norm_window_40.pkl',
#                        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOutSample/XGBFactorEval_ic_all_t_train200_test10_factor_num400_norm_window_40.pkl',
...
#                        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOutSample/LinearFactorEval_ic_all_d_train200_test10_factor_num400_norm_window_40.pkl',
...
#                                ]:
    for signal_file in file_list_xgb:
    ...
    pd.to_pickle([signal,pred_ret],'/data/group/800319/信号存储/signal_XGB_DTC20201214.pkl')
    # 每次用上一个模型的结果做阈值
    ...
    # signal, pred_ret = get_rolling_threshold_with_no_val_set_daily(pct_threshold, signal_file, signal_file.replace('.pkl', '_val_pred/'), val_tag=0, loading_type='old')

#    signal, pred_ret = get_signal_by_val_pct_threshold_integration(pct_threshold, sp_list, fnm_list, 20160101)
#    pd.to_pickle([signal,pred_ret],'/data/user/015664/AFuckingTrigger/temp_signal.pkl')
#    return
#     signal,pred_ret = pd.read_pickle('/data/user/015664/AFuckingTrigger/temp_signal.pkl')
...
#    out_file = '/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEvalRev/XGB_union_old_SeperateEnsemble_InSample_UpHolding%d_UpBuy%d_%dbp_cost.xlsx' % (
#    max_holding, daily_max_buy, int(10000 * cost))

    out_file = '/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEvalRev/XGB_DTC20201214_SeperateEnsemble_InSample_UpHolding%d_UpBuy%d_%dbp_threshold.xlsx' % (
    max_holding, daily_max_buy, int(100 * pct_threshold))
