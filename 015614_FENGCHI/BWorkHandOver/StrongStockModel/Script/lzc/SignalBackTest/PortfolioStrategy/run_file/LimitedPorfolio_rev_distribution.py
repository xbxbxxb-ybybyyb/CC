...
def main(max_holding, daily_max_buy):
    ...
    out_file = '/data/user/015664/AFuckingTrigger/限制买入和持仓/Rev/XGBRevAnother240Ditributed_InSample_UpHolding%d_UpBuy%d_%dbp_cost.xlsx' % (max_holding, daily_max_buy,int(10000*cost))
