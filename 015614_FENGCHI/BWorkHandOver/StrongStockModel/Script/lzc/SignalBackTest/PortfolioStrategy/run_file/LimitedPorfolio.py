...
def main(max_holding, daily_max_buy):
    ...
    # NN
    file_list = ['/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEval/NNCorrStd_ic_all_t_train200_test10_factor_num400_norm_window_40.pkl',
    ...
    out_file = '/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEval/NN_DTC_SeperateEnsemble_InSample_UpHolding%d_UpBuy%d_%dbp_cost.xlsx' % (
