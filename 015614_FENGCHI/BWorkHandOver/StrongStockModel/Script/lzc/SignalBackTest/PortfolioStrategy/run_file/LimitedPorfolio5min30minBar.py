...
def main(max_holding, daily_max_buy):
    ...
    sp_list, fnm_list = [], []
    model_list = ['XGB5minFactor30minBarTNManual']
    for md in model_list:
        # signal_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/out_of_sample/XGB/XGB_train199_test1_factor_num400_norm_window_40.pkl'
        ...
        #               (train_period, test_period, factor_num, N)
        signal_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/5min/XGB5minFactor30minBarTNManual_train200_test10_factor_num312_norm_window_40.pkl'
    ...
    signal, pred_ret = get_signal_by_val_pct_threshold(pct_threshold, sp_list[0], fnm_list[0])
    ...
    helper.one_wave_run(record, kernel=24, output_path='/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEval/%sInSample_UpHolding%d_UpBuy%d_%dbp_cost_%dpct_threshold.xlsx' % ('_'.join(model_list),max_holding, daily_max_buy,int(10000*cost),int(100*pct_threshold)),
