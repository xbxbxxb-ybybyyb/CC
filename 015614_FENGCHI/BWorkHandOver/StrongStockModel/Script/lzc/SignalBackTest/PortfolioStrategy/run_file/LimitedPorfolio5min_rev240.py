...
def main(max_holding,daily_max_buy):
    ...
    cost = 0.001
    N = 40
    signal_file =  '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/5min/FactorEval/XGB5minFactorEval_ic_all_t_train200_test10_factor_num100_norm_window_40.pkl'
    ...
    # pd.to_pickle([signal, pred_ret], '/data/user/015664/AFuckingTrigger/saved_signal/XGB5minNewLoading180_v2_signal_%d_threshold.pkl'%(int(pct_threshold*100)))
    ...
    helper.one_wave_run(record, kernel=24,
                        output_path='/data/user/015664/AFuckingTrigger/限制买入和持仓/5min/XGB5minFactorEvalRev240_ic_all_t_UpHolding%d_UpBuy%d_threshold_%dpct.xlsx'%(max_holding,daily_max_buy,int(pct_threshold*100)),
