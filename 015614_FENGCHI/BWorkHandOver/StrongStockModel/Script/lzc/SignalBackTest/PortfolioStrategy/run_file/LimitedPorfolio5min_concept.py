...
def main(max_holding,daily_max_buy):
    ...
    instance = SignalBasedPortfolioLimitUp(pred_ret, 20160101, 20181231, target_point=bar_list[:-1],
    ...
    helper.one_wave_run(record, kernel=24,
                        output_path='/data/user/015664/AFuckingTrigger/限制买入和持仓/5min/XGB5minFactorEval_ic_all_t_UpHolding%d_UpBuy%d_threshold_%dpct.xlsx'%(max_holding,daily_max_buy,int(pct_threshold*100)),
