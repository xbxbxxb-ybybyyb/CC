...
from StrongStockModel.model.ModelResultLoadingTool import get_signal_by_val_pct_threshold,get_periodly_ret_distribute, get_rolling_threshold_with_no_val_set
import pandas as pd
import numpy as np
...
pd.to_pickle([signal_old,pred_ret_old],'/data/user/015664/AFuckingTrigger/temp_signal.pkl')
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEval/XGBRollingTestThreshold_SeperateEnsemble_InSample_UpHolding%d_UpBuy%d_%dbp_cost.xlsx' % (
