...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/ValDayCompare/'
all_file = f'{base_path}/不同验证集长度计算阈值.xlsx'
...
for file_name in file_list:
    clf_name = file_name.replace('XGB_DTC_OnlyVal5WithoutMax5_CS_XGB_OLS_condition_style_rank_ex20Top600_','')
    clf_name = clf_name.replace('_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20170101_end20211231VolConsider_UpBuy100_10bp_cost.xlsx','')
    clf_name = clf_name.replace('real600_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20170101_end20211231_','')
    clf_name = clf_name.replace('_VolConsider_UpBuy100_10bp_cost.xlsx','')
