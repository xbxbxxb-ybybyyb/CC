...
'XGBMultiFreq_DC_DE0':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_0.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_0.pkl',
                    ],
...
'XGBMultiFreq_DC_DE1':[
    ...
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_1.pkl',
                    ],

'XGBMultiFreq_DC_DE2':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_2.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_2.pkl',
                    ],

'XGBMultiFreq_DC_DE3':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_3.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_3.pkl',
                    ],

'XGBMultiFreq_DTC_DE0':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_0.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_0.pkl',
f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_0/round_0.pkl'
                    ],
'XGBMultiFreq_DTC_DE1':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_1.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_1.pkl',
f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_1/round_1.pkl'
                    ],

'XGBMultiFreq_DTC_DE2':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_2.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_2.pkl',
f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_2/round_2.pkl'
                    ],
'XGBMultiFreq_DTC_DE3':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_2.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_2.pkl',
f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_2/round_2.pkl'
                    ],

'XGBMultiFreq_DTC_DE1_2':[
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_d_ic_d_half_year//round_1.pkl',
    '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBMultiFreqDoubleEnsemble_train200_test10_ic_half_c_ic_c_half_year//round_1.pkl',
f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_1/round_1.pkl'
                    ]+[
...
if os.path.exists('/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/DoubleEnsemble/signal_%s_%.2f.pkl' % (tag, pct_threshold)):
    ...
    val_list = []
    for each in file_list:
        if each.count('round')==1:
            val_path = each.replace('.pkl', '/val_pred/')
        else:
            val_path = each.replace('.pkl', '_val_pred/')

        val_list.append(val_path)
    signal, pred_ret = get_signal_by_val_pct_threshold_integration(pct_threshold, val_list,
                                                                   file_list, 20160104, 'actual_label', 'new', head=73)
...
alpha_pool = pd.read_pickle(f'/data/group/800319/AlphaPool/CS_OLS_condition_style_rank_ex20_F400T488P1_future925t241h123d_uniform20t50.pkl').shift(1).loc[20160101:20181231].rank(ascending=False,axis=1)<pool_num
...
tag = tag.replace('RevTriggerFilterHolding','Exp20Top%d'%pool_num)

instance = StartWithLimitCashVolConsider(pred_ret, 20170101, 20181231,stock_pool=alpha_pool,target_point=bar_list,buy_cost=cost, sell_cost=cost,
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/DoubleEnsembleMultiFreq/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
