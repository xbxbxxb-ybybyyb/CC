...
tag = tag+'RevTriggerFilterHoldingNewVol_deal_ratio_%.1f_per_ratio_%.4f_threshold_%.2f'%(deal_ratio,per_amt_ratio,pct_threshold)
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/CheckDrawDown/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
