...
'XGBMonthly_CatMonthly_LightMonthly':[
'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/LGB_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/Cat_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_d_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_c_train200_test10_factor_num400.pkl',
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    #
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PoolCompare20210611/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
    for each in record:
...
pool_dict = {
    ...
    'F400T488P1_future930t30h135d':'CS_OLS_condition_style_rank_ex20_F400T488P1_future930t30h135d_uniform20t50.pkl',
    'stock_pool_20210611_min600':'stock_pool_20210611_min600.pkl',
    'stock_pool_20210611_min300':'stock_pool_20210611_min300.pkl'
}

# pool_tag = 'old'
each = (0.05, 0.005, 2e8, 600)
# calc_back_test_record(*(each + (0.1, 'XGB_lightGBM_CatBoost', 'CS_XGB_OLS_condition_style_rank_ex20')))
calc_back_test_record(*(each + (0.1, 'XGBMonthly_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
