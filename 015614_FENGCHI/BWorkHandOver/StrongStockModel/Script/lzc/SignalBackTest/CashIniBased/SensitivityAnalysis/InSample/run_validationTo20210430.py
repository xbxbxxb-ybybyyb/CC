...
'XGBMonthly_CatMonthly3_LightMonthly3':[
'/data/group/800319/wyl/model_record/catboosts/catboostnew3_ic_all_t.pkl',
        '/data/group/800319/wyl/model_record/lightgbm_record/lightgbmnew3_ic_all_t.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_d_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_ic_c_train200_test10_factor_num400.pkl',
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    tag = tag +  'WithoutMax5'  # +'WithMax5thresholdTo20210430' #
    ...
    #
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PoolCompare20210615/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
    for each in record:
...
calc_back_test_record(*(each + (0.1, 'XGBMonthly_CatMonthly3_LightMonthly3', 'CS_XGB_OLS_condition_style_rank_ex20')))
