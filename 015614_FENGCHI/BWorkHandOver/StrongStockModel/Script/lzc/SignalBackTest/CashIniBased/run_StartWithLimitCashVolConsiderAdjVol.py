...
from StrongStockModel.backtest.StrategyBackTest.DerivativeStrategy.StartWithLimitCashVolConsiderAdjustedVol import StartWithLimitCashVolConsider,InitailCashBasedEvaluationHelper
...
'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_d_train200_test10_factor_num400_norm_window_40_zscore.pkl',
'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_t_train200_test10_factor_num400_norm_window_40_zscore.pkl',
'/data/group/800319/wyl/model_record/catboostnew2_ic_all_t_zscore.pkl',
 '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t_zscore.pkl',
    ],
'XGB_lightGBM_CatBoost_ZSCORE':[
'/data/group/800319/wyl/model_record/catboostnew2_ic_all_t_zscore.pkl',
 '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t_zscore.pkl',
'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40_zscore.pkl',
'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_d_train200_test10_factor_num400_norm_window_40_zscore.pkl',
...
tag = tag+'RevTriggerFilterHoldingAdjVol_deal_ratio_%.1f_per_ratio_%.4f_threshold_%.2f'%(deal_ratio,per_amt_ratio,pct_threshold)
...
instance = StartWithLimitCashVolConsider(pred_ret, 20160101, 20181231,target_point=bar_list,buy_cost=cost, sell_cost=cost,
                                         ...
                                         deal_percent=deal_ratio,barly_max_buy=100)
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NoFutureInfoResShift_Senstivity/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
