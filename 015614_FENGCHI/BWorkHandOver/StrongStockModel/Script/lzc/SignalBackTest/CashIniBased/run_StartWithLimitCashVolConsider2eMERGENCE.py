...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/OnlineEraEmergencyIntegration/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
...
# import os
# import shutil
# for indicator in ['weight','gain','cover']:
#     source = f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/XGBAllFactor_train400_test10_factornum400_eval_{indicator}val_pred/'
#     target = f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/XGBAllFactor_train400_test10_factornum400_eval_{indicator}_val_pred/'
