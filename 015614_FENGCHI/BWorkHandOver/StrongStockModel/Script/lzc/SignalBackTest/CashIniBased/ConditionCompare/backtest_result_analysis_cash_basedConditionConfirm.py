...
base_path = '/data/user/015664/AFuckingTrigger/盘中终止条件前后对比/PredConsiderV4_2_1FullSample/'
# base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/UpgradeThresholdCompare_to20211130/'
all_file = f'{base_path}/前后限制条件框架对比.xlsx'
# file_list = list(filter(lambda x: x.startswith('XGB') and 'Out' not in x, os.listdir(base_path)))
file_list = sorted(list(filter(lambda x: 'XGB' in x, os.listdir(base_path))))
...
name_para = {
    ...
    'XGBWithSWM_CrossFactor_Cat_LightWithoutMax5CS':'叠加截面因子后20220324'
