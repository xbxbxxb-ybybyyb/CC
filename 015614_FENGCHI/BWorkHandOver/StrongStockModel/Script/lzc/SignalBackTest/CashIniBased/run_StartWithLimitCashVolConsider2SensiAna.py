...
initial_cash = int(AIMR.getParam())
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/OnlineEraSensitive_3PctDeal/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
