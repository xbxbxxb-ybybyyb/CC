...
tag = tag+'RevTriggerFilterHolding_deal_ratio_%.1f_per_ratio_%.4f_threshold_%f.2'%(deal_ratio,per_amt_ratio,pct_threshold)
...
record,cash_series = pd.read_pickle('/data/user/015664/AFuckingTrigger/限制买入和持仓/NoFutureInfoRes/record/%sInSample.pkl'%tag)
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NoFutureInfoRes/%sCheckCHECKVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
