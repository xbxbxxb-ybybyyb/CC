...
account_cap = []
holding_time_count = []
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindow/'
all_file = f'./非固定持仓窗口.xlsx'
...
file_list=['XGBWithSWSHIFReSaveTWithOrigin_Cat_LightCS_XGB_OLS_condition_style_rank_ex20NonFixSignal1000BaseVolConsider_UpBuy100_10bp_cost.xlsx',
 'XGB_DTC_OnlyEarlyStopVolConsider_UpBuy100_10bp_cost.xlsx',
 'XGB_DTC_Only_OldFrameWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
...
name_para = {
    'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightCS_XGB_OLS_condition_style_rank_ex20NonFixSignal1000Base': '非固定窗口触发',
    'XGB_DTC_Only_OldFrameWithoutMa':'持仓240分钟',
    'XGB_DTC_OnlyEarlyStopVolConsider_UpBuy10':'持仓240分钟+提前卖出信号',
