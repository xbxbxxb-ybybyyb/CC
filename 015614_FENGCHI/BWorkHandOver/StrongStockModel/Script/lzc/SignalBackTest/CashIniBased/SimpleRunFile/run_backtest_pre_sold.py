...
from StrongStockModel.backtest.StrategyBackTest.DerivativeStrategy.StartWithLimitCashVolConsiderPreSold import StartWithLimitCashVolConsiderPreSold, InitailCashBasedEvaluationHelper
from StrongStockModel.model.ModelResultLoadingTool import get_signal_by_val_pct_threshold_integration_NoMaxThreshold,get_pre_sold_signal_by_val_pct_threshold_integration_NoMaxThreshold
import pandas as pd
import os
...
'XGBEarly_DE_ZSCORE0':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_0/round_0.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_0/round_0.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_0/round_0.pkl',
               ],
    'XGBEarly_DE_ZSCORE1':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_1/round_1.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_1/round_1.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_1/round_1.pkl',
               ],
    'XGBEarly_DE_ZSCORE2':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_2/round_2.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_2/round_2.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_2/round_2.pkl',
               ],
    'XGBEarly_DE_ZSCORE3':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_3/round_3.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_3/round_3.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_3/round_3.pkl',
               ],    'XGBEarly_DE_ZSCORE4':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_4/round_4.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_4/round_4.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_4/round_4.pkl',
               ],    'XGBEarly_DE_ZSCORE5':[
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_5/round_5.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_5/round_5.pkl',
        f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_5/round_5.pkl',
               ],
    'XGBEarly_DE_ZSCORE0_5':[f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(6)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(6)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(6)],

'XGBEarly_DE_ZSCORE1_3':[f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(1,4)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(1,4)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(1,4)],

'XGBEarly_DE_ZSCORE1_2':[f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(1,3)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(0,3)]+\
    [f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_{i}/round_{i}.pkl' for i in range(0,3)],
...
'/data/group/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',
        '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_d_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_c_train200_test10_factor_num400.pkl',

    ],

'XGBMonthly_D':['/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_d_train200_test10_factor_num400.pkl'],
'XGBMonthly_T':['/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_t_train200_test10_factor_num400.pkl'],
'XGBMonthly_C':['/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_c_train200_test10_factor_num400.pkl'],
'CatBoost':['/data/group/800319/wyl/model_record/catboostnew2_ic_all_t.pkl'],
'lighGBM':['/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl'],
    'XGB_D_Cat_Light':[
        '/data/group/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',
        '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_d_train200_test10_factor_num400.pkl',
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    signal_file_name ='/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/signal_%s_%.2f.pkl' % (tag, pct_threshold)
    ...
    sold_signal_file_name =f'/data/user/015664/AFuckingTrigger/限制买入和持仓/卖出信号存储/sold_signal_{tag}_{pct_threshold:.2f}.pkl'

    if os.path.exists(sold_signal_file_name):
        sold_signal, _ = pd.read_pickle(sold_signal_file_name)
    else:
        sold_signal, sold_pred_ret = get_pre_sold_signal_by_val_pct_threshold_integration_NoMaxThreshold(pct_threshold,
                                                                                             [x.replace('.pkl', '_val_pred/') for x in file_list],
                                                                                             file_list, 20160104, 'actual_label', 'new', head=135)
        pd.to_pickle([sold_signal,sold_pred_ret],sold_signal_file_name)

    # pred_ret = pd.read_pickle('/data/group/800319/信号存储/20200111LinearCompareMV.pkl')
    tag = tag + f'{alpha_pool_tag}Top{pool_num}_PreSold_deal_ratio_%.1f_per_ratio_%.4f_threshold_%.2f_inital_%d' % (deal_ratio, per_amt_ratio, pct_threshold, int(initial_cash))
    ...
    record_file_name = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PreSold/record/record_%sVolConsider_UpBuy100_%dbp_cost.pkl' % (tag, int(10000 * cost))
    if not os.path.exists(record_file_name):
        instance = StartWithLimitCashVolConsiderPreSold(pred_ret,sold_signal, start, end, stock_pool=alpha_pool, target_point=bar_list, buy_cost=cost, sell_cost=cost,
        ...
        record, cash_series, holding_num = pd.read_pickle(record_file_name)
    ...
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PreSold/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
    for each in record:
...
# calc_back_test_record(*(each + (0.1, 'XGBMonthly_D', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthly_T', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthly_C', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'CatBoost', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'lighGBM', 'CS_XGB_OLS_condition_style_rank_ex20')))
calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))


# calc_back_test_record(*(each + (0.1, 'XGB_lightGBM_CatBoost', 'CS_XGB_OLS_condition_style_rank_ex20')))
