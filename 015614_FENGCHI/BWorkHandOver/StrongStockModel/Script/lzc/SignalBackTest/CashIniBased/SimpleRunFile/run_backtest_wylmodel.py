...
'CatOnly':[ '/data/group/800442/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',],
'LightOnly':[ '/data/group/800442/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl',],
'CatLight':[ '/data/group/800442/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl', '/data/group/800442/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',],
}
...
calc_back_test_record(*(each + (0.1,'CatLight', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1,'CatOnly', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1,'LightOnly', 'CS_XGB_OLS_condition_style_rank_ex20')))
