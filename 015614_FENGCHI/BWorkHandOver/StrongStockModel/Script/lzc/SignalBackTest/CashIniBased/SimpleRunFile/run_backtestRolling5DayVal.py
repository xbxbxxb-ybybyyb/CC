...
from StrongStockModel.model.ModelResultLoadingTool import get_signal_by_val_pct_threshold_long_integration_rolling5_day
import pandas as pd
...
para = {
    ...
    '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFactor2022/XGBMixByFeatureImportance_ic_d_train200_test10_factor_num200/XGBMixByFeatureImportance_ic_d_train200_test10_factor_num200'
...
wyl_list = '/data/group/800442/800319/wyl/model_record/lightgbmnew_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc1_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc5_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight20_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight100_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weightall_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight100_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight40_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight20_ic_all_t, /data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweightall_ic_all_t'
# wyl_list = wyl_list.split(', ')
['/data/group/800442/800319/wyl/model_record/lightgbmnew_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc1_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_posinc5_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight20_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weight100_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_weightall_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight100_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight40_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweight20_ic_all_t',
 '/data/group/800442/800319/wyl/model_record/lightgbm_record/lightgbmcus_opsweightall_ic_all_t']
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    tag = tag + 'Rolling5ValWithoutMax5'  # +'WithMax5threshold' #
    ...
    if os.path.exists('/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/signal_%s_%.2f.pkl' % (tag, pct_threshold)):
        ...
        #                                                                'new',
        #                                                                head=135)
        signal, pred_ret,_ = get_signal_by_val_pct_threshold_long_integration_rolling5_day(pct_threshold, [x.replace('.pkl', '_val_pred/') for x in file_list], file_list, start,
                                                                                      'actual_label',
                                                                                      'new',
                                                                                      head=None, end=end)
...
# para_list = itertools.product([0.005,0.0])

each = (0.05, 0.005, 2e8, 600)
# tag_list = ['fix因子400模型|fix200和fix矩阵200|fix200和5分钟矩阵处理200', 'fix200和5分钟矩阵处理200', 'fix因子400模型|fix200和5分钟矩阵处理200',
#             'fix因子400模型|fix200和fix矩阵200|fix200和5分钟矩阵处理200|fix因子和5分钟因子', 'fix因子400模型|fix200和5分钟矩阵处理200|fix因子和5分钟因子'
#             ]



calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '最新截面因子版本1_1', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '最新版本+截面因子1', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '最新版本+截面因子1', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '矩阵_残差_DE', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '矩阵_DE', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '矩阵因子再集成1日残差处理', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '矩阵因子1日残差处理替换', 'CS_XGB_OLS_condition_style_rank_ex20')))
#
# calc_back_test_record(*(each + (0.1, '矩阵因子再集成残差处理(重选)', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '残差处理替换时序处理(重选)', 'CS_XGB_OLS_condition_style_rank_ex20')))
#
# calc_back_test_record(*(each + (0.1, '矩阵因子再集成残差处理', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '残差处理替换时序处理', 'CS_XGB_OLS_condition_style_rank_ex20')))

# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_XGB200_auction')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'XGB_OLS_style_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'XGB_OLS_style_ex20_val_5')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_XGB200_val_5')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_T3')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_T3')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_T3')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_XGB200_20211213')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'XGB_OLS_style_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'OLS_XGB200')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4_Cat_Light_Val', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_Resave_Only', 'CS_XGB_OLS_condition_style_rank_ex20')))


# calc_back_test_record(*(each + (0.1, tag_list[0], 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_Cat_Light_GNN', 'CS_XGB_OLS_condition_style_rank_ex20')))

# calc_back_test_record(*(each + (0.1, 'XGB_D_NoEarlyStoping', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_T_NoEarlyStoping', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_C_NoEarlyStoping', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBNoEarlyStoping_lightGBM_CatBoost', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_D_HalfYear', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_T_HalfYear', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_C_HalfYear', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_OldDTC_CatLight', 'CS_XGB_OLS_condition_style_rank_ex20')))
...
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4OnlySWSHIFTMeanFixFixMIX_Cat_Light_Val', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4WithSWSHIFTMeanFixFixMIX_Cat_Light_Val', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4OnlySWSHIFTTestMeanFixFixMIX_Cat_Light_Val', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4WithSWSHIFTTestMeanFixFixMIX_Cat_Light_Val', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4_Cat_Light_FIX5minOnlyFixSWMean', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4_Cat_Light_XGBMonthlyV4_Cat_Light_FIX5minWithFixSWMean', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBOnlySWSHIFTMeanFixMIX_Cat_Light20211115', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFTMeanFixMIX_Cat_Light20211115', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFTMeanWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_lightGBM_CatBoost_XGBFix', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBFixMixWithCross1120_lightGBM_CatBoost', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB800_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBAppendCrossFactor1122_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWNoSHIFReSaveTWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWNoSHIFReSaveTOnly_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTOnly_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSW_S_M_N_T_TWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGBWithSW_S_M_N_T_ReSaveTOnly_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'Cat', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_D', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_T', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_C', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'XGB_Only', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
