...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    print(tag)
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PoolNumCompare20211112/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
...
from xquant.compute.aimr import AIMR
pool_num =  int(AIMR.getParam())
each = (0.05, 0.005, 2e8, pool_num)
