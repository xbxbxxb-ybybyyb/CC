...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    if os.path.exists(signal_file):
        ...
        #                                                                'new',
        #                                                                head=135)
        res = get_signal_by_val_pct_threshold_long_integration(pct_threshold, [x.replace('.pkl', '/')[:-1]+'_val_pred/' for x in file_list], [x.replace('.pkl', '/') for x in file_list],
                                                               start,
                                                               'actual_label',
                                                               'new',
                                                               head=None, end=end)
...
barra_para_map = {
    'BarraDistance':[
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/Barra/XGBV4_BarraDistance/XGBV4_BarraDistance_ic_d_train200_test10_factor_num400/',
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/Barra/XGBV4_BarraDistance/XGBV4_BarraDistance_ic_t_train200_test10_factor_num400/',
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/Barra/XGBV4_BarraDistance/XGBV4_BarraDistance_ic_c_train200_test10_factor_num400/',
    ]
}
...
calc_back_test_record(*(each + (0.1, 'XGB_Cat_Light_SW_With_BarraDistance', 'CS_XGB_OLS_condition_style_rank_ex20')))
