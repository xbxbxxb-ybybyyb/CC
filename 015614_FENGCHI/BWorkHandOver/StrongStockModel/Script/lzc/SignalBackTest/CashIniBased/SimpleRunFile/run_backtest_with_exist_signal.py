# @Time : 2021/7/5 14:57
# @Author : Zhichen Lu
# @File : run_backtest_with_exist_signal.py
...
para = {
    ...
    'XGBEarly_DE_ZSCORE0_5': [
                                 f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_d_train200_test10_factor400/round_{i}/round_{i}.pkl'
                                 for i in range(6)] + \
                             [
                                 f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_t_train200_test10_factor400/round_{i}/round_{i}.pkl'
                                 for i in range(6)] + \
                             [
                                 f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/ZSCORE/XGBDoubleEnsembleParamBestEarlyStop_ic_half_c_train200_test10_factor400/round_{i}/round_{i}.pkl'
                                 for i in range(6)],
    ...
    'XGB5minFixPointOldLoader_DTC_Cat_Light': [
        '/data/group/800319/junkData/StrongStock//ModelRes/XGB5minFixPoint_ic_half_d_train200_test10_factor_num400/XGB5minFixPoint_ic_half_d_train200_test10_factor_num400.pkl',
        '/data/group/800319/junkData/StrongStock//ModelRes/XGB5minFixPoint_ic_half_t_train200_test10_factor_num400/XGB5minFixPoint_ic_half_t_train200_test10_factor_num400.pkl',
        '/data/group/800319/junkData/StrongStock//ModelRes/XGB5minFixPoint_ic_half_c_train200_test10_factor_num400/XGB5minFixPoint_ic_half_c_train200_test10_factor_num400.pkl',
    ...
    # 'XGB_ic_d': pd.read_pickle('/data/group/800319/信号存储/XGB_ic_d.pkl'),
    # 'XGB_ic_t': pd.read_pickle('/data/group/800319/信号存储/XGB_ic_t.pkl'),
    # 'XGB_ic_c': pd.read_pickle('/data/group/800319/信号存储/XGB_ic_c.pkl'),
    # 'XGB_DTC_ZSCORE_125':pd.read_pickle('/data/group/800319/信号存储/XGB_DTC_ZSCORE_125.pkl'),
    # 'XGB_DTC_ZSCORE_125_sign':pd.read_pickle('/data/group/800319/信号存储/XGB_DTC_ZSCORE_125_sign.pkl'),
    # 'A2C_Signal':pd.read_pickle('/data/group/800442/800319/junkData/StrongStock/R2D2//TainingRes/A2CTest_train80_test20/all_pred_ret.pkl'),
    'CrossValXGBIndividualyIntegration':pd.read_pickle(f'/data/group/800442/800319/信号存储/CrossValXGBIndividualyIntegration.pkl')

}

# para['CrossValXGBIndividualyIntegration'][para['A2C_Signal']<0.05] = np.nan
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    if isinstance(file_list, pd.DataFrame):
        pred_ret = file_list.loc[start:end]
    elif os.path.exists('/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/signal_%s_%.2f.pkl' % (tag, pct_threshold)):
...
# calc_back_test_record(*(each + (0.1, 'XGBFixCrossVal_DTC_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
calc_back_test_record(*(each + (0.1, 'CrossValXGBIndividualyIntegration', 'CS_XGB_OLS_condition_style_rank_ex20')))
...
# path_list = ['/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/XGBMultiFreqFix5min_train200_test10_ic_d_ic_half_d/',
# '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/XGBMultiFreqFix5min_train200_test10_ic_t_ic_half_t/',
# '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/XGBMultiFreqFix5min_train200_test10_ic_c_ic_half_c/',]
# import pandas as pd
# import os
#
# for base_path in path_list:
# # base_path = '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/XGBMultiFreqFix5min_train200_test10_ic_d_ic_half_d/'
#     target_path = base_path[:-1] + 'cp/'
#     target_val_path = base_path[:-1] + 'cp_val_pred/'
...
#     for each in file_list:
#         temp = pd.read_pickle(f'{base_path}{each}').swaplevel(1,2)
#         temp_val = pd.read_pickle(f'{base_path[:-1]}_val_pred/{each}').swaplevel(1,2)
#         pd.to_pickle(temp,f'{target_path}{each}')
#         pd.to_pickle(temp_val,f'{target_val_path}{each}')
#         print(each)
