...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    if pool_dict[alpha_pool_tag] is None:
        ...
        if alpha_pool_tag.startswith('pool_mix_integrate_replace') or (alpha_pool_tag in ['HumanAmendPoolRaw','HumanAmendPoolPlan1','HumanAmendPoolPlan2']):
            print('----------------bool pool----------------------------')
            alpha_pool = pd.read_pickle(f'/data/group/800442/800319/AlphaPool/{pool_dict[alpha_pool_tag]}').shift(1).loc[start:end].astype(bool)#.rank(ascending=False, axis=1) < pool_num
        else:
    ...
    tag = tag + f'{alpha_pool_tag}Top{pool_num}_real{pool_num}'
    tag = tag+f'start{start}_end{end}'
    print(tag)
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/IndustryPoolCompare/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
...
'Im_all_Fq600T488P1_future930t30h135d_uniform20t50',
 'Ir_condition_style_rank_ex20_Fh600T488P1_future930t30h135d_uniform20t50',
 'Im_all_Fq600T488P1_future930t30h135d_uniform10t30',
 'Ir_all_Fq600T488P1_future930t30h135d_uniform20t50',
 'N_all_Fh600T488P1_future930t30h135d_uniform10t30',
 'N_condition_style_rank_ex20_Fh600T488P1_future930t30h135d_uniform10t30',
 'N_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform10t30',
 'N_condition_style_rank_ex20_Fh600T488P1_future930t30h135d_uniform20t50',
 'Ir_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform20t50',
 'N_all_Fh600T488P1_future930t30h135d_uniform20t50',
 'N_all_Fq600T488P1_future930t30h135d_uniform10t30',
 'N_all_Fq600T488P1_future930t30h135d_uniform20t50',
 'Im_all_Fh600T488P1_future930t30h135d_uniform20t50',
 'Im_all_Fh600T488P1_future930t30h135d_uniform10t30',
 'Ir_all_Fq600T488P1_future930t30h135d_uniform10t30',
 'Ir_all_Fh600T488P1_future930t30h135d_uniform20t50',
 'Ir_all_Fh600T488P1_future930t30h135d_uniform10t30',
 'N_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform20t50_corr9',
 'N_style_Fq600T488P1_future930t30h123d_uniform20t50',
 'Ir_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform20t50_corr9',
 'Ir_condition_style_rank_ex20_Fq600T488P1_future930t30h123d_uniform20t50',
 'Ir_condition_style_rank_ex20_Fq400T488P1_future930t30h135d_uniform20t50',
 'Ir_condition_style_rank_ex20_Fq800T488P1_future930t30h135d_uniform20t50',
 'N_style_Fq800T488P1_future930t30h135d_uniform20t50',
 'N_style_Fq400T488P1_future930t30h135d_uniform20t50',
 'N_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform20t50',
'Im_OLS_XGB_style_future135uniform20t50',
'pool_droptail_mix_integrateconstant10',
    'pool_head_first_mix_integrateconstant10',
    'pool_head_first_and_drop_tail_mix_integrateconstant10',
    'pool_mix_integrate_plus_origin',
    'pool_mix_integrate_replace100','pool_mix_integrate_replace200',
    'pool_mix_integrate_replace200',
    'HumanAmendPoolRaw','HumanAmendPoolPlan1','HumanAmendPoolPlan2','WithoutUnderAuction20211123','OLSf135style'
]})
...
pool_tag =  'OLSf135style'#AIMR.getParam()
calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4_Cat_Light',pool_tag)))
# calc_back_test_record(*(each + (0.1, 'XGBMonthlyV4WithSWMeanFixFixMIX_Cat_Light_Val',pool_tag)))
