...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag,
    ...
    tag = f'{tag}_PredCosiV3_deal{deal_ratio:.2f}_per{per_amt_ratio * 1000}bp_thre{int(pct_threshold * 100)}_cash{initial_cash:.0e}_Top600_start{start}_end{end}_' \
...
if __name__ == '__main__':
    ...
    d_threshold,s_ratio,sw_thre = (0.7,0.1,0.005)#eval(AIMR.getParam())#(0.2,1)
    import datetime
