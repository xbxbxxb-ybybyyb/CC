...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    out_path = f'/data/user/015664/AFuckingTrigger/限制买入和持仓/股票池集中度寻优/{file_name}.xlsx'
...
para_list = list(itertools.product([0.005,0.01,0.015],[200,600]))
per_signal_ratio,pool_num = eval(AIMR.getParam())

each = (0.05, per_signal_ratio, 2e8, pool_num)
