...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    tag = tag + 'WithMax5'  # +'WithMax5threshold' #
    ...
    if os.path.exists('/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/signal_%s_%.2f.pkl' % (tag, pct_threshold)):
        ...
        #                                                                'new',
        #                                                                head=135)
        signal, pred_ret = get_signal_by_val_pct_threshold_integration(pct_threshold, [x.replace('.pkl', '_val_pred/') for x in file_list], file_list, start,
                                                                                      'actual_label',
                                                                                      'new',
                                                                                      head=None, end=end)
...
'Im_all_Fq600T488P1_future930t30h135d_uniform20t50',
 ...
 'N_condition_style_rank_ex20_Fq600T488P1_future930t30h135d_uniform20t50',
    'Im_OLS_XGB_style_future135uniform20t50','HumanAmendPoolRaw','HumanAmendPoolPlan1','HumanAmendPoolPlan2'
