...
# base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PredConsiderPrameterSeeking/'
all_file = './V4_2_1单笔1.5%_原参数寻优.xlsx'
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PredConsiderV4_2_1PoolSeekingReParamSeeking/'
...
sensi_eval_res['down_signal_ratio_threshold'] = sensi_eval_res['模型'].apply(lambda x: x.strip('s_thre').split('_d_thre')[1][:4])
sensi_eval_res['swing_threshold'] = sensi_eval_res['模型'].apply(lambda x: x.strip('s_thre').split('_swing')[1])
...
sensi_eval_res_signal['down_signal_ratio_threshold'] = sensi_eval_res_signal['模型'].apply(lambda x: x.strip('s_thre').split('_d_thre')[1][:4])
sensi_eval_res_signal['swing_threshold'] = sensi_eval_res_signal['模型'].apply(lambda x: x.strip('s_thre').split('_swing')[1])
