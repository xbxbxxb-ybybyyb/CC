...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/实盘回测线下跟踪查验20210528/'
# file_list = list(filter(lambda x: x.startswith('XGB') and 'Out' not in x, os.listdir(base_path)))
file_list = list(filter(lambda x: x.startswith('XGB'), os.listdir(base_path)))
sorted(file_list)

file_list = [
 'XGBMonthly_Cat_Light_OnlineTestWithMax5pctOutSampleRevTriggerFilterHolding_AlphaTriggerPoolTop600_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210602_validation.xlsx',
 'XGBMonthly_Cat_Light_OnlineTestWithoutMax5pctOutSampleRevTriggerFilterHolding_AlphaTriggerPoolTop600_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210602_validation.xlsx',
 'XGB_Cat_Light_OnlineTestOutSampleRevTriggerFilterHolding_AlphaTriggerPoolTop600_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210527_validation.xlsx',
 'XGB_Cat_Light_OnlineTestWithoutMax5pctOutSampleRevTriggerFilterHolding_AlphaTriggerPoolTop600_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210602_validation.xlsx',
]
...
all_file = f'{base_path}/不同选因子对比202104.xlsx'
