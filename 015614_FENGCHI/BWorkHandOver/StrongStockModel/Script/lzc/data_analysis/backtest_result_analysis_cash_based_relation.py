...
for file_name in file_list:
    ...
    clf_name = file_name.replace('XGBMonthlyV4_Cat_LightWithoutMax5', '').replace('Top600_real600start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx', '')
...
all_file = f'{base_path}/不同股票池对比20211020.xlsx'
