...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PredConsiderV5PrameterSeekingOutSample/'
...
all_file = './考虑行情和信号量寻优V5OutSample.xlsx'  # f'{base_path}/不同股票池_不同信号版本_不限制预测值千5_20211108.xlsx'
