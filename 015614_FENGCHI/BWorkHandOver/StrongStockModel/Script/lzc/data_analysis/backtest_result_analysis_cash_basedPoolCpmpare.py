...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/实盘回测线下跟踪_股票池之间对比2/'
...
for file_name in file_list:
    clf_name = file_name.replace('XGB_Cat_Light_SWMatrix_OnlineTest','').replace('_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20211215.xlsx','')
...
all_file = f'{base_path}/股票池对比20220113union.xlsx'
