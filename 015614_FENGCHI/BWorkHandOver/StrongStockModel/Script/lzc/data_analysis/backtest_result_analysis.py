...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/FactorEvalRev/'
file_list = sorted(os.listdir(base_path))
file_list = list(filter(lambda x: 'union_ic_all_t' in x and '5bp' in x, file_list))
file_list = [
    'XGB_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThreshold_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow5_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow10_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow20_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow30_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow60_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx',
    'XGBRollingThresholdDailyWindow120_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100_5bp_threshold.xlsx']
...
for file_name in file_list:
    clf_name = file_name.replace('_union_ic_all_t_SeperateEnsemble_InSample_UpHolding300_UpBuy100', ''). \
        replace('bp', 'pct').replace('.xlsx', '').replace('RollingThresholdDailyWindow', '每天用过去固定时间窗口计算阈值').replace('RollingThreshold', '每次用前一期模型预测值计算阈值')
    clf_name = clf_name.replace('10_5pct', '010_5pct').replace('5_5pct', '005_5pct').replace('值20_5pct', '值020_5pct').replace('30_5pct', '030_5pct').replace('60_5pct', '060_5pct')
...
with pd.ExcelWriter('/data/user/015664/AFuckingTrigger/不同触发阈值计算窗口对比.xlsx') as writer:
