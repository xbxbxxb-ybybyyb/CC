...
class MRFixFactorTest(object):
    ...
    def set_recent_pct_change(self, future_days=1, delay_min=1, order_keep_min=30):
        ...
        future2[~ future_finite] = 0
        # return  future
        self.recent_pct_change = future
        self.recent_pct_change2 = future2
        self.recent_pct_change_finite = future_finite
        self.nolimit = nolimit
    ...
    def test_factor(self, factor, standardize_days=40,reg_days=40, move_window=12,test_return=False,
        ...
        def roll_sum(arr, axis=0, keep_axis=()):
            ...
            arr1 = reduce_sum(arr.astype(int), axis=axis, keep_axis=keep_axis)
            keep_axis = (keep_axis,) if isinstance(keep_axis, int) else keep_axis
            axis = np.searchsorted(keep_axis, axis)
...
if __name__ == '__main__':
    ...
    today = 20141231#20211220#get_recent_trade_date()
    self = MRFixFactorTest(20140601, 20140801, today)
    self.set_stock_pool()
    self.set_recent_pct_change()
    self.set_future()

    save_address = '/data/group/800442/800319/HFfactor/RealTimeFixRollRobustReversalResRct1DayTest/data/'
    result_address = f'/data/group/800442/800319/HFfactor/RealTimeFixRollRobustReversalResRct1DayTest/ic_month/'
