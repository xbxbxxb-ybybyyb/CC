...
if __name__ == '__main__':
    ...
    today = get_pre_trade_date(20140801,-50)#get_recent_trade_date()
    self = MRFixFactorTest(20140601, 20140801, 20141229)
    self.set_stock_pool()
    real_future = self.set_future_old()
    recent_pct = self.set_future()

    # factor_address = '/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/'
    # result_address = f'/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/ic_reversal/'
