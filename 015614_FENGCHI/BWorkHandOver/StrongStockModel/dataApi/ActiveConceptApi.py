...
def get_daily_active_concept(start_date=20200101, end_date=20201201,
                             read_path='/data/group/800319/fengchi/interface/active_concept_data/daily_active_concept.h5'):
    date_list = getData.get_date_range(start_date, end_date)
    start_date = date_list[0]
    end_date = date_list[-1]
...
def get_daily_active_stock(start_date=20150601, end_date=20201201,
                           read_path='/data/group/800319/fengchi/interface/active_concept_data/daily_active_stock.pkl'):
    date_list = getData.get_date_range(start_date, end_date)
    start_date = date_list[0]
    end_date = date_list[-1]
...
#     daily_active_concept = get_daily_active_concept(20200501, 20201201)
#     daily_stock = get_daily_active_stock(20200101, 20201201)
#     pass
#