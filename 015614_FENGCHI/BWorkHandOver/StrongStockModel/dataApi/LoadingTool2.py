...
code_list = np.load('/data/group/800442/800319/AAcross/basic/code_list.npy').tolist()
date_list = get_date_range(20140701,20210531)
fix_idx = [trade_minutes.index(x) for x in fix_minutes]


def trans_df2arr(df, start_date=None, end_date=None, code_list=None, freq=7, roll=False):
    address = '/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/'
...
def transform(each,out_path='/data/group/800442/800319/HFfactor/CrossFactor2/data/'):
