...
def main_window_search(i, indicator,future_bar_num,label_path,drop,score_type):
    ...
    out_file =f'/data/group/800442/800319/IntraExp/MDDPeriodFactorInfluence/DropByFIRetrain_{score_type}_v2/Future_{future_bar_num}_bar/{target_file}/{target_file}.pkl'
