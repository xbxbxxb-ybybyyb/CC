...
class StartWithLimitCashVolConsider(PortfolioStrategyBase):
    def __init__(self, signal, start=20140101, end=20181231, stock_pool=None, target_point=None,
                 ...
                 deal_percent=0.1, stk_min_amt=None, down_signal_ratio=0.3, signal_threshold=0.3):
    ...
    def bar_handler(self):
        ...
        if down_signal_ratio>self.down_signal_ratio and len(pool_signal)>self.signal_threshold*len(self.today_pool):
            signal = pd.Series()
