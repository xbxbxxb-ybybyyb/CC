...
class StartWithLimitCashVolConsider(PortfolioStrategyBase):
    def __init__(self, signal, start=20140101, end=20181231, stock_pool=None, target_point=None,
                 ...
                 deal_percent=0.1, stk_min_amt=None, index_pct_change=0.3, signal_threshold=0.3):
    ...
    def bar_handler(self):
        ...
        if down_signal_ratio<self.index_pct_change and eval_all_day_signal_count>self.signal_threshold:
            signal = pd.Series()
