...
class StartWithLimitCashVolConsider(PortfolioStrategyBase):
    def __init__(self, signal, start=20140101, end=20181231, stock_pool=None, target_point=None,
        ...
        close_badj = get_daily_1factor('close_badj',code_list=self.stk_list)
        self.daily_info['pre_close'] = self.daily_info['close'] * close_badj.shift(1).loc[self.daily_info['close'].index] / self.daily_info['close_badj']
        # from dataApi.tradeDate import get_pre_trade_date
        # first_date_close_badj.loc[[get_pre_trade_date(self.daily_info['close'].index[0]),self.daily_info['close'].index[0]]]
    ...
    def bar_handler(self):
        ...
        down_signal_condition = down_signal_ratio>self.down_signal_ratio
        ...
        if down_signal_condition and signal_condition:
        ...
        self.barly_condition_indicator[(date, time_point)] = {
                                                                 ...
                                                                 'bar_down_trigger_signal': len(down_signal),
                                                                ...
                                                                'bar_down_trigger_signal2': len(down_signal.intersection(self.today_pool2)),
                                                                 ...
                                                                 'terminal_flag':down_signal_condition and signal_condition,
        }
    ...
    def run_backtest(self, kernel=10):
        ...
        for date_idx, date in enumerate(bar):
            ...
            for time_idx, time_point in enumerate(self.trading_point):
                ...
                self.bar_actual_future_vol = self.data_flow['actual_future_vol'][time_idx:time_idx + 1].T[(date, time_point)] * 0.1#self.deal_percent
