...
class StartWithLimitCashVolConsider(PortfolioStrategyBase):
    def __init__(self, signal, start=20140101, end=20181231, stock_pool=None, target_point=None,
                 buy_cost=0.001, sell_cost=0.001, per_amt_ratio=0.0025, append_param={}, initial_cash=200000000, barly_max_buy=100, deal_percent=0.1):
        ...
        self.past_5day_rolling_30min_vol = pd.read_pickle(deal_price_path + 'vol_rolling_30_sum_5day_mean.pkl')
        ...
        self.cumsum_30min_vol = pd.read_pickle(deal_price_path + 'vol_rolling_30_sum.pkl').reindex(self.close.index)
    ...
    def daily_update(self, idx, date):
        ...
        self.data_flow['cum_30min_vol'] = self.cumsum_30min_vol[self.date_idx * self.step:(self.date_idx + 1) * self.step]
        self.data_flow['past_5day_cum_30min_vol'] = self.past_5day_rolling_30min_vol
        #不在股票池里的股票
