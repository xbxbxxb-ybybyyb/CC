...
# @Author : Zhichen Lu
# @File : LimitHoldingAndBarTriggerWith240MoreHolding.py

from backtest.StrategyBackTest.PortfolioStrategyBase import PortfolioStrategyBase, EvaluationHelper

class LimitHoldingAndBarTriggerWith240MoreHolding(PortfolioStrategyBase):
    ...
    def bar_handler(self):
        ...
        if holding_num >= self.max_holding_num:
            return
        trigget_num = min(len(trigger_stk), self.barly_max_buy_num)
