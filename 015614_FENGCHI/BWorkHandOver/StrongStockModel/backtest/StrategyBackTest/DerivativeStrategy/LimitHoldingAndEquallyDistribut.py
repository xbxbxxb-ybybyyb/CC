...
# @Author : Zhichen Lu
# @File : LimitHoldingAndEquallyDistribut.py

from backtest.StrategyBackTest.PortfolioStrategyBase import PortfolioStrategyBase, EvaluationHelper

class LimitHoldingAndEquallyDistribut(PortfolioStrategyBase):
    ...
    def bar_handler(self):
        ...
        if holding_num >= self.max_holding_num:
            return
        trigget_num = min(len(trigger_stk),self.max_holding_num//len(self.trading_point))
