...
class XGBRegressionFactorEvalYearly(ModelNonFixWindow):
    ...
    def train_model(self, X_train, y_train, params, end_date=None):
        ...
        if os.path.exists(params['idx_path']+f'{end_date}.pkl'):
            ...
            train_idx,val_idx = get_gaussian_dataset(y_train['actual_label'],0.05,self.clip_range)
        ...
        if 'val_pred_path' in params:
            ...
            val_features, val_labels = X_train.iloc[val_idx], y_train.iloc[val_idx]
...
def main_window_search(i, indicator,future_bar_num,label_path,clip_range):
    ...
    out_file =f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExp/Future_{future_bar_num}_bar/clip{clip_range}/{target_file}/{target_file}.pkl'
