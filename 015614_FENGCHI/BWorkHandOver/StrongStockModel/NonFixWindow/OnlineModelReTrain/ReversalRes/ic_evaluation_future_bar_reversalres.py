...
def future_bar_eval(bar_num):
    out_path = f'{root_path}external_data/PreMinutes__FutureBarBy30Min_8barReversalRes/Future_{bar_num}_bar/'
    eval_path =  f'/data/group/800442/800319/HFfactor/PreMinutes__RealTimeFixRollRobustReversalResRct1Day8Bar//ic_month/Future_{bar_num}_bar/'
...
for b_num in tqdm(list(range(1,9))):
