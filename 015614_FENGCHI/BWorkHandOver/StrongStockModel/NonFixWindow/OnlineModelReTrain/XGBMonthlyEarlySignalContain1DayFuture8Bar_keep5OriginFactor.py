...
for i in range(150,152):
    for f_bar in tqdm(list(range(1, 9))):
        for ind_name in ['ic_d','ic_t','ic_c']:
            main_window_search(i, ind_name,f_bar,label_path='/data/group/800442/800319/HFfactor/ForDerivativeLabel8Bar_keep5_append/data/')
            gc.collect()

send_message(['015664'],'XGB for sim done')
