...
def main_window_search(i, indicator,future_bar_num,label_path):
    ...
    out_file =f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/NonFix8BarWith930Use5Mins_707/Future_{future_bar_num}_bar/{target_file}/{target_file}.pkl'
...
for i in tqdm(range(21,len(para_list)-5)):
