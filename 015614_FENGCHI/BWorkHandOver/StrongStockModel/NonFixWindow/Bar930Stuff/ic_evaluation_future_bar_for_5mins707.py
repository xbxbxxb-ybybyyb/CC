...
def future_bar_eval(bar_num):
    out_path = f'{root_path}external_data/FutureBarBy30Min_8barFor5mins930_707/Future_{bar_num}_bar/'
    eval_path = f'/data/group/800442/800319/NonFixHFfactor5Mins707ValRun/RealTimeFixRollRobust/ic_future_{bar_num}_bar_8bar/'
