...
if __name__ == '__main__':
    ...
    def get_fix_factor_list(factor_address='/arch1/group/800442/800319/HFfactor/DTC2021/data/'):
    ...
    def load_5min_factor_df(factor_name, start, end, add='/arch1/group/800442/800319/HFfactor/DTC2021/data/'):
        ...
        X, y, nolimit, idx_date, idx_code, idx_time = load_fix_data(get_pre_trade_date(start), end, factor_list=[factor_name], freq=48, address=add)
        nolimit[:] = True
        y[~np.isfinite(y)] = 0
    ...
    factor_address = '/arch1/group/800442/800319/HFfactor/DTC2021/data/'
    result_address = f'/data/group/800442/800319/NonFixHFfactor/RealTimeFixRollRobust/ic_future_{bar_num}_bar_8bar/'
