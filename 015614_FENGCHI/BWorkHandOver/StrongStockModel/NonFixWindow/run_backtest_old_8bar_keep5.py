...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    tag = tag + 'WithoutMax5Keep5'  # +'WithMax5threshold' #
    ...
    signal, pred_ret = pd.read_pickle(f'/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/long_nonfix_window_8bar_5keep/signal_long_XGB_DTC_Matrix_Light_Cat_Future_8_Bar_pct_0.05.pkl' )[:2]
...
calc_back_test_record(*(each + (0.1,'XGB_DTC_Matrix_Light_Cat8Bar_Only_OldFrame', 'CS_XGB_OLS_condition_style_rank_ex20')))
