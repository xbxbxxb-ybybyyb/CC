...
# future_bar = int(AIMR.getParam()) # TODO:这里是我注释的，为了调试
future_bar = 1  # 取值为[1,2,3,4,5,6,7,8]

today = get_recent_trade_date()
print(today)
latest_day = get_pre_trade_date(today)
save_bar_future(20140801,latest_day,f_bar=future_bar,
                out_path='/data/group/800442/800319/HFfactor/ForDerivativeLabel8Bar_keep5/data/',order_keep_min=5)
send_message(['015614', '015664'], 'IntradayLabel_Bar8更新成功')
