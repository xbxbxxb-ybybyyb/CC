...
all_file = './V6_2_2_8WindowV2_NonFix_原参数寻优.xlsx'
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowConditionV6_2_3_8WindowSignalRev20220406/'
...
sensi_eval_res['signal_threshold'] = sensi_eval_res['模型'].apply(lambda x: x.split('_')[0])
sensi_eval_res['down_signal_ratio_threshold'] = sensi_eval_res['模型'].apply(lambda x: x.split('_')[1])
...
sensi_eval_res_signal['signal_threshold'] = sensi_eval_res_signal['模型'].apply(lambda x: x.split('_')[0])
sensi_eval_res_signal['down_signal_ratio_threshold'] = sensi_eval_res_signal['模型'].apply(lambda x: x.split('_')[1])
