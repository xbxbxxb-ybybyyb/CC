...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    if True:#not os.path.exists(f'/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindow/record_{file_name}.pkl'):
        ...
        # pd.to_pickle([record,cash_series,holding_num],f'/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowTo2111/record_{file_name}.pkl')
    else:
        print('record exist')
    ...
    out_path = f'/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowTo2111Validation/{file_name}.xlsx'
    for each in record:
