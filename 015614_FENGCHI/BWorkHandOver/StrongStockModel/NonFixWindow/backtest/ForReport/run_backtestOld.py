...
'XGBWithSWM_CrossFactor_Cat_Light': [
        '/data/group/800442/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',
        '/data/group/800442/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl',
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBV4FactorListMixCrossSWMeanOnlyShiftReSave20211122/XGBV4FactorListMixCrossSWMeanOnlyShiftReSave20211122_ic_d_train200_test10_factor_num400.pkl',
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBV4FactorListMixCrossSWMeanOnlyShiftReSave20211122/XGBV4FactorListMixCrossSWMeanOnlyShiftReSave20211122_ic_t_train200_test10_factor_num400.pkl',
        ...
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_t_train200_test10_factor_num400.pkl',
        '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_c_train200_test10_factor_num400.pkl',
    '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFactor20220323/XGBAppendCross_ic_d_train200_test10_factor_num200/XGBAppendCross_ic_d_train200_test10_factor_num200.pkl',
    '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFactor20220323/XGBAppendCross_ic_t_train200_test10_factor_num200/XGBAppendCross_ic_t_train200_test10_factor_num200.pkl',
    '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFactor20220323/XGBAppendCross_ic_c_train200_test10_factor_num200/XGBAppendCross_ic_c_train200_test10_factor_num200.pkl',
...
# for pool_tag in ['ALL','HS300', 'ZZ500', 'ZZ1000', 'SZ50']:
#     pool_dict[pool_tag] = clean_stock_list(stock_list=pool_tag, no_ST=True, least_live_days=240,
#                                   no_pause=True, least_recover_days=1,
#                                   no_pause_limit=0.5, no_pause_stats_days=120,
#                                   no_limit_up=False, no_limit_down=False,
#                                   other_limit=None, start_date=get_pre_trade_date(20170101), end_date=20210531)
#     calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', pool_tag)))
#     gc.collect()

calc_back_test_record(*(each + (0.1, 'XGBWithSWM_CrossFactor_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))

# calc_back_test_record(*(each + (0.1, 'XGBWithSWSHIFReSaveTWithOrigin_Cat_Light', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1,'XGBAndMatrix', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1,'XGB_DTC_Only', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1,'当前线上版本20220126+截面因子1', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, '最新截面因子版本1_2', 'CS_XGB_OLS_condition_style_rank_ex20')))
# calc_back_test_record(*(each + (0.1, 'SW矩阵+MidCap', 'CS_XGB_OLS_condition_style_rank_ex20')))
