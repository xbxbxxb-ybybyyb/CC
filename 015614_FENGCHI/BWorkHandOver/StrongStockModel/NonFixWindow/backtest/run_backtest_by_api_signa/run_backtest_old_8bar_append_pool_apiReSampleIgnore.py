...
sys.path.extend(
    ['/data/user/015664/TriggeredTrading', '/data/user/015664/TriggeredTrading/FeatureEngineering', '/data/user/015664/TriggeredTrading/ensemblemonitor-strategy-python',
     ...
     '/data/user/015664/TriggeredTrading/AWorkHandOver', '/data/user/015664/TriggeredTrading/AWorkHandOver/alphaResearch/dataUpdate',
     '/data/user/015664/TriggeredTrading/AWorkHandOver/Other/code', '/data/user/015664/TriggeredTrading'])
import numpy as np
...
signal_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFix信号存储ReSample2019IgnoreValSet/'
base_model_param = {
    f'XGB_{tag}_{c_range}': {x:
        [
            f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExpIgnoreValSet/Future_8_bar/clip{c_range}/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/',
        ] for x in range(8, 9)
    } for tag in ['d', 't', 'c'] for c_range in [2, 3, 4, 5]
}
base_model_param.update({
    f'XGB_dtc_{c_range}': {x:
        [
            f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExpIgnoreValSet/Future_8_bar/clip{c_range}/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/'
            for tag in ['d', 't', 'c']
        ] for x in range(8, 9)
    } for c_range in [2, 3, 4, 5]
})
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, FIX_tag, TAG_930, alpha_pool_tag):
    ...
    base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/训练集ReSampleIgnoreValSet/'
...
['XGB_d_2', 'XGB_d_3', 'XGB_d_4', 'XGB_d_5', 'XGB_t_2', 'XGB_t_3', 'XGB_t_4', 'XGB_t_5',
 'XGB_c_2', 'XGB_c_3', 'XGB_c_4', 'XGB_c_5', 'XGB_dtc_2', 'XGB_dtc_3', 'XGB_dtc_4', 'XGB_dtc_5', 'XGB_d', 'XGB_t', 'XGB_c', 'XGB_dtc']
['XGB_dt_2', 'XGB_dt_3', 'XGB_dt_4', 'XGB_dt_5','XGB_dt']
import argparse
...
# [
#     '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExp/Future_8_bar/clip2.5/XGBV4ReversalResReselect_ic_d_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_d_train200_test10_factor_num400/',
#     '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExp/Future_8_bar/clip2.5/XGBV4ReversalResReselect_ic_t_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_t_train200_test10_factor_num400/',
#     '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExp/Future_8_bar/clip2.5/XGBV4ReversalResReselect_ic_c_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_c_train200_test10_factor_num400/']
