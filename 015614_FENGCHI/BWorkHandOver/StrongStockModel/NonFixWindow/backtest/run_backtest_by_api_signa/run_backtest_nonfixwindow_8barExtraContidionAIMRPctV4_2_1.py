...
def calc_back_test_record(pct,per_amt_ratio, initial_cash, pool_num, deal_ratio, model_tag, alpha_pool_tag,down_signal_ratio,signal_threshold,down_definition,STAGE):
    ...
    base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowConditionPctV4_2_1/'
...
if get_forbidden_tag():
    ...
    d_signal_ratio,s_threshold,d_definition,pct_thre,stage = para_list_stage1[5]#eval(aimr_multitimes.getParam())#0.15,0.5,0,0
