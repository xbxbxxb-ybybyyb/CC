...
signal_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFix信号存储ReSample2019/'
base_model_param = {
    f'XGB_{tag}_{c_range}': {x:
        [
            f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/ReSampleExp/Future_8_bar/clip{c_range}/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/XGBV4ReversalResReselect_ic_{tag}_train200_test10_factor_num400/',
        ] for x in range(8, 9)
    } for tag in ['d', 't', 'c'] for c_range in [2.5, 3, 4, 5]
}
...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, FIX_tag, TAG_930, alpha_pool_tag):
    ...
    base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/训练集ReSample/'
...
['XGB_d_2.5', 'XGB_d_3', 'XGB_d_4', 'XGB_d_5', 'XGB_t_2.5', 'XGB_t_3', 'XGB_t_4', 'XGB_t_5', 'XGB_c_2.5', 'XGB_c_3', 'XGB_c_4', 'XGB_c_5', 'XGB_dtc_2.5', 'XGB_dtc_3', 'XGB_dtc_4',
 'XGB_dtc_5', 'XGB_d', 'XGB_t', 'XGB_c', 'XGB_dtc']
import argparse
