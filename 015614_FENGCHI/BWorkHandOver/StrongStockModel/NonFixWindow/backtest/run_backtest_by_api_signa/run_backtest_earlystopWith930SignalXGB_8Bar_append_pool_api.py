...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, FIX_tag, TAG_930, alpha_pool_tag):
    ...
    # pred_ret = generate_long_signal(pct_threshold, {8:base_model_param[tag][8]}, start, end, f'{signal_path}/{tag}/long/')[8]
    # inter_signal = generate_short_signal(0, base_model_param[tag], start, end, f'{signal_path}/{tag}/short/')
    ...
    file_name = '%s_EarlyStopFixWith930_%dbp_cost' % (final_tag, int(10000 * cost))
