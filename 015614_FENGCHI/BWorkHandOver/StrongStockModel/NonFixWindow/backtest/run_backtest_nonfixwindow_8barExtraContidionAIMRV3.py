...
condition = {
    ...
    'V3_2_1':'(bar_trigger_signal>(0.15*pool_num*bar_future_window_signal_ratio))and (bar_down_trigger_signal/bar_trigger_signal)>0.5',
...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag,down_signal_ratio,signal_threshold,down_definition,STAGE):
    ...
    condition_series = {
        get_pre_trade_date(start): f'(bar_trigger_signal>({signal_threshold}*pool_num*bar_future_window_signal_ratio))and (bar_down_trigger_signal/bar_trigger_signal)>{down_signal_ratio}'
    ...
    base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowConditionV3/'
