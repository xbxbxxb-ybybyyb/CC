...
# 'V6_2_2':f'(bar_trigger_signal>({signal_threshold}*pool_num*bar_future_window_signal_ratio)) and ((SZZZ/SZZZ_MA5 -1)<-0.008 or SZZZ_MA5_to_MA10<0)'
}
...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag,signal_threshold,down_definition,STAGE):
    ...
    condition_series = {
        get_pre_trade_date(start): f'(bar_trigger_signal>({signal_threshold}*pool_num*bar_future_window_signal_ratio)) and '
    ...
    base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/NonFixWindowConditionV6_2_2/'
...
# d_definition, s_threshold = para_list[20]  # eval(aimr_multitimes.getParam())#0.15,0.5,0,0
# calc_back_test_record(0.005, 2e8, 600, 0.1, 'XGB_DTC_Matrix_Light_CatNonFixWindow', 'CS_XGB_OLS_condition_style_rank_ex20',
#                       s_threshold, d_definition, 0)
# calc_back_test_record(0.005, 2e8, 600, 0.1, 'XGB_DTC_Matrix_Light_CatNonFixWindow', 'CS_XGB_OLS_condition_style_rank_ex20',
#                       s_threshold, d_definition, 1)
