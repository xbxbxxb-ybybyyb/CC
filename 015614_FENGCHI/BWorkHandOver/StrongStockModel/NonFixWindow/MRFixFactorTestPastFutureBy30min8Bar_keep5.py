...
if __name__ == '__main__':
    ...
    today = 20220412#20211231#get_pre_trade_date(20140801,-50)#get_recent_trade_date()
    self = MRFixFactorTest(20140601, 20140801, today)
    self.set_stock_pool()
    self.set_future_by_30min(future_bar=bar_num,order_keep_min=30)
    factor_address = '/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/'
    result_address = f'/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/ic_future_{bar_num}_bar_8bar/'
