...
def main_window_search(i, indicator,future_bar_num):
    ...
    out_file =f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelectedMDDImproveV8BarWith1DayLabel_20220211/Future_{future_bar_num}_bar/{target_file}/{target_file}.pkl'
    ...
    model = XGBRegressionFactorEvalYearly(train_start, test_end, None, feature_address='/data/group/800442/800319/HFfactor/RealTimeFixRollRobustReversalRes/data/',
                                          ...
                                          factor_num=factor_num,label_path='/data/group/800442/800319/HFfactor/ForDerivativeLabel8Bar/data/',future_bar_num=future_bar_num)
