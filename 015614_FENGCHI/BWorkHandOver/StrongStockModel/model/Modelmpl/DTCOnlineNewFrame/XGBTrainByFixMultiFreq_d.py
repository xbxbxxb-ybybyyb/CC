...
daily_eval_indicator = 'ic_d_fix_quater'
frq = 'quater'
...
while len(os.listdir('/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/TrainModelByFix/XGBAllFactor_train400_test10_factornum400_eval_ic_c_fix_freq_month//1430/'))<73:
    print('not yet %d'%len(os.listdir('/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/TrainModelByFix/XGBAllFactor_train400_test10_factornum400_eval_ic_c_fix_freq_month//1430/')))
    time.sleep(60)
    continue
