...
def fit_model(i, output_path, fix_indicator, num):
...
for idx in idx_list:
    for fix_eval_indicator in ['ic_half_d', 'ic_half_t', 'ic_half_c']:
        output_path = f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/TrainModelReCheck/XGBRecheck_fix_eval_{fix_eval_indicator}_{factor_num}/'
    ...
    # out_path = f'/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/TrainModelReCheck/XGBRecheck_fix_eval_{fix_eval_indicator}_{factor_num}/'
    #
