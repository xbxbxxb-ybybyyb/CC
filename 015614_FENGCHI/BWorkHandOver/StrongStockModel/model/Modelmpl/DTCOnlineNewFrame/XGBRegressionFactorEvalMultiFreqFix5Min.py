...
def get_5min_factor_evaluation(num,end_index,eval_indicator,eval_res_path='/arch1/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval/'):
...
for idx in tqdm(idx_list):
    ...
    out_path = f'/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/XGBMultiFreqFix5minNoEnhancedMinute_train200_test10_{fix_indicator}_{daily_indicator}/'
...
path = '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMulti/'

ic_half_d,ic_half_t,ic_half_c,ic_half_d_old = [set() for i in range(4)]
for _,cell in para_list[:138]:
    train_start,train_end,_,_=cell
    temp_d = get_5min_factor_evaluation(200,train_end,'ic_half_d',eval_res_path='/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/')
    temp_t = get_5min_factor_evaluation(200,train_end,'ic_half_t',eval_res_path='/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/')
    temp_c = get_5min_factor_evaluation(200,train_end,'ic_half_c',eval_res_path='/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/')
    temp_d_old = get_5min_factor_evaluation(200, train_end, 'ic_half_d', eval_res_path='/arch1/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval/')
    ic_half_d = ic_half_d.union(set(temp_d))
    ic_half_t = ic_half_t.union(set(temp_t))
    ic_half_c = ic_half_c.union(set(temp_c))
    ic_half_d_old = ic_half_d_old.union(set(temp_d_old))

pd.to_pickle(ic_half_d,'/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/ic_half_d_factor.pkl')
pd.to_pickle(ic_half_t,'/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/ic_half_t_factor.pkl')
pd.to_pickle(ic_half_c,'/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/ic_half_c_factor.pkl')
pd.to_pickle(ic_half_d.union(ic_half_c).union(ic_half_t),'/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/dtc_union_factor.pkl')


factor_list = list(map(lambda x : x.replace('.npy',''),os.listdir('/arch1/group/800442/800319/MinFactor/FactorFixData/Factor/')))
pd.to_pickle(ic_half_d.union(ic_half_c).union(ic_half_t) - set(factor_list),
             '/data/group/800442/800319/junkData/StrongStock/external_data/factor5min_eval_revised/dtc_union_uncalculated.pkl')
