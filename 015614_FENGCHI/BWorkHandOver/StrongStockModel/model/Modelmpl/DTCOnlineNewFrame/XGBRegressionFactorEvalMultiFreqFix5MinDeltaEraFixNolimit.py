...
using_factor_list = pd.read_pickle('/data/group/800319/strategy_local_path3/available_factor_list.pkl')
...
def load_dataset(start_date,end_date,fix_factor_list,min5_factor_list,min5_adress='/arch1/group/800442/800319/MinFactor/FactorDpFixData/Factor/'):
    ...
    # if (nolimit_fix!=nolimit_5min).sum()
...
for idx in tqdm(idx_list):
    ...
    out_path = f'/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMultiDeltaEraData20210820/XGBMultiFreqFix5minFixNolimit_train200_test10_{fix_indicator}_{daily_indicator}/'
