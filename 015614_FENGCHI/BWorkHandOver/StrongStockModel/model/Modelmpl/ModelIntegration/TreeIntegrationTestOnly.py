...
def fit_model(i, output_path):
    path_dict = dict(
        ...
        base_model_res_path_test = out_path[:-1]+'_base_model_res_test_set/'
    )
...
out_path = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/XGB_DTCGWC_HX_RegIntegrationOnlyTest/'
