...
class XGBRegressionFactorEvalRollingSelectFactorWithNNExtractorFeature(ModelNewLoading):
    ...
    def predict(self, model, X_test, end_date=None):
        ...
        feature_to_extract = pd.read_pickle('/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/NNExtractorRecent40Sigmoid_%s_train200_test10_factor_num700_norm_window_40_feature_path/%d.pkl'%(self.eval_indicator,end_date))
    ...
    def train_model(self, X_train, y_train, params, end_date=None):
        ...
        model_extracted.load_weights(
            '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/NNExtractorRecent40Sigmoid_%s_train200_test10_factor_num700_norm_window_40_model_conf/%d.h5' % (self.eval_indicator,end_date))
...
def main_window_search(i,indicator):
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FeatureEngineeringExplore/XGBWithNNFeatureNear40_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
        indicator, train_period, test_period, factor_num, N)
...
print(idx_list)
for idx in idx_list:
    main_window_search(idx, 'ic_half_c')
    gc.collect()
