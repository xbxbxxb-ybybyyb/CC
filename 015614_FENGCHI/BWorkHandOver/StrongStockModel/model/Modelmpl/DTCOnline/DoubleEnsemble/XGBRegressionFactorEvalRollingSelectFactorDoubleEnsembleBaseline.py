...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/DoubleEnsemble/XGBFactorEvalYearlyBaseline_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
        indicator, train_period, test_period, factor_num, N)
    ...
    best_param_clf_xgb = {'booster': 'gbtree', 'colsample_bytree': 0.5243169632466114, 'gamma': 0.1856029577071825, 'max_depth': 7, 'min_child_weight': 9360, 'n_estimators': 100,
                          'sampling_method': 'gradient_based', 'subsample': 0.9672279176597204, 'tree_method': 'gpu_hist'}
