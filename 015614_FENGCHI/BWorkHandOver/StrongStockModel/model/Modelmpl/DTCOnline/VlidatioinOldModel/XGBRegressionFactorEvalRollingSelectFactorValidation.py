...
conf.read('/data/group/800319/strategy_local_path_offline/period_info_20200102_model.ini')
...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDown/XGBFactorEvalYearlyParam10_%s_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
        indicator, train_period, test_period, factor_num, N)
