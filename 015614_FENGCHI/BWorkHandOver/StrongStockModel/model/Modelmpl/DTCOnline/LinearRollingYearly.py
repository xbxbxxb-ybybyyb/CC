...
class LinearRegRollingYearly(ModelNewLoading):
...
def main(i,indicator):
    ...
    if os.path.exists(base_dir + '%d.pkl' % train_end):
        ...
        return
    model = LinearRegRollingYearly(train_start, test_end, None, feature_address='/data/group/800319/HFfactor/FixRoll/data/', factor_eval_indicator=indicator, factor_num=factor_num)
    print(out_file)
    best_param = {'n_jobs': -1}
