...
para_list = [(0, (20150309, 20151225, 20151228, 20160111)),
 ...
 (124, (20200407, 20210127, 20210128, 20210202))]
...
def main(i, indicator):
    ...
    if os.path.exists(base_dir + '%d.pkl' % train_end):
        ...
        return
    model = LinearReg(train_start, test_end, None, feature_address='/data/group/800319/HFfactor/RealTimeFixRollRobust/data/', factor_eval_indicator=indicator, factor_num=factor_num)
    print(out_file)
    best_param = {'n_jobs': -1}
    ...
    best_param['feature_path'] = out_file.replace('.pkl', '_factor_list/')
