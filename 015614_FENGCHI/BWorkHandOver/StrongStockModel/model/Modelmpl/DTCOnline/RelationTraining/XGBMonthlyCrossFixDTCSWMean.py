...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBSWMean_%s_train%d_test%d_factor_num%d.pkl' % (
    ...
    model = XGBRegressionFactorEvalYearly(train_start, test_end, None, feature_address='/data/group/800442/800319/HFfactor/CrossIndutryMean20211104/data/',
...
for i in tqdm(list(range(138))[24:]):
    for ind_name in ['ic_c','ic_d','ic_t']:
