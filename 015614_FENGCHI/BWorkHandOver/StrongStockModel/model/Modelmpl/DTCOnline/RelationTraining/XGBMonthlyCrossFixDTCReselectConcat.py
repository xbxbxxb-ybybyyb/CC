...
class XGBRegressionFactorEvalYearly(ModelNewLoading):
    ...
    def get_fix_factor_evaluation(self, num, end_index,eval_file):
        factor_evaluation = pd.read_pickle(eval_file)
    ...
    def rolling_train_and_predict(self, params={}, period=10, predict_period=10, label_methodology='fix_window', label_param={}, factor_nums=200, kernel=10):
        ...
        for idx, cell_idx in bar:
            ...
            factor_lists = []
            for each in [f'{root_path}external_data/moon_v2/{self.eval_indicator}.pkl',
                         f'{root_path}external_data/moon_sw1_cross_norm/{self.eval_indicator}.pkl']:
                factor_lists.append(self.get_fix_factor_evaluation(factor_nums//2, train_end_idx,eval_file=each))
            ...
            X_train, y_train, X_test, y_test, feature_engineering_time = \
                get_dataset((train_start_idx, train_end_idx), (test_start_idx, test_end_idx),
                                 factor_lists,self.feature_address)
            gc.collect()
...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBV4FactorListMixCrossReselect_%s_train%d_test%d_factor_num%d.pkl' % (
    ...
    model = XGBRegressionFactorEvalYearly(train_start, test_end, None,
                                          feature_address=['/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/',
                                                    '/data/group/800442/800319/HFfactor/RealTimeFixRollCrosslize/data/'],
