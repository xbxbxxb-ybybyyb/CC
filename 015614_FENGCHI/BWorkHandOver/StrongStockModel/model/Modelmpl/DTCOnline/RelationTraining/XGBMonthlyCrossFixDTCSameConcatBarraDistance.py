...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/Barra/XGBV4_BarraDistance/XGBV4_BarraDistance_%s_train%d_test%d_factor_num%d.pkl' % (
...
factor_dir = '/data/group/800442/800319/HFfactor/BarraCrosslize/Distance/data/'
