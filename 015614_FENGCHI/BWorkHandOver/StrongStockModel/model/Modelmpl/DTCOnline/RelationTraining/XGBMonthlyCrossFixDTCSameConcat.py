...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBV4FactorListMixCrossSW1Delay1_%s_train%d_test%d_factor_num%d.pkl' % (
    ...
    model = XGBRegressionFactorEvalYearly(train_start, test_end, None,
                                          feature_address=['/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/',
                                                    '/data/group/800442/800319/HFfactor/RealTimeFixRollCrosslizeDelay1SW/data/'],
...
for i in tqdm(idx_list):
    for ind_name in ['ic_t','ic_d','ic_c']:
