...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV3FactorList_%s_train%d_test%d_factor_num%d.pkl' % (
...
for i in tqdm(list(range(136))[::-1]):
