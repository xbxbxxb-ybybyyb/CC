    ...
    def get_dataset(self, train_idx, test_idx, fix_factor_list, interday_factor, label_method, label_param={}, kernel=10):
        ...
        if train_idx[-1] == test_idx[0] and train_idx[-1] == test_idx[-1]:
            ...
            train_cross_feature,train_cross_label,nolimit_cross,train_idx_date_cross, train_idx_code_cross, train_idx_time_cross = \
                load_fix_data(train_idx[0], get_pre_trade_date(train_idx[-1]),interday_factor,address=factor_dir)
        else:
...
def main_window_search(i, indicator):
    ...
    test_period = 10
    factor_num = 200
    tag = 'XGBAppendCross_%s_train%d_test%d_factor_num%d' % (indicator, train_period, test_period, factor_num)
    out_file = f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFactor20220323/{tag}/{tag}.pkl'
...
factor_dir = '/data/group/800442/800319/HFfactor/CrossFactor/data/'
import shutil
