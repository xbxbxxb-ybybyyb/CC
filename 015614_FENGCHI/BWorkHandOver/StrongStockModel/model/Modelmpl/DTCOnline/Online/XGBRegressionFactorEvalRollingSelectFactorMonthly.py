...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV2_%s_train%d_test%d_factor_num%d.pkl' % (
...
for i in tqdm(list(range(132,134))):
    for ind_name in ['ic_d', 'ic_t', 'ic_c', 'top_ret'][::-1]:
