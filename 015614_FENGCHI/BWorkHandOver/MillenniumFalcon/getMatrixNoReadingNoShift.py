...
def main(out_path_io):
    ...
    for f_name in tqdm(target_list):
        ...
        out_file(f_name,shift=False,out_path_io=out_path_io,all_date_list=_all_date_list,code_list=_code_list)
        gc.collect()

if __name__ == '__main__':
    main('/data/group/800442/800319/HFfactor/CrossIndutryMeanNoShift/data/')
