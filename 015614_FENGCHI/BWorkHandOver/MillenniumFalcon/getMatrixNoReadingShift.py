...
sys.path.append('/data/user/015614/BWorkHandOver/MillenniumFalcon')
...
#        if datetime.datetime.now()>=datetime.datetime(2021, 11, 22, 6, 9, 10, 224050):
#            break
        out_file(f_name,shift=True,out_path_io=out_path_io,all_date_list=_all_date_list,code_list=_code_list)
        gc.collect()

if __name__ == '__main__':
    main('/data/group/800442/800319/HFfactor/CrossIndutryMeanShift/data/')
