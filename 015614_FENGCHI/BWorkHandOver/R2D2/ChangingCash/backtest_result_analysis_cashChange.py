...
# base_path = '/data/group/800442/800319/MarketTiming/NonFixWindow_to_20210531/'
base_path = '/data/group/800442/800319/Timing/ReportFactor/XuqiBacktest_Loop/'
all_file = f'{base_path}/择时查验.xlsx'
file_list = list(filter(lambda x: x.endswith('.xlsx'), os.listdir(base_path)))
# file_list = sorted(list(filter(lambda x: x.endswith('VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210531.xlsx'), os.listdir(base_path))))
# tag_list = ['FixTimeCompare', 'FixTimeLong1', 'FixTimeLong2', 'FixTimeLong3', 'FixTimeLong4', 'FixTimeLong5', 'FixTimeShort1', 'FixTimeShort2', 'FixTimeShort3', 'FixTimeShort4', 'FixTimeShort5', 'FixTimeLongShort1', 'FixTimeLongShort2', 'FixTimeLongShort3', 'FixTimeLongShort4', 'FixTimeLongShort5']
# tag_list = ['FixTimeCompare', 'XY_PointRatio_long', 'XY_PointRatio_short', 'XY_PointRatio_long_short']

# file_list = ['%sAlphaTriggerPoolTop600_deal_ratio_0.1_per_ratio_0.0050VolConsiderOnlineLimit_UpBuy100_10bp_cost_20210531.xlsx' % x for x in tag_list]
...
for file_name in file_list:
    clf_name = file_name.replace('XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_', '').replace('_NonfixWindow_10bp_cost.xlsx', '')
