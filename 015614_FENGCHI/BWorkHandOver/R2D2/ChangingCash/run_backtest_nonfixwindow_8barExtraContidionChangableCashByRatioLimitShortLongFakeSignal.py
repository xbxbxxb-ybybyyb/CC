...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag, timing_tag, down_definition):
    ...
    if timing_tag == 'NoTiming':
        ...
        timing_signal_path = '/data/group/800442/800319/MarketTiming/fake_signal/'
    ...
    file_name = '_LongV1_MaxByRatio_%s_%dbp_cost' % (tag, int(10000 * cost))
    base_dir = '/data/group/800442/800319/MarketTiming/NonFixWindowWithLongFakeV1/'
    ...
    if not os.path.exists(record_file):
        ...
        instance = StartWithLimitCashVolConsider(long_signal,long_pred_ret, short_signal, start, end, stock_pool=alpha_pool, target_point=bar_list, buy_cost=cost, sell_cost=cost,
                                                 ...
                                                 deal_percent=deal_ratio, barly_max_buy=int(1/per_amt_ratio)//len(bar_list), initial_cash=initial_cash,
...
timing_tag_list = ['fake_0.85', 'fake_0.70', 'fake_0.65', 'fake_0.80', 'fake_0.75', 'fake_0.55', 'fake_0.60', 'fake_0.90', 'NoTiming']
