...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag, timing_tag, down_definition,condition_tag):
    ...
    file_name = f'MaxBuy100_s{start}_e{end}_%s_%dbp_cost' % (tag, int(10000 * cost))
...
import itertools
para_list = list(itertools.product(['EMDT_trend_fix_signal', 'SLM_fix_signal', 'SLM_fix_signal_V2', 'NoTiming'],
                  ['V4_2_1', 'V6_2_1', 'V6NV4']))
# timing_tag_list =
