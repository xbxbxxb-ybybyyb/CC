...
# base_path = '/data/group/800442/800319/MarketTiming/NonFixWindowWithLongLimitNum/'
import shutil

# NotLongConditionList = os.listdir('/data/group/800442/800319/MarketTiming/NonFixWindowMannualSignalCondition/')
# for each in  NotLongConditionList:
#     if not each.endswith('.xlsx'):
#         continue
#     target_name = each.replace('NonfixWindow_10bp_cost.xlsx','NotLongCondition_NonfixWindow_10bp_cost.xlsx')
#     shutil.copy(f'/data/group/800442/800319/MarketTiming/NonFixWindowMannualSignalCondition/{each}',
#                 f'/data/group/800442/800319/MarketTiming/NonFixWindowMannualSignalCondition2/{target_name}')
# base_path = '/data/group/800442/800319/MarketTiming/NonFixWindowMannualSignalCondition2/'
base_path = '/data/group/800442/800319/MarketTiming/NonFixWindowMannualSignal2/'
# base_path = '/data/group/800442/800319/MarketTiming/NonFixWindowWithLongFakeV1/'
all_file = f'./择时信号测试20220607.xlsx'
# file_list = sorted(list(filter(lambda x: x.startswith('_LongV1'), os.listdir(base_path))))
file_list = sorted(list(filter(lambda x: x.endswith('.xlsx'), os.listdir(base_path))))
# file_list = [
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_pred_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_short_pred_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_XGB300_NonfixWindow_10bp_cost.xlsx',
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_pred_XGB300_NonfixWindow_10bp_cost.xlsx',
# 'MaxBuy100_s20170101_e20211130_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_short_pred_XGB300_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_XGB300_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_pred_XGB300_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_short_pred_XGB300_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_pred_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
#  '_LongV1_Max100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_short_pred_XGB300Reduce_NonfixWindow_10bp_cost.xlsx',
#              ]

# target_tag = ['EMDT_trend_signal_20220421', 'EMDT_trend_fix_signal_20220421', 'Long100_Short200_SVR_20220421','DiscreteXGB300', 'DcXGB300','NoTiming']
# selected = []
# for each in file_list:
#     isin = False
#     for tag in target_tag:
#         if tag+'_Nonfix' in each:
#             selected.append(each)
# file_list = selected

# file_list.append('MaxBuy100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx')
...
for file_name in file_list:
    clf_name = file_name.replace('_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20',
                                 '').replace('_NonfixWindow_10bp_cost.xlsx', '')  # [108:-28]
    clf_name = clf_name.replace('s20170101_e20211130_', '')
    # clf_name = clf_name.replace('_LongV1_', '')
    # if 'Res' in file_name:
    #     clf_name = clf_name + '_残差'
    # elif 'Origin' in file_name:
    #     clf_name = clf_name + '_原因子'
    if '_LongV1_' in clf_name:
        clf_name = clf_name.replace('_LongV1_', '新框架V1')
    elif '_LongV2_' in clf_name:
        clf_name = clf_name.replace('_LongV2_', '新框架V2')
    else:
        clf_name = '老框架' + clf_name#.replace('MaxB')
    # clf_name = clf_name.replace('NotLongConditionNoTiming','无看多&信号量作为终止条件_不择时')
    # clf_name = clf_name.replace('NotLongCondition','无看多&信号量作为终止条件_叠加多空信号')
    # clf_name = clf_name.replace('NoCondition','无终止条件')
    print(clf_name)
    ...
    data = data.rename(index={'平均每分钟收益率': '平均每分钟收益率(每笔交易的分钟收益按占资加权)'})
    data.loc['平均每分钟收益率(平均收益率_平均持仓时间)'] = data.loc['收益率'] / data.loc['平均持仓时间']
