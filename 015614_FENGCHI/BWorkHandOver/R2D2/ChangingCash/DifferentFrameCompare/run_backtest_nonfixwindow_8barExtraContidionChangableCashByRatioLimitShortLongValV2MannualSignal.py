...
from R2D2.ChangingCash.StartWithLimitCashVolConsiderNonFixSignal8BarExtraContitionChangingCashByRatioLimitShortLongV2 import StartWithLimitCashVolConsider, \
...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag, timing_tag, down_definition):
    ...
    file_name = '_LongV2_Max100_%s_%dbp_cost' % (tag, int(10000 * cost))
