...
def calc_back_test_record(per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag, timing_tag, down_definition):
    ...
    if timing_tag == 'NoTiming':
        ...
        timing_signal = pd.Series(timing_signal)
    ...
    file_name = f'MaxBuyByRatio_s{start}_e{end}_%s_%dbp_cost' % (tag, int(10000 * cost))
    base_dir = '/data/group/800442/800319/MarketTiming/NonFixWindowWithLongLimitNumFake100/'
