...
all_file = f'{base_path}/择时两个版本限制每个bar最大触发数比对V3.xlsx'
# file_list = list(filter(lambda x: x.endswith('.xlsx'), os.listdir(base_path)))
file_list = ['MaxBuyByRatio_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx',
 'MaxBuyByRatio_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx',
 'MaxBuy100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx',
 'MaxBuy100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx',
 '_LongV1_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx',
 '_LongV1_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx']
monthly_pre_active = {}

name_para = {
'MaxBuyByRatio_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx':'原始版本_择时_每个Bar限制1/7',
 'MaxBuyByRatio_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx':'原始版本_无择时_每个Bar限制1/7',
 'MaxBuy100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx':'原始版本_择时_每个Bar限制100',
 'MaxBuy100_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx':'原始版本_无择时_每个Bar限制100',
 '_LongV1_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_NoTiming_NonfixWindow_10bp_cost.xlsx':'看多信号买入最大可买入_无择时_每个Bar限制1/7',
 '_LongV1_XGB_DTC_Matrix_Light_CatNonFixWindow_CS_XGB_OLS_condition_style_rank_ex20_long_short3_NonfixWindow_10bp_cost.xlsx':'看多信号买入最大可买入_择时_每个Bar限制1/7',
}
...
for file_name in file_list:
    ...
    if len(tag) != 1:
        raise Exception('No Defined Tag')
    else:
    ...
    if clf_name=='看多信号买入最大可买入_无择时_每个Bar限制1/7':
        print(1)
