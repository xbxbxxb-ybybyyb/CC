...
file_list = sorted(list(filter(lambda x: x.endswith('xlsx') and 'end20211' in x, os.listdir(base_path))))
# file_list = [
#     'XGBMonthlyV4_Cat_Light_ValWithoutMax5start20210104_end20211027CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20210104_end20211027VolConsider_UpBuy100_10bp_cost.xlsx',
#     'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5_PredCosiV3_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20210104_end20211027_s_thre0.10_d_thre0.70_swing0.005VolConsider_UpBuy100_10bp_cost.xlsx',
#     'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5start20210104_end20211027CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20210104_end20211027VolConsider_UpBuy100_10bp_cost.xlsx'
# ]

file_list = [
    'XGBMonthlyV4_Cat_Light_ValWithoutMax5start20210104_end20211130CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20210104_end20211130VolConsider_UpBuy100_10bp_cost.xlsx',
    'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5_PredCosiV3_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20210104_end20211130_s_thre0.10_d_thre0.70_swing0.005VolConsider_UpBuy100_10bp_cost.xlsx',
    'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5start20210104_end20211130CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20210104_end20211130VolConsider_UpBuy100_10bp_cost.xlsx',
]
...
name_para = {
    'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5start20210104_end20211130CS_XGB_OLS_condition_style_rank_ex20Top600_r': '当前线上更新后版本',
    'XGBMonthlyV4_Cat_Light_Val': '12月迭代前版本',
    'XGBWithSWSHIFReSaveTWithOrigin_Cat_LightWithoutMax5_PredCosiV3_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20210104_end20211130_s_thre0.10': '最新研究成果(暂未上实盘)',
...
for file_name in file_list:
    ...
    if len(tag) != 1:
        ...
        clf_name = file_name[:file_name.index('Without')]  # [:27]
...
all_file = f'{base_path}/更新进展2021比对V2.xlsx'
