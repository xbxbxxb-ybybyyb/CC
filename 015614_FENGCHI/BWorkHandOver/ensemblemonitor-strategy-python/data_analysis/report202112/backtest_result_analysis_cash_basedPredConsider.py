...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/PredConsiderV3PrameterSeekingOutSample/'
...
# import shutil
# file_list = ['XGBMonthlyV4_Cat_Light_ValWithoutMax5_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20170101_end20191231_s_thre0.10_d_thre0.70_swing0.005VolConsider_UpBuy100_10bp_cost.xlsx',
#   'XGBMonthlyV4_Cat_Light_ValWithoutMax5_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20170101_end20191231_s_thre1.00_d_thre1.00_swing0.000VolConsider_UpBuy100_10bp_cost.xlsx']

file_list = ['XGBMonthlyV4_Cat_Light_ValWithoutMax5_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20200102_end20210531_s_thre0.10_d_thre0.70_swing0.005VolConsider_UpBuy100_10bp_cost.xlsx',
  'XGBMonthlyV4_Cat_Light_ValWithoutMax5_deal0.10_per5.0bp_thre5_cash2e+08_Top600_start20200102_end20210531_s_thre1.00_d_thre1.00_swing0.000VolConsider_UpBuy100_10bp_cost.xlsx']
...
name_para = {
    's_thre0.10_d_thre0.70_swing0.005':'优化后',
    's_thre1.00_d_thre1.00_swing0.000':'优化前'
...
for file_name in file_list:
    ...
    # clf_name = file_name[105:].replace('VolConsider_UpBuy100_10bp_cost.xlsx', '')
...
all_file = './考虑行情和信号量寻优V3OutSample前后对比.xlsx'  # f'{base_path}/不同股票池_不同信号版本_不限制预测值千5_20211108.xlsx'
