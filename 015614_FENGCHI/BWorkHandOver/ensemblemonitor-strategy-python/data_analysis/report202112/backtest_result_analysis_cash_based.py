...
base_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/股票池集中度寻优/'
...
file_list = \
    [
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top200_real200_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top200_real200_deal_ratio_0.1_per_ratio_0.0100_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top200_real200_deal_ratio_0.1_per_ratio_0.0150_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0050_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0100_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx',
        'XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20Top600_real600_deal_ratio_0.1_per_ratio_0.0150_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx']
...
for file_name in file_list:
    ...
    clf_name = file_name.replace('XGBMonthlyV4_Cat_Light_ValWithoutMax5CS_XGB_OLS_condition_style_rank_ex20', '')
    clf_name = clf_name.replace('_real200_deal_ratio_0.1_', '').replace('_threshold_0.05_inital_200000000start20170101_end20210531VolConsider_UpBuy100_10bp_cost.xlsx', '')
    clf_name = clf_name.replace('_real600_deal_ratio_0.1_', '')
    clf_name = clf_name.replace('Top', '股票池').replace('per_ratio_', ' 单票仓位')
    clf_name = f'{clf_name[:-6]} {eval(clf_name[-6:]) * 100:.1f}%'
...
all_file = f'{base_path}/单笔_股票池数量测试V2.xlsx'
