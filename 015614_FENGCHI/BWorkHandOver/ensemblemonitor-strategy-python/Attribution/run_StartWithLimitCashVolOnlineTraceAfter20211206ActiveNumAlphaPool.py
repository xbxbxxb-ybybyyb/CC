...
final_tag = strategy_tag + '_OnlineTest'+ 'ActivePoolNumAlphaPool_deal_ratio_%.1f_per_ratio_%.4f' % (deal_ratio, per_amt_ratio)
...
alpha_pool = (alpha_pool2.T<(alpha_pool1.sum(axis=1)+1)).T
