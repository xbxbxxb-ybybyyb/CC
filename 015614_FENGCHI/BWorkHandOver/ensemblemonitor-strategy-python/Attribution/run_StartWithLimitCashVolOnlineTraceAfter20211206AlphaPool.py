...
final_tag = strategy_tag + '_OnlineTest'+ 'AlphaPool_deal_ratio_%.1f_per_ratio_%.4f' % (deal_ratio, per_amt_ratio)
...
alpha_pool = pd.read_pickle('/data/group/800442/800319/AlphaPool/OLS_XGB200_to20211231.pkl').rank(ascending=False,axis=1).shift(1).loc[backtest_start_date:pre_date]<600
