...
per_ratio_change = {
    20210727:0.018,20210729:0.00375,20210730:0.015,20210803:0.09375,20210804:0.015
...
cash_added = {20210705:7000000,20210720:22000000,20210727:-7500000,
            ...
            20210928:-5803249.825620677,
            20210930:5803249.825620677,20211015:-6935082.405405534,20211103:4000000,
            20211111:7000000,20211126:-11000000,20211209:4000000,20211214:-5590000,20211216:7000000,20211215:5590000,
              20211217:-11000000
            }
...
cash_added[20210702] = initial_cash
calc_930_compare(backtest_start_date,today,cash_added)
# per_ratio = {}
# account_value = {}
# for date in get_date_range(20210611,20210630):
#     temp = pd.read_pickle(f'/data/group/800319/strategy_local_path3/FolderFor930_For_SIM/{date}/StrategyIn/init{date}.pkl')
#     account_info = pd.read_pickle(f'/data/group/800319/strategy_local_path3/FolderFor930_For_SIM/{date}/StrategyIn/account_info{date}.pkl')
#     per_ratio[get_pre_trade_date(date)] = temp['per_amt']/account_info['account_value']
#     account_value[get_pre_trade_date(date)] = account_info['account_value']
# per_ratio = pd.Series(per_ratio).apply(lambda x : round(x,2))
