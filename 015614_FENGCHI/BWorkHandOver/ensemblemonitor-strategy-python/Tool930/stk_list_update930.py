...
path_conf = get_path_conf(f'/data/group/800442/800319/strategy_local_path_sim/strategy_local_path3_sim{get_pre_trade_date(today)}/')
...
try:
    ...
    portfolio_file.to_excel(f'{local_config_path}/portfolio_file/EMPortFile{date}_{account}_with_930.xlsx')
