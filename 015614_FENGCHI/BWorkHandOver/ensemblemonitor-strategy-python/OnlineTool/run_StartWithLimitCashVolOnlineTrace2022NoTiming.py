...
base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/实盘回测线下跟踪无仓位择时/'
cash_flow = {
20220121:-20000000,
20220208:20000000,
20220211:-30000000,
...
final_tag = strategy_tag + '_WithTimingOperation'

today = 20220411#int(datetime.date.today().strftime('%Y%m%d'))
