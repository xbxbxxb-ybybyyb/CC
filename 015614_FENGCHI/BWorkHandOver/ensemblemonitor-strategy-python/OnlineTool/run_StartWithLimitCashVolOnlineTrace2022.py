...
condition_series={
    ...
    20220221:'((((bar_first_trigger_num/bar_ratio)>(0.15*pool_num)) or ((bar_cum_first_trigger_num/barly_cum_ratio)>(0.15*pool_num))) or False)and (bar_down_trigger_signal/bar_trigger_signal)>0.5',
    20220309: '(((bar_first_trigger_num/bar_ratio)>(0.15*pool_num)) or ((bar_cum_first_trigger_num/barly_cum_ratio)>(0.15*pool_num)))and ((SZCZ/SZCZ_MA5 -1)<-0.008 or SZCZ_MA5_to_MA10<0)',
    20220322: '((((bar_first_trigger_num/bar_ratio)>(0.15*pool_num)) or ((bar_cum_first_trigger_num/barly_cum_ratio)>(0.15*pool_num))) or False)and (bar_down_trigger_signal/bar_trigger_signal)>0.5',
...
base_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/实盘回测线下跟踪/'
cash_flow = {
20220121:-20000000,
20220208:20000000,
20220211:-30000000,
...
alpha_pool = []
# code_list_path = '/data/group/800319/strategy_local_path3_FixVersion0421/code_list/'
...
instance = StartWithLimitCashVolConsider(pred_ret, backtest_start_date, pre_date, stock_pool=alpha_pool, target_point=bar_list, buy_cost=cost, sell_cost=cost,
                                                     ...
                                                     deal_percent=deal_ratio, initial_cash=50000000, cash_added=cash_flow,
...
out_path = f'{base_dir}/%sVolConsiderOnlineLimit_UpBuy100_%dbp_cost_%d.xlsx' % (final_tag, int(10000 * cost), pre_date)
...
print(out_path)
cash_flow[get_pre_trade_date(backtest_start_date)] = 50000000
main_compare(today,start_backtest_date=backtest_start_date,tag=strategy_tag,cash_flow=cash_flow,basic_indicator_file= f'{base_dir}/barly_condition_indicator/%s_{pre_date}OnlineTracing.pkl' % final_tag)
