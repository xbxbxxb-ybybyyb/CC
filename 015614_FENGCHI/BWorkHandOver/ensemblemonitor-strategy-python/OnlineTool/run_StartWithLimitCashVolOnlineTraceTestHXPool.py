...
alpha_pool = pd.read_pickle('/data/group/800319/AlphaPool/CS_OLS_condition_style_rank_ex20_F600T488P1_future925t241h123d_uniform20t50.pkl')
...
tag = tag.replace('RevTriggerFilterHolding', 'future925t241h123d')
