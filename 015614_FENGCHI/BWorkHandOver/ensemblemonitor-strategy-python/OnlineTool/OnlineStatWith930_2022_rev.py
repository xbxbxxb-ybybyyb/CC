...
def Only_Initial(pre_date, today, T_plus_1_day, portfolio, cash_add, actual_all_cash, cash_add_930):

    daily_initial_generation930(T_plus_1_date=get_pre_trade_date(today, -1), date=today, barly_max_buy=100, stk_min_amt=0.2, per_signal_ratio=0.005, order_ratio=0.1)

    daily_initial_generation(T_plus_1_date=T_plus_1_day, date=today, barly_max_buy=100, stk_min_amt=0.2, per_signal_ratio=0.005,
                             order_ratio=0.1, afternoon_holding=pd.DataFrame(columns=['市值']), portfolio=portfolio)
...
def main(actual_cash):
    ...
    # Only_Initial(pre_date, today, T_plus_1_day, portfolio, cash_add, actual_cash, cash_add_930=cash_add_930)
...
if __name__ == "__main__":
    main(58892208.98 - 1002743.11-3000000-3000000+25288-4000000+300000+2700000 - 16000000)  # 20220209
