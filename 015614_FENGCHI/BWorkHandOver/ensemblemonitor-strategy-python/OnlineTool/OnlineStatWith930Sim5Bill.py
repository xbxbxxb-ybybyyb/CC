...
def AfterHoursStat(pre_date,today,T_plus_1_day,portfolio,cash_add,actual_all_cash,cash_add_930):
    ...
    daily_initial_generation930(T_plus_1_date=get_pre_trade_date(today,-1), date=today, barly_max_buy=100, stk_min_amt=0.2, per_signal_ratio=0.015, order_ratio=1)
    ...
    daily_initial_generation(T_plus_1_date=T_plus_1_day,date=today,barly_max_buy=100,stk_min_amt=0.2,per_signal_ratio=0.005,
                             order_ratio=1,afternoon_holding=afternoon_holding,portfolio=portfolio)
...
def main(actual_cash):
    today = 20210806#int(datetime.date.today().strftime('%Y%m%d'))
...
cash_flow = {
    ...
    20210804:[420000000+7925804.88,58000000+173508.90871492773],
    20210805:[420000000+7925804.88+30000000,58000000+173508.90871492773+4500000],
    20210806:[420000000+7925804.88+30000000,58000000+173508.90871492773+4500000],
}
...
if __name__=="__main__":
    main(20768937.001285076 + 26429219.73 + 1635050.07)
    # main(20768937.001285076+26429219.73)#20210804
