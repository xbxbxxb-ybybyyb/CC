...
condition_series={
    20220112:f'((((bar_first_trigger_num/bar_ratio)>(0.15*pool_num)) or ((bar_cum_first_trigger_num/barly_cum_ratio)>(0.15*pool_num))) or False) and ((bar_down_trigger_signal/bar_trigger_signal)>0.5 or (((SZCZ/SZCZ_MA5 -1)<-0.008 or SZCZ_MA5_to_MA10<0) and (SZCZ_MA5_to_MA10<0)))'
...
final_tag = strategy_tag + '_NoTimingOperationV6NV4'
