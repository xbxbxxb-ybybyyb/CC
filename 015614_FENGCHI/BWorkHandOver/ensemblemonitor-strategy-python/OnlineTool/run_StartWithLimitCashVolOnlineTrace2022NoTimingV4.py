...
condition_series={
    20220112:'((((bar_first_trigger_num/bar_ratio)>(0.15*pool_num)) or ((bar_cum_first_trigger_num/barly_cum_ratio)>(0.15*pool_num))) or False)and (bar_down_trigger_signal/bar_trigger_signal)>0.5',
...
final_tag = strategy_tag + '_NoTimingOperationV4'

today = 20220510#int(datetime.date.today().strftime('%Y%m%d'))
