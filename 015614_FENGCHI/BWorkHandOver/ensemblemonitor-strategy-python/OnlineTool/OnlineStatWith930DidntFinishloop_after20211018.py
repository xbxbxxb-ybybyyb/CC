...
def get_holding_930(date, final_total_holding, cash_added=0,div_cash=0,holding_added=pd.Series(),after_noon_file =None):
    ...
    if after_noon_file is not None:
        ...
        price = after_noon_file.loc[force_sold.index,'当日卖金额(净价)']/after_noon_file.loc[force_sold.index,'当日卖量']
...
if __name__=="__main__":
    ...
    # main(-14651263.975549705 - 2336922.125398323 + 2000000 + 4000000 + 3000000 + 114630054.86)
