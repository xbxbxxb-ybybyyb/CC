...
para = {
    ...
    'XGB_Cat_Light_20100102model': [
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDown/XGBFactorEvalYearlyParam10_ic_half_d_train200_test350_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDown/XGBFactorEvalYearlyParam10_ic_half_t_train200_test350_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDown/XGBFactorEvalYearlyParam10_ic_half_c_train200_test350_factor_num400_norm_window_40.pkl',
        '/data/group/800319/wyl/model_record/a00_model_check/lgbm/oneshot/lightgbmnew_ic_all_t_out_of_sample.pkl',
        '/data/group/800319/wyl/model_record/a00_model_check/catboost/oneshot/catboostnew2_ic_all_t_out_sample.pkl'
    ],
    'XGB_Cat_Light_20100102model_periodly': [
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDownPeriodly/XGBFactorEvalYearlyParam10_ic_half_d_train200_test10_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDownPeriodly/XGBFactorEvalYearlyParam10_ic_half_t_train200_test10_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDownPeriodly/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40.pkl',
        '/data/group/800319/wyl/model_record/a00_model_check/catboost/separate/catboostnew2_ic_all_t_out_sample.pkl',
        '/data/group/800319/wyl/model_record/a00_model_check/lgbm/separate/lightgbmnew_ic_all_t_out_of_sample.pkl'

    ],

    'XGB_Cat_Light_20100102factor_retrain': [
        '/data/group/800319/wyl/model_record/catboostnew2_ic_all_t.pkl',
        '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/Model20200102/XGBFactorEvalYearlyParam10_ic_half_d_train200_test10_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/Model20200102/XGBFactorEvalYearlyParam10_ic_half_t_train200_test10_factor_num400_norm_window_40.pkl',
        '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/Model20200102/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40.pkl',
    ],
    'XGB_Cat_Light_ZSCORE': [
    ...
    # shutil.copy('/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t_out_of_sample_val_pred/20210525.pkl',
    #             '/data/group/800319/wyl/model_record/lightgbmnew_ic_all_t_val_pred/20210525.pkl')
}
...
#         '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_t_train200_test10_factor_num400_norm_window_40.pkl',
# ]:
#     shutil.copy(each.replace('.pkl','_model_conf/20210518.json'),each.replace('.pkl','_model_conf/20210527.json'))
...
if False:  # os.path.exists(f'/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/实盘跟踪线下信号/signal_OutSample_{tag}_{pre_date}.pkl'):
    signal, pred_ret = pd.read_pickle(f'/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/实盘跟踪线下信号/signal_OutSample_{tag}_{pre_date}_validation.pkl')
else:
    # for each in file_list:
    #     out_signal(base_path=each.replace('.pkl','/'), end_date=get_pre_trade_date(today))

    signal, pred_ret = get_signal_by_val_pct_threshold_integration_NoMaxThreshold(pct_threshold, [x.replace('.pkl', '_val_pred/') for x in file_list], file_list,
                                                                                  backtest_start_date,
                                                                                  'actual_label', 'new',
                                                                                  tail=len(period_list) + 1)
    # signal, pred_ret = get_signal_by_val_pct_threshold_integration(pct_threshold, [x.replace('.pkl', '_val_pred/') for x in file_list], file_list,
    #                                                                               backtest_start_date,
    #                                                                               'actual_label', 'new',
    #                                                                               tail=len(period_list) + 1)
    tag = tag + 'WithoutMax5pct'
    print(signal.shape)
    ...
    pd.to_pickle([signal, pred_ret], f'/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/实盘跟踪线下信号/signal_OutSample_{tag}_{pre_date}_validation.pkl')
...
cash_flow = {}
instance = StartWithLimitCashVolConsiderChangingCash(pred_ret, backtest_start_date, 20210608, stock_pool=alpha_pool, target_point=bar_list, buy_cost=cost, sell_cost=cost,
                                                     per_amt_ratio=per_amt_ratio, append_param={'deal_price_path': deal_price_path + 'deal_price_vwap_30min_FullSample.pkl'},
                                                     deal_percent=deal_ratio, initial_cash=2000000, cash_added=cash_flow, per_ratio_change={})
...
out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/实盘回测线下跟踪查验20210528/%sVolConsiderOnlineLimit_UpBuy100_%dbp_cost_%d_validation.xlsx' % (tag, int(10000 * cost), pre_date)
...
# import shutil
# shutil.copy(
#     '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDownPeriodly/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40_model_conf/20210525.json',
#     '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/CheckDrawDownPeriodly/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40_model_conf/20210526.json'
#              )