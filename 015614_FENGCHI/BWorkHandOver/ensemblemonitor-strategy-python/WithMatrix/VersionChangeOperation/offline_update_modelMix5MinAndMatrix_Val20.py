...
def cp_model(threshold, model_path_map, model_path, latest_update_date, factor_map):
    ...
    for each in model_path_map:
        ...
        model_validation_path = model_conf_path.replace('model_conf/', 'val_predrecent_5/')
...
def main():
    ...
    model_path_map = {
        'XGB_D': ['XGB', '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_d_train200_test10_factor_num400_model_conf/'],
        'XGB_T': ['XGB', '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_t_train200_test10_factor_num400_model_conf/'],
        'XGB_C': ['XGB', '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_c_train200_test10_factor_num400_model_conf/'],
    }
    ...
    factor_list_path = {
        'XGB_D': '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_d_train200_test10_factor_num400_factor_list/',
        'XGB_T': '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_t_train200_test10_factor_num400_factor_list/',
        'XGB_C': '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGB_Val20_ic_c_train200_test10_factor_num400_factor_list/',
    }
