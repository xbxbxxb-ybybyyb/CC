...
from dataApi.FixFactorRollPrepare import load_fix_data, feature_engineering,load_dataset_from_multiple_add
import os, time, gc
import pandas as pd
...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/CrossFix/XGBV4FactorListMixCrossSWMeanOnly20211104_sim/XGBV4FactorListMixCrossSWMeanOnly20211104_%s_train%d_test%d_factor_num%d.pkl' % (
    ...
    model = XGBRegressionFactorEvalYearly(train_start, test_end, None,
                                          feature_address=['/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/',
                                                    '/data/group/800442/800319/HFfactor/CrossIndutryMeanSimDailyUpdate20211116/data/'],
    ...
    for each in ['idx_date.npy','idx_time.npy','idx_code.npy','future.npy','nolimit.npy']:
        shutil.copy(f'/data/group/800442/800319/HFfactor/RealTimeFixRollRobust/data/{each}',
                    f'/data/group/800442/800319/HFfactor/CrossIndutryMeanSimDailyUpdate20211116/data/{each}')
