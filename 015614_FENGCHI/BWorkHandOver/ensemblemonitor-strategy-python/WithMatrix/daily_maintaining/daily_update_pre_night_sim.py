...
def out_factor_list(today):
    ...
    local_config_path = f'/data/group/800319/strategy_local_path3_ForMixSim/'
    ...
    desample_factor_list = list(filter(lambda x : x[0] in desample_factor_list,all_desample_factor_list))
