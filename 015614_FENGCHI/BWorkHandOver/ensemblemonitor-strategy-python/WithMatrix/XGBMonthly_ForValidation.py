...
def main_window_search(i, indicator):
    ...
    out_file = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_%s_train%d_test%d_factor_num%d.pkl' % (
...
# monthly_target = '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_%s_train200_test10_factor_num400.pkl'
#
...
#
#
# ['/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_d_train200_test10_factor_num400_model_conf/',
# '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_t_train200_test10_factor_num400_model_conf/',
# '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_c_train200_test10_factor_num400_model_conf/']
#
# target = ['/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_d_train200_test10_factor_num400_model_conf/',
# '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_t_train200_test10_factor_num400_model_conf/',
# '/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_c_train200_test10_factor_num400_model_conf/']
#
# import shutil,os
# for each in target:
...
# for tag in ['d','t','c']:
#     shutil.copy(f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_{tag}_train200_test10_factor_num400_model_conf/20210331.json',
# f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_{tag}_train200_test10_factor_num400_model_conf/20210331.json'
#             )
#     if not os.path.exists(f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_{tag}_train200_test10_factor_num400_factor_list/'):
#         os.makedirs(f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_{tag}_train200_test10_factor_num400_factor_list/')
#
#     shutil.copy(f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/XGBV4FactorList_ic_{tag}_train200_test10_factor_num400_factor_list/20210331.pkl',
#                 f'/data/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/MonthlySelected/MatrixValidation/XGBV4ValidateMatrix_ic_{tag}_train200_test10_factor_num400_factor_list/20210331.pkl'
#                 )