...
def calc_back_test_record(pct_threshold, per_amt_ratio, initial_cash, pool_num, deal_ratio, tag, alpha_pool_tag):
    ...
    signal_file = '/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/MatrixValidation/signal_%s_%.2f.pkl' % (tag, pct_threshold)
    ...
    out_path = '/data/user/015664/AFuckingTrigger/限制买入和持仓/MatrixValidation/%sVolConsider_UpBuy100_%dbp_cost.xlsx' % (tag, int(10000 * cost))
    for each in record:
