...
path_conf = get_path_conf(f'/data/group/800442/800319/strategy_local_path_sim/strategy_local_path3_sim{pre_date}/')
...
try:
    ...
    while True:
        if os.path.exists(f'{source_path}{pre_date}.pkl') or os.path.exists(f'{code_list_path}{pre_date}.pkl'):
            break
        else:
    ...
    portfolio_file.to_excel(f'{local_config_path}/portfolio_file/EMPortFile{date}_{account}.xlsx')
