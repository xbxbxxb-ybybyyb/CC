...
model_path_map = {
    ...
    'XGB_D': ['XGB', '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_d_train200_test10_factor_num400_norm_window_40_model_conf/'],
    'XGB_T': ['XGB', '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_t_train200_test10_factor_num400_norm_window_40_model_conf/'],
    'XGB_C': ['XGB', '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/FactorEvalOnlineTestVRobustOpt/XGBFactorEvalYearlyParam10_ic_half_c_train200_test10_factor_num400_norm_window_40_model_conf/'],
...
if os.path.exists(model_path_map['lightGBM_T'][1].replace('model_conf/','train_features/')+'%d.npy'%latest_update_date):
    lgb_factor_list = list(np.load(model_path_map['lightGBM_T'][1].replace('model_conf/','train_features/')+'%d.npy'%latest_update_date))
else:
    cat1 = joblib.load(model_path_map['CatBoost_T'][1] + '%d.pkl' % latest_update_date)
    lgb_factor_list = cat1.feature_names_
