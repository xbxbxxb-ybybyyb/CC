...
# from online_conf import init_conf_path, holding_info_path, vol_info_path, \
...
key_list = 'init_conf_path, holding_info_path, vol_info_path, restrict_list_path, local_config_path, hyper_param_path'.split(', ')
init_conf_path, holding_info_path, vol_info_path, restrict_list_path, local_config_path, hyper_param_path = [path_conf[x] for x in key_list]
...
import datetime
from xquant.compute.aimr import AIMR
today = 20210406#int(AIMR.getParam())
