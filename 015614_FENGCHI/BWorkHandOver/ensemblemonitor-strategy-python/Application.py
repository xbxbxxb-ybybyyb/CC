...
from Application930 import Application930
...
# [path_conf[x] for x in ['local_config_path', 'holding_info_path', 'hyper_param_path','code_list_path', 'model_config_path', 'buy_time_info_path', 'vol_info_path', 'init_conf_path', 'daily_out_path', 'ratio_path']]
