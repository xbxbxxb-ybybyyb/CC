...
def calc_back_test_record(long_threshold, short_threshold, per_amt_ratio, initial_cash, deal_ratio, tag, alpha_pool_tag, base_dir,strategy_path):
    start = 20220323
    import datetime
    ...
    for date in date_list:
        ...
        temp_pool = get_nonfix_in_val('code_list',date,strategy_path)
        restrict_list = get_nonfix_in_val('restrict_list',date,strategy_path)
...
if __name__ == '__main__':
    ...
    b_dir = '/data/user/015664/AFuckingTrigger/限制买入和持仓/仿真回测NonFix8ModelDropProbFactor20220323NewVal/'
    ...
    calc_back_test_record(long_threshold=0.05, short_threshold=0, per_amt_ratio=0.005, initial_cash=50000000,
                          ...
                          alpha_pool_tag=None,strategy_path=strats_path)
