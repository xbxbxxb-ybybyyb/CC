...
sys.path.append('/data/user/015614/BWorkHandOver/ensemblemonitor-StrongStockModel-python')
...
# os.system(f'cp -r /data/group/800319/strategy_local_path3/morning_model/*  {non_fix_path}/morning_model/')
try:
