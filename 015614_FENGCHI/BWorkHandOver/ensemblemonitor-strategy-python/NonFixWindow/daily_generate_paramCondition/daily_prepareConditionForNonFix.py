...
def generation(today):
    ...
    # para_list.append()
    signal = get_singal(0.05, 'XGB_DTC_Matrix', get_pre_trade_date(today, 30), today, f'/data/user/015664/AFuckingTrigger/限制买入和持仓/信号存储/非固定时点近30日NoCatLight/')
...
if __name__ == '__main__':
    ...
    for t_day in get_date_range(20220303,20220316):#[get_recent_trade_date()]:
