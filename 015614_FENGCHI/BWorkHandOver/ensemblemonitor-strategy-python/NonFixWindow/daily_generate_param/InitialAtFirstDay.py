...
from online_conf import non_fix_930_path,non_fix_in_path

POSITION_CHANGING = True
init_at_first_day(get_pre_trade_date(get_recent_trade_date(),-1),cash=50000000,cash_930=7000000,reinitial_930=True)
