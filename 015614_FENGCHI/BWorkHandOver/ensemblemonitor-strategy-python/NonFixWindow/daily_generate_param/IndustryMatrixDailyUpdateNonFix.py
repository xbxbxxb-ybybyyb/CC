...
def update_restrict_list(date):
    available_pool = pd.read_excel(f'/data/group/800442/800319/strategy_local_path/restrict_list/证券池{date}.xls')
    black_list = pd.read_excel(f'/data/group/800442/800319/strategy_local_path/restrict_list/黑名单{date}.xls')
    ...
    send_message(['015664'],f'不可交易名单长度  {len(restrict_list)}')
