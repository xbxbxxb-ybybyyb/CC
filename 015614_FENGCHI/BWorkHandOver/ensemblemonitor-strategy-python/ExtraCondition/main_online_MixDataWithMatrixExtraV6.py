...
local_config_path = '/data/group/800319/strategy_local_path3_ForExtra/'
...
backtest_list = [(x, get_pre_trade_date(x, -1)) for x in get_date_range(20210913,20210928)]
...
# import shutil
# for each in ['V6_2_2','V6_2_3','V7']:
#     shutil.copytree('/data/group/800319/strategy_local_path3_ForExtra/',f'/data/group/800319/strategy_local_path3_ForExtra_{each}/')
#
# import shutil
