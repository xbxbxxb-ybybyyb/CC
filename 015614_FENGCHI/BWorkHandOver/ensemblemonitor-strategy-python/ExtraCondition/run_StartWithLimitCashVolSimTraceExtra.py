...
from StrongStockModel.backtest.StrategyBackTest.DerivativeStrategy.StartWithLimitCashVolConsiderPredConsiderV4_2 import StartWithLimitCashVolConsider, InitailCashBasedEvaluationHelper
...
per_amt_ratio = 0.005
down_signal_ratio,signal_threshold,swing_threshold = (0.5,0.2,0)
per_ratio_change = {
}
...
base_dir =  '/data/user/015664/AFuckingTrigger/限制买入和持仓/仿真回测Extra/'
...
instance = StartWithLimitCashVolConsider(pred_ret, backtest_start_date, pre_date, stock_pool=alpha_pool, target_point=bar_list, buy_cost=cost, sell_cost=cost,
                                                     per_amt_ratio=per_amt_ratio, append_param={'deal_price_path': deal_price_path + 'deal_price_vwap_30min_FullSample.pkl',
                                                                                                'not close pickle':0},
                                                     deal_percent=deal_ratio, initial_cash=initial_cash, signal_threshold=signal_threshold, down_signal_ratio=down_signal_ratio,
