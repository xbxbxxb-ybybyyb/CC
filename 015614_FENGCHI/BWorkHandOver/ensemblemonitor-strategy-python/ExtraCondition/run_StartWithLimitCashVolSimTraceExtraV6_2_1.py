...
path_conf = get_path_conf('/data/group/800319/strategy_local_path3_ForExtra/')
...
per_amt_ratio = 0.005
index_pct_change, signal_threshold, swing_threshold = (0, 0.2, 0)
per_ratio_change = {
}
...
base_dir =  '/data/user/015664/AFuckingTrigger/限制买入和持仓/仿真回测ExtraV6_2_1/'
