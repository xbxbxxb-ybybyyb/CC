...
base_dir =  '/data/user/015664/AFuckingTrigger/限制买入和持仓/仿真回测Extra_Sim/'
...
pd.to_pickle(instance.barly_condition_indicator, f'{base_dir}/barly_condition_indicator/%s_{pre_date}OnlineTracing.pkl' % tag)
print(f'{base_dir}/barly_condition_indicator/%s_{pre_date}OnlineTracing.pkl' % tag)
