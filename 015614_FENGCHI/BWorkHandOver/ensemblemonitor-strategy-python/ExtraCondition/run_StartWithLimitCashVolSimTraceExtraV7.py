...
from StrongStockModel.backtest.StrategyBackTest.DerivativeStrategy.StartWithLimitCashVolConsiderPredConsiderV7 import StartWithLimitCashVolConsider, InitailCashBasedEvaluationHelper
...
base_dir =  '/data/user/015664/AFuckingTrigger/限制买入和持仓/仿真回测ExtraV7/'
