...
def load_dataset(start_date, end_date, fix_factor_list, min5_factor_list, min5_adress='/arch1/group/800442/800319/MinFactorSuper/FactorFixData/Factor/'):
...
def fit_model(i, output_path, indicator_fix, indicator_daily):
    ...
    #
    # model_conf = pd.read_pickle('/data/group/800319/strategy_local_path3_ForMixSim/model_conf/model_conf20210928.pkl')
    # fix_factor_list,min5_factor_list = model_conf[0]['XGB_D'][2]['fix'],model_conf[0]['XGB_D'][2]['5min']
    # pd.to_pickle([fix_factor_list, min5_factor_list],
    # '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMultiAfterDeltaEraData20210909/XGBMultiFreqFix5minFixNolimit_train200_test10_ic_d_ic_half_d_factor_list/20210928.pkl')
    #
    # fix_factor_list, min5_factor_list = model_conf[0]['XGB_T'][2]['fix'], model_conf[0]['XGB_T'][2]['5min']
    # pd.to_pickle([fix_factor_list, min5_factor_list],
    #              '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMultiAfterDeltaEraData20210909/XGBMultiFreqFix5minFixNolimit_train200_test10_ic_t_ic_half_t_factor_list/20210928.pkl')
    #
    # fix_factor_list, min5_factor_list = model_conf[0]['XGB_C'][2]['fix'], model_conf[0]['XGB_C'][2]['5min']
    # pd.to_pickle([fix_factor_list, min5_factor_list],
    #              '/arch1/group/800442/800319/Faamonitor/PL/all_mkt_ts_norm/Fix5minMultiAfterDeltaEraData20210909/XGBMultiFreqFix5minFixNolimit_train200_test10_ic_c_ic_half_c_factor_list/20210928.pkl')
...
idx_list = list(range(146))[24:][::-1][:1]
