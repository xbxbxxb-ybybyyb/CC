...
backtest_list = [(20210924, 202108927)]
...
# from online_conf import local_config_path,daily_out_path
#
# date = 20210706
# fake_holding = pd.read_pickle(f'{local_config_path}fake_barly_info/{date}/1500.pkl')
