...
# 计算因子值，TestDay
factor_name = "AgainstBeta"
# 请研究员设置本地路径，用于存放日频因子本地检测报告
report_address = r"/data/user/015614/factor/"
start = time.time()
# 计算时间开始时间前移一段时间
# res = Runner.run([factor_name], 20140601, 20191231, options={"calc.num_cpus": 1})
res = Runner.run([factor_name], 20191201, 20191231, options={"calc.num_cpus": 1})
