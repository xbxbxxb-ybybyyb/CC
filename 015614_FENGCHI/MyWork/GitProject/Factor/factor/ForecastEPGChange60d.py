...
class ForecastEPGChange60d(BaseFactor):
    ...
    def calc_single(self,database): 
        ...
        con_forecast_stk = con_forecast_stk.reset_index()[['date','stock','RPT_DATE','C6','C4_TYPE']]
        ...
        con_forecast_stk = con_forecast_stk.loc[multiind2,['C6']].reset_index()
        ...
        C6 = con_forecast_stk['C6'].unstack()
        C6 = C6.reindex(close.columns,axis=1)

        return C6.mean()/C6.iloc[-1]