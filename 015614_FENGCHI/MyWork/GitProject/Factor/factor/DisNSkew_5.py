...
class DisNSkew_5(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        mclosev = mclose.values[-237*5:, :]
        alpha = list(map(lambda i: self.cal_low_dist(mclosev[:, i]), range(mclosev.shape[1])))
