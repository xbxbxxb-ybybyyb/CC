...
class RetAdjVolMeanRegrmse_1_1(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        mvolume_rpl_zscore = np.divide(np.subtract(mvolume_rpl.values[-237:, :], volume_mean), volume_std)  # 做zscore
        mrev = np.multiply(mrtns[-237:, :], mvolume_rpl_zscore * 1000)  # "收益"
        mvolume_rpl = mvolume_rpl.values[-237:, :]
