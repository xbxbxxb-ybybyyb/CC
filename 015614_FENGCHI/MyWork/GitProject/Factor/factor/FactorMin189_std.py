...
class FactorMin189_std(BaseFactor):
    #  定义因子参数
    ...
    depend_data = ['FactorData.Basic_factor.limit_status_minute',"FactorData.Basic_factor.close_minute", "FactorData.Basic_factor.volume_minute","FactorData.Basic_factor.high_minute","FactorData.Basic_factor.low_minute","FactorData.Basic_factor.open_minute"]
    ...
    def calc_single(self, database):
        ...
        ##开盘等于最低价
        condition1=(data4==data3)
        
        ##开盘等于最高价
        condition2=(data4==data2)
