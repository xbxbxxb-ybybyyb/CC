...
class LatestRetRatio(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute_close_period = minute_close.iloc[-27:,:]
        minute_ret_period = minute_close.pct_change(3)
        ret_period_max = minute_ret_period.max()
        return ret_period_max
