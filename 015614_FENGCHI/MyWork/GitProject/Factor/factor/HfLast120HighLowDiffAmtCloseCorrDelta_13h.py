...
class HfLast120HighLowDiffAmtCloseCorrDelta_13h(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        minute_swing_diff_amt = (MinuteHigh - MinuteLow) * MinuteVolume
        df_factor = -Util.array_coef(minute_swing_diff_amt[-120:],MinuteClose[-120:])

        return df_factor

    def reform(self, temp_result):
        res = temp_result-temp_result.shift(1)
        return res
