...
class FactorMin200_meandivstd(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##last
        data1_last_mean=data1.iloc[:-30].mean()   
        
        ##now
        data1_current=data1.iloc[-30:]        
        
        data1_current=data1_current[data1_current>data1_last_mean]
        
        
        ans =data1_current.count()/30
