...
class FactorMin3_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        data1_last = data1_cal.loc[last_date]
        data1_current=data1_cal.loc[current_date]
        
        data2_last= data2_cal.loc[last_date]
        data2_current=data2_cal.loc[current_date]
        
        ##计算部分
        minute_corr1=Util.array_coef(data1_last,data2_last)
        
        minute_corr2=Util.array_coef(data1_current,data2_current)
    
        ans=minute_corr1-minute_corr2
