...
class HF_VmL2HmVStdRatio10minBias(BaseFactor):
    """
    * 因子名：HF_VmL2HmVStdRatio10minBias_13h
    ...
    * 因子创建日期： 2019.9.20
    ...
    #     rolling_high = high.rolling(window=10,min_periods=1).mean()
    #     rolling_low = low.rolling(window=10,min_periods=1).mean()
