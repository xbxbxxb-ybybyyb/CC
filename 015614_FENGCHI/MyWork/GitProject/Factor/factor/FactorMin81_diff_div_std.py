...
class FactorMin81_diff_div_std(BaseFactor):
    #  定义因子参数
    # 因子频率，。默认为日频因子， 可不设置
    factor_type = "FIX"
    ...
    def calc_single(self, database):
        ...
        ##考虑open_up
        data3_r=(data3-data3.shift(1))/abs(data3.shift(1))        
        
        data2_up=data2[(data3_r>0)]
        
        data2_down=data2[(data3_r<0)]
        
        ans =data2_up.std()/data2_down.std()   
