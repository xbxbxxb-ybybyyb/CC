...
class MinuteTERtnVRatio(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        minute_volume_high_rtn = volume_minute[-60:][condi1]
        minute_volume_low_rtn = volume_minute[-60:][condi2]
        result = -(minute_volume_high_rtn.mean() / minute_volume_low_rtn.mean()).rank()
