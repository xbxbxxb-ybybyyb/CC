...
class FactorMin159_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##进行回归
        up_res=data1_r_up.apply(get_regression_res)
        ...
        down_res=data1_r_down.apply(get_regression_res)
