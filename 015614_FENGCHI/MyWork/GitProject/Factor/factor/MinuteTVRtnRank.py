...
class MinuteTVRtnRank(BaseFactor):
    #  定义因子参数
    ...
    depend_data = ["FactorData.Basic_factor.close_minute", "FactorData.Basic_factor.close"]
    ...
    def calc_single(self, database):
        ...
        minute_ret_down = minute_ret[minute_ret < 0]
        ret_mean_ratio = minute_ret_up.mean(axis=0) / minute_ret_down.mean(axis=0)
        return ret_mean_ratio
