...
class LogAmt_1(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        ans_df = np.nanmean(np.log(minute30_amt),axis=0)
        ans = pd.Series(ans_df, index=minute_amt.columns)
        return ans
    ...
    def reform(self, temp_result):
        ...
        factor_values = factor_values.rolling(window=self.reform_window).mean()
