...
class CloseCapVolumeRRBias(BaseFactor):

    factor_type = 'DAY'
    depend_data = ["FactorData.Basic_factor.close", "FactorData.Basic_factor.amt","FactorData.Basic_factor.free_float_shares"]
    ...
    def calc_single(self, database):
        ...
        high = database.depend_data["FactorData.Basic_factor.close"]
    ...
    def reform(self, temp_result):
        return -(temp_result-temp_result.rolling(self.reform_window).mean())/temp_result.rolling(self.reform_window).mean()
