...
class FactorMin95_mean(BaseFactor):
    #  定义因子参数
    # 因子频率，。默认为日频因子， 可不设置
    factor_type = "FIX"
    ...
    def calc_single(self, database):
        ...
        atr_up=atr[pd.DataFrame(data1_temp>0,columns=data1.columns,index=data1.index)]
        
        atr_down=atr[pd.DataFrame(data1_temp<0,columns=data1.columns,index=data1.index)]   
