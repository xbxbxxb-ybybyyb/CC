...
class HighLowStdRatio_meandivstd5(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute30_low = minute_high.resample("30T", label="right").min().dropna(axis=0, how='all').iloc[
                       -8 * (self.lag):, :]
        delta = (minute30_high - minute30_low)
