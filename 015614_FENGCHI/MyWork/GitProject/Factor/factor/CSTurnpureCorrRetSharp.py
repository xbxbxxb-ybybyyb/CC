...
class CSTurnpureCorrRetSharp(BaseFactor):
    """

    *因子名 : CSTurnpureCorrRetSharp
    *因子功能描述 : 量价齐飞因子变形，计算横截面当日turn与前一日turn回归残差与每日return之间的相关系数,
                计算rolling5日的sharp作为因子
    ...
    *修改原因 :  尚未修改
    ...
    def reform(self, temp_result):
        return temp_result.rolling(window=5,min_periods=1).mean()/temp_result.rolling(window=5,min_periods=1).std()        
