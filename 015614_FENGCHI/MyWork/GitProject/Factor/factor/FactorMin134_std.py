...
class FactorMin134_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##白色蜡烛线
        black_current=data1_current<data2_current   
        ...
        Per=black_current.apply(sum)/black_current.shape[0]+condition.apply(sum)/condition.shape[0]
