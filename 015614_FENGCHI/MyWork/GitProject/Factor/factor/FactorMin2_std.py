...
class FactorMin2_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        data1_last = data1.loc[last_date]
        data1_current=data1.loc[current_date]
        
        data2_last= data2.loc[last_date]
        data2_current=data2.loc[current_date]
