...
class FactorMin26_mean(BaseFactor):
    #  定义因子参数
    # 因子频率，。默认为日频因子， 可不设置
    factor_type = "FIX"
    ...
    def calc_single(self, database):
        ...
        ##begin 30     
        data1_last = data1_cal.iloc[0:30,]
        ##end 30
        data1_current=data1_cal.iloc[-30:]
        
        data2_last= data2_cal.iloc[0:30]
        data2_current=data2_cal.iloc[-30:]
