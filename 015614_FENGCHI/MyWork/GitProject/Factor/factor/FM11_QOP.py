...
class FM11_QOP(BaseFactor):

 
    factor_type = "DAY"
    # 定义万得A股财务指标数据库的名称
    s_Wind = 'FactorData.FDD_CHINA_STOCK_QUARTERLY_WIND.qfa_operateincome'
    ...
    def calc_single(self, database):
        ...
        ##选取报告发布日前的信息
        data= data_old[['qfa_operateincome']]
        ...
        #第二步运算：同比运算
        datatemp2=(datatemp2-datatemp2.shift(periods=4))/abs(datatemp2.shift(periods=4))
