...
class MinBum(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        numtrade_minute = database.depend_data['FactorData.Basic_factor.buytradenum_minute']
    ...
    def reform(self, temp_result):
        return temp_result.rolling(5,1).apply(self.weight)