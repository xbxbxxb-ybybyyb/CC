...
class er_percrank_raw_std_short(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        subret_extreme = subret_extreme[subret_extreme['date']==subret_extreme['date'][-1]]
        subret_extreme = subret_extreme.iloc[:,:-1].sum(axis=0)
