...
class IndexCloseCorr(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute_close = data_filter(database.depend_data['FactorData.Basic_factor.close_minute'], limit_status,
                                   method='minute')
        index_000905 = database.depend_data['FactorData.Basic_factor.close-index_minute']['000905.SH']

        # df = ut.array_coef(minute_close, index_000905)
        df = minute_close.corrwith(index_000905)
        return df
