...
class FactorMin165_mean(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        data2_3=pd.DataFrame((data2.values-data3.values)/data3.values,columns=data1.columns, index=data1.index)    
        data2_3_flag=data2_3.apply(quantile_flag,flag_dir=False)

        data1_up=data1[pd.DataFrame(data2_3_flag.values>0,columns=data2.columns,index=data2.index)]
