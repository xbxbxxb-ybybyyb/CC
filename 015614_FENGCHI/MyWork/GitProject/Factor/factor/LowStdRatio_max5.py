...
class LowStdRatio_max5(BaseFactor):
    #  定义因子参数
    ...
    depend_data = ["FactorData.Basic_factor.low_minute","FactorData.Basic_factor.limit_status_minute"]
    ...
    def calc_single(self, database):
        ...
        minute30_low = minute_low.resample("30T", label="right").min().dropna(axis=0, how='all').iloc[
                       -8 * (self.lag)-1:, :]
        delta = (minute30_low - minute30_low.shift(1)).iloc[1:,:]
