...
class CloseCorrVolume_5(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute_close_value = minute_close.iloc[-30:, :]
        minute_volume = data_filter(database.depend_data['FactorData.Basic_factor.volume_minute'],limit_status,method='minute')
        minute_volume_value = minute_volume.iloc[-30:, :]

        ans_df = arraycoef(minute_close_value, minute_volume_value)
