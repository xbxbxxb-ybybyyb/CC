...
class FactorMin161_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##成交量打标记
        data2_flag=data2.apply(quantile_flag,flag_dir=False)

        ##放量
        data1_up=data1[pd.DataFrame(data2_flag.values>0,columns=data2.columns,index=data2.index)]
