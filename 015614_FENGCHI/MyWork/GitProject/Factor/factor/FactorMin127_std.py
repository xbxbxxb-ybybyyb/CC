...
class FactorMin127_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##收益数据
        data2_r=(data2-data2.shift(1))/data2.shift(1)
        data1_r=(data1-data1.shift(1))/data1.shift(1)

        data1_up=data1_r[data2_r>0]   
        
        data1_down=data1_r[data2_r<0] 
