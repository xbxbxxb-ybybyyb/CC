...
class HF_LinearHighDiffSkew_13h(BaseFactor):
    """
    * 因子名：HF_LinearHighDiffSkew_13h
    * 因子功能描述：T日开盘到当前时刻价格的线性趋势线与分钟最高价之差的偏度
    * 因子参数：MinuteHigh, MinuteClose
    * 作者：游加平
    * 因子创建日期： 2019.11.01
    """
    factor_type = "FIX"
