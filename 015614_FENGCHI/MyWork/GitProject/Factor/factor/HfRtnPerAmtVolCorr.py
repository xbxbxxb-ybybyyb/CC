...
class HfRtnPerAmtVolCorr(BaseFactor):
    factor_type = "FIX"
    depend_data = ["FactorData.Basic_factor.close_adj_minute", "FactorData.Basic_factor.volume_adj_minute", "FactorData.Basic_factor.amt_minute"]
    lag = 1
    ...
    def calc_single(self, database):
        ...
        ans = self.array_coef(minute_rtn_per_amt, minute_volume[1:])
