...
class FactorMin221_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##之后的30分钟
        data1_last=data1.iloc[-60:-30]
        data2_last=data2.iloc[-60:-30]
        
        ans =Util.array_coef(data1_current,data2_current)-Util.array_coef(data1_last,data2_last)
