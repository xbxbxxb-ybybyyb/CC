...
# developer 012620_shp

class UpSpeed(BaseFactor):
    """
    """
    factor_type = "DAY"
    ...
    def calc_single(self, database):
        ...
        loc_min = Close.apply(func_min)
        aroon_up = (length - loc_min)/length
        ret_min = (Close.iloc[-1]-Close.min())/Close.min()
        ret_speed_down = ret_min/aroon_up # 收益率相对up速度
