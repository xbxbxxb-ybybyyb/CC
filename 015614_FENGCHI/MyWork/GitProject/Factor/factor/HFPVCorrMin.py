...
class HFPVCorrMin(BaseFactor):

    '''
    * 因子名：HFPVCorrMin_13h
    * 逻辑：最高价和最低价的差和均价相关性的5日最小值。高低差越大说明短期波动大，炒作可能性更高，价格和其相关性越小受其影响越小，获得超额概率越大。
    * 因子参数：分钟数据高低量额
    * 作者：xust
    * 日期：2019.7.12
    * 函数修改日期：尚未修改
    ...
    * 修改原因：尚未修改
    ...
    def reform(self, temp_result):
        return temp_result.rolling(window=5, min_periods=5).min()
