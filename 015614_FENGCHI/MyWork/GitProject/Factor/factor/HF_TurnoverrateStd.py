...
class HF_TurnoverrateStd(BaseFactor):
    """
    *因子名 : HF_TurnoverrateStd_13h
    *因子功能描述 : 分钟换手率（成交量除以总股本）来表示分钟的非流动性，其波动率表示捕捉非流动性的异常
    ...
    *因子创建日期 : 2019.6.21
    ...
    def calc_single(self, database):
        ...
        return res
    def reform(self, df):
        df = df.rolling(window=10,min_periods=1).std()
