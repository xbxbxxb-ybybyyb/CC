...
class GTJA8_mean5(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        min_high = data_filter(database.depend_data['FactorData.Basic_factor.high_minute'], limit_status,
                               method='minute')
        ...
        min_volume = data_filter(database.depend_data["FactorData.Basic_factor.volume_minute"], limit_status,
                                 method='minute')
        ...
        vwap.loc[pd.Timestamp(current_date), :] = min_forward_adj(min_amt.sum(axis=0) / min_volume.sum(axis=0),
