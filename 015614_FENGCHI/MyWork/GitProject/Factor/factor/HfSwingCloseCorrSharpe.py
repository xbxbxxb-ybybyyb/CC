...
class HfSwingCloseCorrSharpe(BaseFactor):
    factor_type = "FIX"
    depend_data = ["FactorData.Basic_factor.close_adj_minute", "FactorData.Basic_factor.high_adj_minute", "FactorData.Basic_factor.low_adj_minute"]
    lag = 1
    reform_window = 10
    ...
    def calc_single(self, database):
        ...
        minute_swing = minute_high / minute_low        
        ans = self.array_coef(minute_swing, minute_close)
