...
class RollingRetCorrPctg_10(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        close = minute_close.values[1:,:]
        close_pre = minute_close.values[:-1,]
        close_price_chg = close /close_pre - 1
        ans_df = arraycoef(close_price_chg[:-1,:], close_price_chg[1:,:])
