...
class FactorMin201_mean(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##last
        data2_last_mean=data2.iloc[:-30].mean()   
        
        ##now
        data2_current=data2.iloc[-30:]        
        
        data1_r_current_up=data1_r_current[data2_current>data2_last_mean]
        
        data1_r_current_down=data1_r_current[data2_current<data2_last_mean]

        
        ans =data1_r_current_up.mean()-data1_r_current_down.mean()
