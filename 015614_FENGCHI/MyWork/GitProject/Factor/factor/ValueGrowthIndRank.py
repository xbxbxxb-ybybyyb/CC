...
class ValueGrowthIndRank(BaseFactor):
    ...
    def calc_single(self, database):
        ...
        roe = WIND_AShareFinancialIndicator['S_FA_ROE_YEARLY'].unstack().fillna(method='ffill').iloc[-1].reindex(index=sw_indcode1.index)
