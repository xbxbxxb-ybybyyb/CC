...
class FactorMin10_meandivstd(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        data1=data1[data1_r<0]
        data2=data2[data1_r<0]
        
        minute_corr=corr1(data1,data2) 
    
        ans=pd.Series(minute_corr,index=data1.columns)
