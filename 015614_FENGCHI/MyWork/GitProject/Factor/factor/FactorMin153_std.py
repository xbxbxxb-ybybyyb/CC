...
class FactorMin153_std(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##最新30分钟的
        data_compare=data2_current
        
        ##进行回归
        curr_res=data1_r_current.apply(get_regression_res)
        
        ##之前的
        data_compare=data2_last

        last_res=data1_r_last.apply(get_regression_res)


        ans =curr_res-last_res
