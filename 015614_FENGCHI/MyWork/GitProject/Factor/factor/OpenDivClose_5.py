...
class OpenDivClose_5(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute_open_value = minute_open.values
        stock_ret = abs(minute_close_value / minute_open_value) - 1
        max_stock_ret = np.nanmax( stock_ret, axis=0)
        ...
        df_factor.loc[current_date,:] = max_stock_ret
