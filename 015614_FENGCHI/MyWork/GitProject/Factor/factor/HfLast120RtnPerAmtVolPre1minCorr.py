...
class HfLast120RtnPerAmtVolPre1minCorr(BaseFactor):
    factor_type = "FIX"
    depend_data = ["FactorData.Basic_factor.close_adj_minute", "FactorData.Basic_factor.amt_minute", "FactorData.Basic_factor.volume_adj_minute"]
    lag = 1
    ...
    def calc_single(self, database):
        ...
        minute_rtn_per_amt = minute_rtn / minute_amt[1:]
        ans = self.array_coef(minute_rtn_per_amt[-120:], minute_volume[:-1][-120:])
