...
class HF_AmtStrengthCloseSharp_13h(BaseFactor):
    """
    *因子名 : HF_AmtStrengthCloseSharp_13h
    *因子功能描述 : 成交额与收盘价的相关性,取Sharp；值越大，表示放量超买，收益越低
    ...
    *因子创建日期 : 2019.08.02
    ...
    def calc_single(self, database):
        ...
        res = Util.array_coef(close,amt_today)
        return res
