...
class CorrHighLowAvgToAmt_Mean_5(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        high_low_avg = (minute_high + minute_low) / 2
        corr_high_low_avg_amt = high_low_avg.corrwith(minute_amt, axis=0)
        return corr_high_low_avg_amt
