...
class FactorMin118_meandivstd(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        arr = data2_r.values > 0
        data1_r_up = data1_r[pd.DataFrame(arr, columns=data1.columns, index=data1.index)]        
        arr = data2_r.values < 0
        data1_r_bottom = data1_r[pd.DataFrame(arr, columns=data1.columns, index=data1.index)]        
             
        ans =data1_r_up.mean()/abs(data1_r_bottom.mean())
