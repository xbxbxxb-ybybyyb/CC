...
class HighStdRatio_max5(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        minute30_high = minute_high.resample("30T", label="right").max().dropna(axis=0, how='all').iloc[
                       -8 * (self.lag)-1:, :]
        delta = (minute30_high - minute30_high.shift(1)).iloc[1:,:]
