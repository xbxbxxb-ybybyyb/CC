...
class FactorMin155_meandivstd(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        ##进行回归
        curr_beta=data1_r_current.apply(get_regression_beta)
        
        ##之前的
        data_compare=data2_last

        last_beta=data1_r_last.apply(get_regression_beta)


        ans =curr_beta-last_beta
