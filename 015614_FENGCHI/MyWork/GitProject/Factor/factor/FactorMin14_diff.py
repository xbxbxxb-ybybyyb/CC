...
class FactorMin14_diff(BaseFactor):
    #  定义因子参数
    ...
    def calc_single(self, database):
        ...
        arr = data1_cal.values < 0
        data1_up = data1_cal[pd.DataFrame(arr, columns=data1_cal.columns, index=data1_cal.index)]
        data2_up = data2_cal[pd.DataFrame(arr, columns=data2_cal.columns, index=data2_cal.index)]     
