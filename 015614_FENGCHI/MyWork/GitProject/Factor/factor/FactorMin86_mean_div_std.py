...
class FactorMin86_mean_div_std(BaseFactor):
    #  定义因子参数
    # 因子频率，。默认为日频因子， 可不设置
    factor_type = "FIX"
    ...
    def calc_single(self, database):
        ...
        data11=iliq[pd.DataFrame((data3_temp>0),columns=data1.columns,index=data1.index)]
        data12=iliq[pd.DataFrame((data3_temp<0),columns=data1.columns,index=data1.index)]        
             
        ans =data11.std()/data12.std()     
