...
from LimitUpPredStrategy.model.ModelImpl.LRModelReg import LRModelReg
...
if __name__ == '__main__':
    lr_model = LRModelReg(start_date=20150101, end_date=20191231, stock_pool_address=None)
    lr_model.set_skf(n_splits=5)
    train_samples, predict_samples = lr_model.get_dataset(train_start_date=20150101,
    ...
    #pred_res.to_pickle(pred_output_path + 'lr_reg_pred_signal.pkl')
