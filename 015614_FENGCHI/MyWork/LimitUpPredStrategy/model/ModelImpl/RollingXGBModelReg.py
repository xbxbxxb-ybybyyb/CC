...
class RollingXGBModelReg(RollingModelBaseReg):
    ...
    def train_model(self, X_train, y_train, params, end_date=None):
        ...
        param_self = xgb_model.get_params()
        ...
        xgb_model.set_params(**args_param)
        ...
        xgb_model = xgb_model.fit(train_features, train_label, verbose=True)
        ...
        if 'val_pred_path' in params:
            ...
            val_labels['prediction'] = self.predict(xgb_model, val_features)
        ...
        if 'train_pred_path' in params:
            ...
            train_label['prediction'] = self.predict(xgb_model, train_features)
