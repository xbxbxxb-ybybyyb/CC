...
class RollingLightGBMModelReg(RollingModelBaseReg):
    ...
    def train_model(self, X_train, y_train, params, end_date=None):
        ...
        param_self = lgb_model.get_params()
        ...
        lgb_model.set_params(**args_param)
        ...
        lgb_model = lgb_model.fit(train_features, train_label, verbose=True)
        ...
        if 'val_pred_path' in params:
            ...
            val_labels['prediction'] = self.predict(lgb_model, val_features)
        ...
        if 'train_pred_path' in params:
            ...
            train_label['prediction'] = self.predict(lgb_model, train_features)
