...
def get_basic_values(factor,start_date=20130101,end_date=None,read_path='/data/group/800442/800319/Daily_ConCept/RawData/BasicData/'):
...
def get_minute_values(factor,start_date=20140101,end_date=None,basic_date=20130101,read_path='/data/group/800442/800319/Daily_ConCept/RawData/BasicData/'):
    date_list = getData.get_date_range(start_date, end_date)
...
def get_concept_values(factor,concept,start_date=20140101,end_date=None,read_path='/data/group/800442/800319/Daily_ConCept/RawData/'):
    date_list = getData.get_date_range(start_date, end_date)
...
# Concept_UnActiveList：概念板块的不活跃个股
# Concept_DragonList：概念板块的龙头个股
def get_1stock_concept(factor,stock,start_date=20140101,end_date=None,read_path='/data/group/800442/800319/Daily_ConCept/RawData/'):
    date_list = getData.get_date_range(start_date, end_date)
...
# 近期活跃股数量
# 近期活跃股涨跌幅
def get_factor_1concept(concpet,factor=None,start_date=20140101,end_date=None,read_path='/data/group/800442/800319/Daily_ConCept/RawData/Concept_IndayData/'):
    date_list = getData.get_date_range(start_date, end_date)
    df=[]
    if factor==None:
...
##获取某一个指标在多个板块之间的结果##
def get_1factor_concept(factor,concept=None,start_date=20140101,end_date=None,use_update_time=True,read_path='/data/group/800442/800319/Daily_ConCept/RawData/Concept_IndayData/'):
    date_list=getData.get_date_range(start_date,end_date)
    start_date=date_list[0]
    end_date=date_list[-1]
    if concept==None:
...
def Get_Active_Concept(start_date,end_date,read_path='/data/group/800442/800319/Daily_ConCept/RawData/BasicData/',save_path='/data/user/015624/'):
    date_list=getData.get_date_range(start_date,end_date)
    #######读取数据#######
...
def Get_Concept_Code():
    ...
    concept_list = os.listdir('/data/group/800442/800319/Daily_ConCept/RawData/Concept_StockList/')
