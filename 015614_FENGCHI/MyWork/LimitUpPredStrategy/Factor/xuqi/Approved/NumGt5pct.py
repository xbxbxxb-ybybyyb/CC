...
class NumGt5pct(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = (zt_prem > 0.05).sum(axis=1) / zt.shift(1).sum(axis=1)
...
fc = NumGt5pct(start_date=20140102, end_date=20210715)
test = fc.calculate('NumGt5pct', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
