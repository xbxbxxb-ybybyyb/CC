...
class AllEBNum4d(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        yzb = (high == low) & zt
        factor = yzb.sum(axis=1).shift(1).rolling(4).mean()
...
fc = AllEBNum4d(start_date=20140102, end_date=20210715)
test = fc.calculate('AllEBNum4d', save_path='/arch1/group/800442/800319/ZTfactors/Approved_2021/')
