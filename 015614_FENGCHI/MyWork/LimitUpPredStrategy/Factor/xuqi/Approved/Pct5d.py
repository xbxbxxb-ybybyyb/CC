...
class Pct5d(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        pct_5d = adjclose.pct_change(5)

        factor = pct_5d.shift(1)
...
fc = Pct5d(start_date=20140102, end_date=20210715)
test = fc.calculate('Pct5d', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
