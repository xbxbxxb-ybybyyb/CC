...
class indexChg20(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        date_list = get_date_range(get_pre_trade_date(self.start_date, 30), self.end_date)
        ...
        factor = ((stk_class == 1) * (high > 0)).mul(idx_pct20['SZCZ'], axis=0) + \
                 ((stk_class == 2) * (high > 0)).mul(idx_pct20['SZZZ'], axis=0)
...
fc = indexChg20(start_date=20140102, end_date=20210715)
test = fc.calculate('indexChg20', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
