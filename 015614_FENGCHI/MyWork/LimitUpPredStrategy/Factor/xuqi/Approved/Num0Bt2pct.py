...
class Num0Bt2pct(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = ((zt_prem >= 0) & (zt_prem <= 0.02)).sum(axis=1) / zt.shift(1).sum(axis=1)
...
fc = Num0Bt2pct(start_date=20140102, end_date=20210715)
test = fc.calculate('Num0Bt2pct', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
