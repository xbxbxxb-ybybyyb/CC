...
class ZT_openningRatio(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = ZT_openningRatio.shift(1)
...
fc = ZT_openningRatio(start_date=20210615, end_date=20210715)
test = fc.calculate('ZT_openningRatio')
