...
class indexO2Cchg(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = ((stk_class == 1) * (high > 0)).mul(idx_o2c['SZCZ'], axis=0) + \
                 ((stk_class == 2) * (high > 0)).mul(idx_o2c['SZZZ'], axis=0)
...
fc = indexO2Cchg(start_date=20140102, end_date=20210715)
test = fc.calculate('indexO2Cchg', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
