...
class indexChg5(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = ((stk_class == 1) * (high > 0)).mul(idx_pct5['SZCZ'], axis=0) + \
                 ((stk_class == 2) * (high > 0)).mul(idx_pct5['SZZZ'], axis=0)
...
fc = indexChg5(start_date=20140102, end_date=20210715)
test = fc.calculate('indexChg5', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
