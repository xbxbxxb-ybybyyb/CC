...
class LnMV(object):
    ...
    def calculate(self, factor_name, save_path=None):
        ...
        factor = (np.log(float_tick*LastPx))[LimitPool].stack()
...
fc = LnMV(start_date=20140102, end_date=20210715)
test = fc.calculate('LnMV', '/arch1/group/800442/800319/ZTfactors/Approved_2021/')
