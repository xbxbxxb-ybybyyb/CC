...
expression = 'abs_sub2(deviation2(abs_sub2(TotalVolumeTrade, WeightedAvgOfferPx), sum2(TotalBidQty, abs_sub2(deviation2(abs_sub2(TotalVolumeTrade, WeightedAvgOfferPx), TotalBidQty), Sell5Price))), Sell5Price)'
basic_factors = []
