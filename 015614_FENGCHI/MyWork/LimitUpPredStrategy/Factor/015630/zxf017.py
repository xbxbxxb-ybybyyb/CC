...
expression = 'deviation2(max2(sub2(TotalBidQty, Sell5OrderQty), deviation2(Sell1OrderQty, NumOfferOrders)), mul2(sub2(TotalVolumeTrade, Buy1Price), deviation2(sub2(Buy1OrderQty, TotalValueTrade), TotalBidQty)))'
basic_factors = []
