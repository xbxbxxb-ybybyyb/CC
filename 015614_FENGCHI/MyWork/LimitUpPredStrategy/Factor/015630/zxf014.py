...
expression = 'abs_sub2(deviation2(abs_sub2(TotalVolumeTrade, WeightedAvgOfferPx), sum2(TotalBidQty, deviation2(abs_sub2(TotalVolumeTrade, WeightedAvgOfferPx), sum2(TotalBidQty, Buy3Price)))), Sell5Price)'
basic_factors = []
