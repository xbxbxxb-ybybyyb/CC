...
expression = 'deviation2(mul2(max2(Buy3NumOrders, TotalBidQty), pn_condition2(TotalVolumeTrade, Buy1Price)), abs_sub2(neg(TotalVolumeTrade), pn_condition2(LastPx, Sell1OrderQty)))'
basic_factors = []
