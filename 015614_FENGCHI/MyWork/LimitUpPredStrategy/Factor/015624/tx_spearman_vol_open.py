...
factor_name = 'spearman_vol_open'

open = getData.get_daily_1factor('open', date_list=LimitPool.index.levels[0].to_list(),code_list=LimitPool.index.levels[1].to_list()).shift(1)
...
factor = open.rolling(20).corr(vol)
