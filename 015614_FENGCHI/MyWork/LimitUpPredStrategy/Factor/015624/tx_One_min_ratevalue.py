...
# 添加依赖因子
dependencies_factors = ['LimitPool','LastPx', 'TotalValueTrade']
# 导入因子
...
factor_name = 'One_min_ratevalue'

Rate = (LastPx[93100] / LastPx[93000] -1)*100
Value = (TotalValueTrade[93100]-TotalValueTrade[93000])/1000

factor =Rate/(Value)
factor.replace(np.inf,0,inplace=True)
factor = factor.loc[LimitPool.index]
