...
def _get_fix_factor_list():
    factor_address = '/data/group/800442/800319/VeryJunkFix/'
...
class TrueSendFactorTest(object):
    ...
    def load_factor(self, factor_name, factor_type='fix', base_date=20130101,
        ...
        if factor_type == 'fix':
            ...
            factor = get_minute_1factor(factor_name, self.start_date, self.end_date, self.freq_num, self.code_list,
            ...
            factor = pd.read_hdf(factor_address + factor_name + '.h5', factor_name, start=start_idx,
                                 stop=end_idx).reindex(self.code_list, axis=1).values
...
if __name__ == '__main__':
    ...
    amt_limit = 5e5
    output_address = '/data/user/015836/TrueSendStrategy/Fix_test_common'
