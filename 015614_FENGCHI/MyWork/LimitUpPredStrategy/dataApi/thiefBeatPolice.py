...
from xquant.xqutils.utils import utils_set_timeout
...
from dataApi.thiefBeatPoliceOfficer import set_user_provider_db_pool
import threading
    ...
    def pool(sql_config, wait_time):
        try:
            __pool = PooledDB(creator=mysql, mincached=pool_config['mincached'], maxcached=pool_config['maxcached'],
                              maxconnections=pool_config['maxconnections'], maxshared=pool_config['maxshared'],
                              blocking=True,
                              host=sql_config['host'], user=sql_config['user'], passwd=sql_config['passwd'],
                              db=sql_config['db'],
