...
def start_backtest(start_date=20200101, end_date=20201231,
                   signal_df_path=None, output_path=None):
    # start_date = 20140101
    # start_date = 20210701
    # end_date = 20210903
    bomb_stock = pd.read_pickle(signal_df_path)
    ...
    bomb_stock = (bomb_stock.fillna(0)).astype(bool)
...
if __name__ == "__main__":
    # main_check()
    start_backtest(20200101, 20201231, signal_df_path=junk_path + 'zhaban_xgb_20210909.pkl')
