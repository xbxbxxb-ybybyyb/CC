...
import sys
sys.path.append('/data/group/800819/')  # 修改此处dataApi团队共享文件夹路径
...
junk_path = '/data/group/800442/800319/Afengchi/junk_data/'
param_path = '/data/group/800442/800319/Afengchi/MyOwnParaFile/'
...
class MyUtil:
    ...
    def get_stock_name_dict():
        today_date = tradeDate.get_today()
        fd = FactorData()
