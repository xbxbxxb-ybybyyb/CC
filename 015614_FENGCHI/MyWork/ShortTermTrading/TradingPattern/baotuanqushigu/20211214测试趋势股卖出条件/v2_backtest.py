...
class StockStrategyDemo(StockStrategyBase):
    ...
    def daily_update(self):
        ...
        ma5_judge3 = ma5_pct < self.sell_cond_kargs['ma5下方止损点']

        expanding_high = stk_minute['close_badj'].expanding().max()
        tmp_pct2 = (expanding_high / ma5_badj - 1) > self.sell_cond_kargs['MA5上方监测点参数']
        intra_withdraw = (stk_minute['close_badj'] / expanding_high - 1) >= self.sell_cond_kargs['MA5上方回撤参数']
        sell_signal = ma5_judge3 | (tmp_pct2 & intra_withdraw)
