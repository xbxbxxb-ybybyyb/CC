...
if __name__ == '__main__':
    print('初始化...')
    t1 = time.time()
    sg = SignalGenerator(start_date=20210601, end_date=20210712) # 因全部计算量太大，所以采用每两年计算一次，然后使用script中的脚本拼接
    ...
    rec_df.to_pickle(junk_path + '20210714fenqizhuanyizhi.pkl')