...
class SimiMethodRollingBase:
    def __init__(self, start_date=20180101, end_date=20210631, concept='SW1', discount=95,
                 history_period=120, history_future_len=(120, 5)):
    ...
    def get_rolling_date(self, trade_date, direction='future'):
        ...
        if direction is 'history':
            """history的代码没有调试好，应该还有问题，对于持有120的配置问题"""
            begin_date = trade_date
            calc_date = tradeDate.get_pre_trade_date(trade_date, 0)
            end_date = tradeDate.get_pre_trade_date(begin_date, -self.future_period)
            ...
            date_tuple_list.append((calc_date, begin_date, end_date, train_start_date, train_end_date))
            while end_date < trade_date:
                start_date = end_date
                calc_date = tradeDate.get_pre_trade_date(start_date, 0)
...
if __name__ == '__main__':
    ...
    # check = smb.get_rolling_date(20200630)
