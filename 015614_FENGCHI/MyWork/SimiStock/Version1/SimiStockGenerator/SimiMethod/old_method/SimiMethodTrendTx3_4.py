...
if __name__ == '__main__':
    ...
    for param in param_list:
        ...
        weight_kind = param[5]
        smt1 = SimiStyleMethod(start_date=20200701, end_date=20210630, concept=concept, pre_days_num=pre_days_num,
...
#        result = smt1.get_hedge_list(mode='serial', kernal_num=24)
        save_name = f'{method_name}_{hedge_max_num}_{corr_threshold}_{weight_kind}_100_20200701_20210630_result.pkl'
