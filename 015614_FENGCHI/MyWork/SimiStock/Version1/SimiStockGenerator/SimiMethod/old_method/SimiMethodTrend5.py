...
class SimiMethodTrend4(SimiMethodBase):
    def __init__(self, start_date=20180101, end_date=20211231, concept='SW1', pre_days_num=252):
        ...
        ln_pctchg = np.log1p(pctchg / 100)

        self.method_name = '日频pctchg对数相关性'
        self.pctchg = ln_pctchg
...
if __name__ == '__main__':
    ...
    for param in param_list:
        ...
        smt1 = SimiMethodTrend4(start_date=20200101, end_date=20201231, concept=concept, pre_days_num=pre_days_num)
        result = smt1.get_hedge_list(mode='serial', kernal_num=20)
