# coding: utf-8
# Author：fengchi863
# Date ：2022/4/16 17:21

"""
将2020年的样本提前，由此会导致一部分问题
这个问题目前使用clean_stock来解决
"""
...
class SimiStyleMethod(SimiMethodBase):
    ...
    def simi_strategy(self, stk_id, trade_date, concept_list):
        ...
        if not self.clean_stock.loc[trade_date, stk_id]:
            return list(), list(), list()
...
#        end_date = 20201231
        ...
        save_name = f'{method_name}_{hedge_max_num}_{corr_threshold}_{weight_kind}_95_{start_date}_{end_date}_2020to2018_result.pkl'
