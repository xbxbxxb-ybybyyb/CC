...
class SimiMethod1(SimiMethodRollingBase):
    ...
    def get_kline_score(self, stk_id, train_date_list, concept_list):
        ...
        high = getData.get_daily_1factor('high_badj', date_list=train_date_list)
        low = getData.get_daily_1factor('low_badj', date_list=train_date_list)
...
if __name__ == '__main__':
    param_dict = {'method_name': ['2nd叠加K线相似度'],
                  'concept': ['SW1'],
                  'hedge_max_num': [7],
