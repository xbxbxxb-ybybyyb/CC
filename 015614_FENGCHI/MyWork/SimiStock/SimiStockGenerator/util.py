...
from SimiStock.dataApi.sendInfo import send_file, send_message
...
class Util:
    ...
    @staticmethod
    def send_file(file_path, file_name, user=['015614']):
        send_file(user, file_path + file_name)

    @staticmethod
    def send_message(content, user=['015614']):
