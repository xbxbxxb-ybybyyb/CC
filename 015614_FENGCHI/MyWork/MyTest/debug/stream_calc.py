...
def calc_callback(self, df_dict):
    ...
    print('finish calculation! now mdtime {} {}!'.format(df_dict['kline1m']['MDTime'].iloc[-1], df_dict['kline1m']['HTSCSecurityID'].iloc[-1]))
    return None
...
run_realtime_calculation_by_securities(data_input_account="015278",
