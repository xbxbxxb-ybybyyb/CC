...
class StockEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.update_reward()
        print(f'episode:{self.episode}|{next_point}|cash:{self.cash}|equity:{cap}|reward:{self.reward}|total:{self.cash + cap}|step profit:{((self.cash + cap) / self.accout_value[-2] - 1) * 100:.2f}')
