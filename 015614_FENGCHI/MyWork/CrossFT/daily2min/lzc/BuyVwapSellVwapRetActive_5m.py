...
# @Author : Zhichen Lu
# @File : BuyVwapSellVwapRetActive.py
import sys
...
class BuyVwapSellVwapRetActive_5m(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 15
    author = 'lzc'
    logic = '卖单VWAP对买单VWAP收益率对分组收益的超额收益的截面zscore'
    article = ''
    freq = '5mins'
    ...
    def cal_groupst(self):
        ...
        factor = (active - st2groupst(active, minute_group, cross_mean)) / st2groupst(active, minute_group, cross_std)
