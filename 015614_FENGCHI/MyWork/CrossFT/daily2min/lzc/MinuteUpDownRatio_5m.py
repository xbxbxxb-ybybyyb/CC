...
class MinuteUpDownRatio_5m(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 15
    author = 'lzc'
    logic = '5分钟bar上超过或两倍标准差的bar的数量/小于-2被标准差的数量 * 组的该值 前日T时刻到当日T时刻为1天'
    ...
    def cal_groupst(self):
        ...
        lower_neg2_std_count = intrad_past_day_rolling_sum(z_close, z_close < -2)
