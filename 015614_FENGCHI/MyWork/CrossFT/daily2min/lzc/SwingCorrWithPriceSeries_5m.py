...
# @Author : Zhichen Lu
# @File :SwingCorrWithPriceSeries_5m.py
...
class SwingCorrWithPriceSeries_5m(crossFactor):
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 0
    author = 'lzc'
    logic = '分钟K涨跌幅 与 价格相关性 * 截面相关性 前日T时刻到当日T时刻为1天'
    article = ''
    freq = '5mins'
    ...
    def cal_groupst(self):
        ...
        return arr_match_index(group_corr * stk_corr, self.cal_date_range, self.date_range)
