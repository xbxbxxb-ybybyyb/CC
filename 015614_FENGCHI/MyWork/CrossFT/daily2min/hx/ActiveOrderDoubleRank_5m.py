...
class ActiveOrderDoubleRank_5m(crossFactor):
    cross_group='sw1'
...
if __name__=='__main__':
    # f = ActiveOrderDoubleRank()
    # print(f.result())
    # val1 = cal_factor('data/user/015836/HANXU/jithub/crossft/factors/hx', 'ActiveOrderDoubleRank_5m.py', {'daily': 1}, notrun=False)
    # val1 = cal_factor()
