...
class AmendActiveBuyRetLagCorrProdRet(crossFactor):
    cross_group='sw1'
    cross_func='cross_mean'
    extend_days=20
    author='hx'
    logic='收益率修正的主买成交额与过去10日均值的行业值与个股收益率的滞后相关系数与个股收益率的乘积'
    ...
    def cal_groupst(self):
        ...
        res = dt_corr2(res, ret, 24)
        res = dt_delay(res, 6)
        return res

    def cal_customst(self):
        return self.cal_groupst() * self.st_factor()
