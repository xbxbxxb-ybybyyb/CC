...
class BigOrderSkewRIR(crossFactor):
    cross_group='sw1'
    cross_func='cross_mean'
    extend_days=2
    author='hx'
    logic='大成交量下收益率偏度 个股排序与行业排序和'
    ...
    def st_factor(self):
        ...
        factor = dt_skew(zero_condition2(reducen(dt_rank(turn, 242), 0.7), ret), 242)
        return factor
...
if __name__=='__main__':
    ...
    # val1 = cal_factor(numd={'1min': 1}, logic='...')
    # val2 = cal_factor(numd={'1min': 5}, logic='...')
