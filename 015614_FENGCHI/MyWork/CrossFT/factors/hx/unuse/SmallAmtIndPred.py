...
def cs_pred3(y, x1, x2):
    ...
    yh = e12 * (y * e12).sum(axis=2)[..., None] + x2 * (y * x2).sum(axis=2)[..., None]
    return yh

class SmallAmtIndPred(crossFactor):
    cross_group='sw1'
    cross_func='cross_mean'
    extend_days=10
    author='hx'
    logic='行业平均市值和成交额预测的小单成交额'
    ...
    def cal_customst(self):
        ...
        res = cs_pred3(small_amt, amt, mkt_cap_ard)
        res = dt_mean(res, 10)
