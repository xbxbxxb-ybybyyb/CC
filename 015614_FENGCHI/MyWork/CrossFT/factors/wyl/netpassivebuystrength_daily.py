...
class netpassivebuystrength_daily(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    extend_days = 1
    author = 'wyl'
    logic = '''净主买强度 = mean（被动买入金额（成交量）-被动卖出金额（成交量））/std（被动买入金额（成交量）-被动买入金额（成交量））'''
    ...
    def st_factor(self):
        ...
        strength_daily = cross_resample(strength,'daily')
