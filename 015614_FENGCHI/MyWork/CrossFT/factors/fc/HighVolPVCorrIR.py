...
class HighVolPVCorrIR(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    extend_days = 5
    author = 'fc'
    freq = 'daily'
    logic = '成交量聚集度较高时段的价量相关性'
    article = ''
    ...
    def cal_groupst(self):
        ...
        ret = st2groupst(corr, group,  self.group_func())
...
if __name__ == '__main__':
    # f = HighVolPVCorrIR(start=20210401, end=20210501)
    # print(f.result())

    val = cal_factor('/data/user/015614/MyWork/CrossFT/factors/fc', 'HighVolPVCorrIR.py', {'daily': 6}, notrun=False)
