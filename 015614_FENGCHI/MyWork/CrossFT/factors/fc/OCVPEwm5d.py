...
class OCVPEwm5d(crossFactor):
    cross_group = 'sw2'
    cross_func = 'cross_mean'
    extend_days = 10
    author = 'fc'
    freq = 'daily'
    logic = '个股开盘集合竞价阶段成交量占比按权重加权 - 组内集合竞价阶段成交量占比按权重加权'
    article = ''
    ...
    def calc_groupst(self):
        ...
        group_call_auction_amt_pct = st2groupst(amt1, self.group,  self.group_func()) / st2groupst(amt2, self.group, self.group_func())
