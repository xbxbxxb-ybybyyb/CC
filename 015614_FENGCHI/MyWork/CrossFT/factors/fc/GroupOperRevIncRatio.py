...
class GroupOperRevIncRatio(crossFactor):
    cross_group = 'sw2'
    cross_func = 'cross_mean'
    extend_days = 250
    author = 'fc'
    # logic = '个股营收TTM增速 - 组内平均营收TTM增速'
    logic = '组内平均营收TTM增速'
    article = '基于股票因子映射的行业轮动方法'
    freq = 'daily'
    basic_datas = {'daily': ['oper_rev_ttm']}

    def st_factor(self):
        oper_rev_ttm = self.database['daily']['oper_rev_ttm']
        return oper_rev_ttm
