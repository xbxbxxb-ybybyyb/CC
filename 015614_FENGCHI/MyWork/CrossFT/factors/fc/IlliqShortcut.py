...
class IlliqShortcut(crossFactor):
    cross_group = 'sw1'
    ...
    article = ''
    basic_datas = {'daily': ['open', 'close', 'high', 'low', 'amt'], '30mins': [], '5mins': [], '1min': []}
...
if __name__ == '__main__':
    ...
    val = cal_factor('/data/user/015614/MyWork/CrossFT/factors/fc', 'IlliqShortcut.py', {'daily': 6}, notrun=False)
