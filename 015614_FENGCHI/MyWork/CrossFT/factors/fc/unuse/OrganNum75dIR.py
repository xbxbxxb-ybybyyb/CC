...
class OrganNum75dIR(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 0
    author = 'fc'
    freq = 'daily'
    logic = '个股的75日内机构覆盖数比例 个股排名 + 分组排名'
    ...
    def st_factor(self):
        ...
        organ_number = fd.get_factor_value('Basic_factor',
                                     ...
                                     factor_names=['organ_number75'])
        organ_number2 = organ_number.reset_index()
        organ_number3 = organ_number2.pivot(index='mddate', columns='stock', values='organ_number75')
