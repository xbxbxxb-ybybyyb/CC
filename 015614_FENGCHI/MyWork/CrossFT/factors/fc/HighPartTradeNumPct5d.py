...
class HighPartTradeNumPct5d(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    extend_days = 10
    author = 'fc'
    logic = '日内高价区间内成交笔数占比5日取均值 行业内均值'
    ...
    def st_factor(self):
        ...
        return dt_mean(high_price_pct, 5)
...
if __name__ == '__main__':
    # f = HighPartTradeNumPct5d(start=20210401, end=20210501)
    # print(f.result())

    val = cal_factor('/data/user/015614/MyWork/CrossFT/factors/fc', 'HighPartTradeNumPct5d.py', {'daily': 6}, notrun=False)
