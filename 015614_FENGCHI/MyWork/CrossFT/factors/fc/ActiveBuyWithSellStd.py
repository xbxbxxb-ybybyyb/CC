...
class ActiveBuyWithSellStd(crossFactor):
    cross_group = 'sw1'
    ...
    def calc_groupst(self):
        ...
        group_buy_std = ts_cumstd(group_activebuyorderamt)
        group_sell_std = ts_cumstd(group_activesellorderamt)
        ret = group_buy_std / group_sell_std
