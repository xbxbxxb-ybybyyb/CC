...
class IndustryMCI_Active(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    ...
    def cal_groupst(self):
        ...
        return arr_match_index(MCIA_stk * MCIA_group, self.cal_date_range, self.date_range)
