...
# @Author : Zhichen Lu
# @File : UpSellCancelDownBuyCancelRatio_daily.py
import sys
...
class UpSellCancelDownBuyCancelRatio_daily(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '上行委买撤单与下行委买撤单比例'
    article = ''
    freq = 'daily'
    basic_datas = {'daily': ['a_mkt_cap'], '30mins': [], '5mins': ['buyordercanceledamt', 'sellordercanceledamt', 'close'], '1min': []}
    ...
    def cal_groupst(self):
        ...
        '''
        buyordercanceledamt, sellordercanceledamt, close = [self.database['5mins'][x] for x in
                                                            ['buyordercanceledamt', 'sellordercanceledamt', 'close']]
        ...
        factor = up_cancel_sell_tradeamt * down_cancel_buy_tradeamt / (group_up_cancel_sell_tradeamt * group_down_cancel_buy_tradeamt)
