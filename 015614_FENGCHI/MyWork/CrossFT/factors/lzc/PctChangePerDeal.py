...
class PctChangePerDeal(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 15
    author = 'lzc'
    logic = '当日日内涨跌幅/成交笔数  *  组内涨跌幅之和/组内成交笔数之和'
    article = '中信建投	20200709	因子深度研究系列	高频量价选股因子初探'
    freq = 'daily'
    basic_datas = {'daily': ['close', 'open'], '30mins': [], '5mins': ['numtrade'], '1min': []}
