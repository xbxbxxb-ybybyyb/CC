...
# @Author : Zhichen Lu
# @File : ActiveSellPassiveSellOrderPressure_daily_std.py
...
class ActiveSellPassiveSellOrderPressure_daily_std(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 15
    author = 'lzc'
    logic = '新增主动委托卖出量/新增被动卖出量 *  行业用自由流通股本折算后的量之比  日内波动'
    article = ''
    freq = 'daily'
...
if __name__ == '__main__':
    ...
    f = ActiveSellPassiveSellOrderPressure_daily_std()
    # e = time.time()
    # f.result()
    # f.save_result()
