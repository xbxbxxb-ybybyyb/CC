...
# @Author : Zhichen Lu
# @File : UpBuytradeAmt2DownSellTradeAmt.py
import sys
...
class UpBuytradeAmt2DownSellTradeAmt(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '截面上分组内上行主动买入额/截面上分组下行主动卖出额 * 个股主动买卖之比'
    article = ''
    freq = '5mins'
    ...
    def cal_groupst(self):
        ...
        return arr_match_index(buytradeamt * group_ratio / selltradeamt, self.cal_date_range, self.date_range)
