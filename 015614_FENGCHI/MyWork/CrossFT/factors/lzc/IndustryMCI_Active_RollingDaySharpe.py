...
# @Author : Zhichen Lu
# @File : IndustryMCI_Active_RollingDaySharpe.py
import sys
...
class IndustryMCI_Active_RollingDaySharpe(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '根据逻辑计算个股 主动订单部分(新增主动委买+新增主动委卖) 流动性 并 衍生分组主动订单流动性 相乘 滚动240分钟取sharpe'
