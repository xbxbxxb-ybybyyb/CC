...
# @Author : Zhichen Lu
# @File : ActivePassiveTurnOverRatio_daily.py
import sys
...
class ActivePassiveTurnOverRatio_daily(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '上行主动成交额计算的换手率 * 分组上的换手率 与被动成交额的换手率的比例'
    article = ''
    freq = 'daily'
    ...
    def cal_groupst(self):
        ...
        factor = group_active_amt * stk_active_amt / (group_passive_amt * stk_passive_amt)
