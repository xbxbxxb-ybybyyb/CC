...
# @Author : Zhichen Lu
# @File :Vol5CorrWithNetPriceRollingDay.py
...
class Vol5CorrWithNetPriceRollingDay(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    extend_days = 5
    author = 'lzc'
    logic = '日内5分钟波动率与收盘净值组内相关性 * 个股波动率 滚动240'
    article = ''
    freq = '5mins'
    ...
    def cal_groupst(self):
        ...
        net_close = (close[:, -1, :] / close[:, 0, :])[:, None, :]
