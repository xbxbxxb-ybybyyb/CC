...
class IndustryMarginalCositOfImmediacyBid(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    ...
    def cal_groupst(self):
        ...
        return arr_match_index(MCIB_stk * MCIB_group, self.cal_date_range, self.date_range)
...
if __name__ == '__main__':
    ...
    f = IndustryMarginalCositOfImmediacyBid()
    e = time.time()
    # f.result()
    f.save_result()
