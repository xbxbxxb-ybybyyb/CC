...
# @Author : Zhichen Lu
# @File : LowestDPathiLIQUIDITY_minute.py
...
class LowestDPathiLIQUIDITY_minute(crossFactor):
    window = 15
    cross_group = 'sw1'
    ...
    article = ''
    freq = '5mins'
    basic_datas = {'daily': ['free_float_shares'], '30mins': [], '5mins': ['open', 'high', 'low', 'close', 'amt'], '1min': []}
    ...
    def st_factor(self):
        ...
        return [self.database['5mins'][x] for x in ['open', 'high', 'low', 'close', 'amt']] + [self.database['daily'][x] for x in ['free_float_shares']]
    ...
    def cal_groupst(self):
        ...
        # minute_group = sameshape(open_,self.group_factor())
...
if __name__ == '__main__':
    ...
    f = LowestDPathiLIQUIDITY_minute()
    e = time.time()
    # f.result()
    f.result()
