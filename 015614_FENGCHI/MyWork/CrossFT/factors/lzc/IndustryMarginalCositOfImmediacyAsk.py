...
# @Author : Zhichen Lu
# @File : IndustryMarginalCositOfImmediacyAsk.py
import sys
...
class IndustryMarginalCositOfImmediacyAsk(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '根据逻辑计算个股卖单流动性 并 衍生分组卖单流动性 相乘'
...
if __name__ == '__main__':
    ...
    f = IndustryMarginalCositOfImmediacyAsk()
    e = time.time()
    # f.result()
    f.save_result()
