...
class IndustryMCI_Pasive(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '根据逻辑计算个股 被动订单部分(新增被动委买+新增被动委卖) 流动性 并 衍生分组被动订单流动性 相乘'
    ...
    def cal_groupst(self):
        ...
        sell_order_amt_group = st2groupst(passiveorderamt, minute_group,  self.group_func())
        industry_sell_vwap = sell_order_amt_group / st2groupst(passiveordervol, minute_group,  self.group_func())
...
if __name__ == '__main__':
    ...
    send_message(['015664'], 'IndustryMCI_Passive done ')
