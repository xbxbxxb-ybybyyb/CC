...
class UpStdToStd_5m(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = 'cross_sum'
    extend_days = 15
    author = 'lzc'
    logic = '个股上行波动率/波动率   *  分组收益均值上行波动率/波动率 昨日T时刻到当日T时刻为一日'
    article = ''
    freq = '5mins'
