...
class OrderImbalace_Ratio(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
    author = 'lzc'
    logic = '计算根据流通股票本折算订单失衡率因子 再计算行业整体的订单失衡率'
    ...
    def cal_groupst(self):
        ...
        return arr_match_index(OIR_stk * OIR_group, self.cal_date_range, self.date_range)
