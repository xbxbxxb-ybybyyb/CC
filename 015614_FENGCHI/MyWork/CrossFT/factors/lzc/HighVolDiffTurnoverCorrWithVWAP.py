...
# @Author : Zhichen Lu
# @File :HighVolDiffTurnoverCorrWithVWAP.py
...
class HighVolDiffTurnoverCorrWithVWAP(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    extend_days = 0
    author = 'lzc'
    logic = '日内5分钟High*Vol-Amount 与 VWAP的相关性 *分组因子值'
    article = ''
    freq = 'daily'
...
if __name__ == '__main__':
    ...
    # f.result()
    cal_factor(start =20210101,end=20210301,numd={})
