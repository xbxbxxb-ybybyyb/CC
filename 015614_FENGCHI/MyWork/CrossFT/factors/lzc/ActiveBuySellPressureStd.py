...
class ActiveBuySellPressureStd(crossFactor):
    ...
    window = 15
    basic_datas = {'daily': [], '30mins': [], '5mins': ['activebuyorderamt', 'activesellorderamt'], '1min': []}
    ...
    def st_factor(self):
        ...
        '''
        activebuyorderamt, activesellorderamt = [self.database['5mins'][x] for x in ['activebuyorderamt', 'activesellorderamt']]
