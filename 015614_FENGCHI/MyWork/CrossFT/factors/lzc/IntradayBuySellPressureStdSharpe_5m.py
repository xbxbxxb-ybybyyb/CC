...
class IntradayBuySellPressureStdSharpe_5m(crossFactor):
    ...
    extend_days = 15
    author = 'lzc'
    logic = '上行主买成交额、下行主卖成交额买卖压截面sharpe 滚动240分钟'
    article = ''
    freq = '5mins'
    ...
    def cal_groupst(self):
        ...
        intra_std = dt_std(buytradeamt / selltradeamt, 48)

        factor = st2groupst(intra_std, daily_group, cross_mean) / st2groupst(intra_std, daily_group, cross_std)
