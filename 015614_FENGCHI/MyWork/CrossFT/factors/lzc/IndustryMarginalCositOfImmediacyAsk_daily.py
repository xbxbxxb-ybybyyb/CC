...
# @Author : Zhichen Lu
# @File : IndustryMarginalCositOfImmediacyAsk_daily.py
import sys
...
class IndustryMarginalCositOfImmediacyAsk_daily(crossFactor):
    window = 15
    cross_group = 'sw1'
    cross_func = ''
    extend_days = 15
...
if __name__ == '__main__':
    ...
    f = IndustryMarginalCositOfImmediacyAsk_daily()
    e = time.time()
    # f.result()
    f.save_result()
