...
class xq_strong_ratio(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        factor = st2groupst((pct>7), self.group, self.group_func())
...
if __name__ == '__main__':
    ...
    f = xq_strong_ratio(group, func, 40, 20170101, 20210531, 'xq', 'xq_strong_ratio', '全市场涨幅7%以上股票占比',
