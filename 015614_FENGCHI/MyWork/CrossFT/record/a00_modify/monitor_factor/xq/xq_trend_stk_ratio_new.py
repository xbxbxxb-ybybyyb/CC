...
class xq_trend_stk_ratio(crossFactor):
    ...
    def st_factor(self):
        ...
        trend_stk = df_match_index_col(trend_stk, self.code_list, self.cal_date_range)# np.array
        return trend_stk
    ...
    def cal_groupst(self):
        ...
        '''
        trend_stk = self.st_factor()
        self.group = sameshape(trend_stk, self.group_factor())
        factor = st2groupst(trend_stk, self.group, self.group_func())
...
if __name__ == '__main__':
    ...
    f = xq_trend_stk_ratio(group, func, 150, 20170101, 20210531, 'xq', 'xq_trend_stk_ratio', '趋势股占比',
