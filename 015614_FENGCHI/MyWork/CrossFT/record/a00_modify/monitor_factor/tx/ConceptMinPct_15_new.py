...
class ConceptMinPct_15(crossFactor):
    def st_factor(self):
        '''
        ...
        stock_pct = stock_close.groupby('date').pct_change(15)
...
if __name__=='__main__':
    f = ConceptMinPct_15(group='sw1', func='cross_mean',extend_days=5, author='tx', factor_name='ConceptMinPct_15',
                        logic='板块行业15分钟涨速', freq='1min')
    f.save_result()
