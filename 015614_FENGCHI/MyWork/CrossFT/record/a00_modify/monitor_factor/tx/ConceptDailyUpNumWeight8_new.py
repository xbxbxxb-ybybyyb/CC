...
class ConceptDailyUpNumWeight8(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyUpNumWeight8(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDailyUpNumWeight8',logic='板块日间上涨8%比例',freq='daily')
    f.save_result()
