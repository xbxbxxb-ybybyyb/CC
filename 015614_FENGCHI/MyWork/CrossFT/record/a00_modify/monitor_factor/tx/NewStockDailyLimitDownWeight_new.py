...
class NewStockDailyLimitDownWeight(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = LimitDown_stock[NewStock].sum(axis=1)/NewStock.sum(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyLimitDownWeight(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyLimitDownWeight',logic='次新股跌停占比',freq='daily')
    f.save_result()
