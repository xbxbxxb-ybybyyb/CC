...
class NewStockDailyDownNum(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = (stock_pct[NewStock]<0).sum(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyDownNum(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyDownNum',logic='次新股下跌数量',freq='daily')
    f.save_result()
