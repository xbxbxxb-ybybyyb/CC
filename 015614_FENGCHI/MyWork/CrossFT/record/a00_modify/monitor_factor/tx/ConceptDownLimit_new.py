...
class ConceptDownLimit(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDownLimit(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptDownLimit',
                        logic='板块日内跌停数量', freq='1min')
    f.save_result()
