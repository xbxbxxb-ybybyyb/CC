...
class NewStockDailyLimitUpmean(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = stock_pct[(stock_pct[NewStock]>0)].mean(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyLimitUpmean(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyLimitUpDown',logic='次新股上涨均值',freq='daily')
    f.save_result()
