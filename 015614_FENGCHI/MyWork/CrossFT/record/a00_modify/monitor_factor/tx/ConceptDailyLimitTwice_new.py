...
class ConceptDailyLimitTwice(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyLimitTwice(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDailyLimitTwice',logic='板块日间连板数量',freq='daily')
    f.save_result()
