...
class ConceptDailyUpDownMean(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyUpDownMean(group='sw1', func='cross_mean',author='tx',extend_days=5,
                              factor_name='ConceptDailyUpDownMean',logic='板块日间上涨均值比下跌均值',freq='daily')
    f.save_result()
