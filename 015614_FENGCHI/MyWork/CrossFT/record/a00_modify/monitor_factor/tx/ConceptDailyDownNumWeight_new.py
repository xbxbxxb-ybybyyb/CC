...
class ConceptDailyDownNumWeight(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyDownNumWeight(group='sw1', func='cross_mean',author='tx',extend_days=5,
                              factor_name='ConceptDailyDownNumWeight',logic='板块日间下跌比例',freq='daily')
    f.save_result()
