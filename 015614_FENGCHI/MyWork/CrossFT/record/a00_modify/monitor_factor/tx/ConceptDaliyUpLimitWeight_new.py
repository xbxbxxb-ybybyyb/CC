...
class ConceptDaliyUpLimitWeight(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDaliyUpLimitWeight(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDaliyUpLimitWeight',logic='板块日间涨停占比',freq='daily')
    f.save_result()
