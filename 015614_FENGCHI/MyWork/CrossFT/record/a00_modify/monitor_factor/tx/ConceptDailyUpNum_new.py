...
class ConceptDailyUpNum(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyUpNum(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDailyUpNum',logic='板块日间上涨数量',freq='daily')
    f.save_result()
