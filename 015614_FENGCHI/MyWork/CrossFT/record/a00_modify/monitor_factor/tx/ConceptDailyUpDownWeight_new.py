...
class ConceptDailyUpDownWeight(crossFactor):
    def st_factor(self):
        '''
        ...
        Down_num = (stock_pct <0)
        Down_num = df_match_index_col(Down_num, self.code_list, self.cal_date_range)  # np.array
...
if __name__=='__main__':
    f = ConceptDailyUpDownWeight(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDailyUpDownWeight',logic='板块日间涨跌比',freq='daily')
    f.save_result()
