...
class NewStockDailyDownNumWeight(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = NewStockDailyDownNumWeight(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyDownNumWeight',logic='次新股下跌占比',freq='daily')
    f.save_result()
