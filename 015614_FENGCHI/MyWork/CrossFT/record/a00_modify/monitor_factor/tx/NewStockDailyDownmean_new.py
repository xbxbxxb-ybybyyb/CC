...
class NewStockDailyDownmean(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = NewStockDailyDownmean(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyDownmean',logic='次新股下跌均值',freq='daily')
    f.save_result()
