...
class ConceptDaliyUpLimit(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDaliyUpLimit(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDaliyUpLimit',logic='板块日间涨停数量',freq='daily')
    f.save_result()
