...
class ConceptDownStockWeight8(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDownStockWeight8(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptDownStockWeight8',
                        logic='板块日内下跌8%占比', freq='1min')
    f.save_result()
