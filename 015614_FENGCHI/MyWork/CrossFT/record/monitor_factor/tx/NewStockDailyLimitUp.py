...
class NewStockDailyLimitUp(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = Limit_stock[NewStock].sum(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyLimitUp(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyLimitUp',logic='次新股涨停数量',freq='daily')
    f.save_result()
