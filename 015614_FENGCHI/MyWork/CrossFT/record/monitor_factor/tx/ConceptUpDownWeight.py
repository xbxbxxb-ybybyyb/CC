...
class ConceptUpDownWeight(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptUpDownWeight(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptUpDownWeight',
