...
class NewStockDailyUpNum(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = NewStockDailyUpNum(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyUpNum',logic='次新股上涨数量',freq='daily')
    f.save_result()
