...
class ConceptUpDownWeight8(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptUpDownWeight8(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptUpDownWeight8',
                        logic='板块日内涨跌比', freq='1min')
    f.save_result()
