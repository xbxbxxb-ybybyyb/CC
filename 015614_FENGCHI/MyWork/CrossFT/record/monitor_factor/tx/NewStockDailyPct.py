...
class NewStockDailyPct(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = stock_pct[NewStock].mean(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyPct(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyPct',logic='次新股涨跌幅',freq='daily')
    f.save_result()
