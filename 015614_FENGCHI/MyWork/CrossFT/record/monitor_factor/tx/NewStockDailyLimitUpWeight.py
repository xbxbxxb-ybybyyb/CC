...
class NewStockDailyLimitUpWeight(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = Limit_stock[NewStock].sum(axis=1)/NewStock.sum(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyLimitUpWeight(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyLimitUpWeight',logic='次新股涨停占比',freq='daily')
    f.save_result()
