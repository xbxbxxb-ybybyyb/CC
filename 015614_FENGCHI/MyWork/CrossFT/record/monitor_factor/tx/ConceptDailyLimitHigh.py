...
class ConceptDailyLimitHigh(crossFactor):
    def st_factor(self):
        ...
        limit_high = df_match_index_col(limit_high, self.code_list, self.cal_date_range)# np.array
...
if __name__=='__main__':
    f = ConceptDailyLimitHigh(group='sw1', func='cross_max',author='tx',extend_days=5,
                              factor_name='ConceptDailyLimitHigh',logic='板块日间连板高度',freq='daily')
    f.save_result()
