...
class ConceptDailyDownNumWeight8(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptDailyDownNumWeight8(group='sw1', func='cross_mean',author='tx',extend_days=5,
                              factor_name='ConceptDailyDownNumWeight8',logic='板块日间下跌8%比例',freq='daily')
    f.save_result()
