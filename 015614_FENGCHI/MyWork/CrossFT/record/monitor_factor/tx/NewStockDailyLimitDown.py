...
class NewStockDailyLimitDown(crossFactor):
    def st_factor(self):
        '''
        ...
        NewStockPct = LimitDown_stock[NewStock].sum(axis=1)
...
if __name__=='__main__':
    f = NewStockDailyLimitDown(group='sw1', func=None,author='tx',extend_days=10,
                              factor_name='NewStockDailyLimitDown',logic='次新股跌停数量',freq='daily')
    f.save_result()
