...
class ConceptUpLimitWeight(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptUpLimitWeight(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptUpLimitWeight',
                        logic='板块日内涨停占比', freq='1min')
    f.save_result()
