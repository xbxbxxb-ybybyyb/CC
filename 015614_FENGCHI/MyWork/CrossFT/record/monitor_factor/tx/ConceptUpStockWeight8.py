...
class ConceptUpStockWeight8(crossFactor):
    def st_factor(self):
        '''
...
if __name__=='__main__':
    f = ConceptUpStockWeight8(group='sw1', func='cross_sum',extend_days=5, author='tx', factor_name='ConceptUpStockWeight8',
                        logic='板块日内上涨8%占比', freq='1min')
    f.save_result()
