...
class ConceptDaliyDownLimitWeight(crossFactor):
    def st_factor(self):
        '''
        ...
        return limitDown_num,Stock_num
...
if __name__=='__main__':
    f = ConceptDaliyDownLimitWeight(group='sw1', func='cross_sum',author='tx',extend_days=5,
                              factor_name='ConceptDaliyDownLimitWeight',logic='板块日间跌停占比',freq='daily')
    f.save_result()
