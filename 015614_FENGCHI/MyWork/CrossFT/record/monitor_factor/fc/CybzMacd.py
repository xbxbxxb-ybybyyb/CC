...
class CybzMacd(crossFactor):
    def st_factor(self):
        ...
        '''
        close = get_daily_1factor('close', code_list=['CYBZ'], date_list=self.cal_date_range, type='bench')
        _, _, a3 = talib.MACD(close['CYBZ'].values, fastperiod=12,
