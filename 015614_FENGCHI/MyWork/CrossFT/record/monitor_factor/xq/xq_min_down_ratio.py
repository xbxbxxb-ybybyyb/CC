...
class xq_min_down_ratio(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        factor = st2groupst((pct_min<0), self.group, self.group_func())
...
if __name__ == '__main__':
    ...
    f = xq_min_down_ratio(group, func, 40, 20170101, 20210531, 'xq', 'xq_min_down_ratio', '分钟全市场下跌家数占比',
