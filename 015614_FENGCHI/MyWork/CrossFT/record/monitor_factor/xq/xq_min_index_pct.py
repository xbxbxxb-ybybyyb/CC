...
class xq_min_index_pct(crossFactor):
    def st_factor(self):
        '''
        ...
        stk_index_pct = ((stk_class == 1) * (high > 0)).mul(pct_min['SZCZ'], axis=0) + \
                        ((stk_class == 2) * (high > 0)).mul(pct_min['SZZZ'], axis=0)
...
if __name__ == '__main__':
    ...
    f = xq_min_index_pct(group, func, 40, 20170101, 20210531, 'xq', 'xq_min_index_pct', '对应指数分钟涨跌幅',
