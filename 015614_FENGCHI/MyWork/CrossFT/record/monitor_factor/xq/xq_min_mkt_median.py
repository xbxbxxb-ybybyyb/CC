...
class xq_min_mkt_median(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        self.group = sameshape(close_min, self.group_factor())
        pre_close = np.repeat(pre_close, 242, axis=1)
        pct_min = close_min/pre_close-1
        factor = st2groupst(pct_min, self.group, self.group_func())
...
if __name__=='__main__':
    ...
    f = xq_min_mkt_median(group, func, 240, 20170101, 20210531, 'xq', 'xq_min_mkt_median', '分钟全市场涨跌中位数',
