...
class xq_continuous_limitup_prem(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        '''
        lb, pct = self.st_factor()
        lb_prem = np.where(lb == 1, pct, np.nan)
...
if __name__ == '__main__':
    ...
    f = xq_continuous_limitup_prem(group, func, 40, 20170101, 20210531, 'xq', 'xq_continuous_limitup_prem', '连板溢价',
