...
class xq_continuous_limitup_num(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        factor = st2groupst(lb, self.group, self.group_func())
...
if __name__ == '__main__':
    ...
    f = xq_continuous_limitup_num(group, func, 40, 20170101, 20210531, 'xq', 'xq_continuous_limitup_num', '连板数量',
