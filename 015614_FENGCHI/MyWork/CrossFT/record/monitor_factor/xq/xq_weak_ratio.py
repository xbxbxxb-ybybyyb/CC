...
class xq_weak_ratio(crossFactor):
    def st_factor(self):
        '''
    ...
    def cal_groupst(self):
        ...
        factor = st2groupst((pct < -7), self.group, calfunc)
...
if __name__ == '__main__':
    ...
    f = xq_weak_ratio(group, func, 40, 20170101, 20210531, 'xq', 'xq_weak_ratio', '全市场跌幅-7%以下股票占比',
