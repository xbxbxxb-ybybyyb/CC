...
class ConceptBenchStockPct5With10day(crossFactor):
    cross_group='sw1'
    ...
    def st_factor(self):
        ...
        # 输出市场标杆股
        # 1、均线排列纯多头
        close_badj = get_daily_1factor('close_badj', self.cal_date_range, self.code_list)
        ...
        stock_pct = stock_pct.rolling(5).mean()/stock_pct.rolling(10).mean()
...
if __name__=='__main__':
    f = ConceptBenchStockPct5With10day()
    f.save_result()