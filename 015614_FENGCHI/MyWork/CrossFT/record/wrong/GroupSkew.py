...
class GroupSkew(crossFactor):
    ...
    def cal_groupst(self):
        ...
        stk_skew = dt_skew(ret,self.window)
        group_skew = dt_skew(group_ret,self.window)
...
if __name__ == '__main__':
    ...
    val1 = cal_factor('data/user/016385/test/crossft/factors/lzc', 'GroupSkew.py', {},
                      notrun=False)
    val2 = cal_factor('data/user/016385/test/crossft/factors/lzc', 'GroupSkew.py', {'daily': 6},
                      notrun=False)
    gap = abs(val1 - val2)
    print(np.nansum(gap))
