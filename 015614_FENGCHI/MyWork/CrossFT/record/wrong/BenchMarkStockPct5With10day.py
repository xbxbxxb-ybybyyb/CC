...
class BenchMarkStockPct5With10day(crossFactor):
    cross_group='sw1'
    cross_func='cross_mean'
    author='tx'
    extend_days = 280
    logic='市场标杆股5日涨跌幅/10日涨跌幅'
    freq='daily'
    ...
    def st_factor(self):
        ...
        NewStockPct5day = stock_pct.rolling(5).mean()[StockChoice].mean(axis=1)
        NewStockPct10day = stock_pct.rolling(10).mean()[StockChoice].mean(axis=1)
        NewStockPct = NewStockPct5day/NewStockPct10day
