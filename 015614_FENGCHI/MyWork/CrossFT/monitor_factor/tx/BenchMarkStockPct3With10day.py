...
class BenchMarkStockPct3With10day(crossFactor):
    cross_group = 'sw1'
    cross_func = 'cross_mean'
    author = 'tx'
    extend_days = 280
    logic = '市场标杆股3日涨跌幅/10日涨跌幅'
    freq = 'daily'
    ...
    def st_factor(self):
        ...
        NewStockPct3day = stock_pct.rolling(3).mean()[StockChoice].mean(axis=1)
        NewStockPct10day = stock_pct.rolling(10).mean()[StockChoice].mean(axis=1)
        NewStockPct = NewStockPct3day / NewStockPct10day
