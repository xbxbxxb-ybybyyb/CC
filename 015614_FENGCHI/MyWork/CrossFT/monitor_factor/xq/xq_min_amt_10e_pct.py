...
class xq_min_amt_10e_pct(crossFactor):
    cross_group='ones'
    cross_func='cross_mean'
    extend_days = 5
    author='xq'
    logic='成交额10亿以上股票平均涨幅'
    article=None
    freq='1min'
    ...
    def st_factor(self):
        ...
        '''
        amt = get_daily_1factor('amt', self.cal_date_range, self.code_list).shift(1)/(10**5)
    ...
    def cal_groupst(self):
        ...
        active_stk_pct = np.where(np.repeat(amt, 242, axis=1) > 10, pct_min, np.nan)
