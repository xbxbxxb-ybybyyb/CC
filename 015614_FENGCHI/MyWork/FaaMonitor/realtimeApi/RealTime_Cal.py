...
# 因子回调计算函数
def Get_RealTime_Data(concept_name,factor_list=factor_list,save_path='/arch1/group/800442/800319/RealTime_Data/'):
    ...
    def calc_callback(self, df_dict,name_list=name_list):
        ...
        with open(save_path + date + '/' + factor_name + '.pkl', 'wb') as f:
