...
import numpy as np
import warnings
from backtest.utility import pprint, max_drawdown_ts, calc_cum_return_ts, \
...
from backtest.pdf_config import *
from backtest.naming_config import *
...
def generate_pdf(pickle_name,rolling_window=20):
    ...
    g_sample_bins_ret_diff2ret = generate_plot(sample_bins_ret_diff2ret, plot_name='Rolling (Max ret - Min ret) / Mean ret',x_label='',y_label='',rot=45)
    g_sample_std2ret = generate_plot(sample_std2ret, plot_name='Rolling Variance ratio of sampled ret (STD/Mean)',x_label='',y_label='',rot=45)
    g_Calmar_half_year = generate_plot(Calmar_half_year, plot_name='Calmar ratio in half year',x_label='',y_label='Calmar Ratio',plot_type='bar',rot=30,bottom=0.2) 
