...
from LimitUpPredStrategy.conf.path_conf import samples_path, label_path
...
class ModelBase:
    ...
    def get_dataset(self, train_start_date=20140101, train_end_date=20191231,
                    ...
                    sample_type='all_factors',
                    label_type='cls_当日收盘是否涨停'):
        train_samples = pd.read_pickle(samples_path + sample_type + '.pkl')
    ...
    def _transfomer_scaler(self, factor_list, scaler, X_train, X_test):
    ...
    def convert_data_4_train_and_test(self, train_samples, non_scaler_list, *factor_scaler_list):
        ...
        for train_index, test_index in skf_data:
            ...
            for factor_list, scaler in factor_scaler_list:
                tmp_X_train, tmp_X_test, _ = self._transfomer_scaler(factor_list, scaler, X_train, X_test)
