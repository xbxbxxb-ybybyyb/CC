...
def main(factor_name, turnover, target_holding_num, buy_pool_num):
    ...
    # 初始化，约125s
    result_output_path = '/data/group/800319/junkData/temp_factor_by_fc/StrategyBackTest/bt_top_n_20200428/'
    ...
    try:
        factor = pd.read_hdf(
            '/data/group/800319/storeFactor/topN_ffactor20200428/%s.h5' % factor_name,
            factor_name)
...
if __name__=="__main__":
    ...
    factor_name_list = []
    import os
    file_dir = r'/data/group/800319/storeFactor/topN_ffactor20200428/'
