...
def main():
    ...
    pd.to_pickle([avg_price, deal_vol],
                 out_path + 'backtest_res_lr_rise_down_zero_5min_2018_all_factor_fillnapad_new_portfolio_20200701_50pctvol.pkl')
    pd.to_pickle(record, out_path + 'record_lr_rise_down_zero_5min_2018_all_factor_fillnapad_new_portfolio_20200701_50pctvol.pkl')
    fulfill_percent, outperformance = SBTB.calc_performance(signal_, target_vol, avg_price, deal_vol)
    pd.to_pickle([fulfill_percent, outperformance], out_path + 'backtest_lr_rise_down_zero_5min_2018_all_factor_fillnapad_new_portfolio_20200701_50pctvol.pkl')
    ...
    pd.to_pickle(outperformance_all, out_path + 'improve_lr_rise_down_zero_5min_2018_all_factor_fillnapad_new_portfolio_20200701_50pctvol.pkl')
