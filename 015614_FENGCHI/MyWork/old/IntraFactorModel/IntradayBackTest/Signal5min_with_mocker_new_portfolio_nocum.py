...
def main():
    ...
    flag = '_new_portfolio_nocumsignal_20200709_v_whole_mkt'
    ...
    signal_ = pd.read_pickle('/data/group/800319/junkData/IntraFactorModel/junkClassification/predict_signal_lr_model_rise_down_zero_5min_v_whole_mkt_20200709.pkl')
    print(signal_.shape)
    ...
    pd.to_pickle([avg_price, deal_vol],
                 out_path + 'backtest_res_lr_rise_down_zero_5min_2018_all_factor_fillnapad%s.pkl' % flag)
    pd.to_pickle(record, out_path + 'record_lr_rise_down_zero_5min_2018_all_factor_fillnapad%s.pkl' % flag)
    ...
    fulfill_percent, outperformance = SBTB.calc_performance(signal_, target_vol, avg_price, deal_vol)
    pd.to_pickle([fulfill_percent, outperformance], out_path + 'backtest_performance_lr_rise_down_zero_5min_2018_all_factor_fillnapad%s.pkl' % flag)
    ...
    pd.to_pickle(outperformance_all, out_path + 'improve_lr_rise_down_zero_5min_2018_all_factor_fillnapad%s.pkl' % flag)
