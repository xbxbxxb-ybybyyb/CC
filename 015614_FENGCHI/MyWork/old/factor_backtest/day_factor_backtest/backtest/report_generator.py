...
import numpy as np
import warnings
from day_factor_backtest.backtest.utility import pprint, max_drawdown_ts, calc_cum_return_ts, \
...
from day_factor_backtest.backtest.pdf_config import *
...
def generate_pdf(pickle_name, corr_information, rolling_window=20):
    ...
    h_seg_ret_30_year = Paragraph('Portfolio Spread by Year %s No Industry Neutral (30 Segment)' % (add_t_cost),
                                  heading_size)
