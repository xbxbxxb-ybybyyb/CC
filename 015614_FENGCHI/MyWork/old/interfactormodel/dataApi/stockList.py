...
def _update_log(status, factor_type, factor, write_type='update', info='', file='/data/group/800319/junkData/updateLog.txt'):
...
def get_stock_list(date=None, address='/data/group/800319/junkData/daily'):
...
def _store_stock_list(address='/data/group/800319/junkData/daily'):
...
def _store_bench_exdiv_weight(address='/data/group/800319/junkData/daily'):
...
def _store_ind_con(address='/data/group/800319/junkData/daily'):
...
def _store_price_get_limit(address='/data/group/800319/junkData/daily'):
...
def _store_ST(address='/data/group/800319/junkData/daily'):
...
def _store_live_days_and_pause(address='/data/group/800319/junkData/daily'):
...
def clean_stock_list(stock_list='ALL', no_ST=True, least_live_days=240, no_pause=True, least_recover_days=1,
                     ...
                     other_limit=None, start_date=None, end_date=None, address='/data/group/800319/junkData/daily'):
    ...
    if no_pause:
        ...
        pause1 = pause[pause == True].ffill(limit=least_recover_days-1) if least_recover_days >= 2 else pause[pause == True]
