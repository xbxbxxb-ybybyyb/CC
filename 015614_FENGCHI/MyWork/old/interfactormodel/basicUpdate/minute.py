...
def _prepare_store_kline_by_stock(code_list, start_date=20130101, end_date=None,
                                  store_address='/data/group/800319/junkData/minuteByStock'):
...
def _prepare_store_kline_by_factor(code_list, factor, data_address='/data/group/800319/junkData/minuteByStock'):
...
def _store_kline_by_stock(code_list=None, line=8, start_date=20130101, end_date=None,
                          stock_list_address='/data/group/800319/junkData/daily',
                          store_address='/data/group/800319/junkData/minuteByStock'):
...
def _store_kline_by_stock_bench(bench_dict=benchmarks, start_date=20100101, end_date=None,
                                  store_address='/data/group/800319/junkData/minuteByStockBench'):
...
def _store_kline_by_factor(line=8, factors=minute_base_data_list,
                           data_address='/data/group/800319/junkData/minuteByStock',
                           store_address='/data/group/800319/junkData/minuteByFactor'):
...
def update_adjfactor_kline_by_factor2(factors=minute_base_data_list[:4],
                           data_address='/data/group/800319/junkData/minuteByFactor',
                           adjfactor_address='/data/group/800319/junkData/daily',
                           desample_address='/data/group/800319/junkData/minuteDesampleByFactor'):
...
def _prepare_update_kline_by_stock(code_list, end_date, store_address='/data/group/800319/junkData/minuteByStock'):
...
def update_kline_by_stock(line=8, stock_list_address='/data/group/800319/junkData/daily',
                          store_address='/data/group/800319/junkData/minuteByStock'):
...
def update_kline_by_stock_bench(bench_dict=benchmarks, store_address='/data/group/800319/junkData/minuteByStockBench'):
...
def update_kline_by_factor2(line=8, factors=minute_base_data_list,
                           data_address='/data/group/800319/junkData/minuteByStock',
                           store_address='/data/group/800319/junkData/minuteByFactor',
                           desample_address='/data/group/800319/junkData/minuteDesampleByFactor'):
...
def update_kline_by_factor(line=8, factors=minute_base_data_list,
                           data_address='/data/group/800319/junkData/minuteByStock',
                           store_address='/data/group/800319/junkData/minuteByFactor',
                           desample_address='/data/group/800319/junkData/minuteDesampleByFactor'):
...
def get_bench_daily_data(data_address='/data/group/800319/junkData/minuteByFactorBench',
                         store_address='/data/group/800319/junkData/dailyBench'):
...
def store_twap(data_address='/data/group/800319/junkData/minuteByFactor',
               store_address='/data/group/800319/junkData/daily'):
...
def update_twap(base_date=20130101, data_address='/data/group/800319/junkData/minuteByFactor',
                store_address='/data/group/800319/junkData/daily'):
...
if __name__ == '__main__':
    '''
    _store_kline_by_stock(line=16, end_date=20200120, store_address='/data/group/800319/junkData/minuteByStock')
    _store_kline_by_stock_bench(end_date=20200120, store_address='/data/group/800319/junkData/minuteByStockBench')
    _store_kline_by_factor(line=24, factors=minute_base_data_list,
                           data_address='/data/group/800319/junkData/minuteByStock',
                           store_address='/data/group/800319/junkData/minuteByFactor')
    _store_kline_by_factor(factors=minute_base_data_list[:-1],
                           data_address='/data/group/800319/junkData/minuteByStockBench',
                           store_address='/data/group/800319/junkData/minuteByFactorBench')
    '''
    update_kline_by_stock(line=16, store_address='/data/group/800319/junkData/minuteByStock')
    update_kline_by_stock_bench(store_address='/data/group/800319/junkData/minuteByStockBench')
    update_kline_by_factor(factors=minute_base_data_list)
    update_kline_by_factor(line=1, factors=minute_base_data_list[:-1],
                           data_address='/data/group/800319/junkData/minuteByStockBench',
                           store_address='/data/group/800319/junkData/minuteByFactorBench',
                           desample_address='/data/group/800319/junkData/minuteDesampleByFactorBench')
    ...
    ###
    _store_kline_by_stock(line=30)
    #_store_kline_by_stock_bench()
    _store_kline_by_factor(line=30, factors=minute_base_data_list,
                           data_address='/data/group/800319/junkData/minuteByStock',
                           store_address='/data/group/800319/junkData/minuteByFactor')
    _store_kline_by_factor(factors=minute_base_data_list[:-1],
                           data_address='/data/group/800319/junkData/minuteByStockBench',
