...
pd.to_pickle([instance.daily_holding, instance.daily_buy_time_info, instance.daily_conf],
             '/data/group/800319/strategy_local_path/FolderFor930/fake_sample_new_frame_out_sample.pkl')
