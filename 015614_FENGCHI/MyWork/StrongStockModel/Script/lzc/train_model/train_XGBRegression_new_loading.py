...
import numpy as np
import pandas as pd
from StrongStockModel.model.Modelmpl.XGBRegression_new_loading import XGBRegression
...
def main_window_search():
    ...
    out_file = '/data/group/800319/Faamonitor/PL/all_mkt_ts_norm/reg_norm_window_compare/XGBNewLoading_train%d_test%d_factor_num%d_norm_window_%d.pkl' % (
