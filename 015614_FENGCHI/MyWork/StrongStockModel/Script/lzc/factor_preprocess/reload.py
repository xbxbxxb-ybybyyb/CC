...
N = 40
preprocessed_ts_norm_by_factor_path = preprocessed_ts_norm_by_factor_path.replace('ts_norm', 'ts_norm_%d' % N)
...
date_list = get_date_range(20140101, 20191231)
