...
class PortfolioStrategyBase:
    ...
    def __init__(self, start=20140101, end=20181231, stock_pool=None, target_point=None,
        ...
        flatten = pd.read_pickle('/data/group/800319/junkData/IntraFactorModel/DataForTplusN/open_flatten.pkl').loc[self.date_list, self.stk_list]
...
class InitailCashBasedEvaluationHelper:
    ...
    def evaluate_daily(self, daily_cash, kernel=10, holding_num=None):
        ...
        wind_a = s.get_factor_value('WIND_AIndexWindIndustriesEOD', S_INFO_WINDCODE=['881001.WI'], trade_dt=daily_info.index.astype(str).tolist())[
