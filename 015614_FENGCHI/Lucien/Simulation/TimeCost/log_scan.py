...
ip_check_dict = {
    '20230411_simlite': [55, 38, 39, 80, 82, 83, 84, 85, 86],
    '': []
}
...
digit2factorSet = {'300001': '168.62.9.55', '300002': '168.62.1.38', '300003': '168.62.1.39', '300004': '168.62.1.82',
                   ...
                   '300009': '168.62.1.80', '300010': '168.62.9.53'}
...
log_file_cache = list()
# parse_1log('20230407', f'uat_lite-20230411')  # 测试用
while True:
    # time.sleep(60)
    ...
    for filename in filename_list:
        ...
        # 临时过滤一部分文件
        # if filename.startswith('StrongStrategy-20230404') or filename.startswith('StrongStrategy-20230406') or filename.startswith('StrongStrategy-20230403'):
        #     continue
