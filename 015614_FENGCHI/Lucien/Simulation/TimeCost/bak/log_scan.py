...
def parse_1log(sim_date, flag):
    ...
    if len(lines) > 0:
        ...
        combined_df5['group'] = combined_df5['machine_code'].replace(jpt_zone_df['class_name'].to_dict())
...
while True:
    ...
    for filename in filename_list:
        ...
        # 临时过滤一部分文件
        # if filename.startswith('StrongStrategy-20230309') or filename.startswith('StrongStrategy-20230313'):
        #     continue
