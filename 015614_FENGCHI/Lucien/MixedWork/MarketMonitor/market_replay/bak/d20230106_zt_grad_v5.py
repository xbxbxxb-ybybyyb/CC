...
if __name__ == '__main__':
    start_date, end_date = 20220101, 20221230
    week_start_date, week_end_date = 20221226, end_date
    ...
    # 为了在连板金字塔标注不同的颜色
    strategy = 'jupiter'    # europa jupiter
    deal_list = list()
    for _date in week_date_list:
    ...
    hot_stk_str = '阳光股份、中交地产、中国武夷、毅昌科技、盛通股份、千红制药、徐家汇、永辉超市、中百集团、焦点科技、跨境通、永泰运、中粮资本、人民网、新华制药'  # 以顿号、分隔，放入外部分析资料中的市场活跃个股名称
    ...
    # zb_info.loc['601068', '所属概念'] = '老基建'
    # zb_info.loc['600476', '所属概念'] = '阿里巴巴平台'
