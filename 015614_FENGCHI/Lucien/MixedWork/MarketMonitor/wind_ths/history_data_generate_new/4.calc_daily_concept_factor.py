...
sw2_concept_list = FileUtil.read_list('/data/user/015614/daily/basic/basic_wind_sw_history3/BlockData/', '最新2015至今全量申万二级行业列表.pkl')
sw20211_list = pd.read_excel('/data/user/015614/daily/basic/basic_wind_sw_history3/BlockData/申万一级行业2021版.xlsx', index_col=0).index.tolist()
sw20141_list = pd.read_excel('/data/user/015614/daily/basic/basic_wind_sw_history3/BlockData/申万一级行业2014版.xlsx', index_col=0).index.tolist()
