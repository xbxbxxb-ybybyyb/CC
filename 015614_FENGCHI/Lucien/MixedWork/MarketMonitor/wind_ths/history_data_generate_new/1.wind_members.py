...
ccpt_daily_data = pd.concat([ccpt_daily_data1, ccpt_daily_data2, ccpt_daily_data3, ccpt_daily_data4, ccpt_daily_data5, ccpt_daily_data6, ccpt_daily_data7], axis=0)
