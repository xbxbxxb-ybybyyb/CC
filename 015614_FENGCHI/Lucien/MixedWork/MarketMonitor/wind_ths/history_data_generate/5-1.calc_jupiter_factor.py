...
def calc_stk_index(trade_date):
    ...
    os.makedirs(block_path + f'daily_max_pctchg_concept/jupiter/', exist_ok=True)
    deal_data.to_pickle(block_path + f'daily_max_pctchg_concept/jupiter/{trade_date}.pkl')
