...
member4 = fd.get_factor_value('WIND_AIndexMembersWIND', S_CON_INDATE='>=20240101', F_INFO_WINDCODE="like'884%'")
wind_member = pd.concat([member99, member0, member00, member01, member02, member03, member1, member2, member3, member4], ignore_index=True)
...
FileUtil.save_list2pkl(wind_concept_list, '/data/user/015614/daily/basic/basic_wind_sw_history2/BlockData/', '最新2015至今全量Wind列表.pkl')
