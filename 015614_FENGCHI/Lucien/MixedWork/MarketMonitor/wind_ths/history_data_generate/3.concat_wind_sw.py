...
# 筛选其中是WI的板块
t1 = time.time()
block_path = '/data/user/015614/daily/basic/basic_wind_sw_history2/BlockData/each_block/'
...
FileUtil.save_list2pkl(sw2_concept_list, '/data/user/015614/daily/basic/basic_wind_sw_history2/BlockData/', '最新2015至今全量申万二级行业列表.pkl')
...
def concat_block(date):
    ...
    os.makedirs('/data/user/015614/daily/basic/basic_wind_sw_history2/BlockData/daily_Wind&SW/', exist_ok=True)
    res.to_pickle('/data/user/015614/daily/basic/basic_wind_sw_history2/BlockData/daily_Wind&SW/' + f'{date}.pkl')
