...
# 初始化参数
parallel_num = 20
path = '/data/user/015614/daily/basic/basic_wind_sw_history20241014/'
...
ccpt_daily_data7 = fd.get_factor_value('WIND_AIndexWindIndustriesEOD', TRADE_DT=['>=' + "20230101", '<=' + "20231231"], S_INFO_WINDCODE="like'884%'")
ccpt_daily_data8 = fd.get_factor_value('WIND_AIndexWindIndustriesEOD', TRADE_DT=['>=' + "20240101", '<=' + now_date], S_INFO_WINDCODE="like'884%'")
ccpt_daily_data = pd.concat([ccpt_daily_data1, ccpt_daily_data2, ccpt_daily_data22, ccpt_daily_data3, ccpt_daily_data4, ccpt_daily_data5, ccpt_daily_data6, ccpt_daily_data7, ccpt_daily_data8], axis=0)
