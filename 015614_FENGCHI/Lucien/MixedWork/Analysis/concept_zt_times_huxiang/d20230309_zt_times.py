...
old_res_df = pd.read_excel('/data/user/015614/shared/for_wys/20220301-20230228个股按规则筛选前20个V4_20230308.xlsx', index_col=0)
diff_index = list()
...
res_df.to_excel('/data/user/015614/shared/for_wys/20220301-20230228个股按规则筛选前20个V5_20230309.xlsx')