...
paramE = [1]
paramF = [1]
param_list = [paramA, paramB, paramC, paramD, paramE, paramF]
...
for param_tuple in tqdm(param_product_list):
    ...
    grey_num = 0
    saturn_num = 0
    paramA, paramB, paramC, paramD, paramE, paramF = param_tuple
    print(param_tuple)
    for dat in date_list:
        ...
        grey_stk_df = grey_df.loc[((grey_df['40日涨跌幅'] >= paramA) & ((grey_df['ycbd_20'] >= paramC) | (grey_df['jyfxts_20'] >= paramE))) | \
                                  ((grey_df['10日最大涨跌幅'] >= paramB) & ((grey_df['ycbd_10'] >= paramD) | (grey_df['jyfxts_10'] >= paramF)))]
