...
track_path = '/data/user/015614/daily/复盘/策略模拟跟踪/20230101_20241231/'

eur_fpath = track_path + 'Europa模型跟踪v3_20230101_20241231.xlsx'  # v1 v2 v3 v4
sellv1_fpath = track_path + 'JupiterNSell模型跟踪v1_20230101_20241231.xlsx' # v1
sellv3_fpath = track_path + 'JupiterNSell34模型跟踪v2_20230101_20241231.xlsx'   # v1
jup_fpath = track_path + 'jupiter模型跟踪v3_20230101_20241231.xlsx' # v8 v9
sat_fpath = track_path + 's1模型跟踪v6_20230101_20241231.xlsx' # v5 v6
jupz_fpath = track_path + 'JupiterZ模型跟踪v1_20230101_20241231.xlsx'   # v1
metis_fpath = track_path + 'Metis模型跟踪v1_20230101_20241231.xlsx' # v1
leda_fpath = track_path + 'Leda模型跟踪v1_20230101_20241231.xlsx' # v1
...
FileUtil.save_dict2xls(res_dict, '/data/user/015614/', '2024年终模型评估结果.xlsx')