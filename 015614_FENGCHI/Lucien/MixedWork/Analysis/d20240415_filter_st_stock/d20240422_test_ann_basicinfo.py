...
path_user = '/data/user/015614/daily/灰名单生成/黑名单/20240422测试/'
...
# 读取基本数据
data = IO.read_data([last_year_period, date], columns=['close'], alt='/data/group/800080/warehouse/prod/MD/CHINA_STOCK/DAILY/WIND/MD_CHINA_STOCK_DAILY_WIND.h5')
...
# if os.path.exists('/data/user/015614/junkData/news_info_2023.pkl'):
#     news_info = pd.read_pickle('/data/user/015614/junkData/news_info_2023.pkl')
# else:
#     # news_info.to_pickle('/data/user/015614/junkData/news_info_2023.pkl')
#     print(1)
...
# ——————第三类：其他风险警示（公司停产）——————
# 处理公告数据
news_info_st2 = news_info[news_info['TEXTTITLE'].apply(lambda x: '停产' in x)]
...
stock_date2['10days_later'] = stock_date2['stop_warning'].apply(lambda x: s.tradingday(x.strftime('%Y%m%d'), 10)[-1])
