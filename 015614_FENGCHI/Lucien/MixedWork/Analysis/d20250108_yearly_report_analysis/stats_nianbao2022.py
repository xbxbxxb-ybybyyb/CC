...
date_list = list(map(lambda x: str(x), date_list))
yugao_all_df = get_latest_nianbao(type='all', early_year=20220101, late_year=20221231)
...
yugao_all_df['距离0430距离'] = yugao_all_df['年报实际披露日首次交易日'].apply(lambda x: tradeDate.get_trade_date_interval(x, base_date=20230430) + 1)
...
FileUtil.save_dict2xls(output_dict, '/data/user/015614/junkData/', '年报披露日公告后表现统计2022.xlsx')
from dataApi.sendInfo import send_file
send_file('/data/user/015614/junkData/年报披露日公告后表现统计2022.xlsx')
