...
yugao_all_df['距离0430距离'] = yugao_all_df['年报实际披露日首次交易日'].apply(lambda x: tradeDate.get_trade_date_interval(x, base_date=20220430) + 1)
...
res.to_excel('/data/user/015614/junkData/2021年度年报披露结果.xlsx')
