...
date_list = get_date_range(20211101, 20220630)
date_list = list(map(lambda x: str(x), date_list))
yugao_all_df = get_latest_yugao(type='all', early_year=20210101, late_year=20211231)
...
yugao_all_df = yugao_all_df.query('预告首次交易日 <= 20221231')
...
res.to_excel('/data/user/015614/junkData/2021年度业绩预告结果.xlsx')
...
FileUtil.save_dict2xls(output_dict, '/data/user/015614/junkData/', '业绩预告后表现统计2021.xlsx')
from dataApi.sendInfo import send_file
send_file('/data/user/015614/junkData/业绩预告后表现统计2021.xlsx')
