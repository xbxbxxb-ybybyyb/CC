...
date_list = list(map(lambda x: str(x), date_list))
yugao_all_df = get_latest_yugao(type='all', early_year=20230101, late_year=20231231)
...
res.to_excel('/data/user/015614/junkData/2023年度业绩预告结果.xlsx')
...
FileUtil.save_dict2xls(output_dict, '/data/user/015614/junkData/', '业绩预告后表现统计.xlsx')
from dataApi.sendInfo import send_file
send_file('/data/user/015614/junkData/业绩预告后表现统计.xlsx')
