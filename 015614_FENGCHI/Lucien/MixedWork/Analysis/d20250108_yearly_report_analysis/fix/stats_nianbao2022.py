...
date_list = get_date_range(20221101, 20230930)
date_list = list(map(lambda x: str(x), date_list))
...
yugao_all_df['距离0430距离'] = yugao_all_df['年报预计披露日首次交易日'].apply(lambda x: tradeDate.get_trade_date_interval(x, base_date=20230430) + 1)
