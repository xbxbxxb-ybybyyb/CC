...
if __name__ == '__main__':
    ...
    today_work_summary = '成交记录生成交接与定时任务设置；进行simlite与仿真日志解析和因子模型对比'

    # TODO:注意修改owner为自己的姓名，注意修改next_meeting_day为本次周例会日期，一般为周二
    send_daily_work_summary(today_work_summary, owner='冯炽', today_date=today_date, root_path=summary_root_path)
