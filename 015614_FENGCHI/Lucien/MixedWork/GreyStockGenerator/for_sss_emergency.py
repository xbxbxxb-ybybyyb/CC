...
'''
shutil.copyfile(root_path + 'abnormal_notice_list_20250424.xlsx',
                root_path + 'abnormal_notice_list_20250425.xlsx')
shutil.copyfile(user_path + 'abnormal_notice_list_20250424.xlsx',
                user_path + 'abnormal_notice_list_20250425.xlsx')