...
# comp_restrict_list = list(filter(lambda x: x[:2] in ['60', '30', '00', '68'], comp_restrict_list))
comp_restrict_list = list(filter(lambda x: x[:2] in ['60', '30', '00', '68', '43', '83', '87', '92'], comp_restrict_list))
