...
# 如果远程调用此文件进行超参数寻优，那么要按以下参数顺序传入参数值
if len(sys.argv) > 1:
    search_time = sys.argv[1]
    strategy_name = sys.argv[2]
    version = sys.argv[3]
    model_name = sys.argv[4]
    hump_model_name = sys.argv[5]
    pred_fpath = sys.argv[6]
    hyper_search_flag = True
    file_save_path = f'/data/user/015614/Zeus/backtest/{strategy_name}/{version}/{model_name}/hyper_opt/{search_time}/'
else:
    search_time = None
    ...
    pred_fpath = '/data/group/800463/fengc/pred/Saturn_v1/xgb_clf_model/20190102~20200630_fcModel_v1.csv'
    file_save_path = f'/data/user/015614/Zeus/backtest/{strategy_name}/{version}/{model_name}/'
...
if __name__ == "__main__":
    ...
    sel_model_names = [hump_model_name]
