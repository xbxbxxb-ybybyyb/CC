...
if __name__ == "__main__":
    ...
    # 修改为自己的文件保存路径
    FilesavePath = '/data/group/800463/fengc/Saturn/v1/bactest/hyper2/'
    ...
    valid_path_list = [
        '/data/group/800463/fengc/pred/Saturn_v1/xgb_clf_model/hyper2/20190102~20200630_fcModel_v1.csv'
        ]
    pred_path_list = [
        '/data/group/800463/fengc/pred/Saturn_v1/xgb_clf_model/hyper2/20190102~20200630_fcModel_v1.csv'
        ]
