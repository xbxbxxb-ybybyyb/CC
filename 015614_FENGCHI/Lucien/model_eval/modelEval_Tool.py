...
class modelEval_Tool:
    def __init__(self, strategy_name, pred_data, valid_data, model_name, begindate, enddate, in_begindate, in_enddate, savepath, label_name='label_pct_cost', vote_type=False, scene_flag=''):
    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1', 'SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                ...
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('JupiterNSell_pct7') >= 0:
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell_pct7/sell%s_profitdata_foreur_SH300_SZ30.pkl' % '_pct7'  # '/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('JupiterNSell_sapphire') >= 0:
                if self.strategy.find('pred1') < 0:
                    indi_str = self.strategy.split('JupiterNSell_sapphire')[-1]
                else:
                    indi_str = (self.strategy.split('JupiterNSell_sapphire')[-1]).split('_pred1')[0]
                # print(indi_str)
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sapphire/%s%s_profitdata_foreur_0.15_2000_300_SH250_SZ20.pkl' % ('sapphire', indi_str)
                self.cost_pct = 0
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('JupiterNSell_pctmerge57') >= 0:
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell_pct7/sell%s_profitdata_foreur_SH300_SZ30.pkl' % '_pct57'  # '/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('EuropaNew_merge31') >= 0:
                self.profit_path = '/data/group/800463//wangj/save_files/EuropaNew/v1/profit003001/europa_31_profitdata_SH300_SZ30.pkl'  # '/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0.002
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('JupiterNSell_pct5') >= 0:
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell_pct5/sell%s_profitdata_foreur_SH300_SZ30.pkl' % '_pct5'  # '/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find('JupiterNSell_rise3') >= 0:
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell_rise3/sell%s_profitdata_foreur_SH300_SZ30.pkl' % '_rise3'  # '/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 10
                self.attend_max = 51
                self.group_ratio = 0.2
                ...
                # self.profit_path = '/data/group/800463/wangj/save_files/Metis_v1/profit/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20_merge_eurmetis.pkl'
                self.cost_pct = 0.002
                self.attend_min = 20  # 5#20
                self.attend_max = 81  # 81#41
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy == 'EuropaNew':
                self.profit_path = '/data/group/800463/sunss/europanew/profit/LabelProfit_zt_twap_0.10_800_190_SH300_SZ30.h5'
                self.cost_pct = 0.002
                self.attend_min = 20  # 5#20
                ...
                self.profit_path = '/data/group/800463/sunss/metis/20230805/profit/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'

                self.cost_pct = 0.002
                self.attend_min = 20  # 5#20
                self.attend_max = 61  # 81#41
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_realrealrealout_20210701_20220930_profitdata_for_alleur_SH300_SZ30_v3new_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_realrealrealout_20220101_20230331_profitdata_for_alleur_SH300_SZ30_v3new_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_realrealrealrealout_v3fited_20221001_20230331_profitdata_for_alleur_SH300_SZ30_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_mergeperiod45_20220101_20230331_profitdata_for_alleur_SH300_SZ30_v3new_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_out_20191001_20201231_profitdata_for_alleur_SH300_SZ30_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_out_20200401_20210630_profitdata_for_alleur_SH300_SZ30_mergeallsell.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/sell123_out_20201001_20211231_profitdata_for_alleur_SH300_SZ30_mergeallsell.pkl'
                self.cost_pct = 0.002
                self.attend_min = 20  # 5#20
                self.attend_max = 51  # 81#41
                self.group_ratio = 0.2
            ...
            if self.profit_path.endswith('.h5'):
                ...
                if self.strategy.find('JupiterZSell') >= 0:
                    ...
                    sel_profit = profit_data.loc[sel_index].sort_index()#.query('remain_amt>0')
                    ...
                    if buy_type == 'pred1':
                        model = model.loc[list(set(sel_profit.loc[model.index].query('buySignal==1 and old_buy_amt>0').index.tolist()))].sort_index()
                        sel_profit = sel_profit.query('buySignal==1 and old_buy_amt>0').loc[model.index].sort_index()
                    else:
                        model = model.loc[list(set(sel_profit.loc[model.index].query('old_buy_amt>0').index.tolist()))].sort_index()
                        sel_profit = sel_profit.query('old_buy_amt>0').loc[model.index].sort_index()
                    str_pred = 'prediction'
                    sel_profit = sel_profit.loc[model.index].sort_index()
                    sel_profit = sel_profit.join(model[[str_pred]], on=['dt', 'Ticker'])
                    sel_profittmp = sel_profit.reset_index()
                    sel_profittmp['buy_dt'] = sel_profittmp['buy_date']
                    sel_profittmp['stockcode'] = sel_profittmp['Ticker']
                    sel_profittmp.set_index(['buy_dt', 'stockcode'], inplace=True)

                    cf_df1 = sel_profittmp.groupby(['buy_date', 'Ticker']).count()['jupiterZ_dt'].sort_values()

                    cf_index1 = cf_df1[cf_df1 > 1].index.tolist()
                    nocf_index1 = cf_df1[cf_df1 <= 1].index.tolist()

                    sels1 = sel_profittmp.loc[cf_index1].set_index(['dt', 'Ticker']).sort_values(
                        ['buy_date', 'stockID', str_pred, 'sell_date']).drop_duplicates(['buy_date', 'stockID'],
                                                                                        keep='first')  # 处理1个买入多个卖出的情况，保留第一个预测为 1的卖出信号

                    sels = pd.concat([sel_profittmp.loc[nocf_index1].set_index(['dt', 'Ticker']), sels1])
                    cf_df = sels.groupby(['dt', 'Ticker']).count()['jupiterZ_dt'].sort_values()
                    cf_index = cf_df[cf_df > 1].index.tolist()

                    print(len(cf_index), len(cf_index1))
                    nocf_index = cf_df[cf_df <= 1].index.tolist()
                    sel = sels.loc[cf_index].sort_values(
                        ['sell_date', 'stockID', str_pred, 'buy_date']).drop_duplicates(['sell_date', 'stockID'],
                                                                                        keep='first')  # # 处理多个买入对应1个卖出的情况，保留最早的买入信号
                    sel = pd.concat([sel.copy(), sels.loc[nocf_index]])
                    ...
                    profit_data = sel.copy()#pd.concat([sel.copy(), sels.loc[nocf_index]])
                    model = model.loc[profit_data.index].sort_index()
                    self.pred_data = self.pred_data.loc[model.reset_index().set_index(['Indexs']).index]
                    print(buy_type,len(profit_data),len(model))'''
                    period_num = self.strategy.split('_')[-1]
                    profit_data['old_buy_amt'] = profit_data['buy_amt']
                    profit_data['buy_amt'] = profit_data['remain_amt']
                    profit_data['buySignal'] = profit_data['buySignal_%s' % period_num]
                    model = self.pred_data.copy().query(
                        'datelist>=%s and datelist<=%s' % (self.begindate, self.enddate)).reset_index()
                    model['dt'] = model['datelist'].apply(lambda x: pd.Timestamp(str(x)))
                    model.set_index(['dt', 'stockID'], inplace=True)
                    sel_index = list(set(model.index.tolist()) & set(profit_data.index.tolist()))
                    ...
                    buy_type = self.strategy.split('_')[-2]
                    if buy_type == 'pred1':
                        model = model.loc[list(set(sel_profit.loc[model.index].query(
                            'buySignal==1 and remain_amt>0').index.tolist()))].sort_index()
                    ...
                    sels1 = sel_profit.loc[cf_index].sort_values(
                        ['buy_date', 'stockID', 'prediction', 'sell_date']).drop_duplicates(['buy_date', 'stockID'],
                                                                                            keep='first')  # 处理1个买入多个卖出的情况，保留第一个预测为 1的卖出信号
                    sel = sels1.sort_values(['sell_date', 'stockID', 'prediction', 'buy_date']).drop_duplicates(
                        ['sell_date', 'stockID'], keep='first')  # # 处理多个买入对应1个卖出的情况，保留最早的买入信号
                    # sel_index1 = list(set(sel_profit.query('prediction==1').index.tolist()) & set(cf_index))
                    # sel_index2 = list(set(sel_profit.query('prediction==0').index.tolist()) & set(cf_index))
                    # print(len(sel_index), len(sel_index1), len(sel_index2), len(sel_profit))
                    #
                    #
                    # # sel_profit.drop_duplicates(subset=['buy_date', 'stockID'], keep='first', inplace=True)
                    # # sel_profit.drop_duplicates(subset=['sell_date', 'stockID'], keep='first', inplace=True)
                    # sel1 = sel_profit.loc[sel_index1].sort_index()
                    # sel2 = sel_profit.loc[sel_index2].sort_index()
                    # # sel1['sell_pred'] = 1
                    # # sel2['sell_pred'] = 0
                    # sel1 = sel1.sort_values(by=['prediction'], ascending=False).sort_index()
                    # sel2 = sel2.sort_values(by=['prediction'], ascending=False).sort_index()
                    #
                    # #sel1.drop_duplicates(subset=['buy_date', 'stockID'], keep='first',inplace=True) 多个买入一个卖出不需要删除
                    # sel1.drop_duplicates(subset=['sell_date', 'stockID'], keep='first',inplace=True)
                    #
                    # #sel2.drop_duplicates(subset=['buy_date', 'stockID'], keep='first',inplace=True)
                    # sel2.drop_duplicates(subset=['sell_date', 'stockID'], keep='last',inplace=True)
                    #
                    # sel = pd.concat([sel1, sel2]).sort_index()
                    # print(len(model),len(sel))
                ...
                elif self.strategy in ['JupiterNSell'] or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pct5') >= 0 or self.strategy.find(
                        'JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0:
                    ...
                    model['dt'] = model['datelist'].apply(lambda x: pd.Timestamp(str(x)))
                    model.set_index(['dt', 'stockID'], inplace=True)
                    pct5pred1 = model.query('pred_pct5==1').index.tolist()
                    pct5other = list(set(model.index.tolist()) - set(pct5pred1))
                    print(len(pct5pred1), len(pct5other))
                    profit_data.loc[pct5pred1, 'pct'] = profit_data.loc[pct5pred1, 'pct5']
                    profit_data.loc[pct5other, 'pct'] = profit_data.loc[pct5other, 'pct7']
                elif self.strategy == 'JupiterNSell34':
                    model = self.pred_data.copy().reset_index()
                    model['dt'] = model['datelist'].apply(lambda x: pd.Timestamp(str(x)))
                    model.set_index(['dt', 'stockID'], inplace=True)
                    ...
                    model['dt'] = model['datelist'].apply(lambda x: pd.Timestamp(str(x)))
                    model.set_index(['dt', 'stockID'], inplace=True)
                    jupz_index = model.query('pred_v1==0 and pred_v3==0 and pred_jupz==1').index.tolist() + model.query(
                        'pred_v1==0 and pred_v3==1 and pred_jupz==1').index.tolist()
                    v1index = model.query('pred_v1==1 and pred_v3==0').index.tolist()
                    v3index = list(set(model.query('pred_v1==0 and pred_v3==1').index.tolist()) - set(
                        model.query('pred_v1==0 and pred_v3==1 and pred_jupz==1').index.tolist()))
                    v2index = list(set(model.index.tolist()) - set(v1index + v3index + jupz_index))
                    print(len(model), len(v1index), len(v3index), len(jupz_index), len(v2index))
                    ...
                    profit_data.loc[jupz_index, 'pct'] = profit_data.loc[jupz_index, 'pct_v3quick']  # - 0.001
                elif self.strategy == 'EuropaSellEnhance':
                    model = self.pred_data.copy().reset_index()
                    model['dt'] = model['datelist'].apply(lambda x: pd.Timestamp(str(x)))
                    model.set_index(['dt', 'stockID'], inplace=True)
                    jupz_index = model.query('pred_v1==0 and pred_v3==0 and pred_jupz==1').index.tolist() + model.query('pred_v1==0 and pred_v3==1 and pred_jupz==1').index.tolist()
                    v1index = model.query('pred_v1==1 and pred_v3==0').index.tolist()
                    v3index = list(set(model.query('pred_v1==0 and pred_v3==1').index.tolist()) - set(model.query('pred_v1==0 and pred_v3==1 and pred_jupz==1').index.tolist()))
                    v2index = list(set(model.index.tolist()) - set(v1index + v3index + jupz_index))
                    print(len(model), len(v1index), len(v3index), len(jupz_index), len(v2index))
                    profit_data['old_pct'] = profit_data['pct']
                    ...
                    profit_data.loc[jupz_index, 'pct'] = profit_data.loc[jupz_index, 'pct_v3quick'] - profit_data.loc[jupz_index, 'old_pct']
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                ...
                # self.label_path = '/data/user/013550/Jupiter/jupiter_v9/fac_20221220/label_df.pkl'
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy in ['JupiterNSell', 'EuropaSell', 'JupiterNSell34', 'EuropaSellEnhance'] or self.strategy.find('JupiterNSell_sapphire') >= 0 or self.strategy.find(
                    'JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find('JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0:
                self.label_path = '/data/group/800463/sunss/%s/%s/factor_df_all_20160101_20211231_931_xly.pkl' % (
                'europa', str(20230317))  # '/data/group/800463/sunss/jupiter_931o2ul/20230201/factor_df_all_20160101_20201231.pkl'
                ...
                self.label_path = '/data/user/018107/share_file/for_wj/%s/%s/factor_df_all_20160101_20230331.pkl' % ('jupiterZ', str(20230415))
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'JupiterZ':
                ...
                self.label_path = '/data/user/018107/share_file/for_wj/europa/20230329/factor_df_all_20160101_20230331_fit.pkl'
                # self.label_path ='/data/group/800463/wangj/save_files/Europa_v3/maxbeta/label_df.pkl'
                self.label_path = '/data/group/800463/wangj/save_files/Metis_v1/profit/label.pkl'

                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'EuropaNew':
                self.label_path = '/data/group/800463/sunss/europanew/20230801/factor_df_all_20160101_20211231_graded.pkl'
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'Metis':
                self.label_path = '/data/group/800463/sunss/metis/20230805/factor_df_all_20160101_20211231_graded.pkl'
                self.label_path = '/data/user/018107/share_file/for_wj/metis/20230805/factor_df_all_20160101_20220630.pkl'
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'SaturnS0':
            ...
            if self.strategy in ['SaturnS0_2tick', 'Saturn3S1']:
                labeladd = pd.read_hdf('/data/group/800463/project/project2_prod/daily_data/sft/sft_basic_origin.h5')
                addcols = list(set(labeladd.filter(regex='label').columns.tolist()) - set(label_data.columns.tolist()))
                label_data = pd.concat([label_data, labeladd[addcols]], axis=1, join_axes=[label_data.index])
                if self.strategy == 'Saturn3S1':
                    label_data['label_TNv2TNo'] = label_data['label_TN3v2TN3o'].tolist()
                    label_data['label_TNo2Tc'] = label_data['label_TN3o2Tc'].tolist()
            label_data = label_data.filter(regex='label*')  # .reset_index()
            label_data = label_data.fillna(0)
            if self.strategy in ['SaturnS1', 'SaturnS0', 'SaturnS0_2tick', 'Saturn', 'Saturn_down', 'SaturnS5', 'SaturnS3', 'SaturnS0&SaturnS1', 'SaturnS1&SaturnS3', 'Saturn3S1']:
                To2pre_df = pd.read_hdf(self.label_path)
                To2pre_df.rename(columns={'saturn_t930_T_o2pre': 'T_o2pre', 'saturn_pre_close': 'pre_close', 'saturn_lzt_day_pattern': 'lzt_label_pattern'}, inplace=True)
                # T1o2pre_df = pd.read_hdf('/data/group/800463/sunss/saturn/data/wd_t1_pct.h5')
                # To2pre_df = pd.read_hdf('/data/group/800463/project/project2_prod/daily_data/Basic/Basic_closed_hf_finish.h5').drop_duplicates()
                T1o2pre_df = pd.read_hdf('/data/group/800463/project/project2_prod/daily_data/Basic/wd_t1_pct.h5')
                label_data = pd.concat([label_data, To2pre_df[['T_o2pre', 'pre_close']], T1o2pre_df], axis=1).reindex(label_data.index)  # ,join_axes=[label_data.index]) # , 'lzt_label_pattern'
            ...
            if 'label_T_close_is_zt' not in label_data.columns.tolist() and (
                    self.strategy in ['JupiterN', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell', 'EuropaSellEnhance'] or self.strategy.find(
                    'JupiterZSell') >= 0 or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find(
                    'JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0):
                label_data['label_T_close_is_zt'] = label_data['label_T_is_zt']
            if 'label_Next_close_is_zt' not in label_data.columns.tolist() and (
                    self.strategy in ['JupiterN', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell', 'EuropaSellEnhance'] or self.strategy.find(
                    'JupiterZSell') >= 0 or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find(
                    'JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0):
    ...
    def generate_series_data(self):
        ...
        if self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find('JupiterNSell_pct5') >= 0 or self.strategy.find(
                'JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0:
            sel_index = list(set(self.pred_data.index.tolist()) & set(self.label_data.index.tolist()))
            model = self.pred_data.loc[sel_index].sort_values(by=['datelist'])
            if self.strategy.find('pred1') >= 0:
                period_indicator = self.strategy.split('pred1_')[1]
                sel_index = list(set(model.index.tolist()) & set(self.profit_data.query('label_pred_%s ==1' % str(period_indicator)).index.tolist()))
                model = model.loc[sel_index].sort_values(by=['datelist'])
            print('model length:%d' % len(model))
        model_valid = model.copy()  # self.valid_data
        ...
        model = pd.concat([model, label_data], axis=1).loc[model.index].reindex(model.index).fillna(0)  # , join_axes=[model.index])
        ...
        model = pd.concat([model[list(set(model.columns.tolist()) - set(profit_data.filter(regex='label*').columns.tolist()))], profit_data.filter(regex='label*')], axis=1).reindex(
            model.index).fillna(0)  # ,join_axes=[model.index])
        if self.strategy in ['EuropaSellEnhance']:
            model = model.query('label_buy_amt>0')
            # model_valid = model_valid.query('label_buy_amt>0')
        # 选择label
        ...
        if self.strategy in ['SaturnS1', 'SaturnS0', 'SaturnS0_2tick', 'Saturn', 'Saturn_down', 'SaturnS5', 'SaturnS3', 'SaturnS0&SaturnS1', 'SaturnS1&SaturnS3', 'Saturn3S1']:  # ,'CeresS1'
        ...
        totalResDf, daily_data, statistic_by_sample, daily_data_valid, model_mingan, model_inmingan, group_proba_all, totalResDf_only_extreme = self.generate_test_report(model, model_valid,
                                                                                                                                                                          scene_flag, predcol)
    ...
    def generate_test_report(self, pred_out, pred_in, scene_flag, probacol):
        ...
        if self.strategy not in ['JupiterN', 'jupiter_sell', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell',
                                 'EuropaSellEnhance'] and self.strategy.find('JupiterZSell') < 0 and self.strategy.find('JupiterNSell_pct7') < 0 and self.strategy.find(
                'JupiterNSell_pctmerge57') < 0 and self.strategy.find('JupiterNSell_pct5') < 0 and self.strategy.find('JupiterNSell_rise3') < 0 and self.strategy.find('JupiterNSell_sapphire') < 0:
            ...
            if self.strategy in ['SaturnS1', 'SaturnS0', 'SaturnS0_2tick', 'Saturn', 'Saturn_down', 'SaturnS5', 'SaturnS3', 'SaturnS1&SaturnS3', 'Saturn3S1']:
            ...
            if self.strategy == 'EuropaSell':  # .find( 'EuropaSell')>=0:
                ...
                statistic_by_sample['pred_jupz'] = sample_data['pred_jupz']
            ...
            elif self.strategy == 'JupiterNSell_pctmerge57':
                statistic_by_sample['pred_pct5'] = sample_data['pred_pct5']
                statistic_by_sample['pred_pct7'] = sample_data['pred_pct7']
                statistic_by_sample['pct5'] = sample_data['label_pct5']
                statistic_by_sample['pct7'] = sample_data['label_pct7']
                statistic_by_sample['重合类型'] = sample_data['chonghe_type']

        statistic_by_sample['是否为上海'] = sample_data['Flag_SH']
        statistic_by_sample[self.indi_str] = sample_data['prediction'].fillna(0).astype(int)
        statistic_by_sample[self.predcol] = sample_data['pred_Reg'].fillna(0).astype(float)
        ...
        totalResDf, _, totalResDf1, _, group_proba_all = self.combine_res_inout(pred_out.copy(), sample_data.copy(), statistic_without_extreme_value.copy(), statistic_by_sample.copy(),
                                                                                statistic_by_day.copy(), pred_in, scene_flag, probacol)

        totalResDf_monthly = totalResDf.copy()  # pd.DataFrame()
        # self.indi_str.find('Model')<0 and
        if (self.indi_str.find('Model') < 0 and self.indi_str.find('Sell') < 0 and self.indi_str.find('stack') < 0 and self.indi_str.find('vote') < 0 and tradedate_length < len(
                hfactor.tradingday(self.begindate, self.enddate)) and self.vote_type == False):
            ...
            for idx in list(range(len(minlist))):
                ...
                statistic_by_day_tmp, statistic_by_sample_tmp = self.fun_statistic_by_day(start_date, stop_date, statistic_by_sample.query('datelist>=%s and datelist<=%s' % (start_date, stop_date)),
                                                                                          pred_out_tmp)
        ...
        writer.save()
        return totalResDf_monthly, daily_data, statistic_by_sample_all.set_index(
            ['datelist', 'stockID']), statistic_by_day_valid, model_mingan, model_valid_mingan, group_proba_all_without_extreme, totalResDf_monthly_without_extreme
    ...
    def fun_statistic_by_day(self, start_date, end_date, by_samples, pred_out):
        ...
        by_day['滚动5日收益率(扣除成本)'] = ((by_sample.groupby('datelist').sum()['收益率(扣除成本)'].reindex(by_day.index).fillna(0)).rolling(5, 5).sum() / (
                    1 + by_sample.groupby('datelist').count()['stockID'].reindex(by_day.index).fillna(0)).rolling(5, 5).sum()).fillna(0)
    ...
    def fun_statistic_by_day_valid(self, by_samples):
        by_sample = by_samples.reset_index().copy()
        cols = list(set(by_sample.columns.tolist()) - set(
            ['stockID', 'Indexs', 'jup_dt', 'sell_dt', 'Ticker', 'dt', 'dt_last_zt_1_ts', 'label_date_list', 'label_touch_list', 'label_vol_list', 'label_sell_date', 'label_touch_ul',
             'label_sell_vol']))
        by_sample[cols] = by_sample[cols].astype(float)
        by_sample['datelist'] = by_sample['datelist'].astype(int)
    ...
    def cal_model_mingan(self, sel_raw_data, factor, step=1):
        ...
        if self.indi_str.find('scene') < 0:
            ...
            for group_indi_str in plot_data.index.tolist():
                ...
                plot_data.loc[group_indi_str, '收益风险比'] = round(plot_data.loc[group_indi_str, '累计盈利'] / abs(plot_data.loc[group_indi_str, '最大回撤']),
                                                               4)  # round(abs(plot_data.loc[group_indi_str,'累计盈利']/plot_data.loc[group_indi_str, '最大回撤']),4)
    ...
    def combine_res_inout(self, pred_sample_data, sample_data, statistic_without_extreme_value, statistic_by_sample, statistic_by_day, pred_in, flag_scene, proba_col):
        ...
        if 'label_zuhe' not in pred_sample_data.columns.tolist() and (
                self.strategy in ['JupiterN', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell', 'EuropaSellEnhance'] or self.strategy.find(
                'JupiterZSell') >= 0 or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find(
                'JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0):
        ...
        if 'label_pat_zuhe' not in pred_sample_data.columns.tolist() and (
                self.strategy in ['JupiterN', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell', 'EuropaSellEnhance'] or self.strategy.find(
                'JupiterZSell') >= 0 or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find(
                'JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0):
        ...
        prec_profit = 0 if statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0] == 0 else \
        statistic_by_sample[(statistic_by_sample['投资金额'] > 0) & (statistic_by_sample['收益率(扣除成本)'] > 0)].shape[0] / statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0]

        ykb = 0 if statistic_by_sample[statistic_by_sample['盈亏金额(扣除成本)'] <= 0]['收益率(扣除成本)'].mean() == 0 else statistic_by_sample[statistic_by_sample['盈亏金额(扣除成本)'] > 0]['收益率(扣除成本)'].mean() / abs(
            statistic_by_sample[statistic_by_sample['盈亏金额(扣除成本)'] <= 0]['收益率(扣除成本)'].mean())
        ...
        if self.strategy in ['JupiterN', 'Europa', 'EuropaNew', 'Metis', 'jupiter003', 'JupiterNSell', 'JupiterNSell34', 'JupiterZ', 'EuropaSell', 'EuropaSellEnhance'] or self.strategy.find(
                'JupiterZSell') >= 0 or self.strategy.find('JupiterNSell_pct7') >= 0 or self.strategy.find('JupiterNSell_pctmerge57') >= 0 or self.strategy.find(
                'JupiterNSell_pct5') >= 0 or self.strategy.find('JupiterNSell_rise3') >= 0 or self.strategy.find('JupiterNSell_sapphire') >= 0:
            ...
            totalResDf.loc['Tc2o10为正占比'] = statistic_by_sample[(statistic_by_sample['Tc2o10收益率'] > 0) & (statistic_by_sample['投资金额'] > 0)].shape[0] / \
                                           statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0]
            ...
            totalResDf.loc['高收益占比'] = statistic_by_sample[(statistic_by_sample['投资金额'] > 0) & (statistic_by_sample['收益率(扣除成本)'] > 0.08)].shape[0] / \
                                      statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0]
            totalResDf.loc['低收益占比'] = statistic_by_sample[(statistic_by_sample['投资金额'] > 0) & (statistic_by_sample['收益率(扣除成本)'] < -0.08)].shape[0] / \
                                      statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0]
            totalResDf.loc['二连板占比'] = statistic_by_sample[(statistic_by_sample['投资金额'] > 0) & (statistic_by_sample['是否T日收盘涨停'] == 1)].shape[0] / \
                                      statistic_by_sample[(statistic_by_sample['投资金额'] > 0)].shape[0]
            ...
            totalResDf.loc['未参与胜率'] = 0 if statistic_by_sample[(statistic_by_sample['投资金额'] == 0)].shape[0] == 0 else float(
                statistic_by_sample[(statistic_by_sample['投资金额'] == 0) & (statistic_by_sample['v2o10收益率'] >= self.cost_pct)].shape[0] / totalResDf.loc['未参与数量'])
        ...
        proba_stats_all = self.group_pattern_stas(pred_sample_data.sort_values(by=proba_col, ascending=False), proba_col, group_num, '')[
            ['标的数量', 'v2o10均值', 'v2o10中位数', 'v2o10为正占比', '扣费收益率均值', '扣费收益率中位数', '扣费收益率为正占比', 'group_id']]
        if flag_scene == '':
            ...
            proba_stats_high = self.group_pattern_stas(
                pred_sample_data.query('%s==1' % flag_scene).sort_values(by=proba_col, ascending=False).iloc[:int(len(pred_sample_data.query('%s==1' % flag_scene)) * self.group_ratio)], proba_col,
                group_num, '')
            proba_stats_low = self.group_pattern_stas(
                pred_sample_data.query('%s==0' % flag_scene).sort_values(by=proba_col, ascending=False).iloc[:int(len(pred_sample_data.query('%s==0' % flag_scene)) * self.group_ratio)], proba_col,
                group_num, '')
        ...
        totalResDf.loc['预测值与标签IC'] = pred_sample_data.query('label_buy_amt>0')[[self.label_name, self.predcol]].corr().loc[
            self.label_name, self.predcol]  # roc_auc_score(pred_sample_data.query('label_buy_amt>0')['label_zuhe'],pred_sample_data.query('label_buy_amt>0')[self.indi_str])
        ...
        totalResDf.loc['前50%预测值与标签IC'] = pred_sample_data_half.iloc[:int(len(pred_sample_data_half) / 2)][[self.label_name, self.predcol]].corr().loc[
            self.label_name, self.predcol]  # roc_auc_score(pred_sample_data.query('label_buy_amt>0')['label_zuhe'],pred_sample_data.query('label_buy_amt>0')[self.indi_str])
    ...
    def cal_basicEval(self, pred_sample_data):
        ...
        for dt, group in grouped:
            ...
            if count == 5:
                ...
                p_score_N5 = precision_score(dfN5['label_zuhe'], dfN5['pred'].astype(int))
                r_score_N5 = recall_score(dfN5['label_zuhe'], dfN5['pred'].astype(int))
    ...
    def cal_basicEval_jup(self, pred_sample_data):
        ...
        for dt, group in grouped:
            ...
            if count == 5:
                ...
                p_score_N5 = precision_score(dfN5['label_zuhe'], dfN5['pred'].astype(int))
                r_score_N5 = recall_score(dfN5['label_zuhe'], dfN5['pred'].astype(int))
                p_pat_score_N5 = precision_score(dfN5['label_pat_zuhe'], dfN5['pred'].astype(int))
                r_pat_score_N5 = recall_score(dfN5['label_pat_zuhe'], dfN5['pred'].astype(int))
    ...
    def cal_proEval(self, pred_sample_data):
        ...
        pred_sample_data['label_zuhe'] = [1 if x >= self.cost_pct else 0 for x in
                                          pred_sample_data[self.label_rev].tolist()]  # pred_sample_data.apply(lambda x: 1 if x['label_v2o10']>=cost_pct else 0, axis = 1)
        if 'pred' not in pred_sample_data.columns.tolist():
            if 'pred_label' in pred_sample_data.columns.tolist():
                pred_sample_data['pred'] = pred_sample_data['pred_label']
            else:
                ...
                pred_sample_data['pred'] = pred_sample_data['prediction']
        prec_score = precision_score(pred_sample_data['label_zuhe'], pred_sample_data['pred'].astype(int))
        rec_score = recall_score(pred_sample_data['label_zuhe'], pred_sample_data['pred'].astype(int))
    ...
    def cal_proEval_jup(self, pred_sample_data):
        ...
        prec_score_pat = precision_score(pred_sample_data['label_pat_zuhe'], pred_sample_data['pred'].astype(int))
        rec_score_pat = recall_score(pred_sample_data['label_pat_zuhe'], pred_sample_data['pred'].astype(int))
