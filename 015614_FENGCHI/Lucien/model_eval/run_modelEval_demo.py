...
def wrapper(_param_list):
    for param_tuple in _param_list:
        ...
        os.system(f'python3 /data/user/015614/Lucien/model_eval/modelEval_demo.py {PERIOD} {testfit}')
        # os.system(f'python3 /data/user/015614/Lucien/model_eval/jupz_demo.py {PERIOD} {testfit}')
