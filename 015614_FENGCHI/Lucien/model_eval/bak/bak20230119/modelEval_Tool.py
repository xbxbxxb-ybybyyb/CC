...
class modelEval_Tool:
    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                #self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit/LabelProfit_zt_twap_0.10_800_190_SH450_SZ100.h5'
                ...
                self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit/003/LabelProfit_zt_twap_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0.002
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                ...
                #self.profit_path = '/data/group/800463/project/project1_prod/LabelProfit/001/LabelProfit_zt_twap_0.10_800_190_SH450_SZ100.h5'
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                self.label_path = '/data/group/800463/project/project1_prod/factor_manager_v2/all_factor_bank/raw/all_factor_20150101_20220225.pkl'
                # self.label_path = '/data/group/800463/sunss/jupiter/20221220/factor_df_all_20160101_20211231.pkl'
                ...
                self.label_path = '/data/group/800463/project/project1_prod/factor_manager_v2/all_factor_bank/test_001/all_factor.pkl'
                self.label_path = '/data/group/800463/sunss/for_xly/europa/20221116_new/factor_df_all_20160101_20211231_train.pkl'
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'SaturnS0':
    ...
    def combine_res_inout(self,pred_sample_data,sample_data,statistic_without_extreme_value,statistic_by_sample,statistic_by_day,pred_in,flag_scene,proba_col):
        ...
        if self.strategy in ['JupiterN','Europa','jupiter003']:
            ...
            totalResDf.loc['收益风险比'] = totalResDf.loc['累计扣费总收益'] / np.abs(totalResDf.loc['最大回撤'])
