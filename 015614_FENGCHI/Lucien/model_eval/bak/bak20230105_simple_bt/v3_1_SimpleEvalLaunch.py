...
hfactor = FactorData()
from model_eval.bak.bak20230105_simple_bt.v3_1_Simple_modelEval_Tool import *
    ...
    def launch(self):
        ...
        if flag == True:
            ...
            for i in list(range(len(pred_path_list))):
                ...
                totalResDf_tmp, by_day_tmp, by_sample_tmp, model_mingan_tmp = tmp_modeleval.generate_series_data()
                if count == 1:
