...
hfactor = FactorData()
from model_eval.bak.bak20230105_simple_bt.v3_6_Simple_modelEval_Tool import *
    ...
    def launch(self):
        ...
        if flag == True:
            ...
            if self.save_flag:
                ...
                writer.save()
                return merge_modeleval, merge_inmodelmingan, merge_modelmingan, merge_attend_metric
            else:
                return merge_modeleval, merge_inmodelmingan, merge_modelmingan, merge_attend_metric