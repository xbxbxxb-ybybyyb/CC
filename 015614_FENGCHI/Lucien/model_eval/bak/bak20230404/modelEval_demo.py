...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Europa.v2_0_12.path_conf import date_config
    ...
    strategy_version = f'fac_20230329_{factor_type}_all_label_pct_graded_lowCost_{PERIOD}'
    ...
    # sel_model_names = ['LgbV8FcModel', 'XgbV8FcModel', 'LrRSFcModel', 'LgbV8HmlFcModel', 'XgbV8HmlFcModel',
    #                    'oldLgbV8FcModel', 'oldXgbV8FcModel', 'oldLrRSFcModel', 'oldLgbV8HmlFcModel', 'oldXgbV8HmlFcModel',
    #                    'lastLgbV8FcModel', 'lastLrRSFcModel']
    ...
    # sel_model_names = ['JupLgbV8FcModel', 'JupXgbV8FcModel', 'JupLrRSFcModel', 'JupLgbV8HmlFcModel', 'JupXgbV8HmlFcModel',
    #                    'EurLgbV8FcModel', 'EurXgbV8FcModel', 'EurLrRSFcModel', 'EurLgbV8HmlFcModel', 'EurXgbV8HmlFcModel']
    # sel_model_names = ['newLgbModel', 'newLgbModelAttend40', 'newLgbModelAttend50', 'newLgbModelAttend60', 'oldLgbModel_before935', 'oldLgbModel_after935']
    # sel_model_names = ['newLgbModel', 'Emotion5LgbModel', 'Emotion11LgbModel']
    # sel_model_names = ['LgbFcModel_before935', 'oldLgbFcModel_before935', 'oldLgbFcModel_after935']
    # sel_model_names = ['newHml', 'newHml0', 'newHml1', 'newHml2',
    #                    'oldHml', 'oldHml0', 'oldHml1', 'oldHml2',
    #                    'allModel']
    # sel_model_names = ['dropicModel', 'oldModel']
    # sel_model_names = ['newDrop76Model', 'oldModel']
    # sel_model_names = ['newModel', 'rffsModel', 'oldModel']
    # sel_model_names = ['newModel', 'o2ulModel', 'oldModel']
    ...
    sel_model_names = ['LgbFSV8Model', 'LgbRffsModel', 'LgbO2ulFSV8', 'XgbFSV8Model', 'XgbRffsModel', 'LinFSV8Model', 'LinRffsModel', 'LinRsfsModel']
    ...
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/XgbRegModelV2/{out_begin}~{out_end}_XgbRegModelV2_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LinRegModel/{out_begin}~{out_end}_LinRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LinRegModelV2/{out_begin}~{out_end}_LinRegModelV2_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_11/LgbRegModelV4/{out_begin}~{out_end}_LgbRegModelV4_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}_duiqi_v209.csv',
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}_duiqi_v209.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModelV4/{out_begin}~{out_end}_LgbRegModelV4_{SUB_VERSION}.csv',
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_9/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}.csv',
    ...
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}_method1.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv',
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_6/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv'
    # ]
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_hml.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}0.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}1.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}2.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}_hml.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}0.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}1.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_5/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}2.csv',
    #     f'/data/user/015614/Zeus/pred/Europa/v2_0_4/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv'
    # ]
    # valid_path_list = [
    ...
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_{SUB_VERSION}_hml.csv',
    #
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LrRegModel/{out_begin}~{out_end}_LrRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v4_hml.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_v4_hml.csv',
    #
    ...
    #     f'/data/user/015614/Zeus/pred/Europa/v1_0_31/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_{SUB_VERSION}_hml.csv',
    #
    #     # f'/data/user/015614/Zeus/pred/Europa/v1_0_31/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/Europa/v1_0_31/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/Europa/v1_0_31/LrRegModel/{out_begin}~{out_end}_LrRegModel_v4.csv',
    #     # f'/data/user/015614/Zeus/pred/Europa/v1_0_31/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v4_hml.csv',
    #     # f'/data/user/015614/Zeus/pred/Europa/v1_0_31/XgbRegModel/{out_begin}~{out_end}_XgbRegModel_v4_hml.csv',
    #
    #     # f'/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     # f'/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/{out_begin}~{out_end}_XgbRegModel_{SUB_VERSION}.csv',
    #     # f'/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/{out_begin}~{out_end}_LrRegModel_{SUB_VERSION}.csv',
    #     # f'/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_hml.csv',
    #     # f'/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/{out_begin}~{out_end}_XgbRegModel_{SUB_VERSION}_hml.csv',
    #     #
    ...
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/JupiterNSell/v1_0_1/LgbClfModel/{out_begin}~{out_end}_LgbClfModel_{SUB_VERSION}.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    # ]

    # 测试10点的样本表现，一个是根据10点前的模型评估结果进行的参数确定，一个是原来的v1_0_1的结果
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_3/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before10.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before10.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_after10.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_3/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    # ]

    # 测试935点的样本表现，一个是根据10点前的模型评估结果进行的参数确定，一个是原来的v1_0_1的结果
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_6/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_6/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend40.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_6/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend50.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_6/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend60.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_after935.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_5/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    # ]
    ...
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_8/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_8/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend40.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_8/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend50.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_8/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935_attend60.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935.csv',
    #     f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_after935.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_8/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_before935.csv',
    #     # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_{SUB_VERSION}_after935.csv',
    # ]
