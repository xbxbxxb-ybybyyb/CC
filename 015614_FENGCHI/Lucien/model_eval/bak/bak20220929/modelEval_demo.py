...
if __name__ == "__main__":
    ...
    strategy_version = 'fac_20220923_FSV9_filterV1_pct_graded'
    ...
    sel_model_names = ['V20220923FcModel', 'V20220913FcModel']
    # sel_model_names = ['V0830ModelV3', 'V0826Model', 'V0824Model', 'beforeChgModel']
    ...
    if flag == True:
        ...
        # valid_path_list = [
        #         '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_6/20190102~20200630_xgbRegModel_v1.csv',
        #         '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20200630_xgbRegModel_v1.csv'
        #     ]
        # pred_path_list = [
        #         '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_6/20190102~20200630_xgbRegModel_v1.csv',
        #         '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20200630_xgbRegModel_v1.csv'
        ...
        # filter_v3_up版本对比
        # valid_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_6/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_6/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20201231_xgbRegModel_v1.csv'
        ...
        # filter_v3_down版本对比
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_7/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20200630_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_7/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_7/20190102~20200630_xgbRegModel_v1.csv',
        ...
        # filter_v4版本对比
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_9/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20200630_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_9/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_9/20190102~20200630_xgbRegModel_v1.csv',
        ...
        # 20220813 S5 935样本
        # valid_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS5/xgb_reg_model/v2_14/20190102~20200630_xgbRegModel_v1.csv'
        #     # '/data/user/015614/Zeus/pred/SaturnS5/xgb_reg_model/v2_14/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS5/xgb_reg_model/v2_14/20190102~20200630_xgbRegModel_v1.csv'
        #     # '/data/user/015614/Zeus/pred/SaturnS5/xgb_reg_model/v2_14/20190102~20201231_xgbRegModel_v1.csv'
        ...
        # 20220813 down版本修改版
        # valid_path_list = [
        #     '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_13/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_13/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_13/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/Saturn_down/xgb_reg_model/v2_13/20190102~20201231_xgbRegModel_v1.csv'
        ...
        # 20220818 v6.1全样本和v5全样本对齐后（其实感觉可以不用对齐）以及v6.3版本的v2_17
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_17/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20200630_xgbRegModel_v1.csv'
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_16/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_2/20190102~20201231_xgbRegModel_v1.csv'
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v2_17/20190102~20200630_xgbRegModel_v1.csv',
        ...
        # 20180825 v6.3 修改因子后和修改因子前的结果对比，以及20220830 V6.3修改因子后和修改因子前的结果对比
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_7/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_5/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_3/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_4/20190102~20200630_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_7/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_5/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_3/20190102~20201231_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_4/20190102~20201231_xgbRegModel_v1.csv',
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_7/20190102~20200630_xgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_5/20190102~20200630_xgbRegModel_v1.csv',
        ...
        # # 20220829 v6_newlabel 切换标签后的训练结果
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_6/20190102~20200630_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_6/20190102~20201231_xgbRegModel_v1.csv',
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_6/20190102~20200630_xgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/xgb_reg_model/v3_0_6/20190102~20201231_xgbRegModel_v1.csv',
        ...
        # %% 20220908 测试V20220906的表现，对比全样本
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_9/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_8/20190102~20200630_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_9/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_8/20190102~20201231_lgbRegModel_v1.csv',
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_9/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_8/20190102~20200630_lgbRegModel_v1.csv',
        ...
        # 对齐0913样本，v1是不对齐的全样本，v2是对齐后的
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_13/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_14/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_15/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_16/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_17/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_10/20190102~20200630_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_13/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_14/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_15/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_16/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_17/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_10/20190102~20201231_lgbRegModel_v1.csv',
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_13/20190102~20200630_lgbRegModel_v1.csv',
        ...
        # 20220919 对齐0913样本 filter_v1
        # valid_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_12/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_10/20190102~20200630_lgbRegModel_v2.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_12/20190102~20201231_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_10/20190102~20201231_lgbRegModel_v2.csv',
        # ]
        # pred_path_list = [
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_12/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_10/20190102~20200630_lgbRegModel_v2.csv',
        ...
        # %% 测试不同数量的市场情绪因子对模型的效果，和方式2对比
        # valid_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_18/20190102~20200630_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_19/20190102~20200630_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_20/20190102~20200630_lgbRegModel_v1.csv',
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_14/20190102~20200630_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_18/20190102~20201231_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_19/20190102~20201231_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_20/20190102~20201231_lgbRegModel_v1.csv',
        #     # '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_14/20190102~20201231_lgbRegModel_v1.csv',
        # ]
        # pred_path_list = [
        #     '/data/user/015614/Zeus/pred/SaturnS1/lgb_reg_model/v3_0_18/20190102~20200630_lgbRegModel_v1.csv',
