...
class modelEval_Tool:
    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                ...
                # self.profit_path = '/data/group/800463/sunss/metis/20230805/profit/LabelProfit_zt_twap_0.10_800_190_SH300_SZ30.h5'
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                ...
                self.label_path = '/data/group/800463/sunss/metis/20230801/factor_df_all_20160101_20211231_graded.pkl'
            ...
            if 'label_T_close_is_zt' not in label_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance'] or self.strategy.find( 'JupiterZSell')>=0):
                label_data['label_T_close_is_zt'] = label_data['label_T_is_zt']
            if 'label_Next_close_is_zt' not in label_data.columns.tolist()  and (self.strategy in ['JupiterN','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance'] or self.strategy.find( 'JupiterZSell')>=0):
    ...
    def generate_test_report(self,pred_out, pred_in,scene_flag,probacol):
        ...
        if self.strategy not in ['JupiterN', 'jupiter_sell','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance'] and self.strategy.find( 'JupiterZSell')<0:
    ...
    def combine_res_inout(self,pred_sample_data,sample_data,statistic_without_extreme_value,statistic_by_sample,statistic_by_day,pred_in,flag_scene,proba_col):
        ...
        if 'label_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance'] or self.strategy.find('JupiterZSell')>=0):
        ...
        if 'label_pat_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance']  or self.strategy.find('JupiterZSell')>=0):
        ...
        if self.strategy in ['JupiterN','Europa','Metis','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','EuropaSell','EuropaSellEnhance'] or self.strategy.find('JupiterZSell')>=0:
