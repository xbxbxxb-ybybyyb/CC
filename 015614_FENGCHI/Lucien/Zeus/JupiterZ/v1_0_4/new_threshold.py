...
from Zeus.JupiterZ.v1_0_4.path_conf import date_config
import json
PERIOD = 'period5'
...
pred_data_fpath_list = [
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/{out_begin}~{out_end}_fsv10_lowCost_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/{out_begin}~{out_end}_fsv11_afterZ_lowCost_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/{out_begin}~{out_end}_fsv11_afterZ_lowCost_XgbRegModel_{SUB_VERSION}.csv',
]
...
pred_model_fpath_list = [
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/fsv10_lowCost_LgbRegModel/',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/fsv11_afterZ_lowCost_LgbRegModel/',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20220930/fsv11_afterZ_lowCost_XgbRegModel/',
]
...
threshold_list = [0.002903, 0.006262, 0.009456]
