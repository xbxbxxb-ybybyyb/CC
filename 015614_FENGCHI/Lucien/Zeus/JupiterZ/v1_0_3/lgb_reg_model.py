...
import pandas as pd
import numpy as np
from Zeus.JupiterZ.v1_0_3.path_conf import *
from Zeus.JupiterZ.v1_0_3.hyper_param_space import hyper_lgb_reg_params
...
from Zeus.JupiterZ.v1_0_3.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
#
fs_version = 'fsv8' # fsv8, fsv10, fsv11
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        if fs_version == 'rffs':
            if lowcost_version == 'lowCost':
                if afterZ_flag == 'True':
                    factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/JupiterZ/v1_0_3/rffs_afterZ_{lowcost_version}_{PERIOD}.pkl')
                else:
                    factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/JupiterZ/v1_0_3/rffs_{lowcost_version}_{PERIOD}.pkl')
            else:
                if afterZ_flag == 'True':
                    factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/JupiterZ/v1_0_3/rffs_afterZ_{PERIOD}.pkl')
                else:
                    factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/JupiterZ/v1_0_3/rffs_{PERIOD}.pkl')
        else:
