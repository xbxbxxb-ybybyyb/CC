...
hfactor = FactorData()
import pandas as pd
from Zeus.JupiterZ.v2_0_5.backtest.modelEval_Tool import *
from Zeus.JupiterZ.v2_0_5.path_conf import version, bt_out_path
...
def deal_preddata(path, viewcol, sel_data='all'):
    ...
    # # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/JupiterZ/v2_0_52/LgbRegModel/20210701~20211231_LgbRegModel_v4.csv', index_col=0) # period4
    # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/JupiterZ/v2_0_56/LgbRffsRegModel/20220401~20220930_LgbRffsRegModel_v5.csv', index_col=0)
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.JupiterZ.v2_0_5.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/JupiterZ/v2_0_5/{x}/model/{PERIOD}/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names]
