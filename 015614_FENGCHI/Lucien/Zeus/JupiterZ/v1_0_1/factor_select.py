...
class FactorSelect:
    ...
    def get_dataset(self, path):
        ...
        factor_list = pd.read_excel(factor_score_fpath, index_col=0).query('lowCost == 1')['factor_name'].tolist()   # lowcost
        X = X[factor_list]
...
if __name__ == '__main__':
    ...
    def launch_1period(period):
        ...
        # FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rffs_lowCost_{period}.pkl')
        FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rffs_afterZ_lowCost_{period}.pkl')
        # FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rffs_afterZ_{period}.pkl')
