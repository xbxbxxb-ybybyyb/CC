...
hfactor = FactorData()
import pandas as pd
from Zeus.JupiterZ.v2_0_2.backtest.modelEval_Tool import *
from Zeus.JupiterZ.v2_0_2.path_conf import version, bt_out_path
...
def deal_preddata(path, viewcol, sel_data='all'):
    ...
    # # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/JupiterZ/v2_0_22/LgbRegModel/20210701~20211231_LgbRegModel_v4.csv', index_col=0) # period4
    # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/JupiterZ/v2_0_26/LgbRffsRegModel/20220401~20220930_LgbRffsRegModel_v5.csv', index_col=0)
    # sell_profit = pd.read_pickle('/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell12_profitdata_foreur_SH300_SZ30.pkl')
    # # sell_profit = pd.read_pickle('/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell23_profitdata_foreur_SH300_SZ30.pkl')
...
if __name__ == "__main__":
    ...
    # strategy_name: 可选strategy_name: 策略名称：可选(SaturnS0,SaturnS1,CeresS0,CeresS1,JupiterN,JupiterZ)
    ...
    ''' test demo '''
    from Zeus.JupiterZ.v2_0_2.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    FilesavePath = bt_out_path + f'JupiterZ/{version}/'

    sel_model_names = ['fsrs_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel',
                       'fsv10_pct_AllLgbRegModel', 'rffs_pct_AllLgbRegModel']
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/JupiterZ/v2_0_2/{x}/model/period2/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names]
