...
period = 'period6'
pred_type = 'test'
sel_model_names = ['fsv11_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsv10_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel']
date_dict = date_config[period]

out_begin, out_end = date_dict[f'{pred_type}_start_date'], date_dict[f'{pred_type}_end_date']
valid_path_list = [f'/data/user/015614/Zeus/pred/JupiterZ/v2_0_1/{x}/model/{period}/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names]
