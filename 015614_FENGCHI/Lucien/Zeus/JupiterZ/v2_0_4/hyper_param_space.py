...
# xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.5, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.5, 'alpha': 1.5,
#                     'min_child_weight': 8, 'n_jobs': -1, 'seed': 2022, 'scale_pos_weight': 1.0, 'silent': True,
#                     'subsample': 0.9, 'tree_method': 'gpu_hist', 'eval_metric': 'rmse', 'objective': 'reg:linear', 'eta': 0.015, 'max_depth': 5, 'num_boost_round': 400}
xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.9, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.5, 'alpha': 1.5,
                    'min_child_weight': 8, 'n_jobs': -1, 'seed': 2022, 'scale_pos_weight': 1.0, 'silent': True,
                    'subsample': 0.9, 'tree_method': 'gpu_hist', 'eval_metric': 'rmse', 'objective': 'reg:linear', 'eta': 0.01, 'max_depth': 4, 'num_boost_round': 400}
...
fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 4, 'num_boost_round': 400}),
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 3, 'num_boost_round': 500}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 600}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400, 'min_child_weight': 7}),
    'rffs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 600}),
}
...
#                     'num_leaves': 36, 'seed': 2022, 'reg_alpha': 2.5, 'reg_lambda': 0.5, 'subsample': 1, 'subsample_freq': 0,  'device': 'gpu',
#                      'gpu_platform_id': 1, 'gpu_device_id': 0, 'gpu_use_dp': True, 'n_estimators': 400, 'max_depth': 7, 'learning_rate': 0.015}
lgb_fixed_params = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'min_child_samples': 4,
                    ...
                    'num_leaves': 36, 'seed': 2022, 'reg_alpha': 2.5, 'reg_lambda': 2.5, 'subsample': 1, 'subsample_freq': 0,  'device': 'gpu',
                     'gpu_platform_id': 1, 'gpu_device_id': 0, 'gpu_use_dp': True, 'n_estimators': 800, 'max_depth': 6, 'learning_rate': 0.04}
...
fixed_lgb_reg_param = {
    'fsv8': add(lgb_fixed_params, {'learning_rate': 0.04, 'max_depth': 6, 'n_estimators': 800}),
    'fsv10': add(lgb_fixed_params, {'learning_rate': 0.03, 'max_depth': 7, 'n_estimators': 900}),
    'fsv11': add(lgb_fixed_params, {'learning_rate': 0.035, 'max_depth': 7, 'n_estimators': 1000}),
    'fsrs': add(lgb_fixed_params, {'learning_rate': 0.325, 'max_depth': 5, 'n_estimators': 950}),
    'rffs': add(lgb_fixed_params, {'learning_rate': 0.3, 'max_depth': 6, 'n_estimators': 850}),
}
