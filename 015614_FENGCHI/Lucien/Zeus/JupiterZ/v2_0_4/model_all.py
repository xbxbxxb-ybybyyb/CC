...
from Zeus.JupiterZ.v2_0_4.backtest.sim_backtest.SimBackTest import SimBackTest

import pandas as pd
import numpy as np
from tqdm import tqdm
from joblib import Parallel, delayed
from Zeus.JupiterZ.v2_0_4.path_conf import *
from Zeus.JupiterZ.v2_0_4.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.JupiterZ.v2_0_4.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.JupiterZ.v2_0_4.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    def __init__(self, model_select='XgbRegModel'):
        self.model_name = f'{fs_version}_{label_flag}_All{model_select}'
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/JupiterZ/v2_0_4/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
...
# btl = BTLite2(strategy_name='JupiterZ',
