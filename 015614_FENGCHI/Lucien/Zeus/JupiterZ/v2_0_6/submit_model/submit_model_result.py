...
# 实际上传的model_name
model_name_list = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'fsv11_pct_AllXgbRegModel',
                   'fsv8_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel']

dept_path = '/data/user/015614/Zeus/pred/JupiterZ/v2_0_6/'
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/JupiterZ/fac_20231219/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
