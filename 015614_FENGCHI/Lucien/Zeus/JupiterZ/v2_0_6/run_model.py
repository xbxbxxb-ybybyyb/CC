...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterZ/v2_0_6/model_all.py {argv_list}')

param_list = list(product(period, fs_version, label_flag, model_select, hyper_search_mode, attend_ratio, seed))
# param_list = list(filter(lambda x: x[1] + '_' + x[3] in ['fsv8_XgbRegModel', 'fsv10_XgbRegModel', 'fsv11_XgbRegModel', 'fsrs_LgbRegModel', 'rffs_LgbRegModel'], param_list))
