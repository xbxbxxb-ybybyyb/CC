...
strategy_name = 'JupiterZ'
version = 'v2_0_7'

root_path = '/data/user/015614/Zeus/backtest/JupiterZ/v2_0_7/回测结果/'

bt_date = '20240116'
# period6_test = f'20211201~20220531_JupiterZ_period6_all_merge_test_模型评价_{bt_date}.xlsx'
# period1_test =  f'20191201~20200531_JupiterZ_period1_all_merge_test_模型评价_{bt_date}.xlsx'
# period2_test = f'20200601~20201130_JupiterZ_period2_all_merge_test_模型评价_{bt_date}.xlsx'
# period2_fit =  f'20201001~20210630_JupiterZ_period2_all_merge_fit_模型评价_{bt_date}.xlsx'
# period3_test = f'20201201~20210531_JupiterZ_period3_all_merge_test_模型评价_{bt_date}.xlsx'
# period3_fit =  f'20210401~20211231_JupiterZ_period3_all_merge_fit_模型评价_{bt_date}.xlsx'
# period4_test = f'20210601~20211130_JupiterZ_period4_all_merge_test_模型评价_{bt_date}.xlsx'
# period5_test = f'20211201~20220531_JupiterZ_period5_all_merge_test_模型评价_{bt_date}.xlsx'
# period6_test = f'20220601~20221130_JupiterZ_period6_all_merge_test_模型评价_{bt_date}.xlsx'
period7_test = f'20221201~20230531_JupiterZ_period7_all_merge_test_模型评价_{bt_date}.xlsx'
bt_res_fpath_list = [period7_test]
bt_res_name_list = ['period7_test']
...
# filtered_model_list = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'fsv11_pct_AllXgbRegModel', 'fsrs_pct_AllLgbRegModel', 'rffs_pct_AllLgbRegModel']

# period5_test = f'20211001~20220331_JupiterZ_period5_all_merge_test_模型评价_{bt_date}.xlsx'
# bt_res_fpath_list = [period5_test]
# bt_res_name_list = ['period5_test']

# period6_test = f'20220401~20220930_JupiterZ_period6_all_merge_test_模型评价_{bt_date}.xlsx'
