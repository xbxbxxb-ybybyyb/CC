...
# 实际上传的model_name
model_name_list = ['fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel',
                   'fsv8_pct_AllLgbRegModel', 'fsv10_pct_AllLgbRegModel']

dept_path = '/data/user/015614/Zeus/pred/JupiterZ/v2_0_7/'
