...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterZ/v1_0_2/lgb_reg_model.py {argv_list}')
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterZ/v1_0_2/xgb_reg_model.py {argv_list}')
