...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterZ/v1_0_5/lgb_reg_model.py {argv_list}')
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterZ/v1_0_5/xgb_reg_model.py {argv_list}')

# param_list = list(product(PERIOD, fs_version, lowcost_version, afterZ_flag))
param_list = [('period5', 'fsv10', 'lowCost', 'False'),
              ('period5', 'fsv8', 'lowCost', 'True')]
