...
pred_data_fpath_list = [
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20230331_prod/{out_begin}~{out_end}_fsv10_lowCost_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20230331_prod/{out_begin}~{out_end}_fsv8_afterZ_lowCost_LgbRegModel_{SUB_VERSION}.csv',
]
...
pred_model_fpath_list = [
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20230331_prod/fsv10_lowCost_LgbRegModel/',
    f'/data/user/015614/shared/for_wj/20230428_JupiterZ_V20230415_period5_rollTo20230331_prod/fsv8_afterZ_lowCost_LgbRegModel/',
]
...
threshold_list = [0.004036, 0.00591]
