...
fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 500, 'objective': 'reg:linear'}),
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 700, 'objective': 'reg:linear'}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 7, 'num_boost_round': 800, 'objective': 'reg:linear'}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400, 'objective': 'reg:linear'}),
    'rffs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 600, 'objective': 'reg:linear'}),
}
...
lgb_fixed_params = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'min_child_samples': 4,
                    ...
                    'num_leaves': 36, 'seed': 2022, 'reg_alpha': 2.5, 'reg_lambda': 0.5, 'subsample': 1, 'subsample_freq': 0,  'device': 'gpu',
                     'gpu_platform_id': 1, 'gpu_device_id': 0, 'gpu_use_dp': True, 'n_estimators': 800, 'max_depth': 7, 'learning_rate': 0.015}
...
fixed_lgb_reg_param = {
    ...
    'fsrs': add(lgb_fixed_params, {'learning_rate': 0.01, 'max_depth': 5, 'n_estimators': 1100}),
