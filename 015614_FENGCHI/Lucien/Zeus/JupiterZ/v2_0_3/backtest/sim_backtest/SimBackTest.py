...
import pandas as pd
import numpy as np
from Zeus.JupiterZ.v2_0_3.strat_conf import strategy_name, strategy_version
from Zeus.JupiterZ.v2_0_3.path_conf import profit_data_fpath, bt_out_path, date_config, data_all_fpath
import math
import time
import os
...
if __name__ == '__main__':
    sbt = SimBackTest(pred_fpath_list=['/data/user/015614/Zeus/pred/JupiterZ/v2_0_3/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20201201~20210531.csv'],
                      fit_fpath_list=['/data/user/015614/Zeus/pred/JupiterZ/v2_0_3/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20210501~20210531.csv'],
