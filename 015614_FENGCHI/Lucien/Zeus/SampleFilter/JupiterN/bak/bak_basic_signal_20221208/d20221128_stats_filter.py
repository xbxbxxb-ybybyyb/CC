...
#%% 统计2022年的比例
stats2022_df = pd.DataFrame(index=['样本数量', 'pct均值', 'pct中位数', 'pct标准差', 'pct胜率', '形态4比例'])
...
basic2022 = basic2022.sort_values(['trade_date', 'SW3', 'ZT_Time'])
# basic2022_group1  = basic2022.groupby(['trade_date', 'SW3']).agg('first') # 改用head进行筛选
basic2022_group1  = basic2022.groupby(['trade_date', 'SW3']).head(1)
signal2022 = signal2022.sort_values(['trade_date', 'SW3', 'ZT_Time'])
# signal2022_group1  = signal2022.groupby(['trade_date', 'SW3']).agg('first')
signal2022_group1  = signal2022.groupby(['trade_date', 'SW3']).head(1)
...
basic2022_group2 = basic2022.groupby(['trade_date', 'SW3']).head(2)
signal2022_group2  = signal2022.groupby(['trade_date', 'SW3']).head(2)
