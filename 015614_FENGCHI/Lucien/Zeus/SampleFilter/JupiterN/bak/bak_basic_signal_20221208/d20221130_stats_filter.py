...
basic2022 = basic2022.sort_values(['trade_date', 'SW2', 'ZT_Time'])
# basic2022_group1  = basic2022.groupby(['trade_date', 'SW2']).agg('first') # 改用head进行筛选
basic2022_group1  = basic2022.groupby(['trade_date', 'SW2']).head(1)    # panzong TODO：check
signal2022 = signal2022.sort_values(['trade_date', 'SW2', 'ZT_Time'])
# signal2022_group1  = signal2022.groupby(['trade_date', 'SW2']).agg('first')
signal2022_group1  = signal2022.groupby(['trade_date', 'SW2']).head(1)
...
basic2022_group2 = basic2022.groupby(['trade_date', 'SW2']).head(2)
signal2022_group2  = signal2022.groupby(['trade_date', 'SW2']).head(2)
...
for idx, time_tuple in enumerate(ZT_time_list):
    ...
    time_dist_df.loc['signal2022_group1_first10ind', period] = len(tmp_signal2022) / len(signal2022_group1_first10ind)
