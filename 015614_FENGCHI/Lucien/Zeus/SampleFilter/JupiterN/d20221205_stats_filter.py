...
basic2021_origin = basic.query('trade_date >= 20210101 & trade_date <= 20211231')
...
signal2021_origin = signal2021.query('trade_date >= 20210101 & trade_date <= 20211231')
signal2021_origin = signal2021_origin.loc[list(set(signal2021_origin.index).intersection(set(basic.index)))]
...
for idx, time_tuple in enumerate(ZT_time_list):
    period = f'H{idx + 1}'
    basic2022 = basic2021_origin.query(f'ZT_Time >= {time_tuple[0]} & ZT_Time <= {time_tuple[1]}')
    signal2022 = signal2021_origin.query(f'ZT_Time >= {time_tuple[0]} & ZT_Time <= {time_tuple[1]}')
