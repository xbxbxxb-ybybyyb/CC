...
from Zeus.Saturn.v2_17.ModelBase import ModelBase
...
class XGBRegModel(ModelBase):
    ...
    def train_model(self, X_train, y_train, param):
        ...
        model.fit(X_train.values, y_train.values.ravel(), early_stopping_rounds=early_stopping_rounds, verbose=True)
        self.model = model
