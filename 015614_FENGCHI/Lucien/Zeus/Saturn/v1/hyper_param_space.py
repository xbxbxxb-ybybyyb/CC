...
xgb_clf_param4 = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 500, 'gamma': 0.1, 'learning_rate': 0.04, 'max_depth': 3, 'min_child_weight': 3.0, 'n_estimators': 270, 'n_jobs': -1, 'objective': 'binary:logistic', 'random_state': 2022, 'reg_alpha': 0, 'reg_lambda': 0.5, 'scale_pos_weight': 3.0, 'score_threshold': 0.4996384384323199, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}
# 9.2781, 4.3799, 465.0, 43341030.5086, -4671347.0
xgb_clf_param5 = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 520, 'gamma': 0.1, 'learning_rate': 0.04, 'max_depth': 4, 'min_child_weight': 4.0, 'n_estimators': 370, 'n_jobs': -1, 'objective': 'binary:logistic', 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.5, 'scale_pos_weight': 3.0, 'score_threshold': 0.45970953626866, 'seed': 2022, 'silent': True, 'subsample': 0.6000000000000001, 'tree_method': 'gpu_hist'}
# 13.1669, 6.084, 243.0, 27275416.4836, -2071515.0
xgb_clf_param6 = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 510, 'gamma': 0.1, 'learning_rate': 0.04, 'max_depth': 4, 'min_child_weight': 5.0, 'n_estimators': 380, 'n_jobs': -1, 'objective': 'binary:logistic', 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 1, 'scale_pos_weight': 3.0, 'score_threshold': 0.5780379403398705, 'seed': 2022, 'silent': True, 'subsample': 0.5, 'tree_method': 'gpu_hist'}
# 12.0199, 6.3518, 357.0, 37101679.0936, -3086678.0
xgb_clf_param7 = {'booster': 'gbtree', 'colsample_bytree': 0.5, 'factor_num': 560.0, 'gamma': 0.1, 'learning_rate': 0.05, 'max_depth': 4, 'min_child_weight': 5.0, 'n_estimators': 530, 'n_jobs': -1, 'objective': 'binary:logistic', 'random_state': 2022, 'reg_alpha': 1, 'reg_lambda': 0.1, 'scale_pos_weight': 3.0, 'score_threshold': 0.47694838988242766, 'seed': 2022, 'silent': True, 'subsample': 0.8, 'tree_method': 'gpu_hist'}
# 14.3449, 6.224, 437.0, 40029098.3923, -2790480.0  最终版本的参数
...
hyper_xgb_clf_params = {
    ...
    'n_estimators': hp.quniform('n_estimators', 400, 750, 10),
    'n_jobs': -1,
    'objective': 'binary:logistic',
    'random_state': 2022,
    'seed': 2022,
