...
product_list = [ ('v6_0_4', 'fsrs', 's1', 'Xgb'),
                 ('v6_0_4', 'rffs', 's1', 'Xgb'),
                 ('v6_0_4', 'fsv8', 's1', 'Xgb'),
                 ('v6_0_4', 'fsv10', 's1', 'Xgb'),
                 ('v6_0_4', 'fsv11', 's1', 'Xgb')]
...
valid_path_list = [f'/data/user/015614/Zeus/pred/Saturn/{pro[0]}/config3/{pro[1]}_{pro[2]}_{pro[3]}/model/{period}/seed_0/{out_begin}~{out_end}.csv' for pro in product_list]
