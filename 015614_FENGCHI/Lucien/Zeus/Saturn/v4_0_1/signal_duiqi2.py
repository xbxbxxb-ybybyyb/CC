...
europa_period1_signal_fpath = '/data/group/800463/wangj/save_files/Europa_v3/Europa_out_testfit_v3_fac_20230317_maxbeta_final_noroll_merge6models_20230328.csv'
...
pred_data_fpath_list = [
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_1/duiqi_{out_begin}~{out_end}_fsv8_LgbRegModel_{SUB_VERSION}.csv',
]
...
for pred_data_fpath in pred_data_fpath_list:
    ...
    # ret.to_csv('/data/user/015614/Zeus/pred/Saturn/v4_0_1/' + f'dropEuropa_{out_begin}~{out_end}_{model_name}_{SUB_VERSION}.csv')
    ret.to_csv('/data/user/015614/Zeus/pred/Saturn/v4_0_1/' + f'dropEuropa_duiqi_{out_begin}~{out_end}_{model_name}_{SUB_VERSION}.csv')