...
from Zeus.Saturn.v2_10.Tool import multiprocess, get_interval_data
from Zeus.Saturn.v2_10.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v2_10.hyper_param_space import model_params
from Zeus.Saturn.v2_10.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v2_10.my_logger import MyLogger
from Zeus.Saturn.v2_10.path_conf import *
from Zeus.Saturn.v2_10.BackTest.SimpleEvalLaunch import EvalLaunch
...
hyper_remark = '打乱验证集测试集_修复score_threshold'
...
def tuning_objective(param):
    ...
    date_config = dict(train_start_date=0,
                       train_end_date=12050,
                       valid_start_date=12050,
                       valid_end_date=17504,
                       test_start_date=17504,
                       test_end_date=21651)
    ...
    y_train, y_valid, y_test, y_train_prob, y_valid_prob, y_test_prob, y_train_clf, y_valid_clf, y_test_clf = \
        get_interval_data(mf_inst.y, y_pred_prob_all, y_pred_clf_all, date_config, int(param['len_train']))
    ...
    if hyper_search_mode or multi_grid_search_mode:
        ...
        if fit_cheat_mode:
            date_config = dict(train_start_date=0,
                               train_end_date=12050,
                               valid_start_date=12050,
                               valid_end_date=21651,
                               test_start_date=21651,
                               test_end_date=25047)
