...
#%% 20220712 修改后的路径
saturn_data_path = os.path.join(wwd_path, 'project2_prod/factor_bank/all_factor_20220712/filter_v1/')
saturn_data_test_fpath = os.path.join(saturn_data_path, 'factor_df_filter_v1_931_20160101_20200630.pkl')
...
factor_score_path = os.path.join(wwd_path, 'project2_prod/factor_bank/all_factor_20220712/filter_v1/')
