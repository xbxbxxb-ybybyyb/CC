...
from Zeus.Saturn.v3_0_5.Tool import multiprocess
from Zeus.Saturn.v3_0_5.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v3_0_5.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v3_0_5.my_logger import MyLogger
from Zeus.Saturn.v3_0_5.path_conf import *
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Saturn.v3_0_5.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Saturn.v3_0_5.hyper_param_space import model_params
