...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_8/xgb_reg_model/',
              log_fname='2022-08-31 22：10：03_SaturnS1_v3_0_8_xgb_reg_model.log',
              note='用全部因子进行测试20160101-20200630')
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_8/lgb_reg_model/',
    #           log_fname='2022-09-07 22：21：28_SaturnS1_v3_0_8_lgb_reg_model.log',
