...
# period1: 'fsv8_config2', 'fsci_config2', 'fsv10_config2', 'fsv11_config2'
# period2: 'fsv8_config2', 'fsci_config2', 'fsv10_config2', 'fsv11_config2'
_model_name = {
   'fsv8_s1_Xgb': 'FSV8Xgb',
   # 'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'RffsXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Saturn/v5_0_4/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Saturns1_label2/fac_20241129/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
