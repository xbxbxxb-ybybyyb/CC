...
from Zeus.Saturn.v3_0_16.path_conf import filter_factor_fpath, factor_path
...
_xgb_imptc_factor = _xgb_imptc_factor.sort_values('feature_importance_rank_mean').set_index('factor_name')
...
score['total_score'] = score['feature_importance_rank_mean']
