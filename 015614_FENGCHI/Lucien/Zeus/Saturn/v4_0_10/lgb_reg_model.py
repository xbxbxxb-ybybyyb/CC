...
import pandas as pd
import numpy as np
from Zeus.Saturn.v4_0_10.path_conf import *
from Zeus.Saturn.v4_0_10.hyper_param_space import hyper_lgb_reg_params
...
from Zeus.Saturn.v4_0_10.my_logger import MyLogger
...
class LgbRegModel:
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        if fs_version == 'rffs':
            factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Saturn/v4_0_10/rffs_{PERIOD}.pkl')
        else:
