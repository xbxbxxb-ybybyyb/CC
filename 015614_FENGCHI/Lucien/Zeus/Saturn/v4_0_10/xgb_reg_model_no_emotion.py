...
import pandas as pd
import numpy as np
from Zeus.Saturn.v4_0_10.path_conf2 import *
from Zeus.Saturn.v4_0_10.hyper_param_space import hyper_xgb_reg_params
...
class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = f'{fs_version}_AllXgbRegModel'
