...
dept_path = f'/data/user/015614/Zeus/pred/Saturn/v6_0_2/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250711_sr2/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'v2t10_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250711_sr2/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'base_FSV8Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250711_sr2/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250711_sr2/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv10_s1_Xgb': 'p5_FSV10Xgb',}},
]

for idx in range(5): # send_dict中两个组合
