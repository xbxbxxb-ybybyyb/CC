...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Saturn/v6_0_2/scripts/model_all.py {argv_list}')
...
param_list = list(filter(lambda x: x[2] + '_' + x[1] in ['config1_fsv10', 'config2_fsv10', 'config2_fsv8', 'config3_fsv10'], param_list))
