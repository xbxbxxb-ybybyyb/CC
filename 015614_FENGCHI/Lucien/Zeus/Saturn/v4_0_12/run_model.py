...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Saturn/v4_0_12/lgb_reg_model_no_emotion.py {argv_list}')
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Saturn/v4_0_12/xgb_reg_model_no_emotion.py {argv_list}')
