...
import shutil
import os
from Zeus.Saturn.v5_0_5.config.path_conf import *
...
# period1: 'fsv8_config4', 'fsci_config2', 'fsv10_config1', 'fsv11_config2'
# period2: 'fsci_config4', 'fsv8_config2', 'fsci_config2'(fsv10), 'fsci_config3'(fsv11)
# period3: fsv10_config2, fsv11_config1, fsv8_config4, fsv10_config1(fsci)
# period3: 'fsv8_config2', 'fsci_config2', 'fsv10_config2', 'fsv11_config2'  【label对冲标签】
# period4: 'fsv8_config5', 'fsci_config5', 'fsv10_config5', 'fsv11_config5'  【label对冲标签】
# period5: 'fsv8_config2', 'fsrs_config1'(fsci), 'fsv11_config1'(fsv10), 'fsv11_config2'
# period5: 'fsrs_config5'(fsv8), 'fsci_config5', 'fsv10_config5', 'fsv11_config5'  【label对冲标签】
# period6: 'fsrs_config5'(fsci), 'fsv11_config5', 'fsv10_config5', 'fsv8_config5' 【label对冲标签】
# period6: 'fsv11_config1', 'fsrs_config1'(fsv10), 'fsv8_config1', 'fsci_config1'
# period7: 'fsrs_config5'(fsv8), 'fsv11_config5', 'fsv10_config5', 'fsci_config5' 【label对冲标签】
# period7: 'fsrs_config2'(fsv8), 'fsv11_config4', 'fsci_config4', 'fsrs_config4'(fsv10)

# 实盘版本
# period8: 'fsv8_config5', 'fsv11_config5', 'fsrs_config5'(fsv10), 'fsci_config5' 【label对冲标签】
# period8: 'fsci_config1', 'fsv8_config1', 'fsrs_config2'(fsv10), 'fsv11_config1'
_model_name = {
   # 'fsv8_s1_Xgb': 'FSV8Xgb',
   'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'RffsXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Saturn/v5_0_5/'   # label
dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Saturns1/fac_20241129/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
# dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Saturns1_label/fac_20241129/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
