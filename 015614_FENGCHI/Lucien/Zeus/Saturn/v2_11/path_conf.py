...
#%% 20220712 修改后的路径
saturn_data_path = os.path.join(fc_path, 'MyData/')
saturn_data_test_fpath = os.path.join(saturn_data_path, 'new_factor_df_filter_v4_931_20160101_20201231_20220808_v2.pkl')
saturn_data_fit_fpath = os.path.join(saturn_data_path, 'new_factor_df_filter_v4_931_20160101_20201231_20220808_v2.pkl')
