...
# filter v4版本 8 8611w | 13 5561w
xgb_reg_param = {'booster': 'gbtree', 'colsample_bytree': 1.0, 'factor_num': 180.0, 'gamma': 0.1, 'learning_rate': 0.005, 'len_test': 1200.0, 'len_train': 7500.0, 'max_depth': 3, 'min_child_weight': 6.0, 'n_estimators': 1000, 'n_jobs': -1, 'pct_threshold': 0.036085372653307114, 'random_state': 2022, 'refer_num': 500.0, 'reg_alpha': 1, 'reg_lambda': 0, 'scale_pos_weight': 3.0, 'seed': 2022, 'silent': True, 'subsample': 0.8, 'tree_method': 'gpu_hist'}
...
hyper_xgb_reg_params = {
    ...
    'len_train': hp.quniform('len_train', 6000, 8500, 500),
