...
from Zeus.Saturn.v3_0_36.DataPrepare import DataPrepare
...
class ModelBase:
    ...
    def get_dateset(self):
        ...
        # 处理数据集，这里要根据数据集进行变化
        # y = pd.read_hdf('/data/group/800463/sunss/for_xly/saturn/V6_20220927/V6_20220927_933_3period/p2_profit_933_0.20_0.10_500_1500_20160101_20211231.h5')
        y = samples[['label_v2o10d3_new']]
