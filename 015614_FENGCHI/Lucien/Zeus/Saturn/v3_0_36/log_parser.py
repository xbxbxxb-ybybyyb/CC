...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS3/v3_0_36/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_SaturnS3_v3_0_36_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS3/v3_0_36/lgb_reg_model/',
              log_fname='2022-10-28 12：13：01_SaturnS3_v3_0_36_lgb_reg_model.log',
              note='这个才是全样本_误删原来log重跑')