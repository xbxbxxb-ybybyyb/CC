...
filtered_samples_pred_test_period1_fpath = f'/data/user/015614/Zeus/pred/Saturn/v4_0_7/fsv8_XgbRegModel/{out_begin}~{out_end}_fsv8_XgbRegModel_{SUB_VERSION}.csv'
filtered_samples_pred_fit_period1_fpath = f'/data/user/015614/Zeus/pred/Saturn/v4_0_7/fsv8_XgbRegModel/{out_begin}~{out_end}_fsv8_XgbRegModel_{SUB_VERSION}.csv'
...
for pred_data_fpath in pred_data_fpath_list:
    ...
    ret.to_csv('/data/user/015614/Zeus/pred/Saturn/v4_0_7/' + f'duiqi_{out_begin}~{out_end}_{model_name}_{SUB_VERSION}.csv')
