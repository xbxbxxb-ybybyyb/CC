...
from Zeus.Saturn.v3_0_39.path_conf import factor_score_fpath, filter_factor_fpath, factor_path
...
drop_factor_list = ['saturn_30s1_sss_tk1mcs_ret931_skew',
                    'saturn_30s1_sss_tk1mcs_ret931_kurt',
                    'saturn_t93030_sss_tk1mcs_ret931_cv',
                    'saturn_t93030_sss_tk1mcs_ret931_kurt',
                    'saturn_t931_sss_tk1mcs_ret931_kurt',
                    'saturn_t931_sss_tk1mcs_ret931_mean',
                    'saturn_t931_sss_tk1mcs_ret931_skew']   # 配合stats_emotion_factor_evaluate_test3.py的筛选
