...
from Zeus.Saturn.v3_0_20.path_conf import filter_factor_fpath, factor_path
...
filtered_factor_list = xgb_imptc_factor.iloc[:261].index.tolist()

filtered_factor_list += emotion_factor_list
