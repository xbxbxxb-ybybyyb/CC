...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/saturn/20230626/')
# filtered_data_test_fpath_with_label = os.path.join(data_path, 'factor_df_filter_931_20160101_20211231_graded.pkl')
data_test_fpath_with_label = os.path.join(data_path, 'factor_df_931_20160101_20220930_graded.pkl')

profit_data_fpath = '/data/group/800463/sunss/saturn/data/p2_profit_931_0.20_0.10_500_1500.h5'

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/S1/fac_20230626/')
xgb_imptc_fsv8_period6_fpath = os.path.join(xgb_imptc_path, 'S1_xgb_importance_20220331_reg15_second_fac_20230626_FSV8_all_label_v2o10d1_graded_total.xlsx')
xgb_imptc_fsv10_period6_fpath = os.path.join(xgb_imptc_path, 'S1_xgb_importance_20220331_reg15_second_fac_20230626_FSV10_all_label_v2o10d1_graded_total.xlsx')
xgb_imptc_fsv11_period6_fpath = os.path.join(xgb_imptc_path, 'S1_xgb_importance_20220331_first_fac_20230626_FSV11_label_v2o10d1_graded_total.xlsx')

fsrs_imptc_path = os.path.join(group_path, 'sunss/saturn/20230626/fsrs/')
fsrs_imptc_period6_fpath = os.path.join(fsrs_imptc_path, 'fsrsv2_label_v2o10d1_graded_20160101_20220331.xlsx')

#%% 因子打分文件
factor_score_path = os.path.join(group_path, 'sunss/saturn/20230626/')
