...
verbose = False
search_time = 0
pred_fname = f'20190102~20200630_{hump_model_name}_v2.csv'    # 保存在对应的版本路径下
...
def tuning_objective(param):
    ...
    # TODO: 是否对齐
    # v6_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/lgb_reg_model/v3_0_11/20190102~20200630_lgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=v6_samples.index)

    v6_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/lgb_reg_model/v3_0_12/20190102~20200630_lgbRegModel_v1.csv', index_col=0)
    valid_test_pred_df = valid_test_pred_df.reindex(index=v6_samples.index)
