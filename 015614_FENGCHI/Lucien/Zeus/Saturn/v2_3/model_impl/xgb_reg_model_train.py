...
from Zeus.Saturn.v2_3.Tool import multiprocess, get_interval_data
from Zeus.Saturn.v2_3.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v2_3.hyper_param_space import model_params
from Zeus.Saturn.v2_3.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v2_3.my_logger import MyLogger
from Zeus.Saturn.v2_3.path_conf import *
from Zeus.Saturn.v2_3.BackTest.EvalLaunch import EvalLaunch
...
pred_type = 'test'   # 这个参数只在not_search_but_backtest为True时起作用，可选test/fit
...
hyper_remark = '新数据集下增多参数后MSE寻优V2'
