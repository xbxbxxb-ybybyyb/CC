...
class modelEval_Tool:
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy in ['SaturnS1', 'SaturnS0','Saturn']:
        ...
        return label_data# -*- coding: utf-8 -*-
"""
Created on Mon Feb  8 10:44:34 2021
931_Saturn_model evaluation
@author: 013550
...
class modelEval_Tool:
    ...
    def generate_series_data(self):
        ...
        if self.strategy in ['SaturnS1', 'SaturnS0','Saturn']: # ,'CeresS1'
        ...
        return totalResDf, daily_data,statistic_by_sample,daily_data_valid,model_mingan,model_inmingan,group_proba_all
    def generate_test_report(self,pred_out, pred_in,scene_flag,probacol):
        ...
        writer.save()
        return totalResDf, daily_data,statistic_by_sample_all.set_index(['datelist','stockID']),statistic_by_day_valid,model_mingan,model_valid_mingan,group_proba_all
    ...
    def cal_sortino(self,day_data,pct_col='收益率(扣除成本)',stepdate=3):
        ...
        return sortino
    def generate_date_group(self,start_date, end_date, stepdate):
        date_index = [int(i) for i in hfactor.tradingday(str(start_date), str(end_date))]
        mid_date = []
