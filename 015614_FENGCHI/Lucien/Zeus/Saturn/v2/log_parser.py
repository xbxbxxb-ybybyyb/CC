...
def log_parse(log_fpath=None,
    ...
    FileUtil.save_df2xls(multi, save_path, 'hyper解析后参数表格_xgb_reg_modelV2_20号早上.xlsx')

if __name__ == '__main__':
    # log_parse('/data/user/015614/Zeus/logs/SaturnS1/v2/xgb_clf_model/' + '2022-07-18 20：01：25_SaturnS1_v2_xgb_clf_model.log')
    log_parse('/data/user/015614/Zeus/logs/SaturnS1/v2/xgb_reg_model/' + '2022-07-19 19：36：50_SaturnS1_v2_xgb_reg_model.log')