...
dept_path = f'/data/user/015614/Zeus/pred/Saturn/v6_0_5/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250724_sr/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv11_s1_Xgb': 'v2t10_FSV11Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250724_sr/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'base_FSV8Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250724_sr/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsrs_s1_Xgb': 'base_FSRSXgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Saturn/fac_20250724_sr/区间{PERIOD[-1]}/',
