...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Saturn/v4_0_5/xgb_reg_model.py {argv_list}')
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Saturn/v4_0_5/xgb_reg_model_all.py {argv_list}')
