...
import pandas as pd
import numpy as np
from Zeus.Saturn.v4_0_11.path_conf import *
from Zeus.Saturn.v4_0_11.hyper_param_space import hyper_lgb_reg_params
...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = f'{fs_version}{abs_flag}_LgbRegModel'
