...
data_test_fpath_with_label = os.path.join('/data/user/015614/shared/for_fc/', 'factor_df_931_20160101_20230625_graded.pkl') # 20230713实盘上线模型的滚动训练
...
date_config = {
    ...
    # 'period5': dict(train_start_date=20160101, train_end_date=20220630, valid_start_date=20220701, valid_end_date=20221231,
    #                 test_start_date=20221201, test_end_date=20221231, fit_start_date=20221201, fit_end_date=20221231),
    # 20230713实盘上线模型的滚动训练
    'period5': dict(train_start_date=20160101, train_end_date=20220630, valid_start_date=20220701, valid_end_date=20230625,
                    test_start_date=20230101, test_end_date=20230523, fit_start_date=20230501, fit_end_date=20230523),
}