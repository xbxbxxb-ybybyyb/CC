...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_1/xgb_reg_model/',
              log_fname='2022-08-22 22：00：50_SaturnS1_v3_0_1_xgb_reg_model.log',
              note='hyper树数量定位1k不早停')