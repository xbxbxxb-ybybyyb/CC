...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_14/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_SaturnS1_v3_0_14_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_14/lgb_reg_model/',
              log_fname='2022-09-20 20：03：18_SaturnS1_v3_0_14_lgb_reg_model.log',
              note='用全部因子进行测试20170101-20200630_因子筛选方式2')