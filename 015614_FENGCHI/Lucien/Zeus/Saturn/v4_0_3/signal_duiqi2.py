...
pred_data_fpath_list = [
    ...
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_3/duiqi_{out_begin}~{out_end}_fsv8_AllXgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_3/duiqi_{out_begin}~{out_end}_fsv10_AllXgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_3/duiqi_{out_begin}~{out_end}_fsv11_AllXgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_3/duiqi_{out_begin}~{out_end}_rffs_AllXgbRegModel_{SUB_VERSION}.csv',
]
...
for pred_data_fpath in pred_data_fpath_list:
    ...
    # ret.to_csv('/data/user/015614/Zeus/pred/Saturn/v4_0_3/' + f'dropEuropa_{out_begin}~{out_end}_{model_name}_{SUB_VERSION}.csv')
    ret.to_csv('/data/user/015614/Zeus/pred/Saturn/v4_0_3/' + f'dropEuropa_duiqi_{out_begin}~{out_end}_{model_name}_{SUB_VERSION}.csv')
