...
from Zeus.Saturn.v4_0_3.hyper_param_space import hyper_xgb_reg_params
...
class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = f'{fs_version}_XgbRegModel'
        ...
        self.get_dataset(filtered_data_test_fpath_with_label)
