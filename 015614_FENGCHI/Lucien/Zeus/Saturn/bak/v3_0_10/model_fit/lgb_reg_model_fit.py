...
from Zeus.Saturn.v3_0_10.Tool import multiprocess
from Zeus.Saturn.v3_0_10.hyper_param_space import hyper_lgb_reg_params, multi_lgb_reg_params
from Zeus.Saturn.v3_0_10.models.lgb_reg_model import LGBRegModel
from Zeus.Saturn.v3_0_10.my_logger import MyLogger
from Zeus.Saturn.v3_0_10.path_conf import *
...
fit_fname = f'20190102~20201231_{hump_model_name}_v2.csv'
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Saturn.v3_0_10.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Saturn.v3_0_10.hyper_param_space import model_params
