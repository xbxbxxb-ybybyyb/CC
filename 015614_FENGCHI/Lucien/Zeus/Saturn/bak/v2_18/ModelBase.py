...
class ModelBase:
    ...
    def get_score_threshold(y_train, y_train_prob_pred, threshold=0.06, refer_num=1000):
        ...
        pred_threshold = np.percentile(y_train_prob_pred[-refer_num:], (1 - _threshold) * 100)    # v3 v2 v1都用的这个
        # pred_threshold = np.percentile(y_train_prob_pred, (1 - _threshold) * 100)  # v4测试改成这个
