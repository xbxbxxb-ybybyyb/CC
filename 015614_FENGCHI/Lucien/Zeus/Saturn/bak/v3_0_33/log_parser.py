...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_33/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_SaturnS1_v3_0_33_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_33/lgb_reg_model/',
              log_fname='2022-10-12 13：26：19_SaturnS1_v3_0_33_lgb_reg_model.log',
              note='这个才是全样本')