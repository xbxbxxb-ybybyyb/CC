...
#%% 20220729 filter v3 修改后的路径
saturn_data_path = os.path.join(group_path, 'sunss/for_xly/saturn/filter_v3/')
saturn_data_test_fpath = os.path.join(saturn_data_path, 'factor_df_filter_v3_down_931_20160101_20201231_remake.pkl')
saturn_data_fit_fpath = os.path.join(saturn_data_path, 'factor_df_filter_v3_down_931_20160101_20201231_remake.pkl')

filter_factor_path = os.path.join(group_path, 'xiely/factor_select/Saturn_v6/')
filter_factor_fpath = os.path.join(filter_factor_path, 'xgb_importance_20190102_allreg4_pct_v6.1_filter_v3_down.xlsx')

factor_score_path = os.path.join(group_path, 'sunss/for_xly/saturn/filter_v3/')
factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_filter_v3_down_931.xlsx')
