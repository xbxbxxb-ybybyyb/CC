...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_22/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_SaturnS1_v3_0_22_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_22/lgb_reg_model/',
              log_fname='2022-09-25 15：51：10_SaturnS1_v3_0_22_lgb_reg_model.log',
