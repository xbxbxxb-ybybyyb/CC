...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v2_16/xgb_reg_model/',
              log_fname='2022-08-22 13：13：07_SaturnS1_v2_16_xgb_reg_model.log',
              note='添加93030因子v3去掉refer_num')