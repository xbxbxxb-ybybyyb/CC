...
from Zeus.Saturn.v2_16.Tool import multiprocess, get_interval_data
from Zeus.Saturn.v2_16.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v2_16.hyper_param_space import model_params
from Zeus.Saturn.v2_16.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v2_16.my_logger import MyLogger
from Zeus.Saturn.v2_16.path_conf import *
from model_eval.bak.bak20230105_simple_bt.SimpleEvalLaunch import EvalLaunch
...
hyper_remark = '添加93030因子v3去掉refer_num'
    ...
    if hyper_search_mode or multi_grid_search_mode:
        ...
        if fit_cheat_mode:
            ...
            mf_inst = XGBRegModel(model_name=model_name,
                                  ...
                                  label='label_v2o10d1')
            # 读取train时的因子
            factor_list = FileUtil.read_list(factor_path + f'{strategy_name}/{model_name}/{version}/', 'factor_list.pkl')
