...
xgb_reg_param = {'booster': 'gbtree', 'colsample_bytree': 0.9, 'factor_num': 170.0, 'gamma': 0.1, 'learning_rate': 0.005, 'len_test': 600.0, 'len_train': 7500.0, 'max_depth': 4, 'min_child_weight': 5.0, 'n_estimators': 1000, 'n_jobs': -1, 'pct_threshold': 0.049697810925106854, 'random_state': 2022, 'refer_num': 900.0, 'reg_alpha': 0, 'reg_lambda': 1, 'scale_pos_weight': 3.0, 'seed': 2022, 'silent': True, 'subsample': 0.7000000000000001, 'tree_method': 'gpu_hist'}
