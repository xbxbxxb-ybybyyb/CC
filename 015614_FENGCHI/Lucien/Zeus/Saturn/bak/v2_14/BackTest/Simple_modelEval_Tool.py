...
class modelEval_Tool:
    ...
    def generate_series_data(self):
        ...
        totalResDf, daily_data,statistic_by_sample = self.generate_test_report(model,model_valid,scene_flag,predcol)
        ...
        return totalResDf, daily_data,statistic_by_sample
    def generate_test_report(self,pred_out, pred_in,scene_flag,probacol):
        ...
        writer.save()
        return totalResDf, daily_data,statistic_by_sample_all.set_index(['datelist','stockID'])
