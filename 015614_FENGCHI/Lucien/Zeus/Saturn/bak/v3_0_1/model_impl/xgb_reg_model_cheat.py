...
from Zeus.Saturn.v3_0_1.Tool import multiprocess
from Zeus.Saturn.v3_0_1.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v3_0_1.hyper_param_space import model_params
from Zeus.Saturn.v3_0_1.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v3_0_1.my_logger import MyLogger
from Zeus.Saturn.v3_0_1.path_conf import *
from model_eval.bak.bak20230105_simple_bt.v3_0_SimpleEvalLaunch import EvalLaunch
...
def tuning_objective(param):
    ...
    if hyper_search_mode or multi_grid_search_mode:
        ...
        test_indicator = round(model_mingan['test_indicator'].max(), 4) if model_mingan.shape[0] > 0 else 0
        ...
        if fit_cheat_mode:
            ...
            model_mingan = model_mingan.sort_values('收益风险比', ascending=False)
            model_mingan['fit_indicator'] = model_mingan['收益风险比'] * model_mingan['累计盈利']
            ...
            _fit_indicator = round(model_mingan['fit_indicator'].max(), 4) if model_mingan.shape[0] > 0 else 0
