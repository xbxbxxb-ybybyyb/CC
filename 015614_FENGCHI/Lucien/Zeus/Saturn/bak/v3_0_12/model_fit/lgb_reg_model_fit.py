...
from Zeus.Saturn.v3_0_12.Tool import multiprocess
from Zeus.Saturn.v3_0_12.hyper_param_space import hyper_lgb_reg_params, multi_lgb_reg_params
from Zeus.Saturn.v3_0_12.models.lgb_reg_model import LGBRegModel
from Zeus.Saturn.v3_0_12.my_logger import MyLogger
from Zeus.Saturn.v3_0_12.path_conf import *
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Saturn.v3_0_12.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Saturn.v3_0_12.hyper_param_space import model_params
