...
from Zeus.Saturn.v3_0_40.path_conf import factor_score_fpath, filter_factor_fpath, factor_path
...
drop_factor_list = ['saturn_t931_sss_tk1mcs_ret931_kurt',
                     'saturn_sss_pct5_mean',
                     ...
                     'saturn_t931_sss_tk1mcs_ret931_mean']   # 配合stats_emotion_factor_evaluate_test4.py的筛选
