...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_16/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_SaturnS1_v3_0_16_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v3_0_16/lgb_reg_model/',
              log_fname='2022-09-21 17：24：42_SaturnS1_v3_0_16_lgb_reg_model.log',
              note='用全部因子进行测试20170101-20200630_因子筛选方式4')