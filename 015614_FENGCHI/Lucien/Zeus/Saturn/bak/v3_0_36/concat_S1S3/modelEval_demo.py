...
hfactor = FactorData()
import pandas as pd
from Zeus.Saturn.v3_0_36.concat_S1S3.modelEval_Tool import *
...
if __name__ == "__main__":
    ...
    # in_begin, in_end = 20191008, 20200630
    out_begin, out_end = 20200701, 20201231
    in_begin, in_end = 20200701, 20201231
    strategy_namelist = ['SaturnS1&SaturnS3'] # 'SaturnS1
    sel_flag = 'all' # 可选SZ,SH,all
    strategy_version = 'fac_20220927_FSV9_all_933_v2o10d3_new'
    ...
    valid_path_list = [
        # '/data/user/015614/junkData/new_test_pred.csv',
        '/data/user/015614/junkData/new_fit_pred.csv',
    ]
    pred_path_list = [
        # '/data/user/015614/junkData/new_test_pred.csv',
        '/data/user/015614/junkData/new_fit_pred.csv',
