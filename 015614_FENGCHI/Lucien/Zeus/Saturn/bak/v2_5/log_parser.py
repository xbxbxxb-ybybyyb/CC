...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v2_5/xgb_reg_model/',
              log_fname='2022-08-08 17：35：41_SaturnS1_v2_5_xgb_reg_model.log',
              note='修复refer_num bug')