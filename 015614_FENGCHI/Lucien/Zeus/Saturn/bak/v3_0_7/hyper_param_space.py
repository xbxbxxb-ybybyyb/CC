...
xgb_reg_param_fit_v0 = {'booster': 'gbtree', 'colsample_bytree': 0.9, 'factor_num': 150.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_weight': 4.0, 'n_estimators': 1000, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.5, 'scale_pos_weight': 1.0, 'score_threshold': 0.009422, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}
...
lgb_reg_param = {}
lgb_reg_param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 270.0, 'gpu_device_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 35.0, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.1, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0, 'score_threshold': 0.008142}
...
hyper_xgb_reg_params = {
    ...
    'factor_num': hp.quniform('factor_num', 260, 280, 10),
