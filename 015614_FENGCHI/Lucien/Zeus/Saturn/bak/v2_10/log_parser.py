...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v2_10/xgb_reg_model/',
              log_fname='2022-08-09 11：14：36_SaturnS1_v2_10_xgb_reg_model.log',
              note='打乱验证集测试集_修复score_threshold')