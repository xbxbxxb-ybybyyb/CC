...
filter_factor_fpath = os.path.join(filter_factor_path, 'xgb_importance_20190102_allcla4_label_mixed_v6.1_filter_v2.xlsx')
...
profit_path = os.path.join(wwd_path, 'project2_prod/factor_bank/all_factor_20220712/filter_v2/')
profit_fpath = os.path.join(profit_path, 'Label_zt_20160101_20211231.h5')
