...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/SaturnS1/v2_2/xgb_reg_model/',
              log_fname='2022-08-08 21：34：09_SaturnS1_v2_2_xgb_reg_model.log',
              note='修复refer_num bug后进行测试')