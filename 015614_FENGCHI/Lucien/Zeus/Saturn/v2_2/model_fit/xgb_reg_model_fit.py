...
def tuning_objective(param):
    ...
    # 和filter_v3版本样本对齐
    # v6_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/xgb_reg_model/v2_6/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=v6_samples.index)

    # 和filter_v3_down版本样本对齐
    # v6_samples = pd.read_csv(fc_path + 'Zeus/pred/Saturn_down/xgb_reg_model/v2_7/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=v6_samples.index)

    # 和filter_v4版本样本对齐
    # v6_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/xgb_reg_model/v2_9/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=v6_samples.index)

    # 和935时点样本对齐
    # s5_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS5/xgb_reg_model/v2_14/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=s5_samples.index)
    # 和935时点样本对齐2
    # s5_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS5/xgb_reg_model/v2_15/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
    # valid_test_pred_df = valid_test_pred_df.reindex(index=s5_samples.index)

    # 和加入93030因子后的样本对齐
    # v6_1_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/xgb_reg_model/v2_16/20190102~20201231_xgbRegModel_v1.csv', index_col=0)
