...
dept_path = f'/data/user/015614/Zeus/pred/Saturn/v6_0_3/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Saturn/fac_20250721_t/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsrs_s1_Xgb': 'v2t10_FSRSXgb',}},
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Saturn/fac_20250721_t/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'base_FSV8Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Saturn/fac_20250721_t/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv11_s1_Xgb': 'p5_FSV11Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Saturn/fac_20250721_t/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv11_s1_Xgb': 'p2_FSV10Xgb',}},
]
