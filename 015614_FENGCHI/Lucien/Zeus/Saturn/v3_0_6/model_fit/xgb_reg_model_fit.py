...
from Zeus.Saturn.v3_0_6.Tool import multiprocess
from Zeus.Saturn.v3_0_6.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Saturn.v3_0_6.models.xgb_reg_model import XGBRegModel
from Zeus.Saturn.v3_0_6.my_logger import MyLogger
from Zeus.Saturn.v3_0_6.path_conf import *
...
def tuning_objective(param):
    ...
    # )
    date_config = dict(train_start_date=20180101,
                       train_end_date=20200630,
                       valid_start_date=20200201,
                       valid_end_date=20200630,
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Saturn.v3_0_6.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Saturn.v3_0_6.hyper_param_space import model_params
