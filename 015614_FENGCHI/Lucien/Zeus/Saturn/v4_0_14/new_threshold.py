...
pred_data_fpath_list = [
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv8_XgbRegModel/{out_begin}~{out_end}_fsv8_XgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv10_XgbRegModel/{out_begin}~{out_end}_fsv10_XgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv11_XgbRegModel/{out_begin}~{out_end}_fsv11_XgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/rffs_XgbRegModel/{out_begin}~{out_end}_rffs_XgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsrs_XgbRegModel/{out_begin}~{out_end}_fsrs_XgbRegModel_{SUB_VERSION}.csv',

    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv8_LgbRegModel/{out_begin}~{out_end}_fsv8_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv10_LgbRegModel/{out_begin}~{out_end}_fsv10_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsv11_LgbRegModel/{out_begin}~{out_end}_fsv11_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/rffs_LgbRegModel/{out_begin}~{out_end}_rffs_LgbRegModel_{SUB_VERSION}.csv',
    f'/data/user/015614/Zeus/pred/Saturn/v4_0_14/fsrs_LgbRegModel/{out_begin}~{out_end}_fsrs_LgbRegModel_{SUB_VERSION}.csv',
]
