...
from Zeus.Saturn.v3_0_30.path_conf import factor_score_fpath, filter_factor_fpath, factor_path
...
added_emotion_factor = added_emotion_factor[added_emotion_factor['区间1-out-value'] < 4]
added_emotion_factor_list_less_4 = added_emotion_factor['factor_name'].tolist()
filtered_factor_list = _xgb_imptc_factor['factor_name'].tolist()
filtered_factor_list = list(set(filtered_factor_list).difference(set(added_emotion_factor_list_less_4)))
