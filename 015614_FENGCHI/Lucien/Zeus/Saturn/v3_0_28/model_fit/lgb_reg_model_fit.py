...
from Zeus.Saturn.v3_0_28.Tool import multiprocess
from Zeus.Saturn.v3_0_28.hyper_param_space import hyper_lgb_reg_params, multi_lgb_reg_params
from Zeus.Saturn.v3_0_28.models.lgb_reg_model import LGBRegModel
from Zeus.Saturn.v3_0_28.my_logger import MyLogger
from Zeus.Saturn.v3_0_28.path_conf import *
...
fit_fname = f'20190102~20201231_{hump_model_name}_v3.csv'   # v3 用来与filter v6.2对比
...
def tuning_objective(param):
    ...
    # 和v6版本样本对齐， TODO: 是否对齐
    v6_samples = pd.read_csv(fc_path + 'Zeus/pred/SaturnS1/lgb_reg_model/v3_0_37/20190102~20201231_lgbRegModel_v1.csv', index_col=0)
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Saturn.v3_0_28.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Saturn.v3_0_28.hyper_param_space import model_params
