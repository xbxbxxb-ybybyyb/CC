...
#%% V6.3数据集上新的因子筛选结果
saturn_data_path = os.path.join(group_path, 'sunss/for_xly/saturn/V6_20220923/V6_20220923_3period/')
...
filter_factor_fpath = os.path.join(filter_factor_path, 'xgb_importance_20190102_reg15_second_fac_20220923_FSV9_filterV1_pct_graded_3period.xlsx')

factor_score_path = os.path.join(group_path, 'sunss/for_xly/saturn/V6_20220923/V6_20220923_3period/')
