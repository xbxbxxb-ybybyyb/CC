...
from Zeus.Sr.v1_0_1.scripts.hyper_param_space import xgb_fixed_params, lgb_fixed_params
...
if __name__ == '__main__':
    ...
    hyper_root_path = f'/data/user/015614/Zeus/pred/Sr/{STRATEGY_VERSION}/'
