...
data_test_fpath_with_label = os.path.join(data_path, 'factor_df_931_20160101_20220630.pkl')
data_fit_fpath_with_label = os.path.join(data_path, 'factor_df_931_20160101_20220630.pkl')

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/project_sell/fac_20230330_new/')
xgb_imptc_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_new_FSV8_all_label_diff_pct_graded.xlsx')
...
xgb_imptc_fsv10_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_new_FSV10_all_label_diff_pct_graded.xlsx')
...
xgb_imptc_fsv11_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_first_fac_20230330_new_FSV11_label_diff_pct_graded.xlsx')
