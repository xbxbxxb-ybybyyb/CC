...
from Zeus.ProjectSell.v1_1_1.hyper_param_space import hyper_lgb_reg_params
...
from Zeus.ProjectSell.v1_1_1.my_logger import MyLogger
...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        ...
        self.model = None
        self.scaler = None
        if 'pct' in label_flag:
            self.label = 'label_diff_pct_v1'
        else:
            self.label = 'label_twap'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        if fs_version == 'rffs':
            factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/ProjectSell/v1_1_1/rffs_{PERIOD}.pkl')
...
# btl = BTLite2(strategy_name='ProjectSellS1',
