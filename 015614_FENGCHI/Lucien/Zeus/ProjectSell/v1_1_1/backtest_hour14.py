...
PERIOD = 'period1'
pred_type = 'test'
# pred_fpath = '/data/user/015614/Zeus/pred/ProjectSell/v1_1_1/rffs_XgbRegModel/hyper/1/20191001~20200331_rffs_XgbRegModel_v1.csv'

PERIOD_list = ['period1', 'period1', 'period2', 'period2', 'period3', 'period3']
pred_type_list = ['test', 'fit', 'test', 'fit', 'test', 'fit']

model_list = [
    'fsv8_twap_XgbRegModel', 'fsv10_twap_XgbRegModel', 'fsv11_twap_XgbRegModel', 'fsrs_twap_XgbRegModel',
    'fsv8_twap_LgbRegModel', 'fsv10_twap_LgbRegModel', 'fsv11_twap_LgbRegModel', 'fsrs_twap_LgbRegModel',
...
for model in model_list:
    ...
    for idx, period in enumerate(PERIOD_list):
        ...
        pred_fpath = f'/data/user/015614/Zeus/pred/ProjectSell/v1_1_1/{model}/{start_date}~{end_date}_{model}_v{period[-1]}.csv'
        ...
        signal_df['prediction'] = signal_df['prediction'] * buy_signal_df.loc[signal_df.index, 'prediction'].fillna(0)
    ...
    FileUtil.save_dict2xls(res_dict, junk_path, f'{model}_addBuy.xlsx')
