...
import pandas as pd
import numpy as np
from Zeus.ProjectSell.v1_0_2.path_conf import *
from Zeus.ProjectSell.v1_0_2.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.ProjectSell.v1_0_2.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
class LgbRegModel:
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/ProjectSell/v1_0_2/rf_fs_list_next_{PERIOD}.pkl')
