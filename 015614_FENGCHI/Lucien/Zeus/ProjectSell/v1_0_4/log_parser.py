...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_4/LgbRegModelV3/',
              log_fname='ProjectSell_v1_0_4_LgbRegModelV3_v5.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_4/LgbRegModelV2/',
              log_fname='ProjectSell_v1_0_4_LgbRegModelV2_v5.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_4/XgbRegModelV3/',
              log_fname='ProjectSell_v1_0_4_XgbRegModelV3_v5.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_4/XgbRegModelV2/',
              log_fname='ProjectSell_v1_0_4_XgbRegModelV2_v5.log',
              note='')
