...
if PERIOD[-1] is '1':
    ...
    best_threshold = 0.00175
elif PERIOD[-1] is '5':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 2.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2000.0, 'n_jobs': -1, 'num_leaves': 20.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.4, 'subsample': 0.5, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0.002553
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV3'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/ProjectSell/v1_0_4/rf_fs_list_next_{PERIOD}.pkl')
