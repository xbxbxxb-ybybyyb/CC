...
class FactorSelect:
    def __init__(self, start_date, end_date):
        ...
        self.label = 'label_diff_pct_next' # label_diff_pct_next
        # self.label = 'label_diff_pct' # label_diff_pct_next
...
if __name__ == '__main__':
    ...
    def launch_1period(period):
        ...
        # 中间结果
        # FileUtil.save_df2pkl(factor_imptc_df, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'tmp_rf_cv_score_next_{period}.pkl')
        ...
        # FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rf_fs_list_next_{period}.pkl')
