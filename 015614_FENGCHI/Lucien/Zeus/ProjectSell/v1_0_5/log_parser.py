...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_5/LgbRffsNextRegModel/',
              log_fname='ProjectSell_v1_0_5_LgbRffsNextRegModel_v4.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_5/XgbRffsNextRegModel/',
              log_fname='ProjectSell_v1_0_5_XgbRffsNextRegModel_v4.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_5/LgbFSV8NextRegModel/',
              log_fname='ProjectSell_v1_0_5_LgbFSV8NextRegModel_v4.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/ProjectSell/v1_0_5/XgbFSV8NextRegModel/',
              log_fname='ProjectSell_v1_0_5_XgbFSV8NextRegModel_v4.log',
              note='')