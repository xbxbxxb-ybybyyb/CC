...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/project_sell/20230330_new/')
...
data_test_fpath_with_label = os.path.join(data_path, 'factor_df_931_20160101_20211231.pkl')
data_fit_fpath_with_label = os.path.join(data_path, 'factor_df_931_20160101_20211231.pkl')

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/project_sell/fac_20230330_new/')
xgb_imptc_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_reg15_second_fac_20230330_new_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_next_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_reg15_second_fac_20230330_new_FSV8_all_label_diff_pct_next_graded.xlsx')
xgb_imptc_fsv10_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_reg15_second_fac_20230330_new_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_fsv10_next_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_reg15_second_fac_20230330_new_FSV10_all_label_diff_pct_next_graded.xlsx')
xgb_imptc_fsv11_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_first_fac_20230330_new_FSV11_label_diff_pct_graded.xlsx')
xgb_imptc_fsv11_next_period4_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20210630_first_fac_20230330_new_FSV11_label_TN_931o2ul_graded.xlsx')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, 'sunss/project_sell/20230330_new/')
factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_931_20160101_20210630.xlsx')
