...
from Zeus.ProjectSell.v1_0_3.hyper_param_space import hyper_lgb_reg_params
...
if PERIOD[-1] is '1':
    ...
    best_threshold = 0.000631
elif PERIOD[-1] is '5':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 9.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2900.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.5, 'subsample': 0.8, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0.0022
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV2'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/ProjectSell/v1_0_3/rf_fs_list_{PERIOD}.pkl')
...
if hyper_search_mode:
    ...
    inst.model.save_model(junk_path + 'period4_LgbRegModel.pkl')
