...
xgb_imptc_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_next_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_fsv10_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_fsv10_next_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_reg15_second_fac_20230330_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_fsv11_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_first_fac_20230330_FSV11_label_diff_pct_graded.xlsx')
xgb_imptc_fsv11_next_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_sell_20211231_first_fac_20230330_FSV11_label_TN_931o2ul_graded.xlsx')

fsrsv2_imptc_path = os.path.join(group_path, 'sunss/project_sell/20230330/fsrs/')
fsrsv2_imptc_period5_fpath = os.path.join(fsrsv2_imptc_path, 'fsrsv2_label_diff_pct_next_graded_20160101_20211231.xlsx')
fsrsv2_imptc_o2ul_period5_fpath = os.path.join(fsrsv2_imptc_path, 'fsrsv2_label_diff_graded_20160101_20211231.xlsx')
