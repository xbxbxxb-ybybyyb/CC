...
if PERIOD[-1] is '1':
    ...
    best_threshold = -0.000331
elif PERIOD[-1] is '5':
    param = {'alpha': 0.2, 'booster': 'gbtree', 'colsample_bytree': 0.5, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.4, 'max_depth': 9.0, 'min_child_weight': 3.0, 'n_jobs': -1, 'num_boost_round': 3700.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.6, 'tree_method': 'gpu_hist'}
    best_threshold = 0.002012
hyper_params = hyper_xgb_reg_params

class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'XgbRegModelV2'
