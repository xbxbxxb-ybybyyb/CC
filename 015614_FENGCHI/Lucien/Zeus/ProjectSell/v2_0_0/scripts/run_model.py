...
config_flag = [f'config{x}' for x in range(1, 2)]
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/ProjectSell/v2_0_0/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config1', 'fsrs_config1', 'rffs_config1', 'rffs_config2', 'rffs_config3', 'fsv11_config3'], param_list))
