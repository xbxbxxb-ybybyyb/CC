...
from Zeus.ProjectSell.v2_0_0.scripts.hyper_param_space import xgb_fixed_params, lgb_fixed_params
...
if __name__ == '__main__':
    ...
    hyper_root_path = f'/data/user/015614/Zeus/pred/ProjectSell/{STRATEGY_VERSION}/'
