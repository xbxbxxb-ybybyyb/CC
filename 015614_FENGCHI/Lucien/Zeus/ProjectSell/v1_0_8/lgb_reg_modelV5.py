...
import pandas as pd
import numpy as np
from Zeus.ProjectSell.v1_0_8.path_conf import *
from Zeus.ProjectSell.v1_0_8.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.ProjectSell.v1_0_8.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
if PERIOD[-1] is '1':
    ...
    best_threshold = -0.000419
elif PERIOD[-1] is '5':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 2.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1000.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.8, 'subsample': 1.0, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.000205
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbFSV10NextRegModel'
    ...
    def get_dataset(self, path):
        ...
        y = pd.read_hdf('/data/group/800463/sunss/project_sell/newData/Sell_pct_new_0.10_800_190_SH300_SZ30.h5')
        y = y[[self.label]]
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        # factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/ProjectSell/v1_0_8/rf_fs_list_next_{PERIOD}.pkl')
    ...
    def get_train_and_test_data(self):
        ...
        filtered_factor = self.filter_factor(xgb_imptc_fpath=eval(f'xgb_imptc_fsv10_next_{PERIOD}_fpath'))
