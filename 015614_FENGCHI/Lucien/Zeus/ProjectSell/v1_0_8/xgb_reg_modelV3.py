...
from Zeus.ProjectSell.v1_0_8.hyper_param_space import hyper_xgb_reg_params
...
if PERIOD[-1] is '1':
    ...
    best_threshold = 0.004748
elif PERIOD[-1] is '5':
    param = {'alpha': 0.9, 'booster': 'gbtree', 'colsample_bytree': 0.9, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.9, 'max_depth': 7.0, 'min_child_weight': 5.0, 'n_jobs': -1, 'num_boost_round': 1300.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.5, 'tree_method': 'gpu_hist'}
    best_threshold = 0.001394
hyper_params = hyper_xgb_reg_params

class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'XgbRffsNextRegModel'
