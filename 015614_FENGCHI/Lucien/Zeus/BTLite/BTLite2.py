...
from Zeus.Saturn.v4_0_1.path_conf import date_config, junk_path
import pandas as pd
import numpy as np
import math
import time
...
class BTLite2:
    ...
    def state_machine(self):
        if self.strategy_name == 'Europa':
        ...
        elif self.strategy_name == 'JupiterN':
            ...
            self.extreme_thres = 0.2
        elif self.strategy_name == 'JupiterNSell':
            ...
            self.attend_max = 41
            self.extreme_thres = 0.2
        elif self.strategy_name == 'JupiterZ':  # 卖出
            self.profit_fpath = '/data/group/800463/sunss/jupiterZ/newData/JupiterZ_Label_0.10_800_190_SH450_SZ100.pkl'
            self.label_fpath = '/data/group/800463/sunss/jupiterZ/20230414/factor_df_all_20160101_20211231.pkl'
            self.cost_pct = 0.002
            self.attend_min = 10
            self.attend_max = 41
            self.extreme_thres = 0.2
        elif self.strategy_name == 'SaturnS1':
            self.profit_fpath = '/data/group/800463/project/project2_prod/profit_backtest/p2_profit_931_0.20_0.10_500_1500.h5'
            self.label_fpath = '/data/group/800463/sunss/saturn/20230626/factor_df_931_20160101_20220930_graded.pkl'
            self.cost_pct = 0.004
            self.attend_min = 10
            self.attend_max = 51
            self.extreme_thres = 0.2
        elif self.strategy_name == 'SaturnS0':
            self.profit_fpath = '/data/group/800463/sunss/saturn/data/p2_profit_930_2tick_0.20_0.10_500_1500.h5'
            self.label_fpath = '/data/group/800463/sunss/saturn/20230524/factor_df_930_2tick_20160101_20211231_graded.pkl'
            self.cost_pct = 0.004
            self.attend_min = 10
            self.attend_max = 51
            self.extreme_thres = 0.2
        ...
        if 'label_pct_cost' not in profit_df.columns:
            ...
            if self.strategy_name == 'JupiterZ':
    ...
    def data_prepare(self):
        ...
        fit_df = pd.read_csv(self.fit_fpath, index_col=0).query(f'datelist >= {self.date_dict["fit_start_date"]} & datelist <= {self.date_dict["fit_end_date"]}')

        self.test_df = self._concat_label_profit(test_df)
        self.fit_df = self._concat_label_profit(fit_df)
...
if __name__ == '__main__':
    t1 = time.time()
    # btl = BTLite(test_fpath='/data/user/015614/Zeus/pred/Europa/v1_0_24/LgbRegModel/20210401~20211231_LgbRegModel_v2.csv',
    #              fit_fpath='/data/user/015614/Zeus/pred/Europa/v1_0_24/LgbRegModel/20210401~20211231_LgbRegModel_v2.csv',
    #              strategy_name='Europa',
    #              model_name='SingleTestModel',
    #              date_dict=date_config['period4_test'],
    #              bt_save_path=junk_path + '回测结果/')
    btl = BTLite2(test_fpath='/data/user/015614/Zeus/pred/Europa/v1_0_29/LgbRegModel/20200401~20201231_LgbRegModel_v2.csv',
                  fit_fpath='/data/user/015614/Zeus/pred/Europa/v1_0_29/LgbRegModel/20200401~20201231_LgbRegModel_v2.csv',
                  strategy_name='Europa',
                  model_name='SingleTestModel',
