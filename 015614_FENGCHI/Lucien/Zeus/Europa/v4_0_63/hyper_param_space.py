...
#     'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 1200, 'subsample': 0.6, 'seed': 2004}),
#     'fsrs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 6, 'num_boost_round': 1100, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2001}),
#     'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
#     'allfactor': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
#     '3kindfactor': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
# }

fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'fsv10': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'rffs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'allfactor': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    '3kindfactor': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
}
