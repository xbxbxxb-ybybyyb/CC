...
root_path = '/data/user/015614/Zeus/backtest/Europa/v4_0_63/回测结果/'
...
period4_fit = f'20211101~20211130_Europa_period4_all_merge_fit_模型评价_{bt_date}.xlsx'
...
filtered_model_list = os.listdir(f'/data/user/015614/Zeus/pred/Europa/v4_0_63/')
