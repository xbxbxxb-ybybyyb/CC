...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/europa/20240531_append/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/Europa/fac_20240531_append/base/')
...
xgb_imptc_pct_fsv11_period1_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20191130_first_FSV11_label_pct_graded.xlsx')
xgb_imptc_pct_fsv11_period2_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20200531_first_FSV11_label_pct_graded.xlsx')
xgb_imptc_pct_fsv11_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_first_FSV11_label_pct_graded.xlsx')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/europa/20240531_append/fsrs/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/europa/20240531_append/')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_63/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_63/rffs2_%s.pkl' % period.replace('_roll', '')",
}
