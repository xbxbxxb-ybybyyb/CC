...
# 实际上传的model_name
# model_name_list = ['fsv8_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsv11_pct_AllLgbRegModel', 'rffs_pct_AllLgbRegModel'] # period4
# model_name_list = ['rffs_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsrs_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel']
# model_name_list = ['fsv11_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsv10_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel']
model_name_list = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsv11_pct_AllLgbRegModel', 'rffs_pct_AllLgbRegModel'] # period7

dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_16/'
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20231102/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
