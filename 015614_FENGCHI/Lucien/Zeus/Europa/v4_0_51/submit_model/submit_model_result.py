...
# 实际上传的model_name
model_name_list = ['fsv8_scaler1_pct_AllXgbRegModel',
                   'fsv11_scaler1_pct_AllXgbRegModel',
                   'fsrs_scaler2_pct_AllLgbRegModel']
# model_name_list = ['fsv11_scaler2_pct_AllLgbRegModel']
# model_name_list = ['fsv11_scaler2_pct_AllLgbRegModel',
#                    'rffs_scaler2_pct_AllXgbRegModel']


dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_51/'
