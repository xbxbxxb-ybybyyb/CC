...
import json
import pandas as pd
from Zeus.Europa.v4_0_53.strat_conf import strategy_version
from Zeus.Europa.v4_0_53.path_conf import *
from Zeus.Europa.v4_0_53.hyper_param_space import xgb_fixed_params, lgb_fixed_params
...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        ...
        best_seed_list = model_param_res.sort_values('平均收益风险比', ascending=False).groupby(watch_params)['seed'].agg('first').tolist()
    ...
    FileUtil.save_df2xls(res_df, '/data/user/015614/junkData/', 'bt_res.xlsx')
