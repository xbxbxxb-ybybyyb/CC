...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_8/xgb_reg_model/',
    #           log_fname='2022-11-08 11：21：36_Europa_v1_0_8_xgb_reg_model.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_8/lgb_reg_model/',
    #           log_fname='2022-11-08 11：21：00_Europa_v1_0_8_lgb_reg_model.log',
    #           note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_8/xgb_reg_model/',
              log_fname='2022-11-09 19：40：22_Europa_v1_0_8_xgb_reg_model.log',
              note='fit')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_8/lgb_reg_model/',
    #           log_fname='2022-11-09 19：38：22_Europa_v1_0_8_lgb_reg_model.log',
    #           note='fit')