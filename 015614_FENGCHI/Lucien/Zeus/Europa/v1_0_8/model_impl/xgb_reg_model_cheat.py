...
from Zeus.Europa.v1_0_8.Tool import multiprocess
from Zeus.Europa.v1_0_8.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Europa.v1_0_8.hyper_param_space import model_params
from Zeus.Europa.v1_0_8.models.xgb_reg_model import XGBRegModel
from Zeus.Europa.v1_0_8.my_logger import MyLogger
from Zeus.Europa.v1_0_8.path_conf import *
from model_eval.bak.bak20230105_simple_bt.v3_5_SimpleEvalLaunch import EvalLaunch
...
use_test_param_mode = True
test_hyper_param_fpath = '2022-11-08 11：21：36_Europa_v1_0_8_xgb_reg_modeltest.xlsx'
...
verbose = False
search_time = 0
test_fname = f'20201001~20210630_{hump_model_name}_v1.csv'    # 保存在对应的版本路径下
    ...
    if hyper_search_mode or multi_grid_search_mode or use_test_param_mode:
        if test_cheat_mode:
            eval_inst = EvalLaunch(date_config=date_config,
                                   ...
                                   file_save_path=output_path,
                                   save_flag=False)
            model_eval, model_inmingan, model_mingan = eval_inst.launch()
            ...
            model_inmingan_copy = model_inmingan_copy.query('0.1 < 实际参与率 < 0.3')  # 控制参与率在0.1-0.3之间
            ...
            model_eval, model_inmingan, model_mingan = pd.DataFrame(), pd.DataFrame(), pd.DataFrame()
            eval_inst = None
            watch_scores = dict()
