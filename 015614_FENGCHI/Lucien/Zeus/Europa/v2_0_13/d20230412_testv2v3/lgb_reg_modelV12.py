...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV12'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        new_t_factor_list = diff_factor_df.query('类型 == "类型三：新增T日因子"')['factor_name'].tolist()
        factor_list = list(set(factor_list).difference(set(new_t_factor_list)))
