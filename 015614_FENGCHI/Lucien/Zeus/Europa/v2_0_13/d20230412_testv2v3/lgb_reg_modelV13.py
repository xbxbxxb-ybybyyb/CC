...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV13'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        diff_factor_df = pd.read_excel('/data/group/800463/sunss/europa/20230329/europa_v3相对于v2因子变动情况.xlsx')
        new_t_1_factor_list = diff_factor_df.query('类型 == "类型四：新增T-1日因子"')['factor_name'].tolist()
        factor_list = list(set(factor_list).difference(set(new_t_1_factor_list)))
