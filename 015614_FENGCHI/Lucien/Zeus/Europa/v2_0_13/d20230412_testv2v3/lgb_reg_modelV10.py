...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV10'
        ...
        self.get_dataset(junk_path + 'factor_df_all_20160101_20220630_add4factors.pkl')
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list.extend(['t1_ulnu_t_ul_rate5', 't1_ulnu_t_ret_mean5', 'EF_time_first_T1_10', 't_emo_ask_amtpct_mean'])
