...
root_path = '/data/user/015614/Zeus/backtest/Europa/v4_0_34/回测结果/'

bt_date = '20240409'
# period6_test = f'20211201~20220531_Europa_period6_all_merge_test_模型评价_{bt_date}.xlsx'
...
filtered_model_list = os.listdir(f'/data/user/015614/Zeus/pred/Europa/v4_0_34/')
