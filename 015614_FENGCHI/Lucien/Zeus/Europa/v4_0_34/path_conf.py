...
xgb_imptc_pct_fsv8_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_reg15_second_fac_20240401_FSV8_all_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv10_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_reg15_second_fac_20240401_FSV10_all_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv11_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_first_fac_20240401_FSV11_label_pct_graded.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_34/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_34/rffs2_%s.pkl' % period.replace('_roll', '')",
}
