...
import pandas as pd
import numpy as np
from Zeus.Europa.v2_0_3.path_conf import *
from Zeus.Europa.v2_0_3.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
from lightgbm import LGBMRegressor
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v2_0_3.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
class LgbRegModel:
    ...
    def tscv_eval_model(self, param):
        ...
        for idx, cv_list in enumerate(rolling_cv_month_list):
            ...
            eval_auc, eval_precision, eval_recall, y_pred_label = self.model_eval(y_valid, y_valid_pred, threshold=0)
    ...
    def start_train(self, param):
        ...
        test_auc, test_precision, test_recall, y_test_pred_label = self.model_eval(self.y_test, y_test_pred, threshold=0)
        ...
        fit_auc, fit_precision, fit_recall, y_fit_pred_label = self.model_eval(self.y_fit, y_fit_pred, threshold=0)
