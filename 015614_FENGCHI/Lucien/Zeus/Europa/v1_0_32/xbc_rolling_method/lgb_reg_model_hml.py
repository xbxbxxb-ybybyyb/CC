...
from Zeus.Europa.v1_0_32.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite import BTLite
from lightgbm import LGBMRegressor
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_32.my_logger import MyLogger
import warnings
import os
import time
np.random.seed(2023)
warnings.filterwarnings("ignore")
date_config = xbc_rolling_config
...
# 10 19 14
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 9.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 24.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.6, 'score_threshold': -0.0000496979163056282, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.8, 'score_threshold': 0.00807614226843666, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
# 22 26
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.4, 'score_threshold': -0.0000113979405431401, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.6, 'score_threshold': 0.00306440962013865, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}
# 8 21
# param_test ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 20.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.3, 'score_threshold': -0.002713153040524, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 18.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 8.0, 'random_state': 2022, 'reg_alpha': 0.1, 'reg_lambda': 0.5, 'score_threshold': 0.00208730778580347, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}

# 20 10 11
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1000.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.3, 'reg_lambda': 0.6, 'score_threshold': 0.00296140236231698, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 18.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.2, 'reg_lambda': 0.9, 'score_threshold': 0.00747613997439669, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}

# 15 21
# param_test ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 20.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.3, 'score_threshold': 0.000640390218472557, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 9.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.4, 'score_threshold': 0.00449871447785472, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}

# 18 5
# param_test ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1200.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.1, 'reg_lambda': 0.8, 'score_threshold': -0.00429218256297715, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'score_threshold': 0.00199823901997973, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# 30
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 800.0, 'n_jobs': -1, 'num_leaves': 20.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 1.0, 'score_threshold': 0.00322707371609427, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1200.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.4, 'score_threshold': 0.00773735189841682, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}

# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 800.0, 'n_jobs': -1, 'num_leaves': 8.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.9, 'score_threshold': 0.000590595398848908, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 1.0, 'score_threshold': 0.00201642403441619, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# 4 11
param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.2, 'score_threshold': -0.000137553122742079, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}
param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.8, 'score_threshold': 0.00105197673001784, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# 40 作废
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.5, 'score_threshold': 0.00471248182326406, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0, 'random_seed': 2022}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.5, 'score_threshold': 0.00471248182326406, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}

# 41 作废
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1300.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.1, 'reg_lambda': 0.4, 'score_threshold': 0.00283125714231749, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1300.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.1, 'reg_lambda': 0.4, 'score_threshold': 0.00283125714231749, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}

# 42 作废
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.4, 'score_threshold': 0.000172706336949441, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.4, 'score_threshold': 0.000172706336949441, 'silent': True, 'subsample': 0.7, 'subsample_freq': 0}

# 40
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1300.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.0, 'reg_lambda': 0.9, 'score_threshold': 0.00681491257166679, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1300.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.0, 'reg_lambda': 0.9, 'score_threshold': 0.00681491257166679, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}

# 41
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.8, 'score_threshold': 0.00271290040178683, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.8, 'score_threshold': 0.00271290040178683, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# 42
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 1.0, 'score_threshold': -0.000477699654573297, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 1.0, 'score_threshold': -0.000477699654573297, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}
...
class LgbRegModel:
    ...
    def train_model(self, X_train, y_train, param):
        ...
        # import joblib
        # self.model = joblib.load(filename='/data/group/800463/fengc/for_xly/europa/20230107_model_file_period4/HmlLgbRegModel/hml0/period4_LgbRegModel.pkl')
    ...
    def xbc_get_split_train_and_test_data(self, idx):
        X_copy = self.X.copy()
        y_copy = self.y.copy()
        X_copy = X_copy.drop(X_copy.filter(regex='label*').columns.tolist(), axis=1)
        y_copy = y_copy.reindex(index=X_copy.index)
        ...
        X_train['trade_month'] = X_train['trade_date'] // 100
        y_train['trade_month'] = y_train['trade_date'] // 100

        trade_month_list = sorted(list(X_train['trade_month'].unique()))
        if idx == 0:
            test_trade_month_list = trade_month_list[:3]
        else:
            test_trade_month_list = trade_month_list[3 + (idx - 1) * 6: 3 + idx * 6]

        train_trade_month_list = [x for x in trade_month_list if x not in test_trade_month_list]
        valid_trade_month_list = [train_trade_month_list[-1]]

        X_train_fold = X_train.query(f'trade_month in {train_trade_month_list}')
        X_valid_fold = X_train.query(f'trade_month in {valid_trade_month_list}')
        X_test_fold = X_train.query(f'trade_month in {test_trade_month_list}')

        y_train_fold = y_train.query(f'trade_month in {train_trade_month_list}')
        y_valid_fold = y_train.query(f'trade_month in {valid_trade_month_list}')
        y_test_fold = y_train.query(f'trade_month in {test_trade_month_list}')

        y_train_fold = y_train_fold[[self.label]]
        y_valid_fold = y_valid_fold[[self.label]]
        y_test_fold = y_test_fold[[self.label]]

        X_train_fold = X_train_fold.drop(['trade_date', 'trade_month'], axis=1)
        X_valid_fold = X_valid_fold.drop(['trade_date', 'trade_month'], axis=1)
        X_test_fold = X_test_fold.drop(['trade_date', 'trade_month'], axis=1)

        # 选择预处理方式
        # X_train_fold, X_valid_fold, X_test_fold = self.fun_trans_train_test_minmaxscaler(X_train_fold, X_valid_fold, X_test_fold)
        # X_train_fold, X_valid_fold, X_test_fold = self.fun_trans_train_test_standardscaler(X_train_fold, X_valid_fold, X_test_fold)
        X_train_fold, X_valid_fold, X_test_fold = self.fun_trans_train_test_minmaxmadscaler(X_train_fold, X_valid_fold, X_test_fold)

        self.X_train, self.X_valid, self.X_test, self.y_train, self.y_valid, self.y_test = X_train_fold, X_valid_fold, X_test_fold, y_train_fold, y_valid_fold, y_test_fold
        return X_train_fold, y_train_fold, X_valid_fold, y_valid_fold, X_test_fold, y_test_fold

    def xbc_start_rolling_halfyear_train(self, param):
        param_copy = param.copy()
        if 'n_estimators' in param_copy.keys():
            param_copy['n_estimators'] = int(param_copy['n_estimators'])
        if 'factor_num' in param_copy.keys():
        ...
        valid_test_pred_df = pd.DataFrame()
        for idx in range(0, 8 + int(SUB_VERSION[1]) - 1):
            X_train, y_train, X_valid, y_valid, X_test, y_test = self.xbc_get_split_train_and_test_data(idx)
            self.train_model(X_train, y_train, param=param_copy)
            y_test_pred = self.predict(X_test.values)

            valid_test_pred = list(np.concatenate([y_test_pred > score_threshold]))
            valid_test_pred_prob = list(np.concatenate([y_test_pred]))
            tmp_valid_test_pred_df = pd.DataFrame(index=self.X_test.index)
            tmp_valid_test_pred_df['prediction'] = valid_test_pred
            tmp_valid_test_pred_df['pred_Reg'] = valid_test_pred_prob
            tmp_valid_test_pred_df['stockID'] = tmp_valid_test_pred_df.index.get_level_values(1)
            tmp_valid_test_pred_df['datelist'] = tmp_valid_test_pred_df.index.get_level_values(0).strftime('%Y%m%d')
            tmp_valid_test_pred_df['Indexs'] = tmp_valid_test_pred_df['stockID'] + ' ' + tmp_valid_test_pred_df['datelist']
            tmp_valid_test_pred_df = tmp_valid_test_pred_df.set_index('Indexs', drop=True)

            valid_test_pred_df = pd.concat([valid_test_pred_df, tmp_valid_test_pred_df], axis=0)

        valid_test_pred_df = valid_test_pred_df.sort_values(['datelist', 'stockID'])
        return valid_test_pred_df
...
def tuning_params(param):
    ...
    if fit_cheat_mode:
        ...
        model_valid_mingan_copy = model_valid_mingan.copy()
        model_valid_mingan_copy['fit_indicator'] = model_valid_mingan_copy['收益风险比'] * model_valid_mingan_copy['扣费收益率胜率'] * model_valid_mingan_copy['实际参与率']
        model_valid_mingan_copy = model_valid_mingan_copy.query('0.05 < 实际参与率 < 0.3')  # 控制参与率在0.1-0.3之间
        model_valid_mingan_copy = model_valid_mingan_copy.sort_values(['fit_indicator'], ascending=False).iloc[0]
        in_adapt_score_threshold = model_valid_mingan_copy.name
        model_test_mingan_copy_ = model_test_mingan.loc[in_adapt_score_threshold]
        ...
        model_test_mingan_copy = model_test_mingan.copy()
        model_test_mingan_copy['fit_indicator'] = model_test_mingan_copy['收益风险比'] * model_test_mingan_copy['扣费收益率胜率'] * model_test_mingan_copy['实际参与率']
        model_test_mingan_copy = model_test_mingan_copy.query('0.05 < 实际参与率 < 0.3')  # 控制参与率在0.1-0.3之间
        model_test_mingan_copy = model_test_mingan_copy.sort_values(['fit_indicator'], ascending=False).iloc[0]
...
if hyper_search_mode:
    ...
    inst_test.pred_out_path += 'xbc_rolling/'
    pred_result = inst_test.xbc_start_rolling_halfyear_train(param=param_test)
    FileUtil.save_df2csv(pred_result, inst_test.pred_out_path, inst_test.pred_fname)
    # check = pd.read_csv('/data/group/800463/fengc/for_wj/20221228_period4_Europa_fac_20221116/20210701~20211231_LgbRegModel_v4_hml.csv', index_col=0)
    # check = check.reindex(index=pred_result.index)
    # check['pred_Reg'].sum()
    # pred_result['pred_Reg'].sum()
