...
# 4.7017
param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1200.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 1.0, 'score_threshold': 0.0040095821033893, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}
...
class LgbRegModel:
    def __init__(self, mode='test', sub_version='v1'):
        self.model_name = 'LgbRegModelV2V3duiqi'
        ...
        self.get_dataset('/data/group/800463/sunss/for_xly/europa/20221116_new/factor_df_all_20160101_20220630_v2v3duiqi.pkl')
...
if hyper_search_mode:
    ...
    import joblib
    os.makedirs(junk_path + f'{inst_test.model_name}/', exist_ok=True)
    junk_path = junk_path + f'{inst_test.model_name}/'
