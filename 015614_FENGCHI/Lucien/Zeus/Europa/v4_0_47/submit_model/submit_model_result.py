...
# 实际上传的model_name
model_name_list = ['fsv8_scaler1_pct_AllXgbRegModel', 'fsv10_scaler1_pct_AllXgbRegModel', 'fsv11_scaler1_pct_AllXgbRegModel',
                   'fsv11_scaler1_pct_AllLgbRegModel', 'fsrs_scaler1_pct_AllLgbRegModel']


dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_47/'
# dest_path = f'/dfs/user/015614/shared/strategy_model/Europa/fac_20240401/mean/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240401/mean/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
