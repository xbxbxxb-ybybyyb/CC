...
# 实际上传的model_name   # NOTE: 20240528用于提交区间5模型
model_name_list = ['fsv11_scaler1_pct_AllXgbRegModel',  # base两个
                   'fsrs_scaler1_pct_AllXgbRegModel']
# model_name_list = ['fsv10_scaler1_pct_AllLgbRegModel']


dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_58/'   #  base
# dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_57/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240529/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
