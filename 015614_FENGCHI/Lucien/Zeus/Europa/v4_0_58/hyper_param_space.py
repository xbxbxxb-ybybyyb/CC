...
fixed_xgb_reg_param = {
    ...
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 4, 'num_boost_round': 1000, 'seed': 2000}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 8, 'num_boost_round': 1100, 'min_child_weight': 7, 'seed': 2003}),
...
fixed_lgb_reg_param = {
    ...
    'fsv10': add(lgb_fixed_params, {'learning_rate': 0.03, 'max_depth': 3, 'n_estimators': 900}),
    'fsv11': add(lgb_fixed_params, {'learning_rate': 0.035, 'max_depth': 3, 'n_estimators': 1000}),
    'fsrs': add(lgb_fixed_params, {'learning_rate': 0.325, 'max_depth': 3, 'n_estimators': 950}),
