...
version_list = ['v4_0_43', 'v4_0_44', 'v4_0_45', 'v4_0_46']
factor_select_list = ['fsv8', 'fsv10', 'fsv11', 'fsrs', 'rffs']
...
product_list = [ ('v4_0_45', 'fsv11', 'scaler2', 'AllLgbRegModel'),
                 ('v4_0_45', 'fsv10', 'scaler1', 'AllXgbRegModel'),
                 ('v4_0_45', 'fsrs', 'scaler1', 'AllXgbRegModel'),
                 ('v4_0_44', 'fsv11', 'scaler2', 'AllLgbRegModel'),
                 ('v4_0_44', 'rffs', 'scaler2', 'AllXgbRegModel'),]
