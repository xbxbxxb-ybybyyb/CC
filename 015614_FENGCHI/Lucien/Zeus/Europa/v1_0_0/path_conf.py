...
#%% V6_20220927
saturn_data_path = os.path.join(group_path, 'sunss/for_xly/europa/20221020/')
saturn_data_test_fpath = os.path.join(saturn_data_path, 'factor_df_all_20160101_20201231.pkl')
saturn_data_fit_fpath = os.path.join(saturn_data_path, 'factor_df_all_20160101_20201231.pkl')

filter_factor_path = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/')
filter_factor_fpath = os.path.join(filter_factor_path, 'xgb_importance_20190102_reg15_second_fac_20221020_FSV8_all_pct_graded_dropHighTimeCost_60.xlsx')

factor_score_path = os.path.join(group_path, 'sunss/for_xly/europa/20221020/')
