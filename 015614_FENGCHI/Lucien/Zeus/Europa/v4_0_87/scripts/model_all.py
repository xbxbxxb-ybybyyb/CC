...
# from Zeus.Europa.v4_0_87.backtest.SimBackTest import SimBackTest
...
from Zeus.Europa.v4_0_87.scripts.hyper_param_space import *
from Zeus.Europa.v4_0_87.label_generate.fetch_label import fetch_label
import xgboost as xgb
import lightgbm as lgb
from Zeus.Europa.v4_0_87.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v4_0_87.scripts.my_logger import MyLogger
import warnings
import random
import os
...
if hyper_search_mode == 2:
    tree_num_list = list(range(300, 1800, 200))
    if model_select == 'XgbRegModel':
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Europa/v4_0_87/{config_flag}/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
