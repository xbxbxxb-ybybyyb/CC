...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v4_0_64.backtest.team_backtest.modelEval_Tool import *
from Zeus.Europa.v4_0_64.path_conf import *
from Zeus.Europa.v4_0_64.strat_conf import *
...
def deal_preddata(path, viewcol, sel_data='all'):
    ...
    # # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/Europa/v4_0_642/LgbRegModel/20210701~20211231_LgbRegModel_v4.csv', index_col=0) # period4
    # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/Europa/v4_0_646/LgbRffsRegModel/20220401~20220930_LgbRffsRegModel_v5.csv', index_col=0)
...
if __name__ == "__main__":
    ...
    sel_model_names = os.listdir(f'/data/user/015614/Zeus/pred/Europa/v4_0_64/')
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v4_0_64/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
