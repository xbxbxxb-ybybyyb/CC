...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/europa/20230314/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20230314-FSV9-all/')
xgb_imptc_path_20210630new = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20210630_new/')
xgb_imptc_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230314_FSV9_all_label_pct_graded_lowCost_drop76_addFactors.xlsx')
xgb_imptc_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230314_FSV9_all_label_pct_graded_lowCost_drop76_addFactors.xlsx')
xgb_imptc_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230314_FSV9_all_label_pct_graded_lowCost_drop76_addFactors.xlsx')
