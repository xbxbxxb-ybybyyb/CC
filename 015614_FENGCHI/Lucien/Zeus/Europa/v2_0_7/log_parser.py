...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModel/',
              log_fname='Europa_v2_0_7_LgbRegModel_v1.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModel/',
              log_fname='Europa_v2_0_7_LgbRegModel_v2.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModel/',
              log_fname='Europa_v2_0_7_LgbRegModel_v3.log',
              note='')

    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_7_LgbRegModelV2_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_7_LgbRegModelV2_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_7/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_7_LgbRegModelV2_v3.log',
    #           note='')