...
config_flag = [f'config{x}' for x in range(1, 7)]
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_83/scripts/model_all.py {argv_list}')
...
param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config4', 'fsv8_config6', 'fsrs_config2', 'fsv11_config1', 'fsrs_config3', 'fsrs_config5'], param_list))
