...
fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400}),
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 600}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 4, 'num_boost_round': 1200, 'seed': 2004}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 1100, 'min_child_weight': 7, 'seed': 2001}),
...
fixed_lgb_reg_param = {
    'fsv8': add(lgb_fixed_params, {'learning_rate': 0.04, 'max_depth': 3, 'n_estimators': 1400, 'seed': 2003}),
    'fsv10': add(lgb_fixed_params, {'learning_rate': 0.03, 'max_depth': 3, 'n_estimators': 1100, 'seed': 2002}),
    'fsv11': add(lgb_fixed_params, {'learning_rate': 0.035, 'max_depth': 3, 'n_estimators': 1000}),
    'fsrs': add(lgb_fixed_params, {'learning_rate': 0.325, 'max_depth': 3, 'n_estimators': 1000, 'seed': 2003}),
    'rffs': add(lgb_fixed_params, {'learning_rate': 0.3, 'max_depth': 3, 'n_estimators': 850}),
}
