...
from Zeus.Europa.v4_0_60.strat_conf import *
...
# 实际上传的model_name   # NOTE: 20240603用于提交区间6模型
# model_name_list = ['fsv11_scaler1_pct_AllXgbRegModel',
                   # 'fsrs_scaler1_pct_AllXgbRegModel']
model_name_list = ['fsrs_scaler1_pct_AllLgbRegModel']


# dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_60/'   #  base
dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_59/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240531/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
