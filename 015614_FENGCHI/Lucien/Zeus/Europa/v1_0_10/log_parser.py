...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_10/xgb_reg_model/',
              log_fname='2022-11-26 01：59：36_Europa_v1_0_10_xgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_10/lgb_reg_model/',
              log_fname='2022-11-26 01：59：26_Europa_v1_0_10_lgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_10/lr_reg_model/',
              log_fname='2022-11-26 02：00：20_Europa_v1_0_11_lr_reg_model.log',
              note='test')