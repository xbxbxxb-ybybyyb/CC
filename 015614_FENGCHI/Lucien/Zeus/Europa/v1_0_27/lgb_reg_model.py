...
import pandas as pd
import numpy as np
from Zeus.Europa.v1_0_27.path_conf import *
from Zeus.Europa.v1_0_27.hyper_param_space import hyper_lgb_reg_params
from model_eval.bak.bak20230105_simple_bt.v3_6_SimpleEvalLaunch import EvalLaunch
from lightgbm import LGBMRegressor
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_27.my_logger import MyLogger
import warnings
import os
import random
random.seed(2023)
...
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6000000000000001, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 24.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 0.5, 'score_threshold': -0.003123, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6000000000000001, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 24.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 0.5, 'score_threshold': -0.000091, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}

param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7000000000000001, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 0.8, 'score_threshold': -0.002618, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7000000000000001, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 0.8, 'score_threshold': 0.002041, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6000000000000001, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.9, 'score_threshold': 0.001671, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.7000000000000001, 'score_threshold': 0.001646, 'silent': True, 'subsample': 1.0, 'subsample_freq': 0}
