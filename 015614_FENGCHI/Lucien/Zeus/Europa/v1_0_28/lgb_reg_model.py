...
import pandas as pd
import numpy as np
from Zeus.Europa.v1_0_28.path_conf import *
from Zeus.Europa.v1_0_28.hyper_param_space import hyper_lgb_reg_params
# from model_eval.v3_6_SimpleEvalLaunch import EvalLaunch
from Zeus.BTLite.BTLite import BTLite
from lightgbm import LGBMRegressor
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_28.my_logger import MyLogger
import warnings
import os
import random
random.seed(2023)
...
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.30000000000000004, 'score_threshold': -0.00244, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.30000000000000004, 'score_threshold': 0.000452, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}

param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.0, 'score_threshold': -0.000749, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}
param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.0, 'score_threshold': -0.000304, 'silent': True, 'subsample': 0.5, 'subsample_freq': 0}

# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 1.0, 'score_threshold': -0.000268, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 1.0, 'score_threshold': 0.002529, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}
...
def tuning_params(param):
    ...
    if fit_cheat_mode:
        ...
        _ic = round(model_eval['预测值与标签IC'], 4) if model_eval.shape[0] > 0 else 0
        _sharpe_ratio = round(model_eval['夏普比率'], 4) if model_eval.shape[0] > 0 else 0
        _buy_times = round(model_eval['实际参与次数'], 4) if model_eval.shape[0] > 0 else 0
        _cum_profit = round(model_eval['累计扣费总收益'], 4) if model_eval.shape[0] > 0 else 0
        _mdd_profit = round(model_eval['最大回撤'], 4) if model_eval.shape[0] > 0 else 0
        _winrate = round(model_eval['扣费后收益率胜率'], 4) if model_eval.shape[0] > 0 else 0
        _join_pct = round(model_eval['样本参与率'], 4) if model_eval.shape[0] > 0 else 0
