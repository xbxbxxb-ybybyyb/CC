...
filter_factor_path = os.path.join(group_path, 'sunss/for_xly/europa/20221101/')
filter_factor_fpath = os.path.join(filter_factor_path, 'regression_select_result_20160101_20200930.xlsx')
