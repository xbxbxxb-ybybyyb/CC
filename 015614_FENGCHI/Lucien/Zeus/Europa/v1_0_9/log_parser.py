...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_9/xgb_reg_model/',
    #           log_fname='2022-11-08 11：21：48_Europa_v1_0_9_xgb_reg_model.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_9/lgb_reg_model/',
    #           log_fname='2022-11-08 11：21：42_Europa_v1_0_9_lgb_reg_model.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_9/xgb_reg_model/',
    #           log_fname='2022-11-09 19：40：27_Europa_v1_0_9_xgb_reg_model.log',
    #           note='fit')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_9/lgb_reg_model/',
              log_fname='2022-11-09 19：40：25_Europa_v1_0_9_lgb_reg_model.log',
              note='fit')