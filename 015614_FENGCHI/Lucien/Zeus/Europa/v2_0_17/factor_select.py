...
if __name__ == '__main__':
    ...
    def launch_1period(period):
        ...
        selected_factor_list = stats.query(f'mean >= 160').index.tolist()
        FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rf_fs_list_{period}.pkl')
        selected_factor_list = stats.query(f'mean >= 165').index.tolist()
        FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rf_fs_list_{period}_165.pkl')
