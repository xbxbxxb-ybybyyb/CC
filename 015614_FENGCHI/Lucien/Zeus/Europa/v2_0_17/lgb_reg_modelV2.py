...
import pandas as pd
import numpy as np
from Zeus.Europa.v2_0_17.path_conf import *
from Zeus.Europa.v2_0_17.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v2_0_17.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
if PERIOD[-1] is '1':
    ...
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 18.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2000.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.001592
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRffsRegModel'
        self.strategy_name = 'Europa'
        self.version = 'v2_0_17'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Europa/v2_0_17/rf_fs_list_{PERIOD}.pkl')
        if 't_emo_ask_amtpct_mean' in factor_list:
            factor_list.remove('t_emo_ask_amtpct_mean')
