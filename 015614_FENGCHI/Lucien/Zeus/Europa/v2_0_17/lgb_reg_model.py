...
if PERIOD[-1] is '1':
    param ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 9.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3300.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.5, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.010228
elif PERIOD[-1] is '2':
    param ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 7.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3700.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.3, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.006697
elif PERIOD[-1] is '3':
    param ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.6, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.003396
elif PERIOD[-1] is '4':
    param ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 7.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2600.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.0, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.003396
elif PERIOD[-1] is '5':
...
if hyper_search_mode:
    ...
    inst.model.save_model(junk_path + f'LgbRegModel.pkl')
