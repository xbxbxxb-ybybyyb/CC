...
import pandas as pd
import numpy as np
from Zeus.Europa.v2_0_8.path_conf import *
...
if PERIOD[-1] is '1':
    ...
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 9.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 20.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3300.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.0, 'subsample': 1.0, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '3':
