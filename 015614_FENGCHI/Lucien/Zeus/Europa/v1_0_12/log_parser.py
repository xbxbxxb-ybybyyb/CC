...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_12/xgb_reg_model/',
              log_fname='2022-11-18 11：19：57_Europa_v1_0_12_xgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_12/lgb_reg_model/',
              log_fname='2022-11-18 11：19：55_Europa_v1_0_12_lgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_12/lr_reg_model/',
              log_fname='2022-11-18 11：20：00_Europa_v1_0_12_lr_reg_model.log',
              note='test')