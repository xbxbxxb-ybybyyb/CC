...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_4/xgb_reg_model/',
    #           log_fname='2022-09-13 21：27：22_Europa_v1_0_4_xgb_reg_model.log',
    #           note='用全部因子进行测试20160101-20200630')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_4/lgb_clf_model/',
              log_fname='2022-10-28 20：49：46_Europa_v1_0_4_lgb_clf_model.log',
              note='')