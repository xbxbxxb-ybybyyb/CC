...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/europa/20240531_scene/')
data_all_fpath = os.path.join(data_path, f'factor_df_draw2_20160101_20221130.pkl')

profit_data_fpath = f'/data/group/800463/sunss/profit/europa/20240401/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/Europa/fac_20240531_scene/base/draw2/')
xgb_imptc_pct_fsv8_period1_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20191130_reg15_second_FSV8_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period2_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20200531_reg15_second_FSV8_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_reg15_second_FSV8_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period4_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20210531_reg15_second_FSV8_draw2_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv10_period1_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20191130_reg15_second_FSV10_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period2_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20200531_reg15_second_FSV10_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_reg15_second_FSV10_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period4_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20210531_reg15_second_FSV10_draw2_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv11_period1_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20191130_first_FSV11_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv11_period2_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20200531_first_FSV11_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv11_period3_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20201130_first_FSV11_draw2_label_pct_graded.xlsx')
xgb_imptc_pct_fsv11_period4_fpath = os.path.join(xgb_imptc_path, f'europa_xgb_importance_20210531_first_FSV11_draw2_label_pct_graded.xlsx')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/europa/20240531_scene/fsrs_draw2/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/europa/20240531_scene/')
factor_score_20191130_fpath = os.path.join(factor_score_path, f'factor_bank_inf_draw2_period.xlsx')
factor_score_20200531_fpath = os.path.join(factor_score_path, f'factor_bank_inf_draw2_period.xlsx')
factor_score_20201130_fpath = os.path.join(factor_score_path, f'factor_bank_inf_draw2_period.xlsx')
factor_score_20210531_fpath = os.path.join(factor_score_path, f'factor_bank_inf_draw2_period.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_66/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_66/rffs2_%s.pkl' % period.replace('_roll', '')",
}
