...
module_name = f'Zeus.Europa.v4_0_80.config.path_conf'
...
label1_data = label_df[['label_pct', 'label_pct_graded', 'label_TN_o2ul', 'label_T_is_zt', 'label_TN_vwap2ul', 'label_T_o2ul', 'label_pattern', 'label_T1_is_zt',
                        'label_p5_graded', 'label_p7_graded', 'label_p9_graded']]
...
label_data['self_pct_label1'] = label_data[['label_pattern', 'label_pct']].apply(lambda x: func4label1(x), axis=1)
