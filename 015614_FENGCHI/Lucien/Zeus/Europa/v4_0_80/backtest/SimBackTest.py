...
class SimBackTest:
    def __init__(self, pred_fpath_list, fit_fpath_list, date_dict, profit_data_fpath=None, data_fpath=None, attend_ratio_range=(10, 45), save_flag=True, multi_attend=True):
    ...
    def state_machine(self):
        ...
        if STRATEGY_NAME == 'JupiterZ':
            ...
            self.cost_pct = 0.002
            self.extreme_thres = 0.2
        elif STRATEGY_NAME == 'ProjectSell':
            self.cost_pct = 0.002
            self.extreme_thres = 0.2
