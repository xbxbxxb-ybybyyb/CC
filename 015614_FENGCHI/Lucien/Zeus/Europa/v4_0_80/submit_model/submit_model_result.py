...
# model_name_list = ['fsv11_scaler1_pct_AllXgbRegModel',
                   # 'fsrs_scaler1_pct_AllXgbRegModel']
# model_name_list = ['fsv8_s1_Xgb', 'fsrs_s1_Xgb', 'rffs_s1_Xgb']
...
_model_name = {
   ...
   # 'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'FcXgb',
   # 'rffs_s1_Xgb': 'Fc2Xgb', # config2
   'rffs_s1_Xgb': 'Fc3Xgb',  # config3
   'fsv11_s1_Xgb': 'FSV11Xgb'    # config3
               }
config = 'config3'


dept_path = f'/data/user/015614/Zeus/pred/Europa/v4_0_80/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240828/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
