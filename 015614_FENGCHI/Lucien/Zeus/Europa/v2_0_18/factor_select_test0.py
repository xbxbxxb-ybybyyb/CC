...
if __name__ == '__main__':
    ...
    def launch_1period(period):
        ...
        # 中间结果
        FileUtil.save_df2pkl(factor_imptc_df, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'tmp_rf_cv_score_{period}_test1.pkl')
        ...
        FileUtil.save_df2pkl(stats, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'tmp_rf_cv_score_{period}_test1.pkl')
        selected_factor_list = stats.query(f'mean >= 280').index.tolist()
        FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rf_fs_list_{period}_test1.pkl')
