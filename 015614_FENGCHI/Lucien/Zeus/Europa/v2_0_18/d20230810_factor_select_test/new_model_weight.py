...
class MyModelTrain:
    def __init__(self, model_select='XgbRegModel'):
        self.model_name = f'{fs_version}{label_flag}_Weight{model_select}'
    ...
    def select_factor(self, xgb_imptc_fpath=None):
        if fs_version == 'rffs':
            factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Europa/v2_0_18/rf_fs_list_{period}_test1_default.pkl')
