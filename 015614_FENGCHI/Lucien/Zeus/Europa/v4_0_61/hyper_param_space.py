...
fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 00}),
    ...
    'fsrs': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 6, 'num_boost_round': 300, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2003}),
    'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 2000, 'seed': 2002}),
}
...
fixed_lgb_reg_param = {
    ...
    'rffs': add(lgb_fixed_params, {'learning_rate': 0.3, 'max_depth': 4, 'n_estimators': 850}),
}
