...
import json
import pandas as pd
from Zeus.Europa.v4_0_18.strat_conf import strategy_version
from Zeus.Europa.v4_0_18.path_conf import *
from Zeus.Europa.v4_0_18.hyper_param_space import xgb_fixed_params, lgb_fixed_params

# 防止query的时候触发关键字，lambda需要特殊处理
xgb_watch_params = ['eta', 'num_boost_round', 'max_depth', 'colsample_bytree', 'gamma', 'alpha', 'lambda', 'min_child_weight', 'subsample','seed']
...
if __name__ == '__main__':
    ...
    plt.savefig('/data/user/015614/junkData/hyper_compare.png', bbox_inches='tight', pad_inches=0.1)
