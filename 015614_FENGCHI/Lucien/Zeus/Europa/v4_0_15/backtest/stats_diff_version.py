...
root_path = '/data/user/015614/Zeus/backtest/Europa/v4_0_15/回测结果/'
...
filtered_model_list = ['rffs_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsrs_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel',
