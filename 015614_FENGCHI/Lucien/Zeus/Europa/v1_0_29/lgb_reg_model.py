...
import pandas as pd
import numpy as np
from Zeus.Europa.v1_0_29.path_conf import *
from Zeus.Europa.v1_0_29.hyper_param_space import hyper_lgb_reg_params
# from model_eval.v3_6_SimpleEvalLaunch import EvalLaunch
from Zeus.BTLite.BTLite import BTLite
from lightgbm import LGBMRegressor
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_29.my_logger import MyLogger
import warnings
import os
np.random.seed(2023)
...
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7000000000000001, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_samples': 2.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.6000000000000001, 'score_threshold': -0.00425431685160644, 'silent': True, 'subsample': 1.0, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6000000000000001, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.2, 'reg_lambda': 0.4, 'score_threshold': 0.00115948946723554, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}

# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.6000000000000001, 'reg_lambda': 0.5, 'score_threshold': 0.00146259794647665, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}
# param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6000000000000001, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.8, 'score_threshold': 0.00136174774415376, 'silent': True, 'subsample': 0.7000000000000001, 'subsample_freq': 0}

param_test ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 3.0, 'min_child_samples': 2.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.9, 'score_threshold': 0.00219748399851243, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'score_threshold': 0.00291052576134486, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
