...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_20/xgb_reg_model/',
              log_fname='2022-11-24 09：05：50_Europa_v1_0_20_xgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_20/lgb_reg_model/',
              log_fname='2022-11-24 09：05：48_Europa_v1_0_20_lgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_20/lr_reg_model/',
              log_fname='2022-11-24 09：05：51_Europa_v1_0_20_lr_reg_model.log',
              note='test')