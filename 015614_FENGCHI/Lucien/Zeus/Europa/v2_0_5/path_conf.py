...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/europa/20230303/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20230304-FSV9-hmlnew/')
xgb_imptc_path_20210630new = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20210630_new/')
xgb_imptc_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230225_FSV9_all_label_pct_graded_lowCost.xlsx')
xgb_imptc_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230225_FSV9_all_label_pct_graded_lowCost.xlsx')
xgb_imptc_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230225_FSV9_all_label_pct_graded_lowCost.xlsx')
...
# 分场景因子
xgb_imptc_hml0_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230303_FSV9_hmlnew_0_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml1_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230303_FSV9_hmlnew_1_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml2_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230303_FSV9_hmlnew_2_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml0_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230303_FSV9_hmlnew_0_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml1_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230303_FSV9_hmlnew_1_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml2_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230303_FSV9_hmlnew_2_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml0_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230303_FSV9_hmlnew_0_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml1_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230303_FSV9_hmlnew_1_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml2_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230303_FSV9_hmlnew_2_label_pct_graded_lowCost.xlsx')
