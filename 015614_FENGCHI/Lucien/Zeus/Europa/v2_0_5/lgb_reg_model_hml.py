...
import pandas as pd
import numpy as np
from Zeus.Europa.v2_0_5.path_conf import *
...
if PERIOD[-1] is '1' and SCENE == 0:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 7.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3500.0, 'n_jobs': -1, 'num_leaves': 4.0, 'random_state': 2022, 'reg_alpha': 0.3, 'reg_lambda': 0.8, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
    ...
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 4000.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
    ...
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 4000.0, 'n_jobs': -1, 'num_leaves': 12.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '3' and SCENE == 0:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 5.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2700.0, 'n_jobs': -1, 'num_leaves': 4.0, 'random_state': 2022, 'reg_alpha': 0.3, 'reg_lambda': 0.8, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
...
class LgbRegModel:
    ...
    def get_dataset(self, path):
        ...
        samples = samples.query(f'hmlnew == {SCENE}')
