...
from Zeus.Europa.v2_0_5.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v2_0_5.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
param = {}
best_threshold = 0
if PERIOD[-1] is '1' and SCENE == 0:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '1' and SCENE == 1:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '1' and SCENE == 2:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3300.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.2, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '2' and SCENE == 0:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2500.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.8, 'subsample': 0.8, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '2' and SCENE == 1:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3300.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.2, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '2' and SCENE == 2:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2800.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.4, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '3' and SCENE == 0:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3100.0, 'n_jobs': -1, 'num_leaves': 8.0, 'random_state': 2022, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '3' and SCENE == 1:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2800.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.4, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
elif PERIOD[-1] is '3' and SCENE == 2:
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbRegModelV2'   # 老版本的hml
    ...
    @staticmethod
    def model_eval(y_true, y_pred, score_threshold=0):
        y_true_label = y_true.values.reshape(-1) > score_threshold
    ...
    def tscv_eval_model(self, param):
        ...
        for idx, cv_list in enumerate(rolling_cv_month_list):
            ...
            eval_auc, eval_precision, eval_recall, eval_rmse, eval_ic, y_pred_label = self.model_eval(y_valid, y_valid_pred, score_threshold=best_threshold)
    ...
    def start_train(self, param):
        ...
        self.train_model(X_train_scaled, self.y_train, param_copy, X_test_scaled, self.y_test)
        y_test_pred = self.predict(X_test_scaled)
        test_auc, test_precision, test_recall, test_rmse, test_ic, y_test_pred_label = self.model_eval(self.y_test, y_test_pred, score_threshold=best_threshold)
        ...
        fit_auc, fit_precision, fit_recall, fit_rmse, fit_ic, y_fit_pred_label = self.model_eval(self.y_fit, y_fit_pred, score_threshold=best_threshold)
