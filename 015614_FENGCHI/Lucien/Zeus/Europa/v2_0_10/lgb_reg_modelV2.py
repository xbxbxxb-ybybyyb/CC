...
from Zeus.Europa.v2_0_10.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v2_0_10.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
class LgbRegModel:
    ...
    def fun_filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=None):
        ...
        #TODO: 测试去掉T-1日因子
        new_factor_t1_list = FileUtil.read_list(factor_select_path, 'new_factor_emotion_list.pkl')
        factor_list = list(set(factor_list).difference(set(new_factor_t1_list)))
