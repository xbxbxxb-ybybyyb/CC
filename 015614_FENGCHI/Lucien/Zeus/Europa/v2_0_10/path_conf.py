...
xgb_imptc_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230317_FSV8_all_label_pct_graded_lowCost_new.xlsx')
xgb_imptc_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230317_FSV8_all_label_pct_graded_lowCost_new.xlsx')
...
xgb_imptc_o2ul_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230317_FSV8_all_label_TN_931o2ul_lowCost_new.xlsx')
xgb_imptc_o2ul_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230317_FSV8_all_label_TN_931o2ul_lowCost_new.xlsx')
xgb_imptc_o2ul_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230317_FSV8_all_label_TN_931o2ul_lowCost_new.xlsx')
