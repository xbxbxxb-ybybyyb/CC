...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV4_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV4_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV4_v3.log',
    #           note='')
    #
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV3_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV3_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_10_LgbRegModelV3_v3.log',
    #           note='')

    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV5/',
              log_fname='Europa_v2_0_10_LgbRegModelV5_v1.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV5/',
              log_fname='Europa_v2_0_10_LgbRegModelV5_v2.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_10/LgbRegModelV5/',
              log_fname='Europa_v2_0_10_LgbRegModelV5_v3.log',
              note='')