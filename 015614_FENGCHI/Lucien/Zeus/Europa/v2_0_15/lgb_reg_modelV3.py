...
if PERIOD[-1] is '1':
    ...
    best_threshold = -0.00491
elif PERIOD[-1] is '4':
    param ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 6.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2400.0, 'n_jobs': -1, 'num_leaves': 36.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.00491
elif PERIOD[-1] is '5':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 9.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2600.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.4, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.000438
hyper_params = hyper_lgb_reg_params

class LgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'LgbO2ulFSV8RegModel'
        ...
        self.model = None
        self.scaler = None
        self.label = 'label_TN_931o2ul_graded'
    ...
    def get_train_and_test_data(self):
        ...
        filtered_factor = self.filter_factor(xgb_imptc_fpath=eval(f'xgb_imptc_o2ul_{PERIOD}_fpath'))
