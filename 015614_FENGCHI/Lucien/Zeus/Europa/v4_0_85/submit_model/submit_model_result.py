...
# 1-3区间 config1-fsv11 config2-fsrs config35 fsrs config46 fsv8
# 4区间 config1-fsrs config2-fsv11 config35-fsrs config91-fsrs
# 5区间 config1-fsrs config2-fsv11 config46-fsrs-fsv10
# 6区间 config1-fsrs config2-fsv11 config46-fsrs-fsv10
# 7区间 config1-fsrs config2-fsv11 config46-fsrs-fsv10 config4 no2
"""
config8 实盘版本
config7_fsv11 base_FSV11Xgb
config1_fsv11 p7_FSV11Xgb
config2_fsrs base_FSRSXgb
"""
_model_name = {
    # 'fsv8_s1_Xgb': 'FSV8Xgb',
   'fsrs_s1_Xgb': 'FSRSXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Europa/v4_0_85/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240901/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
