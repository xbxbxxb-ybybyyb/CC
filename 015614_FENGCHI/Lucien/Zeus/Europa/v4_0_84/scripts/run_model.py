...
config_flag = [f'config{x}' for x in [1,2,4,6,7,8]]
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_84/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsrs_config1', 'fsv11_config2', 'fsrs_config4', 'fsrs_config6', 'fsv10_config4', 'fsv10_config6'], param_list))
