...
search_time = 0
fit_fname = f'20200401~20210630_{hump_model_name}_v1.csv'
# fit_fname = f'20200401~20210630_{hump_model_name}_v2.csv'   # # 不滚动训练的结果
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Europa.v1_0_14.hyper_param_space import model_params_fit
