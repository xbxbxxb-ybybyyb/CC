...
if __name__ == '__main__':
    ...
    def launch_1period(period):
        ...
        FileUtil.save_df2pkl(factor_imptc_df, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'origin_rf_clf_cv_score_{period}.pkl')
        ...
        selected_factor_list = stats.query(f'mean >= 250').index.tolist()
        FileUtil.save_list2pkl(selected_factor_list, factor_select_path + f'{FS.strategy_name}/{FS.version}/', f'rf_fs_clf_list_{period}.pkl')
