...
from Zeus.Europa.v2_0_9.hyper_param_space import hyper_lgb_reg_params
...
if PERIOD[-1] is '1':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 20.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2600.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.0, 'reg_lambda': 1.0, 'subsample': 0.6, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.005914
elif PERIOD[-1] is '2':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 8.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2600.0, 'n_jobs': -1, 'num_leaves': 40.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.6, 'subsample': 1.0, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.000249
elif PERIOD[-1] is '3':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 7.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 12.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3000.0, 'n_jobs': -1, 'num_leaves': 20.0, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.1, 'subsample': 0.8, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.002984
