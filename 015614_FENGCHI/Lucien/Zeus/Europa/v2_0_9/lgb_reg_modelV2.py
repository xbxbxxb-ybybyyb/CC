...
import pandas as pd
import numpy as np
from Zeus.Europa.v2_0_9.path_conf import *  # 5个情绪因子的版本
...
if PERIOD[-1] is '1':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 3.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 2600.0, 'n_jobs': -1, 'num_leaves': 8.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.7, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.007039
elif PERIOD[-1] is '2':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3000.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.3, 'subsample': 0.6, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.004828
elif PERIOD[-1] is '3':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.8, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 4.0, 'metric': {'auc', 'binary_logloss'}, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3200.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.9, 'reg_lambda': 0.9, 'subsample': 0.7, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = -0.00126
...
class LgbRegModel:
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Europa/v2_0_9/rf_fs_list_{PERIOD}.pkl')
