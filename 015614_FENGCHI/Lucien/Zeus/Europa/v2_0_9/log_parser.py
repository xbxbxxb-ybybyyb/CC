...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV4_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV4_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV4/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV4_v3.log',
    #           note='')
    #
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV3_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV3_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV3/',
    #           log_fname='Europa_v2_0_9_LgbRegModelV3_v3.log',
    #           note='')

    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV5/',
              log_fname='Europa_v2_0_9_LgbRegModelV5_v1.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV5/',
              log_fname='Europa_v2_0_9_LgbRegModelV5_v2.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_9/LgbRegModelV5/',
              log_fname='Europa_v2_0_9_LgbRegModelV5_v3.log',
              note='')