...
if PERIOD[-1] is '1':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 7.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 16.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3000.0, 'n_jobs': -1, 'num_leaves': 32.0, 'objective': 'binary', 'random_state': 2022, 'reg_alpha': 0.0, 'reg_lambda': 0.2, 'subsample': 1.0, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0.324236
elif PERIOD[-1] is '2':
    ...
    best_threshold = 0.382138
elif PERIOD[-1] is '3':
    param = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'gpu_device_id': 0, 'gpu_platform_id': 1, 'gpu_use_dp': True, 'learning_rate': 0.005, 'max_depth': 9.0, 'metric': {'binary_logloss', 'auc'}, 'min_child_samples': 2.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 3700.0, 'n_jobs': -1, 'num_leaves': 40.0, 'objective': 'binary', 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.4, 'subsample': 0.9, 'subsample_freq': 0, 'verbosity': -1}
    best_threshold = 0.407399
