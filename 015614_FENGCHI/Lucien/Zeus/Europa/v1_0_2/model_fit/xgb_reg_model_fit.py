...
from Zeus.Europa.v1_0_2.Tool import multiprocess
from Zeus.Europa.v1_0_2.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Europa.v1_0_2.models.xgb_reg_model import XGBRegModel
from Zeus.Europa.v1_0_2.my_logger import MyLogger
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Europa.v1_0_2.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Europa.v1_0_2.hyper_param_space import model_params
