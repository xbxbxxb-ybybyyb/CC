...
filter_factor_path = os.path.join(group_path, 'sunss/for_xly/europa/20221020/regression_select/')
filter_factor_fpath = os.path.join(filter_factor_path, 'regression_select_result_20160101_20181231.xlsx')
