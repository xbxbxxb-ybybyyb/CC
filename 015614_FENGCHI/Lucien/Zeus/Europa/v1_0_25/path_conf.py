...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'sunss/for_xly/europa/20221116/')
xgb_imptc_fpath = os.path.join(xgb_imptc_path, 'regression_select_result_20160101_20210331.xlsx')
