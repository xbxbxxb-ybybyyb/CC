...
import pandas as pd
import numpy as np
from Zeus.Europa.v1_0_25.path_conf import *
from Zeus.Europa.v1_0_25.hyper_param_space import hyper_lr_reg_params
from model_eval.bak.bak20230105_simple_bt.v3_6_SimpleEvalLaunch import EvalLaunch
from sklearn.linear_model import LinearRegression
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_25.my_logger import MyLogger
import warnings
import os
...
# param_test = {'factor_num': 290.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.00177}
param_test = {'factor_num': 290.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.005433}
param_fit = {'factor_num': 290.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.003948}
