...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_30/LgbRegModel/',
    #           log_fname='Europa_v1_0_30_LgbRegModel_v3.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_30/XgbRegModel/',
    #           log_fname='Europa_v1_0_30_XgbRegModel_v3.log',
    #           note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_30/LrRegModel/',
              log_fname='Europa_v1_0_30_LrRegModel_v2.log',
              note='test')