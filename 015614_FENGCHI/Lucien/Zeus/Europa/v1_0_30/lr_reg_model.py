...
from Zeus.Europa.v1_0_30.hyper_param_space import hyper_lr_reg_params
...
# param_test = {'factor_num': 2020.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': -0.000409815732371883}
# param_fit = {'factor_num': 2020.0, 'fit_intercept': True, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.00351361462698723}

# param_test = {'factor_num': 2020.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.0003066652165496953}
# param_fit ={'factor_num': 2020.0, 'fit_intercept': True, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.00321035600580516}

param_test = {'factor_num': 2020.0, 'fit_intercept': False, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.00132874592676652}
param_fit = {'factor_num': 2020.0, 'fit_intercept': True, 'n_jobs': 10, 'normalize': True, 'score_threshold': 0.00732690996647987}
...
class LrRegModel:
    ...
    def get_train_and_test_data(self):
        ...
        filtered_factor = self.filter_factor(xgb_imptc_fpath=eval(f'fsrs_imptc_{PERIOD}_fpath'))
...
if hyper_search_mode:
    ...
    # pred_result = inst_fit.start_train(param=param_fit)
    # import json
    # inst_fit.model.booster_.save_model(junk_path + 'period4_LrRegModel.pkl')
