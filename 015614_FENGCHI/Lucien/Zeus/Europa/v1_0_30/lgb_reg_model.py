...
import pandas as pd
import numpy as np
from Zeus.Europa.v1_0_30.path_conf import *
from Zeus.Europa.v1_0_30.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite import BTLite
from lightgbm import LGBMRegressor
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v1_0_30.my_logger import MyLogger
import warnings
import os
import time
np.random.seed(2023)
...
# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.7, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_samples': 8.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 32.0, 'random_state': 2022, 'reg_alpha': 0.8, 'reg_lambda': 0.1, 'score_threshold': -0.00146846554996796, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 4.0, 'min_child_samples': 14.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'num_leaves': 4.0, 'random_state': 2022, 'reg_alpha': 0.2, 'reg_lambda': 0.7, 'score_threshold': 0.000555531243458643, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}

# param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2030.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 6.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'num_leaves': 4.0, 'random_state': 2022, 'reg_alpha': 0.3, 'reg_lambda': 0.7, 'score_threshold': -0.000852715550882962, 'silent': True, 'subsample': 1.0, 'subsample_freq': 0}
# param_fit = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.9, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 9.0, 'min_child_samples': 20.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 900.0, 'n_jobs': -1, 'num_leaves': 4.0, 'random_state': 2022, 'reg_alpha': 0.2, 'reg_lambda': 0.2, 'score_threshold': 0.000941584634753338, 'silent': True, 'subsample': 0.6, 'subsample_freq': 0}

param_test = {'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.6, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 10.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 800.0, 'n_jobs': -1, 'num_leaves': 28.0, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.1, 'score_threshold': -0.000255230426869592, 'silent': True, 'subsample': 0.9, 'subsample_freq': 0}
param_fit ={'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 1.0, 'device': 'gpu', 'factor_num': 2020.0, 'gpu_device_id': 0, 'gpu_platform_id': 1, 'learning_rate': 0.005, 'max_depth': 6.0, 'min_child_samples': 4.0, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1500.0, 'n_jobs': -1, 'num_leaves': 16.0, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.4, 'score_threshold': 0.00406679195853701, 'silent': True, 'subsample': 0.8, 'subsample_freq': 0}
