...
from Zeus.Europa.v1_0_30.hyper_param_space import hyper_xgb_reg_params
...
# param_test = {'booster': 'gbtree', 'colsample_bytree': 0.7, 'factor_num': 2030.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 9.0, 'min_child_weight': 4.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.2, 'reg_lambda': 0.6, 'scale_pos_weight': 1.0, 'score_threshold': -0.00150817632675171, 'silent': True, 'subsample': 0.5, 'tree_method': 'gpu_hist'}
# param_fit = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 2030.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_weight': 4.0, 'n_estimators': 1400.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.1, 'reg_lambda': 0.8, 'scale_pos_weight': 1.0, 'score_threshold': 0.00221350789070129, 'silent': True, 'subsample': 0.5, 'tree_method': 'gpu_hist'}

# param_test ={'booster': 'gbtree', 'colsample_bytree': 1.0, 'factor_num': 2030.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 8.0, 'min_child_weight': 4.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.7, 'reg_lambda': 0.3, 'scale_pos_weight': 1.0, 'score_threshold': 0.00542715191841125, 'silent': True, 'subsample': 0.8, 'tree_method': 'gpu_hist'}
# param_fit = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 2020.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 5.0, 'min_child_weight': 5.0, 'n_estimators': 800.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 1.0, 'reg_lambda': 0.0, 'scale_pos_weight': 1.0, 'score_threshold': 0.010577380657196, 'silent': True, 'subsample': 0.5, 'tree_method': 'gpu_hist'}

param_test = {'booster': 'gbtree', 'colsample_bytree': 0.8, 'factor_num': 2020.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 7.0, 'min_child_weight': 1.0, 'n_estimators': 1200.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.6, 'reg_lambda': 0.5, 'scale_pos_weight': 1.0, 'score_threshold': 0.00470417737960815, 'silent': True, 'subsample': 0.8, 'tree_method': 'gpu_hist'}
param_fit = {'booster': 'gbtree', 'colsample_bytree': 0.5, 'factor_num': 2030.0, 'gamma': 0, 'learning_rate': 0.005, 'max_depth': 9.0, 'min_child_weight': 3.0, 'n_estimators': 1100.0, 'n_jobs': -1, 'random_state': 2022, 'reg_alpha': 0.5, 'reg_lambda': 0.1, 'scale_pos_weight': 1.0, 'score_threshold': 0.00528004765510559, 'silent': True, 'subsample': 1.0, 'tree_method': 'gpu_hist'}
...
if hyper_search_mode:
    ...
    # pred_result = inst_fit.start_train(param=param_fit)
    # import json
    # inst_fit.model.booster_.save_model(junk_path + 'period4_XgbRegModel.pkl')
