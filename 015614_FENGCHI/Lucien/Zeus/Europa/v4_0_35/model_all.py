...
from Zeus.Europa.v4_0_35.backtest.sim_backtest.SimBackTest import SimBackTest

import pandas as pd
import numpy as np
from tqdm import tqdm
from joblib import Parallel, delayed
from Zeus.Europa.v4_0_35.path_conf import *
from Zeus.Europa.v4_0_35.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.Europa.v4_0_35.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v4_0_35.my_logger import MyLogger
import warnings
import random
import os
...
if len(sys.argv) > 1:
    ...
    hyper_search_mode = eval(sys.argv[6])
...
class MyModelTrain:
    ...
    def get_dataset(self, path):
        ...
        # 更改label
        my_prof_T2 = pd.read_hdf('/data/group/800463/sunss/profit/europa/20240401/LabelProfit_zt_nexttwap_0.15_2000_300_SH250_SZ20.h5')
        data_df_raw = X.join(my_prof_T2['pct'], how='left')
        data_df_raw['pct'][data_df_raw['pct'].isna()] = data_df_raw['label_pct_graded'][data_df_raw['pct'].isna()]
        data_df_raw['label_pct_graded'] = (data_df_raw['label_pct_graded'] + data_df_raw['pct']) / 2  ###  newT12_1
        # y = pd.read_hdf(pr7ofit_data_fpath)
        y = data_df_raw[[self.label]]
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Europa/v4_0_35/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
...
def tuning_params(hyper_params_list, in_time=True, multi=True):
    def wrapper(params):
        for param in tqdm(params):
            ...
            # }
                watch_scores = stats_df[['收益风险比', '收益夏普比率', '平均收益风险比', '平均收益夏普比率', '累计扣费总收益', '最大回撤', '预测值与标签RankIC', '基础样本数量', '扣费后收益率胜率']].to_dict()
