...
model_name_list = ['fsv8_scaler1_pct_AllLgbRegModel']


dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_57/'   #  label
# dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_54/'   # base
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20240524/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
