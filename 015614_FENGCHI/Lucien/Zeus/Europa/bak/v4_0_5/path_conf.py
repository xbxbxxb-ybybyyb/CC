...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_5/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_5/rffs2_%s.pkl' % period.replace('_roll', '')",
}
...
date_config = {
    ...
    'period2_roll': dict(train_start_date=20160101, train_end_date=20191130, valid_start_date=20191201, valid_end_date=20200531,
                    test_start_date=20200601, test_end_date=20201130, fit_start_date=20201101, fit_end_date=20201130),
