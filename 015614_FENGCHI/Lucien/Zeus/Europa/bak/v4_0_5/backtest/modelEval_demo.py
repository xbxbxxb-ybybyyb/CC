...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v4_0_5.backtest.modelEval_Tool import *
from Zeus.Europa.v4_0_5.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Europa.v4_0_5.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v4_0_5/{x}/model/period1/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names[:5]] +\
                        [f'/data/user/015614/Zeus/pred/Europa/v4_0_5/{x}/model/period1/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names[5:10]]
