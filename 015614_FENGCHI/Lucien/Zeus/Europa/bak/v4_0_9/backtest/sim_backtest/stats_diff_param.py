...
import json
import pandas as pd
from Zeus.Europa.v4_0_9.strat_conf import strategy_version
...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        ...
        for search_time in hyper_list:
            ...
            if 'Xgb' in model_name:
                watch_params = ['eta', 'num_boost_round', 'max_depth', 'seed']
            if 'Lgb' in model_name:
                watch_params = ['learning_rate', 'n_estimators', 'max_depth', 'seed']
    ...
    output_dict2['Xgb'] = pd.concat(xgb_res_list, axis=0)
    output_dict2['Lgb'] = pd.concat(lgb_res_list, axis=0)
