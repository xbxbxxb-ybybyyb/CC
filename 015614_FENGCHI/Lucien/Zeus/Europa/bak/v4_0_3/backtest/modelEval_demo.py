...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v4_0_3.backtest.modelEval_Tool import *
...
if __name__ == "__main__":
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v4_0_3/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names[:6]] +\
                        [f'/data/user/015614/Zeus/pred/Europa/v4_0_2/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names[6:12]] +\
                        [f'/data/user/015614/Zeus/pred/Europa/v4_0_2/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names[12:]]
