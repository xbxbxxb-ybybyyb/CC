...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v4_0_3.backtest4concept.modelEval_Tool import *
from Zeus.Europa.v4_0_3.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Europa.v4_0_3.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    # sel_model_names = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'fsv11_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel', 'rffs2_pct_AllXgbRegModel',
    #                    'fsv8_pct_AllLgbRegModel', 'fsv10_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel', 'fsrs_pct_AllLgbRegModel', 'rffs_pct_AllLgbRegModel', 'rffs2_pct_AllLgbRegModel',
    #                    'fsv8_pct_XgbRegModel', 'fsv10_pct_XgbRegModel', 'fsv11_pct_XgbRegModel', 'fsrs_pct_XgbRegModel', 'rffs_pct_XgbRegModel', 'rffs2_pct_XgbRegModel',
    #                    'fsv8_pct_LgbRegModel', 'fsv10_pct_LgbRegModel', 'fsv11_pct_LgbRegModel', 'fsrs_pct_LgbRegModel', 'rffs_pct_LgbRegModel', 'rffs2_pct_LgbRegModel',
    #                    'fsv8_pct_XgbRegModelCross', 'fsv10_pct_XgbRegModelCross', 'fsv11_pct_XgbRegModelCross', 'fsrs_pct_XgbRegModelCross', 'rffs_pct_XgbRegModelCross', 'rffs2_pct_XgbRegModelCross',
    #                    'fsv8_pct_LgbRegModelCross', 'fsv10_pct_LgbRegModelCross', 'fsv11_pct_LgbRegModelCross', 'fsrs_pct_LgbRegModelCross', 'rffs_pct_LgbRegModelCross', 'rffs2_pct_LgbRegModelCross',
    #                    ]

    # sel_model_names = ['rawModel', 'method1Model', 'method2Model', 'method3Model']
    # sel_model_names = ['rawModel', 'method3Model', 'method4Model']
    sel_model_names = ['rawModel', 'allMethod1Model', 'allMethod2Model', 'top1Method1Model', 'top1Method2Model', 'top2Method1Model', 'top2Method2Model',
                       'top3Method1Model', 'top3Method2Model']
    ...
    # valid_path_list = [
    #     f'/data/user/015614/Zeus/pred/Europa/v4_0_3/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
    #     #                f'/data/user/015614/Zeus/pred/Europa/v4_0_3_method1/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
    #     #                f'/data/user/015614/Zeus/pred/Europa/v4_0_3_method2/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
    #                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_method3/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
    #                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_method4/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
    #                    ]
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v4_0_3/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_all_method1/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_all_method2/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top1_method1/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                    f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top1_method2/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                       f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top2_method1/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                       f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top2_method2/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                       f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top3_method1/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                       f'/data/user/015614/Zeus/pred/Europa/v4_0_3_top3_method2/fsv10_pct_AllXgbRegModel/{out_begin}~{out_end}.csv',
                       ]
