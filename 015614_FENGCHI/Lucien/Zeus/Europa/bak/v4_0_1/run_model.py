...
def wrapper(param_list):
    for param in param_list:
        ...
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_1/model.py {argv_list}')
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_1/model_all.py {argv_list}')
