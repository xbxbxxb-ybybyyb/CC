...
dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_4/'
dest_path = '/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20231101/区间1/'    # TODO：根据period修改这里的值
    ...
    for model_name in model_name_list:
        for roll_type in ['', 'roll_']:
            ...
            if seed == 0:
                ...
                #
                # # 复制pred文件
                # pred_fpath = dept_path + f'{model_name}/model/{period}/seed_{seed}/20191201~20200531.csv'
                # shutil.copy(pred_fpath, dest_path + f'{new_model_name}/20191201~20200531_{roll_type.replace("_", "")}.csv')
