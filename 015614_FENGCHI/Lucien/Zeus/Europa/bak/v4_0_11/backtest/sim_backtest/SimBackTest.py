...
import pandas as pd
import numpy as np
from Zeus.Europa.v4_0_11.strat_conf import strategy_name, strategy_version
from Zeus.Europa.v4_0_11.path_conf import profit_data_fpath, bt_out_path, date_config
import math
import time
import os
...
if __name__ == '__main__':
    sbt = SimBackTest(pred_fpath_list=['/data/user/015614/Zeus/pred/Europa/v4_0_11/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20201201~20210531.csv'],
                      fit_fpath_list=['/data/user/015614/Zeus/pred/Europa/v4_0_11/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20210501~20210531.csv'],
