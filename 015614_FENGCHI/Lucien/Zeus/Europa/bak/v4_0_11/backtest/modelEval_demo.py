...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v4_0_11.backtest.modelEval_Tool import *
from Zeus.Europa.v4_0_11.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Europa.v4_0_11.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    sel_model_names = ['rffs_pct_AllXgbRegModel', 'fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsrs_pct_AllLgbRegModel', 'fsv11_pct_AllLgbRegModel',
                       'rffs_pct_AllEmoXgbRegModel', 'fsv8_pct_AllEmoXgbRegModel', 'fsrs_pct_AllEmoXgbRegModel', 'fsrs_pct_AllEmoLgbRegModel', 'fsv11_pct_AllEmoLgbRegModel']
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v4_0_11/{x}/model/period5/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names[:5]] +\
                        [f'/data/user/015614/Zeus/pred/Europa/v4_0_12/{x}/model/period5/seed_0/{out_begin}~{out_end}.csv' for x in sel_model_names[:5]]
