...
model_name_list = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel']

dept_path = '/data/user/015614/Zeus/pred/Europa/v4_0_10/'
dest_path = '/data/user/015614/shared/for_wj/strategy_model/Europa/fac_20231102/区间2_addemo/'    # TODO：根据period修改这里的值
    ...
    for model_name in model_name_list:
        for roll_type in ['', 'roll_']:
            ...
            if seed == 0:
                ...
                # 复制pred文件
                pred_fpath = dept_path + f'{model_name}/model/{period}/seed_{seed}/20200601~20201130.csv'
                shutil.copy(pred_fpath, dest_path + f'{new_model_name}/20200601~20201130_{roll_type.replace("_", "")}.csv')
