...
import pandas as pd
import numpy as np
from Zeus.Europa.v4_0_10.strat_conf import strategy_name, strategy_version
from Zeus.Europa.v4_0_10.path_conf import profit_data_fpath, bt_out_path, date_config
import math
import time
...
class SimBackTest:
    ...
    def single_backtest(self, pred_fpath, fit_fpath):
        ...
        if self.save_flag:
            ...
            FileUtil.save_dict2xls(save_dict, bt_out_path + f'{strategy_name}/{strategy_version}/fsrs_pct_AllXgbRegModel//model/period3/seed_0/', 'bt_result.xlsx')
...
if __name__ == '__main__':
    sbt = SimBackTest(pred_fpath_list=['/data/user/015614/Zeus/pred/Europa/v4_0_10/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20201201~20210531.csv'],
                      fit_fpath_list=['/data/user/015614/Zeus/pred/Europa/v4_0_10/fsrs_pct_AllXgbRegModel/model/period3/seed_0/20210501~20210531.csv'],
