...
xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.9, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.6, 'alpha': 2.8,
                    ...
                    'subsample': 1, 'tree_method': 'gpu_hist', 'eval_metric': 'rmse'}

hyper_xgb_reg_params_list = [
    add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 1000, 'objective': 'reg:linear'}),
    add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 1000, 'objective': 'reg:linear'}),
    add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 1000, 'objective': 'reg:linear'}),
    add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 1200, 'objective': 'reg:linear'}),
]
