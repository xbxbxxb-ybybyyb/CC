...
fsrs_imptc_pct_period2_fpath = os.path.join(fsrs_imptc_path, 'fsrsv3_label_pct_graded_20160101_20200531.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_7/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_7/rffs2_%s.pkl' % period.replace('_roll', '')",
}
