    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            ...
            #     self.extreme_thres = 0.1
                ...
                self.profit_path = '/data/group/800463/sunss/profit/europa/20230920/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                ...
                self.label_path = '/data/group/800463/sunss/europa/20230821/v1/factor_df_all_20160101_20220930_graded.pkl'
