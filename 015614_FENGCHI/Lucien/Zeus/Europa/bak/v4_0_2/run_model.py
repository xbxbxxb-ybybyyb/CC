...
# period = ['period5']
# period = ['period6']
fs_version = ['fsv8', 'fsv10', 'fsv11', 'fsrs', 'rffs', 'rffs2']
# fs_version = ['fsrs']
label_flag = ['pct',]
...
def wrapper(param_list):
    for param in param_list:
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_2/model.py {argv_list}')
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Europa/v4_0_2/model_all.py {argv_list}')
