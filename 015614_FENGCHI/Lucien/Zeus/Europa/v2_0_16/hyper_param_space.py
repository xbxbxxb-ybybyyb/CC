...
hyper_xgb_reg_params = {
    ...
    'gamma': 0,
    'eta': 0.005,
    # 'max_depth': hp.quniform('max_depth', 3, 9, 1),   # 20230426模型太大进行更改
    'max_depth': hp.quniform('max_depth', 3, 8, 1),
    'min_child_weight': hp.quniform('min_child_weight', 1, 6, 1),
    # 'num_boost_round': hp.quniform('num_boost_round', 2000, 4000, 100) if not DEBUG else hp.quniform('num_boost_round', 100, 200, 10),
    'num_boost_round': hp.quniform('num_boost_round', 500, 1000, 10) if not DEBUG else hp.quniform('num_boost_round', 100, 200, 10),
    'n_jobs': -1,
    'random_state': 2022,
    'eval_metric': 'rmse',
