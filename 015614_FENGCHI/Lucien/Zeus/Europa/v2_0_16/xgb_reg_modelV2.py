...
from Zeus.Europa.v2_0_16.hyper_param_space import hyper_xgb_reg_params
...
if PERIOD[-1] is '1':
    ...
    best_threshold = -0.000807
elif PERIOD[-1] is '5':
    param = {'alpha': 0.7, 'booster': 'gbtree', 'colsample_bytree': 0.5, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.2, 'max_depth': 8.0, 'min_child_weight': 3.0, 'n_jobs': -1, 'num_boost_round': 2100.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.7, 'tree_method': 'gpu_hist'}
    best_threshold = 2.5e-05
hyper_params = hyper_xgb_reg_params

class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'XgbRffsRegModel'
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Europa/v2_0_16/rf_fs_list_{PERIOD}_165.pkl')
