...
if PERIOD[-1] is '1':
    ...
    best_threshold = -0.007517
elif PERIOD[-1] is '2':
    param ={'alpha': 0.8, 'booster': 'gbtree', 'colsample_bytree': 0.7, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.3, 'max_depth': 8.0, 'min_child_weight': 4.0, 'n_jobs': -1, 'num_boost_round': 3800.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.7, 'tree_method': 'gpu_hist'}
    best_threshold = -0.005671
elif PERIOD[-1] is '3':
    param ={'alpha': 0.6, 'booster': 'gbtree', 'colsample_bytree': 0.6, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.2, 'max_depth': 8.0, 'min_child_weight': 6.0, 'n_jobs': -1, 'num_boost_round': 3200.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}
    best_threshold = -0.003022
elif PERIOD[-1] is '4':
    param = {'alpha': 0.7, 'booster': 'gbtree', 'colsample_bytree': 0.8, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.2, 'max_depth': 8.0, 'min_child_weight': 5.0, 'n_jobs': -1, 'num_boost_round': 3400.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.8, 'tree_method': 'gpu_hist'}
    best_threshold = 0.000208
elif PERIOD[-1] is '5':
    # param = {'alpha': 0.1, 'booster': 'gbtree', 'colsample_bytree': 0.6, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.9, 'max_depth': 9.0, 'min_child_weight': 4.0, 'n_jobs': -1, 'num_boost_round': 3500.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}
    param = {'alpha': 0.1, 'booster': 'gbtree', 'colsample_bytree': 0.6, 'eta': 0.005, 'eval_metric': 'rmse', 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.9, 'max_depth': 9.0, 'min_child_weight': 4.0, 'n_jobs': -1, 'num_boost_round': 900.0, 'objective': 'reg:linear', 'random_state': 2022, 'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}
    best_threshold = -4.8e-05
hyper_params = hyper_xgb_reg_params

class XgbRegModel:
    def __init__(self, sub_version='v1'):
        self.model_name = 'XgbFSV8RegModelV2'
