...
valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/{pro[0]}/{pro[1]}_{pro[2]}_{pro[3]}/model/{period}/seed_0/{out_begin}~{out_end}.csv' for pro in product_list]
