...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_7/xgb_reg_model/',
    #           log_fname='2022-11-05 20：09：05_Europa_v1_0_7_xgb_reg_model.log',
    #           note='fit')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_7/lgb_reg_model/',
              log_fname='2022-11-05 20：08：22_Europa_v1_0_7_lgb_reg_model.log',
              note='fit')