...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_31/LgbRegModel/',
    #           log_fname='Europa_v1_0_31_LgbRegModel_v5.log',
    #           note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_31/XgbRegModel/',
              log_fname='Europa_v1_0_31_XgbRegModel_v5.log',
              note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_31/LrRegModel/',
    #           log_fname='Europa_v1_0_31_LrRegModel_v5.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_31/CatRegModel/',
    #           log_fname='Europa_v1_0_31_CatRegModel_v3.log',
    #           note='test')
    # hml分场景 hml_factor
    # for ver in [10, 11, 12, 20, 21, 22, 30, 31, 32]:
    # for ver in [50, 51, 52]:
    #     log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_31/XgbRegModel/',
    #               log_fname=f'Europa_v1_0_31_XgbRegModel_v{ver}.log',
    #               note='test')