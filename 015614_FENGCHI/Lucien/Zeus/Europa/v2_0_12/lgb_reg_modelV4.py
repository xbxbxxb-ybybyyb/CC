...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        ...
        self.get_dataset(data_test_fpath_with_label931)
    ...
    def get_train_and_test_data(self):
        ...
        filtered_factor = self.filter_factor(xgb_imptc_fpath=eval(f'xgb_imptc_o2ul_{PERIOD}_fpath11'))
