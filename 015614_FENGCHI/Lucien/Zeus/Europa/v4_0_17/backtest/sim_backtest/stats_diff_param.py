...
import json
import pandas as pd
from Zeus.Europa.v4_0_17.strat_conf import strategy_version
from Zeus.Europa.v4_0_17.path_conf import *
from Zeus.Europa.v4_0_17.hyper_param_space import xgb_fixed_params, lgb_fixed_params
...
xgb_watch_params = ['eta', 'num_boost_round', 'max_depth', 'colsample_bytree', 'gamma', 'alpha', 'lambda', 'seed']
