...
xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.6, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.6, 'alpha': 2.8,
...
mlp_reg_fixed_params = {}

hyper_mlp_reg_params_list = [
    add(mlp_reg_fixed_params, {'learning_rate': 0.02, 'max_depth': 5, 'n_estimators': 800}),
    add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 800}),
    add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 1000}),
    add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 1100}),
]

fixed_mlp_reg_param = {
    'fsv8': add(mlp_reg_fixed_params, {'learning_rate': 0.02, 'max_depth': 5, 'n_estimators': 800}),
    'fsv10': add(mlp_reg_fixed_params, {'learning_rate': 0.02, 'max_depth': 5, 'n_estimators': 800}),
    'fsv11': add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 1100}),
    'fsrs': add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 1100}),
    'rffs': add(mlp_reg_fixed_params, {'learning_rate': 0.015, 'max_depth': 5, 'n_estimators': 1100}),
}