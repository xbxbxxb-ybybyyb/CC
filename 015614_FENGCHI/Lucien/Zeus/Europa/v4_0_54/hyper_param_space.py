...
fixed_xgb_reg_param = {
    ...
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 4, 'num_boost_round': 1200, 'seed': 2001}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 8, 'num_boost_round': 800, 'min_child_weight': 7, 'seed': 2003}),
...
fixed_lgb_reg_param = {
    'fsv8': add(lgb_fixed_params, {'learning_rate': 0.04, 'max_depth': 3, 'n_estimators': 800}),
