...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/europa/20240527/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/Europa/fac_20240527/base/')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/europa/20240527/fsrs/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/europa/20240527/')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_54/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_54/rffs2_%s.pkl' % period.replace('_roll', '')",
}
