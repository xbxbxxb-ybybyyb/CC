...
from Zeus.Europa.v4_0_19.backtest.sim_backtest.SimBackTest import SimBackTest

import pandas as pd
import numpy as np
from tqdm import tqdm
from joblib import Parallel, delayed
from Zeus.Europa.v4_0_19.path_conf import *
from Zeus.Europa.v4_0_19.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.Europa.v4_0_19.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Europa.v4_0_19.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        dtest = self.wrap_test_data(X_test_scaled)
        y_test_pred = self.predict(dtest)
        if seed == seed and not period.endswith('roll'):
            self.best_threshold = np.percentile(y_test_pred, 100 - self.attend_ratio)
        else:
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Europa/v4_0_19/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
