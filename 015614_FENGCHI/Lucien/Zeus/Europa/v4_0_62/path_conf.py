...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/europa/20240531_label/')
data_all_fpath = os.path.join(data_path, f'factor_df_all_20160101_20231130.pkl')

profit_data_fpath = f'/data/group/800463/sunss/profit/europa/20240401/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/Europa/fac_20240531_label/base/')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/europa/20240531_label/fsrs/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/europa/20240531_label/')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_62/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Europa/v4_0_62/rffs2_%s.pkl' % period.replace('_roll', '')",
}
