...
from Zeus.Europa.v1_0_11.hyper_param_space import hyper_lgb_reg_params, multi_lgb_reg_params
from Zeus.Europa.v1_0_11.models.lgb_reg_model import LGBRegModel
...
search_time = 0
fit_fname = f'20190102~20200630_{hump_model_name}_v1.csv'
# fit_fname = f'20190102~20200630_{hump_model_name}_v2.csv'   # # 不滚动训练的结果
