...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_11/xgb_reg_model/',
              log_fname='2022-11-18 10：29：34_Europa_v1_0_11_xgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_11/lgb_reg_model/',
              log_fname='2022-11-18 10：29：27_Europa_v1_0_11_lgb_reg_model.log',
              note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_11/lr_reg_model/',
              log_fname='2022-11-18 10：30：36_Europa_v1_0_11_lr_reg_model.log',
              note='test')