...
fixed_xgb_reg_param = {
    ...
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 4, 'num_boost_round': 600}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 350, 'min_child_weight': 7}),
