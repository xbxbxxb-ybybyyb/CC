...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20230309-FSV9-all/')
xgb_imptc_path_20210630new = os.path.join(group_path, 'xiely/factor_select/Europa_20221024/20210630_new/')
xgb_imptc_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20230303_FSV9_all_label_pct_graded_lowCost_dropic.xlsx')
xgb_imptc_period3_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200930_reg15_second_fac_20230303_FSV9_all_label_pct_graded_lowCost_dropic.xlsx')
xgb_imptc_period2_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20200331_reg15_second_fac_20230303_FSV9_all_label_pct_graded_lowCost_dropic.xlsx')
