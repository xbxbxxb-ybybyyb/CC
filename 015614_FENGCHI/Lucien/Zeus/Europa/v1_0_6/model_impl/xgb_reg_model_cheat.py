...
from Zeus.Europa.v1_0_6.Tool import multiprocess
from Zeus.Europa.v1_0_6.hyper_param_space import hyper_xgb_reg_params, multi_xgb_reg_params
from Zeus.Europa.v1_0_6.hyper_param_space import model_params
from Zeus.Europa.v1_0_6.models.xgb_reg_model import XGBRegModel
from Zeus.Europa.v1_0_6.my_logger import MyLogger
from Zeus.Europa.v1_0_6.path_conf import *
...
test_hyper_param_fpath = '2022-11-03 19：10：34_Europa_v1_0_6_xgb_reg_modeltest.xlsx'
...
verbose = False
search_time = 0
test_fname = f'20200401~20201231_{hump_model_name}_v1.csv'    # 保存在对应的版本路径下
