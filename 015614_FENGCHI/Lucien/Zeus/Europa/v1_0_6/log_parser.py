...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_6/xgb_reg_model/',
    #           log_fname='2022-11-05 20：10：07_Europa_v1_0_6_xgb_reg_model.log',
    #           note='fit')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v1_0_6/lgb_reg_model/',
              log_fname='2022-11-05 20：10：10_Europa_v1_0_6_lgb_reg_model.log',
              note='fit')