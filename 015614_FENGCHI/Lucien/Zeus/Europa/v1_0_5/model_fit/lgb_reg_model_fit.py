...
from Zeus.Europa.v1_0_5.Tool import multiprocess
from Zeus.Europa.v1_0_5.hyper_param_space import hyper_lgb_reg_params, multi_lgb_reg_params
from Zeus.Europa.v1_0_5.models.lgb_reg_model import LGBRegModel
from Zeus.Europa.v1_0_5.my_logger import MyLogger
from Zeus.Europa.v1_0_5.path_conf import *
...
if __name__ == '__main__':
    if hyper_search_mode:
        ...
        from Zeus.Europa.v1_0_5.hyper_param_space import model_params_fit

        param = model_params_fit[model_name]
        if not param:
            from Zeus.Europa.v1_0_5.hyper_param_space import model_params
