...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModel/',
    #           log_fname='Europa_v2_0_4_LgbRegModel_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModel/',
    #           log_fname='Europa_v2_0_4_LgbRegModel_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModel/',
    #           log_fname='Europa_v2_0_4_LgbRegModel_v3.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_4_LgbRegModelV2_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_4_LgbRegModelV2_v2.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV2/',
    #           log_fname='Europa_v2_0_4_LgbRegModelV2_v3.log',
    #           note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV3/',
              log_fname='Europa_v2_0_4_LgbRegModelV3_v1.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV3/',
              log_fname='Europa_v2_0_4_LgbRegModelV3_v2.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/Europa/v2_0_4/LgbRegModelV3/',
              log_fname='Europa_v2_0_4_LgbRegModelV3_v3.log',
              note='')