...
data_all_fpath = os.path.join(data_path, f'factor_df_all_20160101_20210531_with_metis.pkl')
...
# xgb_imptc_pct_fsv11_period5_fpath = os.path.join(xgb_imptc_path, f'sinope_xgb_importance_20211130_first_FSV11_label_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period6_fpath = os.path.join(xgb_imptc_path, f'sinope_xgb_importance_20220531_first_FSV11_label_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period7_fpath = os.path.join(xgb_imptc_path, f'sinope_xgb_importance_20221130_first_FSV11_label_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period8_fpath = os.path.join(xgb_imptc_path, f'sinope_xgb_importance_20230531_first_FSV11_label_pct_graded.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_10/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_10/rffs2_%s.pkl' % period.replace('_roll', '')",
}
