...
for model_name in model_name_list:
    ...
    for csv_fpath in csv_fpath_list:
        if not csv_fpath.endswith('csv'):
            continue
        csv_df = pd.read_csv(f'/data/user/015614/Zeus/pred/Europa/v1_0_1/{model_name}/' + csv_fpath, index_col=0)
        ...
        new_csv_df.to_csv(f'/data/user/015614/Zeus/pred/Europa/v1_0_1_scene/{model_name}/' + csv_fpath)
