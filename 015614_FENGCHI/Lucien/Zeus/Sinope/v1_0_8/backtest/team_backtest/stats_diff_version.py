...
root_path = '/data/user/015614/Zeus/backtest/Sinope/v1_0_8/回测结果/'
...
bt_res_fpath_list = [period2_test]
bt_res_name_list = ['period2_test']
...
filtered_model_list = os.listdir(f'/data/user/015614/Zeus/pred/Sinope/v1_0_8/')
