...
data_all_fpath = os.path.join(data_path, f'factor_df_all_20160101_20200531_with_metis.pkl')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_4/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_4/rffs2_%s.pkl' % period.replace('_roll', '')",
}
