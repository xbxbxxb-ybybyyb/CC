...
class modelEval_Tool:
    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/Sinope_v3/sell/sell12_profitdata_foreur_SH300_SZ30.pkl'#'/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 10
                self.attend_max = 26
                self.group_ratio = 0.2
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/Sinope_v3/sell/sell23_profitdata_foreur_SH300_SZ30.pkl'
                self.cost_pct = 0
                self.attend_min = 10
                self.attend_max = 41
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy.find( 'EuropaSell')>=0:
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/Europa_v3/sell/jupiterZ/%s_with_Europa_profitdata_foreur_SH300_SZ30.pkl'%buy_strategy
                self.cost_pct = 0.001
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                ...
                from Zeus.Europa.v1_0_18.path_conf import profit_data_fpath
                ...
                from Zeus.Sinope.v1_0_18.path_conf import profit_data_fpath
                self.profit_path = profit_data_fpath
                self.cost_pct = 0.002
                self.attend_min = 20
                self.attend_max = 51
            ...
            if self.profit_path.endswith('.h5'):
                ...
                if len(profit_data.index.levels) == 3:
                    ...
                    profit_data['Ticker'] = profit_data['Ticker'] + profit_data['trigger_time'].astype(np.int).astype(str)
                    profit_data = profit_data.set_index(['dt', 'Ticker'])
                if self.strategy.find('EuropaSell') >= 0:
                    period_num = self.strategy.split('_')[-1]
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                ...
                from Zeus.Europa.v1_0_18.path_conf import data_all_fpath
                ...
                from Zeus.Sinope.v1_0_18.path_conf import data_all_fpath
                self.label_path = data_all_fpath
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            # elif self.strategy =='Europa':
            ...
            if 'label_T_close_is_zt' not in label_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Europa','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa', 'Sinope'] or self.strategy.find( 'EuropaSell')>=0):
                label_data['label_T_close_is_zt'] = label_data['label_T_is_zt']
            if 'label_Next_close_is_zt' not in label_data.columns.tolist()  and (self.strategy in ['JupiterN','Europa','Europa','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa', 'Sinope'] or self.strategy.find( 'EuropaSell')>=0):
    ...
    def generate_test_report(self,pred_out, pred_in,scene_flag,probacol):
        ...
        if self.strategy not in ['JupiterN', 'jupiter_sell','Europa','Sinope','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa'] and self.strategy.find( 'EuropaSell')<0:
    ...
    def combine_res_inout(self,pred_sample_data,sample_data,statistic_without_extreme_value,statistic_by_sample,statistic_by_day,pred_in,flag_scene,proba_col):
        ...
        if 'label_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Europa','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa'] or self.strategy.find('EuropaSell')>=0):
        ...
        if 'label_pat_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','Europa','Europa','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa']  or self.strategy.find('EuropaSell')>=0):
        ...
        if self.strategy in ['JupiterN','Europa','Sinope','jupiter003','JupiterNSell','JupiterNSell34','Europa','EuropaSell','EuropaSellEnhance', 'Europa'] or self.strategy.find('EuropaSell')>=0:
