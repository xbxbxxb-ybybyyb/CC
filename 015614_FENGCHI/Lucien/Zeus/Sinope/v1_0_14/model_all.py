...
from Zeus.Sinope.v1_0_14.backtest.sim_backtest.SimBackTest import SimBackTest

import pandas as pd
import numpy as np
from tqdm import tqdm
from joblib import Parallel, delayed
from Zeus.Sinope.v1_0_14.path_conf import *
from Zeus.Sinope.v1_0_14.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.Sinope.v1_0_14.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Sinope.v1_0_14.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    ...
    def get_train_and_test_data(self):
        ...
        if add32_flag:
            add_fea = pd.read_csv('/data/group/800463/xubc/extract_feature/sinope/fac_20240714/sinope_fea0731_4.csv')
            add_fea['dt'] = add_fea['dt'].apply(lambda x: pd.to_datetime(x))
            add_fea = add_fea.drop(['date', 'last_date', 'amt'], axis=1).set_index(['dt', 'Ticker'])
            X_copy = X_copy.join(add_fea, how='left')
            self.factor_list = self.factor_list + [x for x in range(0, 32)]
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Sinope/v1_0_14/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
