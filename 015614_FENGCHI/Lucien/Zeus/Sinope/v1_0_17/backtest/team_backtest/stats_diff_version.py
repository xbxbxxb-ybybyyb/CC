...
strategy_name = 'Sinope'
version = 'v1_0_17'

root_path = '/data/user/015614/Zeus/backtest/Sinope/v1_0_17/回测结果/'

bt_date = '20240807'
# period1_test = f'20191201~20200531_Sinope_period1_all_merge_test_模型评价_{bt_date}.xlsx'
# period1_fit =  f'20200601~20210531_Sinope_period1_all_merge_fit_模型评价_{bt_date}.xlsx'
# period2_test = f'20200601~20201130_Sinope_period2_all_merge_test_模型评价_{bt_date}.xlsx'
# period2_fit =  f'20201201~20211130_Sinope_period2_all_merge_fit_模型评价_{bt_date}.xlsx'
# period3_test = f'20201201~20210531_Sinope_period3_all_merge_test_模型评价_{bt_date}.xlsx'
# period3_fit =  f'20210601~20220531_Sinope_period3_all_merge_fit_模型评价_{bt_date}.xlsx'
# period4_test = f'20210601~20211130_Sinope_period4_all_merge_test_模型评价_{bt_date}.xlsx'
# period4_fit = f'20211201~20221130_Sinope_period4_all_merge_fit_模型评价_{bt_date}.xlsx'
period5_test = f'20211201~20220531_Sinope_period5_all_merge_test_模型评价_{bt_date}.xlsx'
# period5_fit = f'20220501~20220531_Sinope_period5_all_merge_fit_模型评价_{bt_date}.xlsx'
# period6_test = f'20220601~20221130_Sinope_period6_all_merge_test_模型评价_{bt_date}.xlsx'
# period7_test = f'20221201~20230531_Sinope_period7_all_merge_test_模型评价_{bt_date}.xlsx'
bt_res_fpath_list = [period5_test]
bt_res_name_list = ['period5_test']
# filtered_model_list = ['fsv8_pct_AllXgbRegModel', 'fsrs_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'fsv11_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel',
...
# filtered_model_list = ['rffs_scaler1_pct_AllXgbRegModel', 'rffs_scaler1_pct_AllLgbRegModel']
filtered_model_list = os.listdir(f'/data/user/015614/Zeus/pred/Sinope/v1_0_17/')

# period5_test = f'20211001~20220331_Sinope_period5_all_merge_test_模型评价_{bt_date}.xlsx'
# bt_res_fpath_list = [period5_test]
# bt_res_name_list = ['period5_test']

# period6_test = f'20220401~20220930_Sinope_period6_all_merge_test_模型评价_{bt_date}.xlsx'
...
model_list = [
'fsv8_s1_XgbRegModel',
'fsv10_s1_XgbRegModel',
'fsv11_s1_XgbRegModel',
'fsrs_s1_XgbRegModel',
'rffs_s1_XgbRegModel',

'fsv8_s1_LgbRegModel',
'fsv10_s1_LgbRegModel',
'fsv11_s1_LgbRegModel',
'fsrs_s1_LgbRegModel',
'rffs_s1_LgbRegModel',

'fsv8_add32_s1_XgbRegModel',
'fsv10_add32_s1_XgbRegModel',
'fsv11_add32_s1_XgbRegModel',
'fsrs_add32_s1_XgbRegModel',
'rffs_add32_s1_XgbRegModel',

'fsv8_add32_s1_LgbRegModel',
'fsv10_add32_s1_LgbRegModel',
'fsv11_add32_s1_LgbRegModel',
'fsrs_add32_s1_LgbRegModel',
'rffs_add32_s1_LgbRegModel'
]

res_df = res_df.reset_index().set_index('level_1').loc[model_list].reset_index().set_index(['level_0', 'level_1'])
