...
fs_version = ['fsv8', 'fsv10', 'fsv11', 'fsrs', 'rffs',
              'fsv8_add32', 'fsv10_add32', 'fsv11_add32', 'fsrs_add32', 'rffs_add32']
# fs_version = ['rffs']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Sinope/v1_0_19/model_all.py {argv_list}')

param_list = list(product(period, fs_version, label_flag, model_select, scaler_list, hyper_search_mode, attend_ratio, seed))
param_list = list(filter(lambda x: x[1] + '_' + x[3] in ['fsv11_XgbRegModel', 'fsrs_XgbRegModel', 'rffs_XgbRegModel', 'fsv10_LgbRegModel', 'fsv11_LgbRegModel'], param_list))
