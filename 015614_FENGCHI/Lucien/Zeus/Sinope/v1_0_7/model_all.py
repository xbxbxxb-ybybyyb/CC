...
from Zeus.Sinope.v1_0_7.backtest.sim_backtest.SimBackTest import SimBackTest

import pandas as pd
import numpy as np
from tqdm import tqdm
from joblib import Parallel, delayed
from Zeus.Sinope.v1_0_7.path_conf import *
from Zeus.Sinope.v1_0_7.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.Sinope.v1_0_7.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Sinope.v1_0_7.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Sinope/v1_0_7/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
