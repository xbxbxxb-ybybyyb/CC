...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/sinope/20240703/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/sinope/fac_20240703/all/')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/sinope/20240703/fsrs/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/sinope/20240703/')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_11/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Sinope/v1_0_11/rffs2_%s.pkl' % period.replace('_roll', '')",
}
