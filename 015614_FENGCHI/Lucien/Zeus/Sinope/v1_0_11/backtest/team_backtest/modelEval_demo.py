...
hfactor = FactorData()
import pandas as pd
from Zeus.Sinope.v1_0_11.backtest.team_backtest.modelEval_Tool import *
from Zeus.Sinope.v1_0_11.path_conf import *
from Zeus.Sinope.v1_0_11.strat_conf import *
...
def deal_preddata(path, viewcol, sel_data='all'):
    ...
    # # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/Europa/v1_0_112/LgbRegModel/20210701~20211231_LgbRegModel_v4.csv', index_col=0) # period4
    # index_duiqi = pd.read_csv('/data/user/015614/Zeus/pred/Europa/v1_0_116/LgbRffsRegModel/20220401~20220930_LgbRffsRegModel_v5.csv', index_col=0)
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Sinope.v1_0_11.path_conf import date_config
    from Zeus.Sinope.v1_0_11.strat_conf import *
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    # sel_model_names = os.listdir(f'/data/user/015614/Zeus/pred/Sinope/v1_0_11_yizban/')
    sel_model_names = os.listdir(f'/data/user/015614/Zeus/pred/Sinope/v1_0_11/')
    ...
    # valid_path_list = [f'/data/user/015614/Zeus/pred/Sinope/v1_0_11_yizban/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
    valid_path_list = [f'/data/user/015614/Zeus/pred/Sinope/v1_0_11/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
