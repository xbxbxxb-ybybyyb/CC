...
root_path = '/data/user/015614/Zeus/backtest/Sinope/v1_0_11/回测结果/'
...
bt_res_fpath_list = [period3_test]
bt_res_name_list = ['period3_test']
...
filtered_model_list = os.listdir(f'/data/user/015614/Zeus/pred/Sinope/v1_0_11/')
