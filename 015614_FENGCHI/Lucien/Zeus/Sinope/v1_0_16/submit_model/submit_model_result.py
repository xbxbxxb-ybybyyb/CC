...
model_name_list = ['fsv11_s1_XgbRegModel',
...
dept_path = '/data/user/015614/Zeus/pred/Sinope/v1_0_16/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Sinope/fac_20240714/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
