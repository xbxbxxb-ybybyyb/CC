...
product_list = [ ('v1_0_78', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_78', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_78', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_78', 'config2', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_7', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_7', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_7', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_7', 'config2', 'fsv11', 's1', 'Xgb'),
                 ]
