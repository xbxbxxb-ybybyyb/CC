...
dept_path = f'/data/user/015614/Zeus/pred/Neptune/v1_0_7/'

# 正式提交
_send_dict =[
# {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
#      'model_name': {'config1_fsv8_s1_Xgb': 'short_FSV8Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'short_FSV10Xgb',}},
    # {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
    #  'model_name': {'config2_fsv10_s1_Xgb': 'short_sw_high_FSV10Xgb',}},
    # {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
    #  'model_name': {'config3_fsv10_s1_Xgb': 'short_sw_low_FSV10Xgb', }},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv10_s1_Xgb': 'short_vol_low_FSV10Xgb', }},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250627_sa_filter_short/区间{PERIOD[-1]}/',
     'model_name': {'config5_fsv10_s1_Xgb': 'short_vol_high_FSV10Xgb', }},
]
        ...
        for config_model_name in model_name_list:
            ...
            for roll_type in ['', 'roll_']:
                ...
                if seed == 0:
                    ...
                    # 复制预处理文件列表
                    factor_saaler_fpath = dept_path + f'{config}/{model_name}/{period}/model/seed_{seed}/_factorScaler.json'
                    shutil.copy(factor_saaler_fpath, dest_path + f'{new_model_name}/Model_{roll_type}factorScaler.json')
