...
import re
import time
from Zeus.Neptune.v1_0_7.config.strat_conf import DATE_CONFIG
...
def start_backtest(pred_dir, period):
    ...
    for config in config_set:   # 不同的config可能对应不同的收益文件
        ...
        sbt = SimBackTest(pred_fpath_list=tmp_pred_fpath_list,
                          ...
                          period=period,
                          attend_ratio_range=(5, 30),
                          # attend_ratio_range=(1, 10),
                          save_flag=True,
                          multi_attend=True)
...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_7/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_7/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_7/', 'period2')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_7/', 'period7_fit')