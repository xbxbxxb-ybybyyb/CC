...
product_list = [ ('v2_0_18', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v2_0_18', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v2_0_18', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v2_0_18', 'config2', 'fsv11', 's1', 'Xgb'),
                 ('v2_0_1', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v2_0_1', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v2_0_1', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v2_0_1', 'config2', 'fsv11', 's1', 'Xgb'),
                 ]
