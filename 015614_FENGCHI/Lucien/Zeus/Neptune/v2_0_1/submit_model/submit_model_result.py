...
dept_path = f'/data/user/015614/Zeus/pred/Neptune/v2_0_1/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_a_neg/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv8_s1_Xgb': 'base_FSV8Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_a_neg/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_a_neg/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv11_s1_Xgb': 'base_FSV11Xgb', }},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_a_neg/区间{PERIOD[-1]}/',
     'model_name': {'config1_rffs_s1_Xgb': 'base_FcXgb', }},
]
