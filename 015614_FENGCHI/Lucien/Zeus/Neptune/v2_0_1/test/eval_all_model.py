...
for period in period_list:
    tmp_res = pd.read_excel(result_path + f'v2_0_1_Neptune_{period}_汇总结果.xlsx')
...
FileUtil.save_dict2xls(indicator_dict, result_path, 'Neptune从第四区间开始得分.xlsx')
from dataApi.sendInfo import send_file
send_file(result_path + 'Neptune从第四区间开始得分.xlsx')
