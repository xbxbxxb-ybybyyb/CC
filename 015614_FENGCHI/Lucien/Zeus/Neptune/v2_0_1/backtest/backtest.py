...
import re
import time
from Zeus.Neptune.v2_0_1.config.strat_conf import DATE_CONFIG
...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v2_0_1/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v2_0_1/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Neptune/v2_0_1/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v2_0_1/', 'period7_fit')