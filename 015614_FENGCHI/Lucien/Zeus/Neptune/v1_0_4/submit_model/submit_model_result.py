...
import shutil
import os
from Zeus.Neptune.v1_0_4.config.path_conf import *
...
dept_path = f'/data/user/015614/Zeus/pred/Neptune/v1_0_4/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250528_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv8_s1_Xgb': 'base_FSV8Xgb',
                    'config1_fsv11_s1_Xgb': 'base_FcXgb'}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250528_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'base_sw_low_FSV8Xgb',
                    'config2_fsv11_s1_Xgb': 'base_sw_low_FcXgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250528_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv8_s1_Xgb': 'base_sw_high_FSV8Xgb',
                    'config3_fsv11_s1_Xgb': 'base_sw_high_FcXgb'}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250528_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv8_s1_Xgb': 'base_vol_low_FSV8Xgb',
                    'config4_fsv11_s1_Xgb': 'base_vol_low_FcXgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250528_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config5_fsv8_s1_Xgb': 'base_vol_high_FSV8Xgb',
                    'config5_fsv11_s1_Xgb': 'base_vol_high_FcXgb'}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250603_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config6_fsv8_s1_Xgb': 'base_FSV8Xgb', 'config8_fsv10_s1_Xgb': 'base_FSV10Xgb',
                    'config6_fsv11_s1_Xgb': 'base_FcXgb'}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250603_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config7_fsv8_s1_Xgb': 'base_vol_low_FSV8Xgb', 'config8_fsv10_s1_Xgb': 'base_vol_low_FSV10Xgb',
                    'config7_fsv11_s1_Xgb': 'base_vol_low_FcXgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250603_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config8_fsv8_s1_Xgb': 'base_vol_high_FSV8Xgb', 'config8_fsv10_s1_Xgb': 'base_vol_high_FSV10Xgb',
                    'config8_fsv11_s1_Xgb': 'base_vol_high_FcXgb'}},
]

for idx in range(8): # send_dict中两个组合
