...
import re
import time
from Zeus.Neptune.v1_0_4.config.strat_conf import DATE_CONFIG
...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_4/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_4/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_4/', 'period4')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_4/', 'period7_fit')