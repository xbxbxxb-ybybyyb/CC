...
product_list = [ ('v1_0_68', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_68', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_68', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_68', 'config2', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_6', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_6', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_6', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_6', 'config2', 'fsv11', 's1', 'Xgb'),
                 ]
