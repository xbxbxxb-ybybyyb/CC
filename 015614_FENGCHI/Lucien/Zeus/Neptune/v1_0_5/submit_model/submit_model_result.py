...
dept_path = f'/data/user/015614/Zeus/pred/Neptune/v1_0_5/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'mid_FSV8Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv10_s1_Xgb': 'mid_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config5_fsv10_s1_Xgb': 'mid_sw_high_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config8_fsv10_s1_Xgb': 'mid_sw_low_FSV10Xgb', }},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config11_fsv10_s1_Xgb': 'mid_vol_low_FSV10Xgb', }},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250609_sc_filter_mid/区间{PERIOD[-1]}/',
     'model_name': {'config14_fsv10_s1_Xgb': 'mid_vol_high_FSV10Xgb', }},
]
