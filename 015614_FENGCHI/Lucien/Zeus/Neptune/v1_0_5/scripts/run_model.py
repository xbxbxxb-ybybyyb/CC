...
from Zeus.Neptune.v1_0_5.scripts.check_path_is_ok import check_path_is_ok
...
# fs_version = ['rffs']
fs_version = ['fsv10']
# config_flag = [f'config{x}' for x in range(1,16)]
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Neptune/v1_0_5/scripts/model_all.py {argv_list}')
