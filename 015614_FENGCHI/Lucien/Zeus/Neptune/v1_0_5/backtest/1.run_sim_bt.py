...
if __name__ == '__main__':
    ...
    config_list = ['config1', 'config2', 'config91', 'config02']
    config_list = ['config46']
    for config in config_list:
        hyper_root_path = f'/data/user/015614/Zeus/pred/Neptune/{STRATEGY_VERSION}/{config}/'
