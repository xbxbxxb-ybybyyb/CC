...
class FactorSelect:
    def __init__(self, period, config_flag):
        ...
        self.start_date, self.end_date = DATE_CONFIG[period]['train_start_date'], DATE_CONFIG[period]['train_end_date']
        self.period = period
    ...
    def kcv_factor_imptc_eval(self):
        gap_kfold = GapWalkForward(n_splits=5, max_train_size=36, test_size=0)
