...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_3/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_3/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_3/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Neptune/v1_0_3/', 'period7_fit')