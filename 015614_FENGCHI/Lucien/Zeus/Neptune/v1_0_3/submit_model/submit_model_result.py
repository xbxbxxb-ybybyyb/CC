...
import shutil
import os
from Zeus.Neptune.v1_0_3.config.path_conf import *
...
dept_path = f'/data/user/015614/Zeus/pred/Neptune/v1_0_3/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250526_filter_pos/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv8_s1_Xgb': 'base_FSV8Xgb', 'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',
                    'config1_fsv11_s1_Xgb': 'base_FcXgb'}},
    # {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250526_filter_pos/区间{PERIOD[-1]}/',
    #  'model_name': {'config2_fsv8_s1_Xgb': 'base_low_FSV8Xgb', 'config2_fsv10_s1_Xgb': 'base_low_FSV10Xgb',
    #                 'config2_fsv11_s1_Xgb': 'base_low_FcXgb',}},
    # {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Neptune/fac_20250526_filter_pos/区间{PERIOD[-1]}/',
    #  'model_name': {'config3_fsv8_s1_Xgb': 'base_high_FSV8Xgb', 'config3_fsv10_s1_Xgb': 'base_high_FSV10Xgb',
    #                 'config3_fsv11_s1_Xgb': 'base_high_FcXgb'}},
]
