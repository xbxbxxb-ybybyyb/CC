...
profit_data_fpath = f'/data/group/800463/sunss/sapphire/profit/20240720/Sell_pct7_0.15_2000_300_SH250_SZ20.h5'
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_9/rffs_%s.pkl' % period"
}
