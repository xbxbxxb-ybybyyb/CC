...
import pandas as pd
import numpy as np
from Zeus.Sapphire.v1_0_4.path_conf import *
import math
...
model_names = os.listdir('/data/user/015614/Zeus/pred/Sapphire/v1_0_4/')
...
pred_out_path = pred_out_path + 'Sapphire/v1_0_4/'
