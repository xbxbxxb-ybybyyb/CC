...
config1 = dict(
    data_fpath = '/data/group/800463/sunss/sapphire/20240828/p5/factor_df_p5_20160101_20210228.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_10/config1/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_10/config1/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config2 = dict(
    data_fpath = '/data/group/800463/sunss/sapphire/20240828/p7/factor_df_p7_20160101_20210228.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_10/config2/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_10/config2/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
