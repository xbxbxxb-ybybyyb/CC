...
import pandas as pd
import numpy as np
from Zeus.Sapphire.v1_0_1.path_conf import *
from Zeus.Sapphire.v1_0_1.hyper_param_space import hyper_xgb_reg_params
...
from Zeus.Sapphire.v1_0_1.my_logger import MyLogger
...
class XgbRegModel:
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=None):
        ...
        if fs_version == 'rffs':
            factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_1/rffs_{PERIOD}.pkl')
