...
hyper_xgb_reg_params = {
    ...
    'num_boost_round': hp.quniform('num_boost_round', 200, 1000, 100) if not DEBUG else hp.quniform('num_boost_round', 100, 200, 10),
    'n_jobs': -1,
    'random_state': 2022,
    'eval_metric': 'rmse',
...
hyper_lgb_reg_params = {
    ...
    'n_estimators': hp.quniform('n_estimators', 200, 1000, 100) if not DEBUG else hp.quniform('n_estimators', 100, 200, 10),
    'n_jobs': -1,
