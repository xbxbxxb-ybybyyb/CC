...
dept_path = f'/data/user/015614/Zeus/pred/Sapphire/v1_0_11/'   # label
# dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Sapphire7/fac_20240828/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Sapphire5/fac_20240828/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
