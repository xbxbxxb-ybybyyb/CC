...
# label_flag = ['_pct', '_pct_after']
label_flag = ['_pct_after']

def wrapper(param_list):
    for param in tqdm(param_list):
        argv_list = ' '.join(list(param))
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Sapphire/v1_0_0/lgb_reg_model_no_emotion.py {argv_list}')
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Sapphire/v1_0_0/xgb_reg_model_no_emotion.py {argv_list}')
        # os.system(f'python3 /data/user/015614/Lucien/Zeus/Sapphire/v1_0_0/xgb_reg_model_generate_groudtruth.py {argv_list}')
#
