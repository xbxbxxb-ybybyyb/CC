...
import pandas as pd
import numpy as np
from Zeus.Sapphire.v1_0_8.path_conf import *
from Zeus.Sapphire.v1_0_8.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Sapphire.v1_0_8.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    ...
    def select_factor(self):
        if fs_version in ['fsv8', 'fsv10', 'fsv11']:
            ...
            factor_list = factor_list.reset_index().query('select == 1')['factor_name'].tolist()
        else:
            try:
