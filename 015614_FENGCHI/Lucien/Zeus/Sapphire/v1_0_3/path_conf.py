...
#%% 数据集
sapphire_v = 'sapphire3'
data_path = os.path.join(group_path, f'sunss/sapphire/20230810/{sapphire_v}/')
data_fpath = os.path.join(data_path, f'factor_df_{sapphire_v}_20160101_20211231_graded.pkl')

profit_data_fpath = f'/data/group/800463/sunss/profit/sapphire/20230810/Sell_{sapphire_v}_0.15_2000_300_SH250_SZ20.h5'
...
xgb_imptc_pctAfter_fsv8_period1_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20190930_reg15_second_fac_20230810_FSV8_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv8_period2_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200331_reg15_second_fac_20230810_FSV8_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv8_period3_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200930_reg15_second_fac_20230810_FSV8_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv8_period4_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20210331_reg15_second_fac_20230810_FSV8_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv10_period1_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20190930_reg15_second_fac_20230810_FSV10_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv10_period2_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200331_reg15_second_fac_20230810_FSV10_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv10_period3_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200930_reg15_second_fac_20230810_FSV10_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv10_period4_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20210331_reg15_second_fac_20230810_FSV10_all_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv11_period1_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20190930_first_fac_20230810_FSV11_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv11_period2_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200331_first_fac_20230810_FSV11_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv11_period3_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20200930_first_fac_20230810_FSV11_label_diff_pct_after_graded.xlsx')
xgb_imptc_pctAfter_fsv11_period4_fpath = os.path.join(xgb_imptc_path, f'{sapphire_v}_xgb_importance_20210331_first_fac_20230810_FSV11_label_diff_pct_after_graded.xlsx')
...
fsrs_imptc_pctAfter_period1_fpath = os.path.join(fsrs_imptc_path, 'fsrsv2_label_diff_pct_after_graded_20160101_20190930.xlsx')
fsrs_imptc_pctAfter_period2_fpath = os.path.join(fsrs_imptc_path, 'fsrsv2_label_diff_pct_after_graded_20160101_20200331.xlsx')
fsrs_imptc_pctAfter_period3_fpath = os.path.join(fsrs_imptc_path, 'fsrsv2_label_diff_pct_after_graded_20160101_20200930.xlsx')
fsrs_imptc_pctAfter_period4_fpath = os.path.join(fsrs_imptc_path, 'fsrsv2_label_diff_pct_after_graded_20160101_20210331.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Sapphire/v1_0_3/rffs_%s.pkl' % period"
}

#%% 标签设置
label_config = {
    'pct': 'label_diff_pct_graded',
    'pctAfter': 'label_diff_pct_after_graded'
}
