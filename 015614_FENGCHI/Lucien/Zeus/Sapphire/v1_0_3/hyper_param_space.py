...
fixed_xgb_reg_param = "{'alpha': 0.6, 'booster': 'gbtree', 'colsample_bytree': 0.6, 'eta': 0.005, 'eval_metric': 'rmse', " \
                      "'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.2, 'max_depth': 8.0, 'min_child_weight': 6.0, " \
                      "'n_jobs': -1, 'num_boost_round': 1000.0, 'objective': 'reg:linear', 'random_state': 2022, " \
                      "'scale_pos_weight': 1.0, 'silent': True, 'subsample': 0.9, 'tree_method': 'gpu_hist'}"
...
fixed_lgb_reg_param = "{'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5,  'learning_rate': 0.005, 'max_depth': 6,\
    'min_child_samples': 4, 'min_child_weight': 0.001, 'min_split_gain': 0.0, 'n_estimators': 1000,\
    'n_jobs': -1, 'verbosity': -1, 'metric': {'binary_logloss', 'auc'}, 'num_leaves': 36, 'random_state': 2022,\
    'reg_alpha': 1.0, 'reg_lambda': 0.6, 'subsample': 0.9, 'subsample_freq': 0,  'device': 'gpu',\
