...
from Zeus.Sapphire.v1_0_6.strat_conf import *
...
model_name_list = ['rffs_s1_Lgb']


dept_path = '/data/user/015614/Zeus/pred/Sapphire/v1_0_6/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Sapphire/fac_20240531/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
