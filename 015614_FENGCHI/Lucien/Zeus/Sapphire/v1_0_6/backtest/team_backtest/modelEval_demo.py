...
hfactor = FactorData()
import pandas as pd
from Zeus.Europa.v1_0_6.backtest.team_backtest.modelEval_Tool import *
from Zeus.Europa.v1_0_6.path_conf import *
from Zeus.Europa.v1_0_6.strat_conf import *
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Europa.v1_0_6.path_conf import date_config
    from Zeus.Europa.v1_0_6.strat_conf import *
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    sel_model_names = os.listdir(f'/data/user/015614/Zeus/pred/Europa/v1_0_6/')
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Europa/v1_0_6/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
