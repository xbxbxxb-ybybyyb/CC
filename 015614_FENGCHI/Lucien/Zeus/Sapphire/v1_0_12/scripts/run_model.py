...
fs_version = ['fsv8', 'fsv10', 'fsv11', 'fsrs', 'fsci', 'rffs']
...
scaler_list = ['scaler1']
attend_ratio = ['32']   # config2-p7 32%    config1-p5 50%
# attend_ratio = ['50']   # config2-p7 32%    config1-p5 50%
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Sapphire/v1_0_12/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config1', 'fsv10_config1', 'rffs_config1', 'fsrs_config2', 'fsv8_config2', 'rffs_config2'], param_list))
