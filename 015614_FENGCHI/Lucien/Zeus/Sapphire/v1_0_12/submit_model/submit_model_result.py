...
# config2 fsrs fsv8 rffs
# config1 fsv10 fsv8 rffs
_model_name = {
    'fsv8_s1_Xgb': 'FSV8Xgb',
   'fsrs_s1_Xgb': 'FSRSXgb',
   'rffs_s1_Xgb': 'RffsXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Sapphire/v1_0_12/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Sapphire7/fac_20240828/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值 config2
# dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Sapphire5/fac_20240828/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值 config1
