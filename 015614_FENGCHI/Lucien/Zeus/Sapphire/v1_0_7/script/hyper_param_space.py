...
xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.6, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.3, 'alpha': 1.2,
                    ...
                    'subsample': 0.6, 'tree_method': 'gpu_hist', 'eval_metric': 'rmse', 'objective': 'reg:logistic', 'eta': 0.01, 'max_depth': 6, 'num_boost_round': 1000}
...
lgb_fixed_params = {'boosting_type': 'gbdt', 'objective': 'binary', 'class_weight': None, 'colsample_bytree': 0.6, 'min_child_samples': 4,
