...
from Zeus.Sapphire.v1_0_7.backtest.sim_backtest.SimBackTest import SimBackTest
...
from Zeus.Sapphire.v1_0_7.script.path_conf import *
from Zeus.Sapphire.v1_0_7.script.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from Zeus.Sapphire.v1_0_7.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Sapphire.v1_0_7.script.my_logger import MyLogger
import warnings
import random
import os
...
version: like v1_0_0...
strategy_name: like Sapphire, Jupiter...
"""
class MyModelTrain:
    ...
    def train_model(self, X_train, y_train, param, X_valid=None, y_valid=None, stage='no_draw'):
        # def focal_loss_lgb_sk(y_pred, dtrain, alpha=1, gamma=1):
        ...
        if self.model_select == 'XgbRegModel':
            ...
            self.model = model
        elif self.model_select == 'XgbClfModel':
            dtrain = xgb.DMatrix(X_train, y_train)
            dvalid = xgb.DMatrix(X_valid, y_valid)
            eval_result = {}
            num_boost_round = int(param.pop('num_boost_round'))
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Sapphire/v1_0_7/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
...
# btl = BTLite2(strategy_name='Sapphire',
