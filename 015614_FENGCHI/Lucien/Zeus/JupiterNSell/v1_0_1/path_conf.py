...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/jupiter_931o2ul/20230201/')
...
data_test_fpath_with_label = os.path.join(data_path, 'factor_df_all_20160101_20201231.pkl')
data_fit_fpath_with_label = os.path.join(data_path, 'factor_df_all_20160101_20201231.pkl')

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/Jupiter_931o2ul/')
xgb_imptc_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_cla15_second_fac_20221220_FSV8_all_label_TN_931o2ul_mix_lowCost.xlsx')
...
# 分场景因子
xgb_imptc_hml0_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_cla15_second_fac_20221220_FSV8_hml0_label_TN_931o2ul_mix_lowCost.xlsx')
xgb_imptc_hml1_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_cla15_second_fac_20221220_FSV8_hml1_label_TN_931o2ul_mix_lowCost.xlsx')
xgb_imptc_hml2_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_cla15_second_fac_20221220_FSV8_hml2_label_TN_931o2ul_mix_lowCost.xlsx')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, 'sunss/jupiter_931o2ul/20230201/')
# factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_all_xly.xlsx')
factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_all_20160101_20190930_xly.xlsx')
...
date_config = {
    ...
    'period5_fit': dict(train_start_date=20160101, train_end_date=20220630, valid_start_date=20220101, valid_end_date=20220630, test_start_date=20220101, test_end_date=20220630)
}