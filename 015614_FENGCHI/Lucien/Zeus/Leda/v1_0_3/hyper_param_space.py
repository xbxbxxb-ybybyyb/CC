...
xgb_fixed_params = {'booster': 'gbtree', 'colsample_bytree': 0.9, 'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.5, 'alpha': 1.5,
                    ...
                    'subsample': 0.9, 'tree_method': 'gpu_hist', 'eval_metric': 'rmse', 'objective': 'reg:linear', 'eta': 0.01, 'max_depth': 7, 'num_boost_round': 400}
...
# 实际上传的model_name
model_name_list = ['fsv8_pct_AllXgbRegModel', 'fsv10_pct_AllXgbRegModel', 'rffs_pct_AllXgbRegModel',
                   'fsv11_pct_AllLgbRegModel', 'fsrs_pct_AllLgbRegModel']

fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.01, 'max_depth': 5, 'num_boost_round': 400, 'colsample_bytree': 0.7, 'alpha': 3.2}),
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 600}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 7, 'num_boost_round': 600}),
    'fsrs': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 8, 'num_boost_round': 350, 'min_child_weight': 7}),
...
fixed_lgb_reg_param = {
    'fsv8': add(lgb_fixed_params, {'learning_rate': 0.025, 'max_depth': 3, 'n_estimators': 600}),
    'fsv10': add(lgb_fixed_params, {'learning_rate': 0.03, 'max_depth': 3, 'n_estimators': 580}),
    'fsv11': add(lgb_fixed_params, {'learning_rate': 0.035, 'max_depth': 2, 'n_estimators': 520, 'reg_lambda': 1.35, 'min_split_gain': 0.003}),
    'fsrs': add(lgb_fixed_params, {'learning_rate': 0.0325, 'max_depth': 3, 'n_estimators': 577}),
    'rffs': add(lgb_fixed_params, {'learning_rate': 0.028, 'max_depth': 3, 'n_estimators': 450}),
}
