...
class modelEval_Tool:
    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell12_profitdata_foreur_SH300_SZ30.pkl'#'/data/group/800463/project/project1_prod/LabelProfit_fixvol/LabelProfit_zt_pct_931_0.10_800_190_SH450_SZ100.h5'
                self.cost_pct = 0
                self.attend_min = 10
                self.attend_max = 26
                self.group_ratio = 0.2
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell23_profitdata_foreur_SH300_SZ30.pkl'
                self.cost_pct = 0
                self.attend_min = 10
                self.attend_max = 41
                self.group_ratio = 0.2
                ...
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/jupiterZ/%s_with_JupiterZ_profitdata_foreur_SH300_SZ30.pkl'%buy_strategy
                self.cost_pct = 0.001
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                ...
                from Zeus.JupiterZ.v1_0_3.path_conf import profit_data_fpath
                self.profit_path = profit_data_fpath
                self.cost_pct = 0.002
                self.attend_min = 20
                self.attend_max = 51
                self.group_ratio = 0.2
                ...
                from Zeus.Leda.v1_0_3.path_conf import profit_data_fpath
                self.profit_path = profit_data_fpath
                self.cost_pct = 0.002
                self.attend_min = 20
                self.attend_max = 51
            ...
            #     self.extreme_thres = 0.1
                ...
                self.profit_path = '/data/group/800463/sunss/profit/europa/20230925/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'
                from Zeus.JupiterZ.v1_0_3.path_conf import profit_data_fpath
                self.profit_path = profit_data_fpath
                self.europa_profit_path = '/data/group/800463/sunss/profit/europa/20230925/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.h5'
                self.cost_pct = 0.002
                self.attend_min = 20#5#20
                self.attend_max = 51#81#41
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy == 'JupiterZSell':
                #self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_profitdata_for_alleur_SH450_SZ100.pkl'
                #self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealout_20210701_20220930_profitdata_for_alleur_SH300_SZ30_new.pkl'
                #self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealrealout_20220101_20230331_profitdata_for_alleur_SH300_SZ30.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealout_20210701_20220930_profitdata_for_alleur_SH300_SZ30_v3new.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealout_20220101_20230331_profitdata_for_alleur_SH300_SZ30_v3new.pkl'
                self.profit_path='/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealrealout_v3fited_20221001_20230331_profitdata_for_alleur_SH300_SZ30.pkl'
                self.cost_pct = 0.002
                self.attend_min = 20#5#20
                self.attend_max = 51#81#41
                self.group_ratio = 0.2
                self.extreme_thres = 0.1
            elif self.strategy == 'JupiterZSellEnhance':
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealout_20210701_20220930_profitdata_for_alleur_SH300_SZ30_v3new.pkl'
                self.profit_path = '/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealout_20220101_20230331_profitdata_for_alleur_SH300_SZ30_v3new.pkl'
                self.profit_path='/data/group/800463/wangj/save_files/JupiterZ_v3/sell/sell123_realrealrealrealout_v3fited_20221001_20230331_profitdata_for_alleur_SH300_SZ30.pkl'
                self.cost_pct = 0
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
            ...
            elif self.strategy in ['JupiterNSell','JupiterZSell','JupiterNSell34','JupiterZSellEnhance']:
                ...
                from Zeus.JupiterZ.v1_0_3.path_conf import data_all_fpath
                self.label_path = data_all_fpath
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
                ...
                self.label_path = '/data/group/800463/sunss/europa/20231101/factor_df_all_20160101_20200531.pkl'
                from Zeus.JupiterZ.v1_0_3.path_conf import data_all_fpath
                self.label_path = data_all_fpath
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            elif self.strategy == 'Leda':
                from Zeus.Leda.v1_0_3.path_conf import data_all_fpath
                self.label_path = data_all_fpath
                self.label_rev = 'label_TN_o2ul'
                self.label_o2o10 = 'label_pattern'
            # elif self.strategy =='JupiterZ':
            #     from Zeus.JupiterZ.v1_0_3.path_conf import data_all_fpath
            #     self.label_path = '/data/group/800463/sunss/europa/20230817/v1/factor_df_all_20160101_20211231_graded.pkl'
            #     self.label_path = '/data/group/800463/sunss/europa/20231101/factor_df_all_20160101_20211231.pkl'
            #     self.label_path = data_all_fpath
            ...
            if 'label_T_close_is_zt' not in label_data.columns.tolist() and (self.strategy in ['JupiterN','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda'] or self.strategy.find( 'JupiterZSell')>=0):
                label_data['label_T_close_is_zt'] = label_data['label_T_is_zt']
            if 'label_Next_close_is_zt' not in label_data.columns.tolist()  and (self.strategy in ['JupiterN','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda'] or self.strategy.find( 'JupiterZSell')>=0):
    ...
    def generate_test_report(self,pred_out, pred_in,scene_flag,probacol):
        ...
        if self.strategy not in ['JupiterN', 'jupiter_sell','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda'] and self.strategy.find( 'JupiterZSell')<0:
            ...
            if self.strategy == 'JupiterZSell':#.find( 'JupiterZSell')>=0:
        ...
        if self.indi_str.find('vote')<0 or self.indi_str.find('stack')>=0:
            ...
            model_valid_mingan = self.cal_model_mingan(pred_out_without_extreme, self.predcol)
    ...
    def cal_model_mingan(self,sel_raw_data,factor,step=1):
        ...
        if self.indi_str.find('scene')<0:
            ...
            os.makedirs(self.FilesavePath, exist_ok=True)
    ...
    def combine_res_inout(self,pred_sample_data,sample_data,statistic_without_extreme_value,statistic_by_sample,statistic_by_day,pred_in,flag_scene,proba_col):
        ...
        if 'label_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda'] or self.strategy.find('JupiterZSell')>=0):
        ...
        if 'label_pat_zuhe' not in pred_sample_data.columns.tolist() and (self.strategy in ['JupiterN','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda']  or self.strategy.find('JupiterZSell')>=0):
        ...
        if self.strategy in ['JupiterN','JupiterZ','JupiterZ','jupiter003','JupiterNSell','JupiterNSell34','JupiterZ','JupiterZSell','JupiterZSellEnhance', 'Leda'] or self.strategy.find('JupiterZSell')>=0:
