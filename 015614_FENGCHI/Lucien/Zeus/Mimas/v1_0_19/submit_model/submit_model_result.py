...
import shutil
import os
from Zeus.Mimas.v1_0_19.config.path_conf import *
...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v1_0_19/'
# _send_dict =[
#     {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250416_hs1filter/区间{PERIOD[-1]}/',
#      'model_name': {'config3_fsv8_s1_Xgb': 'base_FSV8Xgb', 'config3_fsv11_s1_Xgb': 'base_FSV11Xgb',
#                     'config4_fsv8_s1_Xgb': 'v2o10dh1_FSV8Xgb', 'config4_fsv11_s1_Xgb': 'v2o10dh1_FSV11Xgb'}},
#     {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Mimas/fac_20250416_hs1/区间{PERIOD[-1]}/',
#      'model_name': {'config1_fsv8_s1_Xgb': 'base_FSV8Xgb', 'config1_fsv11_s1_Xgb': 'base_FSV11Xgb',
#                     'config2_fsv8_s1_Xgb': 'v2o10dh1_FSV8Xgb', 'config2_fsv11_s1_Xgb': 'v2o10dh1_FSV11Xgb'}},
# ]

# _send_dict =[
#     {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Mimas/fac_20250416_hs1/区间{PERIOD[-1]}/',
#      'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV8Xgb', 'config1_fsv11_s1_Xgb': 'base_FSV11Xgb',
#                     'config2_fsv8_s1_Xgb': 'v2o10dh1_FcXgb', 'config2_fsv10_s1_Xgb': 'v2o10dh1_FSV10Xgb'}},
# ]

# _send_dict =[
#     {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Mimas/fac_20250416_hs1/区间{PERIOD[-1]}/',
#      'model_name': {'config1_fsrs_s1_Xgb': 'base_FSV8Xgb', 'config1_fsv10_s1_Xgb': 'base_FSV11Xgb',
#                     'config2_fsv8_s1_Xgb': 'v2o10dh1_FcXgb', 'config2_fsrs_s1_Xgb': 'v2o10dh1_FSV10Xgb'}},
# ]
...
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/Mimas/fac_20250416_hs1/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsrs_s1_Xgb': 'base_FSV8Xgb', 'config1_fsv10_s1_Xgb': 'base_FSV11Xgb',
                    'config1_fsv11_s1_Xgb': 'v2o10dh1_FcXgb', 'config2_fsv11_s1_Xgb': 'v2o10dh1_FSV10Xgb'}},
]

for idx in range(1): # send_dict中两个组合
    ...
    for seed in range(3):   # 每个模型提交三个seed的结果
