...
product_list = [ ('v1_0_18', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_18', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_18', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_18', 'config2', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_19', 'config1', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_19', 'config1', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_19', 'config1', 'fsv11', 's1', 'Xgb'),
                 ('v1_0_19', 'config2', 'fsv11', 's1', 'Xgb'),
                 ]
out_begin, out_end = date_dict[f'{pred_type}_start_date'], date_dict[f'{pred_type}_end_date']

valid_path_list = [f'/data/user/015614/Zeus/pred/Mimas/{pro[0]}/{pro[1]}/{pro[2]}_{pro[3]}_{pro[4]}/{period}/model/seed_0/{out_begin}~{out_end}.csv' for pro in product_list]
