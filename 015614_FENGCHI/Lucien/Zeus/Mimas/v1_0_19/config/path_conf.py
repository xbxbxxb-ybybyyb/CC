...
config1 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_19/config1/rffs_%s.pkl' % period.replace('_roll', '').replace('_fit', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_19/config1/rffs2_%s.pkl' % period.replace('_roll', '').replace('_fit', '')",
        },
...
config2 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_19/config2/rffs_%s.pkl' % period.replace('_roll', '').replace('_fit', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_19/config2/rffs2_%s.pkl' % period.replace('_roll', '').replace('_fit', '')",
        },
