...
import re
import time
from Zeus.Mimas.v1_0_19.config.strat_conf import DATE_CONFIG
...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_19/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_19/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_19/', 'period8')
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_19/', 'period7_fit')