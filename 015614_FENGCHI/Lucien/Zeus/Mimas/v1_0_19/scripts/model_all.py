...
from Zeus.Mimas.v1_0_19.backtest.backtest import start_backtest
...
import importlib
from Zeus.Mimas.v1_0_19.backtest.SimBackTest import SimBackTest
from Zeus.Mimas.v1_0_19.config.strat_conf import *
from Zeus.Mimas.v1_0_19.scripts.hyper_param_space import *
from Zeus.Mimas.v1_0_19.label_generate.fetch_label import fetch_label
import xgboost as xgb
import lightgbm as lgb
from Zeus.Mimas.v1_0_19.models.MlpRegModel import MlpRegModel
...
os.environ['CUDA_VISIBLE_DEVICES'] = str(gpu_id)
module_name = f'Zeus.Mimas.v1_0_19.config.path_conf'
...
def tuning_params(hyper_params_list, multi=True):
    ...
    # print('-------开始进行全部回测--------')
    # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_19/', period)
