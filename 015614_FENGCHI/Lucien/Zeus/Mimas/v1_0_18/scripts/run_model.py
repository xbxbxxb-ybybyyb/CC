...
from Zeus.Mimas.v1_0_18.scripts.check_path_is_ok import check_path_is_ok
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Mimas/v1_0_18/scripts/model_all.py {argv_list}')
