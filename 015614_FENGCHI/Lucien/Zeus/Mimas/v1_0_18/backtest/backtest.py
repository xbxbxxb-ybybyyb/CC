...
if __name__ == '__main__':
    while True:
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_18/', 'period1')
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_18/', 'period7')
        start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_18/', 'period8')
        # start_backtest('/data/user/015614/Zeus/pred/Mimas/v1_0_18/', 'period7_fit')