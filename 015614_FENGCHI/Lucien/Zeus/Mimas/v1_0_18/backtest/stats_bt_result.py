...
import json
import pandas as pd
from Zeus.Mimas.v1_0_18.scripts.hyper_param_space import hyper_xgb_reg_params_space
from Zeus.Mimas.v1_0_18.config.strat_conf import DATE_CONFIG, STRATEGY_NAME, STRATEGY_VERSION
from dataApi.sendInfo import send_file
from LucienUtil.FileUtil import FileUtil

result_path = '/data/user/015614/Zeus/pred/Mimas/v1_0_18/'
# period = 'period7_fit'
period = 'period8'
