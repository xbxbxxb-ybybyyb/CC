...
test_fit_res = pd.read_excel(f'/data/user/015614/junkData/hyper_Mimas_v1_0_18_{period_list[0]}.xlsx', sheet_name='最佳表现')
...
for indicator1 in indicator1_list:
    for indicator2 in indicator2_list:
        for period in period_list:
            test_fit_res = pd.read_excel(f'/data/user/015614/junkData/hyper_Mimas_v1_0_18_{period}.xlsx', sheet_name='最佳表现')
