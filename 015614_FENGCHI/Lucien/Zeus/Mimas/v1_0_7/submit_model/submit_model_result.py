...
# period1: 'fsv11_config3', 'fsv10_config4', 'fsci_config2', 'fsci_config3'(假命名为fsv8)
# period2: 'fsv11_config3', 'fsv10_config1', 'fsci_config3', 'fsv8_config2'
# period3:
_model_name = {
   'fsv8_s1_Xgb': 'FSV8Xgb',
   # 'fsrs_s1_Xgb': 'FSRSXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v1_0_7/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Mimass1/fac_20241203/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
