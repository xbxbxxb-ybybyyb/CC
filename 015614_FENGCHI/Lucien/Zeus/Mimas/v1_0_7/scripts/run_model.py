...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Mimas/v1_0_7/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsv10_config4', 'fsci_config2'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsci_config3'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsv10_config1', 'fsci_config3', 'fsv8_config2'], param_list))
