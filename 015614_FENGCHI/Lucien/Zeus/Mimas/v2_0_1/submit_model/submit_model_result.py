...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v2_0_1/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas_m1/fac_20250820/区间{PERIOD[-1]}/',
...
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas_m1/fac_20250820/区间{PERIOD[-1]}/',
    ...
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas_m1/fac_20250820/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv10_s1_Xgb': 'base_FSV11Xgb',}},
]
