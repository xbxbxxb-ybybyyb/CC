...
import pandas as pd
import numpy as np
from Zeus.Mimas.v1_0_1.strat_conf import strategy_name, strategy_version
from Zeus.Mimas.v1_0_1.path_conf import profit_data_fpath, bt_out_path, date_config, data_all_fpath
import math
import time
import os
...
class SimBackTest:
    ...
    def state_machine(self):
        ...
        if 'label_pct_cost' not in profit_df.columns:
            ...
            if strategy_name == 'Mimas':
                profit_df['label_pct'] = profit_df['label_label_diff_pct']
