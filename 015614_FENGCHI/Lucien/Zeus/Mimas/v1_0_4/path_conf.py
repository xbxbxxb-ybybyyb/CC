...
#%% 数据集
data_path = os.path.join(group_path, f'sunss/mimas_sell/20240718_market/')
data_all_fpath = os.path.join(data_path, f'factor_df_931_20160101_20200531.pkl')

profit_data_fpath = f'/data/group/800463/sunss/mimas_sell/profit/Sell_mimas_pct_931_0.20_0.15_1000_1500_250_20.pkl'

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/mimas_sell/fac_20240718_market/all/')
xgb_imptc_pct_fsv8_period1_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20191130_reg15_second_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period2_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20200531_reg15_second_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period3_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20201130_reg15_second_FSV8_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv8_period4_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20210531_reg15_second_FSV8_all_label_diff_pct_graded.xlsx')
...
xgb_imptc_pct_fsv10_period1_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20191130_reg15_second_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period2_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20200531_reg15_second_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period3_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20201130_reg15_second_FSV10_all_label_diff_pct_graded.xlsx')
xgb_imptc_pct_fsv10_period4_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20210531_reg15_second_FSV10_all_label_diff_pct_graded.xlsx')
...
xgb_imptc_pct_fsv11_period1_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20191130_first_FSV11_all_label_diff_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period2_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20200531_first_FSV11_all_label_diff_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period3_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20201130_first_FSV11_all_label_diff_pct_graded.xlsx')
# xgb_imptc_pct_fsv11_period4_fpath = os.path.join(xgb_imptc_path, f'mimas_sell_xgb_importance_20210531_first_FSV11_all_label_diff_pct_graded.xlsx')
...
fsrs_imptc_path = os.path.join(group_path, f'sunss/mimas_sell/20240714_market/fsrs/')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, f'sunss/mimas_sell/20240718_market/')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_4/rffs_%s.pkl' % period.replace('_roll', '')",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Mimas/v1_0_4/rffs2_%s.pkl' % period.replace('_roll', '')",
}

#%% 标签设置
label_config = {
    'pct': 'label_diff_pct_graded',
