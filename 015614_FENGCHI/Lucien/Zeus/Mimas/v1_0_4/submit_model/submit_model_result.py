...
from Zeus.Mimas.v1_0_4.strat_conf import *
...
dept_path = '/data/user/015614/Zeus/pred/Mimas/v1_0_4/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20240718/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
