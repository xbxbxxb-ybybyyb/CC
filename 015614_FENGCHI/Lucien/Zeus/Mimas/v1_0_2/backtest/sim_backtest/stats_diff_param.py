...
import pandas as pd
from Zeus.Mimas.v1_0_2.strat_conf import strategy_version, strategy_name, period
...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        ...
        stats_df['平均累计收益'] = model_test_mingan['累计盈利'].mean()
    ...
    FileUtil.save_dict2xls(output_dict, '/data/user/015614/junkData/', f'{strategy_version}_{strategy_name}_汇总结果.xlsx')
    send_file(f'/data/user/015614/junkData/{strategy_version}_{strategy_name}_汇总结果.xlsx')