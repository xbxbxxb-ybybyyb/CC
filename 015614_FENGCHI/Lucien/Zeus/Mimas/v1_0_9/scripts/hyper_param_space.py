...
fixed_xgb_reg_param = {
    # """period1"""
    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 5000, 'seed': 2000}),    # config3
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 2700, 'seed': 2002}),   # config3
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 3000, 'subsample': 0.6, 'seed': 2002}),  # config3
    ...
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1200, 'sedd': 2004}),    # config4

    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 5000, 'seed': 2000}),    # config5
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 5000, 'seed': 2000}),   # config5
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 5000, 'subsample': 0.6, 'seed': 2001}),  # config5
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1200, 'sedd': 2000}),   # config5

    # """period2"""
    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 3000, 'seed': 2002}),    # config3
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 5000, 'seed': 2004}),   # config3
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 5000, 'subsample': 0.6, 'seed': 2004}),  # config3
    # # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 500, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2002}),
    # # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 2700, 'sedd': 2004}),    # config1

    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 300, 'seed': 2004}),    # config5
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 5000, 'seed': 2003}),   # config5
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 2700, 'subsample': 0.6, 'seed': 2001}),  # config5
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 500, 'sedd': 2000}),   # config5

    # """period3"""
    'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 900, 'seed': 2004}),    # config1
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 500, 'seed': 2003}),   # config1
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 300, 'subsample': 0.6, 'seed': 2004}),  # config1
    # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 500, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2002}),
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 900, 'sedd': 2001}),    # config1

    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 900, 'seed': 2002}),    # config5
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 300, 'seed': 2002}),   # config5
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 500, 'subsample': 0.6, 'seed': 2003}),  # config5
    # # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 700, 'sedd': 2003}),   # config5
}
