...
import shutil
import os
from Zeus.Mimas.v1_0_9.config.path_conf import *
...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v1_0_9/'   # label
...
# dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Mimass1_label3/fac_20241225/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
