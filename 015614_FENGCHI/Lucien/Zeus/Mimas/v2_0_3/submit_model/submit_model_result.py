...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v2_0_3/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250911_mimas3_s/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250911_mimas3_s/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv8_s1_Xgb': 'pct2_FSV8Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250911_mimas3_s/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv11_s1_Xgb': 'TNv2t110_FSV11Xgb',}},

    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250911_mimas3_s/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv10_s1_Xgb': 'pct5_FSV11Xgb',}},
]
