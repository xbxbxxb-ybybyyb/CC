...
config1 = dict(
    data_fpath = '/data/group/800463/sunss/mimas/20241225/factor_df_s1_20160101_20210630.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/mimas/v1_0_10/config1/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/mimas/v1_0_10/config1/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config5 = dict(
    data_fpath = '/data/group/800463/sunss/mimas/20241225_label4/factor_df_s1_20160101_20210630.pkl',
    ...
    xgb_fsv8_fpath="'/data/group/800463/xiely/factor_select/mimas/fac_20241225_label4/s1/mimas_xgb_importance_%s_reg15_second_FSV8_s1_label_pct_diff_graded.xlsx' % (DATE_CONFIG[period.replace('_roll', '')]['valid_end_date'])",
    xgb_fsv10_fpath="'/data/group/800463/xiely/factor_select/mimas/fac_20241225_label4/s1/mimas_xgb_importance_%s_reg15_second_FSV10_s1_label_pct_diff_graded.xlsx' % (DATE_CONFIG[period.replace('_roll', '')]['valid_end_date'])",
    xgb_fsv11_fpath="'/data/group/800463/xiely/factor_select/mimas/fac_20241225_label4/s1/mimas_xgb_importance_%s_first_FSV11_s1_label_pct_diff_graded.xlsx' % (DATE_CONFIG[period.replace('_roll', '')]['valid_end_date'])",
    fsrs_fpath="'/data/group/800463/sunss/mimas/20241225_label4/fsrs/fsrsv2_label_pct_diff_graded_20160101_%s.xlsx' % (DATE_CONFIG[period.replace('_roll', '')]['valid_end_date'])",
    fsci_fpath="'/data/group/800463/tangsq/mimas/20241225_label4/fsci/fsci_label_pct_diff_graded_20160101_%s.xlsx' % (DATE_CONFIG[period.replace('_roll', '')]['valid_end_date'])",

    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/mimas/v1_0_10/config5/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/mimas/v1_0_10/config5/rffs2_%s.pkl' % period.replace('_roll', '')",
        },

    factor_score_fpath = f'/data/group/800463/sunss/mimas/20241225_label4/factor_bank_inf_s1.xlsx',
