...
import shutil
import os
from Zeus.Mimas.v1_0_10.config.path_conf import *
...
# period1: 'fsv8_config3', 'fsci_config4', 'fsv10_config3', 'fsv11_config3'
# period1: 'fsv8_config5', 'fsci_config5', 'fsv10_config5', 'fsv11_config5' 【label对冲标签】
# period2: 'fsv8_config3', 'fsci_config1', 'fsv10_config3', 'fsv11_config3'
# period2: 'fsv8_config5', 'fsci_config5', 'fsv10_config5', 'fsv11_config5' 【label对冲标签】
# period3: 'fsv8_config3', 'fsci_config1', 'fsv10_config3', 'fsv11_config3'
# period3: 'fsv8_config5', 'fsci_config5', 'fsv10_config5', 'fsv11_config5' 【label对冲标签】
_model_name = {
   'fsv8_s1_Xgb': 'FSV8Xgb',
   # 'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'RffsXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Mimas/v1_0_10/'   # label
# dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Mimass1/fac_20241129/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
# dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Mimass1/fac_20241225/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Mimass1_label4/fac_20241225/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
