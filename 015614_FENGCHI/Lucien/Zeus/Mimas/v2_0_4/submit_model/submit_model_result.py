...
# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250915_mimas_m5/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv11_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250915_mimas_m5/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv11_s1_Xgb': 'p2_FSV1Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250915_mimas_m5/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv11_s1_Xgb': 'TNv2t110_FSV11Xgb',}},

    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Mimas/fac_20250915_mimas_m5/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv10_s1_Xgb': 'TNv2t110_FSV8Xgb',}},
]
