...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_5/LgbRegModel/',
              log_fname='JupiterN_v1_0_5_LgbRegModel_v1.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_5/LgbRegModel/',
              log_fname='JupiterN_v1_0_5_LgbRegModel_v2.log',
              note='')