...
# period = ['period4', 'period5', 'period6', 'period7']
...
config_flag = [f'config1', 'config3', 'config4']
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterN/v2_0_3/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config1', 'fsrs_config3', 'fsv8_config4', 'fsv10_config4'], param_list))
param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config1', 'fsrs_config1', 'fsv11_config3', 'fsci_config3'], param_list))
