...
import pandas as pd
import numpy as np
from Zeus.JupiterN.v1_0_8.path_conf import *
from Zeus.JupiterN.v1_0_8.hyper_param_space import hyper_lgb_reg_params
from Zeus.BTLite.BTLite2 import BTLite2
from lightgbm import LGBMRegressor
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc, mean_squared_error
from LucienUtil.FileUtil import FileUtil
from Zeus.JupiterN.v1_0_8.my_logger import MyLogger
import warnings
import os
import json
import joblib
...
if PERIOD[-1] is '3':
    ...
    # best_threshold = 0
    # best_threshold = -0.000668  # attend 40
    # best_threshold = -0.005035    # attend 50
    best_threshold = -0.008902    # attend 60
elif PERIOD[-1] is '4':
    ...
    best_threshold = 0
    # best_threshold = -0.000454  # attend 40
    # best_threshold = -0.004573    # attend 50
    # best_threshold = -0.007866    # attend 60
...
class LgbRegModel:
    def __init__(self, sub_version='v1'):
        ...
        label_data = label_data.query(f'ZT_Time <= {BEFORE_TIME}')
    ...
    def start_train(self, param):
        ...
        valid_auc, valid_auc_std, valid_precision, valid_recall, valid_rmse = self.tscv_eval_model(param=param_copy)
