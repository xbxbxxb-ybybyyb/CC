...
valid_path_list = [
    f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/20191001~20200331_LgbRegModel_v1.csv',
    f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/20200401~20201231_LgbRegModel_v1.csv',
    f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/20200401~20200930_LgbRegModel_v2.csv',
    f'/data/user/015614/Zeus/pred/JupiterN/v1_0_1/LgbRegModel/20201001~20210630_LgbRegModel_v2.csv',
]
