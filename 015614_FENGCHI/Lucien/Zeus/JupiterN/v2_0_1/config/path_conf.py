...
config1 = dict(
    data_fpath = '/data/group/800463/sunss/jupiterN/20240911/factor_df_all_20160101_20210831.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/JupiterN/v2_0_1/config4/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/JupiterN/v2_0_1/config4/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
