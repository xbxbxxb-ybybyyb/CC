...
# from Zeus.JupiterN.v2_0_1.backtest.SimBackTest import SimBackTest
...
from Zeus.JupiterN.v2_0_1.scripts.hyper_param_space import *
from Zeus.JupiterN.v2_0_1.label_generate.fetch_label import fetch_label
import xgboost as xgb
import lightgbm as lgb
from Zeus.JupiterN.v2_0_1.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.JupiterN.v2_0_1.scripts.my_logger import MyLogger
import warnings
import random
import os
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/JupiterN/v2_0_1/{config_flag}/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
