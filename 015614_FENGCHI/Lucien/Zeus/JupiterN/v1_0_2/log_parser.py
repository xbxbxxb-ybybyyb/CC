...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/LgbRegModel/',
    #           log_fname='JupiterN_v1_0_2_LgbRegModel_v5.log',
    #           note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/XgbRegModel/',
              log_fname='JupiterN_v1_0_2_XgbRegModel_v5.log',
              note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/LrRegModel/',
    #           log_fname='JupiterN_v1_0_2_LrRegModel_v5.log',
    #           note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/CatRegModel/',
    #           log_fname='JupiterN_v1_0_2_CatRegModel_v3.log',
    #           note='test')
    # hml分场景 hml_factor
    # for ver in [10, 11, 12, 20, 21, 22, 30, 31, 32]:
    for ver in [50, 51, 52]:
        log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/XgbRegModel/',
                  log_fname=f'JupiterN_v1_0_2_XgbRegModel_v{ver}.log',
                  note='test')
        # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_2/LgbRegModel/',
        #           log_fname=f'JupiterN_v1_0_2_LgbRegModel_v{ver}.log',
        #           note='test')