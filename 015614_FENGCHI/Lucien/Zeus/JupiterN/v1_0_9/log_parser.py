...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_9/LgbRegModelV8/',
              log_fname='JupiterN_v1_0_9_LgbRegModelV8_v1.log',
              note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_9/LgbRegModelV2/',
    #           log_fname='JupiterN_v1_0_9_LgbRegModelV2_v1.log',
    #           note='')
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_9/LgbRegModelV3/',
    #           log_fname='JupiterN_v1_0_9_LgbRegModelV3_v1.log',
    #           note='')