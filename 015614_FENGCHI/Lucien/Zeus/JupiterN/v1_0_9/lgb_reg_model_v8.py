...
"""
滚动时序验证，train训练集长度固定为29个月，即每次剔除较远时间的数据，只保留距离valid最近的29个月数据作为训练集，valid前增加1个月数据进行分割，保证valid和train的独立性
"""
...
class LgbRegModel:
    ...
    def kcv_eval_model(self, param):
        gap_kfold = GapWalkForward(n_splits=5, max_train_size=29, test_size=3, gap_size=1)
