...
"""
GapWalkForward(n_splits=5, max_train_size=None, test_size=3)  滚动向前，test_size=3，不留gap
"""
...
class LgbRegModel:
    ...
    def kcv_eval_model(self, param):
        gap_kfold = GapWalkForward(n_splits=5, max_train_size=None, test_size=3)
