...
valid_path_list = [
    # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/20201001~20210331_LgbRegModel_v3.csv',
    f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/20210401~20211231_LgbRegModel_v3.csv',
    # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/20210401~20210930_LgbRegModel_v4.csv',
    # f'/data/user/015614/Zeus/pred/JupiterN/v1_0_7/LgbRegModel/20211001~20220630_LgbRegModel_v4.csv',
]
