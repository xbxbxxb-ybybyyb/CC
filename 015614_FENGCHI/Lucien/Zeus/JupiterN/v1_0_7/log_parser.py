...
if __name__ == '__main__':
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_7/LgbRegModel/',
              log_fname='JupiterN_v1_0_7_LgbRegModel_v3.log',
              note='')
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_7/LgbRegModel/',
              log_fname='JupiterN_v1_0_7_LgbRegModel_v4.log',
              note='')