...
#%% 数据集
data_path = os.path.join(group_path, 'sunss/jupiter/20221220/')
...
#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, 'xiely/factor_select/Jupiter_20221220/')
xgb_imptc_period1_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20190930_reg15_second_fac_20221220_FSV8_all_pct_graded_lowCost.xlsx')
...
xgb_imptc_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20211231_reg15_second_fac_20221220_FSV8_all_label_pct_graded_lowCost.xlsx')
...
xgb_imptc_hml0_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20211231_reg15_second_fac_20221220_FSV8_hml0_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml1_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20211231_reg15_second_fac_20221220_FSV8_hml1_label_pct_graded_lowCost.xlsx')
xgb_imptc_hml2_period5_fpath = os.path.join(xgb_imptc_path, 'xgb_importance_20211231_reg15_second_fac_20221220_FSV8_hml2_label_pct_graded_lowCost.xlsx')
...
#%% 因子打分文件
factor_score_path = os.path.join(group_path, 'sunss/jupiter/20221220/')
# factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_all_xly.xlsx')
factor_score_fpath = os.path.join(factor_score_path, 'factor_bank_inf_all_20160101_20211231_xly.xlsx')
