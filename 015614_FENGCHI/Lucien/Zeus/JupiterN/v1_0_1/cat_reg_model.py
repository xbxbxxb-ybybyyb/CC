...
from Zeus.JupiterN.v1_0_1.hyper_param_space import hyper_cat_reg_params
...
# param_test = {'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 8.0, 'devices': '0:1', 'feature_border_type': 'GreedyLogSum', 'iterations': 1500.0, 'l2_leaf_reg': 0.9, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'MAE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.9, 'task_type': 'GPU', 'score_threshold': -0.00463662144133536}
# param_fit ={'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 4.0, 'devices': '0:1', 'feature_border_type': 'MinEntropy', 'iterations': 1100.0, 'l2_leaf_reg': 0.0, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'RMSE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.8, 'task_type': 'GPU', 'score_threshold': -0.0000512629568163447}

# param_test = {'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 9.0, 'devices': '0:1', 'feature_border_type': 'GreedyLogSum', 'iterations': 900.0, 'l2_leaf_reg': 0.2, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'MAE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.8, 'task_type': 'GPU', 'score_threshold': -0.00738373037967222}
# param_fit ={'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 9.0, 'devices': '0:1', 'feature_border_type': 'GreedyLogSum', 'iterations': 900.0, 'l2_leaf_reg': 0.6000000000000001, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'MAE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.9, 'task_type': 'GPU', 'score_threshold': -0.00194536802698053}

param_test ={'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 6.0, 'devices': '0:1', 'feature_border_type': 'GreedyLogSum', 'iterations': 900.0, 'l2_leaf_reg': 0.8, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'MAE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.6000000000000001, 'task_type': 'GPU', 'score_threshold': -0.00277133842642741}
param_fit ={'boosting_type': 'Ordered', 'bootstrap_type': 'Bernoulli', 'depth': 8.0, 'devices': '0:1', 'feature_border_type': 'GreedyLogSum', 'iterations': 1500.0, 'l2_leaf_reg': 0.2, 'leaf_estimation_method': 'Gradient', 'learning_rate': 0.005, 'logging_level': 'Silent', 'loss_function': 'MAE', 'nan_mode': 'Forbidden', 'random_seed': 2025, 'subsample': 0.5, 'task_type': 'GPU', 'score_threshold': -0.00140709176509546}

hyper_params = hyper_cat_reg_params

class CatRegModel:
    def __init__(self, mode='test', sub_version='v1'):
        self.model_name = 'CatRegModel'
...
inst_test = CatRegModel(mode='test', sub_version=SUB_VERSION)
inst_fit = CatRegModel(mode='fit', sub_version=SUB_VERSION)
...
if hyper_search_mode:
    ...
    # inst_fit.date_dict = dict(train_start_date=20160101, train_end_date=20210930, valid_start_date=20210401, valid_end_date=20210930, test_start_date=20211001, test_end_date=20220630)
    # inst_fit.pred_fname = 'prod_for_search_threshold.csv'
    # pred_result = inst_fit.start_train(param=param_fit)
    # import json
    # inst_fit.model.save_model(junk_path + 'period4_CatRegModel.pkl')
