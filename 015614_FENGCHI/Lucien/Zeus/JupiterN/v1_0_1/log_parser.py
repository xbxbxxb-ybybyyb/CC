...
if __name__ == '__main__':
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_1/LgbRegModel/',
    #           log_fname='JupiterN_v1_0_1_LgbRegModel_v5.log',
    #           note='test')
    log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_1/XgbRegModel/',
              log_fname='JupiterN_v1_0_1_XgbRegModel_v5.log',
              note='test')
    # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_1/LrRegModel/',
    #           log_fname='JupiterN_v1_0_1_LrRegModel_v5.log',
    #           note='test')
    ...
    for ver in [50, 51, 52]:
        log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_1/XgbRegModel/',
                  log_fname=f'JupiterN_v1_0_1_XgbRegModel_v{ver}.log',
                  note='test')
        # log_parse(log_path='/data/user/015614/Zeus/logs/JupiterN/v1_0_1/LgbRegModel/',
        #           log_fname=f'JupiterN_v1_0_1_LgbRegModel_v{ver}.log',
        #           note='test')