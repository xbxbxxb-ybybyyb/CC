...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/JupiterN/v2_0_0/scripts/model_all.py {argv_list}')
...
param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsrs_config3'], param_list))
