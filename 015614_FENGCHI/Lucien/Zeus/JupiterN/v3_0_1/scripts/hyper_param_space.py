...
fixed_xgb_reg_param = {
    'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2000}),   # period1 config5
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 700, 'seed': 2000}),
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 800, 'subsample': 0.6, 'seed': 2000}),  # period1 config5
    'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 1500, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2002}),  # period1 config1
    'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1000, 'sedd': 2002}),  # period1 config5
}
