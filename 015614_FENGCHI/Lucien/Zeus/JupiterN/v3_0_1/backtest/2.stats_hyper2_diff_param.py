...
if __name__ == '__main__':
    ...
    hyper_root_path = f'/data/user/015614/Zeus/pred/JupiterN/{STRATEGY_VERSION}/'
    ...
    for config in config_names:
        ...
        for model_name in model_names:
            ...
            for search_time in hyper_list:
                ...
                train_result = pd.read_json(hyper_root_path + f'{config}/' + model_name + f'/hyper/{search_time}/train_result.json')
    ...
    FileUtil.save_df2xls(all_res_df, '/data/user/015614/junkData/', f'hyper2_res_{STRATEGY_VERSION}.xlsx')
