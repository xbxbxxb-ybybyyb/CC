...
import pandas as pd
import numpy as np
from Zeus.Metis.v1_0_0.path_conf import *
from Zeus.Metis.v1_0_0.hyper_param_space import hyper_lgb_reg_params
...
from Zeus.Metis.v1_0_0.my_logger import MyLogger
...
class LgbRegModel:
    ...
    def filter_factor(self, xgb_imptc_fpath=None, factor_score_fpath=factor_score_fpath):
        ...
        if fs_version == 'rffs':
            factor_list = pd.read_pickle(f'/data/user/015614/Zeus/factor_select/Metis/v1_0_0/rffs_{PERIOD}.pkl')
