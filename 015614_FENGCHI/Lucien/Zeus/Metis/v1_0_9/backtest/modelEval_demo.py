...
hfactor = FactorData()
import pandas as pd
from Zeus.Metis.v1_0_9.backtest.modelEval_Tool import *
from Zeus.Metis.v1_0_9.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Metis.v1_0_9.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Metis/v1_0_9/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
    ...
    if flag == True:
        ...
        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbRffsRegModel/{out_begin}~{out_end}_LgbRffsRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbRffsRegModel/{out_begin}~{out_end}_XgbRffsRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV8RegModel/{out_begin}~{out_end}_LgbFSV8RegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV8RegModel/{out_begin}~{out_end}_XgbFSV8RegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV10RegModel/{out_begin}~{out_end}_LgbFSV10RegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV10RegModel/{out_begin}~{out_end}_XgbFSV10RegModel_{SUB_VERSION}.csv',
        # ]

        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbRffsNextRegModel/{out_begin}~{out_end}_LgbRffsNextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbRffsNextRegModel/{out_begin}~{out_end}_XgbRffsNextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV8NextRegModel/{out_begin}~{out_end}_LgbFSV8NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV8NextRegModel/{out_begin}~{out_end}_XgbFSV8NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV10NextRegModel/{out_begin}~{out_end}_LgbFSV10NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV10NextRegModel/{out_begin}~{out_end}_XgbFSV10NextRegModel_{SUB_VERSION}.csv',
        # ]
        # valid_path_list = [
        #     '/data/user/015614/Zeus/pred/Europa/v2_0_16/XgbFSV8RegModelV2/20220401~20220930_XgbFSV8RegModelV2_v5.csv',
        # ]
        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbRffsNextRegModel/hyper/42/{out_begin}~{out_end}_LgbRffsNextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbRffsNextRegModel/hyper/27/{out_begin}~{out_end}_XgbRffsNextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV8NextRegModel/hyper/68/{out_begin}~{out_end}_LgbFSV8NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV8NextRegModel/hyper/25/{out_begin}~{out_end}_XgbFSV8NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbFSV10NextRegModel/hyper/66/{out_begin}~{out_end}_LgbFSV10NextRegModel_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbFSV10NextRegModel/hyper/6/{out_begin}~{out_end}_XgbFSV10NextRegModel_{SUB_VERSION}.csv',
        # ]
        ...
        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/Europa/v1_0_92/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v5_duiqi.csv',  # 全部样本训练后对齐信号
        #     f'/data/user/015614/Zeus/pred/Europa/v1_0_92/LgbRegModelV2V3duiqi/{out_begin}~{out_end}_LgbRegModelV2V3duiqi_v5.csv',  # 训练样本对齐后重新训练
        # ]

        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbRegModelV2/{out_begin}~{out_end}_XgbRegModelV2_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_0_9/XgbRegModelV3/{out_begin}~{out_end}_XgbRegModelV3_{SUB_VERSION}.csv',
        # ]
