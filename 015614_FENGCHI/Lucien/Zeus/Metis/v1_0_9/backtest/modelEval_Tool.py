    ...
    def select_profit(self):
        if self.strategy not in ['SaturnS0&SaturnS1','SaturnS1&SaturnS3']:
            if self.strategy == 'JupiterN':
                ...
                self.profit_path = '/data/group/800463/sunss/profit/metis/20230817/v2/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.pkl'
    ...
    def select_label(self):
        ...
        if self.strategy == 'SaturnS0&SaturnS1':
            ...
            if self.strategy == 'JupiterN':
                ...
                self.label_path = '/data/group/800463/sunss/metis/20230821/v2/factor_df_all_20160101_20220331_graded.pkl'
