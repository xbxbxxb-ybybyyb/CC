...
root_path = '/data/user/015614/Zeus/backtest/Metis/v1_0_3/回测结果/'
...
output_dict['排名求和'] = stats_rank_sum
FileUtil.save_dict2xls(output_dict, root_path, '汇总结果.xlsx')
from dataApi.sendInfo import send_file
send_file(root_path + '汇总结果.xlsx')