...
hfactor = FactorData()
import pandas as pd
from Zeus.Metis.v1_0_3.backtest.modelEval_Tool import *
from Zeus.Metis.v1_0_3.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Metis.v1_0_3.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    sel_model_names = ['fsv8_pct_XgbRegModel', 'fsv10_pct_XgbRegModel', 'fsv11_pct_XgbRegModel', 'fsrs_pct_XgbRegModel', 'rffs_pct_XgbRegModel', 'rffs2_pct_XgbRegModel',
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Metis/v1_0_3/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
