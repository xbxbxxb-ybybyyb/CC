...
data_fpath = os.path.join(data_path, f'factor_df_all_20160101_20221231_graded.pkl')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Metis/v1_1_15/rffs_%s.pkl' % period",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Metis/v1_1_15/rffs2_%s.pkl' % period",
}
