...
data_fpath = os.path.join(data_path, f'factor_df_all_20160101_20220331_graded.pkl')
...
xgb_imptc_pct_fsv8_period6_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20220331_reg15_second_fac_20230821_FSV8_all_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv10_period6_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20220331_reg15_second_fac_20230821_FSV10_all_label_pct_graded.xlsx')
...
xgb_imptc_pct_fsv11_period6_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20220331_first_fac_20230821_FSV11_label_pct_graded.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Metis/v1_0_12/rffs_%s.pkl' % period",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Metis/v1_0_12/rffs2_%s.pkl' % period",
}
