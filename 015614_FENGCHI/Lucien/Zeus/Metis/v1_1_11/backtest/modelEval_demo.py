...
hfactor = FactorData()
import pandas as pd
from Zeus.Metis.v1_1_11.backtest.modelEval_Tool import *
from Zeus.Metis.v1_1_11.path_conf import version, bt_out_path
...
if __name__ == "__main__":
    ...
    ''' test demo '''
    from Zeus.Metis.v1_1_11.path_conf import date_config
    if len(sys.argv) > 1:
        PERIOD = sys.argv[1]
    ...
    sel_model_names = ['fsv8_pct_XgbRegModel', 'fsv11_pct_XgbRegModel', 'fsrs_pct_LgbRegModel',
                       'rffs2_pct_XgbRegModel', 'fsv10_pct_LgbRegModel',
                       ]
    ...
    valid_path_list = [f'/data/user/015614/Zeus/pred/Metis/v1_1_11/{x}/{out_begin}~{out_end}.csv' for x in sel_model_names]
    ...
    if flag == True:
        ...
        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/Europa/v1_1_112/LgbRegModel/{out_begin}~{out_end}_LgbRegModel_v5_duiqi.csv',  # 全部样本训练后对齐信号
        #     f'/data/user/015614/Zeus/pred/Europa/v1_1_112/LgbRegModelV2V3duiqi/{out_begin}~{out_end}_LgbRegModelV2V3duiqi_v5.csv',  # 训练样本对齐后重新训练
        # ]

        # valid_path_list = [
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_1_11/LgbRegModelV2/{out_begin}~{out_end}_LgbRegModelV2_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_1_11/XgbRegModelV2/{out_begin}~{out_end}_XgbRegModelV2_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_1_11/LgbRegModelV3/{out_begin}~{out_end}_LgbRegModelV3_{SUB_VERSION}.csv',
        #     f'/data/user/015614/Zeus/pred/ProjectSell/v1_1_11/XgbRegModelV3/{out_begin}~{out_end}_XgbRegModelV3_{SUB_VERSION}.csv',
        # ]
