...
profit_data_fpath = f'/data/group/800463/sunss/profit/metis/20230821/v2/LabelProfit_zt_twap_0.15_2000_300_SH250_SZ20.pkl'

#%% 因子筛选文件
xgb_imptc_path = os.path.join(group_path, f'xiely/factor_select/Metis/V2/fac_20230821/')
...
# xgb_imptc_pct_fsv8_period5_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20210331_reg15_second_fac_20230821_FSV8_all_label_pct_graded.xlsx')
...
# xgb_imptc_pct_fsv10_period5_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20210331_reg15_second_fac_20230821_FSV10_all_label_pct_graded.xlsx')
...
# xgb_imptc_pct_fsv11_period5_fpath = os.path.join(xgb_imptc_path, f'metis_{metis_v}_xgb_importance_20210331_first_fac_20230821_FSV11_label_pct_graded.xlsx')
...
#%% 因子筛选设置
fs_config = {
    'rffs': "'/data/user/015614/Zeus/factor_select/Metis/v1_1_11/rffs_%s.pkl' % period",
    'rffs2': "'/data/user/015614/Zeus/factor_select/Metis/v1_1_11/rffs2_%s.pkl' % period",
}
