...
from Zeus.Metis.v1_0_16.hyper_param_space import *
import xgboost as xgb
import lightgbm as lgb
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Metis.v1_0_16.my_logger import MyLogger
import warnings
import random
import os
...
if hyper_search_mode:
    ...
    for idx in range(max_evals):
        if model_select == 'XgbRegModel':
            ...
            hyper_xgb_reg_params['random_state'] -= 20
            hyper_xgb_reg_params['num_boost_round'] -= 10
            hyper_xgb_reg_params['subsample'] -= 0.001
        elif model_select == 'LgbRegModel':
            auc_indicator = tuning_params(hyper_lgb_reg_params)
            hyper_lgb_reg_params['random_state'] -= 20
