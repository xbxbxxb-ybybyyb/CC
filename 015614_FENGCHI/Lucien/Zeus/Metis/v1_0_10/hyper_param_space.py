...
fixed_xgb_reg_param = "{'alpha': 0.6, 'booster': 'gbtree', 'colsample_bytree': 0.6, 'eta': 0.005, 'eval_metric': 'rmse', " \
                      "'evals_result': ('auc', 'rmse'), 'gamma': 0, 'lambda': 0.2, 'max_depth': 5, 'min_child_weight': 6, " \
                      "'n_jobs': -1, 'num_boost_round': 800.0, 'objective': 'reg:linear', 'random_state': 2022, " \
...
fixed_lgb_reg_param = "{'boosting_type': 'gbdt', 'class_weight': None, 'colsample_bytree': 0.5,  'learning_rate': 0.005, 'max_depth': 5,\
