...
from Zeus.Metis.v1_0_4.path_conf import *
...
PERIOD = 'period1'
pred_type = 'test'
pred_fpath = '/data/user/015614/Zeus/pred/Metis/v1_0_4/rffs_XgbRegModel/hyper/1/20191001~20200331_rffs_XgbRegModel_v1.csv'
