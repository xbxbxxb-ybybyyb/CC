...
fixed_xgb_reg_param = {
    # period4
    'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 500, 'seed': 2000}),  # config2
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 500, 'seed': 2000}),  # config2
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 500, 'subsample': 0.6, 'seed': 2003}),
    ...
    'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2001}),  # config2
}
