...
fixed_xgb_reg_param = {
    # period1
    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 2700, 'seed': 2000}),  # config2
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 5000, 'seed': 2002}),  # config2
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 1500, 'subsample': 0.6, 'seed': 2002}), # config2
    # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 300, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2000}),  # config3
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 700, 'seed': 2000}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2001}),
    #
    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 300, 'seed': 2002}),  # config2
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 900, 'seed': 2003}),  # config2
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 1000, 'subsample': 0.6, 'seed': 2000}), # config2
    # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 1200, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2001}),  # config3
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 700, 'seed': 2000}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2001}),

    # period2
    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 300, 'seed': 2002}),  # config2
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 2100, 'seed': 2000}),  # config2
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 2700, 'subsample': 0.6, 'seed': 2001}), # config2
    # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 2100, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2003}),  # config3
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 700, 'seed': 2000}),
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2001}),

    'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 500, 'seed': 2001}),  # config2
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 500, 'seed': 2003}),  # config2
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 300, 'subsample': 0.6, 'seed': 2003}), # config2
    'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 300, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2002}),  # config3
    'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 700, 'seed': 2000}),
    'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 1500, 'seed': 2001}),
}
