...
# period1: 'fsv11_config1', 'fsv8_config1', 'fsv11_config1', 'fsci_config1'
# period1: 'fsv11_config1', 'fsrs_config1', 'fsv10_config1', 'fsci_config1'
# period2: 'fsv11_config1', 'fsv8_config1', 'fsv11_config1', 'fsci_config1'
# period2: 'fsv11_config1', 'fsrs_config1', 'fsv10_config1', 'fsci_config1'
_model_name = {
   'fsv8_s1_Xgb': 'FSV8Xgb',
   # 'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'RffsXgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Ceres/v1_0_3/'   # label
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Ceress1_label4/fac_20241225/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
