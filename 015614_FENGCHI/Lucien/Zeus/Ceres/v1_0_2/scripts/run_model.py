...
config_flag = [f'config{x}' for x in [2,5]]
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Ceres/v1_0_2/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config1', 'fsv8_config2', 'fsci_config2'], param_list))
