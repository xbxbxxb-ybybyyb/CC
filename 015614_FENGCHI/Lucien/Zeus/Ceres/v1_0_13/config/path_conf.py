...
config1 = dict(
    data_fpath = '/data/group/800463/sunss/ceres/20250324/factor_df_s1_20160101_20240630.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config1/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config1/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config2 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config2/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config2/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config3 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config3/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config3/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config4 = dict(
    data_fpath = '/data/group/800463/sunss/ceres/20250324/factor_df_s1_with_p4_20160101_20240630.pkl',
    filter_data_fpath = '/data/group/800463/sunss/ceres/20250324/factor_df_s1_20160101_20240630.pkl',
    profit_data_fpath = f'/data/group/800463/sunss/ceres/profit/20250318/sp2_profit_interval_s1_0.10_0.10_500_1500_250_20.h5',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config4/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config4/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
# config4 = dict(
#     data_fpath = '/data/group/800463/sunss/p4/20250324/factor_df_20160101_20240630.pkl',
...
#
#     fs_config = {
#             'rffs': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config5/rffs_%s.pkl' % period.replace('_roll', '')",
#             'rffs2': "'/data/user/015614/Zeus/factor_select/Ceres/v1_0_13/config5/rffs2_%s.pkl' % period.replace('_roll', '')",
#         },
#
#     factor_score_fpath = f'/data/group/800463/sunss/p4/20250324/factor_bank_inf.xlsx',
#
