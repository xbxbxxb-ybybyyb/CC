...
dept_path = f'/data/user/015614/Zeus/pred/Ceres/v2_0_2/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Ceres/fac_20250901_vnum/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv8_s1_Xgb': 'base_FSV8Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Ceres/fac_20250901_vnum/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv10_s1_Xgb': 'TNv2To10_v_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Ceres/fac_20250901_vnum/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv11_s1_Xgb': 'basemix_FSV11Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/Ceres/fac_20250901_vnum/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv11_s1_Xgb': 'TNv2To10_vmix_FSV11Xgb',}},
]
