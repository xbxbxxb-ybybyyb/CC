...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Ceres/v2_0_1/scripts/model_all.py {argv_list}')
...
param_list = list(filter(lambda x: x[2] + '_' + x[1] in ['config1_fsv11', 'config2_fsv11', 'config3_fsv10', 'config3_fsv8'], param_list))
