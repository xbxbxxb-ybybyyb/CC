...
fixed_xgb_reg_param = {
    ...
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 2700, 'subsample': 0.6, 'seed': 2004}),  # config4
    ...
    'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 300, 'sedd': 2002}),    # config2

    # 'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 300, 'seed': 2002}),
    # 'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 2700, 'seed': 2001}),   # config1
    # 'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 300, 'subsample': 0.6, 'seed': 2004}),  # config1
    # 'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 500, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2002}),
    # 'rffs': add(xgb_fixed_params, {'eta': 0.025, 'max_depth': 6, 'num_boost_round': 660}),
    # # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 500, 'sedd': 2004}),    # config4
    # 'fsci': add(xgb_fixed_params, {'eta': 0.016, 'max_depth': 5, 'num_boost_round': 300, 'sedd': 2002}),    # config1
}
