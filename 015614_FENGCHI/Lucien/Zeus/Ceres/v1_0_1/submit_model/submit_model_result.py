...
# period1: 'fsv11_config1', 'fsv8_config2', 'fsv11_config4'(假命名fsv10), 'fsci_config2'
# period1: 'fsv11_config1', 'fsci_config1', 'fsv10_config1', 'fsci_config4'(假命名fsv8)
# period2:
_model_name = {
   # 'fsv8_s1_Xgb': 'FSV8Xgb',
   # 'fsrs_s1_Xgb': 'FSRSXgb',
   # 'rffs_s1_Xgb': 'RffsXgb',
   'fsv11_s1_Xgb': 'FSV10Xgb',
...
dept_path = f'/data/user/015614/Zeus/pred/Ceres/v1_0_1/'   # label
dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Ceress1/fac_20241203/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
