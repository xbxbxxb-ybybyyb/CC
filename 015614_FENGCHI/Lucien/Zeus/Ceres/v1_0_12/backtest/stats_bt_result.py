...
import json
import pandas as pd
from Zeus.Ceres.v1_0_12.scripts.hyper_param_space import hyper_xgb_reg_params_space
from Zeus.Ceres.v1_0_12.config.strat_conf import DATE_CONFIG, STRATEGY_NAME, STRATEGY_VERSION
from dataApi.sendInfo import send_file
from LucienUtil.FileUtil import FileUtil

result_path = '/data/user/015614/Zeus/pred/Ceres/v1_0_12/'
period = 'period6'
...
def get_all_result():
    ...
    for dirpath, dirnames, filenames in os.walk(result_path):
        for filename in filenames:
            if 'bt_result' in filename and 'hyper' in dirpath and 'roll' not in dirpath:
    ...
    FileUtil.save_dict2xls(res_dict, '/data/user/015614/junkData/', f'hyper_{STRATEGY_NAME}_{STRATEGY_VERSION}.xlsx')
    send_file(f'/data/user/015614/junkData/hyper_{STRATEGY_NAME}_{STRATEGY_VERSION}.xlsx')
