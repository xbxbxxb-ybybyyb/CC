...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Ceres/v1_0_11/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config1', 'fsv10_config1', 'fsv11_config2', 'rffs_config1', 'fsv8_config2'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config2', 'fsv10_config2', 'fsv11_config2', 'rffs_config2'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config4', 'fsv10_config4', 'fsv11_config4', 'fsci_config3'], param_list))
