...
fs_version = ['fsv8', 'fsv10', 'fsv11', 'fsci', 'rffs', 'fsrs']
# fs_version = ['fsrs']
# fs_version = ['fsci']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Ceres/v1_0_7/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsrs_config2', 'fsv8_config2', 'fsci_config2', 'fsv11_config2'], param_list))
param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsrs_config3', 'fsv8_config4', 'fsv10_config4', 'fsv11_config4'], param_list))
