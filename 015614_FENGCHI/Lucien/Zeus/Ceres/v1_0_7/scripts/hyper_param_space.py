...
fixed_xgb_reg_param = {
    # period4
    'fsv8': add(xgb_fixed_params, {'eta': 0.012, 'max_depth': 5, 'num_boost_round': 900, 'seed': 2004}),  # config4
    'fsv10': add(xgb_fixed_params, {'eta': 0.018, 'max_depth': 6, 'num_boost_round': 500, 'seed': 2004}),  # config4
    'fsv11': add(xgb_fixed_params, {'eta': 0.02, 'max_depth': 5, 'num_boost_round': 700, 'subsample': 0.6, 'seed': 2003}), # config4
    'fsrs': add(xgb_fixed_params, {'eta': 0.015, 'max_depth': 6, 'num_boost_round': 1000, 'subsample': 0.5, 'min_child_weight': 7, 'seed': 2001}),  # config3
