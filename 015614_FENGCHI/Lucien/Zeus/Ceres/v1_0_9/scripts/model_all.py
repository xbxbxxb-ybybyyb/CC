...
# from Zeus.Mimas.v1_0_8.backtest.SimBackTest import SimBackTest
...
import importlib
from Zeus.Ceres.v1_0_8.backtest.SimBackTest import SimBackTest
from Zeus.Ceres.v1_0_8.config.strat_conf import *
from Zeus.Ceres.v1_0_8.scripts.hyper_param_space import *
from Zeus.Ceres.v1_0_8.label_generate.fetch_label import fetch_label
import xgboost as xgb
import lightgbm as lgb
from Zeus.Ceres.v1_0_8.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.Ceres.v1_0_8.scripts.my_logger import MyLogger
import warnings
import random
import os
...
module_name = f'Zeus.Ceres.v1_0_8.config.path_conf'
...
if hyper_search_mode == 2:
    tree_num_list = list(range(300, 1000, 200)) + [1000, 1200, 1500, 1800, 2100, 2700, 3000, 4000, 5000]
    if model_select == 'XgbRegModel':
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/Ceres/v1_0_8/{config_flag}/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
