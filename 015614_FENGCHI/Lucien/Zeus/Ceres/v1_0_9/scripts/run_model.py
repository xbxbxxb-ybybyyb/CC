...
config_flag = [f'config{x}' for x in [2, 3, 4]]
label_trans = ['lt1']
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/Ceres/v1_0_8/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config2', 'fsv10_config2', 'fsrs_config2', 'fsv8_config2'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsv10_config3', 'fsrs_config3', 'fsv8_config4'], param_list))
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsv10_config3', 'fsrs_config3', 'fsv8_config4'], param_list))
param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv11_config3', 'fsv10_config4', 'fsrs_config4', 'fsv8_config4'], param_list))
