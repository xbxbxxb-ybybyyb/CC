...
dept_path = f'/data/user/015614/Zeus/pred/Ceres/v1_0_8/'   # label
# dest_path = f'/data/user/015614/shared/for_skk/strategy_model/Ceress1/fac_20250205_label4/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/Ceress1/fac_20250205/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
