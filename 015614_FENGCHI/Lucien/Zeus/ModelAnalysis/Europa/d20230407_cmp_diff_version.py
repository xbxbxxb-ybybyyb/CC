...
period5_test = '20220101~20220630_Europa_fac_20230329_FSV8_all_label_pct_graded_lowCost_period5_all_merge_test_模型评价_20230408.xlsx'
bt_res_fpath_list = [period5_test]
bt_res_name_list = ['period5_test']
filtered_model_list = ['LgbRegModel', 'LgbRffsRegModel', 'LgbO2ulModel', 'XgbRegModel', 'XgbRffsRegModel', 'LinRegModel', 'LinRffsRegModel']

# d20230412 测试v1_0_32 v3与v2样本变差原因
period5_test = '20220101~20220630_Europa_fac_20230329_FSV8_all_label_pct_graded_lowCost_period5_all_merge_test_模型评价_20230412.xlsx'
filtered_model_list = ['methodA', 'methodB']
filtered_model_list = ['newModel', 'oldModel2A', 'oldModel2B', 'oldModel3A', 'oldModel3B']

period5_test = '20220101~20220630_Europa_fac_20230329_FSV8_all_label_pct_graded_lowCost_period5_all_merge_test_模型评价_20230413.xlsx'
period5_test = '20220401~20220930_Europa_fac_20230329_FSV8_all_label_pct_graded_lowCost_period5_tmp_all_merge_test_模型评价_20230417.xlsx'
filtered_model_list = ['LgbFSV8RegModel', 'LgbRffsRegModel', 'LgbO2ulFSV8RegModel',
