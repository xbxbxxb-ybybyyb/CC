...
# root_path = '/data/user/015614/Zeus/pred/Europa/v1_0_24/LgbRegModel/'
# pred1024 = pd.read_csv(root_path + '20210401~20211231_LgbRegModel_v3.csv', index_col=0)
# pred1024 = pred1024.query('datelist >= 20210701')
# FileUtil.save_df2csv(pred1024, root_path, '20210701~20211231_LgbRegModel_v3_forcmp.csv')
#
# root_path = '/data/user/015614/Zeus/pred/Europa/v1_0_25/LrRegModel/'
# pred1024 = pd.read_csv(root_path + '20210401~20211231_LrRegModel_v3.csv', index_col=0)
# pred1024 = pred1024.query('datelist >= 20210701')
# FileUtil.save_df2csv(pred1024, root_path, '20210701~20211231_LrRegModel_v3_forcmp.csv')

"""cmp"""
root_path = '/data/user/015614/shared/backtest_result/20230105回测结果_Europa_fac_20221220_total_lowCost_5model_period4/'
# root_path = '/data/user/015614/junkData/回测结果/'
period4_test = '20210701~20211231_Europa_fac_20221220_FSV8_all_pct_graded_lowCost_period4_all_merge_test_模型评价_20230105_cmp.xlsx'
bt_res_fpath_list = [period4_test]
bt_res_name_list = ['period4_test']
filtered_model_list = ['LgbV8FcModel', 'XgbV8FcModel', 'LrRSFcModel', 'LgbV8HmlFcModel', 'XgbV8HmlFcModel', 'oldLgbV8FcModel', 'oldLrRSFcModel']
