...
margin_ic_pct = margin_ic_pct > -0.01
margin_ic_pct_winrate = (margin_ic_pct.sum(axis=1) / margin_ic_pct.shape[1]).sort_values(ascending=False)
filtered_factor = margin_ic_pct_winrate[margin_ic_pct_winrate < 0.5].index.tolist()