...
# period4_test = '20210701~20211231_JupiterNSell34_fac_20230330_FSV8_all_label_pct_graded_lowCost_period4_all_merge_test_模型评价_20230418.xlsx'
# bt_res_fpath_list = [period4_test]
# bt_res_name_list = ['period4_test']
# filtered_model_list = ['LgbRffsNextRegModel', 'XgbRffsNextRegModel', 'LgbFSV8NextRegModel', 'XgbFSV8NextRegModel', 'oldLgbRffsNextRegModel', 'oldXgbRffsNextRegModel']

period5_test = '20220401~20220930_JupiterNSell34_fac_20230330_FSV8_all_label_pct_graded_lowCost_period5_all_merge_test_模型评价_20230419.xlsx'
bt_res_fpath_list = [period5_test]
bt_res_name_list = ['period5_test']
filtered_model_list = ['LgbRffsNextRegModel', 'XgbRffsNextRegModel', 'LgbFSV8NextRegModel', 'XgbFSV8NextRegModel', 'LgbFSV10NextRegModel', 'XgbFSV10NextRegModel']

period5_test = '20220401~20220930_JupiterNSell_fac_20230330_FSV8_all_label_pct_graded_lowCost_period5_all_merge_test_模型评价_20230419.xlsx'
bt_res_fpath_list = [period5_test]
bt_res_name_list = ['period5_test']
filtered_model_list = ['LgbRffsRegModel', 'XgbRffsRegModel', 'LgbFSV8RegModel', 'XgbFSV8RegModel', 'LgbFSV10RegModel', 'XgbFSV10RegModel']

# 旧的
# period4_test = '20210701~20211231_JupiterNSell34_fac_20230329_FSV8_all_label_pct_graded_lowCost_period4_all_merge_test_模型评价_20230404.xlsx'
# bt_res_fpath_list = [period4_test]
# bt_res_name_list = ['period4_test']
# filtered_model_list = ['LgbRegModelV2', 'XgbRegModelV2', 'LgbRegModelV2', 'XgbRegModelV3']
