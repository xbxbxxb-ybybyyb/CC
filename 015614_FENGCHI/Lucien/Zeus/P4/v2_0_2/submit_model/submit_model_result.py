...
dept_path = f'/data/user/015614/Zeus/pred/P4/v2_0_2/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250622_h5_sc/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250622_h5_sc/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv10_s1_Xgb': 'pctp5_FSV10Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/P4/fac_20250622_h5_sc/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_skk/strategy_model/P4/fac_20250622_h5_sc/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv10_s1_Xgb': 'pctp5_FSV10Xgb',}},
]
