...
dept_path = f'/data/user/015614/Zeus/pred/P4/v1_0_1/'   # label
...
dest_path = f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20241225/区间{PERIOD[-1]}/'    # TODO：根据period修改这里的值
