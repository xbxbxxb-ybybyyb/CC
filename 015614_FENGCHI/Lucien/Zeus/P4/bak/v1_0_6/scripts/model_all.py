...
# from Zeus.P4.v1_0_6.backtest.SimBackTest import SimBackTest
...
from Zeus.P4.v1_0_6.scripts.hyper_param_space import *
from Zeus.P4.v1_0_6.label_generate.fetch_label import fetch_label
import xgboost as xgb
import lightgbm as lgb
from Zeus.P4.v1_0_6.models.MlpRegModel import MlpRegModel
from sklearn.metrics import roc_curve, auc
from LucienUtil.FileUtil import FileUtil
from Zeus.P4.v1_0_6.scripts.my_logger import MyLogger
import warnings
import random
import os
...
module_name = f'Zeus.P4.v1_0_6.config.path_conf'
...
class MyModelTrain:
    ...
    def start_train(self, param):
        ...
        if seed == 0 and not period.endswith('roll'):
            ...
            self.best_threshold = pd.read_json(f'/data/user/015614/Zeus/pred/P4/v1_0_6/{config_flag}/{self.model_name}/model/{period.replace("_roll", "")}/seed_0/_score_threshold.json').iloc[0, 0]
