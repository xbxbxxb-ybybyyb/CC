...
for period in period_list:
    tmp_res = pd.read_excel(result_path + f'v1_0_2_P4_{period}_汇总结果.xlsx')
...
FileUtil.save_dict2xls(indicator_dict, result_path, 'P4从第四区间开始得分.xlsx')
from dataApi.sendInfo import send_file
send_file(result_path + 'P4从第四区间开始得分.xlsx')
