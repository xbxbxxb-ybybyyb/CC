...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/P4/v1_0_9/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[2] + '_' + x[1] in ['config3_fsv8', 'config3_fsv11', 'config1_fsv8', 'config1_fsv10'], param_list))
# param_list = list(filter(lambda x: x[2] + '_' + x[1] in ['config3_fsv10', 'config2_fsv10', 'config1_fsv8', 'config1_rffs'], param_list))
param_list = list(filter(lambda x: x[2] + '_' + x[1] in ['config3_fsv10', 'config2_rffs', 'config2_fsv8', 'config1_rffs'], param_list))
