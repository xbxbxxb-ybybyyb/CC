...
product_list = [ ('v1_0_8', 'fsrs', 's1', 'Xgb'),
                 ('v1_0_8', 'rffs', 's1', 'Xgb'),
                 ('v1_0_8', 'fsv8', 's1', 'Xgb'),
                 ('v1_0_8', 'fsv10', 's1', 'Xgb'),
                 ('v1_0_8', 'fsv11', 's1', 'Xgb')]
...
valid_path_list = [f'/data/user/015614/Zeus/pred/P4/{pro[0]}/config3/{pro[1]}_{pro[2]}_{pro[3]}/model/{period}/seed_0/{out_begin}~{out_end}.csv' for pro in product_list]
