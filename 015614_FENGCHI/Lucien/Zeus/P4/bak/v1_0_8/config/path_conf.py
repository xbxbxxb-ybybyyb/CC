...
config1 = dict(
    data_fpath = '/data/group/800463/sunss/p4/20250324_ns1/factor_df_ns1_20160101_20221231.pkl',
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config1/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config1/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config2 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config2/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config2/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config3 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config3/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config3/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config4 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config4/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config4/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
...
config5 = dict(
    ...
    fs_config = {
            'rffs': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config5/rffs_%s.pkl' % period.replace('_roll', '')",
            'rffs2': "'/data/user/015614/Zeus/factor_select/P4/v1_0_8/config5/rffs2_%s.pkl' % period.replace('_roll', '')",
        },
