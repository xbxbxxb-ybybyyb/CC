...
fs_version = ['fsv8', 'fsv10', 'fsv11', 'rffs', 'fsrs']
# fs_version = ['fsci']
# fs_version = ['fsv8']
# fs_version = ['rffs']
...
# config_flag = [f'config{x}' for x in [1, 2]]
# config_flag = [f'config{x}' for x in [1, 2]]
# config_flag = [f'config{x}' for x in [1, 2, 3]]
...
def wrapper(param_list):
    for param in tqdm(param_list):
        ...
        os.system(f'python3 /data/user/015614/Lucien/Zeus/P4/v1_0_8/scripts/model_all.py {argv_list}')
...
# param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config2', 'fsv10_config1', 'fsv11_config1', 'rffs_config1', 'fsv10_config2'], param_list))
# # param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv10_config2'], param_list))
# # param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config2', 'fsv10_config2', 'fsv11_config2', 'rffs_config2'], param_list))
# # param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config1', 'fsv10_config1', 'fsv11_config2', 'rffs_config2'], param_list))
# # param_list = list(filter(lambda x: x[1] + '_' + x[2] in ['fsv8_config1'], param_list))
