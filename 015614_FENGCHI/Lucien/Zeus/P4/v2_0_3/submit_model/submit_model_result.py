...
dept_path = f'/data/user/015614/Zeus/pred/P4/v2_0_3/'

# 正式提交
_send_dict =[
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250817_del/区间{PERIOD[-1]}/',
     'model_name': {'config1_fsv10_s1_Xgb': 'base_FSV10Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250817_del/区间{PERIOD[-1]}/',
     'model_name': {'config2_fsv11_s1_Xgb': 'pctp5_FSV10Xgb',}},
{'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250817_del/区间{PERIOD[-1]}/',
     'model_name': {'config3_fsv8_s1_Xgb': 'pctp5_FSV11Xgb',}},
    {'dest_path': f'/data/user/015614/shared/for_wj/strategy_model/P4/fac_20250817_del/区间{PERIOD[-1]}/',
     'model_name': {'config4_fsv8_s1_Xgb': 'v2o10nd1_FSV8Xgb',}},
]
