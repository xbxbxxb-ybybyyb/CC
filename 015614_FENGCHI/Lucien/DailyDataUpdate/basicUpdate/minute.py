...
def _prepare_store_kline_by_factor(code_list, factor, data_address='/data/user/015614/easy_transfer/basic_data/minuteByStock'):
...
def _store_kline_by_stock(code_list=None, line=8, start_date=20150701, end_date=None,
                          stock_list_address='/data/user/015614/easy_transfer/basic_data/daily',
                          store_address='/data/user/015614/easy_transfer/basic_data/minuteByStock'):
...
def _store_kline_by_stock_bench(bench_dict=benchmarks, start_date=20140101, end_date=None,
                                  store_address='/data/user/015614/easy_transfer/basic_data/minuteByStockBench'):
...
def _store_kline_by_factor(line=24, pre_close_address='/data/user/015614/easy_transfer/basic_data/daily',
                           data_address='/data/user/015614/easy_transfer/basic_data/minuteByStock',
                           store_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
                           desample_address='/data/user/015614/easy_transfer/basic_data/minuteDesampleByFactor'):
...
def update_adjfactor_kline_by_factor2(factors=minute_base_data_list[:4],
                           data_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
    ...
    for factor in factors:
        ...
        adjfactor1 = adjfactor.reindex(columns=df.columns, index=set(df.index.get_level_values(0)))  # 由于daily数据和minute数据的起始日期不同，20230213修改
...
def update_kline_by_factor(line=24, pre_close_address='/data/user/015614/easy_transfer/basic_data/daily',
                           data_address='/data/user/015614/easy_transfer/basic_data/minuteByStock',
                           store_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
                           desample_address='/data/user/015614/easy_transfer/basic_data/minuteDesampleByFactor'):
...
if __name__ == '__main__':
    '''
    _store_kline_by_stock(line=16, end_date=20200120, store_address='/data/user/015614/easy_transfer/basic_data/minuteByStock')
    ...
    update_kline_by_factor(line=48, pre_close_address='/data/user/015614/easy_transfer/basic_data/daily',
                           data_address='/data/user/015614/easy_transfer/basic_data/minuteByStock',
                           store_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
                           desample_address='/data/user/015614/easy_transfer/basic_data/minuteDesampleByFactor')
    ...
    update_twap(base_date=20100101, data_address='/data/user/015614/easy_transfer/basic_data/minuteByFactorBench',
                store_address='/data/user/015614/easy_transfer/basic_data/dailyBench')
    update_twap(base_date=20130101, data_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
                store_address='/data/user/015614/easy_transfer/basic_data/daily')
    ...
    _store_kline_by_factor(line=30, pre_close_address='/data/user/015614/easy_transfer/basic_data',
                           data_address='/data/user/015614/easy_transfer/basic_data/minuteByStock',
                           store_address='/data/user/015614/easy_transfer/basic_data/minuteByFactor',
                           desample_address='/data/user/015614/easy_transfer/basic_data/minuteDesampleByFactor')
    get_bench_daily_data()
