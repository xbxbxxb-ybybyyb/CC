...
def update_morning_data(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def _store_daily_data(item='all', address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_stock_list(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_ind_con(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_daily_data(item='all', address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_pause(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_live_days(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_normal_days(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_price_get_limit(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_bench_exdiv_weight(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_dividend(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_common_stock_list(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def update_limit_price(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def amend_daily_data(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def load_limit(address='/data/user/015614/easy_transfer/basic_data/daily'):
    half_years = get_date_range(20091231, 20241231, 'Q')
    ...
    limit_min.to_hdf('%s/limit_min.h5' % address, 'limit_min', format='t')
    limit_max.to_hdf('%s/limit_max.h5' % address, 'limit_max', format='t')


if __name__ == '__main__':

    address = '/data/user/015614/easy_transfer/basic_data/daily'

    _store_daily_data('short_name', address='/data/user/015614/easy_transfer/basic_data/daily')
    ...
    for i in range(len(money_flow_data_list)):
        try:
            _store_daily_data(money_flow_data_list[i], address='/data/user/015614/easy_transfer/basic_data/daily')
        except Exception:
            if dt.datetime.now().hour < 18:
    ...
    update_bench_exdiv_weight(address='/data/user/015614/easy_transfer/basic_data/daily')

    update_common_stock_list(address='/data/user/015614/easy_transfer/basic_data/daily')
