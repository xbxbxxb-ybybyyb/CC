...
def _update_log(status, factor_type, factor, write_type='update', info='',
                file='/data/user/015614/easy_transfer/basic_data/updateLog.txt'):
...
def get_stock_list(date=None, address='/data/user/015614/easy_transfer/basic_data/daily'):
    if date != None:
...
def _store_stock_list(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def _store_bench_exdiv_weight(address='/data/user/015614/easy_transfer/basic_data/daily'):
    date = get_date_range(20100101)
...
def _store_ind_con(address='/data/user/015614/easy_transfer/basic_data/daily'):
    date = get_date_range(20100101)
...
def _store_price_get_limit(address='/data/user/015614/easy_transfer/basic_data/daily'):
    date = get_date_range(20100101)
    _date = _check_input_date(date)
...
def _store_ST(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def _store_live_days_and_pause(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def _store_limit_range(address='/data/user/015614/easy_transfer/basic_data/daily'):
...
def clean_stock_list(stock_list='ALL', no_ST=True, least_live_days=240, least_normal_days=0, no_pause=True,
                     ...
                     trade_mode=False, address='/data/user/015614/easy_transfer/basic_data/daily'):
