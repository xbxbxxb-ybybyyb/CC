...
if __name__ == "__main__":
    ...
    tradeDate = '2023-07-24'
    nowdate = tradeDate[:4] + tradeDate[5:7]+tradeDate[8:]
    begindate, enddate = 20230101, 20230503#'20230327','20230412'#
    # begindate, enddate = 20221107, 20221231#'20230327','20230412'#
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst: #[:2] + environment_lst[4:]:#['night']:#['UAT','UAT_other']:#['night','night_other']:#['night_origin3']:#['night_origin3','night_50_51','night_49_53']:#['UAT_lite']:#
            ...
            if environment == 'prod' and os.path.exists(o45file_name):
                ...
                # o45_lines = list(filter(lambda x: str(x).startswith("b'2022-"), o45_lines))
            ...
            if environment not in  ['prod']:
                ...
                lines = list(filter(lambda x: str(x).startswith("b'2022-"), lines)) # TODO: 2024年要更换一下吧?
            else:
                lines = []
