...
from ProdWork.log_analyse.java_log_parse_str.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        environment_lst = ['UAT']  # ,'UAT_75_77_78','UAT_79_81_82','UAT_50_51_83','UAT_lite','UAT_other']# ['prod','UAT','night','test1','SZEX','SHEX','UAT_49_53','UAT_50_51','UAT_lite','UAT_other']#[:1]#
        ...
        for environment in environment_lst: #[:2] + environment_lst[4:]:#['night']:#['UAT','UAT_other']:#['night','night_other']:#['night_origin3']:#['night_origin3','night_50_51','night_49_53']:#['UAT_lite']:#
            ...
            if environment == 'night':
                file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy.log.gz/StrongStrategy-' + tradeDate + '.log'
            print(file_name)
