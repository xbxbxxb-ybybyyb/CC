...
log_fpath = 'MimasStrategy-2025-07-24-20250729230956-407-0-00000000.log.gz'
...
def parse_log2df(fpath):
    ...
    for line in lines:
        ...
        add_excel('to UniTradeTool', log_time, line, log_tuple_list)
...
if __name__ == '__main__':
    ...
    log_df.to_excel(junk_path + 'ceres1_log_df.xlsx')