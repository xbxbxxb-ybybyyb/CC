...
from ProdWork.log_analyse.jupiter_log_parse.tmp20240704.LogParse_Tool import LogParse_Tool
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                ...
                file_name = '/data/user/013551/forXT/Jupiter/202410110002/20241008_shsz.log'
            print(file_name)
            ...
            lines = list(filter(lambda x: str(x).startswith("2024-"), lines))  # TODO: 2024年要更换一下吧?
