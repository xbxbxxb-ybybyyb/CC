...
from ProdWork.log_analyse.jupiter_log_parse.tmp20241017.LogParse_Tool import LogParse_Tool
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                ...
                # file_name = '/data/user/013551/forXT/Jupiter/202410110002/20241009_shsz.log'
                file_name = f'/data/user/013551/forXT/202411040002/model_combine/jupiter_{tradeDatestr}.log'
            print(file_name)
            ...
            if environment == 'prod' and os.path.exists(o45file_SHname):
                ...
                o45_SHlines = []
            # log_list = os.listdir('/data/group/800463/StrategyLog/prd/0704')
            # lines = []
            # for fname in log_list:
            #     g_file = open(f'/data/group/800463/StrategyLog/prd/0704/{fname}')
