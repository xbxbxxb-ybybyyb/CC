...
from ProdWork.log_analyse.prod.cpp.LogParse_Tool import LogParse_Tool
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'UAT':
                ...
                # file_name = '/data/group/800463/StrategyLog/sim/log_bak/EventDrivenCpp-%s.log.gz' % '2024-10-19'
                # file_name = '/data/group/800463/日内强势股/log/EventDrivenCpp-' + tradeDate + '-UAT.log.gz'
            ...
            if environment == 'night':
                ...
                # file_name = '/data/group/800463/StrategyLog/sim/EventDrivenCpp-%s.log.gz' % tradeDate
                # file_name = '/data/group/800463/StrategyLog/sim/log_bak/EventDrivenCpp-2024-10-12.log.gz'
            if environment == 'prod':
            ...
            # inf_df001 = inf_df001.reset_index().drop_duplicates('index').set_index('index')
            # daily_zt_df001 = daily_zt_df001.reset_index().drop_duplicates('index').set_index('index')
