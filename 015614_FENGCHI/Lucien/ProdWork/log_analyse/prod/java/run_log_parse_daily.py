...
from ProdWork.log_analyse.prod.java.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        environment_lst = ['prod', 'SZEX', 'SHEX', 'UAT']  # ,'UAT_75_77_78','UAT_79_81_82','UAT_50_51_83','UAT_lite','UAT_other']# ['prod','UAT','night','test1','SZEX','SHEX','UAT_49_53','UAT_50_51','UAT_lite','UAT_other']#[:1]#
        # environment_lst = ['night']  # ,'UAT_75_77_78','UAT_79_81_82','UAT_50_51_83','UAT_lite','UAT_other']# ['prod','UAT','night','test1','SZEX','SHEX','UAT_49_53','UAT_50_51','UAT_lite','UAT_other']#[:1]#
        # environment_lst =['prod', 'SZEX', 'SHEX', 'UAT_49_53']
        # environment_lst =['night']
        # environment_lst =['SHEX']
        # environment_lst = ['UAT_lite']
        # environment_lst =['test']
        # environment_lst =['UAT']
        for environment in environment_lst: #[:2] + environment_lst[4:]:#['night']:#['UAT','UAT_other']:#['night','night_other']:#['night_origin3']:#['night_origin3','night_50_51','night_49_53']:#['UAT_lite']:#
            print(tradeDate, environment, '\n')
            # ------------ 按环境加载日志的目录 ---------------
            import gzip
            # file_name = '/data/group/800463/StrategyLog/prd/StrongStrategy-%s.log.gz' % tradeDate
            # file_name = '/data/group/800463/StrategyLog/prd/SHEX.StrongStrategy-%s.log.gz' % tradeDate
            file_name = '/data/group/800463/日内强势股/log/StrongStrategy-%s-%s.log.gz' % (tradeDate, environment)
            if environment == 'UAT':
            ...
            if environment == 'UAT_other':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_other.log.gz'
            if environment == 'UAT_lite':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/20230804_new/StrongStrategy-' + tradeDate + '-uat_lite.log.gz'
            if environment == 'UAT_75_77_78':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_75_77_78.log.gz'
            if environment == 'UAT_79_81_82':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_79_81_82.log.gz'
            if environment == 'UAT_50_51_83':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_50_51_83.log.gz'
            if environment == 'UAT_50_51':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_50_51.log.gz'
            if environment == 'UAT_49_53':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-uat_49_53.log.gz'
            if environment == 'SZEX_udp':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-SZEX_udp.log.gz'
            ...
            if environment == 'SHEX':
                ...
                #file_name = '/data/group/800463/StrategyLog/prd/SHEX.StrongStrategy-' + tradeDate + '.log.gz'
            if environment == 'SZEX':
                file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-SZEX.log.gz'
                #file_name = '/data/group/800463/StrategyLog/prd/SZEX.StrongStrategy-' + tradeDate + '.log.gz'
            if environment == 'night':
                file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy.log.gz/StrongStrategy-' + tradeDate + '.log.gz'
            print(file_name)
            ...
            o45file_name = '/data/group/800463/StrategyLog/prd/SZEX.StrongStrategy-' + tradeDate + '.log.gz'#'/data/group/800463/日内强势股/log/StrongStrategy-%s-SZEX.log.gz'#
            # o45file_name = '/data/group/800463/xiely/日内强势股/log/StrongStrategy-' + tradeDate + '-SZEX.log.gz'
            o45file_SHname = '/data/group/800463/StrategyLog/prd/SHEX.StrongStrategy-' + tradeDate + '.log.gz'
            ...
            if environment == 'prod' and os.path.exists(o45file_name):
                ...
                o45_lines = list(filter(lambda x: str(x).startswith("b'2025-"), o45_lines))
                #o45_lines = list(filter(lambda x: str(x).find("2022-02-14T"), o45_lines))
                print('SZ',len(o45_lines))
                copyfile(o45file_name, '/data/group/800463/日内强势股/log/StrongStrategy-%s-SZEX.log.gz' % tradeDate)
                print('from %s to /data/group/800463/日内强势股/log/StrongStrategy-%s-SZEX.log.gz 上传成功' % (o45file_name, tradeDate))
            else:
                o45_lines = []
            if environment == 'prod' and os.path.exists(o45file_SHname):
                ...
                o45_SHlines = list(filter(lambda x: str(x).startswith("b'2025-"), o45_SHlines))
            ...
            if environment not in  ['prod']:
                ...
                lines = list(filter(lambda x: str(x).startswith("b'2025-"), lines)) # TODO: 2024年要更换一下吧?
            else:
                lines = []
            lines = lines + o45_lines + o45_SHlines
            # lines = list(filter(lambda x: str(x).find("20230509-084957-907-0000001-168.70.8.166") < 0, lines))  # d20230509进行去重操作
            ...
            # 拆分日志
            log_split_file_path = '/data/group/800463/日内强势股/log_parse/日志拆分/%s_%s环境/' % (tradeDatestr, environment)
            if os.path.exists(log_split_file_path):
                shutil.rmtree(log_split_file_path)
            os.makedirs(log_split_file_path, exist_ok=True)
            ...
            # 拆分日志复制第二份
            log_split_file_path = '/data/group/800463/日内强势股/java_log_parse/日志拆分/%s_%s环境/' % (tradeDatestr, environment)
            if os.path.exists(log_split_file_path):
                shutil.rmtree(log_split_file_path)
            os.makedirs(log_split_file_path, exist_ok=True)
            for code, log in logparse.log_dic.items():
            ...
            # TODO: 很多返回变量
            inf_df_, inf_df_pj2_930, inf_df_pj2_931, factor_df, trade_dic, now_trade_dic, all_code_model_data, all_code_model_data_pj2_930, \
            all_code_model_data_pj2_931, daily_zt_df, daily_pj2_df, order_info_df, unfilled_info_df, factor_df_pj2_930, factor_df_pj2_931, \
            new_trade_dic, factor_df_pj3_931, inf_df_pj3_931, factor_df_pj3_930, inf_df_pj3_930, daily_pj3_df, \
            ...
            factor_df_pj2_931_sell,factor_df_pj2_930_sell = logparse.get_inf_from_log(use_zuhe, zuhe_list)

            # inf_df_ = inf_df_.reset_index().drop_duplicates('index', keep='first').set_index('index')
            inf_df_ = inf_df_.reset_index().sort_values(['index','ZT_Time']).drop_duplicates('index', keep='first').set_index('index')

            except_df = logparse.get_except_df()

            # inf_df.to_excel('A:/wangwd/日内强势股/java_log_parse/因子耗时/因子耗时_io_fixed_%s_%s.xlsx'%(tradeDate, environment))
            ...
            factor_df.loc[save_index].sort_index().to_excel('/data/group/800463/日内强势股/log_parse/因子数据/因子数据_%s_%s.xlsx' % (tradeDate, environment))
            factor_df.loc[save_index].sort_index().to_excel('/data/group/800463/日内强势股/java_log_parse/因子数据/因子数据_%s_%s.xlsx' % (tradeDate, environment))
            print('create file %s' % '/data/group/800463/日内强势股/java_log_parse/因子数据/因子数据_%s_%s.xlsx' % (tradeDate, environment))
            factor_df001.loc[save_index001].sort_index().to_excel('/data/group/800463/日内强势股/log_parse/因子数据/因子数据New_%s_%s.xlsx' % (tradeDate, environment))
            factor_df001.loc[save_index001].sort_index().to_excel('/data/group/800463/日内强势股/java_log_parse/因子数据/因子数据New_%s_%s.xlsx' % (tradeDate, environment))
            print('create file %s'%'/data/group/800463/日内强势股/java_log_parse/因子数据/因子数据New_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'930':factor_df_pj2_930, '931':factor_df_pj2_931},'/data/group/800463/日内强势股/log_parse/因子数据/项目二因子数据_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'930':factor_df_pj2_930, '931':factor_df_pj2_931},'/data/group/800463/日内强势股/java_log_parse/因子数据/项目二因子数据_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'931sell': factor_df_pj2_931_sell,
                         '930sell': factor_df_pj2_930_sell},
                        '/data/group/800463/日内强势股/log_parse/因子数据/卖出Sell13因子数据_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'931sell': factor_df_pj2_931_sell,
                         '930sell': factor_df_pj2_930_sell},
                        '/data/group/800463/日内强势股/java_log_parse/因子数据/卖出Sell13因子数据_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'930':factor_df_pj3_930,
                         '931': factor_df_pj3_931},
                        '/data/group/800463/日内强势股/log_parse/因子数据/项目三因子数据_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver({'930': factor_df_pj3_930,
                         '931': factor_df_pj3_931},
                        '/data/group/800463/日内强势股/java_log_parse/因子数据/项目三因子数据_%s_%s.xlsx' % (tradeDate, environment))
            # factor_df_all.to_excel('/data/group/800463/日内强势股/java_log_parse/因子数据/全部因子数据_%s_%s.xlsx' % (tradeDate, environment))
            # factor_df_all.to_pickle('/data/group/800463/日内强势股/java_log_parse/因子数据/全部因子数据_%s_%s.pkl' % (tradeDate, environment))

            if len(except_df) > 0:
                except_df.to_excel('/data/group/800463/日内强势股/log_parse/异常报错/异常报错_%s_%s.xlsx' % (tradeDate, environment))
                except_df.to_excel('/data/group/800463/日内强势股/java_log_parse/异常报错/异常报错_%s_%s.xlsx' % (tradeDate, environment))
                print('create file %s' % '/data/group/800463/日内强势股/java_log_parse/异常报错/异常报错_%s_%s.xlsx' % (tradeDate, environment))

            md_data_path = '/data/group/800463/日内强势股/log_parse/行情数据/%s_%s/' % (tradeDate, environment)
            md_data_path2 = '/data/group/800463/日内强势股/java_log_parse/行情数据/%s_%s/' % (tradeDate, environment)
            model_factor_data_path = '/data/group/800463/日内强势股/log_parse/模型数据/%s_%s/' % (tradeDate, environment)
            model_factor_data_path2 = '/data/group/800463/日内强势股/java_log_parse/模型数据/%s_%s/' % (tradeDate, environment)
            if not os.path.exists(md_data_path):
                os.makedirs(md_data_path)
                os.makedirs(md_data_path2)
            if not os.path.exists(model_factor_data_path):
                os.makedirs(model_factor_data_path)
                os.makedirs(model_factor_data_path2)
            ...
            excel_saver(tupo_excel_dic, '/data/group/800463/日内强势股/实盘分析记录/每日突破/每日突破_%s_%s.xlsx' % (tradeDatestr, environment))
            excel_saver(tupo_excel_dic, '/data/group/800463/日内强势股/java_实盘分析记录/每日突破/每日突破_%s_%s.xlsx' % (tradeDatestr, environment))

            if (environment == 'prod') | (environment == 'SHEX') | (environment in [ 'SZEX','SZEX_udp']):
                ...
                # -------------- 生产上才分析未成交的原因 -------------------
                if environment == 'prod':
                    hist_non_trade = pd.read_excel('/data/group/800463/日内强势股/java_log_parse/因子耗时/因子耗时_%s_%s.xlsx'% (lastdate_h, environment),sheet_name = '未成交统计')
                    hnt_need_col = list(hist_non_trade.columns)
                    hnt_need_col.remove('Unnamed: 0')
                    hist_non_trade = hist_non_trade[hnt_need_col]
                    if len(buy_statistics) != 0:
                        buy_no_deal_stock_list = list(buy_statistics[(buy_statistics['买入当日成交笔数'] == 0) &
                                                              (buy_statistics['买入当日挂单笔数'] != 0)].index)
                        ...
                        for stock in buy_no_deal_stock_list:
                            ...
                            daily_zt_df = pd.read_excel('/data/group/800463/日内强势股/java_实盘分析记录/每日突破/每日突破_%s_%s.xlsx' % (tradeDatestr, 'prod')).set_index(['Unnamed: 0']) # 目前是jupiter的统计，后续修改jupiter001
            ...
            excel_saver(inf_df_dic, '/data/group/800463/日内强势股/log_parse/因子耗时/因子耗时_%s_%s.xlsx' % (tradeDate, environment))
            excel_saver(inf_df_dic, '/data/group/800463/日内强势股/java_log_parse/因子耗时/因子耗时_%s_%s.xlsx' % (tradeDate, environment))
            ...
            if logparse.environment in ['prod','UAT']:
                ...
                ftp_upload(f,'XQuant/013550/temp/因子耗时_%s_%s.xlsx'%(tradeDate,environment),
                           '/data/group/800463/日内强势股/java_log_parse/因子耗时/因子耗时_%s_%s.xlsx'%(tradeDate,environment))
    ...
    send_message(f'{tradeDate}实盘java日志已解析')
