    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'prod' and os.path.exists(o45file_name):
                ...
                copyfile(o45file_name,'/data/group/800463/日内强势股/metis_log/SZEX.MetisStrategy-%s.log.gz' % tradeDate)
                print('from %s to /data/group/800463/日内强势股/metis_log/SZEX.MetisStrategy-%s.log.gz 上传成功' % (o45file_name, tradeDate))
            else:
                o45_lines = []
            if environment == 'prod' and os.path.exists(o45file_SHname):
                ...
                copyfile(o45file_SHname, '/data/group/800463/日内强势股/metis_log/SHEX.MetisStrategy-%s.log.gz' % tradeDate)
                print('from %s to /data/group/800463/日内强势股/metis_log/SHEX.MetisStrategy-%s.log.gz 上传成功' % (o45file_SHname, tradeDate))
            else:
                o45_SHlines = []
