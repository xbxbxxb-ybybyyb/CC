...
from ProdWork.log_analyse.cpp_local_log_parse.xdev_cpp_log_parse20250418.LogParse_Tool import LogParse_Tool
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                ...
                file_name = f'/data/user/013551/forXT/202503120002/europa/europa_20250530_shsz.log'
            if environment == 'xdev':
            ...
            if environment not in  ['prod']:
                ...
                lines = list(filter(lambda x: 'Test4' in str(x) and 'INFO' in str(x), lines))
            else:
                lines = []
