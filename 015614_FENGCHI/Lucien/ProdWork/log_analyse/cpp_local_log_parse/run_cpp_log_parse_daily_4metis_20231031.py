    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                ...
                file_name = '/data/group/800463/日内强势股/cpp_log/sim/EventDrivenStrategy-2023-10-30.log'
            print(file_name)
            ...
            if environment not in  ['prod']:
                ...
                lines = list(filter(lambda x: str(x).startswith("2023-10-30T") and 'INFO' in str(x), lines))
            else:
                lines = []
