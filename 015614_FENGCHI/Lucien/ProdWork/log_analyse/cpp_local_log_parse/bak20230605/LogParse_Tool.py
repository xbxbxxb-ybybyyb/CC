...
from ProdWork.CommonTools import excel_saver, ftp_download,ftp_upload,getValueByKeyFromLine,strTime2MDTime,isException,cal_time_delta,trans_str2dic,getMriskFlag,getRejectReason,getMriskInfo
class LogParse_Tool:
    def __init__(self, environment,date,log_line):
        self.environment = str(environment)
        self.date = str(date)
        self.log_lines = log_line
        self.lines = list(map(self.openpx_determine, log_line))
