        ...
        for key, log in self.log_dic.items():
            ...
            if key_code != '601688.SH':
                ...
                for line in log:
                    ...
                    elif ('riskSummary' in line) & ('拉抬打压' in line) & ('Saturn' not in line)& ('Ceres' not in line) & ('JupiterNew' not in line):
                    ...
                    elif ('isSkip' in line) & ('Saturn' not in line) & ('Ceres' not in line) & ('JupiterNew' not in line):
