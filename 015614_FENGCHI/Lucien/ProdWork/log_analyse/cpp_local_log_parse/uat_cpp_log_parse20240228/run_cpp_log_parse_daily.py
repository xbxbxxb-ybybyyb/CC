...
from ProdWork.log_analyse.cpp_local_log_parse.uat_cpp_log_parse20240228.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'UAT':
                # file_name = '/data/group/800463/StrategyLog/sim/EventDrivenCpp-%s-night.log.gz' % tradeDate
                file_name = '/data/group/800463/StrategyLog/sim/EventDrivenCpp-2024-10-26.log.gz'
            ...
            lines = list(filter(lambda x: str(x).startswith("b'2024-"), lines))  # TODO: 2024年要更换一下吧?
