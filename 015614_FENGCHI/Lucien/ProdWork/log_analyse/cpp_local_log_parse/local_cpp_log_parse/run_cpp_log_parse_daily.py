...
from ProdWork.log_analyse.cpp_local_log_parse.local_cpp_log_parse.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                # file_name = f'/data/group/800463/xiely/save-file/forFc/log/log_local_{tradeDate.replace("-", "")}_new.txt'
                # file_name = '/data/group/800463/StrategyLog/sim/EventDrivenCpp-2023-08-17.log.gz'
                # file_name = '/data/group/800463/StrategyLog/sim/EventDrivenStrategy-2023-08-17.log'
