...
from ProdWork.log_analyse.leda_log_parse.uat.LogParse_Tool import LogParse_Tool


if __name__ == "__main__":
    tradeDate = dt.datetime.now().strftime('%Y-%m-%d')
    tradeDate = '2025-03-27'    # 当天即可
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'night':
                ...
                file_name = '/data/group/800463/StrategyLog/sim/LedaStrategy.log.gz/LedaStrategy-%s.log.gz' % tradeDate
            if environment == 'prod':
                # log_file_path = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '.log'
                file_name = '/data/group/800463/StrategyLog/prd/LedaStrategy-%s.log.gz' % tradeDate
            ...
            if environment == 'test':
                ...
                file_name = '/data/user/013551/forXT/Leda/log/20241030/20241008-sh.leda.log.gz'
                file_name = f'/data/user/013551/forXT/Leda/log/20250408/for_test/leda_{nowdate}.log'
            print(file_name)
