...
from ProdWork.log_analyse.jupiterBj_log_parse.test.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            lines = list(filter(lambda x: str(x).startswith('2024-'), lines))
