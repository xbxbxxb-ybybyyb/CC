...
from ProdWork.log_analyse.jupiterBj_log_parse.uat.LogParse_Tool import LogParse_Tool
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            # ------------ 按环境加载日志的目录 ---------------
            import gzip
            file_name = f'/data/group/800463/StrategyLog/prd/{environment}.JupiterStrategy-{tradeDate}.log.gz'
            if environment == 'UAT':
                # file_name = '/data/group/800463/StrategyLog/sim/JupiterStrategy-%s-night.log.gz' % tradeDate
                # file_name = '/data/group/800463/日内强势股/log/sim/JupiterStrategy-%s.log.gz' % tradeDate
                # file_name = '/data/group/800463/StrategyLog/sim/JupiterStrategy-2024-10-26.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-20250103111116-133-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-20250115160128-834-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-20250124090636-751-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-2025-02-06-20250206090218-496-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-2025-02-06-20250206090218-496-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-2025-02-06-20250206090218-496-0-00000000.log.gz'
                # file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-2025-02-07-20250207090439-589-0-00000000.log.gz'
                file_name = '/data/group/800463/StrategyLog/xsim/JupiterStrategy_BJ-2025-02-14-20250303085425-415-0-00000000.log.gz'
            if environment == 'UAT_lite':
                #file_name = '/data/group/800463/StrategyLog/sim/StrongStrategy-%s.log.gz' % tradeDate
                file_name = '/data/group/800463/日内强势股/log/JupiterStrategy-' + tradeDate + '-uat_lite.log.gz'
            if 'night' in environment:
                ...
                file_name = '/data/group/800463/StrategyLog/sim/JupiterStrategy.log.gz/JupiterStrategy-%s.log.gz' % tradeDate
            if environment == 'prod':
                # log_file_path = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '.log'
                file_name = '/data/group/800463/StrategyLog/prd/JupiterStrategy-%s.log.gz' % tradeDate
            ...
            if environment == 'SHEX':
                ...
                file_name = '/data/group/800463/StrategyLog/prd/SHEX.JupiterStrategy-' + tradeDate + '.log.gz'
            if environment == 'SZEX':
                # file_name = '/data/group/800463/日内强势股/log/StrongStrategy-' + tradeDate + '-SZEX.log.gz'
                file_name = '/data/group/800463/StrategyLog/prd/SZEX.JupiterStrategy-' + tradeDate + '.log.gz'
            if environment == 'test':
                ...
                file_name = f'/data/user/013551/forXT/Jupiter_BJ/local/dev_log/xdev_replay_log/jupiter_bj_{tradeDatestr}.log'
            print(file_name)

            # FIXME：分别是IT传进来和谢璐遥传进来的
            o45file_name = '/data/group/800463/StrategyLog/prd/SZEX.JupiterStrategy-' + tradeDate + '.log.gz' # '/data/group/800463/日内强势股/log/StrongStrategy-%s-SZEX.log.gz'#
            # o45file_name = '/data/group/800463/xiely/日内强势股/log/JupiterStrategy-' + tradeDate + '-SZEX.log.gz'
            ...
            if environment == 'prod' and os.path.exists(o45file_name):
                ...
                copyfile(o45file_name,'/data/group/800463/日内强势股/log/SZEX.JupiterStrategy-%s.log.gz' % tradeDate)
                print('from %s to /data/group/800463/日内强势股/log/SZEX.JupiterStrategy-%s.log.gz 上传成功' % (o45file_name, tradeDate))
            else:
                o45_lines = []
            if environment == 'prod' and os.path.exists(o45file_SHname):
                ...
                copyfile(o45file_SHname, '/data/group/800463/日内强势股/log/SHEX.JupiterStrategy-%s.log.gz' % tradeDate)
                print('from %s to /data/group/800463/日内强势股/log/SHEX.EventDrivenCpp-%s.log.gz 上传成功' % (o45file_SHname, tradeDate))
            else:
                o45_SHlines = []
            if environment == 'UAT' and os.path.exists(file_name):
                uat_file = gzip.GzipFile(file_name)
                uat_lines = uat_file.readlines()
                # copyfile(file_name, '/data/group/800463/日内强势股/log/sim/JupiterStrategy-%s.log.gz' % tradeDate)
                # print('from %s to /data/group/800463/日内强势股/log/sim/JupiterStrategy-%s.log.gz 上传成功' % (file_name, tradeDate))
            ...
            # 拆分日志
            log_split_file_path = '/data/group/800463/日内强势股/jupiterBj_log_parse/日志拆分/%s_%s环境/' % (tradeDatestr, environment)
            ...
            # TODO: 很多返回变量
            inf_df_, factor_df, trade_dic, now_trade_dic, all_code_model_data, daily_zt_df, order_info_df, unfilled_info_df, new_trade_dic = logparse.get_inf_from_log(use_zuhe, zuhe_list)
            ...
            factor_df.loc[save_index].sort_index().to_excel('/data/group/800463/日内强势股/jupiterBj_log_parse/因子数据/因子数据_%s_%s.xlsx' % (tradeDate, environment))
            print('create file %s' % '/data/group/800463/日内强势股/jupiterBj_log_parse/因子数据/因子数据_%s_%s.xlsx' % (tradeDate, environment))

            if len(except_df) > 0:
                except_df.to_excel('/data/group/800463/日内强势股/jupiterBj_log_parse/异常报错/异常报错_%s_%s.xlsx' % (tradeDate, environment))
                print('create file %s' % '/data/group/800463/日内强势股/jupiterBj_log_parse/异常报错/异常报错_%s_%s.xlsx' % (tradeDate, environment))
            md_data_path = '/data/group/800463/日内强势股/jupiterBj_log_parse/行情数据/%s_%s/' % (tradeDate, environment)

            model_factor_data_path = '/data/group/800463/日内强势股/jupiterBj_log_parse/模型数据/%s_%s/' % (tradeDate, environment)
            ...
            excel_saver(tupo_excel_dic, '/data/group/800463/日内强势股/jupiterBj_log_parse/每日突破/每日突破_%s_%s.xlsx' % (tradeDatestr, environment))
            ...
            if (environment == 'prod') | (environment == 'SHEX') | (environment in [ 'SZEX','SZEX_udp', 'SHEX_beta']):
                ...
                # -------------- 生产上才分析未成交的原因 -------------------
                if environment == 'prod':
                    hist_non_trade = pd.read_excel('/data/group/800463/日内强势股/jupiterBj_log_parse/因子耗时/因子耗时_%s_%s.xlsx'% (lastdate_h, environment),sheetname = '未成交统计')
            ...
            excel_saver(inf_df_dic, '/data/group/800463/日内强势股/jupiterBj_log_parse/因子耗时/因子耗时_%s_%s.xlsx' % (tradeDate, environment))