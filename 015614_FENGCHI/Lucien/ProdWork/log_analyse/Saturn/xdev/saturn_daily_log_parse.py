...
from ProdWork.log_analyse.Saturn.xdev.LogParse import LogParse
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment in ['thread', 'xdev', 'xdev2']:
                ...
                # file_name = f'/data/user/013551/forXT/Saturn/log/20250319/saturn_{tradeDatestr}_shsz.log'
                # file_name = f'/data/user/013551/forXT/Saturn/log/20250320/xdev_saturn_{tradeDatestr}.log'
                file_name = f'/data/user/013551/forXT/Saturn/log/20240323/xdev_saturn_{tradeDatestr}_v2.log'
                # file_name = f'/data/user/013551/forXT/Saturn/log/20240419/20240416_002812.SZ.log.new'
