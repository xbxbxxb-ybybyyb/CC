...
from ProdWork.log_analyse.Saturn.uat.LogParse import LogParse
...
if __name__ == "__main__":
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            inf_df_saturn.index.names = ['Unnamed: 0']
            ...
            elif environment in ['UAT', 'night', 'test', 'thread']:
                inf_df_dic = {'因子耗时Saturn': inf_df_saturn,
