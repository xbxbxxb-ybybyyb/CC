...
from ProdWork.log_analyse.Ceres.xdev.LogParse import LogParse
    ...
    for date in s.tradingday(begindate, enddate):
        ...
        for environment in environment_lst:
            ...
            if environment == 'test':
                ...
                file_name = f'/data/user/015614/shared/for_XT/Ceres/logs/20250516.log'
            if environment in ['thread', 'xdev', 'xdev2', 'xdev3', 'night']:
