...
jup_lattern = pd.read_hdf('/data/group/800463/project/project1_prod/left_v2212/Basic_zt/Basic_zt.h5')[['label_pattern']]
...
new_samples = list(sorted(list(set(jupiter_samples.index).union(europa_samples.index).union(metis_samples.index))))
...
# ret_list = get_stk_pattern(new_samples)
