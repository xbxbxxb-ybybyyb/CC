...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        # date = '20250318' # 若未在当个交易日晚上运行程序，需要在次日早上修改date
    ...
    def updatePositionBuy(buyDf, resDf, resDf_pj2, resDf_pj3, logDf, buy_orderDf, resDf001, logDf001, buy_metis_orderDf, logDf_metis, logDf_leda):
        ...
        return resDf, resDf_pj2, resDf_pj3, resDf001, resDf_metis, resDf_leda
    ...
    resDf1, resDf1_pj2, resDf1_pj3, resDf1001, resDf1_metis, resDf1_leda = updatePositionBuy(todayBuyDf.copy(), historyBuyDf.copy(), historyBuyDf_pj2.copy(),
