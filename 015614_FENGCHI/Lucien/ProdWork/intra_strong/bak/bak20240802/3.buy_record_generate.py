...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        # date = '20240603' # 若未在当个交易日晚上运行程序，需要在次日早上修改date
    ...
    leda_sz_queryFile = '/data/group/800463/xiely/daily-track-cpp/%s-SZEX/接口查询统计_20240401_20240913_SZEX_Leda.xlsx' % (date, date)
    leda_sh_queryFile = '/data/group/800463/xiely/daily-track-cpp/%s-SHEX/接口查询统计_20240401_20240913_SHEX_Leda.xlsx' % (date, date)
    ...
    leda_query = cal_querymetric(leda_sz_queryFile, leda_sh_queryFile)    # NOTE：从20240918 leda新需求上线后，不走自营最后一笔委托查询分支
    ...
    basic_file_raw_add['是否触发查询'] = np.nan
    basic_file_raw_add['是否之前有成交'] = np.nan
