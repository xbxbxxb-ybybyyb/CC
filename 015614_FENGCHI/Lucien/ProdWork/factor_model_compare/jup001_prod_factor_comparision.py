...
def factor_comparison(local_data_path, local_factor_path,UAT_factor_path,daily_zuhe_path,date,date_hyphen
    ...
    # TODO：少森给这个文件路径
    while not os.path.exists(local_factor_path + 'all_factor_zt_merge_v2412_%s_europa.pkl' % (date)):
        print(f'缺失{local_factor_path}' + f'all_factor_zt_merge_v2412_{date}_europa.pkl')
        time.sleep(60)
    python_factors = pd.read_pickle(local_factor_path + 'all_factor_zt_merge_v2412_%s_europa.pkl' % (date))
...
if __name__ == '__main__':
    ...
    for date in datelist:
        ...
        for environment in environment_lst:
            ...
            local_factor_path = '/data/group/800463/project/project1_prod/right_v2412/daily_data/%s_europa/' % (str(date))
