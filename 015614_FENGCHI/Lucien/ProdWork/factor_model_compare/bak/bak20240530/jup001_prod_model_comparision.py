...
if __name__ == '__main__':
    ...
    for nowdate in datelist:
        ...
        filter_black_list = pd.read_excel(f'/data/user/015614/daily/灰名单生成/黑名单/black_list_{tradeDatestr}.xlsx')['股票代码'].tolist()
        ...
        for environment in env_list:
            ...
            # TODO: sss提供
            param = pd.read_pickle(f'/data/group/800463/project/project1_prod/right_v2304/daily_data/{nowdate}_europa/all_factor_zt_merge_v2304_{nowdate}_europa.pkl')
