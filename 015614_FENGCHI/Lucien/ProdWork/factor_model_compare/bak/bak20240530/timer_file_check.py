...
while True:
    ...
    if lost_file_num == 0:
        # 提醒双姐
        send_message(f'{trade_date}因子和模型对比文件均以生成——发送人：冯炽', ['015614', '003371'])  # 添加发送给双姐的
        # 提醒同事
        send_message(f'{trade_date}因子和模型对比文件均以生成', ['021012', '018107', '013550'])  # 添加发送给其他同事的
        # send_message(f'{trade_date}因子和模型对比文件均以生成——发送人：冯炽', ['015614'])
        print(f'{trade_date}因子和模型对比文件均以生成——发送人：冯炽')
        break
    else:
