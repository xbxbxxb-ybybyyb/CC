...
if __name__ == '__main__':
    ...
    for nowdate in datelist:
        ...
        for environment in env_list:
            ...
            # TODO: sss提供
            all_df = pd.read_pickle(f'/data/group/800463/project/project1_prod/right_v2212/daily_data/{nowdate}/all_factor_zt_merge_v2212_{nowdate}.pkl')
            ...
            local_factor_fpath = '/data/group/800463/project/project1_prod/right_v2212/daily_data/%s/all_factor_zt_merge_v2212_%s.pkl' % (tradeDateInt, tradeDateInt)
            import time
