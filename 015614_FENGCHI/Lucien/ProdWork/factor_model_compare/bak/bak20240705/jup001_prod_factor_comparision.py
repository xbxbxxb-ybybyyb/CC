...
def factor_comparison(local_data_path, local_factor_path,UAT_factor_path,daily_zuhe_path,date,date_hyphen
    ...
    # TODO：少森给这个文件路径
    while not os.path.exists(local_factor_path + 'all_factor_zt_merge_v2304_%s_europa.pkl' % (date)):
        print(f'缺失{local_factor_path}' + f'all_factor_zt_merge_v2304_{date}_europa.pkl')
        time.sleep(60)
    python_factors = pd.read_pickle(local_factor_path + 'all_factor_zt_merge_v2304_%s_europa.pkl' % (date))

    basic_df = python_factors.copy()
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # date = '20240315'  # TODO:night夜间仿真，修改成下一天的日期，比如对比25号的回放，这里要改成26号下一个交易日
    ...
    for date in datelist:
        ...
        if sys.argv[2:]:
            ...
            # environment_lst = ['SZEX','SHEX_beta','UAT','UAT_50_51','UAT_49_53']
