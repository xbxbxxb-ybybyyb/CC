...
for date in s.tradingday(year_start_date, end_date):
    this_date_basic = pd.read_hdf('/data/group/800463/project/project1_prod/generalStrong_v3/daily_data/%s/Basic_zt_%s_%s.h5' % (date, date, date))
