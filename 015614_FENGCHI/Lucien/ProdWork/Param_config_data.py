...
path_jup_v10 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_jpt_v10.json'
with open(path_jup_v10, 'r', encoding='utf-8') as file_name:
    thred_jup_v10 = json.load(file_name)
    thred_pd_jup_v10 = pd.DataFrame(thred_jup_v10)
thred_dict_jup_v10 = dict(zip(thred_pd_jup_v10['parentPath'].tolist(),thred_pd_jup_v10['modelThres'].tolist()))

# jupiter北交所
path_jup_v10 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_bjs_v1.json'
with open(path_jup_v10, 'r', encoding='utf-8') as file_name:
    thred_jup_bjs_v1 = json.load(file_name)
    thred_pd_jup_bjs_v1 = pd.DataFrame(thred_jup_bjs_v1)
thred_dict_jup_bjs_v1 = dict(zip(thred_pd_jup_bjs_v1['parentPath'].tolist(),thred_pd_jup_bjs_v1['modelThres'].tolist()))
...
path_jup001_v4 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_eur_v4.json'
with open(path_jup001_v4, 'r', encoding='utf-8') as file_name:
    thred_jup001_v4 = json.load(file_name)
    thred_pd_jup001_v4 = pd.DataFrame(thred_jup001_v4)
thred_dict_jup001_v4 = dict(zip(thred_pd_jup001_v4['parentPath'].tolist(),thred_pd_jup001_v4['modelThres'].tolist()))
...
#%% Metis
path_metis_v1 = '/data/group/800463/xiely/save-file/forFc/sp/metis_v1_config.json'
with open(path_metis_v1, 'r', encoding='utf-8') as file_name:
    thred_metis_v1 = json.load(file_name)
    thred_pd_metis_v1 = pd.DataFrame(thred_metis_v1)
thred_dict_metis_v1 = dict(zip(thred_pd_metis_v1['parentPath'].tolist(), thred_pd_metis_v1['modelThres'].tolist()))

#%% Leda
path_leda_v1 = '/data/group/800463/xiely/save-file/forFc/sp/leda_v1_config.json'
with open(path_leda_v1, 'r', encoding='utf-8') as file_name:
    thred_leda_v1 = json.load(file_name)
    thred_pd_leda_v1 = pd.DataFrame(thred_leda_v1)
thred_dict_leda_v1 = dict(zip(thred_pd_leda_v1['parentPath'].tolist(), thred_pd_leda_v1['modelThres'].tolist()))
...
path_s1_v6 = '/data/group/800463/xiely/save-file/forFc/sp/saturn_v6_config.json'
with open(path_s1_v6, 'r', encoding='utf-8') as file_name:
    thred_pj2_931_v6 = json.load(file_name)
    thred_pd_pj2_931_v6 = pd.DataFrame(thred_pj2_931_v6)
thred_dict_pj2_931_v6 = dict(zip(thred_pd_pj2_931_v6['parentPath'].tolist(),thred_pd_pj2_931_v6['modelThres'].tolist()))

path_s1_v7 = '/data/group/800463/xiely/save-file/forFc/sp/saturn_v7_config.json'
with open(path_s1_v7, 'r', encoding='utf-8') as file_name:
    thred_pj2_931_v7 = json.load(file_name)
    thred_pd_pj2_931_v7 = pd.DataFrame(thred_pj2_931_v7)
thred_dict_pj2_931_v7 = dict(zip(thred_pd_pj2_931_v7['parentPath'].tolist(),thred_pd_pj2_931_v7['modelThres'].tolist()))

#%% Ceres v4 type1
path_ceres_v4 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_ceres_v1.json'
with open(path_ceres_v4, 'r', encoding='utf-8') as file_name:
    thred_ceres_v4 = json.load(file_name)
    thred_pd_ceres_v4 = pd.DataFrame(thred_ceres_v4)
thred_dict_ceres_v4 = dict(zip(thred_pd_ceres_v4['parentPath'].tolist(), thred_pd_ceres_v4['modelThres'].tolist()))

#%% P4 v1 type2
path_p4_v1 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_p4_v1.json'
with open(path_p4_v1, 'r', encoding='utf-8') as file_name:
    thred_p4_v1 = json.load(file_name)
    thred_pd_p4_v1 = pd.DataFrame(thred_p4_v1)
thred_dict_p4_v1 = dict(zip(thred_pd_p4_v1['parentPath'].tolist(), thred_pd_p4_v1['modelThres'].tolist()))

#%% mimas v1
path_mimas_v1 = '/data/group/800463/xiely/save-file/for_wj/modelPathConfig_mimas_v1.json'
with open(path_mimas_v1, 'r', encoding='utf-8') as file_name:
    thred_mimas_v1 = json.load(file_name)
    thred_pd_mimas_v1 = pd.DataFrame(thred_mimas_v1)
thred_dict_mimas_v1 = dict(zip(thred_pd_mimas_v1['parentPath'].tolist(), thred_pd_mimas_v1['modelThres'].tolist()))
