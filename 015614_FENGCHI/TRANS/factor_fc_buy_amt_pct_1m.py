# coding: utf-8
# Author：fengchi863
# Date ：2023/3/14 12:12

"""
涨停前1min主买成交额占全部成交额比例
"""
...
def factor_fc_buy_amt_pct_1m(transaction_df, return_fillna_dic=False):
    factor_name = 'fc_buy_amt_pct_1m'
    ...
    transaction_buy = transaction_buy.query(f'MDTime >= {target_time}')
...
if __name__ == '__main__':
    ...
    factor_df=factor_fc_buy_amt_pct_1m(start_date,end_date,IO)
    factor_path = '/data/user/015614/factor/'
    factor_df.to_hdf(factor_path + 'fc_buy_amt_pct_1m.h5', key='fc_buy_amt_pct_1m', mode='w')
