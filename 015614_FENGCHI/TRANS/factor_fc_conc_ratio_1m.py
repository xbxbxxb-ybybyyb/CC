...
def factor_fc_conc_ratio_1m(transaction_df, return_fillna_dic=False):
    factor_name = 'fc_conc_ratio_1m'
...
if __name__ == '__main__':
    ...
    factor_df=factor_fc_conc_ratio_1m(start_date,end_date,IO)
    factor_path = '/data/user/015614/factor/'
    factor_df.to_hdf(factor_path + 'fc_conc_ratio_1m.h5', key='fc_conc_ratio_1m', mode='w')
