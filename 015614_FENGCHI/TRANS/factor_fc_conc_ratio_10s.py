...
def factor_fc_conc_ratio_10s(transaction_df, return_fillna_dic=False):
    factor_name = 'fc_conc_ratio_10s'
    ...
    if transaction_df.shape[0] == 0:
        ...
        target_time = fun_get_time(int(ul_time), -10)
...
if __name__ == '__main__':
    ...
    factor_df=factor_fc_conc_ratio_10s(start_date,end_date,IO)
    factor_path = '/data/user/015614/factor/'
    factor_df.to_hdf(factor_path + 'fc_conc_ratio_10s.h5', key='fc_conc_ratio_10s', mode='w')
