...
def factor_fc_call_m_deal_pct(transaction_df, return_fillna_dic=False):
    factor_name = 'fc_call_m_deal_pct'
    ...
    big_deal_df = transaction_df.query('TradeMoney >= 50000 & TradeMoney < 200000')
    try:
