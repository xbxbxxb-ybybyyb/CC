...
def factor_fc_net_buy_str(transaction_df, return_fillna_dic=False):
    ...
    factor = transaction_net_buy_tick.mean() / transaction_net_buy_tick.std()   # 这里要设置填充值，填充为最大值
...
if __name__ == '__main__':
    ...
    factor_df=factor_fc_net_buy_str(start_date,end_date,IO)
