...
def factor_xbc_20240425_5(transaction_df, return_fillna_dic=False):
    factor_name = 'xbc_20240425_5'
    ...
    transaction_df1 = transaction_df[transaction_df['MDTime'] <= 93010000]
    transaction_df1 = transaction_df1[transaction_df1['MDTime'] >= 93005000]
    transaction_df2 = transaction_df[transaction_df['MDTime'] <= 93005000]
