...
class FactorParamSearch:
    def __init__(self, note=None):
        ...
        self.res_path = f'/data/user/015614/factor/factor_digging_20230913205514_20230914测试_std_1个好的1个冲一下_已全部提交/'
...
if __name__ == '__main__':
    ...
    # fps.wrapper([(1, 0.6, 0.1, 'big')]) # 用于调试