...
class FactorParamSearch:
    def __init__(self, note=None):
        ...
        self.res_path = f'/data/user/015614/factor/factor_digging_20230913205625_20230914测试_std_mul_mean/'
    ...
    def calc_factor(df, param_tuple, return_fillna_dic=False):
        ...
        if param4 == 'big':
            ...
            value = df_big['factor'].std() * df_big['factor'].mean()
        else:
