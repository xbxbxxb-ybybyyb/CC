...
root_path = '/data/user/015614/factor/dig_TransTOrder1_20231026104409/'
...
# 挑选样本
res_df = res_df.sort_values('score', ascending=False).query('score > 30 & self_high_corr < 0.695')
res_df['drop'] = 0
res_df['commit'] = 0
for idx in range(len(res_df)):
    res_df = res_df.query('drop == 0')
    res_df.iloc[idx, 'commit'] = 1
