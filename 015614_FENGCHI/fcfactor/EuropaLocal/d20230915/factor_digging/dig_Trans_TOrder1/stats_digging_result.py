...
root_path = '/data/user/015614/factor/factor_digging_20230919195850_TTrans_TOrder1/'
note = root_path.split('_')[-1][:-1]
file_list = os.listdir(root_path)
xlsx_list = list(filter(lambda x: x.endswith('.xlsx'), file_list))[:500]
factor_fpath_list = list(filter(lambda x: x.endswith('.pkl'), file_list))[:500]
res_list = []
