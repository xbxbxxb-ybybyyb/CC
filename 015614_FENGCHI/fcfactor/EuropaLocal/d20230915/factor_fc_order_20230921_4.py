...
def factor_fc_order_20230921_4(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    # -----------------------------------------------------47.95 0.10----------------------------------------------------------
    # =====>>>> 47.958333333333336 0.10386086392162476 11.842447131176087 122.2145795522578 skk_order_l5_qty_rate，fc_order_last_order_money 0.6472，0.5944
    # !!!! fc_order_20230921_3 0.7013116285007981
    """
    MDTime: 时间
