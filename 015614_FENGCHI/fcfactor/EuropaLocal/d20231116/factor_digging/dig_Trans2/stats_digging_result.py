...
root_path = '/data/user/015614/factor/dig_TTrans2_20231116152614/'
...
# 挑选样本
res_df2 = res_df.copy()
res_df2 = res_df2.sort_values('score', ascending=False).query('score > 30 & highest_corr < 0.685 & high_corr_s_num == 0')
res_df2['drop'] = 0
res_df2['commit'] = 0
while True:
