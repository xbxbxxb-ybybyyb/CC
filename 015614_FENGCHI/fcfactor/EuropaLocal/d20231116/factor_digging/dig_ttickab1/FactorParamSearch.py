...
class FactorParamSearch:
    ...
    def calc_factor(df, param_tuple, return_fillna_dic=False):
        ...
        df['tick_pctchg'] = (df[param3] / df['pre_close'] - 1) / (zcz + 1)

        part_df1 = df.tail(param1)
        part_df2 = df.head(param2)
...
if __name__ == '__main__':
    ...
    param_list = [[5, 10, 20, 30, 40, 50, 60, 100, 200, 400],
                  [5, 10, 20, 30, 40, 50, 60, 100, 200, 400],
                  ['HighPx', 'LowPx', 'LastPx', 'WeightedAvgBidPx', 'WeightedAvgOfferPx']]
    ...
    # fps.wrapper([(3, 3, 'WeightedAvgBidPx')]) # 用于调试