...
if __name__ == '__main__':
    ...
    result_path = f'/data/user/015614/factor/d{date}/'
    ...
    factor_name_list = list(filter(lambda x: str(x).startswith('factor_'), os.listdir(f'/data/user/015614/fcfactor/Europa/d{date}/')))
    ...
    # factor_fname_list = ['factor_fc_trans_order_20231116_4',
    #                      'factor_fc_trans_order_20231116_5',
    #                      'factor_fc_ttickab_20231116_1',
    #                      'factor_fc_ttickab_20231116_2',
    #                      'factor_fc_ttickab_20231116_3']
    # factor_fname_list = ['factor_fc_trans_20231123_14']
    factor_fname_list = ['factor_fc_trans_tickab_20230907_10',
                         'factor_fc_trans_tickab_20230907_10_optm']
    # factor_fname_list = ['factor_fc_ttickab_20231130_12',
    #                      'factor_fc_ttickab_20231130_13',
    #                      'factor_fc_ttickab_20231130_14',
    #                      'factor_fc_ttickab_20231130_15',
    #                      'factor_fc_ttickab_20231130_16',
    #                      'factor_fc_ttickab_20231130_17',
    #                      'factor_fc_ttickab_20231130_18',
    #                      'factor_fc_ttickab_20231130_19',
    #                      ]

    this_submit_factor_dict = dict()
    for factor_fname in factor_fname_list:
        print(f'当前测试因子：{factor_fname}')
        mod_name = f'Europa.d{date}.{factor_fname}'
