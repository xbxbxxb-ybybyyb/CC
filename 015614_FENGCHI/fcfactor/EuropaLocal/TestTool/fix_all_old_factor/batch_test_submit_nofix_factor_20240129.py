...
if __name__ == '__main__':
    ...
    for date in [20230316, 20230323, 20230330, 20230406, 20230413, 20230420, 20230427, 20230511,
        ...
        result_path = f'/data/user/015614/factor/Europa_nofix_20240126/'
        ...
        factor_name_list = list(filter(lambda x: str(x).startswith('factor_'), os.listdir(f'/data/user/015614/fcfactor/Europa/JupEur冯炽修改前_20240126/factor_{date}/')))
        ...
        for factor_fname in factor_fname_list:
            ...
            if os.path.exists(result_path + factor_fname[7:] + '.h5'):
                print(factor_fname, '已存在')
                continue
            mod_name = f'Europa.JupEur冯炽修改前_20240126.factor_{date}.{factor_fname}'
