...
class FactorParamSearch:
    ...
    def calc_factor(df, param_tuple, return_fillna_dic=False):
        ...
        short_time = fun_shift_time(ZT_Time, -min(param1 * 1000, int(dis2opn / 20)))
        long_time = fun_shift_time(ZT_Time, -min(param2 * 1000, int(dis2opn / 2)))
...
if __name__ == '__main__':
    ...
    param_list = [[5, 10, 20, 30, 60, 90, 120, 180, 300, 600, 1200, 1800, 3600],
                  [10, 20, 30, 60, 90, 120, 180, 300, 600, 1200, 1800, 3600, 7200]
                 ]
