...
class FactorParamSearch:
    def __init__(self, note=None):
        ...
        self.res_path = f'/data/user/015614/factor/factor_digging_20230905132402_20230905测试_Trans_TOrder_长中短时/'
    ...
    def calc_factor(df, param_tuple, return_fillna_dic=False):
        ...
        order_df = order_df.query(f'OrderBSFlag == {param4}')  # 卖出委托
        ...
        factor3 = part_trans_df3['TradeQty'].sum() / part_order_df3['OrderQty'].sum()
