...
def factor_fc_trans_20231130_3(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------逐笔成交主动买单中vwap价格上下总量之比--------------------------------------------------------
    ...
    """
    35.45 0.0758
    =====>>>> 35.458333333333336 0.07582941105422236 893621.2309448834 2565720.927009289 xbc_20231019_8，sss_ZT_Time_ms 0.6121，0.6064
    """
