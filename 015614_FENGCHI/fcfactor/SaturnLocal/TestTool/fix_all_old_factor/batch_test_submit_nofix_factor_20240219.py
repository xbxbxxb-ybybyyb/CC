...
if __name__ == '__main__':
    ...
    for date in [20240111, 20240125]:
        ...
        result_path = f'/data/user/015614/factor/Saturn_nofix_20240126/'
        os.makedirs(result_path, exist_ok=True)
        factor_df = pd.DataFrame()
        sft = pj2FactorTest(start_date, end_date)

        factor_name_list = list(filter(lambda x: str(x).startswith('factor_'), os.listdir(f'/data/user/015614/fcfactor/Saturn/Saturn冯炽修改前_202402/factor_{date}/')))
        ...
        for factor_fname in factor_fname_list:
            ...
            if factor_fname[7:] not in fixed_factor_list:
                ...
                continue
            mod_name = f'Saturn.Saturn冯炽修改前_202402.factor_{date}.{factor_fname}'
