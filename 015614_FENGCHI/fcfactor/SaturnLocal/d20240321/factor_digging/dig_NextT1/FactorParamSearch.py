...
class FactorParamSearch:
    ...
    def calc_factor(start_date, end_date, IO, param_tuple, return_fillna_dic=False):
        ...
        b = md_data[param1].unstack().rolling(param2, min_periods=1).mean().stack()
        a = md_data[param1].unstack().rolling(param3, min_periods=1).mean().stack()
...
if __name__ == '__main__':
    ...
    param_list = [['BUY_VALUE_EXLARGE_ORDER', 'SELL_VALUE_EXLARGE_ORDER',
                  ...
                  [1, 2, 3, 6, 10, 20, 30, 40, 60, 90, 120],
                  [2, 3, 5, 10, 20, 30, 40, 60, 90, 120, 240]]
    ...
    # multi = True
    # multi = False
    # fps.wrapper([('BUY_VOLUME_MED_ORDER_ACT', 2, 3)]) # 用于调试