...
root_path = '/data/user/015614/factor/dig_20240321_Saturn_t1_1_20240319164101/'
note = root_path.split('_')[-1][:-1] + '_part9'
file_list = os.listdir(root_path)
batch = 400
start_num = 3600
xlsx_list = list(filter(lambda x: x.endswith('.xlsx') and not x.startswith('因子'), sorted(file_list)))[start_num:start_num+batch]
...
week_submit_date = 20240425
week_root_path = f'/data/user/015614/factor/d20240425_Saturn/'
