...
def factor_fc_LastZtLastTick_20240208_36(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按买入量分段后，每段委托前后变化情况分布
    =====>>>> 33.875 0.096 0.9968970920276341 1.014035264590878 Lzt_latest_last_order_time_cost，xbc_20240125_0 0.6918，0.6695
    """
