...
def factor_fc_LastZtLastTick_20240208_1(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按成交额分层后，相邻TICK卖盘委托变化情况分布对比
    =====>>>> 64.083 0.101 0.5477000881052727 0.27994487703640636 Lzt_pj2k_sell2_compact_mean，fc_LastZtLastTick_20240125_1 0.6408，0.5792
    """
