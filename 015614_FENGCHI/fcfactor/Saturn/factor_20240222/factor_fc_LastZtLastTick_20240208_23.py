...
def factor_fc_LastZtLastTick_20240208_23(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell8OrderQty'].mean() != 0 and part_df1['Sell8OrderQty'].mean() != 0:
            res1 = part_df1['Sell8OrderQty'].std() / part_df1['Sell8OrderQty'].mean()
            res2 = part_df2['Sell8OrderQty'].std() / part_df2['Sell8OrderQty'].mean()
            if res2 != 0:
                res = res1 / res2
            else:
                res = 0
    ...
    """
    按主买委托量分成头尾部后卖盘的委托差异
    =====>>>> 22.125 -0.064 0.7761033841485765 0.2633303444104736 xbc_20240125_6，xbc_20240125_0 0.4851，0.4739
    """
