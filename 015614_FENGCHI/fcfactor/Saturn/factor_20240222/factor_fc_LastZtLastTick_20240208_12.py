...
def factor_fc_LastZtLastTick_20240208_12(df, return_fillna_dic=False):
    import sys
    ...
    seg_threshold = round_(df['TotalBidQty'].quantile(0.75), 6)
    if len(df) > 0:
    ...
    """
    主卖成交卖出分层后，各部分变化情况
    =====>>>> 37.667 0.077 0.7569215912732412 0.25308625680501484 fc_LastZtLastTick_20240125_1，Lzt_pj2k_sell2_compact_mean 0.5489，0.5378
    """
