...
def factor_fc_LastZtLastTick_20240208_9(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell7OrderQty'].mean() != 0 and part_df1['Sell7OrderQty'].mean() != 0:
            res1 = part_df1['Sell7OrderQty'].std() / part_df1['Sell7OrderQty'].mean()
            res2 = part_df2['Sell7OrderQty'].std() / part_df2['Sell7OrderQty'].mean()
            if res2 != 0:
                res = res1 / res2
            else:
                res = 0
    ...
    """
    日内不同状态下卖盘盘口委托量的变化情况
    =====>>>> 47.417 0.094 0.6614306588492782 0.25567970076044627 fc_LastZtLastTick_20240125_1，Lzt_pj2k_sell2_compact_mean 0.6153，0.5727
    """
