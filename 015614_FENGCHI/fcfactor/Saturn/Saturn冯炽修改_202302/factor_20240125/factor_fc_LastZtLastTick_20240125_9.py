...
def factor_fc_LastZtLastTick_20240125_9(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Buy9OrderQty'].mean() != 0:
            res = part_df1['Buy9OrderQty'].mean() / part_df2['Buy9OrderQty'].mean()
        else:
            res = 0
    else:
        res = 0
    ...
    """
    不同主买成交量下，盘口买盘委托量的变化
    =====>>>> 23.75 -0.045 0.5208582795781025 0.30959849966034 wj_last_down_wvadpct，Lzt_pj2k_corr_d_3_1 0.4442，0.3831
    """
