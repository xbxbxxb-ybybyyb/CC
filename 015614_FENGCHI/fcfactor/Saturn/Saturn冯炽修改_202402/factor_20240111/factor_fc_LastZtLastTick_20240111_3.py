...
def factor_fc_LastZtLastTick_20240111_3(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按照总卖量分层，不同区间内买单委托量的变化值
    =====>>>> 25.541 -0.071 21.447581004324412 198.58624418199955 sss_tk_5pbs_diffret_all_mean，Lzt_pj2r_sell_buy_number_abs_diff 0.5807，0.5572
    """
