...
class factor_fc_T1_n20240531_3(BaseFactor):
    owner = 'fc'
    strategy_name = "mercury"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "昨日超大单卖出总手数相对于近1年中位值的差值"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        a = md_data['SELL_VOLUME_EXLARGE_ORDER'].unstack().rolling(240, min_periods=1).median().stack()
