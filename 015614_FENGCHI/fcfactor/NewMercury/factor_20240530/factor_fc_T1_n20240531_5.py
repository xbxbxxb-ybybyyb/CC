...
class factor_fc_T1_n20240531_5(BaseFactor):
    owner = 'fc'
    strategy_name = "mercury"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "过去1日散户主动卖出总量与最近一个月的差值"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        a = md_data['SELL_VOLUME_SMALL_ORDER_ACT'].unstack().rolling(20, min_periods=1).median().stack()
