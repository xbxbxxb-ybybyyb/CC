...
class factor_fc_T1_n20240523_3(BaseFactor):
    owner = 'fc'
    strategy_name = "mercury"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "过去1日超大单卖出总手数相比于最近1年的中位值之差"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        a = md_data["SELL_VOLUME_MED_ORDER_ACT"].unstack().rolling(240, min_periods=1).median().stack()
