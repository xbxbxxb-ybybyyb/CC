...
class factor_fc_T1_n20240606_6(BaseFactor):
    owner = 'fc'
    strategy_name = "mercury"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "昨日主力净流入量/流通股数相对于过去一周的差值"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        a = md_data['CLOSE_MONEYFLOW_PCT_VOLUME_L'].unstack().rolling(5, min_periods=1).median().stack()
