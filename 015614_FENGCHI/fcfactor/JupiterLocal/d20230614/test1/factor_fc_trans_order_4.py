...
def factor_fc_trans_order_4(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    part_order_df2 = order_df.query(f'{target_time3} >= MDTime >= {target_time2}')
    part_trans_df2 = trans_df.query(f'{target_time3} >= MDTime >= {target_time2}')
