...
# T-1日类因子
def factor_fc_t_1_zt_c(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    by_day = pd.Series(np.nansum(zt.values, axis=1), index=zt.index)
    by_day.name = fname
...
if __name__ == '__main__':
    import IO
    factor = factor_fc_t_1_zt_c(20221001, 20221211, IO=IO, return_fillna_dic=False)
    pass