...
s = FactorData()
"""
针对过去N天的swing振幅进行寻优，寻优三个参数，分别是振幅、滚动时间以及滚动计算方式
"""
...
class FactorParamSearch:
    ...
    def calc_factor(start_date, end_date, param_tuple):
        ...
        md_data = IO.read_data([start_date_, end_date], columns=['high', 'low', 'pre_close', 'adjfactor'],
        ...
        flag = md_data['swing'].unstack() > param0
...
if __name__ == '__main__':
    ...
    param_list = [[0.06, 0.07, 0.08, 0.09, 0.098],    # param0
                  [240, 120, 60, 30, 15], # param1
                  ['std','skew', 'kurt', 'sum']]  # func1
