...
def factor_fc_trans_order5(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    trans_df = trans_df.query(f'TradeSellNo in {order_df["OrderIndex"].tolist()}')  # 逐笔成交中卖出Index在OrderIndex中的部分
    ...
    # -------------------------------------------最近60秒，买单中，主动买入的部分，占卖出委托的比例--82.13 11.66-和sss的因子高相关-------------------------------------------------------
