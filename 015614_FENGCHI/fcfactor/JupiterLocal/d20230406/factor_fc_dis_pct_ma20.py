...
def factor_fc_dis_pct_ma20(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='fc_dis_pct_ma20'
    ...
    md_data['dis_pct_ma20'] = md_data['close'] / md_data['ma20'] - 1

    factor_df = pd.DataFrame()
    factor_df[factor_name] = md_data['dis_pct_ma20']
    return factor_df