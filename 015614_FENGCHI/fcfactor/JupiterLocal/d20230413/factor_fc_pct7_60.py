...
def factor_fc_pct7_60(start_date, end_date, IO, return_fillna_dic=False):
    factor_name = 'fc_pct7_60'

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['MD']}

    start_date_ = int(s.tradingday(str(start_date), -70)[0])
