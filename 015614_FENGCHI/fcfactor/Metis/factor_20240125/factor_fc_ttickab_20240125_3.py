...
def factor_fc_ttickab_20240125_3(df, return_fillna_dic=False):
    import sys
    ...
    """
    均分价格后，两区间段上卖盘委托量变化率
    =====>>>> 13.208 -0.096 0.4470363032256534 21.507541551169698 zwh_20240111_003，sss_tk_buyqty_ratio1d5_all_mean 0.1438，0.133
    """
