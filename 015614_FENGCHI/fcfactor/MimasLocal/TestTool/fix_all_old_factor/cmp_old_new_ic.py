...
fixed_factor_df = pd.read_excel('/data/user/015614/fcfactor/Mimas/Mimas冯炽修改_202402/因子列表_fc.xlsx').set_index('factor_name')
fixed_factor_list = fixed_factor_df.query('是否需要修改==1').index.tolist()

old_fpath = '/data/user/015614/factor/Mimas_fix_20240126/'
new_fpath = '/data/user/015614/factor/Mimas_nofix_20240126/'
...
fixed_factor_df.to_excel('/data/user/015614/fcfactor/Mimas/Mimas冯炽修改_202402/因子列表_fc.xlsx')