...
class factor_fc_n20250320_2(BaseFactor):
    ...
    def calculate(self, database):
        ...
        if database["skip"] == True:
            ...
            res11 = part_df1.query('OrderBSFlag == 1')['OrderQty'].count()
            res12 = part_df1.query('OrderBSFlag == 2')['OrderQty'].count()
            res1 = res11 / res12 if res12 != 0 else 1e5

            res21 = part_df2.query('OrderBSFlag == 1')['OrderQty'].count()
            res22 = part_df2.query('OrderBSFlag == 2')['OrderQty'].count()
