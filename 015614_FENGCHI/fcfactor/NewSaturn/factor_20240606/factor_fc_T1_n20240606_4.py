...
class factor_fc_T1_n20240606_4(BaseFactor):
    ...
    factor_explain = "昨日机构买入金额相对于近3日的中位值差异"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        b = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(1, min_periods=1).median().stack()
        a = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(3, min_periods=1).median().stack()
