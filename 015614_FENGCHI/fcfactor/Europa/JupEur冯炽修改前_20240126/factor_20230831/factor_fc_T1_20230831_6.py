...
def factor_fc_T1_20230831_6(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['CLOSE_MONEYFLOW_PCT_VALUE_L'].unstack().diff().rolling(40, min_periods=1).mean().stack()
    # --------------------------------------------------------14:30后的大单净流入金额/流通市值-----------------------------------------------------------
    """
    样本内得分  14.95 -0.0345
    """
