...
def factor_fc_T1_20230824_2_fix(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['CLOSE_MONEYFLOW_PCT_VALUE'].unstack().diff().rolling(90, min_periods=1).mean().stack() * 1e6
