...
def factor_fc_T1_20230831_5(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['BUY_VOLUME_EXLARGE_ORDER'].unstack().diff().rolling(40, min_periods=1).mean().stack()
    # -------------------------------------------------------当日机构主动买入总量------------------------------------------------------------
    """
    样本内得分 15.08 -0.029
    """
