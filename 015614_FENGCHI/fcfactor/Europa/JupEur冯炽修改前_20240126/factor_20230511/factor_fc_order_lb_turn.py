...
def factor_fc_order_lb_turn(df, param_tuple=(), return_fillna_dic=False):
    # inscore 61.62  ic 0.9163  all jupiter
    # inscore 70.83  ic 0.1011  quickrise
    # inscore 68.67 quickrise
    factor_name = 'fc_order_lb_turn'
