...
def factor_fc_trans_20231012_9(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # ------------------------------------------------近90秒同一卖方分组中非同价成交的比例/长区间非同价成交的比例---------------------------------------------------------
    ...
    """
    63.16 -0.1089
    =====>>>> 63.16666666666667 -0.10891056894735526 0.6579460639039907 0.615342120099483 t_big_vwap_chg_sdl，skk_TTickab_t2v_std_new 0.6553，0.6276
    """
