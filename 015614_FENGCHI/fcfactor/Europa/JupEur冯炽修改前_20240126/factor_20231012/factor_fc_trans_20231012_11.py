...
def factor_fc_trans_20231012_11(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # ------------------------------------------------近5分钟同一卖方分组中非同价成交的比例/10分钟长区间非同价成交的比例---------------------------------------------------------
    ...
    long_pct = len(long_group_df[long_group_df['max'] != long_group_df['min']]) / len(long_group_df)
    short_pct = len(short_group_df[short_group_df['max'] != short_group_df['min']]) / len(short_group_df)
    ...
    """
    35.5 -0.0798
    =====>>>> 35.5 -0.07981703668193467 0.8242657603118001 0.2901811121366837 skk_TTickab_LPR_roll2vwap_std_a，skk_TTickab_t2v_std_new 0.4934，0.4864
    """
