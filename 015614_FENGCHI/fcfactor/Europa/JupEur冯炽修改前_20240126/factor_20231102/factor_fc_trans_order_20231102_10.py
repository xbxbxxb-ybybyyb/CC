...
def factor_fc_trans_order_20231102_10(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------突破前10分钟逐笔成交主买与主卖的比值乘逐笔委托主买乘前期该值-------------------------------------------------------------
    ...
    target_time1 = max(fun_get_time(zt_time, -600), 93000000)
    target_time2 = max(fun_get_time(zt_time, -7200), 93000000)
    ...
    """
    36.29 -0.059
    =====>>>> 36.29166666666667 -0.05913641817650327 45.18682533775743 3967.4476441307966 xbc_order_mid_std_100，fc_ttickab_20231026_14 0.6126，0.5813
    """
