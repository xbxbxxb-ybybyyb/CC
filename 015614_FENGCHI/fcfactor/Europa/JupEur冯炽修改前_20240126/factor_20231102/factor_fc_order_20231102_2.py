...
def factor_fc_order_20231102_2(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    part_df = part_df.iloc[-min(len(part_df), 50):]
    ...
    """
    31.95 -0.059
    =====>>>> 31.958333333333336 -0.059338717787305234 -643.0443946843981 598.0346253961178 fc_order_20231026_25，fc_order_20231026_26 0.6157，0.5378
    """
    """
    MDTime: 时间
