...
def factor_fc_trans_order_20230907_8_fix_fix(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    # -----------------------------------------------------88.25 0.1205----------------------------------------------------------
    # 88.04166666666667 0.1203602998265229 57.09916809691775 352.65563691218387 fc_trans_order_b_ratio_in_s，xbc_20230914_1 0.6753，0.6269
