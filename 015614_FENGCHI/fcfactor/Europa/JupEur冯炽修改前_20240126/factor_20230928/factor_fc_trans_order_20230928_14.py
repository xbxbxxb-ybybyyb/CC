...
def factor_fc_trans_order_20230928_14(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------近5秒与近半分钟卖出委托量中成交量的比例-------------------------------------------------------------
    ...
    """
    38.5 0.066 进行了调整，提高了得分
    =====>>>> 41.0 0.07498628948650717 7.754206994861684 20.393651598083526 fc_trans_order_20230907_8_fix_fix，Short_buy_sell_mean_ratio 0.5608，0.5047
    """
