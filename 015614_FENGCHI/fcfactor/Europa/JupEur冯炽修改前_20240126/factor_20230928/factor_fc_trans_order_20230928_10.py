...
def factor_fc_trans_order_20230928_10(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------近1分钟比前1分钟卖出委托量中成交比例的乘积-------------------------------------------------------------
    ...
    # -----------------------------------------------------51.95 0.084----------------------------------------------------------
    #=====>>>> 51.958333333333336 0.08434581722482355 15.705260301325273 616.4562275922822 fc_trans_order_b_ratio_in_s，xbc_20230629_9 0.6631，0.622
