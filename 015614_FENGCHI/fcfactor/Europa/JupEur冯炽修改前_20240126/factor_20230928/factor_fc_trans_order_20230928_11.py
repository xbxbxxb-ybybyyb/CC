...
def factor_fc_trans_order_20230928_11(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------突破前最近一分钟内两段区间中卖出委托量中成交量的乘积-------------------------------------------------------------
    ...
    # -----------------------------------------------------51.67 0.083----------------------------------------------------------
    # =====>>>> 51.66666666666667 0.08328221008344791 104.02417508998586 5232.305374619437 fc_trans_order_b_ratio_in_s，skk_order_l5_bsr4 0.6887，0.5103
    # !!!! fc_trans_order_20230928_10 0.7222774391321707
