...
def factor_fc_trans_order_20231026_24_fix_fix(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------突破前短区间内近半分钟内trans主买卖比乘order主买比-------------------------------------------------------------
    ...
    target_time2 = max(fun_get_time(zt_time, -30), 93000000)
    ...
    """
    51.16 0.094
    =====>>>> 51.16666666666667 0.0942883938541391 22075.125678732795 1730184.738532722 t_l1_trade_ave_time，fc_trans_order_b_ratio_in_s 0.5448，0.5329
    """
