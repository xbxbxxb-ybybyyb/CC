...
def factor_fc_trans_order_20231026_23_fix_fix(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    if return_fillna_dic:
        return {factor_name: 0.0}
    # ----------------------------------------------------突破前20秒比近20分钟内trans主买卖比乘order主买比-------------------------------------------------------------
    ...
    target_time1 = max(fun_get_time(zt_time, -20), 93000000)
    target_time2 = max(fun_get_time(zt_time, -1200), 93000000)
    ...
    """
    57.16 0.07
    =====>>>> 57.16666666666667 0.07029431706964874 170.13972834721284 38892.49217752531 fc_trans_order_b_ratio_in_s，Last_20_200_comparative_strength 0.5467，0.5275
    """
