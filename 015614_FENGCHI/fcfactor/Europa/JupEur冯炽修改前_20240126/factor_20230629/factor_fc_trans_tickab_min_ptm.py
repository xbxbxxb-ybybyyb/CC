...
def factor_fc_trans_tickab_min_ptm(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    min_trans_qty = tmp_trans_df.groupby('m')['TradeMoney'].sum(min_count=1)
    ...
    # ------------------------------成交金额除以成交笔数，最近一小段时间平均每笔交易的单笔金额-- 30.13 7.32 没有高相关----------------------------------------
