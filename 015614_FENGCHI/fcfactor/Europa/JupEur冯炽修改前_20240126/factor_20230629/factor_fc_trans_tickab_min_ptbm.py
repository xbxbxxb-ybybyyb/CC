...
def factor_fc_trans_tickab_min_ptbm(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    min_trans_qty = tmp_trans_df.query('buy_flag == 1').groupby('m')['TradeMoney'].sum(min_count=1)
    ...
    # ------------------------------成交金额除以成交笔数，最近一小段时间平均每笔交易的买单的单笔金额--39.04 8.58 没有高相关--per trade buy money--------------------------------------
