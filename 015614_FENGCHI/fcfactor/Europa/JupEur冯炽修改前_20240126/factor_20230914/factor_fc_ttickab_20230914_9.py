...
def factor_fc_ttickab_20230914_9(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    df['WindowValue'] = df['TotalValueTrade'] - df['TotalValueTrade'].shift(5).fillna(0)
    df['WindowVolume'] = df['TotalVolumeTrade'] - df['TotalVolumeTrade'].shift(5).fillna(0)
