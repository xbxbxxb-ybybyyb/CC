...
def factor_fc_swing_9_15_sum(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    factor_name = 'fc_swing_9_15_sum'
    ...
    flag = md_data['swing'].unstack() > 0.09
    ret = flag.rolling(15).sum().stack()
