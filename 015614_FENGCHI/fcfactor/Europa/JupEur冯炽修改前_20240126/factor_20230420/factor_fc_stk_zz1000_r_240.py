...
def factor_fc_stk_zz1000_r_240(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    factor_name='fc_stk_zz1000_r_240'
    ...
    for dat in s.tradingday(start_date, end_date):
        ...
        cov_ret = array_corr_np(tmp_ret.values[-240:], tmp_market.values.repeat(tmp_ret.shape[1], -1)[-240:])
