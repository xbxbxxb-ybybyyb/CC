...
def factor_fc_dis_pct_ma5(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    ...
    md_data.loc[((md_data['stock_code'].str.startswith('3')) & (md_data['datelist'] >= '20200824')) | md_data['stock_code'].str.startswith('68'), 'dis_pct_ma5'] = \
        md_data.loc[((md_data['stock_code'].str.startswith('3')) & (md_data['datelist'] >= '20200824')) | md_data['stock_code'].str.startswith('68'), 'dis_pct_ma5'] / 2
