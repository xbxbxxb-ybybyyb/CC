...
def factor_fc_ttickab_20231123_18(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------涨停前20分钟内均买价占TickK柱的delta变化----------------------------------------------------
    ...
    def calc_res(df_):
        ret = ((df_['LastPx'] - df_['LowPx'] + 0.0001) / (df_['HighPx'] - df_['LowPx'] + 1e-4)).sum()
        return ret
    ...
    """
    37.125 -0.069
    =====>>>> 37.12500000000001 -0.0695235051981536 12167.334857869333 77445.25620056754 xbc_20231019_8，zwh_20230831_005 0.5723，0.5473
    """
    """
    MDTime: 时间
