...
def factor_fc_trans_order_20231123_13(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    target_time1 = max(fun_get_time(zt_time, -180), 93000000)
    target_time2 = max(fun_get_time(zt_time, -3600), 93000000)
    ...
    """
    38.91 -0.09213
    =====>>>> 38.91666666666667 -0.09213077651163985 514.3921375969676 4259.738311413265 t_big_vwap_chg_sdl，xbc_20231019_8 0.6923，0.636
    """
