...
def factor_fc_T1_20230907_14(start_date, end_date, IO, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    a = md_data['CLOSE_MONEYFLOW_PCT_VALUE_L'].unstack().rolling(120, min_periods=1).mean().stack()

    factor_df = pd.DataFrame()
    factor_df[factor_name] = b - a
    """
    近1日大户主动买入金额相对于过去120日均值的差值
    21.5 -0.04665
    """
    return factor_df
