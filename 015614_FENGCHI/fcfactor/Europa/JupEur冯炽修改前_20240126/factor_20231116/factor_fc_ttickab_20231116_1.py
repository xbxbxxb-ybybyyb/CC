...
def factor_fc_ttickab_20231116_1(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    df['tick_pctchg'] = (df['LastPx'] / df['pre_close'] - 1) / (zcz + 1)

    part_df1 = df.tail(100)
    part_df2 = df.head(20)
    ...
    """
    63.5 0.1328
    =====>>>> 51.16666666666667 0.12323844262602812 11.761323109287332 165.68449848911706 xbc_20231109_6，max_rise_pct 0.6795，0.6525
    """
    """
