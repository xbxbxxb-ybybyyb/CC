...
def factor_fc_trans_20231019_2(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    short_time = fun_shift_time(ZT_Time, -min(30000, int(dis2opn / 20)))
    long_time = fun_shift_time(ZT_Time, -min(7200000, int(dis2opn / 2)))
    ...
    """
    57.375 0.086
    =====>>>> 57.375 0.08610912067962409 -0.398213885126559 0.4162213212191247 t_q75_askid_30s，xbc_20231012_6 0.5818，0.5535
    """
