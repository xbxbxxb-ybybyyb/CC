...
def factor_fc_ttickab_20231019_9(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # --------------------------------------------------近4分钟按成交量去除尾部与去除头部后对应vwap的涨跌幅差异-------------------------------------------------------
    ...
    if len(df) > 0:
        ...
        if len(df_small) > 80: df_small = df_small.head(80) # clip
        df_big = df[df['TotalValueTrade'] <= big]
        if len(df_big) > 80: df_big = df_big.head(80)
    ...
    """
    44.91 0.0928
    =====>>>> 44.91666666666667 0.09284353970924257 -0.03946231848391946 0.20473499627786204 qyh_ttick_apct_a2b_1m，wj_TTick_10_h2prec_maxmin4 0.646，0.6016
    """
