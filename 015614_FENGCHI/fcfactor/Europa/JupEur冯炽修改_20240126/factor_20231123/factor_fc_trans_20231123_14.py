...
def factor_fc_trans_20231123_14(df, return_fillna_dic=False):
    import sys
    ...
    start_time1 = max(fun_get_time(ZT_Time, -1200), 93000000)
    ...
    """
    42 0.088
    =====>>>> 42.00000000000001 0.08873826771228045 190029854.3893883 692511597.9501156 sss_ZT_Time_ms，ZT_Time 0.6898，0.6898
    """
