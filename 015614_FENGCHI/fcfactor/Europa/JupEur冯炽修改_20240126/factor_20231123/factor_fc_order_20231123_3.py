...
def factor_fc_order_20231123_3(df, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0}
    # ---------------------------------------------------近10秒与近半小时逐笔委托中卖出价中位值的前后变化差异------------------------------------------------------
    ...
    start_time2 = max(fun_get_time(zt_time, -1800), 93000000)
    ...
    """
    84.625 -0.12564
    =====>>>> 84.625 -0.12563885780985465 164.50294634917202 1999.7338197668817 xbc_20230914_6，skk_TTickab_h2l_std_b 0.6921，0.6837
    """
    """
    MDTime: 时间
