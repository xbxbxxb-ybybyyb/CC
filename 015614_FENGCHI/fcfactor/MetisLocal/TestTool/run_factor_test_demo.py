...
def wrapper(func, factor_type, basic_df, data_path_dic, tradingday, param_tuple):
    if factor_type in ['TTickab','TOrder','TTransaction', 'TTransaction_Metis', 'TTickab_Metis','TTransaction_MetisAll', 'TTransaction_MetisAll', 'TOrder_MetisAll', 'TTickab_MetisAll']:
...
def run_factor(func, factor_name, factor_type, start_date, end_date, basic_file_path, result_path, append_next_tradingday=False, interval_res=True,
    ...
    if factor_type in ['TTransaction', 'TTickab','TOrder',
                       'TTransaction_Metis', 'TTickab_Metis', 'TTickab_MetisAll',
                       'TTransaction_MetisAll', 'TTransaction_MetisAll', 'TOrder_MetisAll',
        ...
        if factor_type in ['TTransaction', 'TTickab', 'TOrder','TTransaction_Metis', 'TTickab_Metis','TTransaction_MetisAll', 'TTransaction_MetisAll', 'TOrder_MetisAll', 'TTickab_MetisAll']:
