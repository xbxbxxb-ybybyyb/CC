...
def factor_fc_TallTick_20240125_10(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    分区间卖盘委托量前后差异变化的最大值的比例
    14.208 0.033  
    =====>>>> 14.208 0.033 4.182509807705762 467.3121422657338 fc_TallTick_20231229_41，fc_TallTick_20231229_43 0.2957，0.2957
    """
