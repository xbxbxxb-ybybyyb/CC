...
def factor_fc_TallTick_20240125_7(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    主买委托量分层后每层卖十委托量差值最大值的比值
    14.75 0.031  
    =====>>>> 14.75 0.031 1.5454658370358463 83.45484633190547 fc_TallTick_20240111_6，fc_TallTick_20231229_41 0.5531，0.2677
    """
