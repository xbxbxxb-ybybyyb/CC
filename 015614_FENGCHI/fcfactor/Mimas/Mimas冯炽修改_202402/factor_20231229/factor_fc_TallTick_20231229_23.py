...
def factor_fc_TallTick_20231229_23(df, return_fillna_dic=False):
    import sys
    ...
    按成交额头部与尾部的下单量的比值
    15.875 -0.0435
    =====>>>> 15.875 -0.04352340871385252 31.885416097664375 1058.7002855348992 pre_close，Next_pre_close 0.6811，0.6646
    """
