...
def factor_fc_TallTick_20231229_35(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    全天按买入分层后头尾部区间内卖四的委托量的差异对比
    17.333 0.0426
    =====>>>> 17.333333333333336 0.0426646779278741 1.2644589422572186 28.019143968047988 wj_TTick_30_hcl_max，xly_t_1_tick_ya63 0.3231，0.3207
    """
