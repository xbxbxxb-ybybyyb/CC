...
def factor_fc_TallTick_20240104_4(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Buy1OrderQty'].mean() != 0:
            res = part_df1['Buy1OrderQty'].mean() / part_df2['Buy1OrderQty'].mean()
        else:
            res = 0
    else:
        res = 0
    ...
    不同区间段内买单下单量的差异变化
    14.33 0.035
    =====>>>> 14.333333333333336 0.035281086250234045 3.0654853967192035 19.110916219894435 fc_TallTick_20231229_44，fc_TallTick_20231229_36 0.4478，0.4302
    """
