...
def factor_fc_TallTick_20240104_5(df, return_fillna_dic=False):
    import sys
    ...
    seg_threshold = round_(df['TotalVolumeTrade'].quantile(0.5), 6)
    if len(df) > 0:
    ...
    下午不同成交量区间内买单量变化
    14.0 0.0184
    =====>>>> 14.0 0.018410319815892126 6.929299290562973 144.41566981034453 Next_pre_close，pre_close 0.6071，0.6038
    """
