...
def factor_fc_TallTick_20231102_11(df, return_fillna_dic=False):
    import sys
    ...
    df['itvl_pct'] = ((df['LastPx'] - df['LastPx'].shift(1)) / pre_close).apply(lambda x: round_(x, 6))
    ...
    eur2mimas:
    25.25 0.06242 
    =====>>>> 25.25 0.0624 -0.00034646948338947734 0.006859824677044553 zwh_20230720_007，zwh_20230712_001 0.6617，0.621
    """
