...
def factor_fc_TallTick_20240111_5(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell2OrderQty'].max() != 0:
            res = part_df1['Sell2OrderQty'].max() / part_df2['Sell2OrderQty'].max()
        else:
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    根据买单委托量，卖单委托量的前后变化值差异对比
    17.33 0.0417
    =====>>>> 17.333333333333332 0.041710887760293594 0.8561356310459161 1.4987866864085702 fc_TallTick_20231229_31，fc_TallTick_20231229_29 0.3752，0.3028
    """
