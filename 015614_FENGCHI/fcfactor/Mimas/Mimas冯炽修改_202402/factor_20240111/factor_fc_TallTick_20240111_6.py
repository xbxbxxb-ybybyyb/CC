...
def factor_fc_TallTick_20240111_6(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell10OrderQty'].max() != 0:
            res = part_df1['Sell10OrderQty'].max() / part_df2['Sell10OrderQty'].max()
        else:
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按照主买成交量头部和尾部区间内卖单下单量的变化率比值
    16.916 0.035
    =====>>>> 16.916666666666668 0.035569539223078483 0.8725776553736467 0.47203892606829484 fc_TallTick_20231229_29，sss_tk_1pmidv_diffret_all_rise 0.2695，0.2583
    """
