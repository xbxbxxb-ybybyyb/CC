...
def factor_fc_TallTick_20240111_3(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按买入量分为头尾部区间后，卖盘前后差异绝对值的最大值对照
    17.75 0.044
    =====>>>> 17.75 0.04417479586232935 1.1444639427203902 27.380722295250695 fc_TallTick_20231229_35，fc_TallTick_20231229_31 0.4342，0.2875
    """
