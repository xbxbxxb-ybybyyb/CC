...
def factor_fc_TallTick_20240111_10(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell6OrderQty'].max() != 0:
            res = part_df1['Sell6OrderQty'].max() / part_df2['Sell6OrderQty'].max()
        else:
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    主买量排序前后卖单委托值的差异绝对值的对比
    15.958 0.0283
    =====>>>> 15.958333333333334 0.028347352921352244 1.2400196449242058 3.957154588396949 fc_TallTick_20231229_43，fc_TallTick_20231229_35 0.4669，0.2595
    """
