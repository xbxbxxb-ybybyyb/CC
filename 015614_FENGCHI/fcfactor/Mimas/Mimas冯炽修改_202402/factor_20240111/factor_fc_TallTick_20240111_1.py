...
def factor_fc_TallTick_20240111_1(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell3OrderQty'].max() != 0:
            res = part_df1['Sell3OrderQty'].max() / part_df2['Sell3OrderQty'].max()
        else:
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    T-1日下午成交量头尾部区间卖盘委托量最大值之比
    18.45 0.0364
    =====>>>> 18.458333333333332 0.036433234058744504 1.1872103805058352 1.0845370668453589 fc_TallTick_20231229_31，fc_TallTick_20231229_42 0.3036，0.2987
    """
