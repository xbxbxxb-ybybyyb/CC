...
def factor_fc_next1mTick_20230914_10(df, return_fillna_dic=False):
    import sys
    ...
    trade_small = round_(df['WindowValue'].quantile(0.4), 6)
    ...
    factor_dict = {factor_name: value * 1e6}
    # ---------------------------------------------------------------------------------------------------------------
    """
    T日前1min 成交量偏小部分区间vwap与均卖价距离CV
    12.583 -0.03817  
    =====>>>> 12.583333333333334 -0.03817104861773173 7.185022236524193e-05 8.04347214301625e-05 skk_Next1mTick_p2low_std，next_wd_t1_low_price_vol_rate 0.5948，0.553
    """
