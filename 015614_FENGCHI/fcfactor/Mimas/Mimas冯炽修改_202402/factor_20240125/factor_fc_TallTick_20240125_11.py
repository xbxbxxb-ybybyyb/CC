...
def factor_fc_TallTick_20240125_11(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    根据成交量分段，各区间上卖盘委托量差异最大值的比例
    14.125 0.038  
    =====>>>> 14.125 0.038 1.4357167186832887 27.947079332047636 fc_TallTick_20240111_3，fc_TallTick_20231229_35 0.6166，0.3885
    """
