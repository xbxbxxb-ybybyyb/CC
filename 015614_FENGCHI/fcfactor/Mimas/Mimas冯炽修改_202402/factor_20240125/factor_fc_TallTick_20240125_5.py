...
def factor_fc_TallTick_20240125_5(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell7OrderQty'].max() != 0:
            res = part_df1['Sell7OrderQty'].max() / part_df2['Sell7OrderQty'].max()
        else:
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    主买成交量头尾两部分卖七委托量最大值的比例
    15.667 0.035  
    =====>>>> 15.666666666666666 0.034754844649119404 0.9561929842315976 0.7846608313341924 fc_TallTick_20231229_32，fc_TallTick_20231229_29 0.4095，0.2642
    """
