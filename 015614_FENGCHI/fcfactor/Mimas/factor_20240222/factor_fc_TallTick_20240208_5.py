...
def factor_fc_TallTick_20240208_5(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按照主卖成交量分层，不同区间买盘变化情况对比
    13.375 0.024
    =====>>>> 13.375 0.024 0.6397546540559582 0.13171650809068683 qyh_talltick_rlength_a25_up，fc_TallTick_20231229_15 0.5188，0.4687
    """
