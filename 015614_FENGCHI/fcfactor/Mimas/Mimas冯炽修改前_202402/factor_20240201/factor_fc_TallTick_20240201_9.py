...
def factor_fc_TallTick_20240201_9(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按照成交额进行分层，不同成交额区间内买盘委托diff的CV之差
    14.208 0.023  
    =====>>>> 14.208 0.023 0.5557589293725975 0.2106588356303663 qyh_talltick_rlength_a25_up，fc_TallTick_20231229_25 0.6529，0.58
    """
