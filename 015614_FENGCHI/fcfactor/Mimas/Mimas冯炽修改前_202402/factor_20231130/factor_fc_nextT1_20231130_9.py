...
def factor_fc_nextT1_20231130_9(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    b = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(20, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(40, min_periods=1).mean().stack()
    ...
    """
    22.125 -0.04
    =====>>>> 22.125 -0.04053435849219034 3.1493888820089992 13.437174983332492 sss_amts_5_60，wj_last20_v2m1pct_lsdiff 0.5984，0.5382
!!!! fc_nextT1_20231130_13 0.7531819409023203
    """
    return factor_df
"""
AShareMoneyFlow:
