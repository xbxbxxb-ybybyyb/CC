...
def factor_fc_nextT1_20231130_3(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # -------------------------------------------------------当日机构主动买入金额，近2周均值与当年比值------------------------------------------------------------
    ...
    b = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(10, min_periods=1).mean().stack()
    a = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(240, min_periods=1).mean().stack()
    ...
    """
    28.25 -0.06148
    =====>>>> 28.25 -0.06147951437772351 1310.894205901821 4911.3079186082205 saturn_ma_compared，wj_last50_v2m1pct_lsdiff 0.6388，0.6084
!!!! fc_nextT1_20231130_10 0.7290575612434431
!!!! fc_nextT1_20231130_15 0.8151822934468484
    """
    return factor_df
"""
AShareMoneyFlow:
