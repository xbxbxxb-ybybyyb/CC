...
def factor_fc_nextT1_20231130_19(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # --------------------------------------------------------当日买入小单的单数近1个月占近1年均值的比例-----------------------------------------------------------
    ...
    a = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(240, min_periods=1).mean().stack()
    ...
    """
    13.7 -0.053
    =====>>>> 13.708333333333334 -0.053286676009058086 1094.8769609440765 5995.532250785899 xbc_20230713_2，xbc_20230727_5 0.5618，0.525
!!!! fc_nextT1_20231130_15 0.7270401562659513
    """
    return factor_df
"""
AShareMoneyFlow:
