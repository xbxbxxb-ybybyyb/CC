...
def factor_fc_nextT1_20231130_18(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    b = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(10, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(20, min_periods=1).mean().stack()
    ...
    """
    18.29 -0.051
    =====>>>> 18.291666666666668 -0.051363524083511795 931.3151033283953 2646.675626949288 wj_last20_diff，skk_turn_NX20 0.6267，0.6164
!!!! fc_nextT1_20231130_10 0.8089066111852411
    """
    return factor_df
"""
AShareMoneyFlow:
