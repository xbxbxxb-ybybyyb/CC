...
def factor_fc_nextT1_20231130_5(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # -------------------------------------------------------当日买入小单的单数，近1个月与近半年的比值------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(20, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(120, min_periods=1).mean().stack()
    ...
    """
    14.54 -0.0493
    =====>>>> 14.541666666666668 -0.0492985077838097 916.3911921550158 4819.456753333901 xbc_20230713_2，wj_last50_v2m1pct_lsdiff 0.5578，0.5534
!!!! fc_nextT1_20231130_15 0.7230834948870316
    """
    return factor_df
"""
AShareMoneyFlow:
