...
def factor_fc_nextT1_20231130_4(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # ---------------------------------------------------------当日买入特大单的单数，近2周与近3周均值的比值----------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(10, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(20, min_periods=1).mean().stack()
    ...
    """
    25.54 -0.05
    =====>>>> 25.541666666666668 -0.052680035655150885 5.233021817799239 15.18484462426303 wj_last20_diff，fc_nextT1_20230810_3 0.6257，0.5841
    """
    return factor_df
"""
AShareMoneyFlow:
