...
def factor_fc_TallTick_20240125_12(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按主买成交进行分区，各区间上盘口前后delta的最大值
    13.917 0.039  
    =====>>>> 13.917 0.039 1.0978750243881603 44.04097459482884 fc_TallTick_20240111_9，fc_TallTick_20231229_36 0.4001，0.3318
    """
