...
def factor_fc_nextT1_20231130_14(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # ----------------------------------------------------当日买入小单的单数 近3日与近一周的均值之比---------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(3, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(5, min_periods=1).mean().stack()
    ...
    """
    20.45 -0.04953
    =====>>>> 20.458333333333332 -0.04952718419964995 1550.247748337761 2620.1671324204144 wj_last20_macd，xly_t_1_md_tz55 0.6399，0.5818
    """
    return factor_df
"""
AShareMoneyFlow:
