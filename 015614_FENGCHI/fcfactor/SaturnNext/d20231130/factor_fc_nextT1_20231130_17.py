...
def factor_fc_nextT1_20231130_17(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # ------------------------------------------------当日买入特大单的单数近1个月与近3个月的比值-------------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(30, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(90, min_periods=1).mean().stack()
    ...
    """
    19 -0.048
    =====>>>> 19.0 -0.048518496729356785 2.728564815482712 16.3434552246593 wj_last50_v2m1pct_lsdiff，sss_amts_5_60 0.6199，0.5541
!!!! fc_nextT1_20231130_12 0.9676664247521465
!!!! fc_nextT1_20231130_13 0.7761078373759248
!!!! fc_nextT1_20231130_15 0.7454608115749916
    """
    return factor_df
"""
AShareMoneyFlow:
