...
def factor_fc_nextT1_20231130_15(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # ------------------------------------------------当日机构主动买入金额近一个月与近一年之比-------------------------------------------------------------------
    ...
    b = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(30, min_periods=1).mean().stack()
    ...
    """
    20.04 -0.05804
    =====>>>> 20.041666666666668 -0.058044426418333635 450.1950098950389 2985.298073080596 wj_last50_v2m1pct_lsdiff，qyh_md_c_rank_250 0.5907，0.5418
    !!!! fc_nextT1_20231130_12 0.71547147357842
    """
    return factor_df
"""
AShareMoneyFlow:
