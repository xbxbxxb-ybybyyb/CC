...
def factor_fc_nextT1_20231130_11(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # -------------------------------------------------------当日买入中单的单数，近1周与近2周均值之比------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_MED_ORDER'].unstack().rolling(6, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_MED_ORDER'].unstack().rolling(10, min_periods=1).mean().stack()
    ...
    """
    18.16 -0.048
    =====>>>> 18.166666666666668 -0.04836250727759187 154.3470640177771 297.58287382260374 wj_last20_diff，skk_turn_NX11 0.618，0.5433
    """
    return factor_df
"""
AShareMoneyFlow:
