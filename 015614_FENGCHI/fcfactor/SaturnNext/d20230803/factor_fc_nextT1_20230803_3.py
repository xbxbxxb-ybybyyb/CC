...
def factor_fc_nextT1_20230803_3(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['SELL_VOLUME_MED_ORDER_ACT'].unstack().diff().rolling(20, min_periods=1).mean().stack()
    # ------------------------------------------------------中户卖出总量近20日差值均值---------------------------------------------------------------
    """
     29.875 -0.05
    """
