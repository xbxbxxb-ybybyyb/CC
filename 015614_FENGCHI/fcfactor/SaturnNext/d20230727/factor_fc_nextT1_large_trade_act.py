...
def factor_fc_nextT1_large_trade_act(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VALUE_DIFF_LARGE_TRADER_ACT'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------大户金额差(仅主动)(万元)---------------------------------------------------------------
    """
19.625 0.04555116452586384  submit
    """
    return factor_df
"""
AShareMoneyFlow:
