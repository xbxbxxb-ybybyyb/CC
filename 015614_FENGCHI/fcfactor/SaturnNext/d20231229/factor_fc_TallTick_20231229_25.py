...
def factor_fc_TallTick_20231229_25(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    全天成交金额头尾部区间上委托买单量均值的比值
    14.2083 -0.02843
    =====>>>> 14.208333333333332 -0.02843646577010735 13.784030426820317 384.9015169744441 qyh_talltick_rlength_a25_up，pre_close 0.6568，0.5454
    """
