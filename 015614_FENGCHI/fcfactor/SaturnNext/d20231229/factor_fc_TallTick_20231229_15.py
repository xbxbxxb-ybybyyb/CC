...
def factor_fc_TallTick_20231229_15(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        res = np.divide(part_df1['Sell2OrderQty'].mean(), part_df2['Sell2OrderQty'].mean())
        if np.isinf(res):
            res = 0
    else:
        res = 0
    ...
    实际卖单成交量全天分层后盘口委托量之比
    16.291 -0.0322
    =====>>>> 16.291666666666668 -0.0322250361508544 2.013317353563572 3.5462546723909174 qyh_talltick_rlength_a25_up，pre_close 0.6199，0.6074
    """
