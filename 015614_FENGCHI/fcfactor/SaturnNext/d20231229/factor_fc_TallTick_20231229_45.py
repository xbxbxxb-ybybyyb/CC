...
def factor_fc_TallTick_20231229_45(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        if part_df2['Sell5OrderQty'].mean() != 0:
            res = part_df1['Sell5OrderQty'].mean() / part_df2['Sell5OrderQty'].mean()
        else:
            res = 0
    else:
        res = 0
    ...
    T-1日卖出量头尾部卖5量均值之比
    14 0.0331
    =====>>>> 14.0 0.03314730261516539 0.9148546784877722 2.865175371709933 sss_tt_close_acthhi_buy，sss_tk_1pmidv_diffret_all_rise 0.2577，0.2347
    """
