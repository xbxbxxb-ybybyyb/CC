...
def factor_fc_TallTick_20231229_43(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按买单成交量分层，卖出盘口委托量均值之比
    14.625 0.01670
    =====>>>> 14.625 0.016703708021156276 0.5180184299935758 6.874200963826711 qyh_talltick_rlength_a25_up，zwh_20231214_002 0.5175，0.4121
    """
