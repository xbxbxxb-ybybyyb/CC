...
def factor_fc_nextT1_20230824_3(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VOLUME_DIFF_LARGE_TRADER'].unstack().diff().rolling(40, min_periods=1).mean().stack()
    # ------------------------------------------------------大户量差含主被动 近6日差值均值---------------------------------------------------------------
    """
    14.54 0.046 
    """
