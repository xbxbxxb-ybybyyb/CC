...
def factor_fc_nextT1_20230810_2(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['SELL_VALUE_LARGE_ORDER_ACT'].unstack().diff().rolling(60, min_periods=1).mean().stack()
    # ------------------------------------------------------大户主动卖出金额近20日差值均值---------------------------------------------------------------
    """
     20.125 -0.038
    """
