...
def factor_fc_nextT1_20230810_4(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().diff().rolling(20, min_periods=1).mean().stack()
    # ------------------------------------------------------机构买入单数近20日差值均值---------------------------------------------------------------
    """
     19.625 -0.043
    """
