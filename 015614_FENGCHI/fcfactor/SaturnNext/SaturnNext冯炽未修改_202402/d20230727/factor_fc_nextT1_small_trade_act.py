...
def factor_fc_nextT1_small_trade_act(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VALUE_DIFF_SMALL_TRADER_ACT'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------散户金额差(仅主动)(万元)---------------------------------------------------------------
    """
    12.416666666666666 -0.01830075577637329 submit
    """
    return factor_df
"""
AShareMoneyFlow:
