...
def factor_fc_nextT1_20230817_2(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VOLUME_DIFF_LARGE_TRADER'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------大户主被动量差 近6日差值均值---------------------------------------------------------------
    """
     14.125 0.04
    """
