...
def factor_fc_nextT1_20230817_8(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['S_MFD_INFLOW_CLOSE_LARGE_ORDER'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------大单尾盘流入资金金额 近6日差值均值---------------------------------------------------------------
    """
     12.333 0.012
    """
