...
def factor_fc_nextT1_20230817_7(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VOLUME_DIFF_LARGE_TRADER'].unstack().diff().rolling(90, min_periods=1).mean().stack()
    # ------------------------------------------------------散户主动金额差 近90日差值均值---------------------------------------------------------------
    """
     12.6667 0.041
    """
