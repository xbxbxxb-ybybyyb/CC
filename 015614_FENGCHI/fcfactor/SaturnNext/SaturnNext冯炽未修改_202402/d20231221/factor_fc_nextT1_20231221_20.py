...
def factor_fc_nextT1_20231221_20(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = (md_data['c2v'] - c2v_std).unstack().rolling(3, min_periods=1).median().stack()
    # ---------------------------------------------------------------------------------------------------------------------
    """
    close_ma6与黄线距离周度均值
    30.20 -0.0542  
    =====>>>> 30.208333333333336 -0.05425700189783932 -0.008758138389651279 0.015995995083275438 skk_20231214_42，xbc_20231207_8 0.6828，0.6739
    """
    return factor_df