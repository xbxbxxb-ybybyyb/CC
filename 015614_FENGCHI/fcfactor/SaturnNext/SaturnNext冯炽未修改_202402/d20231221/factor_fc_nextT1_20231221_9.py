...
def factor_fc_nextT1_20231221_9(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = (md_data['c2v'] - c2v_std * 3).unstack().rolling(2, min_periods=1).median().stack()
    # ---------------------------------------------------------------------------------------------------------------------
    """
    120日close与vwap距离中位值
    29.083 -0.058 
    =====>>>> 29.083333333333336 -0.05835861967711332 -0.032020523650656066 0.020011052837102077 skk_v2c_mean，xbc_20231214_13 0.6218，0.6079
    """
    return factor_df