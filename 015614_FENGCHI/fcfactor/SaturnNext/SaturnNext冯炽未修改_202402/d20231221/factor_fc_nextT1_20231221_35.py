...
def factor_fc_nextT1_20231221_35(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------------
    """
    对pct和成交量进行放缩，计算其乘积的近1周的中位值
    15.916 -0.050
    =====>>>> 15.916666666666668 -0.050094676148689656 0.08585274135653138 31.192180928081058 xbc_20231214_22，zwh_20231130_001 0.4775，0.4541
    """
    return factor_df