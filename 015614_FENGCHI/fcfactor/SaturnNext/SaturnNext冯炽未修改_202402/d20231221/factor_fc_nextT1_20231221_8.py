...
def factor_fc_nextT1_20231221_8(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = (md_data['c2v'] - c2v_std * 0.2).unstack().rolling(40, min_periods=1).median().stack()
    # ---------------------------------------------------------------------------------------------------------------------
    """
    日均价与收盘价的差值取半年平均再滚动月平均
    26.875 -0.0468
    =====>>>> 26.875 -0.04687853328345929 -0.002497352095145861 0.002581342173359554 skk_20231207_62，sss_c2vwap_20 0.654，0.4274
    """
    return factor_df