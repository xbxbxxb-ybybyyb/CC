...
def factor_fc_TallTick_20231229_26(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        res = np.divide(part_df1['Sell1OrderQty'].mean(), part_df2['Sell1OrderQty'].mean())
        if np.isinf(res):
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    T-1日上午区间内按成交卖单量头尾部卖方委托量变化率
    14.416 0.0255
    =====>>>> 14.416666666666668 0.025566020483283883 3.559492134452036 1.0586677205261297 zwh_20231214_021，zwh_20231207_038 0.3069，0.2961
    """
