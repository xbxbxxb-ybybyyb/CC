...
def factor_fc_TallTick_20231229_42(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    按买入量分头尾部统计两段内卖盘挂单量的比例
    14.833 0.0193
    =====>>>> 14.833333333333334 0.019383790444415468 0.7749549691333634 9.956799001369255 qyh_talltick_rlength_a25_up，wj_TTick_30_hcl_max 0.3814，0.3578
    """
