...
def factor_fc_TallTick_20231229_24(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    根据成交量头尾部区间的卖单委托量计算比值
    15.666 -0.0267
    =====>>>> 15.666666666666668 -0.026740324311684428 48.42748662610209 2255.507928471503 qyh_m5_vol_s2m，qyh_talltick_amt_cct 0.6237，0.6083
    """
