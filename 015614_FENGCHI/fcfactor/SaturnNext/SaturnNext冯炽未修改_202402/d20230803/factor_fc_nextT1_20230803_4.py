...
def factor_fc_nextT1_20230803_4(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['SELL_VALUE_SMALL_ORDER_ACT'].unstack().diff().rolling(20, min_periods=1).mean().stack()
    # ------------------------------------------------------散户卖出金额近20日差值均值---------------------------------------------------------------
    """
     29.66 -0.059
    """
