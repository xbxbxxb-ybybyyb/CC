...
def factor_fc_nextT1_20231130_7(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # -----------------------------------------------------当日买入特大单的单数 近2个月与近半年的均值之比--------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(40, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_EXLARGE_ORDER'].unstack().rolling(120, min_periods=1).mean().stack()
    ...
    """
    17.75 -0.045
    =====>>>> 17.75 -0.04544899844479015 2.251672607443711 15.728643327031081 wj_last50_v2m1pct_lsdiff，xbc_20230713_2 0.6014，0.4749
!!!! fc_nextT1_20231130_12 0.7646154213713118
!!!! fc_nextT1_20231130_15 0.7984936811975364
!!!! fc_nextT1_20231130_5 0.7538952114136303
    """
    return factor_df
"""
AShareMoneyFlow:
