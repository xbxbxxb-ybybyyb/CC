...
def factor_fc_nextT1_20231130_2(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    a = md_data['BUY_TRADES_SMALL_ORDER'].unstack().rolling(90, min_periods=1).mean().stack()
    ...
    """
    31.45 -0.07296
    =====>>>> 31.458333333333336 -0.07296018329189734 4693.859372728409 8427.501835273322 sss_amts_5_60，fc_nextT1_20230803_2 0.686，0.6669
    """
    return factor_df
"""
AShareMoneyFlow:
