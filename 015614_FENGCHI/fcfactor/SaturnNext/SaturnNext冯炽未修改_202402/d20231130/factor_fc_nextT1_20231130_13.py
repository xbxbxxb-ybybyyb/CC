...
def factor_fc_nextT1_20231130_13(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]

    if return_fillna_dic:
        return {factor_name: 0, 'data': ['AShareMoneyFlow']}
    # ---------------------------------------------------当日买入大单的单数近1个月与1个季度均值之比----------------------------------------------------------------
    ...
    b = md_data['BUY_TRADES_LARGE_ORDER'].unstack().rolling(20, min_periods=1).mean().stack()
    a = md_data['BUY_TRADES_LARGE_ORDER'].unstack().rolling(60, min_periods=1).mean().stack()
    ...
    """
    20.04 -0.04
    =====>>>> 20.041666666666668 -0.042678127398041915 25.878782250309865 106.70591438947824 sss_amts_5_60，wj_last50_v2m1pct_lsdiff 0.6589，0.6063
!!!! fc_nextT1_20231130_12 0.7727699701023817
    """
    return factor_df
"""
AShareMoneyFlow:
