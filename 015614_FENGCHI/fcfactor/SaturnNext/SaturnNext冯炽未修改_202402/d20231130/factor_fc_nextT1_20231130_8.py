...
def factor_fc_nextT1_20231130_8(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    a = md_data['BUY_VALUE_EXLARGE_ORDER_ACT'].unstack().rolling(120, min_periods=1).mean().stack()
    ...
    """
    22.20 -0.04893
    =====>>>> 22.208333333333336 -0.048931586727374195 3150.5744286672657 9254.004794782171 qyh_talltran_bamt_cv，fc_nextT1_20230810_3 0.6883，0.688
    """
    return factor_df
"""
AShareMoneyFlow:
