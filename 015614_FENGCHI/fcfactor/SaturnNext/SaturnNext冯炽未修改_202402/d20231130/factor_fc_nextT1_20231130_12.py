...
def factor_fc_nextT1_20231130_12(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    b = md_data['BUY_VALUE_EXLARGE_ORDER'].unstack().rolling(30, min_periods=1).mean().stack()
    a = md_data['BUY_VALUE_EXLARGE_ORDER'].unstack().rolling(90, min_periods=1).mean().stack()
    ...
    """
    18.79 -0.046
    =====>>>> 18.791666666666668 -0.04626635743451429 708.8542644662142 3963.9905728300055 wj_last50_v2m1pct_lsdiff，sss_amts_5_60 0.5961，0.5721
    """
    return factor_df
"""
AShareMoneyFlow:
