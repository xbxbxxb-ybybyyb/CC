...
def factor_fc_TallTick_20231102_4(df, return_fillna_dic=False):
    import sys
    ...
    df['itvl_pct'] = ((df['LastPx'] - df['LastPx'].shift(20)) / pre_close).apply(lambda x: round_(x, 6))
    ...
    eur2mimas:
    17.04166 0.04833  
    =====>>>> 17.041666666666668 0.04833515855815733 -0.0097961744800302 0.025168645158201306 fc_TallTick_m2h_mean，sss_min5_pctstd_rank 0.4801，0.4453
    """
