...
def factor_fc_TallTick_20231229_31(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    根据全天成交量进行分段，按照盘口卖2的委托量计算比值
    21.583 0.0451
    =====>>>> 21.583333333333332 0.04516190139353007 1.2210152966359873 5.31820869150382 wj_TTick_h2c_val，wj_TTick_30_hcl_max 0.3873，0.3781
    """
