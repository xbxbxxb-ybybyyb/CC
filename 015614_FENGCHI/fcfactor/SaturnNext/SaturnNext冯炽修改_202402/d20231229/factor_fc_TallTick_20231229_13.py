...
def factor_fc_TallTick_20231229_13(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    全天买单成交量分层之下卖单委托量对应比值
    21.375 0.0517 
    =====>>>> 21.375 0.05173672763814351 2.148675165690923 0.5263225101168602 wj_TTick_h2c_val，zwh_20231214_021 0.5662，0.5234
    """
