...
def factor_fc_TallTick_20231229_21(df, return_fillna_dic=False):
    import sys
    ...
    if len(df) > 0:
        ...
        res = np.divide(part_df1['Sell1NumOrders'].mean(), part_df2['Sell1NumOrders'].mean())
        if np.isinf(res):
            res = 0
    else:
        res = 0
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    全天不同卖出量的时间段下卖1委托笔数的比值
    12.875 -0.0349
    =====>>>> 12.875000000000002 -0.03499843759679526 1.4707498974575908 1.7083769284545702 zwh_20231214_002，zwh_20231221_032 0.5223，0.4831
    """
