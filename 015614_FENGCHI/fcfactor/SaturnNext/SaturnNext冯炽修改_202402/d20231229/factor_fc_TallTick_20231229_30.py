...
def factor_fc_TallTick_20231229_30(df, return_fillna_dic=False):
    import sys
    ...
    # ---------------------------------------------------------------------------------------------------------------
    """
    根据成交量分层后头尾部区间上卖1委托量的均值之比
    30.0833 0.0477 
    =====>>>> 30.083333333333336 0.047786830126788735 0.4190991671097909 0.36426479626264235 wj_TTick_30_hcl_max，skk_20231221_7 0.4675，0.4495
    """
