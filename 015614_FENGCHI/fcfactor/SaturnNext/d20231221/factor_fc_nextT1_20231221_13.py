...
def factor_fc_nextT1_20231221_13(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = (md_data['c2v'] + c2v_std * 2).unstack().rolling(3, min_periods=1).median().stack()
    # ---------------------------------------------------------------------------------------------------------------------
    """
    月c2v均值考虑波动后的近期中位值
    13.2083 -0.047  
    =====>>>> 13.208333333333332 -0.0479808703783544 0.0385143997578272 0.020570230269880137 skk_20231214_42，skk_20231207_47 0.6591，0.6402
    """
    return factor_df