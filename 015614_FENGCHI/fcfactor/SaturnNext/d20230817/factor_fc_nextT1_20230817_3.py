...
def factor_fc_nextT1_20230817_3(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['BUY_VOLUME_EXLARGE_ORDER'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------机构买入总量近6日差值均值---------------------------------------------------------------
    """
    write wrong, not BUY_VOLUME_EXLARGE_ORDER, has updated at 20230824
    """
    return factor_df
"""
AShareMoneyFlow:
