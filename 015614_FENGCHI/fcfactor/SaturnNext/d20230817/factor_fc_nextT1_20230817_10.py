...
def factor_fc_nextT1_20230817_10(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['SELL_TRADES_SMALL_ORDER'].unstack().diff().rolling(40, min_periods=1).mean().stack()
    # ------------------------------------------------------散户卖出单数 近40日差值均值---------------------------------------------------------------
    """
     18.79 -0.043
    """
