...
def factor_fc_nextT1_20230817_4(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VALUE_DIFF_SMALL_TRADER'].unstack().diff().rolling(20, min_periods=1).mean().stack()
    # ------------------------------------------------------散户金额差含主被动 近20日差值均值---------------------------------------------------------------
    """
     13.5 -0.03
    """
