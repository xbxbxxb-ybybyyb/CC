...
def factor_fc_nextT1_20230817_1(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['SELL_VALUE_SMALL_ORDER_ACT'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------散户主动卖出金额近6日差值均值---------------------------------------------------------------
    """
    17.3 -0.04
    """
