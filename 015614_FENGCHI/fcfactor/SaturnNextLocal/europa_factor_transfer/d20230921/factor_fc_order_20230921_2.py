...
def factor_fc_order_20230921_2(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    # -----------------------------------------------------55.9 0.099----------------------------------------------------------
    # 55.91666666666667 0.09917335636981889 2.835131883350123 19.482859206980798 fc_order_20230914_12，skk_order_l5_qty_rate 0.6885，0.6881
    """
    MDTime: 时间
