...
def factor_fc_order_20230921_3(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    # -----------------------------------------------------53.125 0.097----------------------------------------------------------
    #  53.125 0.09779623080181016 8.484250002636399 86.27233513707773 skk_order_l5_qty_rate，fc_order_last_order_money 0.6635，0.6069
    """
    MDTime: 时间
