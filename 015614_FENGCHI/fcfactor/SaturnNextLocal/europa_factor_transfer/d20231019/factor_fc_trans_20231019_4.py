...
def factor_fc_trans_20231019_4(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    short_time = fun_shift_time(ZT_Time, -min(60000, int(dis2opn / 20)))
    long_time = fun_shift_time(ZT_Time, -min(300000, int(dis2opn / 2)))
    ...
    """
    32.70 0.078
    =====>>>> 32.708333333333336 0.07845362302941121 -0.17836473667297148 0.31951166523541064 Long_short_volatility_diff，fc_trans_order_20230928_13 0.6471，0.6169
    !!!! fc_trans_20231019_1 0.7161511746612083
    """
