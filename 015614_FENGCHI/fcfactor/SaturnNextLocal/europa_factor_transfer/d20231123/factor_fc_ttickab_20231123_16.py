...
def factor_fc_ttickab_20231123_16(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------突破前五分钟内两段区间内均买价占TickK柱比例的比值----------------------------------------------------
    ...
    """
    68.04 0.1106
    =====>>>> 68.04166666666667 0.11067273433233756 16047.483804220805 1147498.8858798156 qyh_ttick_20231109_1，t_big_vwap_chg_sdl 0.6847，0.6233
    """
    """
    MDTime: 时间
