...
def factor_fc_ttickab_20231123_9(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------突破前5秒钟相对于近半小时Vwap均值的变化幅度----------------------------------------------------
    ...
    """
    44.29 -0.079
    =====>>>> 44.29166666666667 -0.07936081930749787 19.953545949182296 144.4139304374704 xbc_20230914_7，xbc_20230914_13 0.6333，0.5805
    """
    """
