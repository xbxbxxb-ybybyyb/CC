...
def factor_fc_ttickab_20231123_6(df, param_tuple=(), return_fillna_dic=False):
    import sys
    ...
    start_time1 = max(fun_get_time(zt_time, -30), 93000000)
    ...
    """
    50 -0.082
    =====>>>> 50.0 -0.08210932204488341 23.96961080979817 149.61829760145423 sss_tk_bpctdiff_t20_halfd，xbc_20230921_11 0.6729，0.6203
    """
    """
