...
def factor_fc_ttickab_20231123_10(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------突破前10秒钟相对于半分钟内Vwap均值的变化幅度----------------------------------------------------
    ...
    start_time2 = max(fun_get_time(zt_time, -30), 93000000)
    ...
    """
    41 -0.078
    =====>>>> 41.00000000000001 -0.07861115251653678 20.97556975236697 139.88222345167915 sss_tk_bpctdiff_t20_halfd，xbc_20230921_11 0.5733，0.524
    """
    """
