...
def factor_fc_trans_20231116_8(df, param_tuple=(), return_fillna_dic=False):
    import sys
    factor_name = sys._getframe().f_code.co_name[7:]
    # -------------------------------------------------突破前五分钟内逐笔成交中每10s区间内价格上涨的数量占比--------------------------------------------------------
    ...
    """
    35.54 -0.0429
    =====>>>> 35.541666666666664 -0.042951368103825535 1.1481365397880292 0.3777770143881676 xbc_20231026_4，fc_ttickab_20231026_14 0.5333，0.521
    """
