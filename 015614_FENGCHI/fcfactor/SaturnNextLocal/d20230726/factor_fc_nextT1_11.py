...
def factor_fc_nextT1_11(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['BUY_VALUE_EXLARGE_ORDER'].unstack().rolling(20, min_periods=3).sum().stack()
    # -------------------------------------------------------机构买入金额--------------------------------------------------------------
    """
    1.875 -0.014859064526833487 saturn_wd_lztcs_big_bid_pct_sum2 0.7361420005254333
    """
    return factor_df
"""
AShareMoneyFlow:
