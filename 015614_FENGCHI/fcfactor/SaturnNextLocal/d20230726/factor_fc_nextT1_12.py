...
def factor_fc_nextT1_12(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['BUY_VOLUME_EXLARGE_ORDER'].unstack().rolling(20, min_periods=3).sum().stack()
    # -------------------------------------------------------机构买入总量--------------------------------------------------------------
    """
    11.625 -0.028335201951143568 saturn_lztb_sundc_t_tran_20，xly_t_1_md_tz23 0.742371505853622，0.7301221778054912
计算本地高相关：
fc_nextT1_10.h5 0.8499505474750934
fc_nextT1_11.h5 0.8864846196307491
    """
    return factor_df
"""
AShareMoneyFlow:
