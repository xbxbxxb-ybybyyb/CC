...
def factor_fc_nextT1_10(start_date, end_date, IO, return_fillna_dic=False):
    ...
    factor_df[factor_name] = md_data['BUY_VALUE_EXLARGE_ORDER'].unstack().rolling(20, min_periods=3).std().stack()
    # -------------------------------------------------------机构买入金额--------------------------------------------------------------
    """
    5.208333333333334 -0.02580041945242295 saturn_wd_lztcs_big_bid_pct_sum2 0.7192710729068988
    """
    return factor_df
"""
AShareMoneyFlow:
