...
def factor_fc_nextT1_17(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['S_MFD_INFLOW'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------净流入金额---------------------------------------------------------------
    """
    7.291666666666668 0.03198278082785298 
    """
    return factor_df
"""
AShareMoneyFlow:
