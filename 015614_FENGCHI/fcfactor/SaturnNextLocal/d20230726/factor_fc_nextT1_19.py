...
def factor_fc_nextT1_19(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    factor_df[factor_name] = md_data['VALUE_DIFF_MED_TRADER_ACT'].unstack().diff().rolling(6, min_periods=1).mean().stack()
    # ------------------------------------------------------中户金额差(仅主动)(万元)---------------------------------------------------------------
    """
    2.291666666666667 0.019085179101564036  
    """
    return factor_df
"""
AShareMoneyFlow:
