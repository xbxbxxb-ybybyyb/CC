...
def factor_fc_nextT1_4(start_date, end_date, IO, return_fillna_dic=False):
    import sys
    ...
    # ----------------------------------最低价与收盘价只差相对于昨收，5日平均 29.291666666666668 0.07362971334959063 wj_last10_bbi 0.7258861789190602-------------------------------------------------------------------------------
    return factor_df