...
root_path = '/data/user/015614/factor/dig_NextT1_20231201015455/'
note = root_path.split('_')[-1][:-1] + '_part12_2'
file_list = os.listdir(root_path)
xlsx_list = list(filter(lambda x: x.endswith('.xlsx') and not x.startswith('因子'), sorted(file_list)))[4900:5300]
factor_fpath_list = list(filter(lambda x: x.endswith('.pkl'), sorted(file_list)))[4900:5300]
res_list = []
...
week_root_path = f'/data/user/015614/factor/d20231130_saturnNext/'
