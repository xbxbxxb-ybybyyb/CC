...
class FactorParamSearch:
    ...
    def calc_factor(start_date, end_date, IO, param_tuple, return_fillna_dic=False):
        ...
        b = md_data['close'].unstack().rolling(param2, min_periods=1).mean().stack()
        a = md_data['close'].unstack().rolling(param3, min_periods=1).mean().stack()
...
if __name__ == '__main__':
    ...
    param_list = [[1, 2, 3, 6, 10, 20, 30, 40, 60, 90, 120],
