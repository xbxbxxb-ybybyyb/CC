...
root_path = '/data/user/015614/factor/dig_NextT1_4_20231218180051/'
note = root_path.split('_')[-1][:-1] + '_part2'
file_list = os.listdir(root_path)
xlsx_list = list(filter(lambda x: x.endswith('.xlsx') and not x.startswith('因子'), sorted(file_list)))[470:]
factor_fpath_list = list(filter(lambda x: x.endswith('.pkl'), sorted(file_list)))[470:]
res_list = []
...
week_submit_date = 20231221
week_root_path = f'/data/user/015614/factor/d20231221_saturnNext/'
