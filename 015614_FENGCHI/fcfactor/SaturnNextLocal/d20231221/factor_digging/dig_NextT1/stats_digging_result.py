...
root_path = '/data/user/015614/factor/dig_NextT1_20231218100521/'
note = root_path.split('_')[-1][:-1] + '_part16'
file_list = os.listdir(root_path)
xlsx_list = list(filter(lambda x: x.endswith('.xlsx') and not x.startswith('因子'), sorted(file_list)))[6000:6400]
factor_fpath_list = list(filter(lambda x: x.endswith('.pkl'), sorted(file_list)))[6000:6400]
res_list = []
...
week_submit_date = 20231229
week_root_path = f'/data/user/015614/factor/d20231229_saturnNext/'
