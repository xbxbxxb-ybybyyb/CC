...
start_date = 20160101
end_date = 20201231
mercury_df = IO.read_data([start_date, end_date], alt='/dfs/group/800463/data/mercury/ff_data/All_Factor/all_factor_dt_label_new.h5')

root_path = '/data/user/015614/fefactorframework/mercury_d20240523_factor_digging_1/factor_test/mercury/'
factor_value = f'/data/user/015614/fefactorframework/mercury_d20240523_factor_digging_1/factor_value/mercury/'
note = '_part2'
...
for factor_fpath in factor_value_list:
    ...
    if factor_fpath != 'factor.pkl':
        ...
        if tmp.shape[0] != mercury_df.shape[0]:
            print(f'{factor_fpath}样本长度不匹配')
        tmp = tmp.reindex(index=mercury_df.index)
        factor_df_list.append(tmp)

#%% 计算和本周已提交因子的相关性
week_submit_date = 20240523
week_root_path = f'/data/user/015614/factor/d{week_submit_date}_Mercury/'
...
has_submit_factors = [
    'fc_T1_n20240523_1023',
    'fc_T1_n20240523_1017',
    'fc_T1_n20240523_1018',
    'fc_T1_n20240523_1040',
    'fc_T1_n20240523_103',

    'fc_T1_n20240523_134',
    'fc_T1_n20240523_1039',
    'fc_T1_n20240523_16',
    'fc_T1_n20240523_105',
    'fc_T1_n20240523_110',
