...
os.chdir(f'/data/user/015614/fcfactor/fefactorframework/batch_factor/Mercury/{d_date}/{digging_name}/')

# factor_list = [f'factor_base']
factor_list = [f'factor_fc_T1_n20240523_1']

res, check_res = Runner.run(factor_name_list=factor_list, start_date=20161201, end_date=20201231, strategy=strategy,
