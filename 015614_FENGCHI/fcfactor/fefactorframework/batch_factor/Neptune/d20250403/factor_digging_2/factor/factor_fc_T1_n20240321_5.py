...
class factor_fc_T1_n20240321_5(BaseFactor):
    owner = 'fc'
    strategy_name = "neptune"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "zt日散户卖出总量相对于近1年中位值的差值"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = "是"
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        a = md_data['SELL_VOLUME_SMALL_ORDER_ACT'].unstack().rolling(240, min_periods=1).median().stack()
