...
param1, param2, param3, param4, param5 = "Buy2Price", "TotalVolumeTrade", 15, 0.03, 5 # 配置超参数

class factor_fc_ttickab_n20240808_346(BaseFactor):
    owner = 'fc'
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            # 计算因子值
            res = np.divide(part_tick_df[col + '_new'].mean(), tick_df[col + '_new'].mean())
            # print(res)
