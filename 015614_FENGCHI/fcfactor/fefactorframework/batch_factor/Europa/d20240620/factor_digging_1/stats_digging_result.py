...
root_path = '/data/user/015614/fefactorframework/europa_d20240620_factor_digging_1/factor_test/europa/'
factor_value = f'/data/user/015614/fefactorframework/europa_d20240620_factor_digging_1/factor_value/europa/'
note = '_part1'
...
res_df2 = res_df2.sort_values('score', ascending=False).query('score > 15 & highest_corr < 0.695 & high_corr_s_num == 0')
res_df2['drop'] = 0
res_df2['commit'] = 0
