...
start_date = 20160101
end_date = 20191231
all_factor_fpath = '/dfs/group/800463/data/project2_public/factor_lib/sft_update_filter_20160101_20191231.pkl'
...
root_path = f'/data/user/015614/fefactorframework/{strategy}_{d_date}_{digging_name}/factor_test/europa/'
factor_value = f'/data/user/015614/fefactorframework/{strategy}_{d_date}_{digging_name}/factor_value/europa/'
note = 'all'
