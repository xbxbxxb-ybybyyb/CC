...
root_path = f'/data/user/015614/fefactorframework/{strategy}_{d_date}_{digging_name}/factor_test/metis/'
factor_value = f'/data/user/015614/fefactorframework/{strategy}_{d_date}_{digging_name}/factor_value/metis/'
note = 'all'
...
week_root_path = f'/data/user/015614/factor/d{week_submit_date}_Metis/'
