...
param1, param2, param3 = "OrderMoney", 0.25, "OrderMoney" # 配置超参数

class factor_fc_n20250320_7(BaseFactor):
    owner = 'fc'
    strategy_name = "metis"
    ...
    t_day_data = ['TCancelprice_MetisAll']
    xdb_data = [
    ]
    ...
    def calculate(self, database):
        ...
        if database["skip"] == True:
            ...
            df = database['TCancelprice_MetisAll']
            ...
            res21 = part_df2.query('OrderBSFlag == 1')[param3].sum()
            res22 = part_df2.query('OrderBSFlag == 2')[param3].sum()
