...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'neptune':
            # sft_basic_path = '/dfs/group/800463/public/projectZZ_public/factor_lib/sft_update_931_20160101_20201231.pkl'  # 这个文件里有label和所有因子
        ...
        all_factors_available = ['label_t2o9d1_pos', 'label_t2o9d1_neg', 'Circu_Mkt']
    ...
    def factor_test(self, factor_df, cost_list, result_path, factor_corr_test=False, generate_pdf=False):
        ...
        factor_df = factor_df.replace(np.inf, np.nan).replace(-np.inf, np.nan)
