...
from xfactor.factor_precheck import jupiter_precheck, europa_precheck, sell_precheck,\
    saturn_precheck, mimas_precheck, metis_precheck, mercury_precheck, neptune_precheck, hotspot_precheck
...
func_map = {
    ...
    "hotspot": hotspot_precheck.hotspot_precheck_aftercalc,
}
