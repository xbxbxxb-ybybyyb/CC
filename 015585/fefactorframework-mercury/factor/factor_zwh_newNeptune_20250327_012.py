...
class factor_zwh_newNeptune_20250327_012(BaseFactor):
    owner = 'zwh'
    strategy_name = "europa"
    factor_name = "zwh_newNeptune_20250327_012"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "开盘波动幅度" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = open_pct.unstack().rolling(5, min_periods=5).mean().stack()  ## 14--12.08
