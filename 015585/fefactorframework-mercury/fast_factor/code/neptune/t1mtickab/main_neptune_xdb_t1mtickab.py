...
class factor_{}(BaseFactor):
    ...
    if len(list_class) > 0:
        res, check_res = Runner.run(start_date=20170101, end_date=20170131, strategy=strategy,
                         output_dir="/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/neptune/20250611_xdbtick1m/",
                         options={
                             "calc.num_cpus": 24,
                             "local_evaluator": "",
                             'precheck': False,
