...
from fast_factor.code.europa.tcancel.function_factor_tcancel import *
...
class factor_{}(BaseFactor):
    ...
    if len(list_class) > 0:
        res, check_res = Runner.run(start_date=20170101, end_date=20191231, strategy=strategy,
                         output_dir="/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20241206tcancel/",
                         options={
                             "calc.num_cpus": 24,
                             "local_evaluator": "",
                             'precheck': False,
