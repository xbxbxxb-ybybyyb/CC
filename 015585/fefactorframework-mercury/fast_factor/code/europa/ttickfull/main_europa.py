...
from fast_factor.code.europa.ttickfull.function_factor import *
...
# 计算
list_del = []
for file_name in os.listdir('/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20240612ttickfull/factor_value/europa'):
    list_del.append(file_name.replace('.h5',''))
for file_name in os.listdir('/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20240620ttickfull/factor_value/europa'):
    list_del.append(file_name.replace('.h5',''))
for file_name in os.listdir('/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20240711ttickfull/factor_value/europa'):
    list_del.append(file_name.replace('.h5',''))
for file_name in os.listdir('/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20240813ttickfull/factor_value/europa'):
    list_del.append(file_name.replace('.h5',''))
...
class factor_{}(BaseFactor):
    ...
    if len(list_class) > 0:
        res, check_res = Runner.run(start_date=20170101, end_date=20191231, strategy=strategy,
                         output_dir="/dfs/user/015585/01_factor_develop_store/fast_factor_newframe/europa/20241204ttickfull/",
                         options={
                             "calc.num_cpus": 24,
                             "local_evaluator": "",
                             'precheck': False,
