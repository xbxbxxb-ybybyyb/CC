...
for time_kind_i,time_type_i,\
    ...
    for calc_i in dic_calc:
        ...
        res, check_res = Runner.run(start_date=20160101, end_date=20160630, strategy=strategy,
                         ...
                         options={
                             ...
                             "factor_test": True,
                             'report':False,
                             'mode': RunMode.research},class_list_out=[factor_qyh_fastfactor])
        i = factor_qyh_fastfactor.factor_name
        print(i)
