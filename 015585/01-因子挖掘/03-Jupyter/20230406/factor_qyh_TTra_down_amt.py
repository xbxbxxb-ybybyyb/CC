...
# jlh_2020_4
# yzhan_hf_f3_28
factor_name = 'qyh_TTra_down_amt'#
def factor_qyh_TTra_down_amt(trans_df, return_fillna_dic=False):
    ...
    buy = buy_max - buy_min
    amt = trans_df[trans_df['TradeSellNo'].isin(list(buy[buy>0.001].index))]['TradeMoney'].sum()
