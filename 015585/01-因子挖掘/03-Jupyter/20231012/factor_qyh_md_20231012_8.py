...
s = FactorData()
factor_name = 'qyh_md_20231012_8'
# zcz,dtj
# 上影线10日均值
# 0.07,43
# down_std_minute5_v3_20d:23
def factor_qyh_md_20231012_8(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(10,1).mean().stack()
    # -------------------------------------------------------------------------------------------------------------------
