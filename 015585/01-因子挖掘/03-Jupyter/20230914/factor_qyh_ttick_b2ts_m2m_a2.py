...
#
#
factor_name = 'qyh_ttick_b2ts_m2m_a2'#
def factor_qyh_ttick_b2ts_m2m_a2(tick_df, return_fillna_dic=False):
    ...
    #
    res1 = tick_df1['WeightedAvgOfferPx'].std()
    res2 = tick_df2['WeightedAvgOfferPx'].std()
    res = (res1+0.0001)/(res2+0.0001)
