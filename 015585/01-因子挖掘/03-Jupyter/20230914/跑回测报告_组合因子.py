...
# from factor_qyh_ttick_amt import factor_qyh_ttick_amt as func
...
'''
date = '20230914'#周四日期
factor_name = 'factor_qyh_ttick_amt'
print(factor_name)
...
df1 = pd.read_hdf(result_path + 'factor_qyh_ttick_amt' + '.h5')
df2 = pd.read_hdf(result_path + 'factor_qyh_md_amt5' + '.h5')
df = pd.concat([df1,df2],axis=1)
df['factor'] = df['qyh_ttick_amt'] / df['qyh_md_amt5']
df = df[['factor']]
print('全样本')
