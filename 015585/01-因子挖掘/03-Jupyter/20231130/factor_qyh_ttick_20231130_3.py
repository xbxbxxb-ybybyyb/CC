...
def factor_qyh_ttick_20231130_3(tick_df, return_fillna_dic=False):
    ...
    tick_df['v'] = tick_df['v'].apply(lambda x : 100000 if x >= 100000 else -100000 if x <= -100000 else round_(x,6))
    ...
    tick_df1 = tick_df[tick_df['v'] > tick_df['v'].shift(1)]
    tick_df2 = tick_df[tick_df['v'] < tick_df['v'].shift(1)]
    #
