...
s = FactorData()
factor_name = 'qyh_md_20231130_3'
# zcz,dtj
# T-1上影线，以open为基准
# 73,0.089
# qyh_md_20231012_5:55
def factor_qyh_md_20231130_3(start_date, end_date, IO, return_fillna_dic=False):
    ...
    #
    df_ori['A'] = df_ori['high'].unstack().fillna(method='ffill',limit=20).stack()
    df_ori['B'] = df_ori['close'].unstack().fillna(method='ffill',limit=20).stack()
    df_ori['C'] = (df_ori['open']).unstack().fillna(method='ffill',limit=20).stack()
