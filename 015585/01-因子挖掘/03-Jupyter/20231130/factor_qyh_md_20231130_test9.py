...
s = FactorData()
# 北向资金：最近5日/20日持股市值变化占股票市值比例，缺失值用行业均值填充
'''

'''
#
factor_name = 'qyh_md_20231130_test9'
def factor_qyh_md_20231130_test9(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['qty_delta'] = df_ori['qty'] - df_ori['qty'].unstack().shift(5).stack()
