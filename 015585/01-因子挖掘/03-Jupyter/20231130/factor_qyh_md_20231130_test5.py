...
s = FactorData()
# 北向资金：最新持股市值占股票市值比例,行业均值填充
'''

'''
#
factor_name = 'qyh_md_20231130_test5'
def factor_qyh_md_20231130_test5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    # para = 5
    # ind_data[factor_name] = df_ori['qty'].unstack().rolling(para,5).mean().stack()
    #
