...
s = FactorData()
factor_name = 'qyh_ulnum_500_indu'
def factor_qyh_ulnum_500_indu(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['ulnum_n_indu_rank'] = df_ori.groupby(['dt','industry'])['ulnum_n'].rank(ascending = False,method = 'min')
    f_data = pd.DataFrame(df_ori['ulnum_n_indu_rank'])
