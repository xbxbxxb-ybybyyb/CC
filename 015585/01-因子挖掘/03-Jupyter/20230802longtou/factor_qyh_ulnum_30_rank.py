...
s = FactorData()
factor_name = 'qyh_ulnum_30_rank'
def factor_qyh_ulnum_30_rank(start_date, end_date, IO, return_fillna_dic=False):
    ...
    # rank
    df_ori['cnt_num_n_transfer_rank'] = df_ori.groupby('dt')['cnt_num_n_transfer'].rank()
    f_data = pd.DataFrame(df_ori['cnt_num_n_transfer_rank'])
