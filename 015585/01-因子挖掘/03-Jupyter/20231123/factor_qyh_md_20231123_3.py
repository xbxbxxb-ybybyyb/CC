...
s = FactorData()
factor_name = 'qyh_md_20231123_3'
# zcz
#
#
#
def factor_qyh_md_20231123_3(start_date, end_date, IO, return_fillna_dic=False):
    ...
    #
    df_ori[factor_name] = ((df_ori['open'] + df_ori['close'])/2 - df_ori['vwap']) / df_ori['close'] - 1
