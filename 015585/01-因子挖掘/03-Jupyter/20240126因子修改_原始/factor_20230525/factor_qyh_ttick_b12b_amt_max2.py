...
factor_name = 'qyh_ttick_b12b_amt_max2'#
def factor_qyh_ttick_b12b_amt_max2(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 12.13}
    ...
    if tick_df1.empty:
        ...
        pct1 = ((tick_df1['Buy1Price'] - tick_df1['WeightedAvgBidPx']) / pre).max()
    if tick_df2.empty:
        pct2 = np.nan
    else:
