...
factor_name = 'qyh_ttick_sp_skew_ud'#
def factor_qyh_ttick_sp_skew_ud(tick_df, return_fillna_dic=False):
    ...
    #
    res1 = tick_df1['WeightedAvgOfferPx'].skew()
    res2 = tick_df2['WeightedAvgOfferPx'].skew()
    res = res1-res2
    if res > 0.55:
        res = (res - 0.55)/100
