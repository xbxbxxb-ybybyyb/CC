...
import pandas as pd
#
# 逻辑：相对净挂买在前1分钟和触发前1分钟的差
# 快速:
# 全样本：
# 写过了，别交了
factor_name = 'factor_qyh_ttick_rcleanb_sum_h2t'#
def factor_qyh_ttick_rcleanb_sum_h2t(tick_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: rcleanb1 - rcleanb2}
    # ---------------------------------------------------------------------------------------------------------------
