...
import pandas as pd
#
# 逻辑：买1-买均在后一半tick中上涨和下跌的均值差
# 快速:-0.1,51
# 全样本：
# qyh_ttick_b12b_ud_mean:70
factor_name = 'qyh_ttick_b12b_h2_mean_hd'#
def factor_qyh_ttick_b12b_h2_mean_hd(tick_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: factor1 - factor2}
    # ---------------------------------------------------------------------------------------------------------------
