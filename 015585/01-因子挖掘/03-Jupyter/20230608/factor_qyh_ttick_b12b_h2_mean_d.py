...
import pandas as pd
#
# 逻辑：买1-买均在后一半tick中下跌的均值
# 快速:23,0.07
# 全样本：
# qyh_ttick_pb2l_med
factor_name = 'qyh_ttick_b12b_h2_mean_d'#
def factor_qyh_ttick_b12b_h2_mean_d(tick_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: factor2}
    # ---------------------------------------------------------------------------------------------------------------
