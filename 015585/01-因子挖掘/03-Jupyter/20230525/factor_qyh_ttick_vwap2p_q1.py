...
import pandas as pd
#
# 逻辑：前1/4时间中，vwap/最新价的均值
# 快速：22，-0.069
# 全样本：
# wu
factor_name = 'qyh_ttick_vwap2p_q1'#
def factor_qyh_ttick_vwap2p_q1(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0.9968}
