...
import pandas as pd
#
# 逻辑：末期价格下跌时，挂买价格和成交均价的corr
# 快速:-0.059,24
# 全样本：
#
factor_name = 'qyh_ttick_corrb2tp_dn_p75'#
def factor_qyh_ttick_corrb2tp_dn_p75(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0.709}
