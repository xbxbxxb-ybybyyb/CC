...
s = FactorData()
factor_name = 'qyh_md_20231019_2'
# zcz,dtj
# 收盘价/20日中位数
# 38,-0.062
# wj_last_C2preC_pct:38,zwh_20230907_002:40
def factor_qyh_md_20231019_2(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = (df_ori['factor']) / df_ori['factor'].unstack().rolling(20,1).median().stack()
    # -------------------------------------------------------------------------------------------------------------------
