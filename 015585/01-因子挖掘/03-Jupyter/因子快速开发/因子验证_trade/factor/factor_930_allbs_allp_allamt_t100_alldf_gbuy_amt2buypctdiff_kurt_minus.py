...
factor_name = '930_allbs_allp_allamt_t100_alldf_gbuy_amt2buypctdiff_kurt_minus'#
def factor_930_allbs_allp_allamt_t100_alldf_gbuy_amt2buypctdiff_kurt_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_t100_alldf_gbuy_amt2buypctdiff_kurt_minus"
    ...
    res = f_calc_kurt(trade_df['factor'])
