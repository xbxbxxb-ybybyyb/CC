...
factor_name = '1m_buy_allp_big_t100_alldf_calc_pct_tail_minus'#
def factor_1m_buy_allp_big_t100_alldf_calc_pct_tail_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_buy_allp_big_t100_alldf_calc_pct_tail_minus"
