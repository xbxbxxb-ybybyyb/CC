...
factor_name = '930_allbs_allp_allamt_t50_alldf_gbuy_amt2buypctdiff_med_minus'#
def factor_930_allbs_allp_allamt_t50_alldf_gbuy_amt2buypctdiff_med_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_t50_alldf_gbuy_amt2buypctdiff_med_minus"
    ...
    res = f_calc_med(trade_df['factor'])
