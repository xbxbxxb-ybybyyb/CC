...
factor_name = '1m_buy_allp_small_all_alldf_calc_pct_cv_minus'#
def factor_1m_buy_allp_small_all_alldf_calc_pct_cv_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_buy_allp_small_all_alldf_calc_pct_cv_minus"
