...
factor_name = '930_allbs_allp_allamt_t300_alldf_gbuy_vwappct_avg_minus'#
def factor_930_allbs_allp_allamt_t300_alldf_gbuy_vwappct_avg_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_t300_alldf_gbuy_vwappct_avg_minus"
    ...
    res = f_calc_avg(trade_df['factor'])
