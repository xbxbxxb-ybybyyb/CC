...
factor_name = '1m_allbs_allp_allamt_all_lendf1_gbuy_vwappct_min_div'#
def factor_1m_allbs_allp_allamt_all_lendf1_gbuy_vwappct_min_div(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_allbs_allp_allamt_all_lendf1_gbuy_vwappct_min_div"
