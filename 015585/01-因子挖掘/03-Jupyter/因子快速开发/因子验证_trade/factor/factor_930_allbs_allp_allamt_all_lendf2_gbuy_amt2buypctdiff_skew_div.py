...
factor_name = '930_allbs_allp_allamt_all_lendf2_gbuy_amt2buypctdiff_skew_div'#
def factor_930_allbs_allp_allamt_all_lendf2_gbuy_amt2buypctdiff_skew_div(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_all_lendf2_gbuy_amt2buypctdiff_skew_div"
    ...
    res1 = f_calc_skew(trade_df1['factor'])
    res2 = f_calc_skew(trade_df2['factor'])
