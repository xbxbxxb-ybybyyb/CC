...
factor_name = '1m_allbs_allp_allamt_all_bsdf_gbuy_amt2buypctdiff_max_div'#
def factor_1m_allbs_allp_allamt_all_bsdf_gbuy_amt2buypctdiff_max_div(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_allbs_allp_allamt_all_bsdf_gbuy_amt2buypctdiff_max_div"
    ...
    res1 = f_calc_max(trade_df1['factor'])
    res2 = f_calc_max(trade_df2['factor'])
