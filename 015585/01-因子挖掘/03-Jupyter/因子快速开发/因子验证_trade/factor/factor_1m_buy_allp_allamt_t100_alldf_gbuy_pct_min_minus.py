...
factor_name = '1m_buy_allp_allamt_t100_alldf_gbuy_pct_min_minus'#
def factor_1m_buy_allp_allamt_t100_alldf_gbuy_pct_min_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_buy_allp_allamt_t100_alldf_gbuy_pct_min_minus"
