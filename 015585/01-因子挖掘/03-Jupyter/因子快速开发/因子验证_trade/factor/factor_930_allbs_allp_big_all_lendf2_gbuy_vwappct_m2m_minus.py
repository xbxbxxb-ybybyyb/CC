...
factor_name = '930_allbs_allp_big_all_lendf2_gbuy_vwappct_m2m_minus'#
def factor_930_allbs_allp_big_all_lendf2_gbuy_vwappct_m2m_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_big_all_lendf2_gbuy_vwappct_m2m_minus"
    ...
    res1 = f_calc_m2m(trade_df1['factor'])
    res2 = f_calc_m2m(trade_df2['factor'])
    res = res1 - res2
