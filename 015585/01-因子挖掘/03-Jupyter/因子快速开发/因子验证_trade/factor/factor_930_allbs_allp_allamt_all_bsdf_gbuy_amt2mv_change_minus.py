...
factor_name = '930_allbs_allp_allamt_all_bsdf_gbuy_amt2mv_change_minus'#
def factor_930_allbs_allp_allamt_all_bsdf_gbuy_amt2mv_change_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_all_bsdf_gbuy_amt2mv_change_minus"
    ...
    res1 = f_calc_change(trade_df1['factor'])
    res2 = f_calc_change(trade_df2['factor'])
    res = res1 - res2
