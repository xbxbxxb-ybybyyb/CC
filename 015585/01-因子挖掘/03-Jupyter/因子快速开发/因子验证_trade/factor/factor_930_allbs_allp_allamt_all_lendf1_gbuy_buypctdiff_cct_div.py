...
factor_name = '930_allbs_allp_allamt_all_lendf1_gbuy_buypctdiff_cct_div'#
def factor_930_allbs_allp_allamt_all_lendf1_gbuy_buypctdiff_cct_div(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_all_lendf1_gbuy_buypctdiff_cct_div"
    ...
    res1 = f_calc_cct(trade_df1['factor'])
    res2 = f_calc_cct(trade_df2['factor'])
