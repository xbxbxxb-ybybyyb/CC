...
factor_name = '1m_allbs_allp_allamt_all_bsdf_gsell_amt2buypctdiff_m2m_div'#
def factor_1m_allbs_allp_allamt_all_bsdf_gsell_amt2buypctdiff_m2m_div(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_allbs_allp_allamt_all_bsdf_gsell_amt2buypctdiff_m2m_div"
