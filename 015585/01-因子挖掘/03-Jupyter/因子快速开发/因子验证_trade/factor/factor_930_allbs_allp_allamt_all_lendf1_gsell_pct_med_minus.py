...
factor_name = '930_allbs_allp_allamt_all_lendf1_gsell_pct_med_minus'#
def factor_930_allbs_allp_allamt_all_lendf1_gsell_pct_med_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_allamt_all_lendf1_gsell_pct_med_minus"
