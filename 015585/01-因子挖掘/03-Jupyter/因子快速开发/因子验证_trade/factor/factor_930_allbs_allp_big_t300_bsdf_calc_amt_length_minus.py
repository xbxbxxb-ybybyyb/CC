...
factor_name = '930_allbs_allp_big_t300_bsdf_calc_amt_length_minus'#
def factor_930_allbs_allp_big_t300_bsdf_calc_amt_length_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "930_allbs_allp_big_t300_bsdf_calc_amt_length_minus"
    ...
    res1 = f_calc_length(trade_df1['factor'])
    res2 = f_calc_length(trade_df2['factor'])
    res = res1 - res2
