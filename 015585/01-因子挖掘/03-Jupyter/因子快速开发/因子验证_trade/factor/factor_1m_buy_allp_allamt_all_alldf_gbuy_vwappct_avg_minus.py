...
factor_name = '1m_buy_allp_allamt_all_alldf_gbuy_vwappct_avg_minus'#
def factor_1m_buy_allp_allamt_all_alldf_gbuy_vwappct_avg_minus(trade_df, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "1m_buy_allp_allamt_all_alldf_gbuy_vwappct_avg_minus"
