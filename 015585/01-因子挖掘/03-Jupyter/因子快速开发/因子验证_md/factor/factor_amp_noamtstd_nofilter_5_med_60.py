...
factor_name = 'amp_noamtstd_nofilter_5_med_60'#
def factor_amp_noamtstd_nofilter_5_med_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "amp_noamtstd_nofilter_5_med_60"
