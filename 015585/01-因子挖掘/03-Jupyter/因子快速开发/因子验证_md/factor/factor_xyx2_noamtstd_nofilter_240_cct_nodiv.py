...
factor_name = 'xyx2_noamtstd_nofilter_240_cct_nodiv'#
def factor_xyx2_noamtstd_nofilter_240_cct_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "xyx2_noamtstd_nofilter_240_cct_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(240,1).apply(lambda x : f_calc_cct(x)).stack()
