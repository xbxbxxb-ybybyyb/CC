...
factor_name = 'pctturn_noamtstd_nofilter_10_avg_nodiv'#
def factor_pctturn_noamtstd_nofilter_10_avg_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "pctturn_noamtstd_nofilter_10_avg_nodiv"
