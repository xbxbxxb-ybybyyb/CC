...
factor_name = 'pct_noamtstd_nofilter_120_min_nodiv'#
def factor_pct_noamtstd_nofilter_120_min_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "pct_noamtstd_nofilter_120_min_nodiv"
