...
factor_name = 'syx2_noamtstd_nofilter_5_sum_nodiv'#
def factor_syx2_noamtstd_nofilter_5_sum_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx2_noamtstd_nofilter_5_sum_nodiv"
