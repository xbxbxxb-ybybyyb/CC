...
factor_name = 'highori_noamtstd_nofilter_20_max_nodiv'#
def factor_highori_noamtstd_nofilter_20_max_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "highori_noamtstd_nofilter_20_max_nodiv"
