...
factor_name = 'l2v_noamtstd_nofilter_1_std_10'#
def factor_l2v_noamtstd_nofilter_1_std_10(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "l2v_noamtstd_nofilter_1_std_10"
