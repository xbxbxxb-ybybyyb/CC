...
factor_name = 'open_noamtstd_nofilter_60_cv_nodiv'#
def factor_open_noamtstd_nofilter_60_cv_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "open_noamtstd_nofilter_60_cv_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(60,1).apply(lambda x : f_calc_cv(x)).stack()
