...
factor_name = 'low_noamtstd_nofilter_60_cct_nodiv'#
def factor_low_noamtstd_nofilter_60_cct_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "low_noamtstd_nofilter_60_cct_nodiv"
