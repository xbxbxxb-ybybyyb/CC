...
factor_name = 'abspctturn_noamtstd_nofilter_120_skew_nodiv'#
def factor_abspctturn_noamtstd_nofilter_120_skew_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "abspctturn_noamtstd_nofilter_120_skew_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(120,1).apply(lambda x : f_calc_skew(x)).stack()
