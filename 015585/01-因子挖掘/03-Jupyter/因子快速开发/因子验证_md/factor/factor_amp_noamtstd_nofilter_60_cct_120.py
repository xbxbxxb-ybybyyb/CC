...
factor_name = 'amp_noamtstd_nofilter_60_cct_120'#
def factor_amp_noamtstd_nofilter_60_cct_120(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "amp_noamtstd_nofilter_60_cct_120"
