...
factor_name = 'vwap_noamtstd_nofilter_60_sum_nodiv'#
def factor_vwap_noamtstd_nofilter_60_sum_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "vwap_noamtstd_nofilter_60_sum_nodiv"
