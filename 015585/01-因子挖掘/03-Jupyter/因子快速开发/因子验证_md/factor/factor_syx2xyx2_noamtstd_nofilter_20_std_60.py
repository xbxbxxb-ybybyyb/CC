...
factor_name = 'syx2xyx2_noamtstd_nofilter_20_std_60'#
def factor_syx2xyx2_noamtstd_nofilter_20_std_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx2xyx2_noamtstd_nofilter_20_std_60"
    ...
    df_ori[factor_name] = df_ori[factor_name] / df_ori['factor'].unstack().rolling(60,1).apply(lambda x : f_calc_std(x)).stack()
