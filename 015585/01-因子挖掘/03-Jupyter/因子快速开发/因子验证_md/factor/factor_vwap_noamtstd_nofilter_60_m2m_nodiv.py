...
factor_name = 'vwap_noamtstd_nofilter_60_m2m_nodiv'#
def factor_vwap_noamtstd_nofilter_60_m2m_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "vwap_noamtstd_nofilter_60_m2m_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(60,1).apply(lambda x : f_calc_m2m(x)).stack()
