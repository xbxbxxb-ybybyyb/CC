...
factor_name = 'syx2xyx1_noamtstd_nofilter_1_std_5'#
def factor_syx2xyx1_noamtstd_nofilter_1_std_5(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx2xyx1_noamtstd_nofilter_1_std_5"
    ...
    df_ori[factor_name] = df_ori[factor_name] / df_ori['factor'].unstack().rolling(5,1).apply(lambda x : f_calc_std(x)).stack()
