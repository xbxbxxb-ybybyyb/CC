...
factor_name = 'lengthk_amtstd_nofilter_20_med_amtdiv'#
def factor_lengthk_amtstd_nofilter_20_med_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "lengthk_amtstd_nofilter_20_med_amtdiv"
