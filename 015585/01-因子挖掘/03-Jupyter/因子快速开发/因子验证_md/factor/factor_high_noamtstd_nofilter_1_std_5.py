...
factor_name = 'high_noamtstd_nofilter_1_std_5'#
def factor_high_noamtstd_nofilter_1_std_5(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "high_noamtstd_nofilter_1_std_5"
