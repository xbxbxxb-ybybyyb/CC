...
factor_name = 'syx1_amtstd_nofilter_5_med_amtdiv'#
def factor_syx1_amtstd_nofilter_5_med_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx1_amtstd_nofilter_5_med_amtdiv"
