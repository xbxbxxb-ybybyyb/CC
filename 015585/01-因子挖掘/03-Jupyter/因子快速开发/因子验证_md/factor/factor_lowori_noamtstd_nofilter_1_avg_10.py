...
factor_name = 'lowori_noamtstd_nofilter_1_avg_10'#
def factor_lowori_noamtstd_nofilter_1_avg_10(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "lowori_noamtstd_nofilter_1_avg_10"
    ...
    df_ori[factor_name] = df_ori[factor_name] / df_ori['factor'].unstack().rolling(10,1).apply(lambda x : f_calc_avg(x)).stack()
