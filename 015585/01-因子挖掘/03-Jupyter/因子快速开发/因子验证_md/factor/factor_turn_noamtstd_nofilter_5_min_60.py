...
factor_name = 'turn_noamtstd_nofilter_5_min_60'#
def factor_turn_noamtstd_nofilter_5_min_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "turn_noamtstd_nofilter_5_min_60"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(5,1).apply(lambda x : f_calc_min(x)).stack()
