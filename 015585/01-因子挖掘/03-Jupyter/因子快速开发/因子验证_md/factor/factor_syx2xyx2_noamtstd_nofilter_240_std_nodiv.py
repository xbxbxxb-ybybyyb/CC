...
factor_name = 'syx2xyx2_noamtstd_nofilter_240_std_nodiv'#
def factor_syx2xyx2_noamtstd_nofilter_240_std_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx2xyx2_noamtstd_nofilter_240_std_nodiv"
