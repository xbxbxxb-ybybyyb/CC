...
factor_name = 'low_noamtstd_nofilter_5_med_20'#
def factor_low_noamtstd_nofilter_5_med_20(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "low_noamtstd_nofilter_5_med_20"
