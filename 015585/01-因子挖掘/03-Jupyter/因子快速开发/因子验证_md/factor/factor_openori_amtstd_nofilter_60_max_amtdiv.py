...
factor_name = 'openori_amtstd_nofilter_60_max_amtdiv'#
def factor_openori_amtstd_nofilter_60_max_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "openori_amtstd_nofilter_60_max_amtdiv"
