...
factor_name = 'pctturn_noamtstd_nofilter_120_std_nodiv'#
def factor_pctturn_noamtstd_nofilter_120_std_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "pctturn_noamtstd_nofilter_120_std_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(120,1).apply(lambda x : f_calc_std(x)).stack()
