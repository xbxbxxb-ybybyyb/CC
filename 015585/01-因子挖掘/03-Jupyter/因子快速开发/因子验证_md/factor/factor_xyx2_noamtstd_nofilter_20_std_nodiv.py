...
factor_name = 'xyx2_noamtstd_nofilter_20_std_nodiv'#
def factor_xyx2_noamtstd_nofilter_20_std_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "xyx2_noamtstd_nofilter_20_std_nodiv"
