...
factor_name = 'open_amtstd_nofilter_20_sum_amtdiv'#
def factor_open_amtstd_nofilter_20_sum_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "open_amtstd_nofilter_20_sum_amtdiv"
