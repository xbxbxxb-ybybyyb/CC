...
factor_name = 'c2v_noamtstd_nofilter_20_m2m_nodiv'#
def factor_c2v_noamtstd_nofilter_20_m2m_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "c2v_noamtstd_nofilter_20_m2m_nodiv"
