...
factor_name = 'abspct_amtstd_nofilter_60_avg_amtdiv'#
def factor_abspct_amtstd_nofilter_60_avg_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "abspct_amtstd_nofilter_60_avg_amtdiv"
    ...
    df_ori["amt"] = df_ori['amt'].unstack().rolling(60,1).apply(lambda x : f_calc_avg(x)).stack()
