...
factor_name = 'xyx1_noamtstd_nofilter_120_cct_nodiv'#
def factor_xyx1_noamtstd_nofilter_120_cct_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "xyx1_noamtstd_nofilter_120_cct_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(120,1).apply(lambda x : f_calc_cct(x)).stack()
