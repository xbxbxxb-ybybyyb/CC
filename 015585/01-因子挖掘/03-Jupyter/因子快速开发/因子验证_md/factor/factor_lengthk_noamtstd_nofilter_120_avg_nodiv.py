...
factor_name = 'lengthk_noamtstd_nofilter_120_avg_nodiv'#
def factor_lengthk_noamtstd_nofilter_120_avg_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "lengthk_noamtstd_nofilter_120_avg_nodiv"
