...
factor_name = 'closeori_noamtstd_nofilter_20_change_nodiv'#
def factor_closeori_noamtstd_nofilter_20_change_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "closeori_noamtstd_nofilter_20_change_nodiv"
