...
factor_name = 'vwap_noamtstd_nofilter_240_cv_nodiv'#
def factor_vwap_noamtstd_nofilter_240_cv_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "vwap_noamtstd_nofilter_240_cv_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(240,1).apply(lambda x : f_calc_cv(x)).stack()
