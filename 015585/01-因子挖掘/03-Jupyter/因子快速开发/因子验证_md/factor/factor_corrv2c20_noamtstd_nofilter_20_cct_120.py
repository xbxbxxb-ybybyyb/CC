...
factor_name = 'corrv2c20_noamtstd_nofilter_20_cct_120'#
def factor_corrv2c20_noamtstd_nofilter_20_cct_120(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "corrv2c20_noamtstd_nofilter_20_cct_120"
    ...
    df_ori[factor_name] = df_ori[factor_name] / df_ori['factor'].unstack().rolling(120,1).apply(lambda x : f_calc_cct(x)).stack()
