...
factor_name = 'abspct_noamtstd_nofilter_120_skew_nodiv'#
def factor_abspct_noamtstd_nofilter_120_skew_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "abspct_noamtstd_nofilter_120_skew_nodiv"
