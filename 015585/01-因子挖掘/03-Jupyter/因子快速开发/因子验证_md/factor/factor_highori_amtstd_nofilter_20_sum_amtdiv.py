...
factor_name = 'highori_amtstd_nofilter_20_sum_amtdiv'#
def factor_highori_amtstd_nofilter_20_sum_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "highori_amtstd_nofilter_20_sum_amtdiv"
    ...
    df_ori["amt"] = df_ori['amt'].unstack().rolling(20,1).apply(lambda x : f_calc_sum(x)).stack()
