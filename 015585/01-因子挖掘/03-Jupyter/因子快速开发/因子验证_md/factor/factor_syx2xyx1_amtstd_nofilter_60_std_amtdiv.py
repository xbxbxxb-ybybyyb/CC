...
factor_name = 'syx2xyx1_amtstd_nofilter_60_std_amtdiv'#
def factor_syx2xyx1_amtstd_nofilter_60_std_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx2xyx1_amtstd_nofilter_60_std_amtdiv"
