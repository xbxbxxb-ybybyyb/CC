...
factor_name = 'logabspct_amtstd_nofilter_5_med_amtdiv'#
def factor_logabspct_amtstd_nofilter_5_med_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "logabspct_amtstd_nofilter_5_med_amtdiv"
    ...
    df_ori["amt"] = df_ori['amt'].unstack().rolling(5,1).apply(lambda x : f_calc_med(x)).stack()
