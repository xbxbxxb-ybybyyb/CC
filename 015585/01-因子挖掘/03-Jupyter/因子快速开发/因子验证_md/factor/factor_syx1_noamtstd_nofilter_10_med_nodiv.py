...
factor_name = 'syx1_noamtstd_nofilter_10_med_nodiv'#
def factor_syx1_noamtstd_nofilter_10_med_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx1_noamtstd_nofilter_10_med_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(10,1).apply(lambda x : f_calc_med(x)).stack()
