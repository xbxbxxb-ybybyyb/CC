...
factor_name = 'close_noamtstd_nofilter_1_sum_60'#
def factor_close_noamtstd_nofilter_1_sum_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "close_noamtstd_nofilter_1_sum_60"
