...
factor_name = 'xyx1_noamtstd_nofilter_1_std_20'#
def factor_xyx1_noamtstd_nofilter_1_std_20(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "xyx1_noamtstd_nofilter_1_std_20"
