...
factor_name = 'logabspct_noamtstd_nofilter_20_avg_nodiv'#
def factor_logabspct_noamtstd_nofilter_20_avg_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "logabspct_noamtstd_nofilter_20_avg_nodiv"
