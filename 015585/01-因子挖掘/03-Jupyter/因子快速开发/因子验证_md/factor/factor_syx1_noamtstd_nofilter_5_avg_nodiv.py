...
factor_name = 'syx1_noamtstd_nofilter_5_avg_nodiv'#
def factor_syx1_noamtstd_nofilter_5_avg_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "syx1_noamtstd_nofilter_5_avg_nodiv"
