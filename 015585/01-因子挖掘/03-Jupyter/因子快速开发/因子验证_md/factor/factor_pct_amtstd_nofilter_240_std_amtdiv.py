...
factor_name = 'pct_amtstd_nofilter_240_std_amtdiv'#
def factor_pct_amtstd_nofilter_240_std_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "pct_amtstd_nofilter_240_std_amtdiv"
