...
factor_name = 'vwapori_amtstd_nofilter_5_max_amtdiv'#
def factor_vwapori_amtstd_nofilter_5_max_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "vwapori_amtstd_nofilter_5_max_amtdiv"
