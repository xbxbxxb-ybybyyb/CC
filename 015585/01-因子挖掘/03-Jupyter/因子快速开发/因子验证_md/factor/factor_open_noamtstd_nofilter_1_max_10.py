...
factor_name = 'open_noamtstd_nofilter_1_max_10'#
def factor_open_noamtstd_nofilter_1_max_10(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "open_noamtstd_nofilter_1_max_10"
    ...
    df_ori[factor_name] = df_ori[factor_name] / df_ori['factor'].unstack().rolling(10,1).apply(lambda x : f_calc_max(x)).stack()
