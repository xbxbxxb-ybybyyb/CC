...
factor_name = 'openori_noamtstd_nofilter_60_cct_120'#
def factor_openori_noamtstd_nofilter_60_cct_120(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "openori_noamtstd_nofilter_60_cct_120"
