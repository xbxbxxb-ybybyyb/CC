...
factor_name = 'open_noamtstd_nofilter_20_avg_60'#
def factor_open_noamtstd_nofilter_20_avg_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "open_noamtstd_nofilter_20_avg_60"
