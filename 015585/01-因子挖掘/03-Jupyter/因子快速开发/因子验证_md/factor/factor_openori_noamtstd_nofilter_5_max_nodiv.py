...
factor_name = 'openori_noamtstd_nofilter_5_max_nodiv'#
def factor_openori_noamtstd_nofilter_5_max_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "openori_noamtstd_nofilter_5_max_nodiv"
