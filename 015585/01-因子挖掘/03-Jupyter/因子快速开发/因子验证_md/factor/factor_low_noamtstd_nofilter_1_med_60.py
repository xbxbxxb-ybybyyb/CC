...
factor_name = 'low_noamtstd_nofilter_1_med_60'#
def factor_low_noamtstd_nofilter_1_med_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "low_noamtstd_nofilter_1_med_60"
