...
factor_name = 'pct_noamtstd_nofilter_5_min_60'#
def factor_pct_noamtstd_nofilter_5_min_60(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "pct_noamtstd_nofilter_5_min_60"
