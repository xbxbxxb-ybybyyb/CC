...
factor_name = 'vwapori_noamtstd_nofilter_5_max_nodiv'#
def factor_vwapori_noamtstd_nofilter_5_max_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "vwapori_noamtstd_nofilter_5_max_nodiv"
