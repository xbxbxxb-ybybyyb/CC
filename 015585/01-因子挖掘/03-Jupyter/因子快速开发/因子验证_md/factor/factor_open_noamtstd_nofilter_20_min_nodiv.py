...
factor_name = 'open_noamtstd_nofilter_20_min_nodiv'#
def factor_open_noamtstd_nofilter_20_min_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "open_noamtstd_nofilter_20_min_nodiv"
