...
factor_name = 'xyx2_amtstd_nofilter_60_avg_amtdiv'#
def factor_xyx2_amtstd_nofilter_60_avg_amtdiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "xyx2_amtstd_nofilter_60_avg_amtdiv"
