...
factor_name = 'closeori_noamtstd_nofilter_240_max_nodiv'#
def factor_closeori_noamtstd_nofilter_240_max_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "closeori_noamtstd_nofilter_240_max_nodiv"
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(240,1).apply(lambda x : f_calc_max(x)).stack()
