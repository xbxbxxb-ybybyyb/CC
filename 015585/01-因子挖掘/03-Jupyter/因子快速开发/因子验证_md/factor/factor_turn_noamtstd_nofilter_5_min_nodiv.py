...
factor_name = 'turn_noamtstd_nofilter_5_min_nodiv'#
def factor_turn_noamtstd_nofilter_5_min_nodiv(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        return {factor_name: 0}
    factor_explain = "turn_noamtstd_nofilter_5_min_nodiv"
