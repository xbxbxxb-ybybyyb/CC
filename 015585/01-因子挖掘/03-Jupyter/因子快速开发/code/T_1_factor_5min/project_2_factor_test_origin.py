...
class FactorTest:
    ...
    def load_data(self):
        ...
        df = self.df_sft.rename(columns={ret_type: 'value'})
    ...
    def factor_test(self, factor_df, result_path, factor_corr_test=False, generate_pdf=False):
        ...
        # 2019IC
        self.result_dic['2019IC']= self.basic_df[pd.Timestamp('20190101'):].groupby('dt').apply(lambda x: x['factor'].corr(x['value'], method='spearman')).mean()
        #
