...
# 剔除已经算过的因子
list_del = []
#for  i in list(os.listdir('/data/user/015585/01-因子挖掘/03-Jupyter/因子快速开发/h5/20250530_zwhmd/')):
#    list_del.append(i[:-3])
list_in = []
for i in list(os.listdir('/data/user/015585/01-因子挖掘/03-Jupyter/因子快速开发/h5/20250530_zwhmd/')):
    list_in.append(i[:-3])
                    ...
                    for amtstd in dic_amtstd:
                        ...
                        if is_generate:
                            ...
                            if factor_name in list_del:
                                continue
                            print(factor_name)
                            factor_path = '/data/user/015585/01-因子挖掘/03-Jupyter/因子快速开发/h5/20250530_zwhmd/'
                            ...
                            for col in df.columns:
                                ...
                                print('mutual:', factor_test.result_dic['corr_sta'].loc['mic_tot', 'value'])
