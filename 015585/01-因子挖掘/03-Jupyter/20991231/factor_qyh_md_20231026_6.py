...
s = FactorData()
factor_name = 'qyh_md_20231026_6'
def factor_qyh_md_20231026_6(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(60,1).median().stack()
    # -------------------------------------------------------------------------------------------------------------------
