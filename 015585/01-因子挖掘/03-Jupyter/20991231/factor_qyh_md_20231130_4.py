...
s = FactorData()
factor_name = 'qyh_md_20231130_4'
def factor_qyh_md_20231130_4(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name:0.02,'data':['MD']}
    # -------------------------------------------------------------------------------------------------------------------
    ...
    df_ori['C'] = (df_ori['low']).unstack().rolling(5,1).mean().stack()
