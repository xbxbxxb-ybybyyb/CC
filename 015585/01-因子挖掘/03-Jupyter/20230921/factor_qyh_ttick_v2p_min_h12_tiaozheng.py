...
# gg
#
factor_name = 'qyh_ttick_v2p_min_h12_tiaozheng'#
def factor_qyh_ttick_v2p_min_h12_tiaozheng(tick_df, return_fillna_dic=False):
    ...
    res1 = tick_df.head(int(len(tick_df)/2))['v2p'].min()
    res2 = tick_df.tail(int(len(tick_df)/2))['v2p'].max()
    #
