...
# #
# date_list = os.listdir('/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改/')
# date_list = [x for x in date_list if 'factor_' in x and '.py' not in x]
# res = pd.DataFrame()
# for date in date_list:
#     factor_list_date = os.listdir('/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改/' + date + '/')
...
#                                     20190101, 20191231,
#                                     basic_file_path,
#                                     '/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改/save_file/', interval_res=False)
#             res[name] = factor_df0[name]
#             print(len(res.columns))
# res.to_pickle('/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改/save_file/res_ori.pkl')

df1 = pd.read_pickle('/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改/save_file/res_ori.pkl') # 新
df2 = pd.read_pickle('/data/user/015585/01-因子挖掘/03-Jupyter/20240126因子修改_原始/save_file/res_ori.pkl') # 旧
