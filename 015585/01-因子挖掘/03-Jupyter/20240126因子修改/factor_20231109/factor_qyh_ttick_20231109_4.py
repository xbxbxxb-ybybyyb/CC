...
# 55,0.097
#
factor_name = 'qyh_ttick_20231109_4'#
def factor_qyh_ttick_20231109_4(tick_df, return_fillna_dic=False):
    ...
    tick_df1 = tick_df1[tick_df1['factor']>0]
    res1 = tick_df1.head(1)['factor'].mean() - tick_df1.tail(1)['factor'].mean()
    #
    ...
    res2 = tick_df.head(1)['factor'].mean() - tick_df.tail(1)['factor'].mean()
    #
    res = res1 + res2
