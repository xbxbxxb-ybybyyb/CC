...
from factor_qyh_tick_b_tail_delvis import factor_qyh_tick_b_tail_delvis as func
...
'''
date = '20230824'#周四日期
factor_name = 'factor_qyh_tick_b_tail_delvis'
print(factor_name)
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TTickab',## TTickab,TOrder,TTransaction
                        start_date, end_date,
                        basic_file_path,
