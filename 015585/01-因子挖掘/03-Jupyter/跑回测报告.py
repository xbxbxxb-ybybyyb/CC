...
from factor_qyh_T1mtra_cct_in import factor_qyh_T1mtra_cct_in
...
参数里的factor_type'''
date = '20230309'#周四日期
factor_name = 'factor_qyh_T1mtra_cct_in'
print(factor_name)
...
factor_df0 = run_factor(factor_qyh_T1mtra_cct_in,
                        factor_name,
                        'TTransaction',
                        start_date, end_date,
                        basic_file_path,
...
df = pd.read_hdf(result_path + factor_name + '_20160101_20181231.h5')
result_path = '/data/user/015585/01-因子挖掘/03-Jupyter/' + date + '/'
