...
from factor_qyh_TTra_amtpertra_b_l500_2mv import factor_qyh_TTra_amtpertra_b_l500_2mv
...
参数里的factor_type'''
date = '20230330'#周四日期
factor_name = 'factor_qyh_TTra_amtpertra_b_l500_2mv'
print(factor_name)
...
factor_df0 = run_factor(factor_qyh_TTra_amtpertra_b_l500_2mv,
                        factor_name,
                        'TTransaction',
                        start_date, end_date,
                        basic_file_path,
...
for col in df.columns:
    ...
    print('高corr库中因子：')
    print(factor_test.result_dic['factor_corr_summary'][['linear','in_score','in_IC_tot','Mutual_Info']])
    print('均值和中位数')
