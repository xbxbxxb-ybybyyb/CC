...
def f_pro_cleanb2ttran(tick_df):#净委买金额/该阶段总成交额,series（开盘后）
    ...
    return cleanb2ttran
def f_pro_cleanb2tran(tick_df):#净委买金额/tick成交额,series（开盘后）O
    tick_df['buy_amt'] = tick_df['TotalBidQty'] * tick_df['WeightedAvgBidPx']
    tick_df['sell_amt'] = tick_df['TotalOfferQty'] * tick_df['WeightedAvgOfferPx']
                                ...
                                for std_i in dic_std:
                                    ...
                                    for calc_i in dic_calc:
                                        ...
                                        for compare_i in dic_compare:
                                            ...
                                            factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/europa/h5/20240514tick3s/'
                                            ...
                                            result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/europa/factor_report/20240514tick3s/'
