...
'''
'''
date = '20240514-全息盘口与tick1s测试/TTick1s'#周四日期
factor_name = 'factor_qyh_ttick_20231130_1'
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TTick1s',## TTickab,TOrder,TTransaction,T-1_factor,MarketIndTTick,TTick1s,TTickfull
                        start_date, end_date,
                        basic_file_path,
