...
from factor_qyh_md_20231026_8 import factor_qyh_md_20231026_8 as func
from test_factor_demo_forzbw import strongFactorTest
import pandas as pd
import numpy as np
'''
每次修改:
...
'''
date = '20231026'#周四日期
factor_name = 'factor_qyh_md_20231026_8'
print(factor_name)
