...
def factor_qyh_ttick_20231026_2(tick_df, return_fillna_dic=False):
    ...
    # res2 = abs(tick_df2['factor'] - tick_df2['factor'].mean()).mean() / tick_df2['factor'].mean() if abs(tick_df2['factor'].mean()) > 0 else np.nan
    #
    ...
    # res1 = abs(tick_df1['factor'] - tick_df1['factor'].mean()).mean()  / tick_df1['factor'].mean() if abs(tick_df1['factor'].mean())>0 else np.nan
