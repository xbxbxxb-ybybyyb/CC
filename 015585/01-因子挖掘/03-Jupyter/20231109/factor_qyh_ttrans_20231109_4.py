...
import pandas as pd
#
# 最后100笔/500笔聚合后偏离程度差异
#
factor_name = 'qyh_ttrans_20231109_4'#
def factor_qyh_ttrans_20231109_4(trans_df, return_fillna_dic=False):
    ...
    #
    res1 = trans_df1['TradeMoney'].kurt()
    res2 = trans_df2['TradeMoney'].kurt()
