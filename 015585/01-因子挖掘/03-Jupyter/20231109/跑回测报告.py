...
from factor_qyh_torder_20231109_1 import factor_qyh_torder_20231109_1 as func
...
'''
date = '20231109'#周四日期
factor_name = 'factor_qyh_torder_20231109_1'
print(factor_name)
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TOrder',## TTickab,TOrder,TTransaction,T-1_factor
                        start_date, end_date,
                        basic_file_path,
