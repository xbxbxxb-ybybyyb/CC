...
# 35,-0.07
# skk_cl_diff_mean3:29
import pandas as pd
import numpy as np
import os
from xquant.factordata import FactorData
s = FactorData()
def factor_qyh_md_plus_price_3_mean(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='qyh_md_plus_price_3_mean'
    ...
    f_data[factor_name] = (f_data['plus']*1 +
                           f_data['plus'].unstack().shift(1).stack()*3 +
                           f_data['plus'].unstack().shift(2).stack()*2)/6
