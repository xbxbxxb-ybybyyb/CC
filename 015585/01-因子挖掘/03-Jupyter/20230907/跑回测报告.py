...
from factor_qyh_ttick_b12b_amt_max2_update import factor_qyh_ttick_b12b_amt_max2_update as func
...
'''
date = '20230907'#周四日期
factor_name = 'factor_qyh_ttick_b12b_amt_max2_update'
print(factor_name)
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TTickab',## TTickab,TOrder,TTransaction,T-1_factor
                        start_date, end_date,
                        basic_file_path,
