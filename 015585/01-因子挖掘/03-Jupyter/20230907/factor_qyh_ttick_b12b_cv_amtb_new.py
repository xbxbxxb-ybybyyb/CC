...
# 全样本：
#
factor_name = 'qyh_ttick_b12b_cv_amtb_new'#
def factor_qyh_ttick_b12b_cv_amtb_new(tick_df, return_fillna_dic=False):
    ...
    if tick_df.empty:
        ...
        pct = ((tick_df['Buy5Price'] - tick_df['WeightedAvgBidPx']) / pre_close)
