...
import pandas as pd
#
# 逻辑：活跃tick中，买1-买均在触发前的值
# 快速:17，-0.058
# 全样本：24，-0.069
# xbc_buy_sell_diff_near_far_mean
factor_name = 'qyh_ttick_b12b_tail_amtb'#
def factor_qyh_ttick_b12b_tail_amtb(tick_df, return_fillna_dic=False):
