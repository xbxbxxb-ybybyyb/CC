...
from factor_qyh_emo_pct_in_all import factor_qyh_emo_pct_in_all as func
...
参数里的func
参数里的factor_type'''
date = '20230519-emotion'#周四日期
factor_name = 'factor_qyh_emo_pct_in_all'
print(factor_name)
...
factor_df0 = run_factor(func,
                        factor_name,
                        'LastTouchTTick',## TTickab,TOrder,LastTouchTTick
                        start_date, end_date,
                        basic_file_path,
...
for col in df.columns:
    ...
    print('IC：')
    print(factor_test.result_dic['corr_sta'].loc['corr_tot','value'])
    print('高corr库中因子：')
