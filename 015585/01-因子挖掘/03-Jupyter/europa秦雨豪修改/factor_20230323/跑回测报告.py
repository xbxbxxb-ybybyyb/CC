...
from factor_qyh_TTra_ratio_small_b2s_std_60s import factor_qyh_TTra_ratio_small_b2s_std_60s as func
...
'''
date = '20230907'#周四日期
factor_name = 'factor_qyh_TTra_ratio_small_b2s_std_60s'
print(factor_name)
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TTransaction',## TTickab,TOrder,TTransaction,T-1_factor
                        start_date, end_date,
                        basic_file_path,
