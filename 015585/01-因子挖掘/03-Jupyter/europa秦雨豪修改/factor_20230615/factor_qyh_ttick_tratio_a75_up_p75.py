...
import numpy as np
import pandas as pd
factor_name = 'qyh_ttick_tratio_a75_up_p75'#
def factor_qyh_ttick_tratio_a75_up_p75(tick_df, return_fillna_dic=False):
    ...
    length = len(tick_df)
    #
    limit = round_(tick_df['ValueTrade'].quantile(0.75),5)
