...
s = FactorData()
factor_name = 'qyh_md_syx_20_mean'
# zcz,dtj
# 上影线/20日均值
# 49,0.067
# down_std_minute5_v3_20d:23
def factor_qyh_md_syx_20_mean(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(20,5).mean().stack()
    # -------------------------------------------------------------------------------------------------------------------
