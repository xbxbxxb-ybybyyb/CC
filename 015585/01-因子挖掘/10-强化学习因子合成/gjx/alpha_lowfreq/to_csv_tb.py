...
# 加载 TensorBoard 日志文件
ea = event_accumulator.EventAccumulator("/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/path/for/checkpoints/new_100_2_20240821132911")
ea.Reload()
