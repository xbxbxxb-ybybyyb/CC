...
# POOL_PATH = '/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/path/for/checkpoints/new_100_2_20240820201001/40960_steps_pool.json'
POOL_PATH = '/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/path/for/checkpoints/new_100_2_20240821132911/364544_steps_pool.json'
...
data1 = StockData(start_time='2019-01-01',
                       end_time='2019-12-30',
