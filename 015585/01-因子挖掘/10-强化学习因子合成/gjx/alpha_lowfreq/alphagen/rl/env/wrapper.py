...
SIZE_ALL = SIZE_NULL + SIZE_OP + SIZE_FEATURE + SIZE_DELTA_TIME + SIZE_CONSTANT + SIZE_SEP + SIZE_DIV_RULE + SIZE_BINARY_DIV_RULE
...
OFFSET_DIV_RULE = OFFSET_CONSTANT + SIZE_CONSTANT
