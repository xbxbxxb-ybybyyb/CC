...
def main(
    ...
    data_train = StockData(start_time='2018-03-05',
                           end_time='2019-03-01',
                           file_path='/data/user/015585/share_file/for_sxs/low_frequency_all.pkl',
                           target_path = '/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/label.pkl')
    data_valid = StockData(start_time='2019-03-01',
                           end_time='2019-06-30',
                           file_path='/data/user/015585/share_file/for_sxs/low_frequency_all.pkl',
                           target_path = '/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/label.pkl')
    data_test = StockData(start_time='2019-03-01',
                          end_time='2019-12-30',
                          file_path='/data/user/015585/share_file/for_sxs/low_frequency_all.pkl',
                          target_path = '/data/user/000021/gjx/alphagen-change-reward存档8.7反正还没改feature，这个能跑但结果不太理想/label.pkl')
