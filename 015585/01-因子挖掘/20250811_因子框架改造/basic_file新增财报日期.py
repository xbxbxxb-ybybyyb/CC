...
df = pd.read_pickle(sft_basic_path).loc[pd.Timestamp(str(start_date)):pd.Timestamp(str(end_date))]
# 财报日期
'''
...
df.to_pickle('/data/user/015585/01-因子挖掘/20250811_因子框架改造/sft_test.pkl')
