...
# score:18,0.12
# sss_lztk_wmean_buy_min_close
# Lzt_pj2r_sell_buy_number_corr
factor_name = 'qyh_lzttick_b12amt_after2zt_mean'#
def factor_qyh_lzttick_b12amt_after2zt_mean(tick_df, return_fillna_dic=False):
