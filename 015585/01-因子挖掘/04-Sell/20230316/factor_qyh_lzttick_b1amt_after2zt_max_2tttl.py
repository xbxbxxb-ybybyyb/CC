...
import pandas as pd
#
# 逻辑：末次封板后，每个tick买1的最大值 / total trade
# score: 28,0.139
# Lzt_pj2r_sell_buy_number_corr:32
# sss_lzo_bigofiap_max
# sss_lztk_wmean_buy_min_close:0.147
# yzhan_hf_t14_4:0.098
factor_name = 'qyh_lzttick_b1amt_after2zt_max_2tttl'#
def factor_qyh_lzttick_b1amt_after2zt_max_2tttl(tick_df, return_fillna_dic=False):
