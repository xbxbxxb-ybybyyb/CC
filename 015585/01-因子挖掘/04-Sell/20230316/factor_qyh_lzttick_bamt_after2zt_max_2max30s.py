...
import pandas as pd
#
# 逻辑：末次封板后，每个tick挂买总额的最大值 / max30s
# score:0.11,14
# 无
factor_name = 'qyh_lzttick_bamt_after2zt_max_2max30s'#
def factor_qyh_lzttick_bamt_after2zt_max_2max30s(tick_df, return_fillna_dic=False):
