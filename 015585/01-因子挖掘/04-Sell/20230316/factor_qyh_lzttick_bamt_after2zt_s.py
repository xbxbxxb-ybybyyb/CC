...
import pandas as pd
# dtj
# 逻辑：末次封板后，每个tick挂买总额的标准差
# score:9,0.06
# 无
factor_name = 'qyh_lzttick_bamt_after2zt_s'#
def factor_qyh_lzttick_bamt_after2zt_s(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 11458868}
