...
# 待提交
# 逻辑：末次涨停后的成交额
# score:0.06,10:成交越多越容易低走
# 无
factor_name = 'qyh_lzttick_amt_after2zt'#
def factor_qyh_lzttick_amt_after2zt(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 27541725}
