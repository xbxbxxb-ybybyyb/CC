...
import numpy as np
import pandas as pd
# 逻辑：末次涨停后，买1占总挂买比例的均值
# score:21,0.12
# sss_lztk_wmean_buy_min_close:0.147
# Lzt_pj2r_sell_buy_number_corr
# sss_lzo_bigofiap_max
factor_name = 'qyh_lzttick_b12amt_after2zt_max'#
def factor_qyh_lzttick_b12amt_after2zt_max(tick_df, return_fillna_dic=False):
    ...
    tick_df['ratio'] = tick_df[col_list_v[0]] / tick_df['TotalBidQty']
    ratio = tick_df['ratio'].max()
