...
# 逻辑：末次涨停前后的挂买金额之比
# score:0.097,16.8
# yzhan_hf_s4_15_v2:-0.09,12
# sss_lzo_bigofiap_max:0.098,16(可调整)
factor_name = 'qyh_lzttick_bamt_ab2zt_30s'#
def factor_qyh_lzttick_bamt_ab2zt_30s(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 3.14}
