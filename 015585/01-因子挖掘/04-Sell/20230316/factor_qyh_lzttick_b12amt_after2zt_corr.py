...
import pandas as pd
# 待提交
# 逻辑：末次涨停后，买1和总挂买的corr
# score:8.6,0.067
# 无
factor_name = 'qyh_lzttick_b12amt_after2zt_corr'#
def factor_qyh_lzttick_b12amt_after2zt_corr(tick_df, return_fillna_dic=False):
    ...
    df_corr = pd.concat([tick_df[col_list_v[0]] , tick_df['TotalBidQty']], axis = 1).corr(method = 'spearman').iloc[0,1]
