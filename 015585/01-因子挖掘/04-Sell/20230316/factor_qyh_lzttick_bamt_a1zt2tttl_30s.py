...
factor_name = 'qyh_lzttick_bamt_a1zt2tttl_30s'#
def factor_qyh_lzttick_bamt_a1zt2tttl_30s(tick_df, return_fillna_dic=False):
    ...
    if len(tick_df_2) >= 10:
        amt_2 = (tick_df_2['TotalBidQty'] * tick_df_2['WeightedAvgBidPx']).head(10).sum()
    else:
