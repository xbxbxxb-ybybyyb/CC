...
import pandas as pd
#
# 逻辑：末次封板后，每个tick挂买总额的最小值
# score:5,0.034
# 无
factor_name = 'qyh_lzttick_bamt_after2zt_min'#
def factor_qyh_lzttick_bamt_after2zt_min(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 3717289}
