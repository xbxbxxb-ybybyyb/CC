...
import pandas as pd
# 待提交
# 逻辑：末次涨停后的成交额 / 当日30S成交额最大值
# score:18,0.11
# 无
factor_name = 'qyh_lzttick_amt_after2zt_2max30s'#
def factor_qyh_lzttick_amt_after2zt_2max30s(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 1.31}
