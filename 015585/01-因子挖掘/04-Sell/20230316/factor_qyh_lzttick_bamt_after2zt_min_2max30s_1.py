...
import pandas as pd
# 待提交
# 逻辑：末次封板后，每个tick挂买总额的最小值 / max30s
# score:6,0.04
# 无
factor_name = 'qyh_lzttick_bamt_after2zt_min_2max30s_1'#
def factor_qyh_lzttick_bamt_after2zt_min_2max30s_1(tick_df, return_fillna_dic=False):
