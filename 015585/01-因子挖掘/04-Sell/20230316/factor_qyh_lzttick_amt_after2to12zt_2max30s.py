...
import pandas as pd
#
# 逻辑：(首次到末次涨停的成交额 - 末次涨停以后的成交额) / 30s成交额的最大值
# score:17，-0.1
# Lzt_tot_open_zt_time
# lzt_label_pattern
factor_name = 'qyh_lzttick_amt_after2to12zt_2max30s'#
def factor_qyh_lzttick_amt_after2to12zt_2max30s(tick_df, return_fillna_dic=False):
