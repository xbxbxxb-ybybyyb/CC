...
from factor_qyh_lzt_corr_bsno_delnum import factor_qyh_lzt_corr_bsno_delnum
...
factor_name = 'factor_qyh_lzt_corr_bsno_delnum'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_lzt_corr_bsno_delnum,
          factor_name = factor_name,
          factor_type = 'LastZtLastTrans',
          start_date = 20160101,
          end_date = 20191231,
