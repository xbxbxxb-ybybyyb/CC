...
from factor_qyh_lzo_amt_mmax_2ttl import factor_qyh_lzo_amt_mmax_2ttl
...
factor_name = 'factor_qyh_lzo_amt_mmax_2ttl'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_lzo_amt_mmax_2ttl,
