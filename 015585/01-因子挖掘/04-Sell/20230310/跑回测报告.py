...
from factor_qyh_T1mtra_ratio_buy_big import factor_qyh_T1mtra_ratio_buy_big
...
date = '20230310'# 周四日期
factor_name = 'factor_qyh_T1mtra_ratio_buy_big'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_T1mtra_ratio_buy_big,
