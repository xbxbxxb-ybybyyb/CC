...
from factor_qyh_lzo_corr_pv_t2_500 import factor_qyh_lzo_corr_pv_t2_500
...
factor_name = 'factor_qyh_lzo_corr_pv_t2_500'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_lzo_corr_pv_t2_500,
