...
class FactorTest:
    def __init__(self, start_date, end_date, segment_number=20,
                 ...
                 cal_mi = True,
                 # time_interval=[93000000, 145000000],
                 # last_is_zt=None, test_sample='bt',
        ...
        if self.strategy_name == 'sell':
            ...
            self.return_type = 'label_v2o10d1' # 待少森确认
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'sell':
            ...
            sft_basic_path = ''# 待少森提供最新的saturn因子文件地址
        else:
            print('strategy_name error, must in [sell,saturn]')
            raise  TypeError
