...
import pandas as pd
#
# 逻辑：0931，(买1-卖1)/close_pre
# score:15.7,7.7,0.085
# sss_t1m_each_mean_down:49,33
# -0.02
factor_name = 'qyh_T1mtick_1m_p_b12s1'#
def factor_qyh_T1mtick_1m_p_b12s1(tick_df, return_fillna_dic=False):
    ...
    df_b12s1 = (tick_df[col_list_p[10]] - tick_df[col_list_p[0]]) / pre
    delta = df_b12s1.mean()
