...
import pandas as pd
#
# 逻辑：0931，每个tick买1和挂卖的corr
# score:GG
# GG
factor_name = 'qyh_T1mtick_1m_corr_b1s'#
def factor_qyh_T1mtick_1m_corr_b1s(tick_df, return_fillna_dic=False):
    ...
    df_bs = pd.concat([tick_df['buyamt0'],bstotal - buytotal],axis = 1)
    corr = df_bs.corr(method = 'spearman').iloc[0,1]
