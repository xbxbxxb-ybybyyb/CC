...
import pandas as pd
#
# 逻辑：0931，每个tick挂卖和成交额的corr
# score:-0.02,6,2.5GG
# 0.01
factor_name = 'qyh_T1mtick_1m_corr_st'#
def factor_qyh_T1mtick_1m_corr_st(tick_df, return_fillna_dic=False):
    ...
    df_bt = pd.concat([bstotal - buytotal,tick_df['amt']],axis = 1)
