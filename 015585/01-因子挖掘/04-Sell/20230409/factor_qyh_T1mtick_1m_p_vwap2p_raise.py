...
import pandas as pd
#
# 逻辑：0931，价格上升时，vwap / price
# score:9,5.5,0.07
# wd_k1_rise_vwap_d_p:10,7,0.07
# -0.02
factor_name = 'qyh_T1mtick_1m_p_vwap2p_raise'#
def factor_qyh_T1mtick_1m_p_vwap2p_raise(tick_df, return_fillna_dic=False):
