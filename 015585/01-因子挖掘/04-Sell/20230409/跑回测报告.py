...
from factor_qyh_T1mtick_1m_amt_t2smin import factor_qyh_T1mtick_1m_amt_t2smin
...
date = '20230409'# 周四日期
factor_name = 'factor_qyh_T1mtick_1m_amt_t2smin'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_T1mtick_1m_amt_t2smin,
