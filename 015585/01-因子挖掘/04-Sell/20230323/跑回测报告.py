...
from factor_qyh_lzo_aztmax_ratio_b2s import factor_qyh_lzo_aztmax_ratio_b2s
...
date = '20230323'# 周四日期
factor_name = 'factor_qyh_lzo_aztmax_ratio_b2s'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_lzo_aztmax_ratio_b2s,
