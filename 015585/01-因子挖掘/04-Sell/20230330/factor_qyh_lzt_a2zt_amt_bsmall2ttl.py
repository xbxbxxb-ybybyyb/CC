...
import pandas as pd
# NO,和mid corr高
# 逻辑：t-1日末次涨停后，成交额中小买单金额 / 当日总成交额
# score:0.04,4
# wu
factor_name = 'qyh_lzt_a2zt_amt_bsmall2ttl'#
def factor_qyh_lzt_a2zt_amt_bsmall2ttl(trans_df, return_fillna_dic=False):
    ...
    if amt_ttl > 0:
        ratio = trans_df_amt_a2zt[trans_df_amt_a2zt < 50000].sum() / amt_ttl
    else:
        ratio = np.nan
