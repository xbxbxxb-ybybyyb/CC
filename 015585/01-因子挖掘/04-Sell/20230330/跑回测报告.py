...
from factor_qyh_lzt_corr_bsno_stat import factor_qyh_lzt_corr_bsno_stat
...
date = '20230330'# 周四日期
factor_name = 'factor_qyh_lzt_corr_bsno_stat'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/04-Sell/' + date + '/'
run_factor(func = factor_qyh_lzt_corr_bsno_stat,
