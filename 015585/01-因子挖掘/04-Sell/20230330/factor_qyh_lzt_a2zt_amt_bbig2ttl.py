...
import pandas as pd
# dtj
# 逻辑：t-1日末次涨停后，成交额中大买单金额 / 当日总成交额
# score:0.149,26
# Lzt_pj2r_sell_buy_number_corr:-0.146,32
# yzhan_hf_s4_15_v2:-0.09
# sss_lztk_ztbuypstat_cv_zt:-0.118
# sss_lztk_wmean_buy_min_close:0.147,30
# sss_lzo_bigofiap_max:0.098
factor_name = 'qyh_lzt_a2zt_amt_bbig2ttl'#
def factor_qyh_lzt_a2zt_amt_bbig2ttl(trans_df, return_fillna_dic=False):
