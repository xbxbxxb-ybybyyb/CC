...
import pandas as pd
# 待提交
# 逻辑：t-1日末次涨停后，成交额中大买单&大卖单金额 / 当日总成交额
# score:0.146,33
# Lzt_pj2r_sell_buy_number_corr:-0.146,32
factor_name = 'qyh_lzt_a2zt_amt_bbigsbig2ttl'#
def factor_qyh_lzt_a2zt_amt_bbigsbig2ttl(trans_df, return_fillna_dic=False):
    ...
    sbig = trans_df_amt_a2zt[trans_df_amt_a2zt>200000]
    #
