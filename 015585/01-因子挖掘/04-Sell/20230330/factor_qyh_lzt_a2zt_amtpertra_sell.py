...
import pandas as pd
#
# 逻辑：t-1日末次涨停后，主动卖单每单成交额
# score:0.01,6
# wu

factor_name = 'qyh_lzt_a2zt_amtpertra_sell'#
def factor_qyh_lzt_a2zt_amtpertra_sell(trans_df, return_fillna_dic=False):
    ...
    #
    trans_df_amt_a2zt = trans_df[trans_df['TradeBSFlag'] == 2].groupby('TradeSellNo')['TradeMoney'].sum()
