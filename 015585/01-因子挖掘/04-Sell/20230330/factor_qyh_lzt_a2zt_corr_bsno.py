...
import pandas as pd
#
# 逻辑：t-1日末次涨停后，买卖单号的corr
# score:0,0
#
factor_name = 'qyh_lzt_a2zt_corr_bsno'#
def factor_qyh_lzt_a2zt_corr_bsno(trans_df, return_fillna_dic=False):
    ...
    #
    corr = trans_df[['TradeBuyNo','TradeSellNo']].corr(method = 'spearman').iloc[0,1]
