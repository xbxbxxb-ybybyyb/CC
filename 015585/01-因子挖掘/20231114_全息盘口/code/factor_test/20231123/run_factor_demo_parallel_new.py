...
def run_factor(func, factor_name, factor_type, start_date, end_date, basic_file_path, result_path, append_next_tradingday=False, interval_res=True,
               ...
               data_path_dic= {'TTransaction': '/data/group/800463/data/project1_prod/transaction_europa/',
                               ...
                               'TFullTick':'/dfs/user/015585/20231115_tickfull_test/europa_data/'}):
    # 因子代码执行函数
    ...
    if factor_type in ['TTransaction', 'TTickab','TOrder',
                       ...
                       'LastTouchTTick','MarketTTick','Market1TTick','MarketIndTTick','T-1_factor','other','TFullTick']:
        # 个股因子
        basic_df = IO.read_data([start_date, end_date], alt=basic_file_path)
        if factor_type in ['TTransaction', 'TTickab', 'TOrder','TFullTick']:
