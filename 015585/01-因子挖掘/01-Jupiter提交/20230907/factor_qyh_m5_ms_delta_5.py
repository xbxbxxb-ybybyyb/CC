...
s = FactorData()
factor_name = 'qyh_m5_ms_delta_5'
def factor_qyh_m5_ms_delta_5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    res['ms'] = np.log(res['ms'].unstack().rolling(5,2).mean().stack())
