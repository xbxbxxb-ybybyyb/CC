...
s = FactorData()
factor_name = 'qyh_md_c2pre_med_1_60'
# dtj,zcz
# 昨日涨跌幅/60日涨跌幅的中位数
# -0.066,43
# wj_last_C2preC_pct：38，xbc_20230921_2：21，zwh_20230907_002：40
def factor_qyh_md_c2pre_med_1_60(start_date, end_date, IO, return_fillna_dic=False):
