...
# 0.088,37
#
factor_name = 'qyh_ttick_20231109_6'#
def factor_qyh_ttick_20231109_6(tick_df, return_fillna_dic=False):
    ...
    #
    res1 = tick_df1['MDTime_delta'].skew()
    res2 = tick_df2['MDTime_delta'].skew()
