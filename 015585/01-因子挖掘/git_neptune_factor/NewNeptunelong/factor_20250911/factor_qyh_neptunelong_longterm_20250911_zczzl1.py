...
class factor_qyh_neptunelong_longterm_20250911_zczzl1(BaseFactor):
    strategy_name = "neptunelong"
    factor_name = "qyh_neptunelong_longterm_20250911_zczzl1"
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res2 = (df_income[f'{col}_diff']).groupby(['dt','Ticker'])\
                .apply(lambda x : x.tail(1).mean()).to_frame(name='单季度营业总收入')
