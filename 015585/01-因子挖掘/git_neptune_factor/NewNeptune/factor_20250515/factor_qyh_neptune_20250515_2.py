...
class factor_qyh_neptune_20250515_2(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250515_2'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "lnpct max 20，快速拉伸幅度统计量" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = res.unstack().rolling(20,1).apply(f_calc_cct).stack().to_frame()
            # res = res.to_frame()
