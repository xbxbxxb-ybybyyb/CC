...
class factor_qyh_neptune_shortterm_20250710_2(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_shortterm_20250710_2"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "成交量 统计量" # 因子逻辑解释
    zcz_adjusted = "是" # 是否针对注册制调整：是/否
    logic_type = "长周期-总量强度" # 逻辑类别
    low_cost = "是" # 是否低耗时
    #
    xdb_data = [
        {
