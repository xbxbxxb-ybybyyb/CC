...
name = '1_3_2'
df_1=pd.read_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger{}.pkl'.format(name)).loc[pd.to_datetime(str(start_date)):pd.to_datetime(str(end_date))]
name = '5_3_1_2'
df_2=pd.read_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger{}.pkl'.format(name)).loc[pd.to_datetime(str(start_date)):pd.to_datetime(str(end_date))]
#
...
df_rehigh = df_1.copy()
name = '_1_3_2 and 5_3_1_2'
# df_rehigh.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger{}.pkl'.format(name))
#
