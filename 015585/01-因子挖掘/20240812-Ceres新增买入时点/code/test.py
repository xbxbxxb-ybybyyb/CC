...
for name in ['_portfolio1_trade']:
    ...
    df_s1=df_s1.loc[(df_rehigh[(df_rehigh['trigger_time'] > 93100000) | (df_rehigh['trigger_time'].apply(lambda x : np.isnan(x)) == True)]).index]
    df_rehigh = df_rehigh[df_rehigh['trigger_time'] > 93100000]
    # 涨停情况
    ...
    sta_df=sta_df.T
    sta_df.to_excel('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file_CTA/qyh{}_up931_20250313_2.xlsx'.format(name))
