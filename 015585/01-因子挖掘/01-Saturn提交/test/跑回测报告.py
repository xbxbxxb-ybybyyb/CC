...
from factor_qyh_T1mtra_power_inout_small import factor_qyh_T1mtra_power_inout_small
...
date = '20230209'#周五日期
factor_name = 'factor_qyh_T1mtra_power_inout_small'
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
print(factor_name)
run_factor(func = factor_qyh_T1mtra_power_inout_small,
