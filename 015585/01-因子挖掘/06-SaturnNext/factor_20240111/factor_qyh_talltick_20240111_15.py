...
#
#
def factor_qyh_talltick_20240111_test(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20240111_test'
    ...
    #
    res = tick_df.head(20)['ValueTrade'].min() - tick_df.tail(20)['ValueTrade'].min()
