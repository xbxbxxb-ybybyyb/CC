...
# -0.07,25
# zcz
def factor_qyh_talltick_pv_mean_ud_abs(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_pv_mean_ud_abs'
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 61022}
    ...
    if zcz:
        pv1 = pv1/2
        pv2 = pv2/2
    factor_dict = {factor_name: abs(pv1-pv2)}
    # ---------------------------------------------------------------------------------------------------------------
