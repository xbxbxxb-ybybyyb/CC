...
# 价格较高时，tick成交量的变异系数
# -0.04,12
# qyh_talltick_amt_cct
def factor_qyh_talltick_amt_cv_p75(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_amt_cv_p75'
    ...
    tick_df = tick_df[tick_df['LastPx'] >= tick_df['LastPx'].quantile(0.75)]
