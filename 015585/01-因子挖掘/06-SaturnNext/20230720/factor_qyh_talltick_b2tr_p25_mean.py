...
import numpy as np
# dtj
# 价格较低时，委买总额和该tick成交额的比值
# 10,-0.01
def factor_qyh_talltick_b2tr_p25_mean(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_b2tr_p25_mean'
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 1136}
