                    ...
                    for amtstd in dic_amtstd:
                        ...
                        if is_generate:
                            for A, B, C, rollingA, rollingB, rollingC in product(dic_getA, dic_getB, dic_getC,
                                ...
                                factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturnnext/h5' + '/20231218T_1factor/' # 因子保存路径
                                ...
                                result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturnnext/factor_report' + '/20231218T_1factor/' # 因子保存路径
