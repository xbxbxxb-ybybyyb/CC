import os
from function_next1mtickab import *
...
for factor_done in list(dic_done_factor['20230816Next1mTickab']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20231201Next1mTickab']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20231213Next1mTickab']['name']):
    list_del.append(factor_done)
#
list_series = ['rcleanb',
                'cleanb2ttran',
...
for time_kind_i,time_type_i,\
    ...
    calc_i,compare_i in product(dic_time_kind,time_type,
        ...
        result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturnnext/factor_report' \
                      + '/20240226Next1mTickab/' # report保存路径
