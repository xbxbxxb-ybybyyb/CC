...
import numpy as np
# dtj
# 价格较低时，成交量高-低的委买/成交的均值，调整
# 14,-0.03
def factor_qyh_talltick_b2tran_p25_a2_1(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_b2tran_p25_a2_1'
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 3936}
