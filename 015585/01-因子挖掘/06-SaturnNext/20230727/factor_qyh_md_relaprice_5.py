...
# -0.072，26
# wj_last5_pctmed，33
def factor_qyh_md_relaprice_5(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='qyh_md_relaprice_5'
    ...
    md_data['low5'] = md_data['low'].unstack().rolling(5,1).min().stack()
