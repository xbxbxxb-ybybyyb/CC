...
#
#
# 下跌tick中，挂买价格的集中度（相对高价的占比）
#
def factor_qyh_talltick_bp_cct_dn(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_bp_cct_dn'
    ...
    cct1 = tick_df1['WeightedAvgBidPx']/pre - 1
    cct1 = (cct1 ** 2).sum() / (cct1.sum()**2)
    factor_dict = {factor_name: cct1}
    # ---------------------------------------------------------------------------------------------------------------
