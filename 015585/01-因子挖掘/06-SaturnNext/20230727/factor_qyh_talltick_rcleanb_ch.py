...
# 相对净委买的变化
# 0.054,16
def factor_qyh_talltick_rcleanb_ch(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_rcleanb_ch'
    ...
    #
    ch = tick_df['rcleanb'].head(1).mean() - tick_df['rcleanb'].tail(1).mean()
