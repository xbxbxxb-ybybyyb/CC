...
import numpy as np
# dtj
# 成交活跃与不活跃时，较早时间里相对净委买的差
# 12,0.03
def factor_qyh_talltick_rcleanb_mean_h20_a2(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_rcleanb_mean_h20_a2'
    ...
    tick_df1 = tick_df1.head(20) if len(tick_df1) > 20 else tick_df1
    tick_df2 = tick_df[tick_df['ValueTrade'] <= tick_df['ValueTrade'].quantile(0.25)]
    tick_df2 = tick_df2.head(20) if len(tick_df2) > 20 else tick_df2
    #
    rcleanb1 = tick_df1['rcleanb'].mean()
    rcleanb2 = tick_df2['rcleanb'].mean()
    res = rcleanb1 - rcleanb2
