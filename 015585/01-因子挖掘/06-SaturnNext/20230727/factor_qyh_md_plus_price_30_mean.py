...
# 逻辑：T-20日的PLUS价格：(2Ct - Ht - Lt)/Ct-1的均值
# 30,-0.075
# sss_c2vwap_20
import pandas as pd
import numpy as np
...
s = FactorData()
def factor_qyh_md_plus_price_30_mean(start_date, end_date, IO, return_fillna_dic=False):
    factor_name='qyh_md_plus_price_30_mean'
    ...
    f_data = f_data.unstack().rolling(30,1).mean().stack()
    # -------------------------------------------------------------------------------------------------------------------
    return f_data
