...
import numpy as np
# dtj
# 买均离散程度在活跃/不活跃时标准差的差异
# 26,-0.062
#
def factor_qyh_talltick_20231214_11(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20231214_11'
    ...
    if zcz:
        tick_df['factor'] = ((tick_df['factor']-1)/2+1) * tick_df['pre_close']
