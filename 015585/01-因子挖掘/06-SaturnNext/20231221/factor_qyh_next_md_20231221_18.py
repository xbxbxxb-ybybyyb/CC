...
# 23，0.059
#
factor_name = 'qyh_next_md_20231221_18'
def factor_qyh_next_md_20231221_18(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(10,1).apply(lambda x : f_calc_cct(x)).stack()
    #
