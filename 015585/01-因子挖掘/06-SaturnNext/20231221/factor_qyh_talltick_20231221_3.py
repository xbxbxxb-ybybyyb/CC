...
# 早盘买1和买均的变异系数
#
def factor_qyh_talltick_20231221_3(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20231221_3'
    ...
    #
    res = tick_df['factor'].mean() / (abs(tick_df['factor'] - tick_df['factor'].mean()).mean() + 1e-4)
