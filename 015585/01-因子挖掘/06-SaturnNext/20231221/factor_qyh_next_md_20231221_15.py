...
# dtj
# 21，-0.064，-0.062
# logpct在过去20日的位置，相对于市场均值的超额
factor_name = 'qyh_next_md_20231221_15'
def factor_qyh_next_md_20231221_15(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori = IO.read_data([start_date, end_date],
                          columns=['amt','vwap','pct_chg','high','low','close','pre_close'],
                          alt='/data/group/800080/warehouse/prod/MD/CHINA_STOCK/DAILY/WIND/MD_CHINA_STOCK_DAILY_WIND.h5')
    #
    df_ori['factor'] = np.log(abs(df_ori['pct_chg'])+1e-3)
