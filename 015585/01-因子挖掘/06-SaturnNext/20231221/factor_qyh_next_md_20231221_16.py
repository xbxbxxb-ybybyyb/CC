...
s = FactorData()
# dtj
# abs（pct*turn)的10日变化值
# 22,-0.06,-0.06
# qyh_next_md_20231214_7(67%)
factor_name = 'qyh_next_md_20231221_16'
def factor_qyh_next_md_20231221_16(start_date, end_date, IO, return_fillna_dic=False):
    ...
    # df_ori[factor_name] = df_ori['factor'].unstack().rolling(20,1).apply(lambda x : f_calc_change(x)).stack()
    df_ori[factor_name] = df_ori['factor'] - df_ori['factor'].unstack().shift(10).stack()
