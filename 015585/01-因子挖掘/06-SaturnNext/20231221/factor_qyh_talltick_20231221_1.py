...
# 17,-0.045
#
def factor_qyh_talltick_20231221_1(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20231221_1'
    ...
    #
    res = abs(tick_df['factor'] - tick_df['factor'].mean()).median()
    factor_dict = {factor_name: res*1000}
    # ---------------------------------------------------------------------------------------------------------------
