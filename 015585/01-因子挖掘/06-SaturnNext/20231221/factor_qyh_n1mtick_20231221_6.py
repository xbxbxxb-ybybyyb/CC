...
import numpy as np
# dtj,zcz
# 最新价/最高价/成交量在30s以后的离群程度,结合委买因子处理部分样本
# 21,0.065,0.088
#
def factor_qyh_n1mtick_20231221_6(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_n1mtick_20231221_6'
    ...
    tick_df['factor'] = tick_df['LastPx'] / tick_df['HighPx'] * tick_df['VolumeTrade']
