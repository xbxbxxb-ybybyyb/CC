...
s = FactorData()
factor_name = 'qyh_os5_sp2vwap'
def factor_qyh_os5_sp2vwap(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 1.62,'data':['ordersheet5','MD']}
    # 可修改的因子编写部分
    ...
    f_data[factor_name] = p_data['p'] / f_data['vwap']
