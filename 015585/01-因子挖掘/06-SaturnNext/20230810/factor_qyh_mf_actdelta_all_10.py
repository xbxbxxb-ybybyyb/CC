...
s = FactorData()
factor_name = 'qyh_mf_actdelta_all_10'
def factor_qyh_mf_actdelta_all_10(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data = IO.read_data([start_date, end_date],
                          columns=['S_MFD_INFLOW_OPENVOLUME']
    ...
    f_data[factor_name] = (f_data['S_MFD_INFLOW_OPENVOLUME']) / \
                          g_data['volume']
