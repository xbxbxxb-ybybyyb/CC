...
s = FactorData()
factor_name = 'qyh_mf_act_small_buy_r'
def factor_qyh_mf_act_small_buy_r(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = (f_data['BUY_VALUE_SMALL_ORDER_ACT']) / \
