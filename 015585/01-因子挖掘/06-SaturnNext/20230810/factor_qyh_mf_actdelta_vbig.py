...
s = FactorData()
factor_name = 'qyh_mf_actdelta_vbig'
def factor_qyh_mf_actdelta_vbig(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data = IO.read_data([start_date, end_date],
                          columns=['VOLUME_DIFF_INSTITUTE_ACT']
    ...
    f_data[factor_name] = (f_data['VOLUME_DIFF_INSTITUTE_ACT']) / \
                          g_data['volume']
