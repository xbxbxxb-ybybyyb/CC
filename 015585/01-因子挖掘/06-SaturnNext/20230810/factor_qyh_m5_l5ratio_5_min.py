...
s = FactorData()
factor_name = 'qyh_m5_l5ratio_5_min'
def factor_qyh_m5_l5ratio_5_min(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 3.55,'data':['minute5','MD']}
    # 可修改的因子编写部分
    ...
    f_data[factor_name] = (qty_data['m1455'] / f_data['amt']).unstack().rolling(5,1).min().stack()
