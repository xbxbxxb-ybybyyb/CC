...
s = FactorData()
factor_name = 'qyh_mf_actdelta_all_14_r'
def factor_qyh_mf_actdelta_all_14_r(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data = IO.read_data([start_date, end_date],
                          columns=['CLOSE_NET_INFLOW_RATE_VOLUME']
                          , alt='/data/group/800080/warehouse/prod/DATABASE/WIND/AShareMoneyFlow/AShareMoneyFlow.h5')
    f_data[factor_name] = (f_data['CLOSE_NET_INFLOW_RATE_VOLUME'])
