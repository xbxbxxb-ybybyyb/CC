...
s = FactorData()
factor_name = 'qyh_m5_p_std_5_20'
def factor_qyh_m5_p_std_5_20(start_date, end_date, IO, return_fillna_dic=False):
    ...
    res = close_data['std'].unstack().rolling(5,2).mean().stack() / close_data['std'].unstack().rolling(20,5).mean().stack()
