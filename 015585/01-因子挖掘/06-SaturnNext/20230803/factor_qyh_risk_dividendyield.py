...
s = FactorData()
factor_name = 'qyh_risk_dividendyield'
def factor_qyh_risk_dividendyield(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['DividendYield']
