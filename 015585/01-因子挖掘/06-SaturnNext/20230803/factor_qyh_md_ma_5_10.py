...
# 逻辑：根据5日、10日收盘价MA,计算MA5相对于MA10的偏离度，factor = (ma5 - ma10)/ma10
# -0.083,31
# saturn_EFS_pct5_T1:47
import pandas as pd
import numpy as np
import os
from xquant.factordata import FactorData
s = FactorData()
factor_name = 'qyh_md_ma_5_10'
def factor_qyh_md_ma_5_10(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = (f_data['ma_5'] - f_data['ma_10']) / f_data['ma_10']
