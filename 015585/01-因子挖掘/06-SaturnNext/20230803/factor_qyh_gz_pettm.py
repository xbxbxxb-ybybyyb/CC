...
s = FactorData()
factor_name = 'qyh_gz_pettm'
def factor_qyh_gz_pettm(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0,'data':['AShareEODDerivativeIndicator']}
    # 可修改的因子编写部分
