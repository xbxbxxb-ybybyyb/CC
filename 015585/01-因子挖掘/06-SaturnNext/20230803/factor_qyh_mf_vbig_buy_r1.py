...
s = FactorData()
factor_name = 'qyh_mf_vbig_buy_r1'
def factor_qyh_mf_vbig_buy_r1(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['BUY_VALUE_EXLARGE_ORDER'] / \
                          (f_data['BUY_VALUE_EXLARGE_ORDER'] +
                           f_data['SELL_VALUE_EXLARGE_ORDER'])
