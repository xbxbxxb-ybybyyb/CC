...
s = FactorData()
factor_name = 'qyh_md_ma_5'
def factor_qyh_md_ma_5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['close'] / f_data['ma_5']
