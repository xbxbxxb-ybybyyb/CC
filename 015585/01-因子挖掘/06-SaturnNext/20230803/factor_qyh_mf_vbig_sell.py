...
s = FactorData()
factor_name = 'qyh_mf_vbig_sell'
def factor_qyh_mf_vbig_sell(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 4696,'data':['AShareMoneyFlow']}
    # 可修改的因子编写部分
