...
s = FactorData()
factor_name = 'qyh_ma_10'
def factor_qyh_ma_10(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['close'] / f_data['ma_10']
