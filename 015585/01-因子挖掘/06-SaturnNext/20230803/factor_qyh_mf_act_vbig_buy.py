...
# 超大单主动买入金额
# -0.03,15
# qyh_talltran_bamt_cv:21
import pandas as pd
import numpy as np
import os
from xquant.factordata import FactorData
s = FactorData()
factor_name = 'qyh_mf_act_vbig_buy'
def factor_qyh_mf_act_vbig_buy(start_date, end_date, IO, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 2761,'data':['AShareMoneyFlow']}
    # 可修改的因子编写部分
