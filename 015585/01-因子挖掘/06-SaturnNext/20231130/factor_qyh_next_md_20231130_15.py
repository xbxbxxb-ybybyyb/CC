...
# 上影线的5日集中度
# 33,-0.066
factor_name = 'qyh_next_md_20231130_15'
def factor_qyh_next_md_20231130_15(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(5,2).apply(lambda x : f_calc_cct(x)).stack()
