...
s = FactorData()
factor_name = 'qyh_next_md_20231130_7'
# dtj
# High的20日均值 - T-1close / low，相对60日平滑最大值的差异
# 25,0.064
def factor_qyh_next_md_20231130_7(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori[factor_name] - df_ori[factor_name].unstack().rolling(60,1).quantile(0.9).stack() # max 16
    # -------------------------------------------------------------------------------------------------------------------
