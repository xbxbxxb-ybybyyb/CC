...
# 挂买占比在开盘活跃/不活跃的差异
#
def factor_qyh_talltick_20231228_6(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20231228_6'
    ...
    tick_df1 = tick_df[tick_df['ValueTrade'] >= tick_df['ValueTrade'].quantile(0.6)]
    tick_df1 = tick_df1.head(100)
    tick_df2 = tick_df[tick_df['ValueTrade'] <= tick_df['ValueTrade'].quantile(0.4)]
    tick_df2 = tick_df2.head(100)
    #
