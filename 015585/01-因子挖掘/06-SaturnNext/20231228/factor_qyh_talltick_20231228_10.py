...
# 18，-0.04，-0.04
#
def factor_qyh_talltick_20231228_10(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20231228_10'
    ...
    #
    tick_df1 = tick_df[tick_df['vwap'] > tick_df['vwap'].shift(1)]
    tick_df2 = tick_df[tick_df['vwap'] < tick_df['vwap'].shift(1)]
