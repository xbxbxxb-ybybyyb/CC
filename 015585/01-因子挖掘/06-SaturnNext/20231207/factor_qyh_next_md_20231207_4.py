...
s = FactorData()
# dtj
# 糅合类因子：close/vwap和pct*turn的20日中位数
# 24,-0.054
#
factor_name = 'qyh_next_md_20231207_4'
def factor_qyh_next_md_20231207_4(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['factor1'] = df_ori['factor'].unstack().rolling(20,10).median().stack()
    df_ori['factor1'] = rank_(df_ori['factor1'])
    #
    df_ori['factor'] = df_ori['pct_chg'] * df_ori['turn']
    df_ori['factor2'] = df_ori['factor'].unstack().rolling(20,10).median().stack()
