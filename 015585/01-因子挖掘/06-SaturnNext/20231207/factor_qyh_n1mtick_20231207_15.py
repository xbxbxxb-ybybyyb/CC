...
import numpy as np
# dtj
# 净委买前半分钟里活跃/不活跃的最小值差异
# 24，0.02
#
def factor_qyh_n1mtick_20231207_15(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_n1mtick_20231207_15'
    ...
    #
    res1 = tick_df1['factor'].min() if not tick_df1.empty else np.nan
    res2 = tick_df2['factor'].min() if not tick_df2.empty else np.nan
