...
# 成交量加权的60日平均涨跌幅
# 32,-0.079
# wj_last50_v2m1pct_lsdiff:18
factor_name = 'qyh_next_md_20231207_18'
def factor_qyh_next_md_20231207_18(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['factor1'] = df_ori['factor'].unstack().rolling(60,1).mean().stack()
    df_ori['factor2'] = df_ori['amt'].unstack().rolling(60,1).median().stack()
