...
# 28,-0.062
#
factor_name = 'qyh_next_md_20231207_20'
def factor_qyh_next_md_20231207_20(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['factor1'] = df_ori['factor'].unstack().rolling(10,1).max().stack()
    df_ori['factor2'] = df_ori['factor'].unstack().rolling(120,1).max().stack()
