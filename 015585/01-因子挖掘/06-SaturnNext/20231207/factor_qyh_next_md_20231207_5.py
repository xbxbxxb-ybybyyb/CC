...
s = FactorData()
# dtj
# abs(pct*turn)的10日均值/60日均值的rank
# 32，-0.07
#
factor_name = 'qyh_next_md_20231207_5'
def factor_qyh_next_md_20231207_5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori['factor2'] = df_ori['factor'].unstack().rolling(60,1).mean().stack()
