...
def factor_qyh_n1mtick_20231207_9(tick_df, return_fillna_dic=False):
    ...
    #
    tick_df1 = tick_df[tick_df['ValueTrade'] >= round_(tick_df['ValueTrade'].quantile(0.5),8)]
    tick_df2 = tick_df[tick_df['ValueTrade'] <= round_(tick_df['ValueTrade'].quantile(0.5),8)]
    #
