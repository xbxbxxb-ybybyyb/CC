...
s = FactorData()
factor_name = 'qyh_mf_big_buy_5'
def factor_qyh_mf_big_buy_5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data = IO.read_data([start_date, end_date],
                          columns=['BUY_VALUE_LARGE_ORDER']
                          , alt='/data/group/800080/warehouse/prod/DATABASE/WIND/AShareMoneyFlow/AShareMoneyFlow.h5')
    f_data[factor_name] = f_data['BUY_VALUE_LARGE_ORDER'].unstack().rolling(5,1).mean().stack()
