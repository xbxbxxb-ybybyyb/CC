...
from factor_qyh_n1mt_ratiob_cv import factor_qyh_n1mt_ratiob_cv as func
from project_2_factor_test_origin import pj2FactorTest
import pandas as pd

date = '20230817'#周四日期
factor_name = 'factor_qyh_n1mt_ratiob_cv'
factor_path = '/data/user/015585/01-因子挖掘/06-SaturnNext/' + date + '/'
run_factor(func = func,
          factor_name = factor_name,
          factor_type = 'Next1mTickab',#TallTick,Next_T-1_factor,Next1mTickab
          start_date = 20160101,
          end_date = 20191231,
