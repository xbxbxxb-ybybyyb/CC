...
from project_2_factor_test_origin_forzbw import pj2FactorTest
import pandas as pd
import os

date = '20240118'#周四日期
factor_name = 'factor_qyh_talltick_20240118_15'
m = __import__(factor_name)
func = getattr(m,factor_name)
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/06-SaturnNext/factor_' + date + '/'
start_date = 20160101
end_date = 20191231
...
#           factor_type = 'TallTick',# TallTick,Next_T-1_factor,Next1mTickab,Next1mTransaction
...
result_path = '/data/user/015585/01-因子挖掘/06-SaturnNext/factor_' + date + '/'
