                    ...
                    for amtstd in dic_amtstd:
                        ...
                        if is_generate:
                            for A, B, C, rollingA, rollingB, rollingC in product(dic_getA, dic_getB, dic_getC,
                                ...
                                factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/neptune/h5' + '/20250326_T_1_Factor_priceori/' # 因子保存路径
                                ...
                                result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/neptune/factor_report' + '/20250326_T_1_Factor_priceori/'  # report保存路径
