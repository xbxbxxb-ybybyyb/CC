...
df_st_2025 = df_st[(df_st['ENTRY_DT'] >= '20250101') & (df_st['ENTRY_DT'] <= '20250430')]
df_st_2025_filter = df_st_2025[df_st_2025['S_TYPE_ST'] != 'R'] # 非“恢复上市”均考虑

# 获取pre_st的总和 df_pre_st
path_pre_st = '/data/user/018107/share_file/for_qyh/tmp/pre_st_list/'
...
# 往前取非停牌的前一个交易日
md_data = IO.read_data([20240101,20250428], columns=['amt'],
...
res_tmp = res_tmp[res_tmp['dt'] != '20250203']
print('原先FC每天预测数量：')
