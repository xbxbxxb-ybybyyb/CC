...
if __name__ == '__main__':
    import os
    start_date,end_date=20170101,20211231
    basic_file_path = '/dfs/user/018107/factor_zoo1/left_v2310/Basic_zt_test/Basic_zt_001.h5'
    result_path = '/dfs/group/800463/data/project1_prod/tickfull_europa/'
