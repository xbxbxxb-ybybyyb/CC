...
if __name__ == '__main__':
    ...
    result_path_tick='/data/user/015585/01-因子挖掘/20230703-暑期实习生数据准备/result/'
    result_path_transaction='/data/user/015585/01-因子挖掘/20230703-暑期实习生数据准备/result/'
    ...
    for tradingday in s.tradingday('20180109', '20180111'):
