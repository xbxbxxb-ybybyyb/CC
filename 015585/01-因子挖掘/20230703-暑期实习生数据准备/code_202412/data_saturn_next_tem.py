...
if __name__ == '__main__':
    ...
    result_path_tick='/dfs/user/015585/03_实习生数据/tick940/'
    result_path_transaction='/dfs/user/015585/03_实习生数据/trade940/'
    ...
    pool = Pool(24)
    task_list = []
    all_Basic_next_hf_finish = pd.read_pickle('/data/user/015585/01-因子挖掘/20230703-暑期实习生数据准备/code_202412/filter_df.pkl').sort_index()
    print(all_Basic_next_hf_finish.shape)
    for tradingday in s.tradingday('20180101', '20201231'):
