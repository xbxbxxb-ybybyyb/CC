...
import pandas as pd
#
# 逻辑：0931，每个tick挂买和挂卖的corr
# score:0.01,0.8,GG
# GG
factor_name = 'qyh_T1mtick_1m_corr_bs'#
def factor_qyh_T1mtick_1m_corr_bs(tick_df, return_fillna_dic=False):
    ...
    df_bs = pd.concat([buytotal,bstotal - buytotal],axis = 1)
    corr = df_bs.corr(method = 'spearman').loc[0,1]
