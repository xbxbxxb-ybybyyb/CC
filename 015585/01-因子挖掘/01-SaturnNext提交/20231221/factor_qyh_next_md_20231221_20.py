...
s = FactorData()
factor_name = 'qyh_next_md_20231221_20'
def factor_qyh_next_md_20231221_20(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori.loc[df_ori['tmp'] < -0.0047,factor_name] = df_ori.loc[df_ori['tmp'] < -0.0047,factor_name] - 0.04*2
