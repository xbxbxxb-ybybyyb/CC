...
# 相对净委买在成交量较高和较低时候的差
# 都min 20，0.046
def factor_qyh_talltick_rcleanb_20_a2_min(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_rcleanb_20_a2_min'
    ...
    res = tick_df1.head(20)['rcleanb'].min() - tick_df2.head(20)['rcleanb'].min()
