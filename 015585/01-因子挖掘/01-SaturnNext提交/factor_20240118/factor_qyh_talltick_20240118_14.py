...
import pandas as pd
import numpy as np
def factor_qyh_talltick_20240118_14(tick_df, return_fillna_dic=False):
    factor_name = 'qyh_talltick_20240118_14'
    ...
    tick_df['factor'] = tick_df['factor'] + tick_df['factor'].mean()
