...
def get_tick_data(stock_code, tradingday):
    ...
    a = StockData()
    df = a.get_tick1s(tradingday, stock_code)
...
result_path = '/dfs/group/800463/data/xdb_data_europa/xdb_tick1s/'
update_data_tickab(20170101,20191231,basic_file_path,result_path,10)