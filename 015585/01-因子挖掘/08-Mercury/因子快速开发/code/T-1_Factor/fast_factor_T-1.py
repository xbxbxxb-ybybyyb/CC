                    ...
                    for amtstd in dic_amtstd:
                        ...
                        if is_generate:
                            for A, B, C, rollingA, rollingB, rollingC in product(dic_getA, dic_getB, dic_getC,
                                ...
                                factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturn/h5' + '/20240102T_1factor/' # 因子保存路径
                                ...
                                result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturn/factor_report' + '/20240102T_1factor/'  # report保存路径
                            ...
                            def factor_func(start_date, end_date, IO, return_fillna_dic=False, df_ori=df_ori.copy()):
                                ...
                                # ---------------------------------------------------------------------------------------------------------------
                                return res
                            basic_file_path = '/dfs/group/800463/data/mercury/ff_data/Basic/basic_dt_new.h5'
                            factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/mercury/h5' + '/20240524_T_1/'  # 因子保存路径
                            factor_df0 = run_factor(func=factor_func,
                                                    factor_name=factor_name,
                                                    factor_type='T-1_factor',
                                                    start_date=start_date,
                                                    ...
                                                    interval_res=False)
                            df = pd.read_hdf(factor_path + factor_name + '.h5')
                            result_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/mercury/factor_report' + '/20240524_T_1/' # report保存路径
                            factor_test = pj2FactorTest(start_date, end_date, cal_mi=False)
                            for col in df.columns:
                                print(col)
                                factor_test.factor_test(df[[col]], result_path,
