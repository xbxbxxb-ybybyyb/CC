...
class pj2FactorTest:
    def __init__(self, start_date, end_date, segment_number=20, style_list=['freeturn'], cal_mi = True,
                 buy_type = 's1'
                 ):
    ...
    def factor_test(self, factor_df, result_path, factor_corr_test=False, generate_pdf=True):
        ...
        if ('freeturn' in self.result_dic['double_group_sort']):
            self.result_dic['check_diff_res'], self.result_dic['check_score_res'] = self.check_score(self.result_dic['double_group_sort']['freeturn'].copy(),
            ...
            self.result_dic['check_diff_res'], self.result_dic['check_score_res'] = self.check_score(self.result_dic['double_group_sort']['tradingday'].copy(),
                                                                                                     self.result_dic['corr_month'].copy(),
                                                                                                     np.sign(self.result_dic['corr_sta'].loc['corr_tot']))
    ...
    def get_factor_information(self):
        ...
        factor_information[' '] = ['Segment Number', 'Buy Type', 'Style List','','','']
        factor_information['Settings'] = [self.segment_number, str(self.buy_type), str(self.style_list),'','','']
