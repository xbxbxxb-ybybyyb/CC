# 每次修改第二行
from run_factor_demo_jupiter import run_factor
from factor_qyh_ths_heat1_all import factor_qyh_ths_heat1_all as func
...
print(factor_name)
start_date, end_date = 20190101, 20191231  # 因子的样本内区间：16-19年
...
# 非快速拉升
print('全样本')
factor_test = strongFactorTest(20190101, 20191231)
res = []
