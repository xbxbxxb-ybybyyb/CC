...
# 开盘价/收盘价20日中位数
# 17
factor_name = 'qyh_metis_md_20240229_3'
def factor_qyh_metis_md_20240229_3(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['open'] / df_ori['close'].unstack().rolling(20,1).median().stack()
