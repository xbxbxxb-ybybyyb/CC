...
def run_factor(func, factor_name, factor_type, start_date, end_date, basic_file_path, result_path, append_next_tradingday=False, interval_res=True,
               ...
               data_path_dic= {'TTransaction': '/data/group/800463/data/project1_prod/transaction_jupiter/',#jupiter的逐笔成交
                               'TTickab': '/data/group/800463/data/project1_prod/tick_jupiter/',#jupiter的快照
                               'TOrder': '/data/group/800463/data/project1_prod/order_jupiter/',#jupiter的逐笔委托
                               'TTransaction_Metis': '/data/group/800463/data/project1_prod/transaction_metis/',#metis临时用于批量迁移的逐笔成交
                               'TTickab_Metis': '/data/group/800463/data/project1_prod/tickab_metis/',#metis临时用于批量迁移的快照
                               'TTransaction_MetisAll': '/data/group/800463/data/project1_prod/transaction_metis_all/',#metis的逐笔成交
                               'TTickab_MetisAll': '/data/group/800463/data/project1_prod/tickab_metis_all/',#metis的快照
                               'TOrder_MetisAll': '/data/group/800463/data/project1_prod/order_metis_all/',#metis的逐笔委托
    ...
    # factor_type: string, 计算的因子类别，Todo:Metis开发TTransaction_MetisAll、TTickab_MetisAll、TOrder_MetisAll类因子。
    ...
    if factor_type in ['TTransaction', 'TTickab','TOrder',
                       'TTransaction_Metis', 'TTickab_Metis',
                       'TTransaction_MetisAll', 'TTickab_MetisAll', 'TOrder_MetisAll',
        ...
        if factor_type in ['TTransaction', 'TTickab', 'TOrder','TTransaction_Metis', 'TTickab_Metis','TTransaction_MetisAll', 'TTickab_MetisAll', 'TOrder_MetisAll']:
            ...
            factor_df_list = Parallel(n_jobs=16)(delayed(calc_tmp_df)(tradingday, num) for tradingday, num in
...
if __name__ == '__main__':
    ...
    import project1_lib.public.factor_test_trade_factor as func_tmp
    #需要开发当日从开盘到metis触发的T日因子（TTransaction_MetisAll、TTickab_MetisAll、TOrder_MetisAll）
    factor_df1 = run_factor(func_tmp.factor_test_trade_factor, 'test_trade_factor', 'TTransaction_MetisAll',
