...
'''
date = '20240307'#周四日期
factor_name = 'factor_qyh_met_ttick_test'
...
factor_df0 = run_factor(func,
                        factor_name,
                        'TTickab_MetisAll',## T-1_factor,TTickab_MetisAll
                        start_date, end_date,
                        basic_file_path,
                        result_path, interval_res=False)
df = pd.read_hdf(result_path + factor_name + '.h5')
# df = pd.read_hdf('/data/user/015585/20240116_frame/factor_value/metis/qyh_met_20240307_2.h5')
# 非快速拉升
# print('全样本')
