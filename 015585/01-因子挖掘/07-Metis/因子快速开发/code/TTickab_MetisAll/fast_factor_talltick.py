...
for factor_done in list(dic_done_factor['20230713talltick']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20230719talltick']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20230814talltick']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20231208talltick']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20231219talltick']['name']):
    list_del.append(factor_done)
for factor_done in list(dic_done_factor['20240110talltick']['name']):
    list_del.append(factor_done)
list_series = ['rcleanb',
                'cleanb2ttran',
                'cleanb2tran',
...
for time_kind_i,time_type_i,\
        ...
        factor_path = '/dfs/user/015585/01_factor_develop_store/fast_factor/saturnnext/h5' \
                      + '/20240112talltick/' # 因子保存路径
        run_factor(func=factor_func,
                   factor_name=factor_name,
                   factor_type='TallTick',
                   start_date=20160101,
                   end_date=20191231,
