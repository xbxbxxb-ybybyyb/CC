...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'future':
            sft_basic_path = '/data/group/800463/data/projectF_public/factor_lib/sft_update_20220801_20230731.pkl'  # 这个文件里有label和所有因子
            ...
            df = pd.read_pickle(sft_basic_path).loc[pd.Timestamp(self.start_date): pd.Timestamp(self.end_date_)]
    ...
    def get_factor_sort(self, data=None, factor_group_num=10): # neptune分组为5，对应1700标的，这里按月，分组改为10
