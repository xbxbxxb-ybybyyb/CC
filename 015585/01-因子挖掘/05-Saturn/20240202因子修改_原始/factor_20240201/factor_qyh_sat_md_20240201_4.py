...
s = FactorData()
factor_name = 'qyh_sat_md_20240201_4'
def factor_qyh_sat_md_20240201_4(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori = IO.read_data([start_date, end_date],
                          columns=['vwap','pre_close','adjfactor','close','high','low','amt','turn'],
