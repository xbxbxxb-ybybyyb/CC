...
# 活跃/不活跃时买1-买均变异系数的差异
# 55,0.077,0.067
factor_name = 'qyh_sat_lztick_20240314_7'#
def factor_qyh_sat_lztick_20240314_7(tick_df, return_fillna_dic=False):
    ...
    res = f_calc_cv(tick_df2['factor']) - f_calc_cv(tick_df1['factor'])
