...
import pandas as pd
# 待提交
# 逻辑：末次封板后，每个tick买1的最大值 / max30s
# score:17,0.11
factor_name = 'qyh_lzttick_b1amt_after2zt_max_2max30s'#
def factor_qyh_lzttick_b1amt_after2zt_max_2max30s(tick_df, return_fillna_dic=False):
