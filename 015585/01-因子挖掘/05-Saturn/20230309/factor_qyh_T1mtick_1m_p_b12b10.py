...
import pandas as pd
#
# 逻辑：0931，(买1-买10)/close_pre
# score:4,21,-0.06
# sss_tk1m_pricepct10_sell_q95,pre_close
factor_name = 'qyh_T1mtick_1m_p_b12b10'#
def factor_qyh_T1mtick_1m_p_b12b10(tick_df, return_fillna_dic=False):
    ...
    df_b12s1 = (tick_df[col_list_p[0]] - tick_df[col_list_p[9]]) / pre
    delta = df_b12s1.mean()
