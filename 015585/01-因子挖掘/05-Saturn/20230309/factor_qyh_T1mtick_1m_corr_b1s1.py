...
import pandas as pd
#
# 逻辑：0931，每个tick挂买1和挂卖1的corr
# score:GG
#
factor_name = 'qyh_T1mtick_1m_corr_b1s1'#
def factor_qyh_T1mtick_1m_corr_b1s1(tick_df, return_fillna_dic=False):
    ...
    df_b1s1 = pd.concat([tick_df['buyamt0'],tick_df['sellamt10']],axis = 1)
    corr = df_b1s1.corr(method = 'spearman').loc['buyamt0','sellamt10']
