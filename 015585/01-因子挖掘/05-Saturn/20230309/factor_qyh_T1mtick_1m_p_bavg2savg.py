...
import pandas as pd
#
# 逻辑：0931，(挂卖均价-挂买均价)/close_pre
# score:-0.03，7.9，3
# 无
factor_name = 'qyh_T1mtick_1m_p_bavg2savg'#
def factor_qyh_T1mtick_1m_p_bavg2savg(tick_df, return_fillna_dic=False):
    ...
    df_b12s1 = (tick_df['WeightedAvgOfferPx'] - tick_df['WeightedAvgBidPx']) / pre
    delta = df_b12s1.mean()
