...
import pandas as pd
#
# 逻辑：0931，(挂卖均价-成交均价)/close_pre
# score:GG
#
factor_name = 'qyh_T1mtick_1m_p_savg2tavg'#
def factor_qyh_T1mtick_1m_p_savg2tavg(tick_df, return_fillna_dic=False):
    ...
    df_b12s1 = (tick_df['WeightedAvgOfferPx'] - (tick_df['amt'] / tick_df['vol'])) / pre
    delta = df_b12s1.mean()
