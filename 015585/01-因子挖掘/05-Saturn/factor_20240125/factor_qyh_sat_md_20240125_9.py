...
# 五日成交量的位置
# 24.5,0.054,0.046
factor_name = 'qyh_sat_md_20240125_9'
def factor_qyh_sat_md_20240125_9(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori[factor_name] = df_ori['factor'].unstack().rolling(5,1).apply(lambda x : f_calc_pos(x)).stack()
    # -------------------------------------------------------------------------------------------------------------------
