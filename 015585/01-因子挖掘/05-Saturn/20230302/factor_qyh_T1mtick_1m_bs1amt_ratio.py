...
import pandas as pd
# 待提交
# 逻辑：0931，每个tick的（买1 - 卖1）占总挂单比例，平均计算
# score:19.61,0.058,13
# 无
factor_name = 'qyh_T1mtick_1m_bs1amt_ratio'#
def factor_qyh_T1mtick_1m_bs1amt_ratio(tick_df, return_fillna_dic=False):
    ...
    ratio = (((tick_df['buyamt'+str(0)]) - (tick_df['sellamt'+str(10)]))/ bstotal).mean()
