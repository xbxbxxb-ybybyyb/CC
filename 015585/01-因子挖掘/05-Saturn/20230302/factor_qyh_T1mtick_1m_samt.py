...
# score:4，GG
#
factor_name = 'qyh_T1mtick_1m_samt'#
def factor_qyh_T1mtick_1m_samt(tick_df, return_fillna_dic=False):
    ...
    for i in range(20):
        ...
        if i == 10:
            selltotal = tick_df[col_list_p[i]] * tick_df[col_list_v[i]]
        if i > 10:
            selltotal = selltotal + tick_df[col_list_p[i]] * tick_df[col_list_v[i]]
