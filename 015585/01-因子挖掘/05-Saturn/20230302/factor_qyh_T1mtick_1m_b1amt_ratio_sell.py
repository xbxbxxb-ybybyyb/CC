...
import pandas as pd
# 待提交
# 逻辑：0931，每个tick的买1占卖单挂单比例，平均计算
# score:14,6,0.04
# 无
factor_name = 'qyh_T1mtick_1m_b1amt_ratio_sell'#
def factor_qyh_T1mtick_1m_b1amt_ratio_sell(tick_df, return_fillna_dic=False):
    ...
    ratio = ((tick_df['buyamt'+str(0)])/ (bstotal - buytotal)).mean()
