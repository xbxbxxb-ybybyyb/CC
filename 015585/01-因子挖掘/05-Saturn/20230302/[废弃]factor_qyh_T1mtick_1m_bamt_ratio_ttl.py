...
import numpy as np
import pandas as pd
# 逻辑：0931，每个tick的挂买总额占总挂单比例，总体计算
# score:10.2，0.03
# pj2k_931_sb_10_wish_mean：18
factor_name = 'qyh_T1mtick_1m_bamt_ratio_ttl'#
def factor_qyh_T1mtick_1m_bamt_ratio_ttl(tick_df, return_fillna_dic=False):
