...
# score: GG
#
factor_name = 'qyh_T1mtick_1m_b1amt_s2m'#
def factor_qyh_T1mtick_1m_b1amt_s2m(tick_df, return_fillna_dic=False):
    ...
    if tick_df['buyamt0'].mean() > 10:
        ratio = tick_df['buyamt0'].std() / tick_df['buyamt0'].mean()
    else:
        ratio = np.nan
