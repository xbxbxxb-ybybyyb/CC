...
# 待提交
# 逻辑：0931，卖1总额
# score:10，8，-0.028 头部好一些
# 无
factor_name = 'qyh_T1mtick_1m_s1amt'#
def factor_qyh_T1mtick_1m_s1amt(tick_df, return_fillna_dic=False):
    ...
    amt = (tick_df[col_list_p[10]] * tick_df[col_list_v[10]]).sum()
