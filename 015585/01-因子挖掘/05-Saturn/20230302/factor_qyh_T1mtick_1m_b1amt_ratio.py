...
import numpy as np
import pandas as pd
# 逻辑：0931，每个tick的买1占总挂单比例，平均计算
# 说明有买1托着更好，这一点可以挖掘
# score:8.05,0.04
# 无
factor_name = 'qyh_T1mtick_1m_b1amt_ratio'#
def factor_qyh_T1mtick_1m_b1amt_ratio(tick_df, return_fillna_dic=False):
    ...
    ratio = ((tick_df['buyamt'+str(0)])/ bstotal).mean()
