...
import numpy as np
import pandas as pd
# 逻辑：0931，每个tick的卖1总额占总挂单比例，平均计算
# score:12，-0.04，9
# 无
factor_name = 'qyh_T1mtick_1m_s1amt_ratio'#
def factor_qyh_T1mtick_1m_s1amt_ratio(tick_df, return_fillna_dic=False):
    ...
    ratio = ((tick_df['sellamt'+str(10)])/ bstotal).mean()
