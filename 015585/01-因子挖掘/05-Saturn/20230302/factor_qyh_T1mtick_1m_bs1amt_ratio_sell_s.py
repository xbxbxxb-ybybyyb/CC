...
import pandas as pd
# 待提交
# 逻辑：0931，买1占卖单挂单比例的波动率 - 卖1占买单挂单比例的波动率
# score:20.7，14，0.065
# 无
factor_name = 'qyh_T1mtick_1m_bs1amt_ratio_sell_s'#
def factor_qyh_T1mtick_1m_bs1amt_ratio_sell_s(tick_df, return_fillna_dic=False):
    ...
    ratio = ((tick_df['buyamt'+str(0)])/ (bstotal - buytotal)).std() - ((tick_df['sellamt'+str(10)])/ buytotal).std()
