...
from factor_qyh_T1mtra_ratio_small_b2s_std import factor_qyh_T1mtra_ratio_small_b2s_std
...
date = '20230216'#周四日期
factor_name = 'factor_qyh_T1mtra_ratio_small_b2s_std'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
run_factor(func = factor_qyh_T1mtra_ratio_small_b2s_std,
