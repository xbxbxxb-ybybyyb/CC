...
from factor_qyh_T1mtra_r_amt2pct_ud_ln import factor_qyh_T1mtra_r_amt2pct_ud_ln
...
date = '20230216'#周四日期
factor_name = 'factor_qyh_T1mtra_r_amt2pct_ud_ln'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
run_factor(func = factor_qyh_T1mtra_r_amt2pct_ud_ln,
