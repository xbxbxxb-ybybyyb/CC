...
# 逻辑：计算KDJ指标，取D和最近D最低点的距离
import pandas as pd
import numpy as np
import os
from xquant.factordata import FactorData
s = FactorData()
factor_name = 'qyh_kdj_d_change'
def factor_qyh_kdj_d_change(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['D'] - f_data['D'].unstack().rolling(20,1).min().stack()
