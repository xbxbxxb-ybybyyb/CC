...
s = FactorData()
factor_name = 'qyh_kdj_kd_deri_max5'
def factor_qyh_kdj_kd_deri_max5(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data[factor_name] = f_data['K-D_deri'].unstack().rolling(5,1).max().stack()
