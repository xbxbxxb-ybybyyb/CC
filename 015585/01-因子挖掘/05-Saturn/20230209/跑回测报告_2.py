...
from factor_qyh_T1mtra_ratio_in_small_0 import factor_qyh_T1mtra_ratio_in_small_0
...
date = '20230209'#周五日期
factor_name = 'factor_qyh_T1mtra_ratio_in_small_0'
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
run_factor(func = factor_qyh_T1mtra_ratio_in_small_0,
