...
from factor_qyh_01test import factor_qyh_01test
...
date = '20230209'#周五日期
factor_name = 'factor_qyh_01test'
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
print(factor_name)
run_factor(func = factor_qyh_01test,
...
factor_test = pj2FactorTest(start_date, end_date, test_sample = 'bt',style_list=['T_o2pre','tradingday'],
                            cal_mi=True, buy_type = '0931',sell_type = 'v',lzt_pattern=[3, 4],high_open=0.08)
res = []
