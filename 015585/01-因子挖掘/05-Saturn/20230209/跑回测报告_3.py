...
from factor_qyh_T1mtra_ratio_in_big_1 import factor_qyh_T1mtra_ratio_in_big_1
...
date = '20230209'#周五日期
factor_name = 'factor_qyh_T1mtra_amtpertra_sell_s'
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
run_factor(func = factor_qyh_T1mtra_ratio_in_big_1,
