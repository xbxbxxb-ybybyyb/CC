...
s = FactorData()
factor_name = 'qyh_plus_price_5_mean'
def factor_qyh_plus_price_5_mean(start_date, end_date, IO, return_fillna_dic=False):
    ...
    f_data = f_data.unstack().rolling(5,1).mean().stack()
