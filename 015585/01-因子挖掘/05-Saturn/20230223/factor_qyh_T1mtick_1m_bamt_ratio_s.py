...
import numpy as np
import pandas as pd
# 逻辑：0931，每个tick的挂买总额占总挂单比例的标准差
# score:无效
#
factor_name = 'qyh_T1mtick_1m_bamt_ratio_s'#
def factor_qyh_T1mtick_1m_bamt_ratio_s(tick_df, return_fillna_dic=False):
    ...
    ratio_s = (buytotal / bstotal).std()
    factor_dict = {factor_name: ratio_s}
    # ---------------------------------------------------------------------------------------------------------------
