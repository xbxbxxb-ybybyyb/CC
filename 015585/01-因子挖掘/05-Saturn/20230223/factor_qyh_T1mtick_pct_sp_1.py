...
import pandas as pd
# 待提交
# 逻辑：跳开幅度：集合竞价0925 - 0924
# score:0.06,9.16
# pj2_last_cancel_chance_price:3.88
factor_name = 'qyh_T1mtick_pct_sp_1'#skip price
def factor_qyh_T1mtick_pct_sp_1(tick_df, return_fillna_dic=False):
    ...
    if zcz:
        pct_sp_1 = pct_sp_1 / 2
    factor_dict = {factor_name: pct_sp_1}
