...
from factor_qyh_T1mtick_1m_bs_price import factor_qyh_T1mtick_1m_bs_price
...
date = '20230223'#周四日期
factor_name = 'factor_qyh_T1mtick_1m_bs_price'
print(factor_name)
factor_path = '/data/user/015585/01-因子挖掘/' + date + '/'
run_factor(func = factor_qyh_T1mtick_1m_bs_price,
