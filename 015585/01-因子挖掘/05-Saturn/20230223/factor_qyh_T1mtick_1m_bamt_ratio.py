...
import numpy as np
import pandas as pd
# 逻辑：0931，每个tick的挂买总额占总挂单比例
# score:0.038,10,6
# pj2k_931_sb_10_wish_mean:18,13
factor_name = 'qyh_T1mtick_1m_bamt_ratio'#
def factor_qyh_T1mtick_1m_bamt_ratio(tick_df, return_fillna_dic=False):
