...
import pandas as pd
# dtj
# 931前一半和后一半时间内，挂买金额/总成交额的均值差异
# 22，-0.071，-0.067
factor_name = 'qyh_sat_1mtick_20240222_2'#
def factor_qyh_sat_1mtick_20240222_2(tick_df, return_fillna_dic=False):
    ...
    tick_df1['factor'] = (tick_df1['buy_amt']) / tick_df1['ValueTrade'].sum() # 除以对应时间段成交总额
    tick_df2['factor'] = (tick_df2['buy_amt']) / tick_df2['ValueTrade'].sum()
