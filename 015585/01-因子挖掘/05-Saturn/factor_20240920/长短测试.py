...
print(factor_check(factor_qyh_sat_md_20240229_4,
            factor_name,
            '/data/user/015585/01-因子挖掘/06-SaturnNext/factor_check/'))

'''
假如你原来有10000股，你相当于误操作卖掉了5000股，现在用两倍杠杆补5000股回来
这卖掉的5000股如果涨了10%，那你就少赚了10%，需要两倍杠杆的5000股涨5%，一旦涨到5%，你就撤掉2500股
相当于用剩下的2500股弥补之前的5000股，是等效的
