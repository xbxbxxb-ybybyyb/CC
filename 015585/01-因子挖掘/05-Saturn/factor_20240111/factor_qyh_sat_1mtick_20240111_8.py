...
# 23,-0.097,-0.1
# 挂买/成交在活跃/不活跃的
factor_name = 'qyh_sat_1mtick_20240111_8'#
def factor_qyh_sat_1mtick_20240111_8(tick_df, return_fillna_dic=False):
    ...
    tick_df1['factor'] = (tick_df1['buy_amt'])/(tick_df1['ValueTrade']+1)
    tick_df2['factor'] = (tick_df2['buy_amt'])/(tick_df2['ValueTrade']+1)
