...
class factor_qyh_mimas_20241031_3(BaseFactor):
    strategy_name = "mimas"
    factor_name = "qyh_mimas_20241031_3"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "中额订单中，订单价格比买10低的部分，订单金额占所有挂单比例的标准差" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df['factor'] = (tick_df['OrderQty'] * tick_df['OrderPrice']) / (
                        tick_df['TotalOfferQty'] * tick_df['WeightedAvgOfferPx']
