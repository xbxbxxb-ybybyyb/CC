...
s = FactorData()
factor_name = 'qyh_md_20231012_11'
def factor_qyh_md_20231012_11(start_date, end_date, IO, return_fillna_dic=False):
    ...
    df_ori = IO.read_data([start_date, end_date],
                          columns=['close','pre_close','high','low','open'],
    ...
    df_ori[factor_name] = df_ori['factor'] / \
                          df_ori['factor'].unstack().rolling(5,1).\
