...
class factor_qyh_newsat_20240411_18(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_18"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "挂买总额的偏度在活跃/不活跃的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df1['factor'] = tick_df1['WeightedAvgBidPx'] * tick_df1['TotalBidQty']
        tick_df2['factor'] = tick_df2['WeightedAvgBidPx'] * tick_df2['TotalBidQty']
        # if zcz:
        #     tick_df1['factor'] = (tick_df1['factor']) / 2
        #     tick_df2['factor'] = (tick_df2['factor']) / 2

        res = tick_df1['factor'].skew() - tick_df2['factor'].skew()
