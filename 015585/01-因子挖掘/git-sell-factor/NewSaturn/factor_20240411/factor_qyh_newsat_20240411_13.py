...
class factor_qyh_newsat_20240411_13(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_13"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "活跃与不活跃时买1量的标准差差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = tick_df1['Buy1OrderQty'].std() - tick_df2['Buy1OrderQty'].std()
