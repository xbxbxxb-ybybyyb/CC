...
class factor_qyh_newsat_20240411_11(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_11"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "T-1日尾盘成交量活跃与不活跃时的末尾值差异/T日成交量均值" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            factor_dict = {self.factor_name: res1 / (abs(res)+1)}
