...
class factor_qyh_newsat_20240411_25(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_25"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "买1价对应涨跌幅的均值在上涨/下跌时候的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df1['factor'] =  tick_df1['Buy1Price']/(tick_df1['pre_close'])
        tick_df2['factor'] =  tick_df2['Buy1Price']/(tick_df2['pre_close'])
        if zcz:
