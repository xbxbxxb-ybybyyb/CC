...
class factor_qyh_newsat_20240411_24(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_24"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "卖均差分的均值在上涨/下跌时候的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df1['factor'] = (tick_df1['WeightedAvgOfferPx'] - tick_df1['WeightedAvgOfferPx'].shift(1))/tick_df1['pre_close']
        tick_df2['factor'] = (tick_df2['WeightedAvgOfferPx'] - tick_df2['WeightedAvgOfferPx'].shift(1))/tick_df2['pre_close']
        if zcz:
