...
class factor_qyh_newsat_20240411_19(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_19"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "买1量的变化在活跃/不活跃的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = tick_df1['Buy1OrderQty'].head(1).mean() - tick_df1['Buy1OrderQty'].tail(1).mean() - \
        (tick_df2['Buy1OrderQty'].head(1).mean() - tick_df2['Buy1OrderQty'].tail(1).mean())
