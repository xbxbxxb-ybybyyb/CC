...
class factor_qyh_newsat_20240411_20(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_20"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "净委买金额/tick成交额的峰度在活跃/不活跃的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = tick_df1['factor'].kurt() - tick_df2['factor'].kurt()
