...
class factor_qyh_newsat_20240411_22(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_22"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "买1-买均的变化在活跃/不活跃时间段的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df1['factor'] = (tick_df1['Buy1Price'] - tick_df1['WeightedAvgBidPx'])/(tick_df1['pre_close'])
