...
class factor_qyh_newsat_20240411_21(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240411_21"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "买均-卖均的集中度在活跃/不活跃的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        def f_calc_cct(tick_series):
            if abs(tick_series.sum()) > 0.001:
                ...
                return np.nan
        res = f_calc_cct(tick_df1['factor']) - f_calc_cct(tick_df2['factor'])
