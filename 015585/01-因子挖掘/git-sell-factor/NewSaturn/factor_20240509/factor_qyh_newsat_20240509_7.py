...
class factor_qyh_newsat_20240509_7(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240509_7"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "尾盘买均-卖均离散程度在活跃/不活跃时候的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        # if zcz:
        res = -tick_df1['factor'].max() / tick_df1['factor'].mean() + tick_df2['factor'].max() / tick_df2['factor'].mean()
