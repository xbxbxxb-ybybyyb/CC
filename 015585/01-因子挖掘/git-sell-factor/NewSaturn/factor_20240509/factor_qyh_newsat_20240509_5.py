...
class factor_qyh_newsat_20240509_5(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240509_5"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df1['factor'] = tick_df1['ValueTrade'].cumsum()/tick_df1['VolumeTrade'].cumsum()/tick_df1['LastPx']
        tick_df2 = tick_df[tick_df['LastPx'] < tick_df['LastPx'].shift(1)]
        tick_df2['factor'] = tick_df2['ValueTrade'].cumsum()/tick_df2['VolumeTrade'].cumsum()/tick_df2['LastPx']
        # if zcz:
