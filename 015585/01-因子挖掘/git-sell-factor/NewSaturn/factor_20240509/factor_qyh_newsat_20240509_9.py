...
class factor_qyh_newsat_20240509_9(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240509_9"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "早盘买均-卖均的变化在活跃/不活跃时候的差异" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df = tick_df[tick_df['MDTime'] <= 113000000]
        ...
        res = tick_df2['factor'].std() - tick_df1['factor'].std()
