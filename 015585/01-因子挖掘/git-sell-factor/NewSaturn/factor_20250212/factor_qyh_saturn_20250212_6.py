...
class factor_qyh_saturn_20250212_6(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_saturn_20250212_6"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "前一半撤单中，订单价格和累计vwap的比例的变异系数" # 因子逻辑解释
    zcz_adjusted = "是" # 是否针对注册制调整：是/否
    logic_type = "买单强度-价格波动" # 逻辑类别
    low_cost = "是" # 是否低耗时
    #
    xdb_data = [
        {
