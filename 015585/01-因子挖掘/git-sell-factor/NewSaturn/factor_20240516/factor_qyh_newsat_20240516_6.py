...
class factor_qyh_newsat_20240516_6(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240516_6"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "前1分钟，买1/买均的离散程度" # 因子逻辑解释
    zcz_adjusted = "是" # 是否针对注册制调整：是/否
    logic_type = "总量强度" # 逻辑类别
    low_cost = "是" # 是否低耗时
    #
    t_day_data = []
    xdb_data = [
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        if zcz:
            tick_df['Buy1Price'] = (tick_df['Buy1Price'] / tick_df['pre_close'] - 1) / 2 + 1
            tick_df['WeightedAvgBidPx'] = (tick_df['WeightedAvgBidPx'] / tick_df['pre_close'] - 1) / 2 + 1
