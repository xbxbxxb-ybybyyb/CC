...
class factor_qyh_newsat_20240516_3(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240516_3"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "前5分钟，涨幅*量的std" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df = tick_df.head(100) if len(tick_df) > 100 else tick_df
