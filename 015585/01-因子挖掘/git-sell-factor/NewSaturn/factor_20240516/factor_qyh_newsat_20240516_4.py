...
class factor_qyh_newsat_20240516_4(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_newsat_20240516_4"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "前1min，成交-买均的变异系数" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        tick_df['factor'] = (tick_df['ValueTrade']/(tick_df['VolumeTrade']) - tick_df['WeightedAvgBidPx'])/(tick_df['pre_close'])
        if zcz:
