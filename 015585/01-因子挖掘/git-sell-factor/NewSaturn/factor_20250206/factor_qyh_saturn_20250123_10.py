...
class factor_qyh_saturn_20250123_10(BaseFactor):
    strategy_name = "saturn/sell"
    factor_name = "qyh_saturn_20250123_10"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "价格在9%以下的撤单,订单价格和排除极端订单后vwap的比例均值" # 因子逻辑解释
