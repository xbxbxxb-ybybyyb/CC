import numpy as np
import pandas as pd
factor_name = 'qyh_sat_lztick_20240321_9'#
def factor_qyh_sat_lztick_20240321_9(tick_df, return_fillna_dic=False):
    ...
    #
    tick_df1['factor'] = (tick_df1['buy_amt'])/tick_df1['ValueTrade'].mean()
    tick_df2['factor'] = (tick_df2['buy_amt'])/tick_df2['ValueTrade'].mean()
    #
