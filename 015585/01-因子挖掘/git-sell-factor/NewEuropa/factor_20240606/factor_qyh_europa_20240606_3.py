...
class factor_qyh_europa_20240606_3(BaseFactor):
    strategy_name = "europa"
    factor_name = "qyh_europa_20240606_3"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "挂买且成交订单里，订单金额/(挂卖金额+挂买总额)的和" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df = tick_df[tick_df['OrderType'] == 'b2']
