...
class factor_qyh_europa_20240606_11(BaseFactor):
    strategy_name = "europa"
    factor_name = "qyh_europa_20240606_11"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "挂卖且未成交订单里，挂单价格-当前价格的均值" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df = tick_df[tick_df['OrderType'] == 'o1']
