...
class factor_qyh_europa_20240815_4(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20240815_4"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "挂买未成交订单中，筛选最后20笔大单，订单价格和买均价差异对应涨跌幅的中位数" # 因子逻辑解释
