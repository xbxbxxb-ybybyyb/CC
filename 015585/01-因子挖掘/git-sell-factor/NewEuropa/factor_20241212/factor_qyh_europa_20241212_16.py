...
class factor_qyh_europa_20241212_16(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20241212_16"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "撤单数据中，后一半订单,vwap价格和订单价格比例的min" # 因子逻辑解释
