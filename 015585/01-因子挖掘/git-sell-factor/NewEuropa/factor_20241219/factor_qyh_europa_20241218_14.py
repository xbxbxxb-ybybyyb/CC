...
class factor_qyh_europa_20241218_14(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20241218_14"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "撤单数据中，价格小于9%的订单里，后一半订单的价格和vwap的偏度" # 因子逻辑解释
