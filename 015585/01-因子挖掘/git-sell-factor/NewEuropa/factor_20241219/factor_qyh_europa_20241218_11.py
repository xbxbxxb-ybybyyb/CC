...
class factor_qyh_europa_20241218_11(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20241218_11"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "撤单数据中，价格大于9.5%的订单里，最后500单价格和累计vwap比值的标准差" # 因子逻辑解释
