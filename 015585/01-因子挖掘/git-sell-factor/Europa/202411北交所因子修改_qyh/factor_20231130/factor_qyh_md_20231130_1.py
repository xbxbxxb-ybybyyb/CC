...
s = FactorData()
factor_name = 'qyh_md_20231130_1'
def factor_qyh_md_20231130_1(start_date, end_date, IO, return_fillna_dic=False):
    ...
    #
    df_ori['A'] = df_ori['high'] + df_ori['low']
    df_ori['B'] = df_ori['open'] + df_ori['close']
    df_ori['C'] = df_ori['close'].unstack().rolling(5).mean().stack()
