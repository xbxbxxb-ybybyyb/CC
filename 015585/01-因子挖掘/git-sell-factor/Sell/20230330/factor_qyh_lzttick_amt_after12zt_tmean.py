...
import pandas as pd
#
factor_name = 'qyh_lzttick_amt_after12zt_tmean'#
def factor_qyh_lzttick_amt_after12zt_tmean(tick_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 71889}
