...
factor_list = ['factor_qyh_mercury_test_ttick_1'] # 不能带.py
strategy = 'mercury'
# for i in os.listdir(os.path.join(os.getcwd(), "factor")):
#     if ".py" in i:
#         factor_list.append(i.split(".py")[0])
res, check_res = Runner.run(factor_name_list=factor_list, start_date=20160101, end_date=20201231, strategy=strategy,
