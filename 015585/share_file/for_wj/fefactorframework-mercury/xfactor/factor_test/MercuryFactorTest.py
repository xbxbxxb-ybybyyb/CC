...
class FactorTest:
    def __init__(self, start_date, end_date, segment_number=20,
        ...
        elif self.strategy_name == 'mercury':
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'mercury':
            ...
            sft_basic_path = '/data/user/013550/shared_files/for_qyh/all_factor_dt_label_new_20160101_20211231.h5'# '/data/group/800463/data/project2_public/factor_lib/sft_update_filter_20160101_20191231.h5'
        else:
