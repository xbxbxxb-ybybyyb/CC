...
class strongFactorTest:
    ...
    def load_data(self):
        df = IO.read_data([self.start_date, self.end_date],alt='/dfs/group/800463/data/project1_public/factor_lib_metis/sft_update_metis_filter_20160101_20191231.h5')
