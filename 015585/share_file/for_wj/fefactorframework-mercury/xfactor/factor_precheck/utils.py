...
from xfactor.runner.DataManager import load_data_for_same_check
...
def get_use_data(py_code):
    ...
    data_dic = {'/data/group/800080/warehouse/prod/MD/CHINA_STOCK/DAILY/WIND/MD_CHINA_STOCK_DAILY_WIND.h5': 'MD',
                ...
                '/data/group/800080/warehouse/prod/DATABASE/WIND/AShareST/AShareST.h5': 'AShareST',
                '/data/group/800463/data/generalStrong/concept/': 'concept',
                '/data/group/800080/warehouse/prod/INDEXWEIGHT/CHINA_STOCK/DAILY/CSI/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5': 'INDEXWEIGHT_CHINA_STOCK_DAILY_CSI',
                's.hsi': 'hsi'
...
def get_h5_info_for_value_same_check(kls, start_date, end_date):
    ...
    for data_dict in kls.t_1_factor_data:
        ...
        while break_flag:
            ...
            try:
                start_date_new = \
                    FactorUtil.factor_data.tradingday(start_date, -int(data_dict["lag"] + 1))[0]
                break_flag = False
