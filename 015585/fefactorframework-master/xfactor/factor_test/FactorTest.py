...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'sell':
            sft_basic_path = '/data/group/800463/data/projectS_public/factor_lib_v2/sft_update_filter_20160101_20191231.h5'
        elif self.strategy_name == 'saturn':
            sft_basic_path = '/data/group/800463/data/project2_public/factor_lib/sft_update_filter_20160101_20191231.h5'
        else:
    ...
    def get_factor_information(self):
        ...
        avg_time = round(np.average(self.cost_list),5)
        ...
        factor_information['Factor Info'] = pd.Series({'Factor Name': self.factor_name,
                                                       ...
                                                       'Average Time Cost': avg_time,
                                                       'Max Time Cost': max_time,
                                                       '90 Percentile Time Cost': percent90,
