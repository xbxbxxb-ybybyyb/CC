...
base_path = '/dfs/group/800463/data/xdb_data_lag3/europa_jupiter/xdb_tickfull/'
date_list = list(os.listdir(base_path))
date_list = [i.replace('.pkl','') for i in date_list if i.startswith('201903')]
for i in date_list:
    print(i)
    convert_tick(base_path, i, "/dfs/user/015585/20240226_xdb_binary_test/xdb_tickfull/")
