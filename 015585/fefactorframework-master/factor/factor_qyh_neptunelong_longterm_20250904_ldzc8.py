...
class factor_qyh_neptunelong_longterm_20250904_ldzc8(BaseFactor):
    strategy_name = "neptunelong"
    factor_name = "qyh_neptunelong_longterm_20250904_ldzc8"
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res1 = (df_balancesheet['流动资产diff']).groupby(['dt','Ticker'])\
