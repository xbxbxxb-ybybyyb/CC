...
class factor_qyh_neptune_shortterm_20250717_7(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_shortterm_20250717_7"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "买卖均价与成交价 统计量" # 因子逻辑解释
    zcz_adjusted = "是" # 是否针对注册制调整：是/否
    logic_type = "短周期-挂单价格" # 逻辑类别
    low_cost = "是" # 是否低耗时
    #
    xdb_data = [
        {
