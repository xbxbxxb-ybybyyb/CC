...
class factor_qyh_europa_20241114_1(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20241114_1"
    fill_na_value = 0
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            if bj:
                ...
                res3 = res3/3
                res4 = res4/3
            res1 = tick_df1['factor1'].median() # 405
            res2 = tick_df2['factor2'].median() # 506
            res2 = (res2 - 0.04124)/0.03099
            res3 = (res3 - 0.04187)/0.02284 # 156
            res1 = (res1 - 2453.5268)
            res4 = (res4 + 0.01071) / 0.01945 # 575
            res1 = 0 if not res1 > -1e8 else res1
            res2 = 0 if not res2 > -1e8 else res2
            res3 = 0 if not res3 > -1e8 else res3
            res4 = 0 if not res4 > -1e8 else res4
            res = min(res3 + res2, res4) * res1
