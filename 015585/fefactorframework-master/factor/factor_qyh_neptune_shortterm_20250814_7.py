...
class factor_qyh_neptune_shortterm_20250814_7(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_shortterm_20250814_7"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "1M 卖均相对差距 统计量" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            zcz = database['zcz']
            #
            tick_df['sell_amt'] = (tick_df['Sell1Price'] - tick_df['WeightedAvgOfferPx'])/(tick_df['pre_close'])
