...
class factor_qyh_neptune_20250417_34(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250417_34'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "low/pre的当日max的5日change" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = res.unstack().rolling(5,2).apply(f_calc_change).stack().to_frame()
            # res = res.to_frame()
