...
class factor_qyh_neptune_20250529_10(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_20250529_10"
    fill_na_value = 1
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori[self.factor_name] = df_ori['amt'].unstack().rolling(20,1).apply(f_calc_m2m).stack()
            # -------------------------------------------------------------------------------------------------------------------
