...
class factor_qyh_europa_20240905_2(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20240905_2"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "价格短期上涨时，订单价格大于9%的订单里，订单量占挂买总量比例的和" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df['factor'] = (tick_df['OrderQty'] / (tick_df['TotalBidQty'] + tick_df['OrderQty']))
