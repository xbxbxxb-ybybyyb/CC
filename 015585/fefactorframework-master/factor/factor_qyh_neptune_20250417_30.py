...
class factor_qyh_neptune_20250417_30(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250417_30'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "5分钟high/vwap的max" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = (df_high / df_vwap).max(axis=1)
