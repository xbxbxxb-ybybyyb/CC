...
class factor_qyh_europa_20241218_7(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_europa_20241218_7"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "撤买数据中，最后1min的总撤单金额/当日撤单总额" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            #
            tran_ttl = round_((cancel_df['OrderQty'] * cancel_df['OrderPrice']).sum(),5)
