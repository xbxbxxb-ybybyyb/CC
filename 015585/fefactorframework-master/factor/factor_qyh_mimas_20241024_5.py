...
class factor_qyh_mimas_20241024_5(BaseFactor):
    strategy_name = "mimas"
    factor_name = "qyh_mimas_20241024_5"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "qyh"  # 开发人员姓名
    factor_explain = "中额订单中，订单价格和市价差异的集中度" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df = tick_df[tick_df['LastPx'] > 0.5]
