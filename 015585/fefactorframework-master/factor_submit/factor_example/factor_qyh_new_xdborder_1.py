...
class factor_qyh_new_xdborder_1(BaseFactor):
    strategy_name = "jupiter/europa"
    factor_name = "qyh_new_xdborder_1"
    fill_na_value = 1
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "T-1日基于xdb_order的每日lastpx中位数的均值" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = trade_df.groupby('MDDate')['OrderPrice'].median().mean() # 得到1s计算的均价
