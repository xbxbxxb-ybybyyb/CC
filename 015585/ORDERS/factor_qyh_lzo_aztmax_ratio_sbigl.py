...
import pandas as pd
#
# 逻辑：t-1日涨停挂单峰值以后，新增挂买中大单比例
# score:
#
factor_name = 'qyh_lzo_aztmax_ratio_bsmall'#
def factor_qyh_lzo_aztmax_ratio_bsmall(order_df, return_fillna_dic=False):
    ...
    ratio = order_df_amt[order_df_amt<50000].sum() / order_df_amt.sum()
