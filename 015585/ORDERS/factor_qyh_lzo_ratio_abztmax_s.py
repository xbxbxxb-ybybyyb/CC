...
import pandas as pd
# dtj
# 逻辑：t-1日涨停挂单峰值前后的挂卖比例
# score:-0.06,8
# 无
factor_name = 'qyh_lzo_ratio_abztmax_s'#
def factor_qyh_lzo_ratio_abztmax_s(order_df, return_fillna_dic=False):
    ...
    #
    order_df_azt = order_df[(order_df['min'] > t) & (order_df['OrderBSFlag'] == 2)]
    order_df_bzt = order_df[(order_df['min'] <= t) & (order_df['OrderBSFlag'] == 2)]
