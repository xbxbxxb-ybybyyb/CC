...
# 54，0.075
#
factor_name = 'qyh_torder_20231012_7'#
def factor_qyh_torder_20231012_7(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 1.001}
    import decimal
    def round_(x, n=0):
        if n > 0:
    ...
    res = order_df['OrderIndex'].max() / order_df['OrderIndex'].mean()
    #
