...
import pandas as pd
# NO
# 逻辑：t-1日920以后挂涨停价的总数，衡量样本热度
# score:-0.02，6
# ZT_sell_order_centrality:0.06,10
factor_name = 'qyh_lzo_heat_zt_920'#
def factor_qyh_lzo_heat_zt_920(order_df, return_fillna_dic=False):
    ...
    if len(order_df) > 0:
        ...
        #
        heat = len(order_df[order_df['OrderPrice'] >= p_zt])
    else:
        heat = np.nan
