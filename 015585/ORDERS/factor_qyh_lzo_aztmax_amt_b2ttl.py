...
import pandas as pd
# dtj
# 逻辑：t-1日涨停挂单峰值以后，新增挂买额 / 总挂单
# score:0.048，6:新增挂买越少越高走
# 无
factor_name = 'qyh_lzo_aztmax_amt_b2ttl'#
def factor_qyh_lzo_aztmax_amt_b2ttl(order_df, return_fillna_dic=False):
