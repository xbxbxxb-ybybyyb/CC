...
import pandas as pd
#
# 逻辑：t-1日涨停挂单峰值以后，新增挂卖中大单比例
# score:0.01,5
#
factor_name = 'qyh_lzo_aztmax_ratio_sbig'#
def factor_qyh_lzo_aztmax_ratio_sbig(order_df, return_fillna_dic=False):
    ...
    ratio = order_df_amt[order_df_amt>200000].sum() / order_df_amt.sum()
