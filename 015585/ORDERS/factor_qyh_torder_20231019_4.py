import numpy as np
import pandas as pd
factor_name = 'qyh_torder_20231019_4'#
def factor_qyh_torder_20231019_4(order_df, return_fillna_dic=False):
    ...
    order_df1 = order_df[order_df['OrderPrice'] < p_zt]
    order_df2 = order_df[order_df['OrderPrice'] >= p_zt]
    #
    para=200
    res1 = order_df1.tail(para)['MDTime_delta'].median()
    res2 = order_df2.tail(para)['MDTime_delta'].median()
