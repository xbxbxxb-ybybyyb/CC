...
def prepare_data(trading_days, data_types, base_path, cpus=16, lag=10, back_up_lag=20, strategy = ''):
    ...
    if strategy == 'europa_jupiter':
        basic_dict = {key : basic_dict_all[key] for key in ['jupiter','europa','industry','float_a_share_df','md_df']}
    elif strategy == 'saturn_sell':
        basic_dict = {key: basic_dict_all[key] for key in ['saturn', 'sell', 'industry', 'float_a_share_df', 'md_df']}
    elif strategy == 'metis':
        basic_dict = {key: basic_dict_all[key] for key in ['metis', 'industry', 'float_a_share_df', 'md_df']}
    elif strategy == 'mimas':
        basic_dict = {key: basic_dict_all[key] for key in ['mimas', 'industry', 'float_a_share_df', 'md_df']}
    else:
        raise TypeError
    tasks = []
    for i in data_types:
...
if __name__ == "__main__":
    ...
    strategy_list = ['europa_jupiter','saturn_sell']
