...
import pandas as pd
# dtj
# 逻辑：t-1日,封板前挂涨停的卖单数量,剔除早期
# -0.082,34
# zcz
#
factor_name = 'qyh_lzo_length_bt2_zt_sdel'#
def factor_qyh_lzo_length_bt2_zt_sdel(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 654}
    # zcz
    ...
    t = (order_df['MDTime'].max() + order_df['MDTime'].min())/2
