...
# zcz
# yzhan_hf_ac9_26:71
factor_name = 'qyh_lzo_length_bt1_n98'#
def factor_qyh_lzo_length_bt1_n98(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 9633}
    # zcz
