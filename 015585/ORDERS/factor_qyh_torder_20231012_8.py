...
# 75,0.118
#
factor_name = 'qyh_torder_20231012_8'#
def factor_qyh_torder_20231012_8(order_df, return_fillna_dic=False):
    ...
    res = (order_df1['OrderAmt'].sum() - order_df2['OrderAmt'].sum())/mv
    # res = order_df1['OrderAmt'].sum() / order_df2['OrderAmt'].sum()
    #
