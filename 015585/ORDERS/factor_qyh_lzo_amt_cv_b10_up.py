...
# 逻辑：t-1日,早盘激进订单的变异系数
# 0.06,28
# qyh_lzo_10_amt_sum_b22ttl:49
factor_name = 'qyh_lzo_amt_cv_b10_up'#
def factor_qyh_lzo_amt_cv_b10_up(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0.000272}
