...
import pandas as pd
#
# 逻辑：t-1日,涨停前的激进与非激进订单个数比
# 0.01,3.75
# zcz
#
factor_name = 'qyh_lzo_length_bt1_982n98'#
def factor_qyh_lzo_length_bt1_982n98(order_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: len1/len2 if len2 > 0 else len1}
    # ---------------------------------------------------------------------------------------------------------------
