...
#
#
factor_name = 'qyh_torder_20231012_10'#
def factor_qyh_torder_20231012_10(order_df, return_fillna_dic=False):
    ...
    order_df = order_df.head(500)
    res = order_df['OrderIndex'].std() / order_df['OrderIndex'].mean()
    #
