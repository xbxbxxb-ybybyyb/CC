...
# dtj
# 逻辑：t-1日挂涨停价的卖单的集中度
# score:0.04,9：卖单越集中，力量越强，越低走
# ZT_sell_order_centrality:0.06,10
factor_name = 'qyh_lzo_zto_cct_s'#
def factor_qyh_lzo_zto_cct_s(order_df, return_fillna_dic=False):
    ...
    order_df_zt = order_df[(order_df['OrderPrice'] >= p_zt) & (order_df['OrderBSFlag'] == 2)]['OrderQty']
