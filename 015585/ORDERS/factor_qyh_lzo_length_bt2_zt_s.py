...
# 15,-0.05
# zcz
# ZT_sell_order_centrality:31
# 考虑剔除一些早期挂的
factor_name = 'qyh_lzo_length_bt2_zt_s'#
def factor_qyh_lzo_length_bt2_zt_s(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 1473}
    # zcz
