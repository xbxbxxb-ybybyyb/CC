...
import pandas as pd
#
# 逻辑：t-1日,早盘激进订单中大单个数/标准化价格
#
#
# zcz
factor_name = 'qyh_lzo_num_10_b_98_2p'#
def factor_qyh_lzo_num_10_b_98_2p(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 8}
    ...
    factor_dict = {factor_name: num1/(pre**0.1)}
    # ---------------------------------------------------------------------------------------------------------------
