...
import pandas as pd
#
# 逻辑：t-1日,早盘激进订单中，卖单金额的变异系数
# zcz
# 13,0.045
factor_name = 'qyh_lzo_morn9_amt_cv_s'#
def factor_qyh_lzo_morn9_amt_cv_s(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 2.49}
    # zcz
