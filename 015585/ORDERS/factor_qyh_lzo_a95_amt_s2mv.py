...
import pandas as pd
# NO
# 逻辑：t-1日挂单量稳定以后，挂卖金额 / 流动市值
# score:9,-0.05
# wu
factor_name = 'qyh_lzo_a95_amt_s2mv'#
def factor_qyh_lzo_a95_amt_s2mv(order_df, return_fillna_dic=False):
    ...
    amt = order_df[order_df['OrderBSFlag'] == 2]['OrderAmt'].sum()
    if amt < 10:
        amt = np.nan
    #
