...
def prepare_order_data_new(df, base_date):
    try:
        ...
        df.columns = ['symbol', 'appl_seq_num', 'OrderIndex', 'OrderPrice', 'OrderQty', "MDTime", "order_index",
                      'local_index', "OrderBSFlag", "OrderType", "MDDate", "timestamp",
                      'ff_shares', 'pre_close', 'industry',
                       'HTSCSecurityID', 'Ticker', 'pattern', 'dt']
        ...
        df = df[['MDDate', 'MDTime', 'OrderIndex', 'OrderPrice', 'OrderQty', 'OrderBSFlag', "OrderType",
                 'ff_shares', 'pattern', 'industry',  'pre_close', 'ul_price', 'dl_price']]
...
def prepare_trade_data_new(df, base_date):
    try:
        ...
        df.columns = ['symbol', 'appl_seq_num', 'TradeBuyNo', 'TradeSellNo', 'TradePrice', "TradeQty", "MDTime",
                      "TradeIndex",
                      'local_index', "TradeBSFlag", "MDDate", "timestamp",
                      'ff_shares', 'pre_close', 'industry',  'HTSCSecurityID', 'Ticker', 'pattern',
                      'dt']
        # ed = time.time()
        ...
        df = df[['MDDate', 'MDTime',
                 'TradeIndex', 'TradeBuyNo', 'TradeSellNo', 'TradeType', 'TradeBSFlag', 'TradePrice', 'TradeQty',
                 'TradeMoney', 'ff_shares', 'pattern', 'industry', 'pre_close']]
...
def prepare_tick_data_new(df, base_date, tick_type):
    try:
        ...
        df = df[[
            "MDDate", "MDTime", "NumTrades", "TotalVolumeTrade", "TotalValueTrade", "VolumeTrade", "LastPx",
            'ff_shares', 'pattern', 'industry',  'pre_close', "OpenPx", "HighPx", "LowPx",
            "TotalBidQty",
            "TotalOfferQty", "WeightedAvgBidPx", "WeightedAvgOfferPx", "Buy1Price", "Buy2Price",
            "Buy3Price", "Buy4Price", "Buy5Price", "Buy6Price", "Buy7Price", "Buy8Price", "Buy9Price",
            "Buy10Price", "Buy1OrderQty", "Buy2OrderQty", "Buy3OrderQty", "Buy4OrderQty", "Buy5OrderQty",
...
def prepare_data(trading_days, data_types, base_path, cpus=16, lag=10, back_up_lag=20):
    ...
    lowfrequency_basic = pd.read_hdf('/dfs/user/013550/StrongStock/Basic/Basic/basic_dt_new_20160101_20201231.h5')#'/data/user/013550//shared_files/for_qyh/basic_20150101_20200720.h5')
    ...
    basic_dict = {
        ...
        'lowfrequency': lowfrequency_basic,
        # "saturn": saturn_basic,
        # "sell": sell_basic,
        # "europa": europa_basic,
        # "metis": metis_basic,
...
if __name__ == "__main__":
    ...
    cpus = 6
    lag = 3
    data_types = ["xdb_order",'xdb_trade',"xdb_tick1s",'xdb_tickex']# xdb_tickfull
    data_types = ["xdb_tick1s"]#['xdb_tickex']#
    base_path = "/dfs/group/800463/data/xdb_data_lag3/lowfrequency/"#"/dfs/user/013550/test/"#"/dfs/user/013550/test/"
    print(start_date,end_date)
    print(base_path)
    xquant_factor_data = FactorData()
    start_date = xquant_factor_data.tradingday(start_date, 1)[0]
    real_start_date = xquant_factor_data.tradingday(start_date, -(lag + 50+ 1))[0]
