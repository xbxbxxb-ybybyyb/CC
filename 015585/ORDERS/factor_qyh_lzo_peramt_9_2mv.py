...
# 8,0.04
# zcz
# Circu_Mkt,float_shares
factor_name = 'qyh_lzo_peramt_9_2mv'#
def factor_qyh_lzo_peramt_9_2mv(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0.134}
    # zcz
    ...
    peramt = order_df['OrderAmt'].mean() / mv
