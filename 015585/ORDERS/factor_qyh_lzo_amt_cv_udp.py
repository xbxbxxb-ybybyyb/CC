...
import pandas as pd
#
# 逻辑：t-1日,早盘大单金额的中位数/mv
# 0,0
#
# gg
factor_name = 'qyh_lzo_amt_med_10_b2_2mv'#
def factor_qyh_lzo_amt_med_10_b2_2mv(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 336380}
    ...
    factor_dict = {factor_name: amt1/mv}
    # ---------------------------------------------------------------------------------------------------------------
