...
import pandas as pd
#
# 逻辑：t-1日涨停挂单峰值前后的挂买比例
# score:3.6,-0.03
#
factor_name = 'qyh_lzo_ratio_abztmax_b'#
def factor_qyh_lzo_ratio_abztmax_b(order_df, return_fillna_dic=False):
    ...
    #
    order_df_azt = order_df[(order_df['min'] > t) & (order_df['OrderBSFlag'] == 1)]
    order_df_bzt = order_df[(order_df['min'] <= t) & (order_df['OrderBSFlag'] == 1)]
