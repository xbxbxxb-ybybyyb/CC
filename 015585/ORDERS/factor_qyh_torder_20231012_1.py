...
# 81,0.11
#
factor_name = 'qyh_torder_20231012_1'#
def factor_qyh_torder_20231012_1(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 8.6}
    import decimal
    def round_(x, n=0):
        if n > 0:
    ...
    res = order_df.tail(50)['OrderAmt'].sum() / mv
    #
