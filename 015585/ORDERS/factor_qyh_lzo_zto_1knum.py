...
# score:3，0.028
# 无
factor_name = 'qyh_lzo_zto_1knum'#
def factor_qyh_lzo_zto_1knum(order_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 9926700}
    # 0930以后
    ...
    amt = order_df_zt[order_df_zt>100000].sum()
