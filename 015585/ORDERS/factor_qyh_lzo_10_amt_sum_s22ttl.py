...
import pandas as pd
# dtj
# 逻辑：t-1日,早盘挂单中，小单挂单金额/全天挂单总额
# 17，0.047
factor_name = 'qyh_lzo_10_amt_sum_s22ttl'#
def factor_qyh_lzo_10_amt_sum_s22ttl(order_df, return_fillna_dic=False):
    ...
    ratio = order_df[order_df['OrderAmt'] <= 50000]['OrderAmt'].sum() / ttl
