...
import pandas as pd
# dtj
# 逻辑：t-1日1450以后，挂卖的金额/流动市值
# score:-0.12，15
# wd_lztcs_close_amt_d_max：-0.11
factor_name = 'qyh_lzo_tail7_amt_s2mv'#
def factor_qyh_lzo_tail7_amt_s2mv(order_df, return_fillna_dic=False):
