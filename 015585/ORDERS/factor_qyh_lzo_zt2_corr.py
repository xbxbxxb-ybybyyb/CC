...
import pandas as pd
# dtj
# 逻辑：t-1日集合竞价，涨停与非涨停订单的量价相关性
#
#
factor_name = 'qyh_lzo_zt2_corr'#
def factor_qyh_lzo_zt2_corr(order_df, return_fillna_dic=False):
    ...
    corr2 = order_df1[['OrderQty','OrderPrice']].corr(method = 'spearman').iloc[0,1]
