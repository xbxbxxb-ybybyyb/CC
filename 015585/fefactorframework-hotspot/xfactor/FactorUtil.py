...
def check_xdb_tick_1s_full(factor_class):
    ...
    for data_dict in factor_class.xdb_data:
        if data_dict["name"] == "xdb_tickfull" or data_dict["name"] == "xdb_tick1s" or data_dict['name'] == 'xdb_tickfulladdorder' or data_dict['name'] == 'xdb_cancel':
            return True
...
def check_tday_tick1s_full(factor_class):
    ...
    for data_name in factor_class.t_day_data:
        if data_name in ['TTickfull','TTickfulladdorder','TTick1s','TCancel','TCancelprice',
                         'T1mTickfull','T1mTickfulladdorder','T1mTick1s','T1mCancel','T1mTickfull_cs','T1mTick1s_cs','T1mCancel_cs','T1mTickfulladdorder_cs',
                         'Next1mTickfull','Next1mTickfulladdorder','Next1mTick1s','Next1mCancel','Next1mTickfull_cs','Next1mTickfulladdorder_cs','Next1mTick1s_cs','Next1mCancel_cs',
                         'TTickfull_MetisAll','TTickfulladdorder_MetisAll','TTick1s_MetisAll','TCancel_MetisAll','TCancelprice_MetisAll']:
            return True
    return False
