...
class factor_qyh_hotspot_20250313_38(BaseFactor):
    strategy_name = "hotspot"
    factor_name = "qyh_hotspot_20250313_38"
    fill_na_value = 0
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            tick_df['factor'] = tick_df['ValueTrade'] / (tick_df['ValueTrade'].tail(1)).replace(0, np.nan)
