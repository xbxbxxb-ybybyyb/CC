    ...
    def load_data(self):
        if self.strategy_name == 'europa':
            df = IO.read_data([self.start_date, self.end_date],
                              alt='/data/user/018107/factor_zoo1/factor_lib_v3/sft_update_europa_filter_20160101_20201231.h5')
        elif self.strategy_name =='jupiter':
            df = IO.read_data([self.start_date, self.end_date],
                              alt='/data/user/018107/factor_zoo1/factor_lib_v3/sft_init_jupiter_filter_20160101_20201231.h5')
        else:
