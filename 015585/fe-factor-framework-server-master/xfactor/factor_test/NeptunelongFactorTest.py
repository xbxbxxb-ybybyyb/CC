...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'neptunelong':
            sft_basic_path =  '/data/user/023859/factor_zooZZmkt/factor_lib/sft_update_931_20160101_20201231.pkl'  # 这个文件里有label和所有因子
    ...
    def factor_test(self, factor_df, cost_list, result_path, factor_corr_test=False, generate_pdf=False):
        ...
        if factor_corr_test:
            check_res = pd.read_excel(
                '/data/group/800463/data/projectZZmkt_public/factor_lib/check_res_tot_neptunelong.xlsx')
