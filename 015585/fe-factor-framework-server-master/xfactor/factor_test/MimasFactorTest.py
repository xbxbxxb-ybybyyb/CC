...
class pj2FactorTest:
    ...
    def load_data(self):
        ...
        sft_basic_path = '/data/user/018107/factor_zoo2/next_factor_lib/sft_update_next_filter_20160101_20201231.pkl'
    ...
    def get_factor_information(self):
        ...
        factor_information[' '] = ['Segment Number', 'Buy Type', '', '', '', '', '', '', '']
        factor_information['Settings'] = [self.segment_number, str(self.buy_type), '', '', '', '', '', '', '']
