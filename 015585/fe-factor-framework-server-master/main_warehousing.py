...
strategy_list = ['Saturn'] # 需要入库的策略名称
path_frame_factor = '/data/user/018107/framework/factor/' # 框架的factor文件夹地址
...
for strategy in strategy_list:
    ...
    if len(factor_list) > 0:
        ...
        Runner.run(factor_name_list=factor_list, start_date=20160101, end_date=20211231,
