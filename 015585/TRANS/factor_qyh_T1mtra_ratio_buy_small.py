...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，主动买入的小单金额占比
# 20,7,0.05
# wd_t1_big_bid_vol_pct
# pj2r_931_Trick_buy_10
# wd_t1_dv_small_pct
factor_name = 'qyh_T1mtra_ratio_buy_small'
def factor_qyh_T1mtra_ratio_buy_small(transaction_df, return_fillna_dic=False):
