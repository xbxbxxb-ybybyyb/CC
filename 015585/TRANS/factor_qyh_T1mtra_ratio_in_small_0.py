...
import numpy as np
import pandas as pd
# 逻辑：T日集合竞价，流入部分50000以下小单金额占比
# score:GG
factor_name = 'qyh_T1mtra_ratio_in_small_0'
def factor_qyh_T1mtra_ratio_in_small_0(transaction_df, return_fillna_dic=False):
    ...
    transaction_df = transaction_df[transaction_df['TradeBSFlag'] == 0]# 集合竞价
    limit = 50000
    # buy
