...
# score: 48,0.076
# Institute_earn:
# sss_finalbuy_amtp_max
factor_name = 'qyh_T1mtra_amt_ratio_p95'#concenteration,qyh_T1mtra_buy_cct
def factor_qyh_T1mtra_amt_ratio_p95(transaction_df, return_fillna_dic=False):
    ...
    amt_p9 = transaction_df[transaction_df['TradePrice'] >= pre_close*1.095]['TradeMoney'].sum()
