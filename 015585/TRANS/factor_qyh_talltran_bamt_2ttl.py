...
# 大买单总额占总成交额的比例
# 3,-0.01
def factor_qyh_talltran_bamt_2ttl(transaction_df, return_fillna_dic=False):
    factor_name = 'qyh_talltran_bamt_2ttl'
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 0.32}
    ...
    factor = buy_big.sum() / transaction_df['TradeMoney'].sum()
