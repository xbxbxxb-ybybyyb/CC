...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，主动卖出非小单金额占比
# 11,7,-0.04
factor_name = 'qyh_T1mtra_ratio_sell_nsmall'
def factor_qyh_T1mtra_ratio_sell_nsmall(transaction_df, return_fillna_dic=False):
