...
import pandas as pd
# 已提交
# 逻辑：买单集中度：买单的平方和 / 总平方和（>0)
# 9，3，-0.01
factor_name = 'qyh_T1mtra_cct_in'#concenteration,qyh_T1mtra_buy_cct
def factor_qyh_T1mtra_cct_in(transaction_df, return_fillna_dic=False):
    ...
    if abs(total_buy) <= 1:
        ...
        buy_cct = (tm_buy ** 2).sum() / total_buy**2
