...
import pandas as pd
#
# 逻辑：(大买单 + 小卖单 - 大卖单 - 小买单) / 流动市值
# score:0.116，69
# 无
factor_name = 'qyh_TTra_ratio_combo_b2s_std'#concenteration,qyh_T1mtra_buy_cct
def factor_qyh_TTra_ratio_combo_b2s_std(transaction_df, return_fillna_dic=False):
    ...
    ratio = (tm_buy[tm_buy>200000].sum() + tm_sell[tm_sell<50000].sum() - tm_sell[tm_sell>200000].sum() - tm_buy[tm_buy<50000].sum())/mv
