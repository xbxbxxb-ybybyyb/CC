...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，买卖双方力量对比(包括集合竞价）,聚合transaction数据，得到买卖双方5万以下的小单总额。再相除
# score:15,6,0.02
factor_name = 'qyh_T1mtra_power_inout_smalltotal_1'
def factor_qyh_T1mtra_power_inout_smalltotal_1(transaction_df, return_fillna_dic=False):
    ...
    if abs(sell_no_small) <= 0.001:
        ...
        power = buy_no_small / sell_no_small
