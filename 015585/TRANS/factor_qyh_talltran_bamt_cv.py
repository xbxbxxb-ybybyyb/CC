...
def factor_qyh_talltran_bamt_cv(transaction_df, return_fillna_dic=False):
    factor_name = 'qyh_talltran_bamt_cv'
    ...
    cv = buy_big.std() / abs(buy_big.mean()) if abs(buy_big.mean()) > 0 else np.nan
