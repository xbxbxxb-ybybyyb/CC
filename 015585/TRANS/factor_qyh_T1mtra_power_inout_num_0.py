...
# score:GG
factor_name = 'qyh_T1mtra_power_inout_num_0'
def factor_qyh_T1mtra_power_inout_num_0(transaction_df, return_fillna_dic=False):
    ...
    transaction_df = transaction_df[transaction_df['TradeBSFlag'] == 0]# 集合竞价以内
