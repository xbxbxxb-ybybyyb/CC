...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据,买单平均每单（非每笔）金额的标准差(除以均值）,衡量投资者的复杂程度
# score:-0.039,12,4
factor_name = 'qyh_T1mtra_amtpertra_in_s_1'
def factor_qyh_T1mtra_amtpertra_in_s_1(transaction_df, return_fillna_dic=False):
