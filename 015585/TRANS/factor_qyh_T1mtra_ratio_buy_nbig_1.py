...
# 逻辑：T日09:31数据，主动买入的非大单金额占比，总体选择主买部分
# 0.01
factor_name = 'qyh_T1mtra_ratio_buy_nbig_1'
def factor_qyh_T1mtra_ratio_buy_nbig_1(transaction_df, return_fillna_dic=False):
