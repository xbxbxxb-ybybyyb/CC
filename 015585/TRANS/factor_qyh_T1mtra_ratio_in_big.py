...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据 + 集合竞价，流入部分大单金额占比
# score:7,2,-0.02
factor_name = 'qyh_T1mtra_ratio_in_big'
def factor_qyh_T1mtra_ratio_in_big(transaction_df, return_fillna_dic=False):
