...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，买卖双方力量对比(包括集合竞价）,聚合transaction数据，得到买卖双方20万以上的大单总额。再相除
# score:-0.03,12,4
factor_name = 'qyh_T1mtra_power_inout_bigtotal'
def factor_qyh_T1mtra_power_inout_bigtotal(transaction_df, return_fillna_dic=False):
