...
# 大卖单的集中度
# 0
def factor_qyh_talltran_samt_cct(transaction_df, return_fillna_dic=False):
    factor_name = 'qyh_talltran_samt_cct'
    ...
    cct = (sell_big**2).sum() / (sell_big.sum()**2) if sell_big.sum()>0 else 0
