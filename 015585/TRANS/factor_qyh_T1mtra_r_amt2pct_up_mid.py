...
factor_name = 'qyh_T1mtra_r_amt2pct_up_mid'#
def factor_qyh_T1mtra_r_amt2pct_up_mid(transaction_df, return_fillna_dic=False):
    ...
    transaction_df_up_big = transaction_df_up_big[transaction_df_up_big <= 200000]
