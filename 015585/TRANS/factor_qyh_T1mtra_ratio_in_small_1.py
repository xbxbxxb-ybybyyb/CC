...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据(不包括集合竞价)，流入部分50000以下小单金额占比
# score:14,3,0.03
factor_name = 'qyh_T1mtra_ratio_in_small_1'
def factor_qyh_T1mtra_ratio_in_small_1(transaction_df, return_fillna_dic=False):
