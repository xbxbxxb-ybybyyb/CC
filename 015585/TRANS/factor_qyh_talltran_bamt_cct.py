...
# 大买单的集中度
# 2.7,-0.008
def factor_qyh_talltran_bamt_cct(transaction_df, return_fillna_dic=False):
    factor_name = 'qyh_talltran_bamt_cct'
    ...
    cct = (buy_big**2).sum() / (buy_big.sum()**2) if buy_big.sum()>0 else 0
