...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，主动卖出小单金额占比
# 10,6,-0.03
factor_name = 'qyh_T1mtra_ratio_sell_small'
def factor_qyh_T1mtra_ratio_sell_small(transaction_df, return_fillna_dic=False):
