...
def get_trigger(index):
    ...
    try:
        ...
        if zcz:
            trigger_time = tick_df[(tick_df['trigger1']==True) & (tick_df['MDTime'] >= 93200000) & (tick_df['LastPx'] >= pre_close*0.94)]['MDTime'].min()
        else:
        ...
        return
factor_df_list = Parallel(n_jobs=15)(delayed(get_trigger)(index) for index in sample.index)
...
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file_saturn/test_trigger5_3_1_2.pkl')
