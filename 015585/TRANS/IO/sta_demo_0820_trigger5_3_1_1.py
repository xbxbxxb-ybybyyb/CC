...
def get_trigger(index):
    ...
    try:
        ...
        if zcz:
            trigger_time = tick_df[(tick_df['trigger1']==True) & (tick_df['MDTime'] >= 93200000) & (tick_df['LastPx'] >= pre_close*0.9)]['MDTime'].min()
        else:
...
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger5_3_1_1.pkl')
