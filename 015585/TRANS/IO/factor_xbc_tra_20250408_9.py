...
class factor_xbc_tra_20250408_9(BaseFactor):
    strategy_name = "hotspot"
    factor_name = "xbc_tra_20250408_9"
    fill_na_value = 0.4
    need_pre_calculate_T_N = False
    owner = "xbc"  # 开发人员姓名
    factor_explain = "factor_xbc_up_down_ratio_diff_abs.py" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            if transaction_df.shape[0] > 0:
                ...
                bar_time = fun_get_time(final_time, -300)
