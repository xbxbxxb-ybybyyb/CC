...
def get_trigger(index):
    ...
    try:
        ...
        ## trigger 5 RSI首次低于20 + 价格突破
        '''
        '''
        tick_df['trigger1'] = (tick_df['rsi_real'] < 0.2) * (tick_df['LastPx'] > tick_df['LastPx'].rolling(5,1).mean())
...
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger6_1_4.pkl')
