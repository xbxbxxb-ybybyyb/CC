...
def get_trigger(index):
    ...
    try:
        ...
        ## trigger 5 RSI首次重新回到20（相对于一分钟以前）
        '''
        '''
        tick_df['trigger1'] = (tick_df['rsi_real'] > 0.1)  * (tick_df['rsi_real'].shift(20) < 0.1)
        if zcz:
...
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file/test_trigger6_2_3.pkl')
