...
def get_trigger(index):
    ...
    try:
        ...
        if rcleanb >= -0.17 and price931 > (pre_close * 0.94) and buy_amt931 > 1 and sell_amt931 > 1 and zcz:
            ...
            tick_df['new_min1'] = (tick_df['LastPx_new'] <= tick_df['LastPx_new_cummin'])# portfolio6 只取最近1h价格作为背离条件之一
...
print(error_list)
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file_p4/test_trigger_p4_portfolio6_1.pkl')
