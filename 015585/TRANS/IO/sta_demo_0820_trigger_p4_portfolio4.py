...
'''
1、931判断，最新总挂买>总挂卖， 且 最新涨跌幅 >= -3%，则931买入
...
def get_trigger(index):
    ...
    try:
        ...
        if buy_amt931 >= sell_amt931 and price931 > (pre_close * 0.94) and buy_amt931 > 1 and sell_amt931 > 1 and zcz:
            trigger_time = 93100000
        elif buy_amt931 >= sell_amt931 and price931 > (pre_close * 0.97) and buy_amt931 > 1 and sell_amt931 > 1 and (not zcz):
            trigger_time = 93100000
        else:
            def cumstd(series):
        ...
        return
factor_df_list = Parallel(n_jobs=32)(delayed(get_trigger)(index) for index in sample.index)
...
sample.to_pickle('/data/user/015585/01-因子挖掘/20240812-Ceres新增买入时点/file_p4/test_trigger_p4_portfolio4.pkl')
