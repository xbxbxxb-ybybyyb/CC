...
class factor_xbc_tra_20250408_11(BaseFactor):
    strategy_name = "hotspot"
    factor_name = "xbc_tra_20250408_11"
    fill_na_value = 21
    need_pre_calculate_T_N = False
    owner = "xbc"  # 开发人员姓名
    factor_explain = "factor_xbc_exchange_ratio_diff_std.py" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            up_ratios = [i/1000 for i in range(10,100,1)]
            if is_zcz:
