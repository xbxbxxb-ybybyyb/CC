...
class factor_xbc_tra_20250408_26(BaseFactor):
    strategy_name = "hotspot"
    factor_name = "xbc_tra_20250408_26"
    fill_na_value =  219
    need_pre_calculate_T_N = False
    owner = "xbc"  # 开发人员姓名
    factor_explain = "factor_xbc_20231019_7.py" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            if transaction_df.shape[0] > 10:
                ...
                value = transaction_df_near['dir_money'].sum()/transaction_df_near['dir_money'].abs().mean()
            else:
                value = nan_value
