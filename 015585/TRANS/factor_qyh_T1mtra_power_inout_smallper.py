...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，买卖双方力量对比(包括集合竞价）,聚合transaction数据，得到买卖双方5万以下的小单每单金额。再相除
# score:15,6,-0.04
factor_name = 'qyh_T1mtra_power_inout_smallper'
def factor_qyh_T1mtra_power_inout_smallper(transaction_df, return_fillna_dic=False):
