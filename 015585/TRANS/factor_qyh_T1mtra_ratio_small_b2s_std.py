...
# 逻辑：(小买单 - 小卖单) / 流动市值
# score:64,-0.119
factor_name = 'qyh_T1mtra_ratio_small_b2s_std'#concenteration,qyh_T1mtra_buy_cct
def factor_qyh_T1mtra_ratio_small_b2s_std(transaction_df, return_fillna_dic=False):
