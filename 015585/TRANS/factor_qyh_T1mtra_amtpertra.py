...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，单笔成交额（包括集合竞价，但不包括委托撤单）
# score:GG
factor_name = 'qyh_T1mtra_amtpertra'
def factor_qyh_T1mtra_amtpertra(transaction_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: amtpertra}
    # ---------------------------------------------------------------------------------------------------------------
