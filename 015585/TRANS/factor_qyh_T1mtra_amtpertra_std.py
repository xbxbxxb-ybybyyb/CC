...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据，标准化单笔成交额（包括集合竞价，但不包括委托撤单）:除以T-1自由流通市值
# score:13,4,-0.04
factor_name = 'qyh_T1mtra_amtpertra_std'
def factor_qyh_T1mtra_amtpertra_std(transaction_df, return_fillna_dic=False):
