...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据 + 集合竞价，(流入部分小单 且 流出部分大单)金额占比
# score:6,1,0.02
factor_name = 'qyh_T1mtra_ratio_in_small_out_big'#del big out
def factor_qyh_T1mtra_ratio_in_small_out_big(transaction_df, return_fillna_dic=False):
