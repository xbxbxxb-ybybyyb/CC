...
# 逻辑：买单和卖单的托单程度综合>0
# score:8，6，0.1
# pj2_max_order_qty_zb：2
factor_name = 'qyh_T1mtra_r_bs_hold_1'
def factor_qyh_T1mtra_r_bs_hold_1(transaction_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: -0.276}
    ...
    ret_2 = power_2.sum() / pre
    sell_hold = ret_2 - ret_1

    factor_dict = {factor_name: (buy_hold - sell_hold) * 100000/mv}
