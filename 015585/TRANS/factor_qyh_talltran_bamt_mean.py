...
def factor_qyh_talltran_bamt_mean(transaction_df, return_fillna_dic=False):
    factor_name = 'qyh_talltran_bamt_mean'
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: 443809}
