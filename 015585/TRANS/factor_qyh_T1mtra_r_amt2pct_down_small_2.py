...
# score:3,-0.02
# 0
factor_name = 'qyh_T1mtra_r_amt2pct_down_small_2'#
def factor_qyh_T1mtra_r_amt2pct_down_small_2(transaction_df, return_fillna_dic=False):
    ...
    transaction_df_down_big = transaction_df_down_big[transaction_df_down_big < 50000]# 大单
    ...
    phead = transaction_df_down.groupby('TradeSellNo')['TradePrice'].max()
