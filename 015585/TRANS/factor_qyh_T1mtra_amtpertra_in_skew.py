...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据(包括集合竞价）,买单平均每单（非每笔）金额的偏度,衡量投资者的厚尾程度，即偏向一类投资者的程度(理论上右偏比较好）
# score:GG
#
factor_name = 'qyh_T1mtra_amtpertra_in_skew'
def factor_qyh_T1mtra_amtpertra_in_skew(transaction_df, return_fillna_dic=False):
