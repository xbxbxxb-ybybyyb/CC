...
import numpy as np
import pandas as pd
# 逻辑：T日09:31数据(包括集合竞价）,卖单平均每单（非每笔）金额
# score:
#
factor_name = 'qyh_T1mtra_amtpertra_out'
def factor_qyh_T1mtra_amtpertra_out(transaction_df, return_fillna_dic=False):
