...
import numpy as np
import pandas as pd
factor_name = 'qyh_T1mtra_r_amt2pct_down_small_1'#
def factor_qyh_T1mtra_r_amt2pct_down_small_1(transaction_df, return_fillna_dic=False):
    if return_fillna_dic:
        # 返回因子为nan时的填充值
        return {factor_name: -0.44}
    ...
    transaction_df_down_big = transaction_df_down_big[transaction_df_down_big < 50000]#
