...
import pandas as pd
# 0216待提交
# 逻辑：每个主动买单的金额/拉升幅度（基于上一单价格） - 每个主动卖单的金额/拉升幅度，金额都取ln
# 5，3，-0.02
factor_name = 'qyh_T1mtra_r_amt2pct_ud_ln'#
def factor_qyh_T1mtra_r_amt2pct_ud_ln(transaction_df, return_fillna_dic=False):
    ...
    factor_dict = {factor_name: power_1 - power_2}
