...
for ticker in ['IC.CFE', 'IF.CFE','IM.CFE']:
    suffix_dict = {'IC.CFE':'zz500','IF.CFE':'hs300','IM.CFE':'zz1000'}
    startdate,enddate = 20220818, 20220819
    if startdate == enddate:
        print(ticker, ' startdate == enddate, data already exists!')

    paralist = get_target_list(ticker,startdate,enddate)

    rootpath = '/data/user/015626/data/share/LOCAL_DATA/CSV/MINUTE/CHINA_STOCK/tick_transaction_order_tominute_v4/'
