...
save_path = '/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/%s_IF_prod/' % kind

factor_path = '/data/user/015626/data/share/LOCAL_DATA/Mobius/IM_factors_fromICIFprod/IF_prod_IM/'
