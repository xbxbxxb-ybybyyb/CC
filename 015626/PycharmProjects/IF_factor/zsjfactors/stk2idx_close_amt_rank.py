...
class stk2idx_close_amt_rank(FactorGeneratorComplex):
    def __init__(self):
        super(stk2idx_close_amt_rank, self).__init__(required_columns=['close_zz500', 'amount_zz500'],
                                                     lookback_bars=2000)
    ...
    def on_bar(self, data):
        ...
        ts_pct_win = 2400
        min_pct = 0.9
        stk2idx_close_amt_rank = calc_ma_helper(stk2idx_close_amt_rank_raw,ma_win,ts_pct_win,min_pct)

        factor = stk2idx_close_amt_rank.to_frame()
