...
class _Function(object):
    ...
    def __init__(self, function, name, arity, need_const):
...
def make_function(function, name, arity, need_const=False):
    ...
    if not isinstance(function, np.ufunc):
        if need_const:
            temp_arity = arity + 1
            if six.get_function_code(function).co_argcount != temp_arity:
    ...
    return _Function(function, name, arity, need_const)
...
ts_sum2 = make_function(function=_ts_sum, name='ts_sum', arity=1, need_const=True)
