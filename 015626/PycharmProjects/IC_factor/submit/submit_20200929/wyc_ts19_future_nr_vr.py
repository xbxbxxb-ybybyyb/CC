...
class wyc_ts19_future_nr_vr(FactorGeneratorComplex):

    def __init__(self):
        suffix = '_zz500'
        required_columns=['close' + suffix,'low' + suffix,'high' + suffix,'volume' + suffix,'stk_volatility' + suffix]
        lookback_bars=2000
        super(wyc_ts19_future_nr_vr, self).__init__(
