...
import pandas as pd
import numpy as np
class wyc_ts22_spot(FactorGenerator):
    def __init__(self):
        required_columns=['close_spot']
        lookback_bars=2000
        super(wyc_ts22_spot, self).__init__(
    ...
    def on_bar(self, df):
        ...
        N2 = 8
        N3 = 8
        Rn1 = (df.close_spot - delay(df.close_spot, N1)) / delay(df.close_spot, N1) * 100
        Rn2 = (df.close_spot - delay(df.close_spot, N2)) / delay(df.close_spot, N2) * 100
