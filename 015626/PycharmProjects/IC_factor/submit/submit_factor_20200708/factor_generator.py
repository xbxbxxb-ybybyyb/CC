...
class FactorGenerator:
    ...
    def prepare_hot_data(obj):
        ...
        data4 = IO.read_data([obj.start_time, obj.end_time], alt=os.path.join(obj.data_root_path, obj.ic_data))
    ...
    def __callback__(self):
        ...
        if len(df.dropna(axis = 0)) == 0:
            print(columnname,'*************')
        df.to_hdf('/data/user/015626/data/share/factor/1min/minute_factor_20200722/' + columnname +'.h5', key = columnname)
        return df
