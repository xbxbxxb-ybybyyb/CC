...
class stk2idx_maxret_diff_chg_zsj(FactorGeneratorComplex):
    def __init__(self):
        super(stk2idx_maxret_diff_chg_zsj, self).__init__(required_columns=['close_zz500', 'amount_zz500'],
                                                     lookback_bars=2000)
    ...
    def on_bar(self, data):
        ...
        stk2idx_maxret_diff_std_raw = stk_maxret_diff.std(axis=1)
