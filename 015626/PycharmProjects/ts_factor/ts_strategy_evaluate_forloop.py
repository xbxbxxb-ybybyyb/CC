...
def evaluate(signal_df, ticker, price_kind='vwap', long_in=0.5, long_out=0.5, short_in=-100, short_out=-0.5,
...
def strategy_evaluate(pnl, trade):
    ...
    # ===计算累积净值
    results.loc[0, '累积净值'] = round(pnl['equity_curve'].iloc[-1], 2)
