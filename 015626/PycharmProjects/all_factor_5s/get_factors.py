...
if __name__ == '__main__':
    FactorGenerator(required_columns=['open', 'high', 'low', 'close', 'volume', 'amount', 'position', 'vwap', 'share','open_spot', 'high_spot', 'low_spot', 'close_spot', 'volume_spot', 'amt_spot'],lookback_bars=50000000000).prepare_hot_data()
