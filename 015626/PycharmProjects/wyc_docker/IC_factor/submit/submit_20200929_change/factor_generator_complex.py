...
class FactorGeneratorComplex:
    ...
    def __init__(self, factor_name='test', lookback_bars=5000, required_columns=None,
                 savepath='/data/user/015626/data/share/factor/1min/IC_factors/submit_test_20200929_tsrank'):
    ...
    def prepare_hot_data(inst, start_date, end_date):
        ...
        data_dict = pd.read_pickle(os.path.join(data_path, 'IC_cfg_data_insample.pkl'))
