...
class FactorGeneratorComplex:
    ...
    def __init__(self, factor_name='test', lookback_bars=5000, required_columns=None,
                 savepath='/data/user/015626/data/share/factor/1min/IC_factors/hfcfg_test_20201024'):
    ...
    def prepare_hot_data(inst, start_date, end_date):
        data_dict = {}
        data_path = '/data/user/015626/data/share/MD/CHINA_FUTURES/MINUTE/cfg_hf_data/'
