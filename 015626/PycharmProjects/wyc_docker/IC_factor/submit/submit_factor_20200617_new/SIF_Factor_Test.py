...
class SIF_Factor_Test:
    def __init__(self, df, factor_name, layers = 4, threshold = 0.5, ticker = 'IC.CFE',signal_lims=(-1, 1), save_image = True, show_image = True,starttime = 20160101, endtime = 20220101, savepath = '/data/user/015626/data/share/factor/factor_test/'):
    ...
    def draw_result(self):
        ...
        plt.text(0.6,0.7,'rp_per_deal: ' + str(rp_per_deal),fontsize=14)
        plt.text(0.6,0.6,'rp_per_deal_long: ' + str(rp_per_deal_long),fontsize=14)
        plt.text(0.6,0.5,'rp_per_deal_short: ' + str(rp_per_deal_short),fontsize=14)
