...
class FactorGenerator:
	...
	def __init__(self, factor_name = 'test', lookback_bars = 5000, required_columns = None,
				 savepath = '/data/user/015626/data/share/factor/1min/IC_factors/tick_to_minute_wind_00_20200907'):
	...
	def __callback__(self, start_date, end_date):
		savepath = os.path.join(self.savepath, 'IC_prod_00')
