...
class stk2idx_ret_ch_corr_zsj(FactorGeneratorComplex):
    def __init__(self):
        super(stk2idx_ret_ch_corr_zsj, self).__init__(required_columns=['close_zz500', 'amount_zz500', 'high_zz500'],
                                                     lookback_bars=2000)
    ...
    def on_bar(self, data):
        ...
        ret_close_high_corr_raw = stk_ret_close.corrwith(stk_ret_high,axis=1)
        ma_win = 30
        ts_pct_win = 1200
        min_pct = 0.9
