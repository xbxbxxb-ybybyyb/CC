...
class stk2idx_ret_range_corr_zsj(FactorGeneratorComplex):
    def __init__(self):
        super(stk2idx_ret_range_corr_zsj, self).__init__(required_columns=['close_zz500', 'amount_zz500', 'high_zz500', 'low_zz500'],
                                                     lookback_bars=2000)
    ...
    def on_bar(self, data):
        ...
        stk_ret = stk_close/stk_close.shift(1) - 1
        ret_range_corr_raw = stk_ret.corrwith(stk_ret_range,axis=1)
