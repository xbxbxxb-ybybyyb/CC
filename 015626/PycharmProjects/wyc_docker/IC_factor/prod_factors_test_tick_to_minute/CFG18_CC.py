# -*- coding: utf-8 -*-
"""
Created on Mon Aug 17 19:05:14 2020
...
class CFG18_CC(FactorGeneratorComplex):
    def __init__(self):
        required_columns=['high_zz500', 'close_zz500', 'weight_zz500']
    ...
    def on_bar(self, df):
        ...
        htemp = self.normalization(htemp.to_frame().rolling(45, min_periods = 15).mean(), 242*4)
        #a2 = pd.DataFrame(a2)
