...
class DataCenter(object):
    ...
    def load_index_data(self, index_code):
        ...
        self.__index_data_dict[index_code] = IO.read_data([self.__start_date,self.__end_date+'235959'],alt='{}/{}.h5'.format(self.__minute_index_path,index_code))
    ...
    def load_data(self):
        ...
        if self.__data_dict.get('Other_Variety') is not None:
            ...
            for k,v in other_variety_dict.items():
                df_temp_variety = self.__future_data_dict[i][v]
