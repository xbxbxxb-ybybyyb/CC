...
class RolTrendLS_CC(FactorGenerator):
    def __init__(self):

        required_columns =['close', 'low', 'high']

        super(RolTrendLS_CC, self).__init__(
    ...
    def on_bar(self, data):
        ...
        ll = (data['close'] - data['low'].rolling(60, min_periods = 15).min())/(data['high'].rolling(60, min_periods = 15).max() - data['low'].rolling(60, min_periods = 15).min())
