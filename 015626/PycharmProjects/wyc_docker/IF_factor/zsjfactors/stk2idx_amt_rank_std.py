...
class stk2idx_amt_rank_std(FactorGeneratorComplex):
    def __init__(self):
        super(stk2idx_amt_rank_std, self).__init__(required_columns=['close_zz500', 'amount_zz500'],
                                                     lookback_bars=2000)
    ...
    def on_bar(self, data):
        ...
        ts_pct_win = 2400
        min_pct = 0.9
        stk2idx_amt_rank_std = calc_std_helper(stk2idx_amt_rank_raw,std_win,ts_pct_win,min_pct)

        factor = stk2idx_amt_rank_std.to_frame()
