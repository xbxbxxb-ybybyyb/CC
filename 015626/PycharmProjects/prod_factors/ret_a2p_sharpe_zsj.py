...
class ret_a2p_sharpe_zsj(FactorGeneratorComplex):
    ...
    def on_bar(self, data):
        ...
        ret_active_sharpe_raw = ret_active_raw.rolling(roll_win, min_win).mean() / ret_active_raw.rolling(roll_win,min_win).std()
        ret_inactive_sharpe_raw = ret_inactive_raw.rolling(roll_win, min_win).mean() / ret_inactive_raw.rolling(roll_win, min_win).std()
