...
class LminLmean_nr_cv_CFG_CC_IF_IM(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 6
    data_dict = dict()
    data_dict['Stock'] = ['close', 'low', 'stk_index_corr_zz1000', 'adjfactor']
    normalize_size = 720
    ...
    def calculate(self, data):
        ...
        stk_index_corr_hs300 = data['stk_index_corr_zz1000'].values[-1275:]
