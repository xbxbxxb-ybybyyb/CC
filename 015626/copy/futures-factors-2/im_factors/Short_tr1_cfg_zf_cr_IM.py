...
class Short_tr1_cfg_zf_cr_IM(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 2
    data_dict = dict()
    data_dict['Stock'] = ['close', 'high', 'low', 'stk_index_corr_zz1000', 'adjfactor']
    normalize_size = 1210
    ...
    def calculate(self, data):
        ...
        stk_index_corr_zz500 = data['stk_index_corr_zz1000'].values[-362:]
