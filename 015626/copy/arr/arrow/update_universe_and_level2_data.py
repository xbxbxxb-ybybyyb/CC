...
def update_level2_data_for_universe(date, download_t_1_data = False, download_t_data = False, force_override = False, kind = 'history', use_thirdparty = True):
    ...
    if download_t_1_data:
        ...
        xquant_data.retrieve_level2_by_h5(_univ_preday, data_root, 'Stock', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ_preday, data_root, 'Transaction', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ_preday, data_root, 'Order', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ_preday, data_root, 'Order_RAW', 24, force_override = force_override, use_thirdparty = use_thirdparty)
    ...
    if download_t_data:
        ...
        xquant_data.retrieve_level2_by_h5(_univ, save_path, 'Stock', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ, save_path, 'Transaction', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ, save_path, 'Order', 24, force_override = force_override, use_thirdparty = use_thirdparty)
        xquant_data.retrieve_level2_by_h5(_univ, save_path, 'Order_RAW', 24, force_override = force_override, use_thirdparty = use_thirdparty)
