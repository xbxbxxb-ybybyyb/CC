...
class wsc_hf5(FactorGeneratorComplex):
    def __init__(self):
        super(wsc_hf5, self).__init__(required_columns=['BidP0_500', 'close_500', 'weight_500'],
                                      lookback_bars=2000)

    def on_bar(self, data):
        # factor_logic: first bid-ask apread, then weight sum
        bidp0 = data['BidP0_500']
        close_500 = data['close_500']
        weight_500 = data['weight_500']
        price_spread = bidp0 - close_500
