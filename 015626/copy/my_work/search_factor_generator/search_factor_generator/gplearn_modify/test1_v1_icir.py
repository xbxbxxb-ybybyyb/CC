...
from gplearn_modify.fitness import information_coefficient, sharpe_ratio, r_square, segmented_information_coefficient, icir
...
factor_save_path = os.path.join('/data/user/017024/data/IC_factors/gp_factors_wsc',
                                start_date + '-' + end_date_outsample, 'icir')
...
if __name__ == '__main__':
    ...
    gp1 = SymbolicTransformer(population_size=6000, hall_of_fame=100, n_components=20, generations=20,
                              tournament_size=3, stopping_criteria=250, const_range=None, const_params_range=(3, 121),
                              init_depth=(1, 4), init_method='half and half', function_set=function_set,
                              metric=icir, parsimony_coefficient=0.0005, p_crossover=0.87, p_subtree_mutation=0.02,
                              ...
                              verbose=1, random_state=106, factor_save_path=factor_save_path, time_now=time_now, rolling_window=1200)
    ...
    gp2 = SymbolicTransformer(population_size=30, hall_of_fame=6, n_components=3, generations=3, tournament_size=3,
                              ...
                              init_method='half and half', function_set=function_set, metric=icir,
