...
factor_save_path = os.path.join(factor_save_path_raw, str(datetime_now))
...
if __name__ == '__main__':
    ...
    gp1 = SymbolicTransformer(population_size=50, hall_of_fame=10, n_components=5, generations=3,
                              ...
                              metric=fitness3, parsimony_coefficient=0.01, p_crossover=0.87, p_subtree_mutation=0.02,
