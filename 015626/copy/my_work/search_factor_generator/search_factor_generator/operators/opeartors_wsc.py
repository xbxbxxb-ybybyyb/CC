...
from utils_wsc.help_functions import rolling_window, replace_zero


__all__ = ['inverse', 'log', 'rolling_norm', 'sqrt', 'ts_argmax', 'ts_argmin', 'ts_corr', 'ts_cov', 'ts_decay_linear',
           'ts_delay', 'ts_delta', 'ts_ema_span', 'ts_max', 'ts_mean', 'ts_median', 'ts_min', 'ts_pct_change',
           'ts_pred', 'ts_pred_delta', 'ts_rank', 'ts_reg_alpha', 'ts_reg_beta', 'ts_reg_residual', 'ts_skew', 'ts_sma',
           'ts_std', 'ts_sum', 'ts_truncated_ema']
...
def ts_truncated_ema(df1, d, alpha):
    ...
    output = ts_decay_linear(df1, d, weight)
    return output
