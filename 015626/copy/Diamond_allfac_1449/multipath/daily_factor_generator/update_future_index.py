import sys
sys.path.insert(4, '/data/user/017024/overnight_factors/factors/overnight_prod_20210127_76/ic/')
...
fs1 = [f for f in os.listdir('/data/user/017024/overnight_factors/factors/overnight_prod_20210127_76/ic/') if f.endswith('.py')]
fs2 = [f for f in os.listdir('/data/user/017024/overnight_factors/factors/overnight_prod_20210127_76/if/') if f.endswith('.py')]
fs = fs1 + fs2
for f in fs:
...
if __name__ == '__main__':
    ...
    flag_path_start = flag_root + str(end_date) + '_overnight_factors_future_index.start'
    ...
    flag_path_success = flag_root + str(end_date) + '_overnight_factors_future_index.success'
