...
class wsc_limit_24_no_st(FactorGenerator):
    ...
    def on_bar(self, data_dict):
        ...
        open_000906_trun = open_000906.iloc[open_000906.index.indexer_at_time(futures_data_morning_begin)]
        open_000906_trun.index = pd.to_datetime(open_000906_trun.index.date)
        close_000906_trun = close_000906.iloc[close_000906.index.indexer_at_time(trade_stop_time)]
        close_000906_trun.index = pd.to_datetime(close_000906_trun.index.date)
        index_ret = close_000906_trun / open_000906_trun - 1
        ...
        stk_ret = close_alla_daily_trun / open_alla_daily_trun - 1
