...
class wsc_limit_3_no_st(FactorGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, required_columns=required_columns, ts_norm_method='ts_rank', ts_norm_bars=22, **kwargs)
    ...
    def on_bar(self, data_dict):
        ...
        limit_judgement1 = (high_alla_daily_trun == limit_alla_daily)  # 判断股票盘中是否一度涨停
