...
class wyc_mf8_totalcount(FactorGenerator):
    def __init__(self, *args, ts_norm_bars=0, **kwargs):
        ...
        super(wyc_mf8_totalcount, self).__init__(*args, required_columns=required_columns,
                                   ts_norm_bars=90, **kwargs)
    ...
    def on_bar(self, df):
        ...
        factor = (smallcount + midcount + bigcount + supercount).to_frame()
        # factor = ts_rank(factor, 90).to_frame()
