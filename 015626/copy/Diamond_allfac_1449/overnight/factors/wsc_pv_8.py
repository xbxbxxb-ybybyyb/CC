...
class wsc_pv_8(FactorGenerator):
    ...
    def on_bar(self, data_dict):
        ...
        close_000300_daily_1449 = close_000300[close_000300.index.indexer_at_time(trade_stop_time)]
        close_000300_daily_1449.index = pd.to_datetime(close_000300_daily_1449.index.date)
        close_000300_daily_1449.index.name = 'dt'
        spot_ret = ts_pct_change(close_000300_daily_1449, 1)
