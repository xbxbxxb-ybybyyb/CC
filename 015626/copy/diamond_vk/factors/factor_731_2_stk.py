...
import pandas as pd
# 日跳跃度因子
class factor_731_2_stk(FactorGenerator):
    def __init__(self, *args, **kwargs):
        required_columns = ['high_stk', 'low_stk', 'close_stk', 'amount_stk']
        super(factor_731_2_stk, self).__init__(*args, required_columns=required_columns, **kwargs)
