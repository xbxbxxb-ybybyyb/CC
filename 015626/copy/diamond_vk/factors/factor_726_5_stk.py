...
import pandas as pd
# 模糊性
class factor_726_5_stk(FactorGenerator):
    def __init__(self, *args, **kwargs):
        required_columns = ['close_stk', 'amount_stk', 'volume_stk']
        super(factor_726_5_stk, self).__init__(*args, required_columns=required_columns, **kwargs)
