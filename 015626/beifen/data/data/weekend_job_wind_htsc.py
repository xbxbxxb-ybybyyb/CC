...
class WIND_DATABASE:
    ...
    def dumper(self):
        ...
        if self.dfreq =='QUARTERLY':
            ...
            if self.table_name in self.over_write_list or self.table_name == 'WIND_AShareMonRepBrokers':
                update_list = csv_list
            else:
                update_list = []
                for date in self.cdate_list:
                    path = os.path.join(self.table_csv_path,str(date) + '.csv')
...
def first_job(sdate,edate):
    ...
    qtr_list2 = ['WIND_AShareSalesSegment','WIND_AShareFinExpense','WIND_AShareAuditOpinion','WIND_AShareIBrokerIndicator',
            'WIND_AShareBankIndicator','WIND_AShareInsuranceIndicator']

    daily_list = ['WIND_AShareDescription','WIND_AShareIndClassCITICS','WIND_AShareST', 'WIND_AShareManagement',
                'WIND_AShareMonRepBrokers','WIND_AShareMgHoldReward','WIND_AIndexMembers','WIND_AShareConseption',
                'WIND_AShareRightIssue'] 
    
    daily_list2 = ['WIND_AShareStaff','WIND_ASharePledgepro','WIND_AShareIPO','WIND_AShareSEO','WIND_AShareMjrHolderTrade']
...
def second_job(sdate,edate):
    ...
    daily_list =  ['WIND_AShareFFCalendar','WIND_CMFundAssetPortfolio', 'WIND_CMFOtherPortfolio', 'WIND_CMFundIndPortfolio',
                    'WIND_CMFundStockPortfolio','WIND_CMFundBondPortfolio', 'WIND_AShareMarginSubject', 'WIND_AShareStrangeTradedetail',
                    'WIND_AShareStrangeTrade', 'WIND_AShareHolderNumber', 'WIND_AShareFloatHolder', 
                    'WIND_AShareEXRightDivRecord', 'WIND_AShareCompRestricted', 'WIND_AShareEquityPledgeInfo',
                 'WIND_AShareInsideHolder','WIND_BOIndexWeightsWIND','WIND_AShareStyleCoefficient',
                 'WIND_AShareTradingSuspension','WIND_AShareIllegality','WIND_AShareMajorEvent','WIND_ASarePlanTrade']

    qtr_list = []

    daily_list2 = ['WIND_AShareIndustriesCode','WIND_AShareCapitalization', 'WIND_AShareFreeFloat', 'WIND_AShareAgency',
                 'WIND_AShareCOCapitaloperation', 'WIND_AshareStockRepo', 'WIND_AShareCorporateFinance',
                 'WIND_AShareIssueCommAudit', 'WIND_AShareEquityDivision',
                 'WIND_IPOCompRFA', 'WIND_IECMemberList', 'WIND_AShareLeadUnderwriter','WIND_IPOInquiryDetails',
                 'WIND_AShareIncDescription', 'WIND_AShareIncQuantityPrice', 'WIND_AShareIncQuantityDetails',
                 'WIND_AShareIncExercisePct', 'WIND_AShareIncExecQtyPri', 'WIND_AShareEsopDescription', 'WIND_AShareEsopTradingInfo',
                 'WIND_AShareStaffStructure', 'WIND_AShareMajorHolderPlanHold','WIND_AShareTypeCode','WIND_htzqedbdzzbs',
                'WIND_AShareMainandnoteitems']
    

    table_dict = {'DAILY': daily_list+daily_list2,'QUARTERLY': qtr_list}
