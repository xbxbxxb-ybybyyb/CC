...
def retrieve(table_name,cdate_list,root_folder):
    ...
    if table_name in ['con_forecast_schedule', 'con_forecast_stk','cmb_report_subtable',
            ...
            'change_type','change_event','con_stock_income']:
...
def update_consensus_data(sdate=None,edate=None,operation='append'):
    ...
    # cdate_list = list(set(all_days) - set(cdate_list))
    # cdate_list.sort()
    ...
    for table_name in table_list:
        ...
        if table_name not in ['cmb_report_research','der_report_research','author_pj','change_type','change_event']:
            ...
            # else:
            csv2h5(csv_list,h5_path,table_name,'append',min_size=0)
...
if __name__ == '__main__':
    lst_workday, sdate,edate = get_current_nature_date()
    print(lst_workday,sdate)
    update_consensus_data(lst_workday,sdate)
