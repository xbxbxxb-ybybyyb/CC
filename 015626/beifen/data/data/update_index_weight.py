...
def date_period_handler(sdate=None,edate=None):
    ...
    if sdate is not None and edate is None:
        ...
        fdate_list_dt = IO.read_data([20090101,21000101],ftype=FType.CALENDAR).index.get_level_values(0)
        fdate_list = [int(dt.datetime.strftime(i,'%Y%m%d')) for i in fdate_list_dt]
...
class unv_factor(object):
    def __init__(self, start_date, end_date,date_list):
        self.start_date = start_date
        self.end_date = end_date
        # self.sdate_prev,self.edate,self.cdate_list = check_update_date(self.start_date,self.end_date)
        self.sdate_prev, self.edate, self.cdate_list = start_date, end_date,date_list
        self.fail_dict = {}
    ...
    def csv_to_database(self):
        ...
        # factor_list = ['SH50']
        h5_path_source = 'Z:\\warehouse\\prod\\INDEXWEIGHT\\CHINA_STOCK\\DAILY\\CSI\\INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5'
...
def updater_universe(sdate=None,edate=None):
    ...
    sdate,edate,cdate_list = 20200102,20200103,[20200102,20200103]
    unv_factor(sdate, edate,cdate_list).cronb()
...
# date_list = [20150612,20151211,20151229,20160608,20161209,20170117,20170213,20170609,20171208,20180608,20181214,20190117,20190614]
# for date in date_list:
    # updater_universe(sdate=date,edate=date)

# updater_universe(20200101,20200105)

ftp_download('20200102')