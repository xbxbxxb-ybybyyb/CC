...
def updater_universe_csv(cdate_list):
    ...
    save_index_component(cdate_list, ['index_1000'], store_path)
...
class unv_factor(object):
    ...
    def csv_to_database(self):
        ...
        h5_path_source = r'Z:\warehouse\prod\LOCAL_DATA\CSV\stock_universe\tmp.h5'
        h5_path_destination = r'Z:\warehouse\prod\UNIV\CHINA_STOCK\DAILY\OPTM\tmp.h5'
        factor_list = ['index_1000']

        # update_universe_raw(self.cdate_list,csv_path,h5_path_source,factor_list,operation='create')
        """Create Universe"""
...
updater_universe(20090101,20190819)