...
def csv2h5(date_list, operation = 'append'):
    ...
    root_path = 'Z://warehouse//test//LOCAL_DATA//CSV//hf_MD//'
    table_h5_file = 'Z://warehouse//test//HF_MD//HIGH_FREQ_MD_TEST.h5'
...
run(20140101,20180101)

# sdate, edate, cdate_list = check_update_date(20180101,20191106)
