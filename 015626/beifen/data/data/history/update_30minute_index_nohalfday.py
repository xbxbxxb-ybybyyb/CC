...
def MD_retrieve(date):
    root = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\wind_data\\index\\'
    path = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\WIND\\MINUTE\\index_perdate\\'
...
def rolling(sdate=None, edate=None):
    ...
    factor_list = ['vwap_minute30_1','vwap_minute30_2','vwap_minute30_3','vwap_minute30_4',
    ...
    csv_path = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\wind_data\\index\\'
    h5_path = r'Z:\warehouse\prod\VD\CHINA_INDEX\DAILY\WIND\VD_CHINA_INDEX_DAILY_WIND.h5'

    update_wind_daily_h5(cdate_list,factor_list +factor_list2,csv_path,h5_path,operation='append')


def flag_check(date):
    path = 'Z:\\warehouse\\prod\\LOCAL_DATA\\FLAG\\' + str(date) + '\\' + str(date) + '_' + 'MINUTE.success'
    return os.path.exists(path)


# rolling(20140101,20191018)



# # rolling(20130326,20191016)
...
if __name__ == '__main__':
    ...
    flag_path1 = flag_root + str(edate) + '_' + 'VD2.success'
