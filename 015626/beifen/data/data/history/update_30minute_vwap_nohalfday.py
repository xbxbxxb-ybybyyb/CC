...
def MD_retrieve(date):
    root = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\wind_data\\'
    path = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\WIND\\MINUTE\\stock_perdate\\'
...
def rolling(sdate=None, edate=None):
    ...
    csv_path = 'Z:\\warehouse\\prod\\LOCAL_DATA\\CSV\\wind_data\\'
    h5_path = 'Z:\\warehouse\\prod\\VD\\CHINA_STOCK\\DAILY\\WIND\\VD_CHINA_STOCK_DAILY_WIND.h5'
...
if __name__ == '__main__':
    ...
    flag_path1 = flag_root + str(edate) + '_' + 'VD.success'
