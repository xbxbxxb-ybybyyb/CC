...
def run(start = None, end = None):
    ...
    for i in range(1,len(cdate_list)):
        ...
        df_total = get_total_data(dfindicator1, dfprices1, dfhalfday, df_preclose, dfprices0, day1)
...
# run(20141112,20191108)

sdate, edate, cdate_list = check_update_date(20140101,20191108)
