            ...
            for fname in update_list:
                ...
                if len(dat1)<=min_size:
                    ...
                    if self.table_name == 'WIND_AShareProfitNotice':
                        ...
                        h5_store.append(self.table_name, dat, data_columns=True,
                                        min_itemsize={'S_EST_INSTITUTE': 30, 'S_EST_RATINGANALYST': 50,
                                                      'S_EST_PRERATING_INST': 20})

                    elif self.table_name == 'WIND_AShareIPOPricingForecast':
                        h5_store.append(self.table_name, dat, data_columns=True,
                                        min_itemsize={'EST_MEMO': 1500})
...
def wind_concensus_job(sdate=None, edate=None):
    sdate, edate, cdate_list = check_update_date(sdate=sdate, edate=edate)
    #已完成'WIND_AShareConsensusData','WIND_AIndexConRollingData','WIND_AShareConsensusindex'
    #未完成'WIND_AShareIPOPricingForecast',
...
# wind_concensus_job(20160919,20191112)
