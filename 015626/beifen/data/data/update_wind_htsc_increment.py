...
class WIND_DATABASE:
    def __init__(self, table_name, sdate, edate, 
        ...
        name_mapping_dict = {'WIND_AShareAFIndicator': 'AShareANNFinancialIndicator', 'WIND_Ashareeoddindicator': 'AShareEODDerivativeIndicator',
                    ...
                    'WIND_AshareFinaccounts': 'AshareFinancialaccounts','WIND_AIndexConRollingData':'AIndexConsensusRollingData',
        ...
        self.table_h5_file =  os.path.join(self.table_h5_path,self.h5_name+'tmp.h5')
        ...
        if self.dfreq=='DAILY':
            ...
            qtr_list = get_qtr_list(self.sdate,self.edate,num_qtr=4)
        ...
        self.over_write_list = ['WIND_AShareIndClassCITICS', 'WIND_AShareDescription', 'WIND_AShareIndustriesCode','WIND_AShareST',
                        'WIND_AShareCapitalization', 'WIND_AShareFreeFloat', 'WIND_AShareIPO', 'WIND_AShareAgency',
                         ...
                         'WIND_AShareMainandnoteitems','WIND_AShareIPOPricingForecast']    
    ...
    def csv2h5(self, update_list, min_size=0):
        ...
        dat_fig_dict = {'WIND_AShareProfitExpress':{'dt':'REPORT_PERIOD','Ticker':'S_INFO_WINDCODE'},
                        ...
                        'WIND_AShareStockRating':{'dt':'S_EST_ESTNEWTIME_INST','Ticker':'S_INFO_WINDCODE'},
                        ...
                        'WIND_AShareIPOPricingForecast':{'dt':'date','Ticker':'S_INFO_WINDCODE'},
            ...
            for fname in update_list:
                ...
                if len(dat1)<=min_size:
                    ...
                    if self.table_name == 'WIND_AShareProfitNotice':
                        ...
                        h5_store.append(self.table_name,dat, datacolumns=True)
                    elif self.table_name == 'WIND_AIndexConRollingData':
                        h5_store.append(self.table_name,dat,data_columns=True,min_itemsize={'Ticker':40}) 

                    elif self.table_name == 'WIND_AShareConRollingData':
                        h5_store.append(self.table_name,dat,data_columns=True,min_itemsize={'Ticker':40,'ROLLING_TYPE':20})
                    elif self.table_name == 'WIND_AShareEarningEst':
                        dat.drop(['ANALYST_ID', 'REPORT_NAME','RESEARCH_INST_NAME','ANALYST_NAME','REPORT_SUMMARY'], axis=1, inplace=True)
                        dat['COLLECT_TIME'] = dat['COLLECT_TIME'].astype(str)
                        dat['FIRST_OPTIME'] = dat['FIRST_OPTIME'].astype(str)
                        h5_store.append(self.table_name,dat,data_columns=True,min_itemsize={'FIRST_OPTIME':50,'COLLECT_TIME':50})

                    elif self.table_name == 'WIND_AShareStockRating':
                        dat['S_EST_PRERATING_INST'] = dat['S_EST_PRERATING_INST'].astype(str)
                        dat.drop(['S_EST_INSTITUTE', 'S_EST_RATINGANALYST','S_EST_REPORT_TITLE','S_EST_RATINGANALYSTID'], axis=1, inplace=True)
                        h5_store.append(self.table_name,dat,data_columns=True,min_itemsize={'S_EST_RATING_INST':50,'S_EST_PRERATING_INST':50})
                    else:
                        h5_store.append(self.table_name,dat,data_columns=True)
    ...
    def retriever(self):
        ...
        if self.table_name in ['WIND_AShareFinancialIndicator', 'WIND_AShareProfitExpress', 'WIND_AShareTTMHis',
            ...
            sql_where = ' where F_PRT_ENDDATE='
                                ...
                                'WIND_AShareFFCalendar', 'WIND_AShareEquityPledgeInfo','WIND_AShareConsensusindex']:
            sql_where = ' where ANN_DT='
        elif self.table_name in ['WIND_CMFundStockPortfolio']:
            sql_where = ' where ANN_DATE='
        elif self.table_name in ['WIND_AShareStockRating']:
            sql_where = ' where S_EST_ESTNEWTIME_INST='
        elif self.table_name in ['WIND_AShareConsensusData','WIND_AShareConRollingData','WIND_AIndexConRollingData','WIND_AShareEarningEst']:
...
def first_job(sdate,edate):
    ...
    qtr_list = ['WIND_AShareBalanceSheet','WIND_AShareCashFlow','WIND_AShareIncome','WIND_AShareProfitExpress',
                    ...
                    'WIND_AShareIssuingDatePredict','WIND_AShareProfitExpress','WIND_AShareDividend','WIND_AIndexFinancialderivative']
    # qtr_list = ['WIND_AShareAFIndicator', 'WIND_AShareIssuingDatePredict','WIND_AShareProfitExpress']
# ['WIND_AShareBalanceSheet','WIND_AShareIssuingDatePredict','WIND_AShareFinancialIndicator','WIND_AShareTTMHis',
# 'WIND_AShareCashFlow','WIND_AShareIncome','WIND_AShareProfitExpress']
    first_daily_list = ['WIND_AShareDescription','WIND_AShareIndClassCITICS','WIND_AShareST', 'WIND_AShareManagement',
                        'WIND_AShareMonRepBrokers','WIND_Ashareeoddindicator','WIND_AShareEODPrices','WIND_AIndexEODPrices',
                        'WIND_AShareMgHoldReward','WIND_AShareMoneyFlow','WIND_AShareL2Indicators'] 
...
def second_job(sdate,edate):
    sdate,edate,cdate_list = check_update_date(sdate = sdate, edate = edate)

    daily_list =  ['WIND_SHSCDailyStatistics','WIND_SHSCShortselling',
                    'WIND_SHSCTop10ActiveStocks','WIND_SHSCChannelholdings', 'WIND_ASharePledgepro', 'WIND_AShareFFCalendar',
   ...
   # AShareAuditOpinion, AShareProfitExpress, AShareMonthlyReportsofBrokers
    new_daily_list = ['WIND_AShareCapitalization','WIND_AShareFreeFloat', 'WIND_AShareIPO', 'WIND_AShareAgency',
                ...
                'WIND_AShareEsopDescription','WIND_AShareEsopTradingInfo', 'WIND_AShareStaffStructure','WIND_AShareEquityPledgeInfo',
                 ...
                 'WIND_AShareStyleCoefficient','WIND_AShareMjrHolderTrade','WIND_AShareTypeCode','WIND_AShareTradingSuspension',
                 'WIND_AShareMainandnoteitems','WIND_AIndexWindIndustriesEOD']
    ...
    qtr_list = ['WIND_FinNotesDetail','WIND_AShareIBrokerIndicator',
                'WIND_AShareInsuranceIndicator','WIND_AShareBankIndicator','WIND_AShareSalesSegment',
                'WIND_Top5ByLongTermBorrowing','WIND_Top5ByOperatingIncome','WIND_AshareOthreceivables','WIND_AShareFinExpense',
                'WIND_AshareInventorydetails','WIND_AshareFinaccounts','WIND_Top5ByAccReceivable']
    table_dict = {'DAILY': daily_list + new_daily_list +  tech_daily_list,'QUARTERLY': qtr_list}
    # table_dict = {'DAILY': [],'QUARTERLY': ['WIND_AshareOthreceivables','WIND_AShareFinExpense',
    #             'WIND_AshareInventorydetails','WIND_AshareFinaccounts','WIND_Top5ByAccReceivable',
    #             'WIND_Top5ByAccReceivable']}
...
def add_new_tables(sdate,edate):
    sdate,edate,cdate_list = check_update_date(sdate = sdate, edate = edate)
    qtr_list = []
    daily_list =  ['WIND_AShareIPOPricingForecast']

    # daily_list =  ['WIND_AIndexConRollingData']
    # daily_list =  ['WIND_AShareConsensusData','WIND_AShareStockRatingConsus','WIND_AShareConsensusRollingData','WIND_AIndexConsensusRollingData']
   ...
   # AShareAuditOpinion, AShareProfitExpress, AShareMonthlyReportsofBrokers
    ...
    table_dict = {'DAILY':[],'QUARTERLY': ['WIND_AShareMonRepBrokers']}
...
add_new_tables(20040101,20190625)
# add_new_tables(20150101,20190522)


'''
WIND_AIndexConsensusData   not exist
WIND_AShareConsensusindex OK
AShareIndusRating
AShareIPOPricingForecast
AShareEarningEst
AShareStockRating
