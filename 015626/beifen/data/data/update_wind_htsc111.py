...
class WIND_DATABASE:
    ...
    def retriever(self):
        ...
        elif self.table_name in ['WIND_AShareConsensusData','WIND_AShareConRollingData','WIND_AIndexConRollingData','WIND_AIndexConsensusData']:
...
def wind_concensus_job(sdate=None, edate=None):
    sdate, edate, cdate_list = check_update_date(sdate=sdate, edate=edate)
    #'WIND_AShareIndusRating','WIND_AIndexConsensusData','WIND_AShareConsensusData'
    table_dict = {'DAILY': ['WIND_AShareTechIndicators'], 'QUARTERLY': []}
    # AShareswingRevADJ
    for table_type in table_dict:
        for table_name in table_dict[table_type]:
            print(table_name)
...
# wind_concensus_job(20170306,20170316)
