...
cursor = conn.cursor()
#未完成 'TRERecDetConf',
#已经完成'TRESmartSumPer','TRESumHzn','TRESumAper','TRESmartClusterPer','TREOrgNotesPer','TREPerAdvance','TREPerIndex',
effectivedate_tables = ['TRERecSum','TREDetConfPer']
...
for table in effectivedate_tables:
    ...
    if table == 'TRERecSum':
        monthdate_list = pd.date_range('2011-01', '2019-11', freq='M')
    else:
