...
def prepare_minute_dummy(ref_date):
    ref_date = IO.str_date_parser(ref_date)
    minute_data = IO.read_data([ref_date.strftime('%Y%m%d'), ref_date.strftime('%Y%m%d')+'235959'], alt = '/data/user/015626/data/share/MD/CHINA_CONVERTIBLE_BOND/MINUTE/CHINA_CONVERTIBLE_BOND_MINUTE_AND_STOCK.h5')
