...
#    hot_root = '/data/user/012245/projects/SimHF/ccbond/Data/Hot/'
    ...
    kzz_stock_minute_path = os.path.join(private_root,'MD','CHINA_CONVERTIBLE_BOND','MINUTE','CHINA_CONVERTIBLE_BOND_MINUTE_AND_STOCK_new.h5')
    ...
    kzz_model_value_key = 'scores_005_univ'
    kzz_model_value_path = os.path.join(trade_root, 'model', 'model_value', '%s.h5' % kzz_model_value_key)
    kzz_model_file_path = os.path.join(trade_root, 'model', 'model_file', 'kzz_models_005_univ.pkl')
