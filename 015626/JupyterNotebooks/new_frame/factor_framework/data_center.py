...
class DataCenter(object):
    def __init__(self, variety, data_type, instrument_type, data_dict, start_date, end_date, days_past):
        ...
        self.__minute_index_path = '/data/user/015615/MarketData/MD/CHINA_INDEX/MINUTE'
        self.__minute_stock_path = '/data/user/015615/MarketData/MD/CHINA_STOCK/MINUTE_v4'
        self.__index_weights_path = '/data/user/015615/MarketData/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5'
