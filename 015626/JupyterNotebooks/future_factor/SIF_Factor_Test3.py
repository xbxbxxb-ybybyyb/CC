...
class SIF_Factor_Test:
    def __init__(self, df, factor_name, layers = 4, fee = 0, threshold = 0.5, ticker = 'IC.CFE',signal_lims=(-1, 1), save_image = True, show_image = True,starttime = 20160101, endtime = 20220101, savepath = '/data/user/015626/data/share/factor/factor_test/'):
    ...
    def draw_result(self):
        ...
        after_fee_cumualtive_long_short_point = cumualtive_long_short_point - (long_deal_num+short_deal_num) * self.fee
