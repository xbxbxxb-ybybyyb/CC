...
from utils_wsc.help_functions import read_pickle, rolling_norm, save_pickle
from factor_test.SIF_Factor_Test10_modify import SIF_Factor_Test
from multiprocessing.pool import Pool
from operators.opeartors_wsc import ts_sum, ts_mean, ts_argmax, ts_argmin, ts_rank
...
def signal_reshaper(signals, signal_lims=signal_lims, layers=layers):
