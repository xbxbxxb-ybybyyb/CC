...
doc = SimpleDocTemplate('/data/user/017024/share/overnight/strategy_tracking_report/Diamond_2_0/Diamond_tracking_report_' + future_ret_raw.index[-1].strftime('%Y%m%d') +'.pdf')
doc.build(story)
