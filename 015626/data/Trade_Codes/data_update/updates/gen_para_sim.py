...
future_list_ic = 'IC2407.CF,IC2409.CF'
future_list_if = 'IF2407.CF,IF2409.CF'
future_list_im = 'IM2407.CF,IM2409.CF'
...
model_list = ['ic_v7unifac_orig_norm2',  'ic_v7unifac_crn_norm2', 
              'if_v7c_orig_norm2', 'if_v7_crn_norm2', 
              'im_v1unifac_crn_norm2', 'im_v1unifac_orig_norm2'
              ]
...
model_date_dict = {
                   ...
                   #'if_v7_crn': '20231229_if_if_v7_crn',
                   'if_v7c_orig_norm2': '20240329_if_if_v7c',
                   'if_v7_crn_norm2': '20240329_if_if_v7_crn',
                   
                   #'ic_v7c': '20230224_ic_ic_v7c',
                   'ic_v7unifac_crn_norm2': '20240329_ic_ic_v7unifac_crn',
                   'ic_v7unifac_orig_norm2': '20240329_ic_ic_v7unifac',                  
                   ...
                   'im_v1unifac_crn_norm2': '20240329_im_im_v1unifac_crn',
                   #'im_v1unifac_orig': '20231229_im_im_v1unifac',
                   'im_v1unifac_orig_norm2': '20240329_im_im_v1unifac' 
                   }
...
cszj_dict = {
             ...
             'if_v7c_orig': 0,
             'if_v7_crn': 0, 
             'if_v7c_orig_norm2': 25,
             'if_v7_crn_norm2':25,
            
             'ic_v8unifac_crn_norm2':0,
             'ic_v7unifac_orig_norm2': 20,
             'ic_v7unifac_crn_norm2':20,             
             'ic_v7unifac_orig': 0,
             'ic_v7unifac_crn': 0,
             'ic_v7unifac':0,
            
             'im_v1unifac_crn': 0,
             'im_v1unifac_crn_norm2': 25, 
             'im_v1unifac_orig': 0,
             'im_v1unifac_orig_norm2': 25,                   
            }
...
pos_dict['if_v7c_orig_norm2'] =[[0.0,  0.07, 0.15, 0.61, 0.67, 0.73, 0.8],
                                [0.07, 0.15, 0.61, 0.67, 0.73, 0.8,  100.0],
                                [0,    0,    0,    2.5,  5,    7.5,  10],
                                [0,    5,    10,   10,   10,   10,   10]]

pos_dict['if_v7_crn_norm2'] =[[0.0,  0.07, 0.15, 0.7,  0.75, 0.8,  0.85],
...
pos_dict['ic_v7unifac_crn_norm2'] =[[0.0,  0.07, 0.15, 0.7,  0.75, 0.8,  0.85],
                                    [0.07, 0.15, 0.7,  0.75, 0.8,  0.85, 100.0],
                                    [0,    0,    0,    2.5,  5,    7.5,  10],
                                    [0,    5,    10,   10,   10,   10,   10]]
...
pos_dict['im_v1unifac_crn_norm2'] =[[0.0,  0.07, 0.15, 0.71,  0.76, 0.81,  0.86],
                                    [0.07, 0.15, 0.71,  0.76, 0.81,  0.86, 100.0],
                                    [0,    0,    0,    2.5,  5,    7.5,  10],
                                    [0,    5,    10,   10,   10,   10,   10]]

pos_dict['im_v1unifac_orig'] =[[0.0,  0.1, 0.2, 0.75,  0.8, 0.85,  0.9],
                             [0.1,  0.2, 0.75, 0.8, 0.85,  0.9, 100.0],
                             [0,    0,   0,   2.5,  5,    7.5,  10],
                             [0,    5,   10,  10,   10,   10,   10]]
