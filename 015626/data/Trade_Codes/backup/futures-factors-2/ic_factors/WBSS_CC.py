...
class WBSS_CC(FutureFactor):
    ...
    def calculate(self, data):
        weight = data['weight'].iloc[-15:]
        w = data['WeightBuyOrderQtySumMean'].iloc[-15:] / data['WeightSellOrderQtySumMean'].iloc[-15:]* weight
        ...
        hret = hret.ewm(8).mean().values[-1] * (weight.values[-1])
