# -*- coding: utf-8 -*-
"""
Created on Thu Jan 27 17:36:21 2022
...
class AbsPx1Min_Weighted_modified_if(FutureFactor):
    ...
    def calculate(self, data):
        ...
        factor = np.nanmean(cross_if(data['weight'].values[-1] * data['AbsPxPath'].values[-1] / data['close'].values[-1]))
