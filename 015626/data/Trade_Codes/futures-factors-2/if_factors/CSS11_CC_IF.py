...
class CSS11_CC_IF(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'buy_midorder_volume_othermin', 'buy_smallorder_volume_othermin','weight', 'close']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['buy_midorder_volume_othermin'].values[-20:]
        temp2 = data['buy_smallorder_volume_othermin'].values[-20:]
