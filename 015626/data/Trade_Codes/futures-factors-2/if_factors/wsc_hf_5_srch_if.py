...
class wsc_hf_5_srch_if(FutureFactor):
    ...
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = ['BuyUniqueOrderNum', 'SellUniqueOrderNum', 'stk_index_corr_hs300', 'weight']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        stk_index_corr = data['stk_index_corr_hs300'].values[-145:]
