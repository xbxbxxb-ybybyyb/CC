...
class CSS19_CC_IF(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'sell_superorder_volume_v2', 'sell_bigorder_volume_v2','weight', 'close']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['sell_superorder_volume_v2'].iloc[-20:]
        temp2 = data['sell_bigorder_volume_v2'].iloc[-20:]
        ...
        hret = hret.ewm(20, min_periods = 1).mean().iloc[-1:]
        #hret = np.nanmean(hret.values[-20:], axis = 0)
