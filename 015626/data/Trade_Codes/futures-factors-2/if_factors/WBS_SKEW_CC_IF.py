# -*- coding: utf-8 -*-
"""
Created on Mon Sep  5 11:16:20 2022
...
class WBS_SKEW_CC_IF(FutureFactor):
    ...
    def calculate(self, data):
        weight = data['weight'].iloc[-40:]
        w = data['WeightBuyOrderQtySumMean'].iloc[-40:] / data['WeightSellOrderQtySumMean'].iloc[-40:]* weight
        ...
        hret = hret.ewm(30).mean().values[-1] * (weight.values[-1])
