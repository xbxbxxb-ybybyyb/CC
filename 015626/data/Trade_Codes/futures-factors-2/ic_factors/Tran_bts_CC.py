...
class Tran_bts_CC(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'tran_buy_unique_order_count', 'tran_sell_unique_order_count', 'amount', 'weight']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['tran_buy_unique_order_count'].values[-10:]
        temp2 = data['tran_sell_unique_order_count'].values[-10:]
