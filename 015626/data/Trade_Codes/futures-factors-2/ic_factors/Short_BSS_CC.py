...
class Short_BSS_CC(FutureFactor):
    ...
    def calculate(self, data):
        df_s1 = ((data['BuyNumOrdersSumMean'].iloc[-45:] / r(data['WeightBuyOrderQtySumMean'].iloc[-45:])))#*data['weight_500']
        df_s2 = ((data['SellNumOrdersSumMean'].iloc[-45:] / r(data['WeightSellOrderQtySumMean'].iloc[-45:])))#*data['weight_500']
        ...
        hret = hret.ewm(10).mean().values[-1]
