...
def param_entry(trading_day, offset):
    ...
    for variety in variety_list:
        ...
        if os.path.exists(os.path.join(dest, params_file)):
...
def param_entry2(trading_day, offset):
    params_file = 'params.json'
    root_data_path = '/dfs/user/666466/03_mobius/02_FactorData'  # 不能修改
    template_path = '/dfs/user/666466/01_params/template/model'  # 需要修改
    dest_model_path = '/dfs/user/666466/01_params'   # 需要修改 
