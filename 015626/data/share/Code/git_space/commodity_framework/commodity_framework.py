...
class DataCenter(object):
    ...
    def get_data_helper(self, para):
        ...
        try:
            ...
            main_secmain_df = pd.concat([select, secmain_select], axis = 1)
            main_secmain_df.index.name = 'dt'
            main_secmain_df['tday'] = main_secmain_df['tday'].fillna(main_secmain_df['tday_secmain'])

            return {date : main_secmain_df}
        except Exception as e:
            print(para, e)
            return None
