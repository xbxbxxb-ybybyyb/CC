...
for i in index:
    while True:
        ...
        if res is None:
            ...
            history_data = pd.concat([history_data, get_data(i).reset_index()
...
class DataCenter(object):
    ...
    def get_continus_data_for_variety(self, variety):
        ...
        for date in self.__trading_days:
            ...
            _future_data = future_data[(future_data['tday'] >= dt1) & (future_data['tday'] <= dt2)]
            ...
            continuous_dict[date] = pd.concat([select, secmain_select], axis = 1)
