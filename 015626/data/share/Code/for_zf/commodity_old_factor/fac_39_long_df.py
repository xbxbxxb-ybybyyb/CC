...
class fac_39_long_df(FactorGenerator):
    def __init__(self):
        required_columns=['close', 'high', 'main_mask']

        super(fac_39_long_df, self).__init__(required_columns=required_columns
                                  )
    ...
    def on_bar(self, data, aa, bb, ccc):
        ...
        vol = rtn.rolling(bb, min_periods=1).std()
