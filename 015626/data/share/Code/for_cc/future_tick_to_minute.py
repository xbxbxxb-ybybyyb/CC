...
def calc(columns,data_dict, data_dict_minute, data_dict_minute_concat, data_dict_factor_concat, factor_number, count, count1, count2, temp, bl, b, contract_3, n = freq):
    ...
    try:
            ...
            #if ((('2015' in b[dt]) and ((' 09:14' not in b[dt]) and (' 09:15:0' not in b[dt]))) or (('2015' not in b[dt]) and ((' 09:29' not in b[dt]) and (' 09:30:0' not in b[dt])))):
...
if __name__ == '__main__':
    ...
    im_path = os.path.join(rootpath, 'IM_MINUTE.h5')
