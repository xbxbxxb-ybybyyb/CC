# -*- coding: utf-8 -*-
"""
Created on Fri Apr  8 14:52:12 2022
...
class s_WBS_CC_IF_IM(FutureFactor):
    ...
    def calculate(self, data):
        df_s = data['WeightBuyOrderQtySumMean'].iloc[-25:] / r(data['WeightSellOrderQtySumMean'].iloc[-25:])
        df_s = (df_s.skew(axis = 0)).values * data['weight'].values[-1]
        hclose = data['close'].values[-82:]
        hret = hclose[1:]/hclose[:-1] - 1
        hret[abs(hret)>10000] = np.nan
        hret = ts_truncated_ema_span_1(hret, 80, 20)[-1]
