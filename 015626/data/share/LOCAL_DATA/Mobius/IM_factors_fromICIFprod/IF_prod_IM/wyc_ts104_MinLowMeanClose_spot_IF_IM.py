...
class wyc_ts104_MinLowMeanClose_spot_IF_IM(FutureFactor):
    
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Index_Id'] = {'000852.SH':['close', 'low']} 
    normalize_size = 1000
    normalize_type = 'ts_rank'
    
    def calculate(self, data):
        low = data['low_000852.SH'].values[-155:]
        close = data['close_000852.SH'].values[-155:]
