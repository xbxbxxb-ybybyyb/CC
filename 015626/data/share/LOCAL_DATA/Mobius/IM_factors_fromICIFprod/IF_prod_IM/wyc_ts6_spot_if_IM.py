...
class wyc_ts6_spot_if_IM(FutureFactor):
    data_type = 'Future'# 成分股为'IndexStock' 期货与指数为'Future'
    days_past = 2
    data_dict = dict()
    instrument_type = 'recent'
    data_dict['Index_Id'] = {'000852.SH':['close','high','low','volume']}
    ...
    def calculate(self, df):
        close = df['close_000852.SH'][-460:]
        high = df['high_000852.SH'][-460:]
        low = df['low_000852.SH'][-460:]
        volume = df['volume_000852.SH'][-460:]
