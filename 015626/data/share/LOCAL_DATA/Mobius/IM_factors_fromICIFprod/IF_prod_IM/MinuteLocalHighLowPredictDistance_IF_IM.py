...
class MinuteLocalHighLowPredictDistance_IF_IM(FutureFactor):
    '''
    Description: 
    ...
    def calculate(self, data):
        ...
        index_close = data['close_000852.SH']
        first_idx = index_close.first_valid_index()
        index_close = index_close.loc[first_idx:].values
