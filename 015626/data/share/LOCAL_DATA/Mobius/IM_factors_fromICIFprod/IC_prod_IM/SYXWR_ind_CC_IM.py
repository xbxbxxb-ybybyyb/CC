...
class SYXWR_ind_CC_IM(FutureFactor):
    
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Index_Id'] = {'000852.SH':[ 'high', 'low', 'close', 'open']}
    ...
    def calculate(self, data):
        hopen = (data['open_000852.SH'].values)[-120:]
        hhigh = (data['high_000852.SH'].values)[-120:]
        hlow = (data['low_000852.SH'].values)[-120:]
        hclose = (data['close_000852.SH'].values)[-120:]
