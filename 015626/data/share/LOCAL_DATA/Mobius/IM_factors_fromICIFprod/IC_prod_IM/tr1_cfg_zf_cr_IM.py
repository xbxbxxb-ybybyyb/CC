...
class tr1_cfg_zf_cr_IM(FutureFactor):
    '''
    成分股因子
    '''
    ...
    days_past = 3
    data_dict = dict()
    data_dict['Stock'] = ['close','high','low','adjfactor','stk_index_corr_zz1000']
    ...
    def calculate(self, data):
        ...
        cr = (data['stk_index_corr_zz1000'].iloc[-5:].rank(axis=1,pct=True))*2-1
        crr = cr.values
