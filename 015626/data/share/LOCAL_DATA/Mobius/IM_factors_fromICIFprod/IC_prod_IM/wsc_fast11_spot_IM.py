...
class wsc_fast11_spot_IM(FutureFactor):
    ...
    def calculate(self, data):
        ...
        index_open = data['open_000852.SH'].values[-30:]
        index_high = data['high_000852.SH'].values[-30:]
        index_close = data['close_000852.SH'].values[-30:]
        index_low = data['low_000852.SH'].values[-30:]
