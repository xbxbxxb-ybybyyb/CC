...
class Short_BS_Main_CFG2_CC_IM(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = ['stk_index_corr_zz1000', 'BuyUniqueOrderNum', 'BuyTradeNum', 'SellUniqueOrderNum', 'SellTradeNum']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        df_s = data['stk_index_corr_zz1000'].values[-3:]
