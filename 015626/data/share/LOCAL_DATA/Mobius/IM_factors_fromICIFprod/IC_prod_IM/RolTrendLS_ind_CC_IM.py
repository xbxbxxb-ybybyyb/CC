...
class RolTrendLS_ind_CC_IM(FutureFactor):
    
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Index_Id'] = {'000852.SH':[ 'high', 'low', 'close']}
    normalize_size = 1200
    normalize_type = 'ts_rank'
    #num_range = [-1, 1]
    
    def calculate(self, data):
        hclose = (data['close_000852.SH'].values)[-85:]
        hhigh = (data['high_000852.SH'].values)[-85:]
        hlow = (data['low_000852.SH'].values)[-85:]
