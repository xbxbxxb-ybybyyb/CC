...
class LSC_CC_IM(FutureFactor):
    
    data_type = 'Future'
    days_past = 5
    data_dict = dict()
    data_dict['Index_Id'] = {'000852.SH':['high','close', 'low']}
    normalize_size = 1200
...
#    num_range = '[0, 1]'
    ...
    def calculate(self, data):
        ...
        high = (data['high_000852.SH'].values)[-1100:]
        close = (data['close_000852.SH'].values)[-1100:]
        low = (data['low_000852.SH'].values)[-1100:]
