...
version_list = ['if_v7c', 'im_v1unifac', 'ic_v75unifac']
...
roll_name_dict = {'ic_prod_v6':'_r240','if_prod_v5_add':'_r240','ic_short_v1':'_r720',
                  'ic_trade_v1':'_r240','if_v6nl':'_r720','ic_v75c':'_r720', 'ic_short_v3c':'_r720',
...
version_ticker_dict = {'ic_prod_v6':'IC.CFE','if_prod_v5_add':'IF.CFE','ic_short_v1':'IC.CFE',
                       'ic_trade_v1':'IC.CFE','if_v6nl':'IF.CFE','ic_v75c':'IC.CFE','ic_short_v3c':'IC.CFE',
                       'if_v7c':'IF.CFE','if_v7c2':'_r720','ic_v75unifac':'IC.CFE',
                       'ic_v7unifac':'IC.CFE', 'im_v1unifac':'IM.CFE' }
...
ts_pct_win_dict = {'ic_trade_v1':20*240,'ic_prod_v6':20*240,'if_prod_v5_add':20*240,
                   ...
                   'ic_v7unifac':20*240, 'im_v1unifac':20*240} # sub model raw to norm pct_win
...
ts_pct_win_dict2 = {'ic_trade_v1':10*240,'ic_prod_v6':10*240,'if_prod_v5_add':10*240,
                    ...
                    'if_v7c':10*240,'if_v7c2':10*240,'ic_v75unifac':10*240, 'ic_v7unifac':10*240, 'im_v1unifac':10*240 } # model stack pct_win
...
model_list_rnn = ['lstm_cla','lstm_reg']
...
with_desc_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,'ic_short_v1':True,
                  ...
                  'im_v1unifac':True} # nonlinear_raw_factor # for cc rfe rff only
...
with_desc_norm_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,
                       ...
                       'ic_v75unifac':True, 'ic_v7unifac':True, 'im_v1unifac':True} # nonlinear_factor_norm
...
for version in version_list:        
    ...
    save_path = '/data/group/800466/trade/Mobius/trade_files/%s/historySignal' % (next_tday + '_' + model_date2 + trail)
    ...
    if os.path.exists('/data/group/800466/trade/Mobius/trade_files/%s' % (str(date) + '_' + model_date2 + trail)):
        from shutil import rmtree
        rmtree('/data/group/800466/trade/Mobius/trade_files/%s' % (str(date) + '_' + model_date2 + trail))
