...
model_name_list = ['%s_im_im_v1unifac_crn_mom'%full_date, '%s_ic_ic_v8unifac_mom'%full_date, '%s_if_if_v7_crn_mom'%full_date]
...
model_date_dict = {'if_v7c':'%s_if_if_v7c'%full_date,
                   'if_v7_crn_mom':'%s_if_if_v7_crn_mom'%full_date,                  
                   'ic_v7unifac': '%s_ic_ic_v7unifac'%full_date,
                   'ic_v7unifac_crn': '%s_ic_ic_v7unifac_crn'%full_date,
                   'ic_v8unifac_crn_mom': '%s_ic_ic_v8unifac_crn_mom'%full_date,
                   'ic_v7c': '%s_ic_ic_v7c'%full_date,
                   'im_v1unifac_crn_mom': '%s_im_im_v1unifac_crn_mom'%full_date,  
 }



version_ticker_dict = {'if_v7_crn_mom':'IF.CFE', 'if_v7c':'IF.CFE', 
                       'ic_v7unifac_crn': 'IC.CFE', 'ic_v7unifac': 'IC.CFE', 'ic_v7unifac_crn_mom': 'IC.CFE', 
                       'im_v1unifac_crn_mom': 'IM.CFE'}
model_date_use_dict = {
                       'if_v7_crn_mom':'%s'%(model_date_dict['if_v7_crn_mom']),
                       'if_v7c':'%s'%(model_date_dict['if_v7_crn']),
                       'ic_v7unifac_crn':'%s'%(model_date_dict['ic_v7unifac_crn']),
                       'ic_v7unifac_crn_mom':'%s'%(model_date_dict['ic_v7unifac_crn_mom']),
                       'ic_v7unifac':'%s'%(model_date_dict['ic_v7unifac']),
                       'ic_v7c':'%s'%(model_date_dict['ic_v7c']),
                       'im_v1unifac_crn_mom':'%s'%(model_date_dict['im_v1unifac_crn_mom']),
                       }
...
def calc(ud, model_name):
    ...
    # other configuration
    model_name_list = ['crn_cla', 'crn_reg', 'mom_reg', 'mom_reg']
