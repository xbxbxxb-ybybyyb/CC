...
if ss == 0:
    ...
    import fuck_data.settings_50 as settings
elif ss == 55:
    import fuck_data.settings_55 as settings
...
def generate_his_data(today_str, days, target_folder, ss = ss):
    ...
    a = time.time()
    if ss == 0:
        AIMR.runTasks('/generate_his_data_test.py', json.dumps(params))
    elif ss == 50:
        AIMR.runTasks('/generate_his_data_50.py', json.dumps(params))
    elif ss == 55:
        AIMR.runTasks('/generate_his_data_55.py', json.dumps(params))
    print('done!!!')
    b = time.time()
    lm = link.LinkMessage()
...
#    generateHistoryData(str(20231115))
    ...
    #for edate in [20240901, 20240902, 20240903, 20240904, 20240926, 20240927]:
    #date_str = str(edate)
    #generateHistoryData('20240901')
    #generateHistoryData('20240902')
    #generateHistoryData('20240903')
    generateHistoryData('20240904')
    #generateHistoryData('20240926')
    #generateHistoryData('20240927')
