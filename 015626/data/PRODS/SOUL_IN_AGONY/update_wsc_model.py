...
model_name_list = ['%s_ic_ic_v8uf2'%full_date]
...
model_date_dict = {'if_v7c':'%s_if_if_v7c'%full_date,
                   ...
                   'ic_v8_wsc': '%s_ic_ic_v8uf'%full_date,
                   'ic_v8_wsc2': '%s_ic_ic_v8uf2'%full_date,
...
model_date_use_dict = {
                       ...
                       'ic_v8_wsc': '%s'%(model_date_dict['ic_v8_wsc']),
                       'ic_v8_wsc2': '%s'%(model_date_dict['ic_v8_wsc2'])
                       }
                    
_, __, update_date_list = check_update_date(20240130, 20240228)
...
def calc(ud, model_name):
    ...
    model_trade_dir = '/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/model/model_update/%s/model_trade/%s'%(model_name, model_name)
    model_value_dir = '/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/model/model_update/%s/model_value'%model_name
    ...
    # other configuration
    model_name_list = ['dnn_binary', 'dnn_regression']
    pred_time_list = [1, 5, 10, 20, 30]
