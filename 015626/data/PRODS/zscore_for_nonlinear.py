...
if kind == 'if':
    trail = '_if'
    read_path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IF_nonlinear/minute_raw/'
elif kind == 'ic':
    trail = ''
    read_path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_nonlinear/minute_raw/'
else:
    pass
...
li_nl1 = os.listdir(read_path)
li_nl = [item.replace('.h5', '') for item in li_nl1]
roll_win  = 60*240
...
path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/%s_features_new_181/'%kind.lower()
path_new = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/%s_features_new_181_zscore/'%kind.lower()
path_diff_new = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/%s_features_new_181_diff_zscore/'%kind.lower()
