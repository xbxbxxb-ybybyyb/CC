...
class fac_45_df(FutureFactor):
    ...
    def calculate(self, data):
        ...
        fac_short = self.fac_norm_list[-int(coef/2):]
        hclose_short = dclose[-int(coef/2):]
        cs = new_corr(fac_short, hclose_short)
        
        fac_long = self.fac_norm_list[-coef * 2:]
