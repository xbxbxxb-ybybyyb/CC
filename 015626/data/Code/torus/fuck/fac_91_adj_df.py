...
class fac_91_adj_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(900 / self.bars_dict[self.ticker])) * self.freq)
        self.required_columns = ['last_to_mid', 'low', 'BidAskSpreadMean', 'close']
