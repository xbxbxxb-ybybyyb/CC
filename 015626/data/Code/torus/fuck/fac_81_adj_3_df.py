...
class fac_81_adj_3_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.required_columns = ['buy_small_volume',  'sell_small_volume', 'high', 'BidAskSpreadMean', 'close']
    ...
    def calculate(self, data):
        ...
        localhigh = nanargmax_new(data['high'][-int(nanmax_np([1, aaa * coef])):])
        
        fac = (data['buy_small_volume'][-200:]- data['sell_small_volume'][-200:])
        fac = nanmean_np(-fac[localhigh:])
    ...
    def pre_calculate(self, data):
        ...
        for i in range(10, -1, -1):
            ...
            if i == 0:
                ...
                bsv = data['buy_small_volume'][(-200 - i) :]
                ssv = data['sell_small_volume'][(-200 - i) :]
                ...
                bsv = data['buy_small_volume'][(-200 - i) : -i]
                ssv = data['sell_small_volume'][(-200 - i) : -i]
            ...
            localhigh = nanargmax_new(dhigh[-int(nanmax_np([1, aaa * coef])):])
