...
class fac_58_2_df(FutureFactor):
    ...
    def calculate(self, data):        
        ...
        volume_sum = move_sum_bk(volume,window = 4, min_count = 2)

        mf_sum = move_sum_bk(mf, window = 4, min_count = 2)
        ...
        score_raw1 = nanmean_np(vwap_diff[-15:])        
