...
'''    
di_cszj_cat['IF.CFE'] = 1.5e8 / 10000000#di_cszj_cat['IF.CFE']
di_cszj_cat['IC.CFE'] = 2.5e8 / 10000000#di_cszj_cat['IC.CFE']
di_cszj_cat['IM.CFE'] = 3e8 / 10000000#di_cszj_cat['IM.CFE']
...
model_date_dict = {
                   ...
                   'if_v7c_orig_norm2': '20250328_if_if_v7c',
                   'if_v7_crn_norm2': '20250328_if_if_v7_crn',
                   'if_v7_crn_trend_norm2' : '20250328_if_if_v7_crn_trend',
                   'if_v7_crn_ew_norm2' : '20250328_if_if_v7_crn_ew',
                   
                   'ic_v7unifac_crn_norm2': '20250328_ic_ic_v7unifac_crn',
                   'ic_v7unifac_orig_norm2': '20250328_ic_ic_v7unifac',  
                   'ic_v7unifac_crn_trend_norm2' : '20250328_ic_ic_v7unifac_crn_trend',
                   'ic_v7_crn_ew_norm2': '20250328_ic_ic_v7_crn_ew',          

                   'im_v1unifac_crn_norm2': '20250328_im_im_v1unifac_crn',
                   'im_v1unifac_orig_norm2': '20250328_im_im_v1unifac',
                   'im_v1unifac_crn_trend_norm2': '20250328_im_im_v1unifac_crn_trend',
                   'im_v1_crn_ew_norm2': '20250328_im_im_v1_crn_ew',
                   }
...
cszj_dict = {
             ...
             'ic_v7unifac_crn': 0,
             'ic_v7unifac':0,
             'ic_v7unifac_crn_trend_norm2' : 20, 
             'ic_v7_crn_ew_norm2': 20, 
            
             'im_v1unifac_crn': 0,
             'im_v1unifac_crn_norm2': di_cszj_cat['IM.CFE'], 
             'im_v1unifac_orig': 0,
             'im_v1unifac_orig_norm2': di_cszj_cat['IM.CFE'],  
             'im_v1unifac_crn_trend_norm2': 25, 
             'im_v1_crn_ew_norm2': 25,  
...
#                short_temp = 0
                short_temp = max(short_temp - 200, 0) if 'IM' in future else max(short_temp - 100, 0)
            except:
                short_temp = 0
            try:
                long_temp = dic_temp[future[:-3] + '多仓']
#                long_temp = 0
                long_temp = max(long_temp - 200, 0) if 'IM' in future else max(long_temp - 100, 0)
            except:
                long_temp = 0
