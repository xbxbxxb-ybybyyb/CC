...
end_date_standard = '20210924'
start_date_standard = '20210801'
days_interval = 50

save_path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE_new/%s_nonlinear/' % kind

factor_path = '/data/user/015626/data/share/Code/git_space/futures-factors-2/%s_nonlinear' % str.lower(kind)
