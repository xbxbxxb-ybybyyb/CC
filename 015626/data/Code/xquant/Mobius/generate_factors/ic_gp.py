...
start_date_standard = '20210401'
days_interval = 120

save_path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE_new_recent/%s_gp/' % kind

factor_path = '/data/user/015626/data/share/Code/git_space/futures-factors-2/%s_gp' % str.lower(kind)
