...
def final_flag_check(date):
    ...
    path2 = '/data/user/015626/data/share/para/Mobius_%s/MobiusStrategy_IM_%s#503103.xlsx'%(next_tday, next_tday)
...
def check_model_and_trade_files(edate):
    ...
    xxy_path = '/data/user/015626/data/share/para/Mobius_%s/'% (next_tday)
    print(xxy_path)
    model_list = []
    ...
    for path in model_list:
        ...
        for x in os.listdir(rawpath):
            ...
            try:
                ...
                if (('crn_ew' not in pklpath) and pkl.shape != (237,3)) or len(pkl.dropna()) < 236 or (('crn_ew' in pklpath) and pkl.shape != (237,1)):
