...
for datee in update_date_list:
    ...
    for version in version_list:
        ...
        save_path = '/data/group/800466/trade/Mobius/trade_files/%s/historySignal' % (next_tday + '_' + model_date + trail)
        ...
        if os.path.exists('/data/group/800466/trade/Mobius/trade_files/%s' % (str(date) + '_' + model_date + trail)):
            from shutil import rmtree
            rmtree('/data/group/800466/trade/Mobius/trade_files/%s' % (str(date) + '_' + model_date + trail))
...
trade_files_path = '/data/group/800466/trade/Mobius/trade_files/'
