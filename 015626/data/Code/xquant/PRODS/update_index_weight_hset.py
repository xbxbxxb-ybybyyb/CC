...
#    namedict = {'HS300':'index_weight_hs300','SH50':'index_weight_sh50','ZZ500':'index_weight_zz500'}
    for date in cdate_list:
        ...
        for index in index_list:
            ...
            if len(df) == 0:
                print(index , next_trading_date,'no data')
                continue
...
def update_universe_raw(cdate_list,csv_path,h5_path,factor_list,operation='append'):
    weight_list = ['index_weight_sh50','index_weight_hs300','index_weight_zz500','index_weight_zz1000']
    ...
    for date in cdate_list:
        ...
        for factor_name in factor_list:
            if factor_name == 'SH50':
                ...
                bool_name = 'index_300'
            elif factor_name == 'ZZ1000':
                weight_name = 'index_weight_zz1000'
                bool_name = 'index_1000'
            elif factor_name == '000688.SH':
                weight_name = 'index_weight_kc50'
                bool_name = 'index_kc50'
            

            if factor_name == 'SH50' and date < 20100101:
                continue
            if factor_name == '000688.SH' and date < 20200723:
                continue
...
if __name__ == '__main__':
    ...
    factor_list = ['HS300', 'ZZ500', 'SH50','ZZ1000', '000688.SH']
    ...
    if wsall < 0.001:
        ...
        lm = link.LinkMessage()
        lm.sendMessage('weight wrong' + str(list(weight_sum)))
        del lm
