...
for contractc in ['IC.CFE', 'IF.CFE', 'IM.CFE']:
    ...
    if contractc == 'IC.CFE':
        ...
        if std < 0.0004:
            ...
            di_cszj_cat[contractc] = 4e8 / 10000000
        elif (std >= 0.0008) and (std < 0.0009):
            di_cszj_cat[contractc] = 4.5e8 / 10000000
        elif (std >= 0.0009) and (std < 0.001):
            di_cszj_cat[contractc] = 5e8 / 10000000
        elif (std >= 0.001):
            di_cszj_cat[contractc] = 5.5e8 / 10000000
    else:
        if std < 0.0005:
            di_cszj_cat[contractc] = 2.5e8 / 10000000
        elif (std >= 0.0005) and (std < 0.0008):
            di_cszj_cat[contractc] = 2.5e8 / 10000000
        elif (std >= 0.0008):
            di_cszj_cat[contractc] = 3e8 / 10000000
    print(contractc, std, di_cszj_cat[contractc] * 2)
'''    
di_cszj_cat['IF.CFE'] = 3e8 / 10000000#di_cszj_cat['IF.CFE']
di_cszj_cat['IC.CFE'] = 4.5e8 / 10000000#di_cszj_cat['IC.CFE']
di_cszj_cat['IM.CFE'] = 5e8 / 10000000#di_cszj_cat['IM.CFE']
...
future_list_ic = 'IC2509.CF,IC2512.CF'
kcbl_list_ic = '4:1'
future_list_if = 'IF2509.CF,IF2512.CF'
kcbl_list_if = '1:0'
future_list_im = 'IM2509.CF,IM2512.CF'
kcbl_list_im = '3:1'
...
filter_dict['futures_long_vol']['IC.CFE'] = '>=0.0005'
filter_dict['futures_long_vol']['IF.CFE'] = '>=0.0005'
filter_dict['futures_long_vol']['IM.CFE'] = '>=0.0005'
...
model_list = ['ic_v7unifac_orig_norm2',  
              ...
              'ic_v7unifac_crn_trend_norm2',
              'ic_v7_crn_ew_norm2',
            
              'if_v7c_orig_norm2', 
              'if_v7_crn_norm2', 
              'if_v7_crn_trend_norm2',
              'if_v7_crn_ew_norm2', 
            
              'im_v1unifac_crn_norm2', 
              'im_v1unifac_orig_norm2',
              'im_v1unifac_crn_trend_norm2',
              'im_v1_crn_ew_norm2',
              ]
              #'im_v1unifac_crn', 'im_v1unifac_orig']

_model_date = 20250627
model_date_dict = {

                   'if_v7c_orig_norm2': f'{_model_date}_if_if_v7c',
                   'if_v7_crn_norm2': f'{_model_date}_if_if_v7_crn',
                   'if_v7_crn_trend_norm2' : f'{_model_date}_if_if_v7_crn_trend',
                   'if_v7_crn_ew_norm2' : f'{_model_date}_if_if_v7_crn_ew',
                   
                   'ic_v7unifac_crn_norm2': f'{_model_date}_ic_ic_v7unifac_crn',
                   'ic_v7unifac_orig_norm2': f'{_model_date}_ic_ic_v7unifac',  
                   'ic_v7unifac_crn_trend_norm2' : f'{_model_date}_ic_ic_v7unifac_crn_trend',
                   'ic_v7_crn_ew_norm2': f'{_model_date}_ic_ic_v7_crn_ew',          

                   'im_v1unifac_crn_norm2': f'{_model_date}_im_im_v1unifac_crn',
                   'im_v1unifac_orig_norm2': f'{_model_date}_im_im_v1unifac',
                   'im_v1unifac_crn_trend_norm2': f'{_model_date}_im_im_v1unifac_crn_trend',
                   'im_v1_crn_ew_norm2': f'{_model_date}_im_im_v1_crn_ew',
                   }
...
cszj_dict = {
             ...
             'if_v7_crn_trend_norm2': 15,
             'if_v7_crn_ew_norm2': 15,
             ...
             'ic_v7unifac_crn': 0,
             'ic_v7unifac':0,
             'ic_v7unifac_crn_trend_norm2' : 25, 
             'ic_v7_crn_ew_norm2': 25, 
            
             'im_v1unifac_crn': 0,
             'im_v1unifac_crn_norm2': di_cszj_cat['IM.CFE'], 
             'im_v1unifac_orig': 0,
             'im_v1unifac_orig_norm2': di_cszj_cat['IM.CFE'],  
             'im_v1unifac_crn_trend_norm2': 30, 
             'im_v1_crn_ew_norm2': 30,  
...
rank_dict = {
                   ...
                   'if_v7_crn': [4800, 2400],
                   'if_v7_crn_trend_norm2': [4800, 2400],
                   'if_v7_crn_ew_norm2': [4800, 2400],
                   ...
                   'ic_v7unifac_crn_trend_norm2' : [4800, 2400],
                   'ic_v7_crn_ew_norm2': [4800, 2400],
    
                   'im_v1unifac_crn_norm2': [4800, 2400],
                   'im_v1unifac_crn': [4800, 2400],
                   'im_v1unifac_orig_norm2': [4800, 2400],
                   'im_v1unifac_orig': [4800, 2400],
                   'im_v1unifac_crn_trend_norm2': [4800, 2400], 
                   'im_v1_crn_ew_norm2': [4800, 2400], 
                    }
...
lstm_dict = {
                   ...
                   'if_v7c_orig': 10, 
                   'if_v7_crn': 10,
                   'if_v7_crn_trend_norm2': 10,
                   'if_v7_crn_ew_norm2': 10,
                   ...
                   'ic_v7unifac_orig': 10,
                   'ic_v7unifac':10,
                   'ic_v7unifac_crn_trend_norm2' : 10,
                   'ic_v7_crn_ew_norm2': 10,
                   
                   'im_v1unifac_crn': 10,
                   'im_v1unifac_crn_norm2': 10,
                   'im_v1unifac_orig': 10,
                   'im_v1unifac_orig_norm2': 10,
                   'im_v1unifac_crn_trend_norm2': 10, 
                   'im_v1_crn_ew_norm2': 10, 
                    }
...
vol_dict = {       'if_v7c': 30,
                   ...
                   'if_v7c_orig': 0, 
                   'if_v7_crn': 0,
                   'if_v7_crn_trend_norm2': 0,
                   'if_v7_crn_ew_norm2': 0,
                   ...
                   'ic_v7unifac_orig': 0, 
                   'ic_v7unifac': 30,
                   'ic_v7unifac_crn_trend_norm2' : 0,
                   'ic_v7_crn_ew_norm2': 0,
                
                   'im_v1unifac_crn': 0,
                   'im_v1unifac_crn_norm2': 0,
                   'im_v1unifac_orig': 0,
                   'im_v1unifac_orig_norm2': 0,
                   'im_v1unifac_crn_trend_norm2': 0, 
                   'im_v1_crn_ew_norm2': 0, 
                    }
...
pos_dict['if_v7_crn_trend_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]

pos_dict['if_v7_crn_ew_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]
...
pos_dict['if_v7_crn_norm2'] =[[0.0,  0.08, 0.16, 0.63, 0.69, 0.75, 0.82],
                              [0.08, 0.16, 0.63, 0.69, 0.75, 0.82, 100.0],
                              [0,    0,    0,    2.5,  5,    7.5,  10],
                              [0,    5,    10,   10,   10,   10,   10]]
...
pos_dict['ic_v7unifac_crn_trend_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]

pos_dict['ic_v7_crn_ew_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]
...
pos_dict['ic_v7unifac_crn_norm2'] =[[0.0,  0.08, 0.16, 0.63, 0.69, 0.75, 0.82],
                              [0.08, 0.16, 0.63, 0.69, 0.75, 0.82, 100.0],
                              [0,    0,    0,    2.5,  5,    7.5,  10],
                              [0,    5,    10,   10,   10,   10,   10]]
...
pos_dict['im_v1unifac_crn_trend_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]

pos_dict['im_v1_crn_ew_norm2'] =[[0.0,  0.01, 0.8],
                              [0.01, 0.8, 100.0],
                              [0,    0,    10],
                              [0,    10,   10]]


pos_dict['im_v1unifac_crn_norm2'] =[[0.0,  0.08, 0.16, 0.66, 0.72, 0.78, 0.85],
                               [0.08, 0.16, 0.66, 0.72, 0.78, 0.85, 100.0],
                               [0,    0,    0,    2.5,  5,    7.5,  10],
                               [0,    5,    10,   10,   10,   10,   10]]
...
savepath = os.path.join('/data/user/015626/data/share/para/Mobius_para/', 'Mobius_' + next_tday)
...
for contract_cat in ['IF.CFE', 'IC.CFE', 'IM.CFE']:
    ...
    for i, mi in enumerate(model_date):
        ...
        # 过滤
        if (filter_bool_dict[contract_cat] == True) and (norm2[i] != 'norm') and ('crn_ew' not in mi) and ('crn_trend' not in mi):
...
#            filter_bool_list.append(1)
            zhege_num = 1
#            if 'im_v1unifac' in mi:
#                zhege_num = 0
#            if 'im_v1unifac_crn' in mi:
#                zhege_num = 1
            filter_bool_list.append(zhege_num)  
        else:
...
#                short_temp = 0
#                if 'IM2509' in future:
#                    short_temp = max(short_temp - 50, 0) 
            except:
                short_temp = 0
            try:
...
#                long_temp = 0
#                if 'IM2509' in future:
#                    long_temp = max(long_temp - 50, 0) 
            except:
                long_temp = 0
            print(future, short_temp, long_temp)
...
#    if 'IM' in contract_cat.upper() or 'IF' in contract_cat.upper():
#        paradict2 = {'合约代码': future_list1,
#                 '平仓优先级': list(range(1, len(future_list1) + 1)),
#                 '卖出交易账户多头持仓': [0] * len(future_list1),
#                 '买入交易账户空头持仓': [0] * len(future_list1)
...
#subprocess.run([__import__('sys').executable, 'gen_para_json.py'])
#lm = link.LinkMessage()
#lm.sendMessage('json para done')
#del lm

subprocess.run([__import__('sys').executable, 'gen_para_json_multipath.py'])
lm = link.LinkMessage()
lm.sendMessage('json para multipath done')
del lm