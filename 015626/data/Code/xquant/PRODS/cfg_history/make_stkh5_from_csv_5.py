...
#csv_rootpath = '/data/group/800466/warehouse/prod/MD/MarketData/MD/TEMP_STOCK/'
csv_rootpath = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/TEMP_STOCK/'
...
def get_stock_from_csv(stock):
    try:
        ...
        #csvlist = [item for item in csvlist if (('2022' in item) or ('202112') in item)]
        if len(csvlist) == 0:
            return
        csvdflist = []
        ...
        finaldf = finaldf[standard_columnslist]
        if len(finaldf) == 0:
            print(stock +'!!!!!!!!!!!!!!!!!!!!!!!!')
...
stock_list = sorted(os.listdir('/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/TEMP_STOCK/'))
stock_list = stock_list[800:1000]
