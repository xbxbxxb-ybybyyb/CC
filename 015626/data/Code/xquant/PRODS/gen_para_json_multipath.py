...
def gen_params_json(tday, zone, dest_path, template_file, variety_str, trade_day, root_data_path, offset_str='00', rank_type='norm2'):
    ...
    if offset_str == '0':
        model_config = {"IC": [{
                "信号编号": 1,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_ic_ic_v7unifac/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 2,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_ic_ic_v7unifac_crn/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
                ...
                "信号编号": 3,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_ic_ic_v7unifac_crn_trend/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 4,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_ic_ic_v7_crn_ew/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
        ...
        , "IF": [{
                "信号编号": 1,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_if_if_v7c/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 2,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_if_if_v7_crn/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
                ...
                "信号编号": 3,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_if_if_v7_crn_trend/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 4,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_if_if_v7_crn_ew/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
        ...
        , "IM": [{
                "信号编号": 1,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_im_im_v1unifac_crn/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 2,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_im_im_v1unifac/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
                ...
                "信号编号": 3,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_im_im_v1unifac_crn_trend/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
            ...
            {
                "信号编号": 4,
                "对应模型目录": f"/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/model/model_trade/{model_date}_im_im_v1_crn_ew/",
                "历史信号文件目录": "",
                "波动率时间窗口": 0,
                "Rank周期1": 4800,
                "Rank周期2": 2400,
