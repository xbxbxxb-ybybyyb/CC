# -*- coding: utf-8 -*-
"""
Created on Mon Aug 29 16:18:49 2022
...
class LinkMessage:
    ...
    def __sendMessage_new(self, msg):
        ...
        if len(success_user_ids) != len(self.user_ids):
            logger.error(
                "铃客漏发消息：expect_user_list={}, actual_user_list={}, msg={}".format(self.user_ids, success_user_ids, msg))
        else:
            logger.info(
