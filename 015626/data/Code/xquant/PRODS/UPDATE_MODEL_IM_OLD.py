...
"""
#20241231
#future + spot, model_list = doubled ~ sample naming: et_cla_future, et_cla_spot 
#fs = future + spot

"""

version_list = ['im_v1unifac', 'if_v7c', 'ic_v7unifac']
model_date_dict = {'ic_prod_v6':'20220715_ic_ic_prod_v6_fix',
                   ...
                   'if_v6nl':'20221230_if_if_v6nl',
                   'ic_v75c':'20230224_ic_ic_v75c',
                   'ic_short_v3c':'20230224_ic_ic_short_v3c',
                   ...
                   'ic_v75unifac':'20240628_ic_ic_v7unifac',
...
roll_name_dict = {'ic_prod_v6':'_r240','if_prod_v5_add':'_r240','ic_short_v1':'_r720',
                  'ic_trade_v1':'_r240','if_v6nl':'_r720','ic_v75unifac':'_r720', 'ic_short_v3c':'_r720',
                  'if_v7c2':'_r720', 'ic_v7unifac':'_r720',
                  'if_v7c':'_r720','ic_v75unifac':'_r720','im_v1unifac':'_r720',
                  'if_v7c':'_r720','ic_v7unifac':'_r720','im_v1unifac':'_r720' }

version_ticker_dict = {'ic_prod_v6':'IC.CFE','if_prod_v5_add':'IF.CFE','ic_short_v1':'IC.CFE',
                       'ic_trade_v1':'IC.CFE','if_v6nl':'IF.CFE','ic_short_v3c':'IC.CFE',
                       'if_v7c':'IF.CFE','ic_v7unifac':'IC.CFE', 'im_v1unifac':'IM.CFE',
                       'if_v7c':'IF.CFE','ic_v7unifac':'IC.CFE','ic_v75unifac':'IC.CFE', 'im_v1unifac':'IM.CFE'}
...
ts_pct_win_dict = {'ic_trade_v1':20*240,'ic_prod_v6':20*240,'if_prod_v5_add':20*240,
                   'ic_short_v1':5*240,'if_v6nl':20*240,'ic_v75c':20*240,'ic_short_v3c':20*240,
                   'if_v7c':20*240,'if_v7c2':20*240,'ic_v75unifac':20*240,
                   'ic_v7unifac':20*240, 'im_v1unifac':20*240,
                   'if_v7c':20*240,'ic_v7unifac':20*240, 'im_v1unifac':20*240} # sub model raw to norm pct_win

ts_pct_win_dict2 = {'ic_trade_v1':10*240,'ic_prod_v6':10*240,'if_prod_v5_add':10*240,
                    'ic_short_v1':5*240,'if_v6nl':10*240,'ic_v75c':10*240,'ic_short_v3c':10*240,
                    'if_v7c':10*240,'if_v7c2':10*240,'ic_v75unifac':10*240, 'ic_v7unifac':10*240, 'im_v1unifac':10*240,
                    'if_v7c':10*240, 'ic_v7unifac':10*240, 'im_v1unifac':10*240} # model stack pct_win
...
model_list_dict = {'ic_trade_v1':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   ...
                   'ic_v75c':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'ic_short_v3c':['et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'if_v7c':['et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'if_v7c2':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'ic_v75unifac':['et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'ic_v7unifac':['et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'im_v1unifac':['et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
...
fac_path_dict= {'ic_trade_v1':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/trade_v1/minute_norm',
                ...
                'ic_v75c':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_prod_v7_2/minute_norm',
                ...
                'if_v7c2':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IF_prod_v7_2/minute_norm',
                'ic_v75unifac':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_prod_v7_2/minute_norm',
                'ic_v7unifac':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_linear_strat2/minute_norm',
...
fac_desc_raw_path_dict = {'ic_trade_v1':'',
                          ...
                          'if_v6nl':'',
                          'ic_v75c':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_nonlinear_diff_zscore/minute_norm',
                          ...
                          'if_v7c2':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IF_nonlinear_diff_zscore/minute_norm',
                          'ic_v75unifac':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_nonlinear_diff_zscore/minute_norm',
...
fac_desc_norm_path_dict = {'ic_trade_v1':'',
                           ...
                           'ic_v75c':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_nonlinear_zscore/minute_norm',
                           ...
                           'if_v7c2':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IF_nonlinear_zscore/minute_norm',
                           'ic_v75unifac':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_nonlinear_zscore/minute_norm',
...
fac_add_path_dict = {'if_v7c':['/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/if_features_new_181_zscore/minute_norm/',
                               '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/if_features_new_181_diff_zscore/minute_norm/'],
                            
                     'if_v7c2':['/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/if_features_new_181_zscore/minute_norm/',
                               '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/if_features_new_181_diff_zscore/minute_norm/'],
                            
                     'ic_v75unifac':['/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IF_prod_v7_2/minute_norm/',
...
comb2_model_list =['lgbm_cla_future', 'lgbm_reg_future', 'mlp_reg_future', 'et_cla_future',
       'lstm_cla_future', 'et_cla_spot', 'lstm_cla_spot', 'lgbm_cla_spot',
       'lgbm_reg_spot', 'mlp_reg_spot']
...
hpr_spec_dict_all = {
                    ...
                    'ic_v75c':{**{i:long_list for i in ['lstm_cla','et_cla']},
                    ...
                    'if_v7c':{**{i:short_list for i in ['lgbm_cla','lgbm_reg','mlp_reg']},
                             **{i:long_list for i in ['et_cla','lstm_cla']}},
                    'if_v7c2':{**{i:short_list for i in ['lasso_reg','lgbm_cla','lgbm_reg','mlp_reg']},
                             **{i:long_list for i in ['lr_cla','et_cla','lstm_cla']}},
                    'ic_v75unifac':{**{i:long_list for i in ['lstm_cla','et_cla']},
                              **{i:short_list for i in ['lgbm_cla','lgbm_reg','mlp_reg']}},
                    'ic_v7unifac':{**{i:long_list for i in ['lstm_cla','et_cla']},
                              **{i:short_list for i in ['lgbm_cla','lgbm_reg','mlp_reg']}},
                    'im_v1unifac':{**{i:long_list for i in ['lstm_cla','et_cla']},
                              **{i:short_list for i in ['lgbm_cla','lgbm_reg','mlp_reg']}},

                    'if_v7c':{**{i:short_list for i in ['lgbm_cla_future','lgbm_reg_future','mlp_reg_future']},
                                 **{i:long_list for i in ['et_cla_future','lstm_cla_future','et_cla_spot','lstm_cla_spot',
                                                          'lgbm_cla_spot','lgbm_reg_spot','mlp_reg_spot']}},
                    'ic_v7unifac':{**{i:short_list for i in ['lgbm_cla_future','lgbm_reg_future','mlp_reg_future']},
                                 **{i:long_list for i in ['et_cla_future','lstm_cla_future','et_cla_spot','lstm_cla_spot',
                                                          'lgbm_cla_spot','lgbm_reg_spot','mlp_reg_spot']}},
                    'im_v1unifac':{**{i:short_list for i in ['lgbm_cla_future','lgbm_reg_future','mlp_reg_future']},
                                 **{i:long_list for i in ['et_cla_future','lstm_cla_future','et_cla_spot','lstm_cla_spot',
                                                          'lgbm_cla_spot','lgbm_reg_spot','mlp_reg_spot']}}}

with_desc_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,'ic_short_v1':True,
                  'if_v6nl':False,'ic_v75c':True,'ic_short_v3c':True,'if_v7c':True, 'if_v7c2':True,
                  'ic_v75unifac':True, 'ic_v7unifac':True, 
                  'im_v1unifac':True,
                  'if_v7c':True, 'ic_v7unifac':True, 'im_v1unifac':True} # nonlinear_raw_factor # for cc rfe rff only

with_desc_norm_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,
                       'ic_short_v1':True,'if_v6nl':True,'ic_v75c':True,'ic_short_v3c':True,'if_v7c':True,'if_v7c2':True,
                       'ic_v75unifac':True, 'ic_v7unifac':True, 'im_v1unifac':True,
                       'if_v7c':True, 'ic_v7unifac':True, 'im_v1unifac':True} # nonlinear_factor_norm

time_step_dict = {**{i:30 for i in ['ic_trade_v1','ic_prod_v6','if_prod_v5_add','ic_short_v1']},
                  **{i:10 for i in ['if_v6nl','ic_v75c','ic_short_v3c','if_v7c','if_v7c2','ic_v75unifac', 'ic_v7unifac', 'im_v1unifac',
                                    'if_v7c','ic_v7unifac','im_v1unifac']}}
min_pct = 0.96
use_update = True
dropna = True
return_itr = True
...
for edate in date_list:
    ...
    for version in version_list:
        ...
        comb1_list = list(set(comb2_model_list))
        ...
        norm_path_dict[factor_name] =os.path.join(pred_norm_root,edate,'%s.pkl'%(factor_name))
        #mlp_cla_list = ['ic_v75unifac/', 'if_v7c/']
        for used_version in mlp_cla_list:
            if used_version in pred_norm_root:               
                comb2_list_final = comb2_list
            else:     
                print('!!!!!!!! MLP_CLA NOT USED !!!!!!!!')         
                comb2_list_final = [item for item in comb2_list if 'mlp_cla' not in item]
        #pred_comb_raw2 = pred_hpr_raw[comb2_list_final].mean(axis=1)
