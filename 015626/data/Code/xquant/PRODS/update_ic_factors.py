...
flist = [x for x in flist if x.__name__ not in slow_factors]
...
print('------wait slow factors flag')
while True:
    flag_slow_success = flag_path + str(date) + '_' + '%s_slow.success' % str.lower(kind)
    if os.path.exists(flag_slow_success):
        break
    time.sleep(60)  
