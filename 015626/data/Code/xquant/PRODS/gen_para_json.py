...
# 父目录路径（根据交易日期生成）
parent_dir = f"/data/user/015626/data/share/para/Mobius_para/{current_date}"
# 模型参数生成所需模板文件，非常重要，需要修改
template_path = '/data/user/015626/data/share/para/Mobius_para/gen_mobius_params/template/model/'  # 需要修改
# 模型参数保存路径
dest_model_path = '/data/user/015626/data/share/para/Mobius_para/'   # 需要修改 

excel_dict = {"IM": f"/data/user/015626/data/share/para/Mobius_{current_date}/MobiusStrategy_IM_{current_date}#503103.xlsx",
              "IF": f"/data/user/015626/data/share/para/Mobius_{current_date}/MobiusStrategy_IF_{current_date}#503102.xlsx",
              "IC": f"/data/user/015626/data/share/para/Mobius_{current_date}/MobiusStrategy_IC_{current_date}#503101.xlsx"}
