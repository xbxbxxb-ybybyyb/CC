...
di_cszj_cat['IF.CFE'] = 1.5e8 / 10000000
di_cszj_cat['IC.CFE'] = 2.5e8 / 10000000
di_cszj_cat['IM.CFE'] = 3e8 / 10000000
...
future_list_ic = 'IC2501.CF,IC2503.CF'
kcbl_list_ic = '1:0'
future_list_if = 'IF2501.CF,IF2503.CF'
kcbl_list_if = '1:0'
future_list_im = 'IM2501.CF,IM2503.CF'
kcbl_list_im = '1:0'
...
model_date_dict = {
                   ...
                   #'if_v7_crn': '20240628_if_if_v7_crn',
                   'if_v7c_orig_norm2': '20240628_if_if_v7c',
                   'if_v7_crn_norm2': '20240628_if_if_v7_crn',
                   
                   #'ic_v7c': '20230224_ic_ic_v7c',
                   'ic_v7unifac_crn_norm2': '20240628_ic_ic_v7unifac_crn',
                   ...
                   'im_v1unifac_crn_norm2': '20240628_im_im_v1unifac_crn',
...
pos_dict['im_v1unifac_crn_norm2'] =[[0.0,  0.07, 0.15, 0.73,  0.78, 0.83,  0.89],
                                    [0.07, 0.15, 0.73,  0.78, 0.83,  0.89, 100.0],
                                    [0,    0,    0,    2.5,  5,    7.5,  10],
                                    [0,    5,    10,   10,   10,   10,   10]]
...
for contract_cat in ['IF.CFE', 'IC.CFE', 'IM.CFE']:
    ...
    if sim == True:
        ...
        writer = pd.ExcelWriter(os.path.join(savepath, 'MobiusStrategy_%s.xlsx' % (contract_cat[:-4] + '_' +str(next_tday) + '_old' + machine)))
