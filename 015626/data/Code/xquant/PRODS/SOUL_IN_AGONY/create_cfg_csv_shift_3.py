import os, glob, re
os.system("cp /data/user/016700/__init__.py  /opt/anaconda3/lib/python3.6/site-packages/MDCDataProvider/")
os.system("cp /data/user/016700/MDCDataProvider.ini  /opt/anaconda3/lib/python3.6/site-packages/MDCDataProvider/conf/")
...
#        print(para)
    ...
    tick = tick.sort_values(by = 'MDTime', ascending = True)
    ...
    #transaction = transaction.sort_values(by = 'MDTime')
    ...
    #order = order.sort_values(by = 'MDTime')
...
def update_by_date(date, ticker, ncore = 24):
    ...
    fuck_list = set(os.listdir('/dfs/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/MINUTE_shift_55/')) - set(os.listdir('/dfs/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/MINUTE_shift_50/'))
    fuck_list  = list(fuck_list)
    fuck_list = [item.replace('.h5', '') for item in fuck_list]
    today_uplist = get_target_list(ticker,last_tday,date)
    today_uplist = [item for item in today_uplist if (item[1]) in (fuck_list)] 
    with Pool(ncore) as pool:
...
try:
    ...
    pass
h5_rootpath = '/dfs/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/MINUTE/'
weight_path = '/data/group/800466/warehouse/prod/MD/MarketData/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5'

sdate,edate,cdate_list = check_update_date(20180101, 20180630)
...
#temp_list = pd.read_pickle('/data/user/016700/temp.pkl')
#cdate_list = temp_list[363:]
