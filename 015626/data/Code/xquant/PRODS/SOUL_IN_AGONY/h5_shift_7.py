...
try:
    ...
    pass
h5_rootpath = '/dfs/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/MINUTE_shift_%s/'%str(ss)
...
weight_path = '/data/group/800466/warehouse/prod/MD/MarketData/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5'
_ = get_target_list('IF.CFE', '20211101', '20220110') + get_target_list('IC.CFE', '20211101', '20220110') + get_target_list('IM.CFE', '20211101', '20220110')
_11 = pd.DataFrame(_)
