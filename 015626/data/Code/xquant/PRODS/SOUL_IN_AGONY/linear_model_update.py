...
_,eedate,date_list = check_update_date(20230628, 20230630)
...
model_date_dict = {'ic_prod_v6':'20220715_ic_ic_prod_v6_fix',
                   ...
                   'if_v7c':'20230428_if_if_v7c',
                   'if_v7c2':'20230120_if_if_v7c2',
                   'ic_v7unifac':'20230428_ic_ic_v7unifac',
                   'im_v1unifac':'20230428_im_im_v1unifac'
                }
...
version_ticker_dict = {'ic_prod_v6':'IC.CFE','if_prod_v5_add':'IF.CFE','ic_short_v1':'IC.CFE',
                       ...
                       'if_v7c':'IF.CFE','if_v7c2':'_r720','ic_v7unifac':'IC.CFE','im_v1unifac':'IM.CFE' }
...
ts_pct_win_dict = {'ic_trade_v1':20*240,'ic_prod_v6':20*240,'if_prod_v5_add':20*240,
                   ...
                   'if_v7c':20*240,'if_v7c2':20*240,'ic_v7unifac':20*240,'im_v1unifac':20*240} # sub model raw to norm pct_win
...
ts_pct_win_dict2 = {'ic_trade_v1':10*240,'ic_prod_v6':10*240,'if_prod_v5_add':10*240,
                    ...
                    'if_v7c':10*240,'if_v7c2':10*240,'ic_v7unifac':10*240, 'im_v1unifac':10*240 } # model stack pct_win
...
model_list_dict = {'ic_trade_v1':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   ...
                   'if_v7c':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'if_v7c2':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'ic_v7unifac':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg'],
                   'im_v1unifac':['lasso_reg','lr_cla','et_cla','lgbm_cla','lgbm_reg','lstm_cla','mlp_reg']}
...
hpr_spec_dict_all = {
                    ...
                    'if_v7c':{**{i:short_list for i in ['lasso_reg','lgbm_cla','lgbm_reg','mlp_reg']},
...
with_desc_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,'ic_short_v1':True,
                  'if_v6nl':False,'ic_v7c':True,'ic_short_v3c':True,'if_v7c':True, 'if_v7c2':True,'ic_v7unifac':True, 
...
with_desc_norm_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,
                       'ic_short_v1':True,'if_v6nl':True,'ic_v7c':True,'ic_short_v3c':True,'if_v7c':True,'if_v7c2':True,
                       'ic_v7unifac':True, 'im_v1unifac':True} # nonlinear_factor_norm

time_step_dict = {**{i:30 for i in ['ic_trade_v1','ic_prod_v6','if_prod_v5_add','ic_short_v1']},
                  **{i:10 for i in ['if_v6nl','ic_v7c','ic_short_v3c','if_v7c','if_v7c2','ic_v7unifac', 'im_v1unifac']}}
min_pct = 0.96
use_update = True
dropna = True
return_itr = True
...
for edate in date_list:
    ...
    for version in version_list:
        ...
        norm_path_dict[factor_name] =os.path.join(pred_norm_root,edate,'%s.pkl'%(factor_name))
        #mlp_cla_list = ['ic_v7unifac/', 'if_v7c/']
