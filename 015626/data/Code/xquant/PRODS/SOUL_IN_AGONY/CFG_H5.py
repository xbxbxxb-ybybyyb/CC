...
rootpath = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/CSV/MINUTE/CHINA_STOCK/tick_transaction_order_tominute_v5/'
try:
    os.makedirs('/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/CSV/MINUTE/CHINA_STOCK/tick_transaction_order_tominute_v5/')
except:
    pass
h5_rootpath = '/dfs/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/'
...
print(index_ret_50.index[0], index_ret_50.index[-1])
print(index_ret_300.index[0], index_ret_50.index[-1])
print(index_ret_500.index[0], index_ret_50.index[-1])
print(index_ret_1000.index[0], index_ret_50.index[-1])

weight_path = '/data/group/800466/warehouse/prod/MD/MarketData/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5'
_ = get_target_list('IF.CFE', '20170101', '20250109') + get_target_list('IC.CFE', '20170101', '20250109') + get_target_list('IM.CFE', '20170101', '20250109')
_11 = pd.DataFrame(_)
...
for stock in ['600941.SH']:
    ...
    hholder = [itemm for itemm in hholder if type(itemm) == pd.DataFrame]
