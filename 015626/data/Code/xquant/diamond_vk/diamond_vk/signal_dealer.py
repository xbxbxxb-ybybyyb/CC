...
#            signal_temp = signal_temp * 2
        trade_money_per_contract = min(TRADING_PLAN['init_money'] * signal_temp, TRADING_PLAN['total_money_limit'])
...
def signal_dealer(factor_series, index_prices, recent_contract, season_contract, volume_limit_dict, settlement_ratio_dict):
    ...
    return trading_plan_1_0, trading_plan_2_0, trading_plan_2_0_05
