...
#tday = 20230101 
for x in [('IF_prod_v7_2','IF.CFE'), ('IC_prod_v7_2','IC.CFE'), ('IM_factors','IM.CFE')]:
    libname = x[0]
    ticker = x[1]
    print(x)
    ...
    save_image = True
    show_image = False
    savepath = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/Archives/factor_report/' + libname 
