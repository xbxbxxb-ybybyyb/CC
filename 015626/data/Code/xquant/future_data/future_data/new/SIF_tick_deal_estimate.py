...
def get_deal_px_vol(para):
    ...
    date = para[0]
    contract = para[1]
    if os.path.exists('/data/user/015626/data/share/MD/CHINA_FUTURES/TICK/RECENT_MONTH_with_deal_estimate/IC_CFE/%s.csv' % date):
        return
    print(para)
    ...
    tickdf.to_csv('/data/user/015626/data/share/MD/CHINA_FUTURES/TICK/RECENT_MONTH_with_deal_estimate/IC_CFE/%s.csv' % date)

univ = IO.read_data([20230627,20240530], columns = ['contract_00'], alt = '/data/user/015626/data/share/MD/CHINA_FUTURES/daily/MD_STOCK_INDEX_FUTURES_UNIVERSE.h5')
univ = univ.xs('IC.CFE', level = 1).reset_index()
