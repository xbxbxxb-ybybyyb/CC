...
md = IO.read_data([20200101,20230101], columns = ['close'], alt = '/data/group/800080/warehouse/prod/MD/CHINA_STOCK/DAILY/WIND/MD_CHINA_STOCK_DAILY_WIND.h5')
...
_,_,cdate_list1 = check_update_date(20200101,20210101)
