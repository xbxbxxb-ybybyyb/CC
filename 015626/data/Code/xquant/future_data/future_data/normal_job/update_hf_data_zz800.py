...
def retrieve_stopping_by_date(date, save_root_path = '/arch0/group/800466/warehouse/prod/MD/CHINA_STOCK_STOPPING/'):
    print(date, ' start retrieve')
    iw = IO.read_data([date],columns=['close'], alt = '/data/user/015626/data/share/MD/CHINA_STOCK/daily/CHINA_STOCK_STOPPING.h5')
    stock_list = iw.index.get_level_values(1).tolist()
...
sdate,edate,cdate_list = check_update_date(20210709, 20220209)
