...
def get_5mins_bidask_54_58(path):
    ...
    afternoon = csvdf.loc[(idx.hour == 14) & (idx.minute >= 54) & (idx.minute <= 58)].mean().to_frame().T.add_suffix('_pm')
    result = morning.join(afternoon)
...
with Pool(processes = 16) as pool:
    dflist = pool.map(get_5mins_bidask_54_58, pathlist)
...
IO.pd_hdf5_writer(r, '/data/user/015626/data/share/MD/CHINA_FUTURES/daily/overnight_ret_5mins_54_58.h5', dataset='overnight_ret_5mins')
