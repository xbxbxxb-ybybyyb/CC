...
def select_index(adf):
    ...
    t5 = adf.loc[(idx.hour == 9) & (idx.minute == 25)]
    ...
    t = t5.append(t1).append(t2).append(t3).append(t4)
    t = t.sort_index()
    return t
...
with Pool(processes = 24) as pool:
    ...
    df20 = finaldf.loc[finaldf.index.get_level_values(0) >= pd.to_datetime('20161201')]
...
picklesavename = ticker[:2] + '_cfg_data_1612_now.pkl'
...
save_pickle(df20dict, '/data/user/015626/data/share/LOCAL_DATA/for_wsc/cfg_925_930/' + picklesavename)
