...
pickle_path = '/data/group/800080/warehouse/prod/LOCAL_DATA/CSV/WIND/MINUTE/stock/'
paralist = get_target_list('IF.CFE',20150301,20200401)
...
save_pickle(data_dict, '/data/user/015626/data/warehouse/prod/MD/CHINA_FUTURES/MINUTE/IF_cfg_hf_new_150301_200401.pkl')    
...
df = pd.read_pickle('/data/user/015626/data/warehouse/prod/MD/CHINA_FUTURES/MINUTE/cfg_hf_data/IF_cfg_hf_new_161130_200101_h5.pkl')
...
insample_path = '/data/user/015626/data/share/MD/CHINA_FUTURES/MINUTE/'
outsample_path = '/data/user/015626/data/warehouse/prod/MD/CHINA_FUTURES/MINUTE/OUTSAMPLE/'

df = df.dropna(subset = ['Ticker'])
indf = df.loc['20161201':'20200101']
indf = indf.reset_index().set_index(['dt','Ticker']).sort_index()
indf2 = indf.unstack(level = 1)
data_dict = {}
for col in indf2.columns.get_level_values(0).unique():
    data_dict[col + suffix_dict[ticker]] = indf2[col]
save_pickle(data_dict, os.path.join(insample_path, '%s_cfg_new_hf_data_insample.pkl' % ticker[:2]))
'''