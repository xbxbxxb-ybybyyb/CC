...
# Save Path
# NO '/' AT THE END !
save_path = '/data/user/015626/data/share/LOCAL_DATA/CSV/MINUTE/CHINA_FUTURES/tick_to_15s/ALL_CONTRACT'
...
############################## ----- write h5 ---- ###################################
create_h5_list = ['/data/user/015626/data/share/LOCAL_DATA/CSV/MINUTE/CHINA_FUTURES/tick_to_15s/ALL_CONTRACT/' + x[-19:] for x in updatelist]
