# -*- coding: utf-8 -*-
"""
Created on Fri Sep  4 11:05:04 2020
...
# Save Path
# NO '/' AT THE END !
save_root_path = '/data/user/015626/data/share/LOCAL_DATA/CSV/MINUTE/CHINA_FUTURES/tick_to_minute_no0929/'
save_path_IC = save_root_path + 'IC'
save_path_IF = save_root_path + 'IF'
save_path_IH = save_root_path + 'IH'

begin_date, end_date, cdate_list = check_update_date(20100101,20200919)
