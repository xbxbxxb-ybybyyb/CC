...
def update_cfgdata(para):
    ...
    rootpath = '/data/group/800002/FutureTrader/test/LOCAL_DATA/CSV/MINUTE/CHINA_STOCK/tick_transaction_tominute_v2/'
    csvpath = os.path.join(rootpath, str(date))
    filepath = os.path.join(csvpath, stock+'.csv')
#     if os.path.exists(filepath):
#         return
    h5_rootpath = '/data/group/800002/FutureTrader/test/MD/CHINA_STOCK/MINUTE/'
    ...
    if len(result) < 1200:
        ...
        index_data_300 = IO.read_data([pre20date, tomorrowdate], alt = '/data/group/800002/FutureTrader/test/MD/CHINA_INDEX/MINUTE/000300.SH.h5')
        ...
        index_data_500 = IO.read_data([pre20date, tomorrowdate], alt = '/data/group/800002/FutureTrader/test/MD/CHINA_INDEX/MINUTE/000905.SH.h5')
...
def get_target_list(ticker, startdate, enddate):
    ...
    indexweight = IO.read_data([startdate, enddate],columns = [tickercolumn], alt = '/data/group/800002/FutureTrader/test/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5')
...
def update_by_date(date, ncore = 8):
...
sdate,edate,cdate_list = check_update_date(20210104,20210104)
