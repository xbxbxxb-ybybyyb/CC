...
if __name__ == '__main__':
    handlers = list()
    handlers.append(Process(target=get_futuretick_bydate, args = (20220905,20231124,'MAIN')))
#    handlers.append(Process(target=get_futuretick_bydate, args = (20230427,20231124,'MAIN')))
#    handlers.append(Process(target=get_futuretick_bydate, args = (20220905,20231124,'SECONDMAIN')))
#    handlers.append(Process(target=get_futuretick_bydate, args = (20230427,20231124,'SECONDMAIN')))
