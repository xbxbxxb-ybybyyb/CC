...
#    ic_list = ['IC' + str(a) + '.CFE' for a in range(2201, 2213)]
#    if_list = ['IF' + str(a) + '.CFE' for a in range(2201, 2213)]
#    ih_list = ['IH' + str(a) + '.CFE' for a in range(2201, 2213)]
#    ic_list2 = ['IC' + str(a) + '.CFE' for a in range(2301, 2313)]
#    if_list2 = ['IF' + str(a) + '.CFE' for a in range(2301, 2313)]
#    ih_list2 = ['IH' + str(a) + '.CFE' for a in range(2301, 2313)]
#    wind_code_list = ic_list2 + if_list2 + ih_list2 + ic_list + if_list + ih_list
    year_int = int(time.strftime('%Y%m%d', time.localtime(time.time()))[2:4])
    next_year_int = year_int + 1
    wind_code_list = []
    for x in ['IC','IF','IH','IM']:
        for y in [year_int, next_year_int]:
            wind_code_list += [x + str(a) + '.CFE' for a in range(y * 100 + 1, y * 100 + 13)]
...
a, b, c = check_update_date(None, None)
...
get_futuretick_bydate(clist[-2], clist[-1])
