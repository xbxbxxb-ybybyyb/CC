...
def get_futuretick_bydate(sdate = None, edate = None):
    ...
    ic_list = ['IC'+str(a)+'.CFE' for a in range(1501,1513)]
    if_list = ['IF'+str(a)+'.CFE' for a in range(1501,1513)]
    ih_list = ['IH'+str(a)+'.CFE' for a in range(1501,1513)]
...
get_futuretick_bydate(20140701, 20160101)