...
for ticker in ['IC.CFE']:
    ...
    paralist = get_target_list(ticker,20201201,20220618)
...
#        dflist.append(get_csvdf(para))
    ...
    print('sort done!')
    dfnew.to_pickle('/data/user/015626/data/share/MD/CHINA_FUTURES/10s/zz500_cfg_10s_20201201_20220618.pkl')
    
    insample = dfnew.unstack()
    for col in insample.columns.get_level_values(0).unique():
        insample[col].to_pickle('/data/user/015626/data/share/MD/CHINA_FUTURES/10s/OUTSAMPLE/ZZ500/%s.pkl'%col)
