...
def get_10s(para):
    ...
    ohlcva = tick.groupby('seconds_10s').agg(aggdict_ohlcva)
...
IO.pd_hdf5_writer(df,'/data/user/015626/data/share/MD/CHINA_FUTURES/10s/RECENT_MONTH_FUTURE_10S.h5', dataset='RECENT_MONTH_FUTURE_10S', override = True)