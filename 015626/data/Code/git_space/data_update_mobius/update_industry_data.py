...
from function_tools_data import get_trading_days
...
ROOT_PATH = '/data/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_INDUSTRY/MINUTE'
...
if __name__ == '__main__':
    ...
    flag_root = flag_rootpath + str(b) + '/'
    
    flag_path_success = flag_root + str(b) + '_' + 'INDUSTRY.success'
