# -*- coding: utf-8 -*-
"""
Created on Mon Sep  5 10:45:29 2022
...
class WMAXMIN_1_CC_IF(FutureFactor):
    ...
    def calculate(self, data):
        w = (data['WeightBuyOrderQtySumMean'].values[-20:]) / r(data['WeightSellOrderQtySumMean'].values[-20:])
        df_s = np.nanmax(w, axis = 0)/r(np.nanmin(w, axis = 0))
        df_s = df_s * data['weight'].values[-1]
        hclose = data['close'].iloc[-231:]
