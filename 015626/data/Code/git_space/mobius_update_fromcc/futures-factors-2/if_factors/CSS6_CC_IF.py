...
class CSS6_CC_IF(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'sell_super_lo_quantity', 'sell_super_cancel_lo_quantity', 'weight', 'close']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['sell_super_lo_quantity'].values[-20:]
        temp2 = data['sell_super_cancel_lo_quantity'].values[-20:]
