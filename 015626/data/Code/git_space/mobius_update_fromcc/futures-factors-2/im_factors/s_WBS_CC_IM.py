# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 10:21:53 2022
...
class s_WBS_CC_IM(FutureFactor):
    ...
    def calculate(self, data):
        df_s = data['WeightBuyOrderQtySumMean'].iloc[-25:] / r(data['WeightSellOrderQtySumMean'].iloc[-25:])# * data['weight'].iloc[-24:]
        df_s = (df_s.skew(axis = 0)).values
        hclose = data['close'].values[-21:]
        hret = hclose[1:]/hclose[:-1] - 1
        hret[abs(hret)>10000] = np.nan
        hret = np.nanmean(hret, axis = 0)
