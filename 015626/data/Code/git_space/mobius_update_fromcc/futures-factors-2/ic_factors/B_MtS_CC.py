...
class B_MtS_CC(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'buy_midorder_money', 'buy_smallorder_money', 'stk_index_corr_zz500']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['buy_midorder_money'].values[-10:]
        temp2 = data['buy_smallorder_money'].values[-10:]
