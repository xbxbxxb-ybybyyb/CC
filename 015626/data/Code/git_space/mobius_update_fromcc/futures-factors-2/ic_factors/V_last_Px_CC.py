...
class V_last_Px_CC(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'LastPx_last15s', 'vwap_last15s', 'stk_index_corr_zz500']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['LastPx_last15s'].values[-30:]
        temp2 = data['vwap_last15s'].values[-30:]
