...
model_name_list = [ '%s_im_im_v1unifac_crn_mom'%full_date, '%s_ic_ic_v7unifac_crn_mom'%full_date, '%s_if_if_v7_crn_mom'%full_date]
...
model_date_dict = {
                   ...
                   'ic_v7unifac_crn_mom': '%s_ic_ic_v7unifac_crn_mom'%full_date,
...
version_ticker_dict = {'if_v7_crn':'IF.CFE', 'if_v7c':'IF.CFE', 
                       ...
                       'im_v1unifac_crn': 'IM.CFE', 'im_v1unifac_crn_mom' : 'IM.CFE', 'if_v7_crn_mom': 'IF.CFE', 'ic_v7unifac_crn_mom': 'IC.CFE'}
model_date_use_dict = {
...
_, __, update_date_list = check_update_date(20240409, 20240411)
...
def calc(ud, model_name):
    ...
    # other configuration
    model_name_list = ['crn_cla', 'crn_reg', 'mom_cla', 'mom_reg']
