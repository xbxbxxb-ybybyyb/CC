...
for edate in cdate_list:
    ...
    cash_dict['20240329_if_if_v7c_orig_norm2'] = 2e8
    cash_dict['20240329_if_if_v7_crn_norm2'] = 2e8
    ...
    cash_dict['20240329_im_im_v1unifac_orig_norm2'] = 2.5e8
    cash_dict['20240329_im_im_v1unifac_crn_norm2'] = 2.5e8
    ...
    pos_dict['20240329_im_im_v1unifac_crn_norm2'] = { (0,         0.07): (0.0,       0.0),
                                                (0.07,      0.15):  (0.0/10,   0.5/10),
                                                (0.15,      0.75):  (0.0/10,   1/10),
                                                (0.75,       0.8): (0.25/10,  1.0/10),
                                                (0.8,      0.85):  (0.5/10,   1.0/10),
                                                (0.85,       0.9): (0.75/10,  1.0/10),
                                                (0.9,      100):  (1.0/10,   1.0/10) }
    ...
    for i, model_name in enumerate(model_date_list):
        ...
        if 'v7_crn' not in model_name.lower():
