...
ts_pct_win_dict = {'ic_trade_v1':20*240,'ic_prod_v6':20*240,'if_prod_v5_add':20*240,'ic_short_v1':5*240,'if_v6nl':20*240,'ic_v7c':20*240,'ic_short_v3c':20*240} # sub model raw to norm pct_win
ts_pct_win_dict2 = {'ic_trade_v1':10*240,'ic_prod_v6':10*240,'if_prod_v5_add':10*240,'ic_short_v1':5*240,'if_v6nl':10*240,'ic_v7c':10*240,'ic_short_v3c':10*240} # model stack pct_win
...
fac_path_dict= {'ic_trade_v1':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/trade_v1/minute_norm',
                ...
                'if_v6nl':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/Archives/IF_prod_v6/minute_norm',
                'ic_v7c':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/IC_prod_v7_2/minute_norm',
                'ic_short_v3c':'/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/Archives/IC_short_v3/minute_norm'}
...
with_desc_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,'ic_short_v1':True,'if_v6nl':False,'ic_v7c':True,'ic_short_v3c':True} # nonlinear_raw_factor # for cc rfe rff only
with_desc_norm_dict = {'ic_trade_v1':False,'ic_prod_v6':False,'if_prod_v5_add':False,'ic_short_v1':True,'if_v6nl':True,'ic_v7c':True,'ic_short_v3c':True} # nonlinear_factor_norm

time_step_dict = {**{i:30 for i in ['ic_trade_v1','ic_prod_v6','if_prod_v5_add','ic_short_v1']},
                  **{i:10 for i in ['if_v6nl','ic_v7c','ic_short_v3c']}}
min_pct = 0.96
use_update = True
dropna = True
return_itr = True
...
lm = link.LinkMessage()
lm.sendMessage('ARCHIVE - UPDATE MODEL FINISHED!')
del lm
