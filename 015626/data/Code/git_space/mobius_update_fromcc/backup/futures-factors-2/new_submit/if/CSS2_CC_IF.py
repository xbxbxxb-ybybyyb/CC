...
class CSS2_CC_IF(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'sell_midorder_volume_othermin', 'sell_smallorder_volume_othermin', 'weight', 'close']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['sell_midorder_volume_othermin'].values[-20:]
        temp2 = data['sell_smallorder_volume_othermin'].values[-20:]
