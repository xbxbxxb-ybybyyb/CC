...
class CSS12_CC_IF(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'sell_big_cancel_lo_amount', 'sell_cancel_lo_counts','weight', 'close']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['sell_big_cancel_lo_amount'].values[-20:]
        temp2 = data['sell_cancel_lo_counts'].values[-20:]
