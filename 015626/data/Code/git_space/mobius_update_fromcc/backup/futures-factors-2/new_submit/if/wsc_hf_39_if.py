...
class wsc_hf_39_if(FutureFactor):
    # 用ts_skew(盘口卖单金额/盘口卖单金额, 60)来衡量盘口买卖压，这个因子是卖压越大的股票的平均收益率越高越好
    ...
    def calculate(self, data):
        ...
        factor_init = ts_skew(WeightBuyMoneySumMean / replace_zero(WeightSellMoneySumMean), 60)[-120:]
        ...
        factor_raw = np.nanmean(factor_mask_1, axis=1) - np.nanmean(factor_mask_2, axis=1)
