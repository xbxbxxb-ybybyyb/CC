# -*- coding: utf-8 -*-
"""
Created on Tue Jan 25 18:13:41 2022
...
class wsc_fast7_hf(FutureFactor):
    ...
    def calculate(self, data):
        BuyUniqueOrderNum = data['SellUniqueOrderNum'].values[-3:]
        BuyTradeNum = data['SellTradeNum'].values[-3:]
        ...
        factor_mean = (factor_raw_after_mask2) / r(factor_raw_after_mask)

        return np.mean(factor_mean)
