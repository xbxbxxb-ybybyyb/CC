...
class DataCenter(object):
    ...
    def __init__(self, variety, data_type, instrument_type, data_dict, start_date, end_date, days_past):
        ...
        self.__minute_stock_path = '/data/group/800466/warehouse/prod/MD/MarketData/MD/CHINA_STOCK/MINUTE'
        ...
        self._FUTURES = ['IC','IF','IH','IM']
        self._INDEXES = ['000016.SH','000300.SH','000905.SH','000852.SH']
        self._INDEX_DICT = {'IC':'ZZ500','IF':'HS300','IH':'SH50','IM':'ZZ1000'}
    ...
    def set_index_data(self, index_data2):
        self.__index_data = index_data2
    ...
    def load_stock_data(self):
        ...
        assert 'weight_sh50' not in fields
        if self.__variety == 'IH':
            if 'weight' in fields:
                fields.remove('weight')
                fields.append('weight_sh50')
        ...
        if self.__variety == 'IH':
            if 'weight_sh50' in fields:
                self.get_stock_data()['weight'] = self.get_stock_data()['weight_sh50']
                del(self.get_stock_data()['weight_sh50'])
