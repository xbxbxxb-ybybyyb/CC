...
__all__ = ['DType', 'DFreq', 'DSource', 'UniType', 'MktType', 'FType', 'DTable']
...
class FType(Enum):
    ...
    INDEXWEIGHT                        = 10 # Index Weight Data
...
class DTable(Enum):
    ...
    AShareAuditOpinion            = 25
    AShareManagement              = 26
    AShareFinancialExpense        = 27
    AShareIllegality              = 28
    AShareMajorEvent              = 29
    AShareHolderNumber            = 30
    AShareInsideHolder            = 31
    AShareSalesSegment            = 32
    AShareAnnInf                  = 33
    AShareCapitalization          = 34
    AShareST                      = 35
    AIndexEODPrices               = 36
    CIndexFuturesPositions        = 37
    CBondFuturesPositions         = 38
    ChinaMutualFundAssetPortfolio = 39
    AIndexIndustriesEODCITICS     = 40
    AIndexConsensusData           = 41
    AIndexConsensusRollingData    = 42
    AShareConsensusData           = 43
    AShareConsensusindex          = 44
    AShareConsensusRollingData    = 45
    AShareStockRatingConsus       = 46
    AShareStockConcept            = 47
    AShareEODPrices               = 48
    # SUNTIME Tables
    ...
    DERIVED_barra               = 205
    DERIVED_fundamental_fix     = 206
    DERIVED_blacklist_filter    = 207
    DERIVED_custom_universe     = 208
    DERIVED_RTD                 = 209
    DERIVED_market_descriptor   = 210
    DERIVED_market_base         = 211
    # WIND API
    APIDAILY                    = 301
    APIQUARTERLY                = 302
