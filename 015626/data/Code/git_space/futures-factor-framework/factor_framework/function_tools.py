...
# rootpath = '/arch1/group/800466/MarketData/MD/' #ARCH1数据
rootpath = '/data/group/800466/warehouse/prod/MD/MarketData/MD/'
...
def get_constituent_stock_list(index_type = 'ZZ500', date= None):
    assert index_type in ['ZZ500','HS300','SH50','ZZ1000']
    col_dict = {'ZZ500':'index_weight_zz500','HS300':'index_weight_hs300','SH50':'index_weight_sh50','ZZ1000':'index_weight_zz1000'}
...
def get_all_stocklist_by_period(variety = 'IC', start_date = '20130101', end_date = '20220101'):
    assert variety in ['IC', 'IF', 'IH', 'IM']
    col_dict = {'IC': 'index_weight_zz500', 'IF': 'index_weight_hs300', 'IH': 'index_weight_sh50', 'IM': 'index_weight_zz1000'}
...
def get_universe_contract(variety = 'IC', instrument_type = 'main', date = None):
    assert variety in ['IC','IF','IH', 'IM'], 'variety must be in [IC, IF, IH, IM]'
