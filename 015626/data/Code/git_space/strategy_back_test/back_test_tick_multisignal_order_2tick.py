...
class TS_BACK_TEST:
    ...
    def __init__(self, signal_list, ticker='IC.CFE', start_date = None, end_date = None,
                 ...
                 max_open_value = None, max_deal_volume_in_minute = 60, volume_per_order = 3, volume_tick_num = 2):
        """
        ...
        self.volume_tick_num = volume_tick_num
    ...
    def back_test_singleday(self, date):
        ...
        tickdf['commission_num'] = tickdf['TotalVolumeTrade'].rolling(self.volume_tick_num, min_periods = 1).mean().apply(lambda x:max(min(np.floor(x), self.volume_per_order), 1))
