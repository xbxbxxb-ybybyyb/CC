...
class TS_BACK_TEST:
    ...
    def __init__(self, signal_list, ticker='IC.CFE', start_date = None, end_date = None,
                 ...
                 filter_series = None, filter_open = False, filter_close = False, filter_dist_long_short = False, filter_close_series = None, max_open_value = None):
        """
        ...
        :param filter_close: 是否根据过滤信号平仓
        :param filter_dist_long_short: 过滤信号是否区分多空，当为true时信号需为0/1/-1，当为false时信号需为0/1。
        :param filter_close_series: 指导平仓交易的过滤信号series
