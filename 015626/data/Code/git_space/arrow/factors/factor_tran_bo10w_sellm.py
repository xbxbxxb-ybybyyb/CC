...
class factor_tran_bo10w_sellm(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 'all'
        required_columns = ['transaction_t', 'transaction_t_1', 'tick_t']
        super(factor_tran_bo10w_sellm, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            temp = data_t_1[(data_t_1.TradePrice >= open_px) & (data_t_1.TradeBSFlag == 2)]
