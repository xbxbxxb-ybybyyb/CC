...
trade_root = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/test_samples/Arrow/v2_0_7/arrow_prod/'
...
today_data_root = ''
universe_path = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/test_samples/Arrow/v2_0_7/arrow_prod/universe/arrow_universe.pkl'
...
# model config
model_name = 'model_20240927'
# model_list = ['lr_cla','lasso_reg','lgbm_cla','lgbm_reg','mlp_reg','mlp_cla']
model_list = ['lasso_reg','lgbm_reg','mlp_reg']
stack_model = 'lasso_reg'
model_root = os.path.join('/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/test_samples/Arrow/Arrow-20241008/', model_name)
stack_model_root = os.path.join(model_root, 'stack_model_reg')
model_value_path = os.path.join(trade_root, 'model', 'model_value')

# short model config
short_model_name = 'model_20240927_open'
# model_list = ['lr_cla','lasso_reg','lgbm_cla','lgbm_reg','mlp_reg','mlp_cla']
short_model_list = ['lasso_reg','lgbm_reg','mlp_reg']
short_stack_model = 'lasso_reg'
short_model_root = os.path.join('/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/test_samples/Arrow/Arrow-20241008/', short_model_name)
