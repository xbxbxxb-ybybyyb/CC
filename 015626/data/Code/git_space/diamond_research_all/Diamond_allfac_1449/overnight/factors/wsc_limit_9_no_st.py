...
class wsc_limit_9_no_st(FactorGenerator):
    ...
    def on_bar(self, data_dict):
        ...
        limit_judgement3 = (open_alla_daily_trun == limit_alla_daily)  # 判断股票早盘是否涨停
        limit_judgement4 = (open_alla_daily_trun == stopping_alla_daily)  # 判断股票早盘是否涨停
