...
class wyc_mf6_sbuyvol(FactorGenerator):
    def __init__(self, *args, ts_norm_bars=0, **kwargs):
        required_columns=['buy_smallorder_volume_500']
        
        super(wyc_mf6_sbuyvol, self).__init__(*args, required_columns=required_columns,
    ...
    def on_bar(self, df):
        ...
        factor = buy_small_volume.to_frame()
