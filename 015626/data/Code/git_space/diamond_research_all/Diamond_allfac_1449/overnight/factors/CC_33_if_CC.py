...
class CC_33_if_CC(FactorGenerator):
    def __init__(self, *args, **kwargs):
        
        required_columns=['close_000300.SH', 'volume_000300.SH']

        super(CC_33_if_CC, self).__init__(*args, required_columns=required_columns, ts_norm_method='ts_rank', ts_norm_bars=30, **kwargs)
    ...
    def on_bar(self, data):
        ...
        high = data['close_000300.SH'].between_time(futures_data_morning_begin, datetime.time(hour, minute))

        close = data['volume_000300.SH'].between_time(futures_data_morning_begin, datetime.time(hour, minute))
