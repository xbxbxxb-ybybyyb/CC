...
class wsc_limit_20(FactorGenerator):
    ...
    def on_bar(self, data_dict):
        ...
        limit_judgement3 = (open_alla_daily_0930 == limit_alla_daily)  # 判断截止到0930，股票是否涨停
        limit_judgement4 = (open_alla_daily_0930 == stopping_alla_daily)  # 判断截止到0930，股票是否跌停
