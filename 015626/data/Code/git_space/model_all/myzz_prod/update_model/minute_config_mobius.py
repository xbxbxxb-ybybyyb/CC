...
# suffix_list = ['if_v7c', 'ic_v7unifac', 'im_v1unifac', 'if_v7c_spot', 'ic_v7unifac_spot', 'im_v1unifac_spot']

####################################################################################################

fac_base = '/data/user/015626/model/mobius_prod_zz/factor/minute'
pred_res_root = '/data/user/015626/model/mobius_prod_zz/pred_index'

check_flag = False
ftypes = ['GEN_MODEL_FACTORS']
flag_path_mobius = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/FLAGS'
flat_path_model = '/data/user/015626/model/flag'
flag_gap = 60 * 5
