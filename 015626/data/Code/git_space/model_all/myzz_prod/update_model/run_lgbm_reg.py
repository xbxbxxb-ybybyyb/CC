...
from strategy.fitting_model import pred_fit_lgbm_reg_kf, get_train_test_sample, set_seed
...
for suffix in suffix_list:
    ...
    if shuffle:
        ...
        param = {'reg_alpha': 0.1,
                 ...
                 'n_jobs': 24,
                 'random_state': 2018}
    fit_pred_func = partial(pred_fit_lgbm_reg_kf, param=param, fold_num=fold_num,
                            verbose=verbose, track_feature_importance=track_feature_importance,
                            return_score=return_score, return_model=return_model, return_misc=return_misc,
                            plot_model=plot_model, shuffle=shuffle)
