...
def main():
    ...
    dat_root = '/dfs/user/015626/model/mobius_prod_zz'

    path_id = '55'
    version_list = ['if_v7c_fs', 'ic_v7unifac_fs', 'im_v1unifac_fs']
    model_date_dict = {
        'if_v7c_fs': f'20241213_if_if_v7c_fs_{path_id}',
        'ic_v7unifac_fs': f'20241213_ic_ic_v7unifac_fs_{path_id}',
        'im_v1unifac_fs': f'20241213_im_im_v1unifac_fs_{path_id}',
    }
    ts_pct_win_dict = {
        'if_v7c_fs': 20 * 240,
    ...
    fac_path_dict = {
        ...
        'if_v7c_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IF_shift_{path_id}/if_ever/minute_norm',
        'ic_v7unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IC_shift_{path_id}/ic_unifac_ever/minute_norm',
        'im_v1unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IM_shift_{path_id}/im_unifac_ever/minute_norm',
    }
    fac_desc_raw_path_dict = {
        'if_v7c_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IF_shift_{path_id}/nonlinear/minute_norm',
        'ic_v7unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IC_shift_{path_id}/nonlinear/minute_norm',
        'im_v1unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IM_shift_{path_id}/nonlinear/minute_norm',
    }
    ...
    with_desc_dict = {
        'if_v7c_fs': False,
        'ic_v7unifac_fs': False,
        'im_v1unifac_fs': False,
    }
    with_desc_norm_dict = {
        'if_v7c_fs': False,
        'ic_v7unifac_fs': False,
    ...
    dummy_path_dict = {
        'if_v7c_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IF_shift_{path_id}/dummies/minute_norm',
        'ic_v7unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IC_shift_{path_id}/dummies/minute_norm',
        'im_v1unifac_fs': f'/data/group/800466/warehouse/test/alpha/CHINA_FUTURES/MINUTE/IM_shift_{path_id}/dummies/minute_norm',
    }
    fac_add_path_dict = {
    ...
    for version in version_list:
        ...
        dummy_path = dummy_path_dict[version]
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_mobius_20241213 (data zz)')
