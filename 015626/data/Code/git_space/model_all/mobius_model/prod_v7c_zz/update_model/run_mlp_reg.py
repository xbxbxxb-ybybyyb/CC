...
from strategy.fitting_model import pred_fit_mlp_reg, get_train_test_sample, set_seed
...
for suffix in suffix_list:
    ...
    fit_pred_func = partial(pred_fit_mlp_reg, fold_num=fold_num, params=params, verbose=verbose, return_score=return_score,
                            return_misc=return_misc, plot_model=plot_model, track_feature_importance=track_feature_importance,
                            return_model=return_model, use_generator=True, rlrop_param=rlrop_param,
                            shuffle=shuffle)
