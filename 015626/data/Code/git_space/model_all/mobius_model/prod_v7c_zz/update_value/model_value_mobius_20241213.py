...
def main():
    ...
    dat_root = '/data/user/020529/share/mobius_prod_zz'

    version_list = ['if_v7c_fs', 'ic_v7unifac_fs', 'im_v1unifac_fs']
    model_date_dict = {
        'if_v7c': '20241213_if_if_v7c',
        'ic_v7unifac': '20241213_ic_ic_v7unifac',
        'im_v1unifac': '20241213_im_im_v1unifac',

        'if_v7c_fs': '20241213_if_if_v7c_fs',
        'ic_v7unifac_fs': '20241213_ic_ic_v7unifac_fs',
        'im_v1unifac_fs': '20241213_im_im_v1unifac_fs',
    }
    ts_pct_win_dict = {
        'if_v7c': 20 * 240,
        'ic_v7unifac': 20 * 240,
