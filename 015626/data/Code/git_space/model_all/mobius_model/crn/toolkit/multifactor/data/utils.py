...
from toolkit.multifactor.IO import IO
from toolkit.multifactor.IO.IO_enums import *
...
def get_current_date(new_date_time=18):
    ...
    nearest_date = min(fdate_list, key=lambda x: abs(x - current_date) if x <= current_date else 10000)
