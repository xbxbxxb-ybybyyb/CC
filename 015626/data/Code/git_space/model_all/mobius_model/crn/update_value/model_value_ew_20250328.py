...
def main():
    ...
    strategy = '20250328_if_if_v7_crn_ew'
    ...
    strategy = '20250328_ic_ic_v7_crn_ew'
    model_times = {'crn_ew': [1]}
    num_models = 1 * 5  # num_seeds x num_folds(5)
    ...
    strategy = '20250328_im_im_v1_crn_ew'
    model_times = {'crn_ew': [1]}
    num_models = 1 * 5  # num_seeds x num_folds(5)
...
def generate_flags(date):
    flag_path = f'/data/user/020529/share/flag/{date}/model_value_ew_20250328.success'
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_ew_20250328')
