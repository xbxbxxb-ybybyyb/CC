...
def main():
    ...
    strategy = '20241213_if_if_v7_crn_trend'
    model_times = {
        'crn_trend_cla': [10, 20, 30],
        'crn_trend_reg': [10, 20, 30],
    }
    ...
    strategy = '20241213_ic_ic_v7unifac_crn_trend'
    model_times = {
        'crn_trend_cla': [10, 20, 30],
        'crn_trend_reg': [10, 20, 30],
    }
    ...
    strategy = '20241213_im_im_v1unifac_crn_trend'
    model_times = {
        'crn_trend_cla': [10, 20, 30],
        'crn_trend_reg': [10, 20, 30],
    }
    ...
    strategy = '20241213_if_if_v7_crn_ew'
    model_times = {'crn_ew': [1]}
    num_models = 1 * 5  # num_seeds x num_folds(5)
    factor_root = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/if_ever/minute_norm'
    assert strategy.split('_')[0] == model_date
    update_model(strategy, model_times, num_models, factor_root, model_root, value_root, trade_date_list)

    strategy = '20241213_ic_ic_v7_crn_ew'
    model_times = {'crn_ew': [1]}
    num_models = 1 * 5  # num_seeds x num_folds(5)
    factor_root = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/ic_unifac_ever/minute_norm'
    assert strategy.split('_')[0] == model_date
    ...
    strategy = '20241213_im_im_v1_crn_ew'
    model_times = {'crn_ew': [1]}
    num_models = 1 * 5  # num_seeds x num_folds(5)
    factor_root = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/im_unifac_ever/minute_norm'
    assert strategy.split('_')[0] == model_date
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_trend_20241213 (data)')
