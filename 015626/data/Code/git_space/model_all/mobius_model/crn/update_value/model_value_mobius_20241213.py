...
def main():
    ...
    strategy = '20241213_if_if_v7_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
    ...
    strategy = '20241213_ic_ic_v7unifac_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
        'crn_spot_cla': [10, 20, 30],
    ...
    strategy = '20241213_im_im_v1unifac_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
        'crn_spot_cla': [10, 20, 30],
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_mobius_20241213 (data)')
