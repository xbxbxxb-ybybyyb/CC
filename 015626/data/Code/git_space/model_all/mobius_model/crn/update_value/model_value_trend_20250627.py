...
def main():
    ...
    strategy = '20250627_if_if_v7_crn_trend'
    model_times = {
    ...
    strategy = '20250627_ic_ic_v7unifac_crn_trend'
    model_times = {
        'crn_trend_cla': [10, 20, 30],
        'crn_trend_reg': [10, 20, 30],
    }
    ...
    strategy = '20250627_im_im_v1unifac_crn_trend'
    model_times = {
        'crn_trend_cla': [10, 20, 30],
        'crn_trend_reg': [10, 20, 30],
    }
...
def generate_flags(date):
    flag_path = f'/data/user/020529/share/flag/{date}/model_value_trend_20250627.success'
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_trend_20250627')
