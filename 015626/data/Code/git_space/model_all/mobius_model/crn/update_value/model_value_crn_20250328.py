...
def main():
    ...
    strategy = '20250328_if_if_v7_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
    ...
    strategy = '20250328_ic_ic_v7unifac_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
        'crn_spot_cla': [10, 20, 30],
    ...
    strategy = '20250328_im_im_v1unifac_crn'
    model_times = {
        'crn_cla': [1, 5, 10],
        'crn_reg': [1, 5, 10],
        'crn_spot_cla': [10, 20, 30],
...
def generate_flags(date):
    flag_path = f'/data/user/020529/share/flag/{date}/model_value_crn_20250328.success'
...
if __name__ == '__main__':
    ...
    try:
        ...
        traceback.print_exc()
        link.LinkMessage().sendMessage('Error: model_value_crn_20250328')
