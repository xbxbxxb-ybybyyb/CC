...
def main(need_train=True, need_onnx=True, need_value=True, xy_exists=False):
    ...
    bgn_date = '20231001'
    end_date = '20240101'
    factor_root_name = 'IC_unifac_ever'
    factor_list_name = 'ic_v8uf'
    ...
    logger = LoggerMyself(f'{ticker}_{model_name}_{bgn_date}_{end_date}.log', os.path.join(log_path, 'update_model'))
    ...
    if need_value:
        ...
        logger.info('sig value dumps', outputs='both')


if __name__ == '__main__':
    main(need_train=False, need_onnx=False, need_value=True, xy_exists=True)
