...
class fac_34_orig_1min_df_10x_(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = 5 * freq
        self.required_columns = ['close', 'open', 'high', 'low']
        self.normalize_size = int(30 * self.bars_dict[ticker] / self.freq)
    ...
    def calculate(self, data):
        ...
        self.t_pcor2_list = self.t_pcor2_list[-1000:]
        
        return ema_1(self.t_pcor2_list, 1000, 1/451)
        
    def pre_calculate(self, data):
        self.t_pcor2_list = []
        mean_num = 50
        for i in range(1050, -1, -1):
            if i == 0:
