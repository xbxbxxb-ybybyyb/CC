...
class fac_54_df_20x_noroll_(FutureFactor):
    ...
    def calculate(self, data):
        ...
        price_level = rolling_normalize_array(twap,5400)

        price_std = move_std_bk(rtn, window = 160, min_count = 5, ddof = 1)
