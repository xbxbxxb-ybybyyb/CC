...
class fac_80_adj_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(540/ self.bars_dict[self.ticker])) * freq)
        self.required_columns = ['buy_small_volume', 'sell_small_volume', 'close', 'BidAskSpreadMean', 'buy_active', 'sell_active']
    ...
    def calculate(self, data):
        ...
        fac = (data['buy_small_volume'][-540:] / r(data['buy_active'][-540:]) - data['sell_small_volume'][-540:] / r(data['sell_active'][-540:]))
