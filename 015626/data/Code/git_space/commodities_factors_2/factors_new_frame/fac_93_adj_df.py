...
class fac_93_adj_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(1831 / self.bars_dict[self.ticker])) * freq)
        self.required_columns = [ 'buy_small_volume', 'BidAskSpreadMean', 'close', 'sell_small_volume']
    ...
    def calculate(self, data):
        ...
        fac1 = data['buy_small_volume'][-900:] - data['sell_small_volume'][-900:]
