...
class fac_39_aug_orig_1min_df_5x_noroll_(FutureFactor):
    ...
    def calculate(self, data):
        ...
        close = data['close_secmain'][-711:]

        high = data['high_secmain'][-711:]

        rtn = close[ccc:] - close[:-ccc]
        ...
        co = cross_hub_num_array(close[-(aa * 4 + 10):], aa * 2) + 1

        ret = close[-1] - nanmax_np(high[:-ccc][-aa:])
    ...
    def pre_calculate(self, data):
        ...
        for i in range(bb*3 + 5, -1, -1):
            ...
            if i == 0:
                ...
                close = data['close_secmain'][-(711+i):-i]

                high = data['high_secmain'][-(711+i):-i]
