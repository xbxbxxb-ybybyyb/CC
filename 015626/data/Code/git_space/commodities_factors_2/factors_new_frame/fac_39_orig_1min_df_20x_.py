...
class fac_39_orig_1min_df_20x_(FutureFactor):
    ...
    def calculate(self, data):
        ...
        close = data['close_secmain'][-4900:]

        high = data['high_secmain'][-4900:]
    ...
    def pre_calculate(self, data):
        ...
        for i in range(bb*3+ 5, -1, -1):
            ...
            if i == 0:
                ...
                close = data['close_secmain'][-(4900+i):-i]

                high = data['high_secmain'][-(4900+i):-i]         
