...
class fac_95_adj_df(FutureFactor):
    ...
    def calculate(self, data):
        ...
        fac_high = nanmax_np(dhigh[localhigh:])
        fac_low = nanmin_np(dlow[localhigh:])
    ...
    def pre_calculate(self, data):
        ...
        for i in range(41, -1, -1):
            if i == 0:
                ...
                dlow = data['low'][-751 - i:]
                dhigh = data['high'][-751 - i:]
    
            else:
                hclose = data['close'][-751 - i: -i]
                ba = data['BidAskSpreadMean'][-30 - i: -i]
                dlow = data['low'][-751 - i: -i]
                dhigh = data['high'][-751 - i: -i]
