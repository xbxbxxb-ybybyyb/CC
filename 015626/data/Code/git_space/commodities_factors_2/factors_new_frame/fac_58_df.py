...
class fac_58_df(FutureFactor):
    ...
    def calculate(self, data):        
        ...
        volume_sum = move_sum_bk(volume,window = 6, min_count = 3)

        mf_sum = move_sum_bk(mf, window = 6, min_count = 3)
        ...
        score_raw1 = nanmean_np(vwap_diff[-4:])

        co = cross_hub_num_array(close[-50:],20) + 1
