...
class fac_55_orig_1min_df(FutureFactor):
    ...
    def calculate(self, data):
        ...
        low_mean = move_mean_bk(low,window = 5,min_count = 1)[-120:]
        ...
        factor = ema_1(self.prefactor_list[-60:],60,1/21)
