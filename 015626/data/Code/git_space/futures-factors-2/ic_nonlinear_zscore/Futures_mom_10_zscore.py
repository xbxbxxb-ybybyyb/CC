# -*- coding: utf-8 -*-
"""
Created on Fri Jan 28 10:01:29 2022
...
class Futures_mom_10_zscore(FutureFactor):
    ...
    def calculate(self, data):
        hclose = data['close_cont_IC'].iloc[-11:].values
        
        factor = np.nanmean(hclose[1:] / hclose[:-1] - 1)
