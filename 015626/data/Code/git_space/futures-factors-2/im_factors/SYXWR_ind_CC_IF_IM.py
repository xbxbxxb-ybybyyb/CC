...
class SYXWR_ind_CC_IF_IM(FutureFactor):
    ...
    def calculate(self, data):
        hopen = (data['open_000852.SH'].values)[-150:]
        hhigh = (data['high_000852.SH'].values)[-150:]
        hlow = (data['low_000852.SH'].values)[-150:]
        hclose = (data['close_000852.SH'].values)[-150:]
