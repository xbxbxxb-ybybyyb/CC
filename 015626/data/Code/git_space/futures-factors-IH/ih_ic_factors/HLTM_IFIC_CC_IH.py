...
class HLTM_IFIC_CC_IH(FutureFactor):
    
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Continuous_Data'] = {'IH':['high','low', 'vwap']} 
    normalize_size = 1200
    ...
    def calculate(self, data):
        hlow = (data['low_cont_IH'].values)[-60:]
        hhigh = (data['high_cont_IH'].values)[-60:]
        vwap =(data['vwap_cont_IH'].values)[-60:]
