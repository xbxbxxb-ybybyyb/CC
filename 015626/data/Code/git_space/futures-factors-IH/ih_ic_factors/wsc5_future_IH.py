...
class wsc5_future_IH(FutureFactor):
    data_type = 'Future'
    days_past = 5
    data_dict = dict()
...
#    num_range = '(-0.5,1]'
    ...
    def calculate(self, data):
        future_close = data['close_cont_IH'].values[-1140:]
        future_high = data['high_cont_IH'].values[-1140:]
        future_low = data['low_cont_IH'].values[-1140:]
        N = 45
