...
class wyc_ts6_future_nr_cr_IH(FutureFactor):
    data_type = 'IndexStock' 
    instrument_type = 'recent'
    days_past = 12
    data_dict = dict()
    data_dict['Stock'] = ['close', 'stk_index_corr_sh50', 'high', 'low', 'volume', 'adjfactor'] 
...
#    num_range = '[0,1]'
    ...
    def calculate(self, df):
        ...
        cr = (2 * df['stk_index_corr_sh50'].rank(axis=1, pct=True) - 1).values[-120:]
        factor = factor * cr
