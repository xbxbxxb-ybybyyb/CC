...
class wyc_ts6_spot_IH(FutureFactor):
    ...
    def calculate(self, df):
        a = (df['high_000016.SH'] - df['low_000016.SH'])
        a[abs(a) < 1e-8] = np.nan
        b = df['volume_000016.SH'] * ((df['close_000016.SH'] - df['low_000016.SH']) - (df['high_000016.SH'] - df['close_000016.SH']))
        c = b / a
