...
class MinuteIndexHighLowCorrReturnDiff_IF_IH(FutureFactor):
    '''
    Description: 
    Class: 
    Author: jinpx
    ...
    days_past = 5
    data_dict = dict()
    data_dict['Stock'] = ['stk_index_corr_sh50', 'close', 'adjfactor']
    normalize_size = 60
    normalize_type = 'ts_rank'

    def calculate(self, data):
        
        stk_index_corr_hs300 = data['stk_index_corr_sh50'].values
