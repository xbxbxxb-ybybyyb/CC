...
class Minute_CMO60MidPoint30Rank60BidVol_IH(FutureFactor):
    '''
    ...
    days_past = 1
    data_dict = dict()
    data_dict['Continuous_Data'] = {'IH': ['BidVol']}
    normalize_size = 1 * 240
    normalize_type = 'ts_rank'

    def calculate(self, data):
        rank_60 = data['BidVol_cont_IH'].rolling(60).apply(lambda x: x.searchsorted(x[-1], sorter=np.argsort(x)),
