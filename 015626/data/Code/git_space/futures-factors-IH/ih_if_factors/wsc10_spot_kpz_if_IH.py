...
class wsc10_spot_kpz_if_IH(FutureFactor):
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
...
#    num_range = '(-0.5,1]'
    ...
    def calculate(self, data):
        spot_close = data['close_000016.SH'].values[-94:]
        spot_high = data['high_000016.SH'].values[-94:]
        spot_low = data['low_000016.SH'].values[-94:]
        n = 30
