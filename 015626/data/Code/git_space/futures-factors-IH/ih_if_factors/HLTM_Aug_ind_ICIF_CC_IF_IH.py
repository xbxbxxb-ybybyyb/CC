...
class HLTM_Aug_ind_ICIF_CC_IF_IH(FutureFactor):
    ...
    def calculate(self, data):
        hlow = (data['low_000016.SH'].values)[-90:]
        hhigh = (data['high_000016.SH'].values)[-90:]
        hclose = (data['close_000016.SH'].values)[-90:]
        hvolume = (data['volume_000016.SH'].values)[-90:]
