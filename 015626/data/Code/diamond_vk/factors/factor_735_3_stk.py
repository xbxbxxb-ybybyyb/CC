...
class factor_735_3_stk(FactorGenerator):
    def __init__(self, *args, **kwargs):
        required_columns = ['close_stk', 'volume_stk']
        super(factor_735_3_stk, self).__init__(*args, required_columns=required_columns, **kwargs)
