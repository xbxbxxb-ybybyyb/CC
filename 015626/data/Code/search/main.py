...
if __name__ == '__main__':
    start_date_insample = '20180101'  # 训练集开始时间
    end_date_insample = '20220101'  # 训练集结束时间
    start_date_outsample = '20220101'  # 验证集开始时间
    end_date_outsample = '20221230'  # 验证集结束时间
    ret_target = 'ret_1'
    metric_method = 'icht_minus_17.5'
    ticker = 'AU.SHF'
    folder_name = 'cfg_v3_nodrop_1200'
    search_data_root = 'data.h5'
    search_label_root = 'ret.h5'
    ...
    base_root = '/dfs/user/015626/data/search/COMMODITY/AU.SHF/'
