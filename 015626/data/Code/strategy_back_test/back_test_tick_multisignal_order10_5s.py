        ...
        for i in range(1, date_signal_lenth):
            ...
            if need_trade_num == 0:#此分钟不交易
                ...
                for z in range(len(order_px_para)):
                    if z < 10:
                        deal_period_flag = True
                    else:
                        deal_period_flag = False
                    ...
                    if round(open_price,1) >= _deal_price and tickvolume > 0 and open_commission_num > 0 and orderbook_qty > 0 and deal_period_flag:
                        ...
                        # get_vol = max(tickvolume, orderbook_qty) if tickvolume * orderbook_qty > 0 else 0
