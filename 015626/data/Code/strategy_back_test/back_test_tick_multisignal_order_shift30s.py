...
class TS_BACK_TEST:
    ...
    def __init__(self, signal_list, ticker='IC.CFE', start_date = None, end_date = None,
                 ...
                 c_rate=3 / 100000, tickslippage = 1.2, 
        ...
        global dt_idx, raw_idx, contract_00_idx, open_idx, close_idx ,low_idx ,vwap_idx ,twap_idx ,pos_price_idx ,pos_min_idx ,pos_max_idx ,open_filter_idx
            ...
            if len(signal_df.columns.tolist()) == 1:
                ...
                if md is None:
                    md = IO.read_data([start_time, end_time], columns=['contract_00', 'open', 'high', 'low', 'close', 'vwap','volume','twap'],
                                      alt='/data/user/016700/Data/MD/CHINA_FUTURES/MINUTE/XQUANT_MINUTE/MD_SIF_TICK_TO_MINUTE_RECENT_MONTH.h5')
    ...
    def back_test_singleday(self, date):
        ...
        tickdf = tickdf.between_time('0900','1130').append(tickdf.between_time('1300','1530'))
        index_list = []
        for x in tickdf.index:
            new_x = x - datetime.timedelta(seconds = 30)
            if new_x.hour == 12:
                new_x = new_x - datetime.timedelta(hours = 1, minutes = 30)
            index_list.append(new_x)
        tickdf.index = index_list
