...
'''
# IF
factor = change_sig('/data/user/012315/share/ts/strategy/minute/res_20210528/if/prod/norm_nd/pred_comb.h5', change_ticker='IF.CFE')    
save_root_path = '/data/user/015626/data/share/factor/back_test/IF_ts/20210528/'
...
name_prefix = 'pred_comb_start_20210101'
save_path = os.path.join(save_root_path,  name_prefix)
if not os.path.exists(save_path):
    os.makedirs(save_path)
pd.DataFrame(pos_dict).T.to_csv(os.path.join(save_path,'pos_dict.csv'))
a,b,c,d = TS_BACK_TEST(factor.loc['20210101':'20210529'],price_kind='twap',ticker='IF.CFE', slippage=0.4#没用了, initial_cash=100000000, save_path = save_path, name_prefix = name_prefix,
          pos_dict=pos_dict, capital_use_rate = 1,stop_loss = -0.005,deal_volume_ratio = 1, 
          tick_price_kind = 'tickslippage',
          tickslippage = 0.8#或者1, max_wait_tick_num = 4, delay_tick_num=0).back_test() 

# IC
factor = change_sig('/data/user/012315/share/ts/strategy/minute/res_20210528/ic/prod/norm_nd/pred_comb.h5', change_ticker='IC.CFE')    
save_root_path = '/data/user/015626/data/share/factor/back_test/IC_ts/20210528/'
...
if not os.path.exists(save_path):
    os.makedirs(save_path)
pd.DataFrame(pos_dict).T.to_csv(os.path.join(save_path,'pos_dict.csv'))
a,b,c,d = TS_BACK_TEST(factor.loc['20210101':'20210529'],price_kind='twap',ticker='IC.CFE', slippage=0.6#没用了, initial_cash=100000000, save_path = save_path, name_prefix = name_prefix,
          pos_dict=pos_dict, capital_use_rate = 1,stop_loss = -0.005,deal_volume_ratio = 1, 
          tick_price_kind = 'tickslippage',
