...
if __name__ == '__main__':
    handlers = list()
    handlers.append(Process(target=get_futuretick_bydate, args = (20120101,20190102,'MAIN')))
    handlers.append(Process(target=get_futuretick_bydate, args = (20190101,20220905,'MAIN')))
    handlers.append(Process(target=get_futuretick_bydate, args = (20120101,20190102,'SECONDMAIN')))
    handlers.append(Process(target=get_futuretick_bydate, args = (20190101,20220905,'SECONDMAIN')))
