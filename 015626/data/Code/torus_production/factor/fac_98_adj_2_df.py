...
class fac_98_adj_2_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(1201 / self.bars_dict[self.ticker])) * freq)
        self.required_columns = [  'close', 'BidAskSpreadMean',  'last_to_mid']
