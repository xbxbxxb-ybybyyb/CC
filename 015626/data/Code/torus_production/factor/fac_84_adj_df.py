...
class fac_84_adj_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(1200 / self.bars_dict[self.ticker])) * self.freq)
        self.required_columns = ['buy_gigantic_volume',  'sell_gigantic_volume', 'close', 'BidAskSpreadMean']
    ...
    def calculate(self, data):
        ...
        fac = (data['buy_gigantic_volume'][-1200:]  - data['sell_gigantic_volume'][-1200:])
