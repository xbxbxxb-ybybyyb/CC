...
class fac_54_df_5x_noroll_(FutureFactor):
    ...
    def calculate(self, data):
        ...
        price_level = rolling_normalize_array(twap,1350)

        price_std = move_std_bk(rtn, window = 40, min_count = 5, ddof = 1)
