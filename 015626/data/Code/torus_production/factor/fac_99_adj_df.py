...
class fac_99_adj_df(FutureFactor):
    ...
    def __init__(self, ticker, freq):
        ...
        self.days_past = int(int(np.ceil(916 / self.bars_dict[self.ticker])) * freq)
    ...
    def calculate(self, data):
        ...
        close_diff = data['buy_gigantic_volume'][-451:] - data['sell_gigantic_volume'][-451:]
        locallow = nanargmax_new(close_diff[-int(nanmax_np([1, aaa * coef])):]) 

        fac = data['buy_small_volume'][-451:] - data['sell_small_volume'][-451:]
