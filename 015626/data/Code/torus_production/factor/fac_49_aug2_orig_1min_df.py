...
class fac_49_aug2_orig_1min_df(FutureFactor):
    ...
    def calculate(self, data):
        ...
        close = data['close_secmain'][-70:]
        high = data['high_secmain'][-70:]
        low = data['low_secmain'][-70:]
        ...
        factor = ema_span_1(self.temp4_list[-c*3:], c*3, c)
        return factor
    ...
    def pre_calculate(self, data):
        ...
        for i in range(50, -1, -1):
            if i == 0:
                ...
                close = data['close_secmain'][-70 - i: -i]
                high = data['high_secmain'][-70 - i: -i]
                low = data['low_secmain'][-70 - i: -i]  
            if len(close) == 0:
                temp2 = np.nan
            else:
                low_n = nanmin_np(low[-a:])
