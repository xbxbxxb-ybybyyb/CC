...
def ahead_generate_indicator_for_index_stock_change(today, change_date, minute_shift, index_stock_change_dict, first_generate):
    if first_generate:
        ...
        prepare_trading_day(test_case_base_folder_index_stock_change, today, batch_run_stock_list=batch_run_stock_list,
                            load_his_data=None,
                            work_indicator_folder=settings.OfficalIndicatorFolder,
...
if __name__ == '__main__':
    ...
    for minute_shift in minute_shift_list:
        ...
        index_stock_change_dict={'ZZ1000': {'new_stocks': {'300360.SZ'}, 'removed_stocks': {'000488.SZ'}}}
        # ahead_generate_indicator_for_index_stock_change("20250312", "20250317", minute_shift, index_stock_change_dict,
        #                                                 first_generate=True)
        ahead_generate_indicator_for_index_stock_change("20250314", "20250317", minute_shift, index_stock_change_dict,
