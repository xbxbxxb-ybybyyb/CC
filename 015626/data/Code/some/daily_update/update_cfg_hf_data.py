...
#    startdate,enddate,_ = check_update_date(20230301, 20230302)
    ...
    save_pickle(out_dict, os.path.join(outsample_path, '%s_cfg_hf_data_2020.pkl' % ticker[:2]))
