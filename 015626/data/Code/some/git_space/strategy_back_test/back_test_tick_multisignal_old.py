...
class TS_BACK_TEST:
    ...
    def __init__(self, signal_list, ticker='IC.CFE', start_date = None, end_date = None,
                 ...
                 save_path='/data/user/', name_prefix='', show_image = True):
        """
    ...
    def prepare_data(self):
        ...
        for sig_dict in self.signal_list:
            ...
            signal_df['ret_for_ic'] = signal_df['close'].pct_change().shift(-2)
            ...
            IC_list.append(round(signal_df['raw'].corr(signal_df['ret_for_ic']), 5))
            ...
            if need_trade_num == 0:#此分钟不交易
                ...
                if (pre_hold_num == 0) and (now_hold_num != 0):
                    ...
                    totaltrade_dict[totaldeal_count].update({'pos_close':np.sign(pre_hold_num),'close_time':nowtime,'profit_intradeal':profit_intradeal,
                                                            ...
                                                            'open_value_intratrade':open_value_intratrade})
                    profit_intradeal = 0
                    totaldeal_count += 1
                    max_hold_num_intrade = 0
                    max_hold_num_intrade_price = None
    ...
    def back_test(self):
        ...
        totaltrade_df = totaltrade_df[['totaltrade_count', 'pos',  'open_time', 'close_time', 'pos_close', 'profit_intradeal', 
                                       'change','change_of_open_value_intratrade', 'open_value_intratrade','max_hold_value', 'equity_curve', 'holding_time']]
