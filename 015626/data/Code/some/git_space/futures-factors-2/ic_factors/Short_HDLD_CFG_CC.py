# -*- coding: utf-8 -*-
"""
Created on Wed Dec 22 14:53:22 2021
...
class Short_HDLD_CFG_CC(FutureFactor):
    ...
    def calculate(self, data):
        ...
        hopen = data['open_preadj'].iloc[-19:].values
        hclose = data['close_preadj'].iloc[-19:].values
        temp1 = np.where(hopen>hclose, hopen, hclose)
        temp2 = np.where(hopen>hclose, hclose, hopen)
        
        t_pcorr = np.nanmean(((temp1[1:] - temp1[:-1])+(temp2[1:] - temp2[:-1])), axis = 0)
