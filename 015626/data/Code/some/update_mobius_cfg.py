...
rootpath = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/CSV/MINUTE/CHINA_STOCK/tick_transaction_order_tominute_v4/'
...
for date in cdate_list:
    ...
    weight_sh50 = IO.read_data([pre_32_date, date], columns = ['index_weight_sh50'], alt = '/data/group/800466/warehouse/prod/MD/MarketData/MD/UNIVERSE/INDEXWEIGHT_CHINA_STOCK_DAILY_CSI.h5')
