...
def second_job(sdate = None, edate = None):
    ...
    daily_list =  ['WIND_ASharePledgeproportion', 'WIND_AShareFFCalendar',
...
def fix_problem_job(sdate = None, edate = None):
    ...
    tech_daily_list = ['WIND_AShareFreeFloatCalendar']
...
fix_problem_job(20191208,20191224)
