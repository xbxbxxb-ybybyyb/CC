...
def check_data(path,mode):
    ...
    test_path = '/data/group/800080/warehouse/test/DATABASE/WIND/' + path + '/' + path + '.h5'
...
def main():
    ...
    path_list = os.listdir('/data/group/800080/warehouse/test/DATABASE/WIND/')
    
    overwrite_list = ['AShareDescription','AShareST','AShareManagement','AShareConseption','WIND_AShareIndClassCITICS']
