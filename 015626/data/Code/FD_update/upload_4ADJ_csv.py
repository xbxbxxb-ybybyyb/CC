...
def ftp_upload(date):
    ...
    for factor in tech_daily_list:
        remotepath = os.path.join('/XQuant/015626/ftp_data/WIND',factor , date + '.csv')
        localpath = os.path.join('/data/group/800080/warehouse/prod/LOCAL_DATA/CSV/WIND',factor, date + '.csv')
...
def main():
    ...
    flag = os.path.join('/data/user/015626/FLAG', date, date + '_tech_daily.success')
    print(flag)
