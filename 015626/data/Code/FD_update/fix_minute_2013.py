...
def update_wind_minute(sdate=None, edate=None, use_len=20, operation='append'):
    destination_path = '/data/group/800080/warehouse/test/LOCAL_DATA/CSV/WIND/MINUTE/'
    tic = time.time()
...
sdate,edate,cdate_list = check_update_date(20130101,20130325)
update_wind_minute(sdate,edate)