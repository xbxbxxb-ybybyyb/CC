...
class WIND_DATABASE:
    def __init__(self, table_name, sdate, edate, 
                 base_path = '/data/group/800080/warehouse/test/', 
                 dtype = 'STOCK',
                 mkttype = 'CHINA',
                 ftype = 'FDD',
                 dfreq = 'QUARTERLY',
...
def second_job(sdate = None, edate = None):
    ...
    new_daily_list = ['WIND_AShareMarginTradeSum','WIND_AShareCapitalization','WIND_AShareFreeFloat', 'WIND_AShareIPO', 'WIND_AShareAgency',
       ...
       'WIND_htzqedbdzzbs','WIND_AIndexIndustriesEODCITICS','WIND_SIndexPerformance','WIND_BOIndexWeightsWIND',
                ...
                'WIND_AShareIllegality','WIND_AShareMajorEvent','WIND_ASarePlanTrade','WIND_AShareInsideHolder','WIND_SHSCDailyStatistics']
    ...
    #'WIND_ChinaOptionEODPrices','WIND_ChinaOptionIndexEODPrices','WIND_ChinaOptionMemberStatistics', 'WIND_ChinaOptionValuation','WIND_ChinaOptionDailyStatistics', 
    new_daily_option_list = ['WIND_ChinaOptionDescription']
...
#    table_dict = { 'QUARTERLY': qtr_list,'DAILY': daily_C_list + daily_list + new_daily_list}

    
    table_dict = {'DAILY': ['WIND_AShareStrangeTrade','WIND_AShareMarginTradeSum'],'QUARTERLY': []}
...
def fix_job(sdate=None,edate=None):
    ...
    table_dict = { 'DAILY':['WIND_IPOInquiryDetails'] ,'QUARTERLY': []}
    
    for table_type in table_dict:
        for table_name in table_dict[table_type]:
            print (table_name)
            instantiate(table_name, sdate, edate, base_path = '/data/group/800080/warehouse/prod/', operation = 'create', table_dict=table_dict, update_h5_flag=True)
