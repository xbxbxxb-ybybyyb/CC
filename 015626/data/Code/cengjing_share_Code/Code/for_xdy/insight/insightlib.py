        ...
        try:
            if marketdata.marketDataType == EMarketDataType.MD_TICK:  # .MD_TICK 快照
                ...
                if marketdata.HasField("mdKLine"):
                    print(marketdata.mdKLine.HTSCSecurityID, marketdata.mdKLine.MDTime, ' open: ', marketdata.mdKLine.OpenPx, ' close: ', marketdata.mdKLine.ClosePx, ' volume: ', marketdata.mdKLine.TotalVolumeTrade, ' amount: ', marketdata.mdKLine.TotalValueTrade)
