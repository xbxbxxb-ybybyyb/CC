...
for i in univ.values:
    ...
    if i[1][0] == '6':
        ...
        result.append([i[0], i[1], -data_order_raw[data_order_raw.OrderType == 10].OrderQty.sum() / data_order.OrderQty.sum()])
    else:
        ...
        result.append([i[0], i[1], -data_txn[data_txn.TradeType == 1].TradeQty.sum() / data_order.OrderQty.sum()])
