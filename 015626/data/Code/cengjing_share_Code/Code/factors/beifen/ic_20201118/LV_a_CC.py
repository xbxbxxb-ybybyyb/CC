# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 18:16:47 2020
...
class LV_a_CC(FactorGenerator):
    def __init__(self):
        required_columns=['amount', 'recent_month_mask']

        super(LV_a_CC, self).__init__(required_columns=required_columns
                                  )
    ...
    def on_bar(self, data):
        volume = ((data['amount'])[data['recent_month_mask']]).mean(axis = 1)

        v_max = np.array([volume.rolling(40, min_periods = 20).std()])
