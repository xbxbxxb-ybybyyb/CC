...
class FactorGeneratorComplex:
    ...
    def __init__(self, factor_name='test', lookback_bars=5000, required_columns=None,
                 savepath='/data/user/015626/data/share/alpha/CHINA_FUTURES/MINUTE/IC_20200630_new1121'):
        ...
        if use_cache:
            ...
            if ticker == 'IC.CFE':
                ...
                if datakind == 'insample':
                    ...
                    cfg_hf_data = read_pickle(os.path.join(insample_path, 'IF_cfg_hf_data_160101_200401.pkl'))
                elif datakind == 'outsample':        
