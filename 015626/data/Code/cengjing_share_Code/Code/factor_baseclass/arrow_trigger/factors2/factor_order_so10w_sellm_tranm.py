...
class factor_order_so10w_sellm_tranm(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 'all'
        required_columns = ['transaction_t', 'transaction_t_1', 'tick_t', 'order_t_1']
        super(factor_order_so10w_sellm_tranm, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            order_t_1['OrderMoney'] = order_t_1.OrderPrice * order_t_1.OrderQty
            ...
            temp = order_t_1[(order_t_1.OrderBSFlag == 2) & (order_t_1.OrderPrice < open_px)]
            temp = temp[temp.OrderMoney > 100000]
            ...
            factor[stk] = data_t_1[data_t_1['TradeSellNo'].isin(order_index_list)].TradeMoney.sum()
