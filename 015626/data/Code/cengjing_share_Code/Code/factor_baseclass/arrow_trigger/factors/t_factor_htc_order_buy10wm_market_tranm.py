...
class t_factor_htc_order_buy10wm_market_tranm(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction', 'order']
        super(t_factor_htc_order_buy10wm_market_tranm, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
