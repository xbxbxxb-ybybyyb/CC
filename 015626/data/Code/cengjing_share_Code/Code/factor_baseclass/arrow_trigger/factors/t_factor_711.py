...
import pandas as pd
# 涨潮过程的收益率 与 退潮过程收益率之比
class t_factor_711(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_711, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
