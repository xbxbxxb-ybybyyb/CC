...
class factor_order_so10w_buym_tranm(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 'all'
        required_columns = ['transaction_t', 'transaction_t_1', 'tick_t', 'order_t_1']
        super(factor_order_so10w_buym_tranm, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            temp = order_t_1[(order_t_1.OrderBSFlag == 1) & (order_t_1.OrderPrice < open_px)]
            ...
            factor[stk] = data_t_1[data_t_1['TradeBuyNo'].isin(order_index_list)].TradeMoney.sum()
