...
if __name__ == '__main__':
    ...
    FactorGenerator(required_columns=['open', 'high', 'low', 'close', 'volume', 'amount', 'position', 'vwap', 'share','open_spot', 'high_spot', 'low_spot', 'close_spot', 'volume_spot', 'amt_spot',
                                      ...
                                      'open_if', 'high_if', 'low_if', 'close_if', 'volume_if', 'amount_if', 'position_if', 'vwap_if', 'share_if','open_spot_if', 'high_spot_if', 'low_spot_if', 'close_spot_if', 'volume_spot_if', 'amt_spot_if'] \
                    ,lookback_bars=500000000).prepare_hot_data(startdate, enddate)
