...
trade_root = '/arch1/group/800466/warehouse/Arrow/arrow_factors3/'
hot_root = os.path.join('/arch1/group/800466/warehouse/Arrow/arrow_factors2', 'hot')
history_root = os.path.join('/arch1/group/800466/warehouse/Arrow/arrow_factors2', 'history')
...
today_data_root = ''
universe_path = '/arch1/group/800466/warehouse/Arrow/arrow_factors3/universe_highopen_all.pkl'

mad_periods = [5, 60]
factor_clip_scope_days = 120
histfactor_days = 59
histfactor_path = os.path.join(trade_root, 'factor', 'h5', 'arrow_factor_distribution_v3.h5')
...
factorinput_path = os.path.join(trade_root, 'factor', 'h5', 'factor_clip_v3_95_mad_5_60.h5')
