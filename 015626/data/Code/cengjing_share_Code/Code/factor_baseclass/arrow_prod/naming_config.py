...
trade_root = '/data/group/800466/warehouse/prod/MD/MarketData/LOCAL_DATA/test_samples/Arrow/v2_0_1/arrow_prod/'
...
today_data_root = ''
universe_path = '/data/user/000072/share/for_wyc/arrow/universe/universe_all_20240507.pkl'
...
# short model config
short_model_name = 'model_20240129_open_1vs4'
# model_list = ['lr_cla','lasso_reg','lgbm_cla','lgbm_reg','mlp_reg','mlp_cla']
