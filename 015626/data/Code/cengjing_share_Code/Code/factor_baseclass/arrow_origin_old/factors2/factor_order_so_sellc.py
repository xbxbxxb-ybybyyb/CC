...
class factor_order_so_sellc(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 'all'
        required_columns = ['transaction_t', 'transaction_t_1', 'tick_t', 'order_t_1']
        super(factor_order_so_sellc, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            sell = order_t_1[order_t_1.OrderBSFlag == 2]

            factor[stk] = len(sell[sell.OrderPrice < open_px])
