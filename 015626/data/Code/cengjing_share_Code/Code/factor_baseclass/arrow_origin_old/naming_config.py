...
trade_root = '/dfs/group/800466/warehouse/Arrow/arrow/'
...
today_data_root = ''
universe_path = '/dfs/group/800466/warehouse/Arrow/arrow_0932/universe/universe_all_20240417_with_trigger_dt.pkl'

mad_periods = [5, 60]
factor_clip_scope_days = 120
histfactor_days = 59
histfactor_path = os.path.join(trade_root, 'factor9', 'h5', 'arrow_factor_distribution_v3.h5')
histfactor_dataset = 'arrow_factor_distribution_v3'
rawfactor_path = os.path.join(trade_root, 'factor9', 'h5', 'arrow_factor.h5')
rawfactor_dataset = 'arrow_factor'
factorinput_path = os.path.join(trade_root, 'factor9', 'h5', 'factor_clip_v3_95_mad_5_60.h5')
factorinput_dataset = 'factor_clip_v3_95_mad_5_60'
factor_savepath = os.path.join(trade_root, 'factor9', 'csv')
