...
def simple_run(libpath, save_result=False, save_path = None, ticker = 'IC.CFE',
    ...
    origindata = IO.read_data([in_start_time, in_end_time], columns=['vwap'],
                              alt='/data/user/015626/data/share/MD/CHINA_FUTURES/MINUTE/MD_STOCK_INDEX_FUTURES_RECENT_MONTH.h5')
    ...
    select_factors = select_factors_from_stats(report_out, report_full, avg_bars_t, rp_per_deal_t, IC_t,
...
# 根据因子测试结果筛选因子
def select_factors_from_stats(report_out, report_full, avg_bars_t = 5, rp_per_deal_t = 0.5, IC_t = 0.005,
                              self_corr_t = 0.75, sharpe_outsample_t = 0.4, sharpe_insample_t = 0.8):
    """
...
libpath = '/data/user/012398/data/alpha/CHINA_FUTURES/MINUTE/IC_test00/'
# libpath = '/data/user/015626/data/share/factor/group/IC_all/'
save_path = '/data/user/015626/data/share/factor/factor_test/1min/all_factor_test_20200822/IC_test00/factorlib_filter_20200822/'

simple_run(libpath, ticker='IC.CFE', corr_threshold=0.75, save_path=save_path, save_result=True)
