# -*- coding: utf-8 -*-
"""
Created on Mon Jun 29 18:11:53 2020
...
class HLTM_Aug_ind_CC(FactorGenerator):
    def __init__(self):

        required_columns =['close_spot', 'high_spot', 'low_spot', 'volume_spot']

        super(HLTM_Aug_ind_CC, self).__init__(
    ...
    def on_bar(self, data):
        ...
        vwtc_r = (temp*data['volume_spot']).rolling(18, min_periods = 10).mean()
