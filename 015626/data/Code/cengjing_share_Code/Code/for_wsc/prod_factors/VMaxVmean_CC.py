# -*- coding: utf-8 -*-
"""
Created on Wed Jun 17 09:28:54 2020
...
class VMaxVmean_CC(FactorGenerator):
    def __init__(self):
        required_columns=['vwap']
        super(VMaxVmean_CC, self).__init__(required_columns=required_columns)
