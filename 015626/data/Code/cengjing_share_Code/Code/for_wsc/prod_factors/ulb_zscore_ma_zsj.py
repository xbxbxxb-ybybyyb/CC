...
"""
class ulb_zscore_ma_zsj(FactorGenerator):
    def __init__(self):
        super(ulb_zscore_ma_zsj, self).__init__(factor_name = 'ulb_zscore_ma_zsj',
    ...
    def on_bar(self, data):
        ...
        ulb_zscore_ma = calc_ma_helper(score_raw, ma_win, ts_pct_win)
