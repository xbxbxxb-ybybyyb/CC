kind = 'IC'
dtype = 'IndexStock'  # Future IndexStock
end_date_standard = '20210101'
start_date_standard = '20201101'
days_interval = 50

save_path = '/data/group/800466/warehouse/prod/alpha/CHINA_FUTURES/MINUTE/%s_prod/20210910longperiod/' % kind

import sys
sys.path.insert(4,'/data/user/015626/data/share/Code/factor_rewrite/factor_framework') # 框架路径
sys.path.insert(4,'/data/user/015626/data/share/Code/factor_rewrite/developers/wyc/20210908/%s_np/' % str.lower(kind)) # 因子代码路径
...
fs = [f for f in os.listdir('/data/user/015626/data/share/Code/factor_rewrite/developers/wyc/20210908/%s_np/' % str.lower(kind)) if f.endswith('.py')]
for f in fs:
