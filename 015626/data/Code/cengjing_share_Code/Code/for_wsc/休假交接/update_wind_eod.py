...
class WIND_DATABASE:
    ...
    def csv2h5(self, update_list, min_size=0):
        ...
        """
        dat_fig_dict = {'WIND_ChinaOptionDescription':{'dt':'S_INFO_FTDATE','Ticker':'S_INFO_WINDCODE'},
...
#                            dat[k].fillna('Nan', inplace = True)
    ...
    def get_df(self, date):
        ...
        elif self.table_name in ['WIND_ChinaOptionEODPrices', 'WIND_ChinaOptionIndexEODPrices', 'WIND_ChinaOptionValuation',
            ...
            if self.table_name in self.over_write_list:
                try:
                    ...
                    if self.table_name == 'WIND_AIndexMembers':
                        ...
                        df = s.get_factor_value(self.table_name, ANN_DT=['>=20210801']) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20210620','<20210801'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20210510','<20210620'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20210401','<20210510'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20210224','<20210401'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20210106','<20210224'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20201129','<20210106'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20201101','<20201129'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20201001','<20201101'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20200901','<20201001'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20200801','<20200901'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20200701','<20200801'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20200501','<20200701'])) \
                        .append(s.get_factor_value(self.table_name, ANN_DT=['>=20200101','<20200501'])) \
...
def test_eod_job(sdate=None,edate=None):

    first_daily_list = ['WIND_AShareEODPrices'] 
...
#sdate,edate,cdate_list = check_update_date(20210623,20210623)
import datetime
udate = int(datetime.datetime.now().date().strftime('%Y%m%d'))
test_eod_job(udate, udate)
