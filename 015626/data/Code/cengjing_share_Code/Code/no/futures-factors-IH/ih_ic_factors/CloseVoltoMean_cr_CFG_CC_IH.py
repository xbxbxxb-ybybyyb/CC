...
class CloseVoltoMean_cr_CFG_CC_IH(FutureFactor):

    
    data_type = 'IndexStock'# 成分股为'IndexStock' 期货与指数为'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'volume', 'close', 'adjfactor', 'stk_index_corr_sh50']
    ...
    def calculate(self, data):
        ...
        stk_index_corr = data['stk_index_corr_sh50'].iloc[-61:]
