...
# 先mask后rolling
class CLP_CC_IH(FutureFactor):

    
    data_type = 'Future'
    days_past = 1
    data_dict = dict()
    data_dict['Continuous_Data'] = {'IH':['close','OpenInterest']}  
    normalize_size = 1200
...
#    num_range = '[-0.3, 1]'
    ...
    def calculate(self, data):
        ...
        hclose = (data['close_cont_IH'].values)[-30:]
        hclose = np.sign(hclose)
        position = (data['OpenInterest_cont_IH'].values)[-31:]
