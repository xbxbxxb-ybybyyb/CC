...
class LSC_CC_IH(FutureFactor):
    
    data_type = 'Future'
    days_past = 5
    data_dict = dict()
    data_dict['Continuous_Data'] = {'IH':['high','close', 'low']}
    normalize_size = 1200
...
#    num_range = '[0, 1]'
    ...
    def calculate(self, data):
        ...
        high = (data['high_cont_IH'].values)[-1100:]
        close = (data['close_cont_IH'].values)[-1100:]
        low = (data['low_cont_IH'].values)[-1100:]
