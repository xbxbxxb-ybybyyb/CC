...
class hhll_ind_CC_nr_ct_CFG_CC_IH(FutureFactor):

    data_type = 'IndexStock'# 成分股为'IndexStock' 期货与指数为'Future'
    days_past = 7
    data_dict = dict()
    instrument_type = 'recent'
    data_dict['Stock'] = ['close','turnover_rate','low', 'high', 'stk_index_corr_sh50', 'adjfactor']
    ...
    def calculate(self, data):
        ...
        stk_index_corr = data['stk_index_corr_sh50'].iloc[-31:]        
