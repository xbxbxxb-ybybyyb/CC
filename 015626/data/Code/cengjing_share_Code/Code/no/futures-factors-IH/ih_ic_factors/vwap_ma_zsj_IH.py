...
class vwap_ma_zsj_IH(FutureFactor):
    
    data_type = 'Future'
    days_past = 6
    data_dict = dict()
    data_dict['Continuous_Data'] = {'IH':['high','low', 'close', 'volume']} 
    normalize_size = 0
...
#    num_range = '[0, 1]'
    ...
    def calculate(self, data):
        close = data['close_cont_IH'].iloc[-1300:]
        high = data['high_cont_IH'].iloc[-1300:]
        low = data['low_cont_IH'].iloc[-1300:]
        volume = data['volume_cont_IH'].iloc[-1300:]
