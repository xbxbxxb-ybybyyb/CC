...
class wsc11_future_IH(FutureFactor):
    data_type = 'Future'
    days_past = 6
    data_dict = dict()
...
#    num_range = '(-0.5,1]'
    ...
    def calculate(self, data):
        future_close = data['close_cont_IH'].values[-1314:]
        future_high = data['high_cont_IH'].values[-1314:]
        future_low = data['low_cont_IH'].values[-1314:]
        future_open = data['open_cont_IH'].values[-1314:]
        n = 20
