...
class tr1_zf_if_IH(FutureFactor):
    '''
    期货类因子
    '''
...
#    num_range = '(-0.5, 1]'
    ...
    def calculate(self, data):
        close = data['close_000016.SH'].iloc[-1]
        high = data['high_000016.SH'].iloc[-121*2-1:].values
        low = data['low_000016.SH'].iloc[-121*2-1:].values
