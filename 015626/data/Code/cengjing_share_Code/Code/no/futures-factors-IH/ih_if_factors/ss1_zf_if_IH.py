...
class ss1_zf_if_IH(FutureFactor):
    '''
    期货类因子
    '''
    ...
    days_past = 7
    data_dict = dict()
    data_dict['Index_Id'] = {'000016.SH':['close','high']}
    normalize_size = 242*5 # normalize所用历史数据长度
    normalize_type = 'rolling_norm' # normalize方法'rolling_norm'或者'ts_rank'
#    num_range = '[-0.5, 1]'

    def calculate(self, data):
        close = data['close_000016.SH'].iloc[-250*6-10:].values
        high = data['high_000016.SH'].iloc[-250*6-10:].values
