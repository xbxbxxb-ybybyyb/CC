...
class BuySellRatio_CC_IF_IH(FutureFactor):
    
    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = ['BuyNumOrdersSumMean','weight', 'close', 'SellNumOrdersSumMean']
    normalize_size = 1200
    ...
    def calculate(self, data):
        df_s = bk.move_mean(data['BuyNumOrdersSumMean'].values[-16:] / r(data['SellNumOrdersSumMean'].values[-16:]), 10, 2, axis = 0)[-2:]
