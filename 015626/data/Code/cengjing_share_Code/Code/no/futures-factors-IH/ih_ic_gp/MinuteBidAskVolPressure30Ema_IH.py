...
class MinuteBidAskVolPressure30Ema_IH(FutureFactor):
    '''
    ...
    days_past=1
    data_dict=dict()
    data_dict['Continuous_Data'] = {'IH': ['AskVol', 'BidVol']}
    ...
    def calculate(self, data):
        ...
        ask_vol = data['AskVol_cont_IH'].values 
        bid_vol = data['BidVol_cont_IH'].values 
