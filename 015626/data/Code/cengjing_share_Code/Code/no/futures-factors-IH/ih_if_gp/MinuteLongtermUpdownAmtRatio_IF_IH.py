...
class  MinuteLongtermUpdownAmtRatio_IF_IH(FutureFactor):
    '''
    ...
    data_dict['Index_Id'] = {'000016.SH':['close','amount']}
    normalize_size= 60
    ...
    def calculate(self, data):
        ...
        close_index = data['close_000016.SH'].values[-lb:]
        amount_index = data['amount_000016.SH'].values[-lb:][1:]
