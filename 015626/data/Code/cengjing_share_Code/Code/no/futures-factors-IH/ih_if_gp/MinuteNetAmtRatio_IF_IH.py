...
class  MinuteNetAmtRatio_IF_IH(FutureFactor):
    '''
    ...
    days_past=6
    data_dict=dict()
    data_dict['Continuous_Data'] = {'IH':['close','amount']}
    ...
    def calculate(self, data):
        ...
        close_lastdays = data['close_cont_IH'].values[:240*5]
        amount_lastdays = data['amount_cont_IH'].values[:240*5]
