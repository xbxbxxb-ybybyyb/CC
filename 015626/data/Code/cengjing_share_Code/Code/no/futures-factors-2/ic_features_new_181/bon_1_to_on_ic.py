...
class bon_1_to_on_ic(FutureFactor):
    ...
    def calculate(self, data):
        ...
        sell_super_lo_counts = data['sell_super_lo_counts'].values[-1]
        ...
        sell_super_lo_counts[sell_super_lo_counts > 100] = 100
        buy_lo_counts[buy_lo_counts > 20000] = 20000
        sell_lo_counts[sell_lo_counts > 10000] = 10000

        factor = np.nansum(buy_super_lo_counts + sell_super_lo_counts) / np.nansum(buy_lo_counts + sell_lo_counts)
        return factor
