...
class ALLBUY_SELL_V_2_CC(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'allbuy_smallorder_volume', 'sell_smallorder_volume_v2', 'stk_index_corr_zz500']
    normalize_size = 1200
