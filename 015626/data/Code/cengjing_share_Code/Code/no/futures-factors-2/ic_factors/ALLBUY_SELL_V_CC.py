...
class ALLBUY_SELL_V_CC(FutureFactor):

    data_type = 'IndexStock' 
    days_past = 1
    data_dict = dict()
    data_dict['Stock'] = [ 'allbuy_smallorder_volume', 'allsell_smallorder_volume', 'stk_index_corr_zz500']
    normalize_size = 1200
    ...
    def calculate(self, data):
        ...
        temp1 = data['allbuy_smallorder_volume'].values[-10:]
        temp2 = data['allsell_smallorder_volume'].values[-10:]
