...
class wsc_spot_8_if(FutureFactor):
    """
    ...
    days_past = 1
    data_dict = dict()
    data_dict['Index_Id'] = {'000300.SH':['close', 'amount'], '000905.SH':['close']}
    normalize_size = 1200
    normalize_type = 'ts_rank'
    num_range = None
    
    def calculate(self, data):
        spot_close_if = data['close_000300.SH'].values[-12:]
        spot_close_ic = data['close_000905.SH'].values[-12:]
        spot_amount_if = data['amount_000300.SH'].values[-12:]
