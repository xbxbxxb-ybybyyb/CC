# -*- coding: utf-8 -*-
"""
Created on Fri Jan 28 09:03:44 2022
...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 28 09:02:30 2022
...
class BigOrderRatioSell_Weighted_5_zscore(FutureFactor):
    ...
    def calculate(self, data):
        ...
        date = str(data['sell_superorder_count'].index.date[-1]) 
        sup = sup.loc[date]
        big = big.loc[date]
        mid = mid.loc[date]
        ...
        factor = np.nanmean(data['weight'].values[-1] * big/temp)
