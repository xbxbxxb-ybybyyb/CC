...
class FactorGenerator:
    ...
    def prepare_hot_data(inst, start_date, end_date, ticker='IC.CFE', datakind = 'insample'):
        ...
        if datakind == 'insample':
            ...
            futures_data = read_pickle(os.path.join(insample_path, 'FUTURE_DATA_120101_200901.pkl'))
        elif datakind == 'outsample':
            index_data = read_pickle(os.path.join(outsample_path, 'SPOT_DATA_2020.pkl'))
            futures_data = read_pickle(os.path.join(outsample_path, 'FUTURE_DATA_2020.pkl'))
