...
def get_futuretick_bydate(sdate=None, edate=None):
    ...
    # ic_list = ['IC' + str(a) + '.CFE' for a in range(2001, 2013)]
    # if_list = ['IF' + str(a) + '.CFE' for a in range(2001, 2013)]
    # ih_list = ['IH' + str(a) + '.CFE' for a in range(2001, 2013)]
    ic_list2 = ['IC' + str(a) + '.CFE' for a in range(1601, 1613)] + ['IC' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IC' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IC' + str(a) + '.CFE' for a in range(1801, 1813)] + ['IC' + str(a) + '.CFE' for a in range(1901, 1913)] + ['IC' + str(a) + '.CFE' for a in range(2001, 2013)] + ['IC' + str(a) + '.CFE' for a in range(2101, 2113)] + ['IC' + str(a) + '.CFE' for a in range(2201, 2213)]
    if_list2 = ['IF' + str(a) + '.CFE' for a in range(1601, 1613)] + ['IF' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IF' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IF' + str(a) + '.CFE' for a in range(1801, 1813)] + ['IF' + str(a) + '.CFE' for a in range(1901, 1913)] + ['IF' + str(a) + '.CFE' for a in range(2001, 2013)] + ['IF' + str(a) + '.CFE' for a in range(2101, 2113)] + ['IF' + str(a) + '.CFE' for a in range(2201, 2213)]
    ih_list2 = ['IH' + str(a) + '.CFE' for a in range(1601, 1613)] + ['IH' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IH' + str(a) + '.CFE' for a in range(1701, 1713)] + ['IH' + str(a) + '.CFE' for a in range(1801, 1813)] + ['IH' + str(a) + '.CFE' for a in range(1901, 1913)] + ['IH' + str(a) + '.CFE' for a in range(2001, 2013)] + ['IH' + str(a) + '.CFE' for a in range(2101, 2113)] + ['IH' + str(a) + '.CFE' for a in range(2201, 2213)]
    t_list2 = ['T' + str(a) + '.CFE' for a in range(1601, 1613)] + ['T' + str(a) + '.CFE' for a in range(1701, 1713)] + ['T' + str(a) + '.CFE' for a in range(1701, 1713)] + ['T' + str(a) + '.CFE' for a in range(1801, 1813)] + ['T' + str(a) + '.CFE' for a in range(1901, 1913)] + ['T' + str(a) + '.CFE' for a in range(2001, 2013)] + ['T' + str(a) + '.CFE' for a in range(2101, 2113)] + ['T' + str(a) + '.CFE' for a in range(2201, 2213)]

    wind_code_list = ic_list2 + if_list2 + ih_list2 + t_list2
    root_path = '/data/user/015615/MarketData/LOCAL_DATA/CSV/TICK/CHINA_FUTURES/ALL_CONTRACT'
...
if __name__ == '__main__':
    ...
    a, b, c = check_update_date(int(start_date), int(end_date))

# flag_root = '/data/user/015626/data/share/LOCAL_DATA/FLAG/' + str(b) + '/'
# if not os.path.exists(flag_root):
#     os.makedirs(flag_root)
# flag_path_start = flag_root + str(b) + '_' + 'stock_index_future_tick.start'
#
...
# flag_path_success = flag_root + str(b) + '_' + 'stock_index_future_tick.success'
