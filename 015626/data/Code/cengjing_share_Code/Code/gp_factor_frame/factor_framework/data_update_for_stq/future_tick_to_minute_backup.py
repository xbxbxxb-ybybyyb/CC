...
# NO '/' AT THE END !
ROOT_PATH = '/data/user/015615/MarketData'
...
def resample_and_update_csv(read_path, save_path):
    old_columns = ['dt', 'OpenInterest', 'Buy1Price', 'Buy1OrderQty', 'Sell1Price', 'Sell1OrderQty', 'Buy2Price',
                   'Buy2OrderQty', 'Sell2Price', 'Sell2OrderQty',
                   'Buy3Price', 'Buy3OrderQty', 'Sell3Price', 'Sell3OrderQty', 'Buy4Price', 'Buy4OrderQty',
                   'Sell4Price', 'Sell4OrderQty', 'Buy5Price', 'Buy5OrderQty', 'Sell5Price', 'Sell5OrderQty', 'OpenPx', 'HighPx', 'LowPx', 'PreOpenInterest',
    ...
    new_columns = ['dt', 'OpenInterest', 'BidP0', 'BidV0', 'AskP0', 'AskV0', 'BidP1', 'BidV1', 'AskP1', 'AskV1',
                   'BidP2', 'BidV2', 'AskP2', 'AskV2',
                   'BidP3', 'BidV3', 'AskP3', 'AskV3', 'BidP4', 'BidV4', 'AskP4', 'AskV4', 'TodayOpen', 'TodayHigh','TodayLow','PreOpenInterest',
                   'PreClosePx','PreSettlePrice','TotalVolumeTrade','TotalValueTrade']
    ...
    how_method_dict = {'AskVol': 'sum', 'BidVol': 'sum', 'interest': 'sum', 'AskP0': 'last', 'AskP1': 'last',
                       'AskP2': 'last', 'AskP3': 'last', 'AskP4': 'last',
                       'BidP0': 'last', 'BidP1': 'last', 'BidP2': 'last', 'BidP3': 'last', 'BidP4': 'last',
                       'TodayOpen':'last','TodayHigh':'last','TodayLow':'last','PreOpenInterest':'last',
                       'PreClosePx':'last','PreSettlePrice':'last','TotalVolumeTrade':'last','TotalValueTrade':'last'}
