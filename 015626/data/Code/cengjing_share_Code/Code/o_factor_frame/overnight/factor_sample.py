...
class factor_sample(FactorGenerator):

    def __init__(self, *args, **kwargs):
        required_columns=['close_zz500' ,'amount_zz500']
        super(factor_sample, self).__init__(*args, required_columns=required_columns, ts_norm_method='ts_rank', ts_norm_bars=3, **kwargs)
