...
class HistoryData:
    def __init__(self, date, ticker, hisdays=0):
        self.date = date
        ...
        eod = IO.read_data([self.start_date, self.date], universe = self.universe, columns = ['S_DQ_LIMIT', 'S_DQ_STOPPING'], alt = eod_path)
