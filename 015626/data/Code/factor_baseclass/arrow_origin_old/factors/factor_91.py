...
class factor_91(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['order']
        super(factor_91, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            data = data[(data.MDTime < 92600000000) & (data.OrderBSFlag == 2)]
