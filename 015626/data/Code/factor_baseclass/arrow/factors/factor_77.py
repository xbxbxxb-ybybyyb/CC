...
class factor_77(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['order', 'transaction']
        super(factor_77, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            b = data_o[(data_o.OrderBSFlag == 2) & (data_o.OrderPrice <= px)]
