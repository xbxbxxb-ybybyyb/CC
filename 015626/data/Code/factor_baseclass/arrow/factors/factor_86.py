...
class factor_86(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['tick', 'order']
        super(factor_86, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            data_order = data_order[(data_order.OrderType == 2) & (data_order.OrderBSFlag == 2)]
            MaxPxOrder = data_order[data_order.OrderPrice == MinPx].OrderQty.sum()
