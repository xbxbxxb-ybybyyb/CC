...
trade_root = '/dfs/group/800466/warehouse/Arrow/arrow_hs300/'
...
data_root = '/dfs/group/800466/warehouse/prod/MD/CHINA_STOCK/LEVEL2/'
hot_data_root = '/dfs/group/800466/warehouse/prod/MD/CHINA_STOCK/LEVEL2/'
today_data_root = '/dfs/group/800466/warehouse/Arrow/today_data/'
universe_path = os.path.join(trade_root, 'universe', 'arrow_hs300.pkl')
