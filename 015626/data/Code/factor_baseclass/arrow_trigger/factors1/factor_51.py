...
class factor_51(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['tick']
        super(factor_51, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            if len(data) == 0:
                factor[stk] = np.nan
                continue
            lr.fit(data[['MDTime']], data[['Buy1Price']] * 1e14)
