...
import pandas as pd
# 收益率与更优波动率的比值
class t_factor_718(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_718, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
