...
import pandas as pd
# 当日更优波动率异常高的分钟数成交额占比
class t_factor_724(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_724, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            factor[stk] = temp['amount'].sum() / dfmin['amount'].sum()
