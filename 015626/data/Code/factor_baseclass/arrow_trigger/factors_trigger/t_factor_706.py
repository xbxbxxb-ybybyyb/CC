...
import pandas as pd
# 成交量激增且收益率大于0.01的分钟数
class t_factor_706(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_706, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            factor[stk] = len(dfmin[(dfmin['vdiff'] > dfmin['vs']) & (dfmin['ret'] > 0.01)])
