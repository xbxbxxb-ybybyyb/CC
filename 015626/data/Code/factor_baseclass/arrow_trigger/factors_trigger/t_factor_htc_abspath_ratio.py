...
class t_factor_htc_abspath_ratio(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_htc_abspath_ratio, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            factor[stk] = data_t_1['abs_px_diff'].sum() / (data_t_1.TradePrice.max() - data_t_1.iloc[-1]['TradePrice'])
