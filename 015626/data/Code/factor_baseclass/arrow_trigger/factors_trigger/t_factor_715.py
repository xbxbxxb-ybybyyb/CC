...
class t_factor_715(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_715, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            if dfmin.loc[up_time]['volume'] < dfmin.loc[down_time]['volume']:
                ...
                factor[stk] = tide_ret / get_timediff_minutes(max_v_time, down_time) * 1e5
