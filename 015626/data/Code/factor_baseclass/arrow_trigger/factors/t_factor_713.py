...
class t_factor_713(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['transaction']
        super(t_factor_713, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            if max_v_time == up_time:
                ...
                factor[stk] = tide_ret / get_timediff_minutes(up_time, max_v_time) * 1e5
