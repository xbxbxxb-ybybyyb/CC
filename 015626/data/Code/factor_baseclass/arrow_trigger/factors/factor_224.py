...
class factor_224(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['order']
        super(factor_224, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            data = data[(data.OrderMoney > 100000) & (data.MDTime > 92000000000) & (data.MDTime < 92600000000)]
