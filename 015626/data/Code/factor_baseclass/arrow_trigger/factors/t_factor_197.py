...
class t_factor_197(FactorGenerator):
    def __init__(self, *args, **kwargs):
        data_mode = 't'
        required_columns = ['order']
        super(t_factor_197, self).__init__(*args, data_mode = data_mode, required_columns=required_columns, **kwargs)
    ...
    def on_bar(self, df):
        ...
        for stk in df['universe']:
            ...
            factor[stk] = -1 * data_buy.OrderMoney.sum() / (data_buy.OrderMoney.sum() + data_sell.OrderMoney.sum())
