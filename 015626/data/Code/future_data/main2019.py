...
def get_futuretick_bydate(sdate = None, edate = None, kind = 'MAIN'):
    ...
    root_path = '/data/user/015626/data/share/MD/CHINA_FUTURES/TICK/' + kind
    for i in range(len(cdate_list)):
        ...
        for ticker in wind_code_list:
           ...
           csvpath = os.path.join(root_path,category+'_'+exchange)
           if exchange != 'CFE':
                continue
...
get_futuretick_bydate(20190101, 20200901, kind = 'MAIN')

# dfm = IO.read_data([20160101,20200204], columns = ['WIND_CODE'],alt = '/data/user/012245/warehouse/prod/MD/CHINA_FUTURES/DAILY/MAIN/MD_CHINA_FUTURES_DAILY_MAIN.h5')
# dfs = IO.read_data([20160101,20200204], columns = ['WIND_CODE'],alt = '/data/user/012245/warehouse/prod/MD/CHINA_FUTURES/DAILY/SECONDMAIN/MD_CHINA_FUTURES_DAILY_SECONDMAIN.h5')
# dfm = dfm.rename(columns = {'WIND_CODE':'sp_contract'})
# IO.pd_hdf5_writer(dfm,'/data/user/015626/data/share/future/MAIN/MAIN_SP_CONTRACT2.h5',dataset='main')
# dfs = dfs.rename(columns = {'WIND_CODE':'sp_contract'})
# IO.pd_hdf5_writer(dfs,'/data/user/015626/data/share/future/SECONDMAIN/SECONDMAIN_SP_CONTRACT2.h5',dataset='secondmain')