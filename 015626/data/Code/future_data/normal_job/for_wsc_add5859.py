...
rootpath = '/data/user/015626/data/share/LOCAL_DATA/for_wsc/MINUTE/'
...
alldf_origin = historydf
start_date, end_date = 20130101, 21000101
...
########################## update mask #############################
print('update mask')
futures_data = IO.read_data([20130101, 21000101],columns = ['open', 'close', 'high', 'low', 'amount', 'volume', 'vwap', 'twap','position','share'],
alt=os.path.join('/data/user/015626/data/share/LOCAL_DATA/for_wsc/MINUTE/MD_SIF_TICK_TO_MINUTE_ALL_CONTRACT.h5'))
...
u = IO.read_data([20130101, 21000101], alt = '/data/user/015626/data/share/MD/CHINA_FUTURES/daily/MD_STOCK_INDEX_FUTURES_UNIVERSE.h5')
...
save_pickle(future_dict, '/data/user/015626/data/share/LOCAL_DATA/for_wsc/MINUTE/FUTURE_DATA_for_wsc.pkl')