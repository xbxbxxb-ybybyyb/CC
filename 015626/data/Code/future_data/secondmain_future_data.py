...
def get_futuretick_bydate(sdate=None, edate=None, kind='MAIN'):
    ...
    for i in range(len(cdate_list)):
        ...
        wind_code_list = IO.read_data([cdate_list[i]],
                                      alt='/data/user/012245/warehouse/prod/MD/CHINA_FUTURES/DAILY/' + kind + '/MD_CHINA_FUTURES_DAILY_' + kind + '.h5').WIND_CODE.tolist()
...
get_futuretick_bydate(c[-2], c[-1], kind='SECONDMAIN')