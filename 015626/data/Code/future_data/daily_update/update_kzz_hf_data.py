...
def get_csvdf(para):
    ...
    try:
        ...
        return
print('start')
a = pd.read_pickle('/data/user/015626/data/share/MD/CHINA_CONVERTIBLE_BOND/MINUTE/CHINA_CONVERTIBLE_BOND_HF_TO_MINUTE.pkl')
print('to h5')
IO.pd_hdf5_writer(a, '/data/user/015626/data/share/MD/CHINA_CONVERTIBLE_BOND/MINUTE/CHINA_CONVERTIBLE_BOND_HF_TO_MINUTE.h5', dataset='CHINA_CONVERTIBLE_BOND_HF_TO_MINUTE')                
'''
if __name__ == '__main__':
    rootpath = '/arch1/group/800466/warehouse/prod/MD/CHINA_CONVERTIBLE_BOND/tick_transaction_to_minute/'
    print('start')
    _,_,cdatelist = check_update_date(20170101,20210727)
...
#        pool.map(get_hfdata, paralist)
    ...
    df.to_pickle('/data/user/015626/data/share/MD/CHINA_CONVERTIBLE_BOND/MINUTE/CHINA_CONVERTIBLE_BOND_HF_TO_MINUTE.pkl')
'''