...
def get_ticker(a):
    namedict = {16:'IH.CFE',300:'IF.CFE',905:'IC.CFE'}
    return namedict[a]
...
df = icdf.append(ifdf).append(ihdf)
...
for ticker in ['IC.CFE', 'IF.CFE','IH.CFE']:
    ...
    close = pd.concat([close_morning_930_939,close_morning_940_949,close_morning_950_959,close_noon_1430_1439,close_noon_1440_1449,close_noon_1450_1459], axis = 1)

    for am in ['close_morning_930_939', 'close_morning_940_949', 'close_morning_950_959']:
        for pm in ['close_noon_1430_1439', 'close_noon_1440_1449', 'close_noon_1450_1459']:
