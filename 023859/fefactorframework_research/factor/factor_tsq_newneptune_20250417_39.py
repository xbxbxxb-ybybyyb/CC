...
class factor_tsq_newneptune_20250417_39(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_39"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "下单额买卖不平衡标准差"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = ((data['OrderAmt_buy'] - data['OrderAmt_sell']) / (data['OrderAmt_buy'] + data['OrderAmt_sell']).replace(0,np.nan)).kurt()
