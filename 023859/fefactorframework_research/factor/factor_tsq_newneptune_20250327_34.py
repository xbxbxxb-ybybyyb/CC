...
class factor_tsq_newneptune_20250327_34(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250327_34"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "资金净流入标准差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori['factor'] = df_ori['NET_INFLOW_RATE_VOLUME'].unstack().rolling(20,1).std().stack()
