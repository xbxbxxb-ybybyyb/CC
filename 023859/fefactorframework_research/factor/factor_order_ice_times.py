...
class factor_order_ice_times(BaseFactor):
    strategy_name = "neptune"
    factor_name = "order_ice_times"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "wenj"  # 开发人员姓名
    factor_explain = "使用前一分钟累积挂单量估计成交量，实际成交量大于估计成交量的分钟数占总分钟数的比例" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        times = data.groupby('Ticker').apply(self.order_ice)
