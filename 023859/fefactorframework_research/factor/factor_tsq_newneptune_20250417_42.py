...
class factor_tsq_newneptune_20250417_42(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_42"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "买单下单额自相关系数"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = data['OrderAmt_buy'].autocorr()
