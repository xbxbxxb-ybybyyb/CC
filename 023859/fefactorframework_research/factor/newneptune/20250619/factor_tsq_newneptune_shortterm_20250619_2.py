...
class factor_tsq_newneptune_shortterm_20250619_2(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_shortterm_20250619_2"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "收益率自相关性" # 因子逻辑解释
