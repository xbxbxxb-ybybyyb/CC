...
class factor_tsq_newneptune_shortterm_20250626_4(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_shortterm_20250626_4"
    fill_na_value = 0
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = data[(data['TradeMoney'] > 50000)&(data['TradeBSFlag'] == 1)]['TradeQty'].sum() / (1e-6+data['TradeQty'].sum())
