...
class factor_tsq_newneptune_20250417_17(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_17"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "成交均价收益率自相关性" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        data_all['AvgPx'] = data_all['ValueTrade'] / data_all['VolumeTrade'].replace(0,np.nan)
        data_all['ret'] = data_all['AvgPx'].pct_change()
        res = data_all['ret'].autocorr()
