...
class factor_tsq_newneptune_20250410_7(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250410_7"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            # -------------------------------------------------------------------------------------------------------------------
            df_minute5_close = df_minute5_close.div(df_minute5_close['pre_close'],axis=1)
            df_minute5_high = df_minute5_high.div(df_minute5_high['pre_close'],axis=1)
            df_ori['factor'] = (df_minute5_high[columns] - df_minute5_close[columns]).std(axis=1)
