...
class factor_tsq_newneptune_20250327_50(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250327_50"
    fill_na_value = 3
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "日内成交额峰度" # 因子逻辑解释
    ...
    t_1_factor_data = [
        {'name': 'minute5_amt',  # 同一个因子内的name不能重复，同一批计算因子间不同表(以路径为准，与lag、column无关)不能相同名字（可以相同表叫不同名字）
         ...
         'lag': 20,  # 注意为正数
         'column': ['m925', 'm930', 'm935', 'm940', 'm945', 'm950', 'm955', 'm1000','m1005', 'm1010', 'm1015', 'm1020', 'm1025', 'm1030', 'm1035', 'm1040','m1045', 'm1050', 'm1055', 'm1100', 'm1105', 'm1110', 'm1115', 'm1120',\
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori = database['minute5_amt']
            # -------------------------------------------------------------------------------------------------------------------
            df_ori['factor'] = df_ori.kurt(axis=1)
