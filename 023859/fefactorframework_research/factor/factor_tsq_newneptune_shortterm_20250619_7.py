...
class factor_tsq_newneptune_shortterm_20250619_7(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_shortterm_20250619_7"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "最新价与过去三笔成交价差绝对值的平均" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = (data['TradePrice'] - data['TradePrice'].rolling(3,1).mean()).abs().mean()
