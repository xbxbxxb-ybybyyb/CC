...
class factor_tsq_newneptune_20250508_25(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250508_25"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = df_cashflow.groupby(['dt','Ticker'])['FREE_CASH_FLOW'].apply(lambda x : x.tail(5).mean()).to_frame(name = self.factor_name)
