...
class factor_tsq_newneptune_20250417_43(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_43"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "卖单下单额自相关系数"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = data['OrderAmt_sell'].autocorr()
