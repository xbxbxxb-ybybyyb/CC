...
class factor_tsq_newneptune_test_1(BaseFactor):
    owner = 'tsq'
    strategy_name = "neptune"
    factor_name = 'tsq_newneptune_test_1'
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = df_ori["BUY_VOLUME_MED_ORDER"].unstack().rolling(90, 1).mean().stack().apply(lambda x: round_(x, 2))
