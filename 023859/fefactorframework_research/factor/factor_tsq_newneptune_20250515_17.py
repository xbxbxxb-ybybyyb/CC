...
class factor_tsq_newneptune_20250515_17(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250515_17"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = df_income['LESS_TAXES_SURCHARGES_OPS'].groupby(['dt', 'Ticker']).apply(lambda x: x.tail(4).mean()).to_frame(name=self.factor_name)
