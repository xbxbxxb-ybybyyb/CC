...
# 单独财务数据，非CS
class factor_tsq_newneptune_20250424_29(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250424_29"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "研发费用" # 因子逻辑解释
