...
# 单独财务数据，非CS
class factor_tsq_newneptune_20250424_31(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250424_31"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "融资租入固定资产" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = df_income['FA_FNC_LEASES'].tail(12).sum()
