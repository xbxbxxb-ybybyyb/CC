...
class factor_tsq_newneptune_20250327_70(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250327_70"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "开盘与收盘价格变动差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori['pre_close'] = database['MD']['pre_close']
            ...
            morning_times = ['m930', 'm935', 'm940', 'm945', 'm950', 'm955']
            afternoon_times = ['m1430', 'm1435', 'm1440', 'm1445', 'm1450','m1455']
            df_ori['factor1'] = df_ori[morning_times].T.pct_change().T.sum(axis=1)
            df_ori['factor2'] = df_ori[afternoon_times].T.pct_change().T.sum(axis=1)
