...
class factor_tsq_newsaturn_20250320_7(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "saturn"
    factor_name = "tsq_newsaturn_20250320_7"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "买单盘口占优时的占比" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = len(data_all[(data_all['Buy1OrderQty']+data_all['Buy2OrderQty']+data_all['Buy3OrderQty']+data_all['Buy4OrderQty']) > (data_all['Sell1OrderQty']+data_all['Sell2OrderQty']+data_all['Sell3OrderQty']+data_all['Sell4OrderQty'])]) / len(data_all)
