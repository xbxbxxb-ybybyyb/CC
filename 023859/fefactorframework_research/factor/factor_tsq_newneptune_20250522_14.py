...
class factor_tsq_newneptune_20250522_14(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250522_14"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = (df_income['STM_BS_TOT']/df_income['TOT_SHR']).groupby(['dt','Ticker']).apply(lambda x : x.tail(16).std()).to_frame(name = self.factor_name)
