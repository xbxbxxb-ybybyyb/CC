...
class factor_tsq_newsaturn_20250320_4(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "saturn"
    factor_name = "tsq_newsaturn_20250320_4"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "买卖强度比标准差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        bid_ask_power_ratio = (data_all['TotalBidQty'] * data_all['WeightedAvgOfferPx'] - data_all['TotalOfferQty'] * data_all['WeightedAvgBidPx']) / (data_all['TotalBidQty'] * data_all['WeightedAvgOfferPx'] + data_all['TotalOfferQty'] * data_all['WeightedAvgBidPx'])
        res = (bid_ask_power_ratio).std()
