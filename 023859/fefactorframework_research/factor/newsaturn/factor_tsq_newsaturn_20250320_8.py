...
class factor_tsq_newsaturn_20250320_8(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "saturn"
    factor_name = "tsq_newsaturn_20250320_8"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "买10与买1压单之比" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = np.sum(data_zt['Buy10OrderQty']) / (1e-6 + np.sum(data_zt['Buy1OrderQty']))
