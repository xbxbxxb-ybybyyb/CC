...
class factor_tsq_newsaturn_20250320_5(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "saturn"
    factor_name = "tsq_newsaturn_20250320_5"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "中位数之上成交量与成交笔数相关系数" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            for date in data.index.get_level_values(0).unique():
                ...
                data_['NumTrade'] = data_['NumTrades'].diff()
