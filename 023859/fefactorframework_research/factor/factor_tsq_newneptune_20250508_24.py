...
class factor_tsq_newneptune_20250508_24(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250508_24"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "笔均买单下单额波动"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        data['AmtBuy_Num'] = data['OrderAmt_buy'] / data['OrderNum_buy'].replace(0,np.nan)
        res = data['AmtBuy_Num'].std()
