...
class factor_tsq_newneptune_20250417_45(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_45"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = ""  # 因子逻辑解释
    zcz_adjusted = "否"  # 是否针对注册制调整：是/否
    logic_type = "买单下单额与成交额占比标准差"  # 逻辑类别
    low_cost = "是"  # 是否低耗时
    t_day_data = []
    #
    xdb_data = [
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = (data['OrderAmt_buy'] / data['ValueTrade'].replace(0,np.nan)).std()
