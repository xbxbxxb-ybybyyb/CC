...
def generate_neptune_basic_stocks_pool(start_date, end_date):
    ...
    for date in tqdm(trading_days):
        stockPool = list(set(s.hset('INDEX', date, 'ZZ2000')['stock']))
        res[date] = stockPool
    return res
...
neptune_basic_file.to_pickle('/dfs/user/023859/share_file/for_sss/basic_file_zz2000_20160101_20250630.pkl')
