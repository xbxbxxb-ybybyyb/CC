...
basic_df = pd.read_pickle('/dfs/user/023859/neptune/basic_file_zz1800_20160101_20241231.pkl').loc[pd.Timestamp(str(start_date)):pd.Timestamp(str(end_date))]
basic_df['STPT'] = True
...
basic_df[['label_t2o30d1','label_t4o30d1','label_t6o30d1']] = md[['label_t2o30d1','label_t4o30d1','label_t6o30d1']]
...
md = pd.concat([md1,md2,md3,md4,md5,md6])[['pre_close','close','amt','adjfactor','buy_0931_0941_twap','sell_0931_0941_twap','buy_1000_1010_twap','sell_1000_1010_twap']]
...
basic_df.to_pickle('/dfs/user/023859/neptune/sft_file_zz1800_20160101_20201231.pkl')