...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'neptune':
            sft_basic_path = '/data/user/023859/factor_zooZZ/factor_lib/sft_basic_formal_931_20160101_20201231.h5'  # 这个文件里有label和所有因子
    ...
    def factor_test(self, factor_df, cost_list, result_path, factor_corr_test=False, generate_pdf=False):
        ...
        if factor_corr_test:
            if self.strategy_name == 'neptune':
                check_res = pd.read_excel('/data/group/800463/data/projectZZ_public/factor_lib/check_res_tot_neptune.xlsx')
