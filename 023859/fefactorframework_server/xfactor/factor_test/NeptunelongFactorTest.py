...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'neptunelong':
            sft_basic_path =  '/data/user/023859/factor_zooZZmkt/factor_lib/sft_update_931_20160101_20211231.pkl'  # 这个文件里有label和所有因子
        ...
        all_factors_available = ['label_t2o30d1','label_t4o30d1','label_t6o30d1','label_t11o30d1','label_t2o9d1_pos', 'label_t2o9d1_neg']
