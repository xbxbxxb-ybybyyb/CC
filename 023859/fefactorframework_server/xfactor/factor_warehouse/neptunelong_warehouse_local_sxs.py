...
for test_date in test_date_list[start_index:]:
    ...
    day_factor_inf = day_factor_inf[day_factor_inf['factor_owner'].isin(['zxj','wenj'])]
    ...
    check_res_inf_.to_excel(res_path + 'check_res/sxs_check_res_tot_neptunelong_{}.xlsx'.format(test_date), index=False)
    ...
    check_res_inf_sta.to_excel(res_path + 'check_res/sxs_check_res_tot_neptunelong_sta_{}.xlsx'.format(test_date), index=False) #统计截图
    ...
    #
    # 输出结果
    # update_file = res_path + 'sft_update_931_20160101_20201231.pkl'
    # all_factor_df.to_pickle(update_file)
    #
    # 公共地址输出结果
    # check_res_inf_.to_excel(res_public_path + 'check_res_tot_neptunelong.xlsx', index=False)
    #
    # update_public_file = res_public_path + 'sft_update_931_20160101_20191231.pkl'
