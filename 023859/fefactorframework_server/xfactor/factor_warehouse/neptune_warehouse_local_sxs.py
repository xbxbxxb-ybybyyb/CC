...
for test_date in test_date_list[start_index:]:
    ...
    check_res_inf_.to_excel(res_path + 'check_res/sxs_check_res_tot_neptune_{}.xlsx'.format(test_date), index=False)
    ...
    check_res_inf_sta.to_excel(res_path + 'check_res/sxs_check_res_tot_neptune_sta_{}.xlsx'.format(test_date), index=False) #统计截图
