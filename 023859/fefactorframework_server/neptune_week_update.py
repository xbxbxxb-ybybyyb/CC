...
# 筛选df后
df = pd.read_excel('/data/user/023859/factor_zooZZ/all_factor_inf.xlsx')
...
# paths = '/data/user/023859/factor_zooZZ/all_factor_tmp/931/'
...
print(parallel_list)
params = {"parallel_list": parallel_list,
          "tag":"xquant", "cpu":dock_pool_num, "gpu":0, "memory":100*1024}
AIMR.runTasks('neptune_week_update_aimr.py',json.dumps(params))