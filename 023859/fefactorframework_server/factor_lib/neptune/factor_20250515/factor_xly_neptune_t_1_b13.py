...
class factor_xly_neptune_t_1_b13(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_b13"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "委买与委卖强度" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            try:
                ...
                res = (tick_df['Buy1OrderQty'] - tick_df['Sell1OrderQty']).mean()/ff_shares
                if np.isinf(res):
                    res = 1
            except:
