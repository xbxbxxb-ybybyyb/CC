...
class factor_tsq_newneptune_20250403_3(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250403_3"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "日内涨跌幅最大值与偏度之比" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            columns = ['m925', 'm930', 'm935', 'm940', 'm945', 'm950', 'm955', 'm1000', 'm1005', 'm1010', 'm1015', 'm1020',
                    'm1025', 'm1030', 'm1035', 'm1040', 'm1045', 'm1050', 'm1055', 'm1100', 'm1105', 'm1110', 'm1115',
                    'm1120', 'm1125', 'm1300', 'm1305', 'm1310', 'm1315', 'm1320', 'm1325', 'm1330', 'm1335', 'm1340', 'm1345',
                    'm1350', 'm1355', 'm1400', 'm1405', 'm1410', 'm1415', 'm1420', 'm1425', 'm1430', 'm1435', 'm1440',
                    'm1445', 'm1450', 'm1455']
            for col in columns:
                df_ori[col] = df_ori[col] / df_ori['pre_close'].replace(0,np.nan) - 1
                df_ori.loc[df_ori['zcz'] == 1, col] = df_ori.loc[df_ori['zcz'] == 1, col] / 2
                df_ori.loc[df_ori['bj'] == 1, col] = df_ori.loc[df_ori['bj'] == 1, col] / 3

            df_ori['factor'] = df_ori[columns].max(axis=1) / (df_ori[columns].skew(axis=1)).replace(0,np.nan)
