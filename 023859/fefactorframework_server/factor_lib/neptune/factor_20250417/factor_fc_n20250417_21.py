...
class factor_fc_n20250417_21(BaseFactor):
    owner = 'fc'
    strategy_name = "neptune"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 1e8
    need_pre_calculate_T_N = True
    factor_explain = "过去2个月大单资金流向占比均值" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = df_ori["MONEYFLOW_PCT_VOLUME_L"].unstack().rolling(40, 1).apply(mean_).stack()
