...
class factor_xly_neptune_t_1_a30(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a30"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori[self.factor_name] = df_ori['factor'].unstack().diff().rolling(10,min_periods=1).max().stack()
