...
class factor_tsq_newneptune_20250417_12(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_12"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "成交额与笔均成交额相关系数" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        data['trade_per_value'] = data['ValueTrade'] / data['NumTrade']
        res = data['trade_per_value'].corr(data['ValueTrade'], method='spearman')
