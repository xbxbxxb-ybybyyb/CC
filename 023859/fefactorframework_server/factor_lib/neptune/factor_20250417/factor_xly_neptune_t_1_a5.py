...
class factor_xly_neptune_t_1_a5(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a5"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "大单主动买额-大单主动卖额均值" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori[self.factor_name] = df_ori['factor'].unstack().rolling(5,min_periods=1).max().stack()
