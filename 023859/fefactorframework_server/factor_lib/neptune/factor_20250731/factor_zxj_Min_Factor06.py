...
class factor_zxj_Min_Factor06(BaseFactor):
    strategy_name = "neptune"
    factor_name = "zxj_Min_Factor06"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "zxj"
    factor_explain = "多空博弈因子"
    zcz_adjusted = "否"
    logic_type = ""
    low_cost = ""
    t_day_data = []
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        df_to_store = df_today_factors[['多空博弈']].copy()
        df_to_store.rename(columns={'多空博弈': self.factor_name }, inplace=True) 
