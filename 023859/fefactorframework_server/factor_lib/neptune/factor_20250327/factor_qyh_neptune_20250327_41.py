...
class factor_qyh_neptune_20250327_41(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250327_41'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "大户买入的20日均值" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori[self.factor_name] = df_ori["BUY_VALUE_EXLARGE_ORDER"].unstack().rolling(20, 1).apply(f_calc_avg).stack()
