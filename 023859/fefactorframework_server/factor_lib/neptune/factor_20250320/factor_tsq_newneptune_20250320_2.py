...
class factor_tsq_newneptune_20250320_2(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250320_2"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "10日与20日收益率差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori['factor'] = df_ori['adjclose'].unstack().shift(10).stack() / df_ori['adjclose'].unstack().shift(20).stack() - 1
