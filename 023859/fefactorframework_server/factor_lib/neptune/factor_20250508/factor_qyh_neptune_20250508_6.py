...
class factor_qyh_neptune_20250508_6(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_20250508_6"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            #
            res = df_balancesheet.groupby(['dt','Ticker'])['OTH_PAYABLE_TOT'].apply(lambda x : x.tail(8).std()).to_frame(name = self.factor_name)
