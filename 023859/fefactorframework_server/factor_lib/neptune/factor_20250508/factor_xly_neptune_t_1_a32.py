...
class factor_xly_neptune_t_1_a32(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a32"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "不同时间段净流入" # 因子逻辑解释
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 10,
         'column': ['OPEN_NET_INFLOW_RATE_VALUE','CLOSE_NET_INFLOW_RATE_VALUE']},
    ...
    t_1_factor_data_types = ['AShareMoneyFlow','RISK']
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['OPEN_NET_INFLOW_RATE_VALUE'] - df_ori['CLOSE_NET_INFLOW_RATE_VALUE']
            ...
            df_ori2[self.factor_name] = (df_ori2['factor_ind']-df_ori2['factor']).unstack().rolling(5,min_periods=1).mean().stack()
