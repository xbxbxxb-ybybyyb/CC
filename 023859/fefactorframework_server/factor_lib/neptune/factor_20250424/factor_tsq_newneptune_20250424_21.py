...
class factor_tsq_newneptune_20250424_21(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250424_21"
    fill_na_value = 1
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "分钟开盘价较昨收最小值"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = (data['OpenPx_1m'] / data['pre_close'].replace(0,np.nan)).min()
