...
class factor_ssr_net_l_s3_60(BaseFactor):
    ...
    t_1_factor_data = [{'name': 'MD',
                       ...
                       {'name': 'AShareMoneyFlow',
                        ...
                        'lag': factor_period + 5,
                        'column': ['BUY_VALUE_LARGE_ORDER', 'SELL_VALUE_LARGE_ORDER']},
                       ]
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            mf['net']=mf['BUY_VALUE_LARGE_ORDER']-mf['SELL_VALUE_LARGE_ORDER']
            mf['sum']=(mf['BUY_VALUE_LARGE_ORDER']-mf['SELL_VALUE_LARGE_ORDER']).abs()
