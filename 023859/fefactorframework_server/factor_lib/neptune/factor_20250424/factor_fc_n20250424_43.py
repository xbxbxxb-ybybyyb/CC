...
class factor_fc_n20250424_43(BaseFactor):
    owner = 'fc'
    strategy_name = "neptune"
    factor_name = sys._getframe().f_code.co_name[7:]
    fill_na_value = 1e8
    need_pre_calculate_T_N = True
    factor_explain = "近60个交易日机构卖出金额的偏差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = df_ori["SELL_VALUE_EXLARGE_ORDER"].unstack().rolling(60, 3).apply(skew_).stack()
