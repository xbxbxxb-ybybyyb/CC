...
class factor_xly_neptune_t_1_a23(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a23"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "行业内方差" # 因子逻辑解释
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 10,
         'column': ['CLOSE_NET_INFLOW_RATE_VALUE']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['CLOSE_NET_INFLOW_RATE_VALUE']
            ...
            ind_df = df_ori.groupby(['date', 'Ind'])[['factor']].std()
