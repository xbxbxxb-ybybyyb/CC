...
class factor_xly_neptune_t_1_a17(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a17"
    fill_na_value = 0
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 10,
         'column': ['VALUE_DIFF_LARGE_TRADER_ACT']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['VALUE_DIFF_LARGE_TRADER_ACT']
            ...
            df_ori2[self.factor_name] = df_ori2['factor_ind'].unstack().rolling(5, min_periods=1).mean().stack()
