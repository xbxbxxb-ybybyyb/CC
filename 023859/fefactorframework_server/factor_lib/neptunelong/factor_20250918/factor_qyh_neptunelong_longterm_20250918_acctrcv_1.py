...
class factor_qyh_neptunelong_longterm_20250918_acctrcv_1(BaseFactor):
    strategy_name = "neptunelong"
    factor_name = "qyh_neptunelong_longterm_20250918_acctrcv_1"
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            res = (df_balancesheet['ACCT_RCV']).groupby(['dt','Ticker'])\
                .apply(lambda x : f_calc_cct(x.tail(4))).to_frame(name='应收账款统计量')
