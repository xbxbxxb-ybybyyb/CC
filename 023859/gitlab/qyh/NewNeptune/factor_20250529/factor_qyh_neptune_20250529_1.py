...
class factor_qyh_neptune_20250529_1(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250529_1'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "h/pre 10" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = (df).mean(axis=1)
            res = res.unstack().rolling(10,1).apply(f_calc_m2m).stack().to_frame()
