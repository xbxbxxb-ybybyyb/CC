...
class factor_qyh_neptune_shortterm_20250828_1(BaseFactor):
    strategy_name = "neptune"
    factor_name = "qyh_neptune_shortterm_20250828_1"
    fill_na_value = ('median',0.5)
    need_pre_calculate_T_N = True
    owner = "qyh"  # 开发人员姓名
    factor_explain = "委买占比 统计量" # 因子逻辑解释
