...
class factor_xly_neptune_t_1_a49(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a49"
    fill_na_value = 0
    ...
    t_1_factor_data = [
        {'name': 'MD_CHINA_STOCK_DAILY_WIND',
         ...
         'lag': 30,
         'column': ['high','close','pre_close','open','low']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = (df_ori['close'] - df_ori['open'])/(df_ori['high'] - df_ori['low']+1)
