...
class factor_xly_neptune_t_1_a43(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a43"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = (df_ori['high'] - df_ori['close']-(df_ori['close']-df_ori['low']))/(df_ori['high'] + df_ori['low'])
            ...
            df_ori2['factor_ind2'] = df_ori2['factor'] - df_ori2['factor_ind']
            df_ori2[self.factor_name] = df_ori2['factor_ind2'].unstack().rolling(30, min_periods=1).mean().stack()
