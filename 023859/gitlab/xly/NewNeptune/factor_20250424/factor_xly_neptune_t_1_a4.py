...
class factor_xly_neptune_t_1_a4(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a4"
    fill_na_value = 0
    ...
    t_1_factor_data = [{'name': 'AShareMoneyFlow',
                        ...
                        'lag': 10,
                        'column': ['S_MFD_INFLOW_OPEN','S_MFD_INFLOW_CLOSE']}
                       ]
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['S_MFD_INFLOW_OPEN'] - df_ori['S_MFD_INFLOW_CLOSE']
