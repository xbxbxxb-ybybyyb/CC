...
class factor_xly_neptune_t_1_a47(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a47"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori2[self.factor_name] = df_ori2['factor_ind2'].unstack().rolling(60, min_periods=1).mean().stack()
