...
class factor_xly_neptune_t_1_a34(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a34"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "行业资金净流入" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['S_MFD_INFLOW']
            ...
            df_ori2[self.factor_name] = df_ori2['factor_ind'].unstack().diff().rolling(10,min_periods=1).std().stack()
