...
class factor_xly_neptune_t_1_a37(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a37"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "xly"  # 开发人员姓名
    factor_explain = "大单净流入" # 因子逻辑解释
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 50,
         'column': ['OPEN_MONEYFLOW_PCT_VALUE_L','CLOSE_MONEYFLOW_PCT_VALUE_L']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['OPEN_MONEYFLOW_PCT_VALUE_L'] - df_ori['CLOSE_MONEYFLOW_PCT_VALUE_L']
            ...
            df_ori2[self.factor_name] = (df_ori2['factor_ind']-df_ori2['factor']).unstack().rolling(40,min_periods=1).mean().stack()
