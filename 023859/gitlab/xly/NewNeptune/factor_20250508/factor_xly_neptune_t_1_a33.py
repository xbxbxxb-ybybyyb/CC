...
class factor_xly_neptune_t_1_a33(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a33"
    fill_na_value = 0
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 40,
         'column': ['OPEN_NET_INFLOW_RATE_VALUE']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori2[self.factor_name] = (df_ori2['factor_ind']-df_ori2['factor']).unstack().rolling(30,min_periods=1).mean().stack()
