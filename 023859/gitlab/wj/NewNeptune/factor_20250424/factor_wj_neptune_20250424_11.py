...
class factor_wj_neptune_20250424_11(BaseFactor):
    strategy_name = "neptune"
    factor_name = "wj_neptune_20250424_11"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "wj"  # 开发人员姓名
    factor_explain = "净流入金额/成交笔数，10日标准差" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:  # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori['long'] = (df_ori['S_MFD_INFLOW']/(1e-3+df_ori['TRADES_COUNT'])).unstack().rolling(10,1).apply(
