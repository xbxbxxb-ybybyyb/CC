...
class factor_wj_neptune_20250410_21(BaseFactor):
    strategy_name = "neptune"
    factor_name = "wj_neptune_20250410_21"
    fill_na_value = 0
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            if len(df) > 1:
                ...
                res3 = (df['BidQty']/(df['WeightedAvgBidPx']+1e-3 - df['WeightedAvgOfferPx'])/(df['OfferQty']+1e-3)).mean()
