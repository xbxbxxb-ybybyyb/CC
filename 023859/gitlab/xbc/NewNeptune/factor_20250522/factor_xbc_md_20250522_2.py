...
class factor_xbc_md_20250522_2(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xbc_md_20250522_2"
    fill_na_value = 1
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            df_ori['s1'] = ((df_ori['high'] - df_ori['close']) / df_ori['turn'])**2
            df_ori['s2'] = ((df_ori['open'] - df_ori['low']) / df_ori['turn'])**2
