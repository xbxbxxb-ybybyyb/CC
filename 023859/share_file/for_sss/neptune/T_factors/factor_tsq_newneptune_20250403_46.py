...
class factor_tsq_newneptune_20250403_46(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250403_46"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "中间价收益率最大值" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            data['MidPx'] = (data['WeightedAvgBidPx'] + data['WeightedAvgOfferPx']) / 2
            ret = data['MidPx'] / data['pre_close'] - 1
            res = ret.max()
