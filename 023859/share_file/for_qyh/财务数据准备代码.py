...
start_date = '20160101'
end_date = '20241231'
basic_file = pd.read_pickle('/dfs/user/023859/neptune/basic_file_neptune_all_20160101_20241231.pkl')
...
df1.loc[(df1['Ticker'] == '000043.SZ')&df1['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df1.loc[df1['Ticker'] == '001914.SZ', 'S_INFO_LISTDATE'].iloc[0] # TODO 补充改名股票S_INFO_LISTDATE
df1.loc[(df1['Ticker'] == '300114.SZ')&df1['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df1.loc[df1['Ticker'] == '302132.SZ', 'S_INFO_LISTDATE'].iloc[0]

df2 = pd.merge(df2, ipo_data[['S_INFO_LISTDATE','S_INFO_DELISTDATE','Ticker']], left_on='Ticker', right_on='Ticker', how='left')
df2.loc[(df2['Ticker'] == '000043.SZ')&df2['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df2.loc[df2['Ticker'] == '001914.SZ', 'S_INFO_LISTDATE'].iloc[0] # TODO 补充改名股票S_INFO_LISTDATE
df2.loc[(df2['Ticker'] == '300114.SZ')&df2['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df2.loc[df2['Ticker'] == '302132.SZ', 'S_INFO_LISTDATE'].iloc[0]

df3 = pd.merge(df3, ipo_data[['S_INFO_LISTDATE','S_INFO_DELISTDATE','Ticker']], left_on='Ticker', right_on='Ticker', how='left')
df3.loc[(df3['Ticker'] == '000043.SZ')&df3['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df3.loc[df3['Ticker'] == '001914.SZ', 'S_INFO_LISTDATE'].iloc[0] # TODO 补充改名股票S_INFO_LISTDATE
df3.loc[(df3['Ticker'] == '300114.SZ')&df3['S_INFO_LISTDATE'].isna(), 'S_INFO_LISTDATE'] = df3.loc[df3['Ticker'] == '302132.SZ', 'S_INFO_LISTDATE'].iloc[0]
