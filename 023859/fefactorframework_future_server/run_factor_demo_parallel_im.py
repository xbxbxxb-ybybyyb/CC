...
def run_factor(func, factor_name, factor_type, start_date, end_date, basic_file_path, result_path, append_next_tradingday=False, interval_res=True,
    ...
    if factor_type in ['TTickabAll']:
        ...
        factor_df_list = Parallel(n_jobs=24)(delayed(calc_tmp_df)(tradingday, num) for tradingday, num in
...
if __name__ == '__main__':
    start_date, end_date = 20220801, 20250430 # 因子的样本内区间：20220801-20230731
    basic_file_path = '/data/user/023859/factor_zooF/factor_lib/Basic_future_20220801_20250430.h5' # '/data/group/800463/data/projectF_public/factor_lib/Basic_future_20220801_20230731.h5'
    result_path = '/data/user/023859/im_test/'
    from factor_sample.factor_tsq_future_20250626_5 import factor_tsq_future_20250626_5
    factor_df0 = run_factor(factor_tsq_future_20250626_5, 'tsq_future_20250626_5', 'TTickabAll',
                           start_date, end_date, basic_file_path, result_path, interval_res=False)

    # factor_df0 = pd.read_hdf('/data/user/023859/factor_zooF/all_factor/tsq_future_20250626_4/tsq_future_20250626_4.h5')
    ft = FactorTest(20230801,20250430)
    ft.factor_test(factor_df0[['tsq_future_20250626_5']], result_path=result_path, factor_corr_test=True, generate_pdf=True)
