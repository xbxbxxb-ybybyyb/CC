...
class FactorTest:
    ...
    def load_data(self):
        ...
        if self.strategy_name == 'future':
            sft_basic_path = '/data/user/023859/factor_zooF/factor_lib/sft_update_20220801_20250430.pkl'  # 这个文件里有label和所有因子
            ...
            df = pd.read_pickle(sft_basic_path).loc[pd.Timestamp(str(self.start_date)): pd.Timestamp(self.end_date_)]
