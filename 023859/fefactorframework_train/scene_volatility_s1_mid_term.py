...
update_xlsx = False
scene_factor_name = 'tsq_newneptune_s1_scene_volatility_mid_term' # 分场景因子名称
...
period_dict = {
    'ret_t-1_1000_t_open':['last_m955','m925'],
    'ret_t-1_1030_t_1000':['last_m1025','m955'],
    'ret_t-1_1100_t_1030':['last_m1055','m1025'],
    'ret_t-1_1300_t_1100':['last_m1125','m1055'],
    'ret_t-1_1330_t_1300':['last_m1325','m1125'],
    'ret_t-1_1400_t_1330':['last_m1355','m1325'],
    'ret_t-1_1430_t_1400':['last_m1425','m1355'],
    'ret_t_930_t_1430':['m925','m1425'],
}
...
for i, period in enumerate(period_dict):
    ...
    basic_file[f'factor_ret_{i + 9}'] = md[period].unstack().shift(i+7).stack()
    basic_file[f'factor_ret_{i + 17}'] = md[period].unstack().shift(i+14).stack()
