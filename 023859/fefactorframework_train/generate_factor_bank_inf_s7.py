...
strategy='neptune'
factor_version_date = 20250729
factor_check_path = '/data/group/800463/data/projectZZ_public/factor_lib/check_res_tot_neptune.xlsx'
result_path_local = os.path.join('/dfs/user/023859/share_file/for_xbc/neptune',str(factor_version_date))
...
factor_type_T_1 = ["['T-1_Factor']","['xdb_tick1m']","['xdb_order1m']"] # 去掉财务因子
...
# 来自少森的T日因子
factor_bank_inf_t = pd.read_excel('/dfs/user/018107/share_file/for_tsq/20250729_zz1000_s7_factor_inf.xlsx')
...
# 补充情绪因子
# factor_bank_inf_emotion_s1 = pd.read_excel('/data/user/023859/factor_zooZZ/emotion_factor_inf_s1.xlsx')
# emotion_factor_count = len(factor_bank_inf_emotion_s1)
...
# scene_factor_count = len(factor_bank_inf_scene_s1)
...
factor_bank_inf_all = pd.concat([factor_bank_inf[['factor_name','factor_type','factor_owner','提交时间','emotion','t']],\
                                 ...
                                 # factor_bank_inf_emotion_s1[['factor_name','factor_type','factor_owner','提交时间','emotion','t']],\
...
assert all_factor_count == (T_1_factor_count + T_factor_count)

# factor_bank_inf_all.to_excel(os.path.join(result_path_public,'factor_bank_inf_s1.xlsx'))
factor_bank_inf_all.to_excel(os.path.join(result_path_local,'factor_bank_inf_s7.xlsx'))