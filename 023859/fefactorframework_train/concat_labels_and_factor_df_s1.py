...
# 区间3 fit
factor_df_s1 = pd.read_pickle(f'/dfs/user/023859/neptune/{strategy_version}/factor_df_s1_{start_date}_{end_date}.pkl')
...
label_df = pd.read_pickle(f'/dfs/user/023859/neptune/{strategy_version}/label_df_s1_20170110_20241231.pkl').loc[pd.Timestamp(str(start_date)):pd.Timestamp(str(end_date))]
...
factor_df_all = label_df[['buy_amt','weight','label_t2o9d1_neg','label_t2o9d1_pos']].join(factor_df_s1)
assert len(factor_df_all) == len(label_df)

# filter: 剔除波动率小于千3，权重小于万5的样本
factor_df_all = factor_df_all[factor_df_all['tsq_newneptune_s1_scene_volatility'] >= 0.003]
...
volatility_median = factor_df_all.loc[:pd.Timestamp('20200630')]['tsq_newneptune_s1_scene_volatility'].median()
factor_df_volatility_high = factor_df_all[factor_df_all['tsq_newneptune_s1_scene_volatility'] >= volatility_median]
factor_df_volatility_low = factor_df_all[factor_df_all['tsq_newneptune_s1_scene_volatility'] < volatility_median]
...
# factor_df_all.loc[:pd.Timestamp('20210630')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_filter_20170110_20201231.pkl')
# factor_df_swing_high.loc[:pd.Timestamp('20210630')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_sw_high_filter_20170110_20201231.pkl')
# factor_df_swing_low.loc[:pd.Timestamp('20210630')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_sw_low_filter_20170110_20201231.pkl')
# factor_df_volatility_high.loc[:pd.Timestamp('20210630')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_vol_high_filter_20170110_20201231.pkl')
# factor_df_volatility_low.loc[:pd.Timestamp('20210630')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_vol_low_filter_20170110_20201231.pkl')
...
factor_df_all.loc[factor_df_all['tsq_newneptune_s1_scene_volatility'] >= volatility_median,'scene_vol'] = 1

factor_df_all.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/factor_df_s1_filter_{start_date}_{end_date}.pkl')
factor_df_all.to_pickle(f'/dfs/user/023859/share_file/for_skk/neptune/{strategy_version}/factor_df_s1_filter_{start_date}_{end_date}.pkl')
...
factor_df_volatility_high.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/factor_df_s1_vol_high_filter_{start_date}_{end_date}.pkl')
factor_df_volatility_high.to_pickle(f'/dfs/user/023859/share_file/for_skk/neptune/{strategy_version}/factor_df_s1_vol_high_filter_{start_date}_{end_date}.pkl')
factor_df_volatility_low.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/factor_df_s1_vol_low_filter_{start_date}_{end_date}.pkl')
factor_df_volatility_low.to_pickle(f'/dfs/user/023859/share_file/for_skk/neptune/{strategy_version}/factor_df_s1_vol_low_filter_{start_date}_{end_date}.pkl')