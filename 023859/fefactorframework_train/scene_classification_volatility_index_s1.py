...
index_df = pd.read_pickle(f'/dfs/user/023859/neptune/index_label_period_20160101_20241231.pkl') # 指数日内半小时标签
...
index_df['t-2_preclose_open'] = index_df['preclose_open'].shift(2)

index_df['tsq_newneptune_s1_index_scene_volatility'] = index_df[periods_t_1+periods_t_2+periods_t_3+['t_preclose_open','t-1_preclose_open','t-2_preclose_open']].std(axis=1)
index_df['tsq_newneptune_s1_index_scene_volatility'] = index_df['tsq_newneptune_s1_index_scene_volatility'].fillna(0)
...
IO.pd_hdf5_writer(result_df[['tsq_newneptune_s1_index_scene_volatility']], hdf5=os.path.join(res_path,'tsq_newneptune_s1_index_scene_volatility.h5'), dataset='neptune')
