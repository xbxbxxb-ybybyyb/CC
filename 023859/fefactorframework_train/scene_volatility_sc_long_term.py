...
scene_factor_name = 'tsq_newneptune_sc_scene_volatility_long_term' # 分场景因子名称
...
md = md[md['amt']>0]
close_px = IO.read_data([20160101,end_date],columns=['m1425'], alt='/data/group/800463/data/generalStrong/minute5/close.h5')
md = md.join(close_px)
md.loc[md['zcz'], 'm1425'] = ((md.loc[md['zcz'], 'm1425'] / md.loc[md['zcz'], 'pre_close'] - 1) / 2 + 1) * md.loc[md['zcz'], 'pre_close']
md['m1425'] = md['m1425'] * md['adjfactor']
md['pre_m1425'] = md['m1425'].unstack().shift(1).stack()
md['ret'] = md['m1425'] / md['pre_m1425'] - 1
