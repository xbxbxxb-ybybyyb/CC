...
update_xlsx = False
scene_factor_name = 'tsq_newneptune_sc_scene_swing_mid_term' # 分场景因子名称
...
period_dict = {
    'swing_t_1330_t_1430':['m1330','m1335','m1340','m1345','m1350','m1355','m1400','m1405','m1410','m1415','m1420','m1425'],
    'swing_t_1100_t_1330':['m1100','m1105','m1110','m1115','m1120','m1125','m1300','m1305','m1310','m1315','m1320','m1325'],
    'swing_t_1000_t_1100':['m1000','m1005','m1010','m1015','m1020','m1025','m1030','m1035','m1040','m1045','m1050','m1055'],
    'swing_t-1_1430_t_1000':['last_m1430','last_m1435','last_m1440','last_m1445','last_m1450','last_m1455','m925','m930','m935','m940','m945','m950','m955'],
}
...
for i, period in enumerate(period_dict):
    ...
    basic_file[f'factor_swing_{i + 1}'] = md[period].unstack().shift((i+1) // 4).stack()
    basic_file[f'factor_swing_{i + 5}'] = md[period].unstack().shift((i+1) // 4 + 1).stack()
    basic_file[f'factor_swing_{i + 9}'] = md[period].unstack().shift((i+1) // 4 + 2).stack()
    basic_file[f'factor_swing_{i + 13}'] = md[period].unstack().shift((i+1) // 4 + 3).stack()
    basic_file[f'factor_swing_{i + 17}'] = md[period].unstack().shift((i+1) // 4 + 4).stack()
    basic_file[f'factor_swing_{i + 21}'] = md[period].unstack().shift((i+1) // 4 + 5).stack()
