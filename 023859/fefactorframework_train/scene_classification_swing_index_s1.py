...
index_df['swing_t-3'] = index_df['swing'].shift(3)
index_df['tsq_newneptune_s1_index_scene_swing'] = index_df[['swing_t-1','swing_t-2','swing_t-3']].mean(axis=1)
index_df['tsq_newneptune_s1_index_scene_swing'] = index_df['tsq_newneptune_s1_index_scene_swing'].fillna(0)
...
if update_xlsx:
    ...
    scene_factor_bank_inf_append = pd.DataFrame({'factor_name':['tsq_newneptune_s1_index_scene_swing'],'factor_type':["['IndexLast3Tick']"],'factor_owner':['tsq'],'提交时间':['20250527'],'emotion':[""], 't':['T-1']})
...
IO.pd_hdf5_writer(result_df[['tsq_newneptune_s1_index_scene_swing']], hdf5=os.path.join(res_path,'tsq_newneptune_s1_index_scene_swing.h5'), dataset='neptune')
