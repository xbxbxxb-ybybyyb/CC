...
def run(factor_name_list, start_date, end_date, strategy, output_dir, options=None, data_filter = 'no_filter'):
    calc_num_cpus = 1
    ...
    result, check_result = __calc_factor(strategy, factor_name_list, start_date, end_date, mode, calc_num_cpus,
                                         precheck, run_factor_test, report, output_dir, local_evaluator, data_filter)

    return result, check_result


def __calc_factor(strategy, factor_name_list, start_date, end_date, mode, calc_num_cpus, precheck, run_factor_test,
                  report, output_dir, local_evaluator, data_filter):
    result = {}
    cost_result = {}
    checker_result = {}
    task_manager = TaskManager(factor_name_list, start_date, end_date, strategy, data_filter)
