...
IO.pd_hdf5_writer(label_df_long_term, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/p2_profit_intervalTwap_sc_long_term_0.10_0.10.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_mid_term, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/p2_profit_intervalTwap_sc_mid_term_0.10_0.10.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_short_term, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/p2_profit_intervalTwap_sc_short_term_0.10_0.10.h5', dataset='neptune')

IO.pd_hdf5_writer(label_df_long_term_neg, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/neg/p2_profit_intervalTwap_sc_long_term_0.10_0.10.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_mid_term_neg, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/neg/p2_profit_intervalTwap_sc_mid_term_0.10_0.10.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_short_term_neg, hdf5='/data/group/800463/tangsq/neptune/profit/20250609/neg/p2_profit_intervalTwap_sc_short_term_0.10_0.10.h5', dataset='neptune')
...
IO.pd_hdf5_writer(label_df_long_term[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_long_term.h5', dataset='neptune',override=True)
IO.pd_hdf5_writer(label_df_mid_term[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_mid_term.h5', dataset='neptune',override=True)
IO.pd_hdf5_writer(label_df_short_term[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_short_term.h5', dataset='neptune',override=True)


IO.pd_hdf5_writer(label_df_long_term_neg[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_long_term_neg.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_mid_term_neg[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_mid_term_neg.h5', dataset='neptune')
IO.pd_hdf5_writer(label_df_short_term_neg[['label_pct','label_Tc2b10','label_TNo2Tc','label_TNv2TNo','label_T_close_is_zt','label_Next_close_is_zt']], hdf5=f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/zz1000_labels_file_sc_short_term_neg.h5', dataset='neptune')
