...
class factor_tsq_newneptune_20250424_test(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250424_test"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "卖单下单价除以下单额标准差"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = (1e4 * data['OrderPrice_sell_mean'] / data['OrderAmt_sell'].replace(0,np.nan)).std()
