...
class factor_tsq_newneptune_20250417_27(BaseFactor):
    strategy_name = "neptune"
    factor_name = "tsq_newneptune_20250417_27"
    fill_na_value = 0
    need_pre_calculate_T_N = True
    owner = "tsq"  # 开发人员姓名
    factor_explain = "成交额加权收益率"  # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        res = np.sum(data_all['ValueTrade'] * data_all['ret']) / np.sum(data_all['ValueTrade'])
