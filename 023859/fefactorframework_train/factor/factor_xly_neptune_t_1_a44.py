...
class factor_xly_neptune_t_1_a44(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a44"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = (df_ori['high'] - df_ori['close']-df_ori['low']+df_ori['open'])/(df_ori['high'] + df_ori['low'])
            ...
            df_ori2[self.factor_name] = df_ori2['factor_ind'].unstack().rolling(120, min_periods=1).mean().stack()
