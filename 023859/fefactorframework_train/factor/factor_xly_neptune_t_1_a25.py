...
class factor_xly_neptune_t_1_a25(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_a25"
    fill_na_value = 0
    ...
    t_1_factor_data = [
        {'name': 'AShareMoneyFlow',
         ...
         'lag': 10,
         'column': ['S_MFD_INFLOW_CLOSEVOLUME']},
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            df_ori['factor'] = df_ori['S_MFD_INFLOW_CLOSEVOLUME']
            ...
            ind_df = df_ori.groupby(['date', 'Ind'])[['factor']].max()
