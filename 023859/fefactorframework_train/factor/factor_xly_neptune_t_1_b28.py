...
class factor_xly_neptune_t_1_b28(BaseFactor):
    strategy_name = "neptune"
    factor_name = "xly_neptune_t_1_b28"
    fill_na_value = 0
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            try:
                ...
                res = tick_df_period['Sell1OrderQty'].diff().fillna(0).corr(tick_df_period['Sell1Price'].diff().fillna(0))
                if np.isinf(res):
                    res = 1
            except:
