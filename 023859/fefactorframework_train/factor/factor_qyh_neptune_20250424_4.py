...
class factor_qyh_neptune_20250424_4(BaseFactor):
    owner = 'qyh'
    strategy_name = "neptune"
    factor_name = 'qyh_neptune_20250424_4'
    fill_na_value = 0
    need_pre_calculate_T_N = True
    factor_explain = "lnpct的10日median" # 因子逻辑解释
    ...
    def pre_calculate_T_N_data(self, database):
        if database["skip"] == True:
            ...
            res = (df).max(axis=1)
            res = res.unstack().rolling(10,2).median().stack().to_frame()
