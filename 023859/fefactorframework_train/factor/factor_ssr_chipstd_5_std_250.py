...
class factor_ssr_chipstd_5_std_250(BaseFactor):
    ...
    def pre_calculate_T_N_data(self, database):
        ...
        if database["skip"] == True: # 纯h5文件的T-1_Factor保留这一段，但不产生影响
            ...
            md['value'] = (md['vvalue_sum'] / md['atr_sum'])**0.5
            ...
            df = pd.DataFrame(value.round(4).rank(axis=1, pct=True).round(4).stack())-0.5
