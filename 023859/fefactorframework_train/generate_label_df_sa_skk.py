...
start_date, end_date = 20170110,20210630
...
factor_bank_inf = pd.read_excel(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_bank_inf_sa.xlsx')
strategy_path = f'/dfs/user/023859/neptune/{strategy_version}'
factor_df_path = os.path.join(strategy_path, f'factor_df_sa_20170110_20211231.pkl')
...
long_term_name = 'p2_profit_intervalTwap_1000_1010_Sell_intervalTwap_1000_1010_0.10_0.10.h5'
mid_term_name = 'p2_profit_intervalTwap_1000_1010_Sell_intervalTwap_931_941_0.10_0.10.h5'
short_term_name = 'p2_profit_intervalTwap_1000_1010_Sell_T0_intervalTwap_1430_1440_0.10_0.10.h5'
...
# volatility_threshold_long_term = factor_df_all.loc[:pd.Timestamp('20191231')]['tsq_newneptune_sa_scene_volatility_long_term'].quantile(0.1)
# volatility_threshold_mid_term = factor_df_all.loc[:pd.Timestamp('20191231')]['tsq_newneptune_sa_scene_volatility_mid_term'].quantile(0.1)
volatility_threshold_short_term = factor_df_all.loc[:pd.Timestamp('20191231')]['tsq_newneptune_sa_scene_volatility_short_term'].quantile(0.1)
...
factor_df_all_short_term = factor_df_all[factor_df_all['tsq_newneptune_sa_scene_volatility_short_term'] >= max(0.003,volatility_threshold_short_term)]
...
swing_median_short_term = factor_df_all_short_term.loc[:pd.Timestamp('20190630')]['tsq_newneptune_sa_scene_swing_short_term'].median()
factor_df_swing_high_short_term = factor_df_all_short_term[factor_df_all_short_term['tsq_newneptune_sa_scene_swing_short_term'] >= swing_median_short_term]
factor_df_swing_low_short_term = factor_df_all_short_term[factor_df_all_short_term['tsq_newneptune_sa_scene_swing_short_term'] < swing_median_short_term]
...
volatility_median_short_term = factor_df_all_short_term.loc[:pd.Timestamp('20190630')]['tsq_newneptune_sa_scene_volatility_short_term'].median()
factor_df_volatility_high_short_term = factor_df_all_short_term[factor_df_all_short_term['tsq_newneptune_sa_scene_volatility_short_term'] >= volatility_median_short_term]
factor_df_volatility_low_short_term = factor_df_all_short_term[factor_df_all_short_term['tsq_newneptune_sa_scene_volatility_short_term'] < volatility_median_short_term]
...
# factor_df_all_short_term.loc[:pd.Timestamp(str(test_end_date))].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/{start_date}_{test_end_date}/factor_df_sa_filter_short_term_20170110_{test_end_date}.pkl')
#
...
# factor_df_swing_high_short_term.loc[:pd.Timestamp(str(test_end_date))].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/{start_date}_{test_end_date}/factor_df_sa_sw_high_filter_short_term_20170110_{test_end_date}.pkl')
# factor_df_swing_low_short_term.loc[:pd.Timestamp(str(test_end_date))].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/{start_date}_{test_end_date}/factor_df_sa_sw_low_filter_short_term_20170110_{test_end_date}.pkl')
#
...
# factor_df_volatility_high_short_term.loc[:pd.Timestamp(str(test_end_date))].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/{start_date}_{test_end_date}/factor_df_sa_vol_high_filter_short_term_20170110_{test_end_date}.pkl')
# factor_df_volatility_low_short_term.loc[:pd.Timestamp(str(test_end_date))].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/{start_date}_{test_end_date}/factor_df_sa_vol_low_filter_short_term_20170110_{test_end_date}.pkl')
...
factor_df_all_short_term.loc[factor_df_all_short_term['tsq_newneptune_sa_scene_swing_short_term'] >= swing_median_short_term,'scene_sw'] = 1
factor_df_all_short_term['scene_vol'] = 0
factor_df_all_short_term.loc[factor_df_all_short_term['tsq_newneptune_sa_scene_volatility_short_term'] >= volatility_median_short_term,'scene_vol'] = 1
factor_df_all_short_term.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/{start_date}_{end_date}/factor_df_sa_filter_short_term_{start_date}_{end_date}.pkl')
factor_df_swing_high_short_term.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/{start_date}_{end_date}/factor_df_sa_sw_high_filter_short_term_{start_date}_{end_date}.pkl')
factor_df_swing_low_short_term.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/{start_date}_{end_date}/factor_df_sa_sw_low_filter_short_term_{start_date}_{end_date}.pkl')
factor_df_volatility_high_short_term.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/{start_date}_{end_date}/factor_df_sa_vol_high_filter_short_term_{start_date}_{end_date}.pkl')
factor_df_volatility_low_short_term.to_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/{strategy_version}/{start_date}_{end_date}/factor_df_sa_vol_low_filter_short_term_{start_date}_{end_date}.pkl')