...
update_xlsx = False
scene_factor_name = 'tsq_newneptune_s1_scene_swing_short_term' # 分场景因子名称
...
period_dict = {
    'swing_t-1_1430_t_open':['last_m1430','last_m1435','last_m1440','last_m1445','last_m1450','last_m1455','m925'],
    'swing_t-1_1400_t-1_1430':['last_m1400','last_m1405','last_m1410','last_m1415','last_m1420','last_m1425'],
    'swing_t-1_1330_t-1_1400':['last_m1330','last_m1335','last_m1340','last_m1345','last_m1350','last_m1355'],
    'swing_t-1_1300_t-1_1330':['last_m1300','last_m1305','last_m1310','last_m1315','last_m1320','last_m1325'],
    'swing_t-1_1100_t-1_1300':['last_m1100','last_m1105','last_m1110','last_m1115','last_m1120','last_m1125'],
    'swing_t-1_1030_t-1_1100':['last_m1030','last_m1035','last_m1040','last_m1045','last_m1050','last_m1055'],
    'swing_t-1_1000_t-1_1030':['last_m1000','last_m1005','last_m1010','last_m1015','last_m1020','last_m1025'],
    'swing_t-1_930_t-1_1000':['last_m930','last_m935','last_m940','last_m945','last_m950','last_m955'],
}
...
for i, period in enumerate(period_dict):
    ...
    basic_file[f'factor_swing_{i + 1}'] = md[period].unstack().shift(0).stack()
    basic_file[f'factor_swing_{i + 9}'] = md[period].unstack().shift(1).stack()
    basic_file[f'factor_swing_{i + 17}'] = md[period].unstack().shift(2).stack()
