...
basic_file_path = f'/dfs/user/023859/neptune/{factor_version_date}/basic_file_zz1000_sc_20170110_20241231.pkl' # zz1000 sc时点基础样本，比s1更大一些
factor_bank_inf_path = os.path.join(strategy_path,'factor_bank_inf_sc.xlsx') # 可用因子列表
...
t_factor_path = '/dfs/user/018107/share_file/for_tsq/20250513_zz1000_factor_value_20160101_20220630.pkl'
emotion_factor_path = f'/dfs/user/023859/neptune/20250428/20160101_20250331' # 情绪因子路径
# scene_swing_factor_path = f'/dfs/user/023859/neptune/20250527/scene_factors_swing/20170110_20241231' # 情绪因子路径
...
factor_list.append(pd.read_hdf(os.path.join(scene_volatility_factor_path,'tsq_newneptune_sc_scene_volatility_short_term.h5')).loc[pd.Timestamp(str(start_date)):pd.Timestamp(str(end_date))])
...
# factor_list.append(pd.read_hdf(os.path.join(scene_swing_factor_path,'tsq_newneptune_sc_scene_swing.h5')).loc[pd.Timestamp(str(start_date)):pd.Timestamp(str(end_date))])
...
# 原始因子值
all_factor_df.to_pickle(os.path.join(strategy_path, f'factor_df_sc_{start_date}_{end_date}.pkl'))