...
index_df = pd.read_pickle(f'/dfs/user/023859/neptune/index_label_period_20160101_20241231.pkl')
...
index_df['t_preclose_open'] = index_df['preclose_open']
index_df['t-1_preclose_open'] = index_df['preclose_open'].shift(1)

index_df['tsq_newneptune_sc_index_scene_volatility'] = index_df[periods_t_1+periods_t_2+periods_t+['t_preclose_open','t-1_preclose_open']].std(axis=1)
index_df['tsq_newneptune_sc_index_scene_volatility'] = index_df['tsq_newneptune_sc_index_scene_volatility'].fillna(0)
...
if update_xlsx:
    ...
    scene_factor_bank_inf_append = pd.DataFrame({'factor_name':['tsq_newneptune_sc_index_scene_volatility'],'factor_type':["['IndexLast2Tick', 'IndexTTick']"],'factor_owner':['tsq'],'提交时间':['20250527'],'emotion':[""], 't':['T']})
...
IO.pd_hdf5_writer(result_df[['tsq_newneptune_sc_index_scene_volatility']], hdf5=os.path.join(res_path,'tsq_newneptune_sc_index_scene_volatility.h5'), dataset='neptune')
