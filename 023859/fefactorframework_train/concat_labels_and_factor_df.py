...
# factor_df_all.loc[:pd.Timestamp('20201231')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_filter_20170110_20201231.pkl')
...
# factor_df_volatility_high.loc[:pd.Timestamp('20201231')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_vol_high_filter_20170110_20201231.pkl')
# factor_df_volatility_low.loc[:pd.Timestamp('20201231')].to_pickle(f'/data/group/800463/tangsq/neptune/{strategy_version}/factor_df_s1_vol_low_filter_20170110_20201231.pkl')
