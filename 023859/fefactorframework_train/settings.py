...
valid_strategy_names = ["saturn", "sell", "jupiter", 'europa', "metis", "mimas", "saturn/sell", "jupiter/europa",
                        "sell/saturn","mercury",
                        "europa/jupiter","neptune"]
valid_single_strategy_names = ["saturn", "sell", "jupiter", 'europa', "metis", "mimas","mercury","neptune"]
...
xdb_path_xdbformat = {
    ...
    "neptune": "/dfs/group/800463/data/xdb_data_lag3_new/neptunelong/",
}
...
path_dict = {
    ...
    "neptune": {
        'T1mTransaction': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/transaction_cs/',
        'T1mTickab': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/tick_cs/',
        'T1mTick1s': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/tick1s_cs/',
        'T1mCancel': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/cancelprice_cs/',
        'T1mTickfulladdorder': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/tickfulladdorder_cs/',
        'T1mOrder': '/dfs/group/800463/data/projectZZ_prod/everyday_Data_931/order_cs/',
        'Basic': '/dfs/user/023859/neptune/basic_file_zz1000_20160101_20250630.h5',
        # 'Basic': '/data/user/023859/factor_zooZZmkt/factor_lib/Basic_closed_hf_finish_20160101_20201231.h5'
    },
}
...
precheck_path_dict = {
    ...
    "neptune": {
        "precheck_basic_path": '/dfs/user/023859/neptune/basic_file_zz1000_20160101_20250630.h5',
        "long_interval": ['20160101', '20191231'],
        "short_interval_list": ['20160104', '20160105', '20160106', '20160107', '20180601', '20180604', '20191227',
                                '20191230', '20191231'],
    },
