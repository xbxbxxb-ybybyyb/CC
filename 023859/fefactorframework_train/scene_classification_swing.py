...
data_period1 = pd.read_pickle(f'/dfs/user/023859/share_file/for_wj/neptune/20250526/factor_df_s1_filter_20170110_20201231.pkl')
...
data_period1['swing_t-3'] = md['swing_t-3']

data_period1['swing'] = data_period1[['swing_t-1','swing_t-2','swing_t-3']].mean(axis=1)
...
data_period1.drop(columns=['weight','swing','swing_t-1','swing_t-2','swing_t-3']).to_pickle('/dfs/user/023859/share_file/for_wj/neptune/20250526/factor_df_s1_scene_filter_20170110_20210630.pkl')
