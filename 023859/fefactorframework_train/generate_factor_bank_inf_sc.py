...
strategy='neptune'
factor_version_date = 20250609
factor_check_path = '/data/group/800463/data/projectZZ_public/factor_lib/check_res_tot_neptune.xlsx'
t_factor_path = '/dfs/user/018107/share_file/for_tsq/20250626_zz1000_sc_factor_inf.xlsx'
result_path_local = os.path.join('/dfs/user/023859/neptune',str(factor_version_date)+'/20170110_20221231')
os.makedirs(result_path_local,exist_ok=True)
result_path_public = f'/data/group/800463/tangsq/neptune/{factor_version_date}/20170110_20221231'
...
# 补充情绪因子
factor_bank_inf_emotion_sc = pd.read_excel('/data/user/023859/factor_zooZZ/emotion_factor_inf_sc.xlsx')
emotion_factor_count = len(factor_bank_inf_emotion_sc)
print(f'指数情绪因子数：{emotion_factor_count}')
# 补充分场景因子
factor_bank_inf_scene_sc = pd.read_excel('/data/user/023859/factor_zooZZ/scene_factor_inf_sc.xlsx')
...
factor_bank_inf_all.to_excel(os.path.join(result_path_public,'factor_bank_inf_sc.xlsx'))
factor_bank_inf_all.to_excel(os.path.join(result_path_local,'factor_bank_inf_sc.xlsx'))