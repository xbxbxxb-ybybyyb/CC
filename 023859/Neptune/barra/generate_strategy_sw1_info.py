...
start_date, end_date = 20210701, 20221231
...
#
# df_saturn = pd.read_csv('/data/user/013550/For_TSQ/signal/saturn/fac_20241129/集成信号_20210701_20220630.csv')
...
df_ceres = pd.read_csv('/data/user/021012/团队分享/for_tsq/ceres/fac_20241225/集成信号_20210701_20221231_s1_all.csv')
...
#
df_mimas = pd.read_csv('/data/user/013550/For_TSQ/signal/mimas/fac_20241225/集成信号_20210701_20221231.csv')
...
# df_p4 = pd.read_csv('/data/user/013550/For_TSQ/signal/p4/fac_20241225/集成信号_20220701_20221231.csv')
# df_p4['dt'] = pd.to_datetime(df_p4['dt'])
# df_p4 = df_p4.set_index(['dt','Ticker'])
# df_p4 = df_p4.loc[pd.to_datetime(str(start_date)):pd.to_datetime(str(end_date))]
# df_p4 = df_p4[['label_pct','label_buy_amt','vote_sum_pred']].rename(columns={'label_pct':'pct','label_buy_amt':'buy_amt'})
...
#
df_strategy_basic = pd.concat([df_ceres,df_mimas,df_p4],axis=0).sort_index() # saturn、ceres、mimas策略样本一起考虑
...
df_strategy_basic_sw1.to_pickle('/data/user/023859/Hedging/ceres+mimas+p4/df_strategy_basic_sw1_%s_%s.pkl'%(start_date, end_date))