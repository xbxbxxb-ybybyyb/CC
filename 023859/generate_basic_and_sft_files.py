...
neptune_sft_file = md_filtered[['list_len','Circu_Mkt','label_t2o30d1','label_t4o30d1','label_t6o30d1']].dropna()

neptune_basic_file_in_sample = neptune_basic_file.loc[:pd.to_datetime('20191231')]
neptune_basic_file_out_sample = neptune_basic_file.loc[pd.to_datetime('20200101'):]

neptune_sft_file_in_sample = neptune_sft_file.loc[:pd.to_datetime('20191231')]
neptune_sft_file_out_sample = neptune_sft_file.loc[pd.to_datetime('20200101'):]
