...
class factor_tsq_20241205_1(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "jupiter/europa"
    factor_name = "tsq_20241205_1"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "订单量与订单数相关性" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            data['num'] = data['NumTrades'].diff()
            data = data[(data['vol'] >= data['vol'].median())]
            res = data['vol'].corr(data['num'], method='spearman')
