...
zz1000_amt_dict = {'2亿现货':2e8,'4亿现货':4e8, '6亿现货':6e8}
deviation_dict = {'偏离度1':1,'偏离度1.5':1.5}
...
for i in range(len(vote_num_list)):
    ...
    excel_writer = pd.ExcelWriter(f'/data/user/023859/Hedging/industry/industry_neutral/{strategy_join}_vote{vote_num}_beta行业中性对冲回测结果{start_date}_{end_date}.xlsx')
