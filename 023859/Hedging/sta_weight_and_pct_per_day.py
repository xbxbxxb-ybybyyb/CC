...
root_dict = {'index_info':'/data/user/023859/Hedging/index_price_20210701_20240630.pkl',\
             ...
             'strategy_info':'/dfs/user/023859/industry_hedging/saturn+ceres+mimas+p4/df_strategy_basic_sw1_20210701_20230630.pkl',\
...
ZZ1000_amt = 6
industry_deviation = [1.5,0.02]
vote_num_list = [4,3,2,1]
...
folder_name = f'/dfs/user/023859/share_file/for_wys/industry_hedging/{strategy_join}/20250906'
