...
def calc_profit(trading_days, strategy_list, root_dict, ZZ1000_buy_amt_daily, deviation, holding_day):
    ...
    df_strategy_sign_sw1 = df_strategy_basic_sw1[df_strategy_basic_sw1['vote_sum_pred']>=1]
