...
class factor_tsq_neweuropa_20241226_5(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "jupiter/europa"
    factor_name = "tsq_neweuropa_20241226_5"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "撤单量加权卖单撤单时间差" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            res = (data_sell['time_delta']*data_sell['OrderQty']).sum()/data_sell['OrderQty'].sum()
