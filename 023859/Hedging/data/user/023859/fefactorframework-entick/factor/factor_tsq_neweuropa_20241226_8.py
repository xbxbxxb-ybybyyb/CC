...
class factor_tsq_neweuropa_20241226_8(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "jupiter/europa"
    factor_name = "tsq_neweuropa_20241226_8"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "触发前五分钟最高价与最低低价差峰度" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            if len(data):
                ...
                res = (data['HighPx'] - data['LowPx']).kurt()
            else:
                res = np.nan
