...
class factor_tsq_neweuropa_20241226_4(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "jupiter/europa"
    factor_name = "tsq_neweuropa_20241226_4"
    fill_na_value = 0
    need_pre_calculate_T_N = False
    owner = "tsq"  # 开发人员姓名
    factor_explain = "卖单撤单时间间隔峰度偏度差" # 因子逻辑解释
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            res_skew = data_sell['time_delta'].skew()
            res_kurt = data_sell['time_delta'].kurt()
            res = (3*res_kurt-res_skew**2)/3
