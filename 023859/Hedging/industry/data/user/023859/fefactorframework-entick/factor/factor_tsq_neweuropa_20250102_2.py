...
class factor_tsq_neweuropa_20250102_2(BaseFactor):
    # 以下为因子基本信息
    strategy_name = "jupiter/europa"
    factor_name = "tsq_neweuropa_20250102_2"
    fill_na_value = 0
    ...
    def calculate(self, database):
        if database["skip"] == True:
            ...
            res = ((data['Buy1OrderQty'] - data['Sell1OrderQty'])/(1e-6+data['Buy1OrderQty']+data['Sell1OrderQty'])).skew()
