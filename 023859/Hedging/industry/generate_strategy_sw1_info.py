...
# df_ceres = pd.read_csv('/data/user/021012/团队分享/for_tsq/ceres/fac_20241225/集成信号_20210701_20220630_label3_all.csv')
...
#
df_mimas = pd.read_csv('/data/user/013550/For_TSQ/signal/mimas/fac_20241225/集成信号_20210701_20220630.csv')
...
df_strategy_basic = df_mimas.sort_index() # saturn、ceres、mimas策略样本一起考虑
df_strategy_sign = df_mimas_sign.sort_index() # saturn、ceres、mimas策略样本一起考虑
...
df_strategy_sign_sw1.to_pickle('/data/user/023859/Hedging/mimas/df_strategy_sign_vote%s_sw1_%s_%s.pkl'%(vote_num, start_date, end_date))
