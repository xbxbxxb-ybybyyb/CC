...
public class Saturn_t931_wd_t1_order_vol_std_bda
extends BaseFactor {
    public Saturn_t931_wd_t1_order_vol_std_bda(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t931_wd_t1_order_vol_std_bda"};
    }
