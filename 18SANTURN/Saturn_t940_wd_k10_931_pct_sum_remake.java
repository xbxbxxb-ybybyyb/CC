...
public class Saturn_t940_wd_k10_931_pct_sum_remake
extends BaseFactor {
    public Saturn_t940_wd_k10_931_pct_sum_remake(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t940_wd_k10_931_pct_sum_remake"};
    }
