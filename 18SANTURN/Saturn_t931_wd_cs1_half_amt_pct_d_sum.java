...
public class Saturn_t931_wd_cs1_half_amt_pct_d_sum
extends BaseFactor {
    private final Set<String> stocksFiltered;

    public Saturn_t931_wd_cs1_half_amt_pct_d_sum(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t931_wd_cs1_half_amt_pct_d_sum"};
    ...
    public void calculate() {
        ...
        if (currentHalfAmtPct != null && halfAmtPctSum != 0.0) {
            factorValue = currentHalfAmtPct / halfAmtPctSum;
        }
