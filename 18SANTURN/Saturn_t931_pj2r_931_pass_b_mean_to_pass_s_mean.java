...
public class Saturn_t931_pj2r_931_pass_b_mean_to_pass_s_mean
extends BaseFactor {
    public Saturn_t931_pj2r_931_pass_b_mean_to_pass_s_mean(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t931_pj2r_931_pass_b_mean_to_pass_s_mean"};
    }
