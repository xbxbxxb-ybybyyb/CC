...
public class Saturn_t940_wd_k10_max_pct_ex_ul
extends BaseFactor {
    public Saturn_t940_wd_k10_max_pct_ex_ul(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t940_wd_k10_max_pct_ex_ul"};
    }
