...
public class Saturn_t931_sss_t1m_meanp_actbuy
extends BaseFactor {
    public Saturn_t931_sss_t1m_meanp_actbuy(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t931_sss_t1m_meanp_actbuy"};
    }
    ...
    public void calculate() {
        ...
        double threshold = MathUtil.calculateMean(amtList);
