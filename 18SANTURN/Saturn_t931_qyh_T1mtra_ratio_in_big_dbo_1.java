...
public class Saturn_t931_qyh_T1mtra_ratio_in_big_dbo_1
extends BaseFactor {
    public Saturn_t931_qyh_T1mtra_ratio_in_big_dbo_1(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t931_qyh_T1mtra_ratio_in_big_dbo_1"};
    }
