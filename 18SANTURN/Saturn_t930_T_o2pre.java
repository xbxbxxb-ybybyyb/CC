...
public class Saturn_t930_T_o2pre
extends BaseFactor {
    public Saturn_t930_T_o2pre(SaturnMarketDataManager marketDataManager, Map<String, Double> factorValueMap) {
        super(marketDataManager, factorValueMap);
        this.factorName = new String[]{"saturn_t930_T_o2pre"};
    }
